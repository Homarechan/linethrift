...
public partial class AuthService
{
  ...
  {
    Task<string> normalizePhoneNumberAsync(string countryCode, string phoneNumber, string countryCodeHint, CancellationToken cancellationToken);

    Task respondE2EELoginRequestAsync(string verifier, E2EEPublicKey publicKey, byte[] encryptedKeyChain, byte[] hashKeyChain, ErrorCode errorCode, CancellationToken cancellationToken);

    Task<string> confirmE2EELoginAsync(string verifier, byte[] deviceSecret, CancellationToken cancellationToken);

    Task logoutZAsync(CancellationToken cancellationToken);

    Task<LoginResult> loginZAsync(LoginRequest loginRequest, CancellationToken cancellationToken);

    Task<SecurityCenterResult> issueTokenForAccountMigrationSettingsAsync(bool enforce, CancellationToken cancellationToken);

    Task<SecurityCenterResult> issueTokenForAccountMigrationAsync(string migrationSessionId, CancellationToken cancellationToken);

    Task<string> verifyQrcodeWithE2EEAsync(string verifier, string pinCode, ErrorCode errorCode, E2EEPublicKey publicKey, byte[] encryptedKeyChain, byte[] hashKeyChain, CancellationToken cancellationToken);
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task<string> normalizePhoneNumberAsync(string countryCode, string phoneNumber, string countryCodeHint, CancellationToken cancellationToken)
    {
    ...
    public async Task respondE2EELoginRequestAsync(string verifier, E2EEPublicKey publicKey, byte[] encryptedKeyChain, byte[] hashKeyChain, ErrorCode errorCode, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> confirmE2EELoginAsync(string verifier, byte[] deviceSecret, CancellationToken cancellationToken)
    {
    ...
    public async Task logoutZAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<LoginResult> loginZAsync(LoginRequest loginRequest, CancellationToken cancellationToken)
    {
    ...
    public async Task<SecurityCenterResult> issueTokenForAccountMigrationSettingsAsync(bool enforce, CancellationToken cancellationToken)
    {
    ...
    public async Task<SecurityCenterResult> issueTokenForAccountMigrationAsync(string migrationSessionId, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> verifyQrcodeWithE2EEAsync(string verifier, string pinCode, ErrorCode errorCode, E2EEPublicKey publicKey, byte[] encryptedKeyChain, byte[] hashKeyChain, CancellationToken cancellationToken)
    {
  ...
  public partial class loginZArgs : TBase
  {
    ...
    public override string ToString()
    {
      ...
      if (LoginRequest != null && __isset.loginRequest)
      {
        ...
        sb.Append(LoginRequest== null ? "<null>" : LoginRequest.ToString());
      }
      sb.Append(")");
      return sb.ToString();
    }
