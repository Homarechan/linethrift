...
public partial class ShopService
{
  ...
  {
    Task buyCoinProductAsync(PaymentReservation paymentReservation, CancellationToken cancellationToken);

    Task buyFreeProductAsync(string receiverMid, string productId, int messageTemplate, string language, string country, long packageId, CancellationToken cancellationToken);

    Task buyMustbuyProductAsync(string receiverMid, string productId, int messageTemplate, string language, string country, long packageId, string serialNumber, CancellationToken cancellationToken);

    Task checkCanReceivePresentAsync(string recipientMid, long packageId, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getActivePurchasesAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductSimpleList> getActivePurchaseVersionsAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<List<CoinProductItem>> getCoinProductsAsync(PaymentType appStoreCode, string country, string language, CancellationToken cancellationToken);

    Task<List<CoinProductItem>> getCoinProductsByPgCodeAsync(PaymentType appStoreCode, PaymentPgType pgCode, string country, string language, CancellationToken cancellationToken);

    Task<CoinHistoryResult> getCoinPurchaseHistoryAsync(CoinHistoryCondition request, CancellationToken cancellationToken);

    Task<CoinHistoryResult> getCoinUseAndRefundHistoryAsync(CoinHistoryCondition request, CancellationToken cancellationToken);

    Task<ProductList> getDownloadsAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getEventPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getNewlyReleasedPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getPopularPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getPresentsReceivedAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getPresentsSentAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<Product> getProductAsync(long packageID, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getProductListAsync(List<string> productIdList, string language, string country, CancellationToken cancellationToken);

    Task<ProductList> getProductListWithCarrierAsync(List<string> productIdList, string language, string country, string carrierCode, CancellationToken cancellationToken);

    Task<Product> getProductWithCarrierAsync(long packageID, string language, string country, string carrierCode, CancellationToken cancellationToken);

    Task<ProductList> getPurchaseHistoryAsync(long start, int size, string language, string country, CancellationToken cancellationToken);

    Task<Coin> getTotalBalanceAsync(PaymentType appStoreCode, CancellationToken cancellationToken);

    Task<long> notifyDownloadedAsync(long packageId, string language, CancellationToken cancellationToken);

    Task<PaymentReservationResult> reserveCoinPurchaseAsync(CoinPurchaseReservation request, CancellationToken cancellationToken);

    Task<PaymentReservationResult> reservePaymentAsync(PaymentReservation paymentReservation, CancellationToken cancellationToken);
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task buyCoinProductAsync(PaymentReservation paymentReservation, CancellationToken cancellationToken)
    {
    ...
    public async Task buyFreeProductAsync(string receiverMid, string productId, int messageTemplate, string language, string country, long packageId, CancellationToken cancellationToken)
    {
    ...
    public async Task buyMustbuyProductAsync(string receiverMid, string productId, int messageTemplate, string language, string country, long packageId, string serialNumber, CancellationToken cancellationToken)
    {
    ...
    public async Task checkCanReceivePresentAsync(string recipientMid, long packageId, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getActivePurchasesAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductSimpleList> getActivePurchaseVersionsAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<CoinProductItem>> getCoinProductsAsync(PaymentType appStoreCode, string country, string language, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<CoinProductItem>> getCoinProductsByPgCodeAsync(PaymentType appStoreCode, PaymentPgType pgCode, string country, string language, CancellationToken cancellationToken)
    {
    ...
    public async Task<CoinHistoryResult> getCoinPurchaseHistoryAsync(CoinHistoryCondition request, CancellationToken cancellationToken)
    {
    ...
    public async Task<CoinHistoryResult> getCoinUseAndRefundHistoryAsync(CoinHistoryCondition request, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getDownloadsAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getEventPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getNewlyReleasedPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getPopularPackagesAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getPresentsReceivedAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getPresentsSentAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<Product> getProductAsync(long packageID, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getProductListAsync(List<string> productIdList, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getProductListWithCarrierAsync(List<string> productIdList, string language, string country, string carrierCode, CancellationToken cancellationToken)
    {
    ...
    public async Task<Product> getProductWithCarrierAsync(long packageID, string language, string country, string carrierCode, CancellationToken cancellationToken)
    {
    ...
    public async Task<ProductList> getPurchaseHistoryAsync(long start, int size, string language, string country, CancellationToken cancellationToken)
    {
    ...
    public async Task<Coin> getTotalBalanceAsync(PaymentType appStoreCode, CancellationToken cancellationToken)
    {
    ...
    public async Task<long> notifyDownloadedAsync(long packageId, string language, CancellationToken cancellationToken)
    {
    ...
    public async Task<PaymentReservationResult> reserveCoinPurchaseAsync(CoinPurchaseReservation request, CancellationToken cancellationToken)
    {
    ...
    public async Task<PaymentReservationResult> reservePaymentAsync(PaymentReservation paymentReservation, CancellationToken cancellationToken)
    {
