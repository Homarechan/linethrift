...
public partial class BuddyManagementService
{
  ...
  {
    Task addBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken);

    Task addBuddyMembersAsync(string requestId, List<string> userMids, CancellationToken cancellationToken);

    Task blockBuddyMemberAsync(string requestId, string mid, CancellationToken cancellationToken);

    Task<List<SendBuddyMessageResult>> commitSendMessagesToAllAsync(List<string> requestIdList, CancellationToken cancellationToken);

    Task<List<SendBuddyMessageResult>> commitSendMessagesToMidsAsync(List<string> requestIdList, List<string> mids, CancellationToken cancellationToken);

    Task<bool> containsBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken);

    Task<byte[]> downloadMessageContentAsync(string requestId, string messageId, CancellationToken cancellationToken);

    Task<byte[]> downloadMessageContentPreviewAsync(string requestId, string messageId, CancellationToken cancellationToken);

    Task<byte[]> downloadProfileImageAsync(string requestId, CancellationToken cancellationToken);

    Task<byte[]> downloadProfileImagePreviewAsync(string requestId, CancellationToken cancellationToken);

    Task<long> getActiveMemberCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<List<string>> getActiveMemberMidsByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<List<string>> getAllBuddyMembersAsync(CancellationToken cancellationToken);

    Task<List<string>> getBlockedBuddyMembersAsync(CancellationToken cancellationToken);

    Task<long> getBlockerCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<BuddyDetail> getBuddyDetailByMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<BuddyProfile> getBuddyProfileAsync(CancellationToken cancellationToken);

    Task<Ticket> getContactTicketAsync(CancellationToken cancellationToken);

    Task<long> getMemberCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> getSendBuddyMessageResultAsync(string sendBuddyMessageRequestId, CancellationToken cancellationToken);

    Task<SetBuddyOnAirResult> getSetBuddyOnAirResultAsync(string setBuddyOnAirRequestId, CancellationToken cancellationToken);

    Task<UpdateBuddyProfileResult> getUpdateBuddyProfileResultAsync(string updateBuddyProfileRequestId, CancellationToken cancellationToken);

    Task<bool> isBuddyOnAirByMidAsync(string buddyMid, CancellationToken cancellationToken);

    Task<string> linkAndSendBuddyContentMessageToAllAsyncAsync(string requestId, Message msg, string sourceContentId, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> linkAndSendBuddyContentMessageToMidsAsync(string requestId, Message msg, string sourceContentId, List<string> mids, CancellationToken cancellationToken);

    Task notifyBuddyBlockedAsync(string buddyMid, string blockerMid, CancellationToken cancellationToken);

    Task notifyBuddyUnblockedAsync(string buddyMid, string blockerMid, CancellationToken cancellationToken);

    Task<string> registerBuddyAsync(string buddyId, string searchId, string displayName, string statusMeessage, byte[] picture, Dictionary<string, string> settings, CancellationToken cancellationToken);

    Task<string> registerBuddyAdminAsync(string buddyId, string searchId, string displayName, string statusMessage, byte[] picture, CancellationToken cancellationToken);

    Task<string> reissueContactTicketAsync(long expirationTime, int maxUseCount, CancellationToken cancellationToken);

    Task removeBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken);

    Task removeBuddyMembersAsync(string requestId, List<string> userMids, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> sendBuddyContentMessageToAllAsync(string requestId, Message msg, byte[] content, CancellationToken cancellationToken);

    Task<string> sendBuddyContentMessageToAllAsyncAsync(string requestId, Message msg, byte[] content, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> sendBuddyContentMessageToMidsAsync(string requestId, Message msg, byte[] content, List<string> mids, CancellationToken cancellationToken);

    Task<string> sendBuddyContentMessageToMidsAsyncAsync(string requestId, Message msg, byte[] content, List<string> mids, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> sendBuddyMessageToAllAsync(string requestId, Message msg, CancellationToken cancellationToken);

    Task<string> sendBuddyMessageToAllAsyncAsync(string requestId, Message msg, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> sendBuddyMessageToMidsAsync(string requestId, Message msg, List<string> mids, CancellationToken cancellationToken);

    Task<string> sendBuddyMessageToMidsAsyncAsync(string requestId, Message msg, List<string> mids, CancellationToken cancellationToken);

    Task sendIndividualEventToAllAsyncAsync(string requestId, string buddyMid, NotificationStatus notificationStatus, CancellationToken cancellationToken);

    Task<SetBuddyOnAirResult> setBuddyOnAirAsync(string requestId, bool onAir, CancellationToken cancellationToken);

    Task<string> setBuddyOnAirAsyncAsync(string requestId, bool onAir, CancellationToken cancellationToken);

    Task<SendBuddyMessageResult> storeMessageAsync(string requestId, BuddyMessageRequest messageRequest, CancellationToken cancellationToken);

    Task unblockBuddyMemberAsync(string requestId, string mid, CancellationToken cancellationToken);

    Task unregisterBuddyAsync(string requestId, CancellationToken cancellationToken);

    Task unregisterBuddyAdminAsync(string requestId, CancellationToken cancellationToken);

    Task updateBuddyAdminProfileAttributeAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken);

    Task updateBuddyAdminProfileImageAsync(string requestId, byte[] picture, CancellationToken cancellationToken);

    Task<UpdateBuddyProfileResult> updateBuddyProfileAttributesAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken);

    Task<string> updateBuddyProfileAttributesAsyncAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken);

    Task<UpdateBuddyProfileResult> updateBuddyProfileImageAsync(string requestId, byte[] image, CancellationToken cancellationToken);

    Task<string> updateBuddyProfileImageAsyncAsync(string requestId, byte[] image, CancellationToken cancellationToken);

    Task updateBuddySearchIdAsync(string requestId, string searchId, CancellationToken cancellationToken);

    Task updateBuddySettingsAsync(Dictionary<string, string> settings, CancellationToken cancellationToken);

    Task<string> uploadBuddyContentAsync(ContentType contentType, byte[] content, CancellationToken cancellationToken);
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task addBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken)
    {
    ...
    public async Task addBuddyMembersAsync(string requestId, List<string> userMids, CancellationToken cancellationToken)
    {
    ...
    public async Task blockBuddyMemberAsync(string requestId, string mid, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<SendBuddyMessageResult>> commitSendMessagesToAllAsync(List<string> requestIdList, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<SendBuddyMessageResult>> commitSendMessagesToMidsAsync(List<string> requestIdList, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task<bool> containsBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<byte[]> downloadMessageContentAsync(string requestId, string messageId, CancellationToken cancellationToken)
    {
    ...
    public async Task<byte[]> downloadMessageContentPreviewAsync(string requestId, string messageId, CancellationToken cancellationToken)
    {
    ...
    public async Task<byte[]> downloadProfileImageAsync(string requestId, CancellationToken cancellationToken)
    {
    ...
    public async Task<byte[]> downloadProfileImagePreviewAsync(string requestId, CancellationToken cancellationToken)
    {
    ...
    public async Task<long> getActiveMemberCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<string>> getActiveMemberMidsByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<string>> getAllBuddyMembersAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<List<string>> getBlockedBuddyMembersAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<long> getBlockerCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<BuddyDetail> getBuddyDetailByMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<BuddyProfile> getBuddyProfileAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<Ticket> getContactTicketAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<long> getMemberCountByBuddyMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> getSendBuddyMessageResultAsync(string sendBuddyMessageRequestId, CancellationToken cancellationToken)
    {
    ...
    public async Task<SetBuddyOnAirResult> getSetBuddyOnAirResultAsync(string setBuddyOnAirRequestId, CancellationToken cancellationToken)
    {
    ...
    public async Task<UpdateBuddyProfileResult> getUpdateBuddyProfileResultAsync(string updateBuddyProfileRequestId, CancellationToken cancellationToken)
    {
    ...
    public async Task<bool> isBuddyOnAirByMidAsync(string buddyMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> linkAndSendBuddyContentMessageToAllAsyncAsync(string requestId, Message msg, string sourceContentId, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> linkAndSendBuddyContentMessageToMidsAsync(string requestId, Message msg, string sourceContentId, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task notifyBuddyBlockedAsync(string buddyMid, string blockerMid, CancellationToken cancellationToken)
    {
    ...
    public async Task notifyBuddyUnblockedAsync(string buddyMid, string blockerMid, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> registerBuddyAsync(string buddyId, string searchId, string displayName, string statusMeessage, byte[] picture, Dictionary<string, string> settings, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> registerBuddyAdminAsync(string buddyId, string searchId, string displayName, string statusMessage, byte[] picture, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> reissueContactTicketAsync(long expirationTime, int maxUseCount, CancellationToken cancellationToken)
    {
    ...
    public async Task removeBuddyMemberAsync(string requestId, string userMid, CancellationToken cancellationToken)
    {
    ...
    public async Task removeBuddyMembersAsync(string requestId, List<string> userMids, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> sendBuddyContentMessageToAllAsync(string requestId, Message msg, byte[] content, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> sendBuddyContentMessageToAllAsyncAsync(string requestId, Message msg, byte[] content, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> sendBuddyContentMessageToMidsAsync(string requestId, Message msg, byte[] content, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> sendBuddyContentMessageToMidsAsyncAsync(string requestId, Message msg, byte[] content, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> sendBuddyMessageToAllAsync(string requestId, Message msg, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> sendBuddyMessageToAllAsyncAsync(string requestId, Message msg, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> sendBuddyMessageToMidsAsync(string requestId, Message msg, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> sendBuddyMessageToMidsAsyncAsync(string requestId, Message msg, List<string> mids, CancellationToken cancellationToken)
    {
    ...
    public async Task sendIndividualEventToAllAsyncAsync(string requestId, string buddyMid, NotificationStatus notificationStatus, CancellationToken cancellationToken)
    {
    ...
    public async Task<SetBuddyOnAirResult> setBuddyOnAirAsync(string requestId, bool onAir, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> setBuddyOnAirAsyncAsync(string requestId, bool onAir, CancellationToken cancellationToken)
    {
    ...
    public async Task<SendBuddyMessageResult> storeMessageAsync(string requestId, BuddyMessageRequest messageRequest, CancellationToken cancellationToken)
    {
    ...
    public async Task unblockBuddyMemberAsync(string requestId, string mid, CancellationToken cancellationToken)
    {
    ...
    public async Task unregisterBuddyAsync(string requestId, CancellationToken cancellationToken)
    {
    ...
    public async Task unregisterBuddyAdminAsync(string requestId, CancellationToken cancellationToken)
    {
    ...
    public async Task updateBuddyAdminProfileAttributeAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken)
    {
    ...
    public async Task updateBuddyAdminProfileImageAsync(string requestId, byte[] picture, CancellationToken cancellationToken)
    {
    ...
    public async Task<UpdateBuddyProfileResult> updateBuddyProfileAttributesAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> updateBuddyProfileAttributesAsyncAsync(string requestId, Dictionary<string, string> attributes, CancellationToken cancellationToken)
    {
    ...
    public async Task<UpdateBuddyProfileResult> updateBuddyProfileImageAsync(string requestId, byte[] image, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> updateBuddyProfileImageAsyncAsync(string requestId, byte[] image, CancellationToken cancellationToken)
    {
    ...
    public async Task updateBuddySearchIdAsync(string requestId, string searchId, CancellationToken cancellationToken)
    {
    ...
    public async Task updateBuddySettingsAsync(Dictionary<string, string> settings, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> uploadBuddyContentAsync(ContentType contentType, byte[] content, CancellationToken cancellationToken)
    {
