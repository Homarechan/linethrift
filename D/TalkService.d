...
interface TalkService {
  ...
  enum methodMeta = [
    TMethodMeta(`searchCollection`, 
      [TParamMeta(`query`, 1), TParamMeta(`param`, 2)],
    ...
    TMethodMeta(`getE2EEPublicKey`, 
      [TParamMeta(`mid`, 2), TParamMeta(`version`, 3), TParamMeta(`keyId`, 4)],
      [TExceptionMeta(`e`, 1, `TalkException`)]
    ),
    ...
    TMethodMeta(`updateProfileAttributes`, 
      [TParamMeta(`reqSeq`, 1), TParamMeta(`request`, 2)]
    ),
