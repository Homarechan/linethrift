...
class notifyEmailConfirmationResult_args(object):
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i1121 in range(_size1117):
                        _key1122 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1123 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.parameterMap[_key1122] = _val1123
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            ...
            for kiter1124, viter1125 in self.parameterMap.items():
                oprot.writeString(kiter1124.encode('utf-8') if sys.version_info[0] == 2 else kiter1124)
                oprot.writeString(viter1125.encode('utf-8') if sys.version_info[0] == 2 else viter1125)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
