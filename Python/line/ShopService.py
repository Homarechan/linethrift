...
class getProductList_args(object):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1494 in range(_size1490):
                        _elem1495 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.productIdList.append(_elem1495)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            ...
            for iter1496 in self.productIdList:
                oprot.writeString(iter1496.encode('utf-8') if sys.version_info[0] == 2 else iter1496)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.language is not None:
            oprot.writeFieldBegin('language', TType.STRING, 3)
...
class getProductListWithCarrier_args(object):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1501 in range(_size1497):
                        _elem1502 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.productIdList.append(_elem1502)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            oprot.writeFieldBegin('productIdList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.productIdList))
            for iter1503 in self.productIdList:
                oprot.writeString(iter1503.encode('utf-8') if sys.version_info[0] == 2 else iter1503)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.language is not None:
            oprot.writeFieldBegin('language', TType.STRING, 3)
