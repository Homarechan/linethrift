            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1294 in range(_size1290):
                        _elem1295 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1296 in self.success:
                oprot.writeString(iter1296.encode('utf-8') if sys.version_info[0] == 2 else iter1296)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getNewlyReleasedBuddyIds_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    self.success = {}
                    (_ktype1298, _vtype1299, _size1297) = iprot.readMapBegin()
                    for _i1301 in range(_size1297):
                        _key1302 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1303 = iprot.readI64()
                        self.success[_key1302] = _val1303
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter1304, viter1305 in self.success.items():
                oprot.writeString(kiter1304.encode('utf-8') if sys.version_info[0] == 2 else kiter1304)
                oprot.writeI64(viter1305)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
