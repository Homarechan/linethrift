            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1324 in range(_size1320):
                        _elem1325 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1359 in range(_size1355):
                        _elem1360 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1361 in self.success:
                oprot.writeString(iter1361.encode('utf-8') if sys.version_info[0] == 2 else iter1361)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1366 in range(_size1362):
                        _elem1367 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1368 in self.success:
                oprot.writeString(iter1368.encode('utf-8') if sys.version_info[0] == 2 else iter1368)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getGroupsForChannel_args(object):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1373 in range(_size1369):
                        _elem1374 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.groupIds.append(_elem1374)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.groupIds is not None:
            ...
            for iter1375 in self.groupIds:
                oprot.writeString(iter1375.encode('utf-8') if sys.version_info[0] == 2 else iter1375)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getSimpleChannelContacts_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1394 in range(_size1390):
                        _elem1395 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem1395)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.ids))
            for iter1396 in self.ids:
                oprot.writeString(iter1396.encode('utf-8') if sys.version_info[0] == 2 else iter1396)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1401 in range(_size1397):
                        _elem1402 = SimpleChannelContact()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i1408 in range(_size1404):
                        _key1409 = iprot.readI32()
                        _val1410 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter1411, viter1412 in self.success.items():
                oprot.writeI32(kiter1411)
                oprot.writeString(viter1412.encode('utf-8') if sys.version_info[0] == 2 else viter1412)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1417 in range(_size1413):
                        _elem1418 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1419 in self.success:
                oprot.writeString(iter1419.encode('utf-8') if sys.version_info[0] == 2 else iter1419)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
