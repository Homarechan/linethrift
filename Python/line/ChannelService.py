            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1424 in range(_size1420):
                        _elem1425 = ChannelNotificationSetting()
...
class getFriendChannelMatrices_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1431 in range(_size1427):
                        _elem1432 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.channelIds.append(_elem1432)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1433 in self.channelIds:
                oprot.writeString(iter1433.encode('utf-8') if sys.version_info[0] == 2 else iter1433)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class issueRequestTokenWithAuthScheme_args(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1438 in range(_size1434):
                        _elem1439 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.authScheme.append(_elem1439)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter1440 in self.authScheme:
                oprot.writeString(iter1440.encode('utf-8') if sys.version_info[0] == 2 else iter1440)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class getUpdatedChannelIds_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1445 in range(_size1441):
                        _elem1446 = ChannelIdWithLastUpdated()
                        _elem1446.read(iprot)
                        self.channelIds.append(_elem1446)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1447 in self.channelIds:
...
class updateChannelNotificationSetting_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1459 in range(_size1455):
                        _elem1460 = ChannelNotificationSetting()
                        _elem1460.read(iprot)
                        self.setting.append(_elem1460)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.setting is not None:
            ...
            for iter1461 in self.setting:
                iter1461.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
