...
class MessageService_fetchMessageOperations_args {
 public:
  ...
  virtual ~MessageService_fetchMessageOperations_args() throw();
...
class MessageService_fetchMessageOperations_pargs {
 public:
  ...
  virtual ~MessageService_fetchMessageOperations_pargs() throw();
...
class MessageService_fetchMessageOperations_result {
 public:
  ...
  virtual ~MessageService_fetchMessageOperations_result() throw();
...
class MessageService_fetchMessageOperations_presult {
 public:
  ...
  virtual ~MessageService_fetchMessageOperations_presult() throw();
  MessageOperations* success;
  TalkException e;
...
class MessageService_getLastReadMessageIds_args {
 public:
  ...
  virtual ~MessageService_getLastReadMessageIds_args() throw();
  std::string chatId;
...
class MessageService_getLastReadMessageIds_pargs {
 public:
  ...
  virtual ~MessageService_getLastReadMessageIds_pargs() throw();
...
class MessageService_getLastReadMessageIds_result {
 public:
  ...
  virtual ~MessageService_getLastReadMessageIds_result() throw();
...
class MessageService_getLastReadMessageIds_presult {
 public:
  ...
  virtual ~MessageService_getLastReadMessageIds_presult() throw();
  LastReadMessageIds* success;
  TalkException e;
...
class MessageService_multiGetLastReadMessageIds_args {
 public:
  ...
  virtual ~MessageService_multiGetLastReadMessageIds_args() throw();
...
class MessageService_multiGetLastReadMessageIds_pargs {
 public:
  ...
  virtual ~MessageService_multiGetLastReadMessageIds_pargs() throw();
...
class MessageService_multiGetLastReadMessageIds_result {
 public:
  ...
  virtual ~MessageService_multiGetLastReadMessageIds_result() throw();
...
class MessageService_multiGetLastReadMessageIds_presult {
 public:
  ...
  virtual ~MessageService_multiGetLastReadMessageIds_presult() throw();
  std::vector<LastReadMessageIds> * success;
  TalkException e;
