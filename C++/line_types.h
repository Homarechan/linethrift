...
extern const std::map<int, const char*> _PType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _PromotionType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _PMType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _SRType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _TRType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _SubType_VALUES_TO_NAMES;

std::ostream& operator<<(std::ostream& out, const SubType::type& val);

struct IdentityResponseType {
  enum type {
    UNKNOWN = 0,
    SUCCESS = 1,
...
extern const std::map<int, const char*> _IdentityResponseType_VALUES_TO_NAMES;

std::ostream& operator<<(std::ostream& out, const IdentityResponseType::type& val);

struct AvailableChatTypes {
  enum type {
    PERSONAL = 1,
    ROOM = 2,
    GROUP = 3,
...
extern const std::map<int, const char*> _AvailableChatTypes_VALUES_TO_NAMES;

std::ostream& operator<<(std::ostream& out, const AvailableChatTypes::type& val);

struct ChatAppExceptionCode {
  enum type {
    INVALID_REQUEST = 1,
    UNAUTHORIZED = 2,
    SERVER_ERROR = 100
...
extern const std::map<int, const char*> _ChatAppExceptionCode_VALUES_TO_NAMES;

std::ostream& operator<<(std::ostream& out, const ChatAppExceptionCode::type& val);

struct ChatappCategory {
  enum type {
    PRIORITY = 2,
    REGULAR = 1,
    MORE = 3
...
extern const std::map<int, const char*> _ChatappCategory_VALUES_TO_NAMES;
...
typedef struct _Chatapp__isset {
  _Chatapp__isset() : chatappId(false), name(false), icon(false), url(false), availableChatTypes(false) {}
  bool chatappId :1;
  bool name :1;
  bool icon :1;
  bool url :1;
  bool availableChatTypes :1;
} _Chatapp__isset;

class Chatapp : public virtual ::apache::thrift::TBase {
 public:

  Chatapp(const Chatapp&);
  Chatapp& operator=(const Chatapp&);
  Chatapp() : chatappId(), name(), icon(), url() {
  }

  virtual ~Chatapp() throw();
  std::string chatappId;
  std::string name;
  std::string icon;
  std::string url;
  std::vector<AvailableChatTypes::type>  availableChatTypes;

  _Chatapp__isset __isset;

  void __set_chatappId(const std::string& val);
  ...
  void __set_availableChatTypes(const std::vector<AvailableChatTypes::type> & val);

  bool operator == (const Chatapp & rhs) const
  {
    if (!(chatappId == rhs.chatappId))
      return false;
    if (!(name == rhs.name))
      return false;
    if (!(icon == rhs.icon))
    ...
    if (!(url == rhs.url))
      return false;
    if (!(availableChatTypes == rhs.availableChatTypes))
      return false;
    return true;
  }
  bool operator != (const Chatapp &rhs) const {
  ...
  bool operator < (const Chatapp & ) const;
...
typedef struct _MyChatapp__isset {
  _MyChatapp__isset() : app(false), category(false), priority(false) {}
  bool app :1;
  bool category :1;
  bool priority :1;
} _MyChatapp__isset;

class MyChatapp : public virtual ::apache::thrift::TBase {
 public:

  MyChatapp(const MyChatapp&);
  MyChatapp& operator=(const MyChatapp&);
  MyChatapp() : category((ChatappCategory::type)0), priority(0) {
  }

  virtual ~MyChatapp() throw();
  Chatapp app;
  ChatappCategory::type category;
  int64_t priority;

  _MyChatapp__isset __isset;

  void __set_app(const Chatapp& val);

  void __set_category(const ChatappCategory::type val);

  void __set_priority(const int64_t val);

  bool operator == (const MyChatapp & rhs) const
  {
    if (!(app == rhs.app))
      return false;
  ...
  bool operator < (const MyChatapp & ) const;
...
typedef struct _GetMyChatappsResponse__isset {
  _GetMyChatappsResponse__isset() : apps(false), continuationToken(false) {}
  bool apps :1;
  bool continuationToken :1;
} _GetMyChatappsResponse__isset;

class GetMyChatappsResponse : public virtual ::apache::thrift::TBase {
 public:

  GetMyChatappsResponse(const GetMyChatappsResponse&);
  GetMyChatappsResponse& operator=(const GetMyChatappsResponse&);
  GetMyChatappsResponse() : continuationToken() {
  }

  virtual ~GetMyChatappsResponse() throw();
  std::vector<MyChatapp>  apps;
  std::string continuationToken;

  _GetMyChatappsResponse__isset __isset;

  void __set_apps(const std::vector<MyChatapp> & val);

  void __set_continuationToken(const std::string& val);

  bool operator == (const GetMyChatappsResponse & rhs) const
  {
    if (!(apps == rhs.apps))
      return false;
  ...
  bool operator < (const GetMyChatappsResponse & ) const;
...
typedef struct _GetMyChatappsRequest__isset {
  _GetMyChatappsRequest__isset() : language(false), continuationToken(false) {}
  bool language :1;
  bool continuationToken :1;
} _GetMyChatappsRequest__isset;

class GetMyChatappsRequest : public virtual ::apache::thrift::TBase {
 public:

  GetMyChatappsRequest(const GetMyChatappsRequest&);
  GetMyChatappsRequest& operator=(const GetMyChatappsRequest&);
  GetMyChatappsRequest() : language(), continuationToken() {
  }

  virtual ~GetMyChatappsRequest() throw();
  std::string language;
  std::string continuationToken;

  _GetMyChatappsRequest__isset __isset;

  void __set_language(const std::string& val);

  void __set_continuationToken(const std::string& val);

  bool operator == (const GetMyChatappsRequest & rhs) const
  {
  ...
  bool operator < (const GetMyChatappsRequest & ) const;
...
typedef struct _GetChatappRequest__isset {
  _GetChatappRequest__isset() : chatappId(false), language(false) {}
  bool chatappId :1;
  bool language :1;
} _GetChatappRequest__isset;

class GetChatappRequest : public virtual ::apache::thrift::TBase {
 public:

  GetChatappRequest(const GetChatappRequest&);
  GetChatappRequest& operator=(const GetChatappRequest&);
  GetChatappRequest() : chatappId(), language() {
  }

  virtual ~GetChatappRequest() throw();
  std::string chatappId;
  std::string language;

  _GetChatappRequest__isset __isset;

  void __set_chatappId(const std::string& val);

  void __set_language(const std::string& val);

  bool operator == (const GetChatappRequest & rhs) const
  {
    if (!(chatappId == rhs.chatappId))
      return false;
    if (!(language == rhs.language))
  ...
  bool operator < (const GetChatappRequest & ) const;
...
typedef struct _ChatappException__isset {
  _ChatappException__isset() : code(false), reason(false) {}
  bool code :1;
  bool reason :1;
} _ChatappException__isset;

class ChatappException : public virtual ::apache::thrift::TBase {
 public:

  ChatappException(const ChatappException&);
  ChatappException& operator=(const ChatappException&);
  ChatappException() : code((ChatAppExceptionCode::type)0), reason() {
  }

  virtual ~ChatappException() throw();
  ChatAppExceptionCode::type code;
  std::string reason;

  _ChatappException__isset __isset;

  void __set_code(const ChatAppExceptionCode::type val);

  void __set_reason(const std::string& val);

  bool operator == (const ChatappException & rhs) const
  {
    if (!(code == rhs.code))
      return false;
  ...
  bool operator < (const ChatappException & ) const;
...
typedef struct _GetChatappResponse__isset {
  _GetChatappResponse__isset() : app(false) {}
  bool app :1;
} _GetChatappResponse__isset;

class GetChatappResponse : public virtual ::apache::thrift::TBase {
 public:

  GetChatappResponse(const GetChatappResponse&);
  GetChatappResponse& operator=(const GetChatappResponse&);
  GetChatappResponse() {
  }

  virtual ~GetChatappResponse() throw();
  Chatapp app;

  _GetChatappResponse__isset __isset;

  void __set_app(const Chatapp& val);

  bool operator == (const GetChatappResponse & rhs) const
  {
    if (!(app == rhs.app))
      return false;
    return true;
  ...
  bool operator < (const GetChatappResponse & ) const;
...
typedef struct _WebLoginResponse__isset {
  _WebLoginResponse__isset() : returnUrl(false) {}
  bool returnUrl :1;
} _WebLoginResponse__isset;

class WebLoginResponse : public virtual ::apache::thrift::TBase {
 public:

  WebLoginResponse(const WebLoginResponse&);
  WebLoginResponse& operator=(const WebLoginResponse&);
  WebLoginResponse() : returnUrl() {
  }

  virtual ~WebLoginResponse() throw();
  std::string returnUrl;

  _WebLoginResponse__isset __isset;

  void __set_returnUrl(const std::string& val);

  bool operator == (const WebLoginResponse & rhs) const
  {
  ...
  bool operator < (const WebLoginResponse & ) const;
...
typedef struct _WebLoginRequest__isset {
  _WebLoginRequest__isset() : hookedFullUrl(false), sessionString(false), fromIAB(false) {}
  bool hookedFullUrl :1;
  bool sessionString :1;
  bool fromIAB :1;
} _WebLoginRequest__isset;

class WebLoginRequest : public virtual ::apache::thrift::TBase {
 public:

  WebLoginRequest(const WebLoginRequest&);
  WebLoginRequest& operator=(const WebLoginRequest&);
  WebLoginRequest() : hookedFullUrl(), sessionString(), fromIAB(0) {
  }

  virtual ~WebLoginRequest() throw();
  std::string hookedFullUrl;
  std::string sessionString;
  bool fromIAB;

  _WebLoginRequest__isset __isset;

  void __set_hookedFullUrl(const std::string& val);

  void __set_sessionString(const std::string& val);

  void __set_fromIAB(const bool val);

  bool operator == (const WebLoginRequest & rhs) const
  {
    if (!(hookedFullUrl == rhs.hookedFullUrl))
      return false;
    if (!(sessionString == rhs.sessionString))
      return false;
    if (!(fromIAB == rhs.fromIAB))
      return false;
    return true;
  }
  bool operator != (const WebLoginRequest &rhs) const {
  ...
  bool operator < (const WebLoginRequest & ) const;
...
typedef struct _TestCallRoute__isset {
  _TestCallRoute__isset() : token(false), voipServer(false) {}
  bool token :1;
  bool voipServer :1;
} _TestCallRoute__isset;

class TestCallRoute : public virtual ::apache::thrift::TBase {
 public:

  TestCallRoute(const TestCallRoute&);
  TestCallRoute& operator=(const TestCallRoute&);
  TestCallRoute() : token() {
  }

  virtual ~TestCallRoute() throw();
  std::string token;
  CallHost voipServer;

  _TestCallRoute__isset __isset;

  void __set_token(const std::string& val);

  void __set_voipServer(const CallHost& val);

  bool operator == (const TestCallRoute & rhs) const
  {
    if (!(token == rhs.token))
      return false;
    if (!(voipServer == rhs.voipServer))
      return false;
    return true;
  }
  bool operator != (const TestCallRoute &rhs) const {
  ...
  bool operator < (const TestCallRoute & ) const;
...
typedef struct _ProfileContent__isset {
  _ProfileContent__isset() : value(false), meta(false) {}
  bool value :1;
  bool meta :1;
} _ProfileContent__isset;

class ProfileContent : public virtual ::apache::thrift::TBase {
 public:

  ProfileContent(const ProfileContent&);
  ProfileContent& operator=(const ProfileContent&);
  ProfileContent() : value() {
  }

  virtual ~ProfileContent() throw();
  std::string value;
  std::map<std::string, std::string>  meta;

  _ProfileContent__isset __isset;

  void __set_value(const std::string& val);

  void __set_meta(const std::map<std::string, std::string> & val);

  bool operator == (const ProfileContent & rhs) const
  {
    if (!(value == rhs.value))
      return false;
    if (!(meta == rhs.meta))
  ...
  bool operator < (const ProfileContent & ) const;
...
typedef struct _UpdateProfileAttributesRequest__isset {
  _UpdateProfileAttributesRequest__isset() : profileAttributes(false) {}
  bool profileAttributes :1;
} _UpdateProfileAttributesRequest__isset;

class UpdateProfileAttributesRequest : public virtual ::apache::thrift::TBase {
 public:

  UpdateProfileAttributesRequest(const UpdateProfileAttributesRequest&);
  UpdateProfileAttributesRequest& operator=(const UpdateProfileAttributesRequest&);
  UpdateProfileAttributesRequest() {
  }

  virtual ~UpdateProfileAttributesRequest() throw();
  std::map<ProfileAttribute::type, ProfileContent>  profileAttributes;

  _UpdateProfileAttributesRequest__isset __isset;

  void __set_profileAttributes(const std::map<ProfileAttribute::type, ProfileContent> & val);

  bool operator == (const UpdateProfileAttributesRequest & rhs) const
  {
    if (!(profileAttributes == rhs.profileAttributes))
      return false;
    return true;
  }
  bool operator != (const UpdateProfileAttributesRequest &rhs) const {
  ...
  bool operator < (const UpdateProfileAttributesRequest & ) const;
...
typedef struct _IdentityCredentialResponse__isset {
  _IdentityCredentialResponse__isset() : metaData(false), responseType(false), confirmationVerifier(false), timeoutInSeconds(false) {}
  bool metaData :1;
  bool responseType :1;
  bool confirmationVerifier :1;
  bool timeoutInSeconds :1;
} _IdentityCredentialResponse__isset;

class IdentityCredentialResponse : public virtual ::apache::thrift::TBase {
 public:

  IdentityCredentialResponse(const IdentityCredentialResponse&);
  IdentityCredentialResponse& operator=(const IdentityCredentialResponse&);
  IdentityCredentialResponse() : responseType((IdentityResponseType::type)0), confirmationVerifier(), timeoutInSeconds(0) {
  }

  virtual ~IdentityCredentialResponse() throw();
  std::map<std::string, std::string>  metaData;
  IdentityResponseType::type responseType;
  std::string confirmationVerifier;
  int64_t timeoutInSeconds;

  _IdentityCredentialResponse__isset __isset;

  void __set_metaData(const std::map<std::string, std::string> & val);

  void __set_responseType(const IdentityResponseType::type val);

  void __set_confirmationVerifier(const std::string& val);

  void __set_timeoutInSeconds(const int64_t val);

  bool operator == (const IdentityCredentialResponse & rhs) const
  {
    if (!(metaData == rhs.metaData))
      return false;
    if (!(responseType == rhs.responseType))
      return false;
    if (!(confirmationVerifier == rhs.confirmationVerifier))
      return false;
  ...
  bool operator < (const IdentityCredentialResponse & ) const;
...
typedef struct _IdentifierConfirmationRequest__isset {
  _IdentifierConfirmationRequest__isset() : metaData(false), forceRegistration(false), verificationCode(false) {}
  bool metaData :1;
  bool forceRegistration :1;
  bool verificationCode :1;
} _IdentifierConfirmationRequest__isset;

class IdentifierConfirmationRequest : public virtual ::apache::thrift::TBase {
 public:

  IdentifierConfirmationRequest(const IdentifierConfirmationRequest&);
  IdentifierConfirmationRequest& operator=(const IdentifierConfirmationRequest&);
  IdentifierConfirmationRequest() : forceRegistration(0), verificationCode() {
  }

  virtual ~IdentifierConfirmationRequest() throw();
  std::map<std::string, std::string>  metaData;
  bool forceRegistration;
  std::string verificationCode;

  _IdentifierConfirmationRequest__isset __isset;

  void __set_metaData(const std::map<std::string, std::string> & val);

  void __set_forceRegistration(const bool val);

  void __set_verificationCode(const std::string& val);

  bool operator == (const IdentifierConfirmationRequest & rhs) const
  {
    if (!(metaData == rhs.metaData))
      return false;
    if (!(forceRegistration == rhs.forceRegistration))
      return false;
    if (!(verificationCode == rhs.verificationCode))
      return false;
    return true;
  }
  bool operator != (const IdentifierConfirmationRequest &rhs) const {
  ...
  bool operator < (const IdentifierConfirmationRequest & ) const;
...
typedef struct _IdentityCredentialRequest__isset {
  _IdentityCredentialRequest__isset() : metaData(false), identityProvider(false), cipherKeyId(false), cipherText(false), confirmationRequest(false) {}
  bool metaData :1;
  bool identityProvider :1;
  bool cipherKeyId :1;
  bool cipherText :1;
  bool confirmationRequest :1;
} _IdentityCredentialRequest__isset;

class IdentityCredentialRequest : public virtual ::apache::thrift::TBase {
 public:

  IdentityCredentialRequest(const IdentityCredentialRequest&);
  IdentityCredentialRequest& operator=(const IdentityCredentialRequest&);
  IdentityCredentialRequest() : identityProvider((IdentityProvider::type)0), cipherKeyId(), cipherText() {
  }

  virtual ~IdentityCredentialRequest() throw();
  std::map<std::string, std::string>  metaData;
  IdentityProvider::type identityProvider;
  std::string cipherKeyId;
  std::string cipherText;
  IdentifierConfirmationRequest confirmationRequest;

  _IdentityCredentialRequest__isset __isset;

  void __set_metaData(const std::map<std::string, std::string> & val);

  void __set_identityProvider(const IdentityProvider::type val);

  void __set_cipherKeyId(const std::string& val);

  void __set_cipherText(const std::string& val);

  void __set_confirmationRequest(const IdentifierConfirmationRequest& val);

  bool operator == (const IdentityCredentialRequest & rhs) const
  {
    if (!(metaData == rhs.metaData))
      return false;
    if (!(identityProvider == rhs.identityProvider))
      return false;
    if (!(cipherKeyId == rhs.cipherKeyId))
      return false;
    if (!(cipherText == rhs.cipherText))
      return false;
    if (!(confirmationRequest == rhs.confirmationRequest))
      return false;
    return true;
  }
  bool operator != (const IdentityCredentialRequest &rhs) const {
  ...
  bool operator < (const IdentityCredentialRequest & ) const;
...
typedef struct _AuthSessionRequest__isset {
  _AuthSessionRequest__isset() : metaData(false) {}
  bool metaData :1;
} _AuthSessionRequest__isset;

class AuthSessionRequest : public virtual ::apache::thrift::TBase {
 public:

  AuthSessionRequest(const AuthSessionRequest&);
  AuthSessionRequest& operator=(const AuthSessionRequest&);
  AuthSessionRequest() {
  }

  virtual ~AuthSessionRequest() throw();
  std::map<std::string, std::string>  metaData;

  _AuthSessionRequest__isset __isset;

  void __set_metaData(const std::map<std::string, std::string> & val);

  bool operator == (const AuthSessionRequest & rhs) const
  {
    if (!(metaData == rhs.metaData))
      return false;
    return true;
  ...
  bool operator < (const AuthSessionRequest & ) const;
...
typedef struct _CategoryItem__isset {
  _CategoryItem__isset() : collection(false), cat(false), name(false) {}
  bool collection :1;
  bool cat :1;
  bool name :1;
} _CategoryItem__isset;

class CategoryItem : public virtual ::apache::thrift::TBase {
 public:

  CategoryItem(const CategoryItem&);
  CategoryItem& operator=(const CategoryItem&);
  CategoryItem() : collection(0), cat(0), name() {
  }

  virtual ~CategoryItem() throw();
  int32_t collection;
  int32_t cat;
  std::string name;

  _CategoryItem__isset __isset;

  void __set_collection(const int32_t val);

  void __set_cat(const int32_t val);

  void __set_name(const std::string& val);

  bool operator == (const CategoryItem & rhs) const
  {
  ...
  bool operator < (const CategoryItem & ) const;
...
typedef struct _PromotionBuddyInfo__isset {
  _PromotionBuddyInfo__isset() : buddyMid(false) {}
  bool buddyMid :1;
} _PromotionBuddyInfo__isset;

class PromotionBuddyInfo : public virtual ::apache::thrift::TBase {
 public:

  PromotionBuddyInfo(const PromotionBuddyInfo&);
  PromotionBuddyInfo& operator=(const PromotionBuddyInfo&);
  PromotionBuddyInfo() : buddyMid() {
  }

  virtual ~PromotionBuddyInfo() throw();
  std::string buddyMid;

  _PromotionBuddyInfo__isset __isset;

  void __set_buddyMid(const std::string& val);

  bool operator == (const PromotionBuddyInfo & rhs) const
  {
  ...
  bool operator < (const PromotionBuddyInfo & ) const;
...
typedef struct _PromotionInstallInfo__isset {
  _PromotionInstallInfo__isset() : downloadUrl(false), customUrlSchema(false) {}
  bool downloadUrl :1;
  bool customUrlSchema :1;
} _PromotionInstallInfo__isset;

class PromotionInstallInfo : public virtual ::apache::thrift::TBase {
 public:

  PromotionInstallInfo(const PromotionInstallInfo&);
  PromotionInstallInfo& operator=(const PromotionInstallInfo&);
  PromotionInstallInfo() : downloadUrl(), customUrlSchema() {
  }

  virtual ~PromotionInstallInfo() throw();
  std::string downloadUrl;
  std::string customUrlSchema;

  _PromotionInstallInfo__isset __isset;

  void __set_downloadUrl(const std::string& val);

  void __set_customUrlSchema(const std::string& val);

  bool operator == (const PromotionInstallInfo & rhs) const
  {
    if (!(downloadUrl == rhs.downloadUrl))
      return false;
    if (!(customUrlSchema == rhs.customUrlSchema))
      return false;
    return true;
  }
  bool operator != (const PromotionInstallInfo &rhs) const {
  ...
  bool operator < (const PromotionInstallInfo & ) const;
...
typedef struct _PromotionMissionInfo__isset {
  _PromotionMissionInfo__isset() : promotionMissionType(false), missionCompleted(false), downloadUrl(false), customUrlSchema(false) {}
  bool promotionMissionType :1;
  bool missionCompleted :1;
  bool downloadUrl :1;
  bool customUrlSchema :1;
} _PromotionMissionInfo__isset;

class PromotionMissionInfo : public virtual ::apache::thrift::TBase {
 public:

  PromotionMissionInfo(const PromotionMissionInfo&);
  PromotionMissionInfo& operator=(const PromotionMissionInfo&);
  PromotionMissionInfo() : promotionMissionType((PMType::type)0), missionCompleted(0), downloadUrl(), customUrlSchema() {
  }

  virtual ~PromotionMissionInfo() throw();
  PMType::type promotionMissionType;
  bool missionCompleted;
  std::string downloadUrl;
  std::string customUrlSchema;

  _PromotionMissionInfo__isset __isset;

  void __set_promotionMissionType(const PMType::type val);

  void __set_missionCompleted(const bool val);

  void __set_downloadUrl(const std::string& val);

  void __set_customUrlSchema(const std::string& val);

  bool operator == (const PromotionMissionInfo & rhs) const
  {
    if (!(promotionMissionType == rhs.promotionMissionType))
      return false;
    if (!(missionCompleted == rhs.missionCompleted))
      return false;
    if (!(downloadUrl == rhs.downloadUrl))
      return false;
    if (!(customUrlSchema == rhs.customUrlSchema))
  ...
  bool operator < (const PromotionMissionInfo & ) const;
...
typedef struct _PromotionDetail__isset {
  _PromotionDetail__isset() : promotionBuddyInfo(false), promotionInstallInfo(false), promotionMissionInfo(false) {}
  bool promotionBuddyInfo :1;
  bool promotionInstallInfo :1;
  bool promotionMissionInfo :1;
} _PromotionDetail__isset;

class PromotionDetail : public virtual ::apache::thrift::TBase {
 public:

  PromotionDetail(const PromotionDetail&);
  PromotionDetail& operator=(const PromotionDetail&);
  PromotionDetail() {
  }

  virtual ~PromotionDetail() throw();
  PromotionBuddyInfo promotionBuddyInfo;
  PromotionInstallInfo promotionInstallInfo;
  PromotionMissionInfo promotionMissionInfo;

  _PromotionDetail__isset __isset;

  void __set_promotionBuddyInfo(const PromotionBuddyInfo& val);

  void __set_promotionInstallInfo(const PromotionInstallInfo& val);

  void __set_promotionMissionInfo(const PromotionMissionInfo& val);

  bool operator == (const PromotionDetail & rhs) const
  {
    if (!(promotionBuddyInfo == rhs.promotionBuddyInfo))
      return false;
    if (!(promotionInstallInfo == rhs.promotionInstallInfo))
      return false;
    if (!(promotionMissionInfo == rhs.promotionMissionInfo))
      return false;
    return true;
  }
  bool operator != (const PromotionDetail &rhs) const {
  ...
  bool operator < (const PromotionDetail & ) const;
...
typedef struct _PromotionInfo__isset {
  _PromotionInfo__isset() : promotionType(false), buddyInfo(false), promotionDetail(false) {}
  bool promotionType :1;
  bool buddyInfo :1;
  bool promotionDetail :1;
} _PromotionInfo__isset;

class PromotionInfo : public virtual ::apache::thrift::TBase {
 public:

  PromotionInfo(const PromotionInfo&);
  PromotionInfo& operator=(const PromotionInfo&);
  PromotionInfo() : promotionType((PromotionType::type)0) {
  }

  virtual ~PromotionInfo() throw();
  PromotionType::type promotionType;
  PromotionBuddyInfo buddyInfo;
  PromotionDetail promotionDetail;

  _PromotionInfo__isset __isset;

  void __set_promotionType(const PromotionType::type val);

  void __set_buddyInfo(const PromotionBuddyInfo& val);

  void __set_promotionDetail(const PromotionDetail& val);

  bool operator == (const PromotionInfo & rhs) const
  {
    if (!(promotionType == rhs.promotionType))
      return false;
    if (!(buddyInfo == rhs.buddyInfo))
      return false;
    if (!(promotionDetail == rhs.promotionDetail))
      return false;
    return true;
  }
  bool operator != (const PromotionInfo &rhs) const {
  ...
  bool operator < (const PromotionInfo & ) const;
...
typedef struct _StickerProperty__isset {
  _StickerProperty__isset() : hasAnimation(false), hasSound(false), hasPopup(false), stickerResourceType(false), stickerOptions(false), compactStickerOptions(false), stickerHash(false), stickerIds(false) {}
  bool hasAnimation :1;
  bool hasSound :1;
  bool hasPopup :1;
  bool stickerResourceType :1;
  bool stickerOptions :1;
  bool compactStickerOptions :1;
  bool stickerHash :1;
  bool stickerIds :1;
} _StickerProperty__isset;

class StickerProperty : public virtual ::apache::thrift::TBase {
 public:

  StickerProperty(const StickerProperty&);
  StickerProperty& operator=(const StickerProperty&);
  StickerProperty() : hasAnimation(0), hasSound(0), hasPopup(0), stickerResourceType((SRType::type)0), stickerOptions(), compactStickerOptions(0), stickerHash() {
  }

  virtual ~StickerProperty() throw();
  bool hasAnimation;
  bool hasSound;
  bool hasPopup;
  SRType::type stickerResourceType;
  std::string stickerOptions;
  int32_t compactStickerOptions;
  std::string stickerHash;
  std::set<std::string>  stickerIds;

  _StickerProperty__isset __isset;

  void __set_hasAnimation(const bool val);

  void __set_hasSound(const bool val);

  void __set_hasPopup(const bool val);

  void __set_stickerResourceType(const SRType::type val);

  void __set_stickerOptions(const std::string& val);

  void __set_compactStickerOptions(const int32_t val);

  void __set_stickerHash(const std::string& val);

  void __set_stickerIds(const std::set<std::string> & val);

  bool operator == (const StickerProperty & rhs) const
  {
    if (!(hasAnimation == rhs.hasAnimation))
      return false;
    if (!(hasSound == rhs.hasSound))
      return false;
    if (!(hasPopup == rhs.hasPopup))
      return false;
    if (!(stickerResourceType == rhs.stickerResourceType))
      return false;
    if (!(stickerOptions == rhs.stickerOptions))
      return false;
    if (!(compactStickerOptions == rhs.compactStickerOptions))
      return false;
    if (!(stickerHash == rhs.stickerHash))
      return false;
    if (!(stickerIds == rhs.stickerIds))
      return false;
    return true;
  }
  bool operator != (const StickerProperty &rhs) const {
  ...
  bool operator < (const StickerProperty & ) const;
...
typedef struct _ThemeProperty__isset {
  _ThemeProperty__isset() : thumbnailUrl(false), themeResourceType(false) {}
  bool thumbnailUrl :1;
  bool themeResourceType :1;
} _ThemeProperty__isset;

class ThemeProperty : public virtual ::apache::thrift::TBase {
 public:

  ThemeProperty(const ThemeProperty&);
  ThemeProperty& operator=(const ThemeProperty&);
  ThemeProperty() : thumbnailUrl(), themeResourceType((TRType::type)0) {
  }

  virtual ~ThemeProperty() throw();
  std::string thumbnailUrl;
  TRType::type themeResourceType;

  _ThemeProperty__isset __isset;

  void __set_thumbnailUrl(const std::string& val);

  void __set_themeResourceType(const TRType::type val);

  bool operator == (const ThemeProperty & rhs) const
  {
    if (!(thumbnailUrl == rhs.thumbnailUrl))
      return false;
    if (!(themeResourceType == rhs.themeResourceType))
      return false;
    return true;
  }
  bool operator != (const ThemeProperty &rhs) const {
  ...
  bool operator < (const ThemeProperty & ) const;
...
typedef struct _SticonProperty__isset {
  _SticonProperty__isset() : sticonIds(false) {}
  bool sticonIds :1;
} _SticonProperty__isset;

class SticonProperty : public virtual ::apache::thrift::TBase {
 public:

  SticonProperty(const SticonProperty&);
  SticonProperty& operator=(const SticonProperty&);
  SticonProperty() {
  }

  virtual ~SticonProperty() throw();
  std::set<std::string>  sticonIds;

  _SticonProperty__isset __isset;

  void __set_sticonIds(const std::set<std::string> & val);

  bool operator == (const SticonProperty & rhs) const
  {
    if (!(sticonIds == rhs.sticonIds))
      return false;
    return true;
  }
  bool operator != (const SticonProperty &rhs) const {
  ...
  bool operator < (const SticonProperty & ) const;
...
typedef struct _ProductProperty__isset {
  _ProductProperty__isset() : stickerProperty(false), sticonProperty(false), themeProperty(false) {}
  bool stickerProperty :1;
  bool sticonProperty :1;
  bool themeProperty :1;
...
class ProductProperty : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_stickerProperty(const StickerProperty& val);

  void __set_sticonProperty(const SticonProperty& val);

  void __set_themeProperty(const ThemeProperty& val);

  bool operator == (const ProductProperty & rhs) const
  {
    if (!(stickerProperty == rhs.stickerProperty))
      return false;
    if (!(sticonProperty == rhs.sticonProperty))
      return false;
    if (!(themeProperty == rhs.themeProperty))
      return false;
    return true;
  }
  bool operator != (const ProductProperty &rhs) const {
...
typedef struct _ProductSearchSummary__isset {
  _ProductSearchSummary__isset() : id(false), type(false), name(false), author(false), promotionInfo(false), version(false), newFlag(false), priceTier(false), priceInLineCoin(false), property(false), subType(false), onSale(false), availableForPresent(false), availableForPurchase(false), validDays(false), authorId(false), saleFlag(false) {}
  bool id :1;
  bool type :1;
  bool name :1;
  bool author :1;
  bool promotionInfo :1;
  bool version :1;
  bool newFlag :1;
  bool priceTier :1;
  bool priceInLineCoin :1;
  bool property :1;
  bool subType :1;
  bool onSale :1;
  bool availableForPresent :1;
  bool availableForPurchase :1;
  bool validDays :1;
  bool authorId :1;
  bool saleFlag :1;
} _ProductSearchSummary__isset;

class ProductSearchSummary : public virtual ::apache::thrift::TBase {
 public:

  ProductSearchSummary(const ProductSearchSummary&);
  ProductSearchSummary& operator=(const ProductSearchSummary&);
  ProductSearchSummary() : id(), type((PType::type)0), name(), author(), version(0), newFlag(0), priceTier(0), priceInLineCoin(), subType((SubType::type)0), onSale(0), availableForPresent(0), availableForPurchase(0), validDays(0), authorId(), saleFlag(0) {
  }

  virtual ~ProductSearchSummary() throw();
  std::string id;
  PType::type type;
  std::string name;
  std::string author;
  ...
  _ProductSearchSummary__isset __isset;

  void __set_id(const std::string& val);

  void __set_type(const PType::type val);

  void __set_name(const std::string& val);

  void __set_author(const std::string& val);

  void __set_promotionInfo(const PromotionInfo& val);
  ...
  void __set_priceInLineCoin(const std::string& val);

  void __set_property(const ProductProperty& val);

  void __set_subType(const SubType::type val);

  void __set_onSale(const bool val);

  void __set_availableForPresent(const bool val);

  void __set_availableForPurchase(const bool val);

  void __set_validDays(const int32_t val);

  void __set_authorId(const std::string& val);

  void __set_saleFlag(const bool val);

  bool operator == (const ProductSearchSummary & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(type == rhs.type))
    ...
    if (!(author == rhs.author))
      return false;
    if (!(promotionInfo == rhs.promotionInfo))
      return false;
    ...
    if (!(priceTier == rhs.priceTier))
      return false;
    if (!(priceInLineCoin == rhs.priceInLineCoin))
      return false;
    ...
    if (!(availableForPresent == rhs.availableForPresent))
      return false;
    if (!(availableForPurchase == rhs.availableForPurchase))
      return false;
    if (!(validDays == rhs.validDays))
      return false;
    if (!(authorId == rhs.authorId))
      return false;
    if (!(saleFlag == rhs.saleFlag))
      return false;
    return true;
  }
  bool operator != (const ProductSearchSummary &rhs) const {
  ...
  bool operator < (const ProductSearchSummary & ) const;
...
typedef struct _ServiceItem__isset {
  _ServiceItem__isset() : id(false), title(false), g(false), subType(false), appId(false), channelId(false), badge(false), iconUrl(false), downloadUrl(false), launchScheme(false), iconTint(false) {}
  bool id :1;
  bool title :1;
  bool g :1;
  bool subType :1;
...
class ServiceItem : public virtual ::apache::thrift::TBase {
 public:

  ServiceItem(const ServiceItem&);
  ServiceItem& operator=(const ServiceItem&);
  ServiceItem() : id(), title(), g(0), subType((SubType::type)0), appId(), channelId(), badge(), iconUrl(), downloadUrl(), launchScheme(), iconTint(0) {
  }

  virtual ~ServiceItem() throw();
  std::string id;
  std::string title;
  int32_t g;
  SubType::type subType;
  ...
  void __set_iconUrl(const std::string& val);

  void __set_downloadUrl(const std::string& val);

  void __set_launchScheme(const std::string& val);

  void __set_iconTint(const bool val);
  ...
  bool operator == (const ServiceItem & rhs) const
  {
    ...
    if (!(badge == rhs.badge))
      return false;
    if (!(iconUrl == rhs.iconUrl))
      return false;
    if (!(downloadUrl == rhs.downloadUrl))
      return false;
    if (!(launchScheme == rhs.launchScheme))
      return false;
    if (!(iconTint == rhs.iconTint))
      return false;
    return true;
  }
  bool operator != (const ServiceItem &rhs) const {
  ...
  bool operator < (const ServiceItem & ) const;
...
typedef struct _AdditionalInfoItem__isset {
  _AdditionalInfoItem__isset() : id(false), g(false), title(false), descr(false), iconUrl(false), link(false) {}
  bool id :1;
  bool g :1;
  bool title :1;
  bool descr :1;
  bool iconUrl :1;
  bool link :1;
} _AdditionalInfoItem__isset;

class AdditionalInfoItem : public virtual ::apache::thrift::TBase {
 public:

  AdditionalInfoItem(const AdditionalInfoItem&);
  AdditionalInfoItem& operator=(const AdditionalInfoItem&);
  AdditionalInfoItem() : id(), g(0), title(), descr(), iconUrl(), link() {
  }

  virtual ~AdditionalInfoItem() throw();
  std::string id;
  int32_t g;
  std::string title;
  std::string descr;
  ...
  _AdditionalInfoItem__isset __isset;
  ...
  bool operator == (const AdditionalInfoItem & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(g == rhs.g))
  ...
  bool operator < (const AdditionalInfoItem & ) const;
...
typedef struct _YellowpageItem__isset {
  _YellowpageItem__isset() : id(false), mid(false), name(false), address(false), latitude(false), longitude(false), distance(false), canFreeCall(false), k(false), phoneNumber(false), cat(false), categoryIcon(false), additionalInfo(false) {}
  bool id :1;
  bool mid :1;
  bool name :1;
  bool address :1;
...
} _YellowpageItem__isset;

class YellowpageItem : public virtual ::apache::thrift::TBase {
 public:

  YellowpageItem(const YellowpageItem&);
  YellowpageItem& operator=(const YellowpageItem&);
  YellowpageItem() : id(), mid(), name(), address(), latitude(0), longitude(0), distance(0), canFreeCall(0), k(0), phoneNumber(), cat(0), categoryIcon(0) {
  }

  virtual ~YellowpageItem() throw();
  std::string id;
  std::string mid;
  std::string name;
  std::string address;
  ...
  int32_t cat;
  int32_t categoryIcon;
  std::vector<AdditionalInfoItem>  additionalInfo;

  _YellowpageItem__isset __isset;
  ...
  void __set_canFreeCall(const bool val);
  ...
  void __set_categoryIcon(const int32_t val);

  void __set_additionalInfo(const std::vector<AdditionalInfoItem> & val);

  bool operator == (const YellowpageItem & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(mid == rhs.mid))
    ...
    if (!(distance == rhs.distance))
      return false;
    if (!(canFreeCall == rhs.canFreeCall))
      return false;
    if (!(k == rhs.k))
      return false;
    ...
    if (!(cat == rhs.cat))
      return false;
    if (!(categoryIcon == rhs.categoryIcon))
      return false;
    if (!(additionalInfo == rhs.additionalInfo))
      return false;
    return true;
  }
  bool operator != (const YellowpageItem &rhs) const {
  ...
  bool operator < (const YellowpageItem & ) const;
...
typedef struct _BuddySearchResult__isset {
  _BuddySearchResult__isset() : mid(false), displayName(false), pictureStatus(false), picturePath(false), statusMessage(false), businessAccount(false), iconType(false), botType(false) {}
  bool mid :1;
  bool displayName :1;
...
class BuddySearchResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  BuddySearchResult() : mid(), displayName(), pictureStatus(), picturePath(), statusMessage(), businessAccount(0), iconType(0), botType((BotType::type)0) {
  }

  virtual ~BuddySearchResult() throw();
  std::string mid;
  ...
  void __set_iconType(const int32_t val);

  void __set_botType(const BotType::type val);
  ...
  bool operator == (const BuddySearchResult & rhs) const
  {
    ...
    if (!(businessAccount == rhs.businessAccount))
      return false;
    if (!(iconType == rhs.iconType))
      return false;
    if (!(botType == rhs.botType))
      return false;
    return true;
  }
  bool operator != (const BuddySearchResult &rhs) const {
...
typedef struct _GeoAddressItem__isset {
  _GeoAddressItem__isset() : latitude(false), longitude(false), displayAddress(false) {}
  bool latitude :1;
  bool longitude :1;
  bool displayAddress :1;
} _GeoAddressItem__isset;

class GeoAddressItem : public virtual ::apache::thrift::TBase {
 public:

  GeoAddressItem(const GeoAddressItem&);
  GeoAddressItem& operator=(const GeoAddressItem&);
  GeoAddressItem() : latitude(0), longitude(0), displayAddress() {
  }

  virtual ~GeoAddressItem() throw();
  double latitude;
  double longitude;
  std::string displayAddress;

  _GeoAddressItem__isset __isset;

  void __set_latitude(const double val);

  void __set_longitude(const double val);

  void __set_displayAddress(const std::string& val);

  bool operator == (const GeoAddressItem & rhs) const
  {
    if (!(latitude == rhs.latitude))
      return false;
    if (!(longitude == rhs.longitude))
      return false;
    if (!(displayAddress == rhs.displayAddress))
      return false;
    return true;
  }
  bool operator != (const GeoAddressItem &rhs) const {
  ...
  bool operator < (const GeoAddressItem & ) const;
...
typedef struct _AddFriendData__isset {
  _AddFriendData__isset() : mid(false) {}
  bool mid :1;
} _AddFriendData__isset;

class AddFriendData : public virtual ::apache::thrift::TBase {
 public:

  AddFriendData(const AddFriendData&);
  AddFriendData& operator=(const AddFriendData&);
  AddFriendData() : mid() {
  }

  virtual ~AddFriendData() throw();
  std::string mid;

  _AddFriendData__isset __isset;

  void __set_mid(const std::string& val);

  bool operator == (const AddFriendData & rhs) const
  {
    if (!(mid == rhs.mid))
      return false;
    return true;
  ...
  bool operator < (const AddFriendData & ) const;
...
typedef struct _InstallAppData__isset {
  _InstallAppData__isset() : installData(false) {}
  bool installData :1;
} _InstallAppData__isset;

class InstallAppData : public virtual ::apache::thrift::TBase {
 public:

  InstallAppData(const InstallAppData&);
  InstallAppData& operator=(const InstallAppData&);
  InstallAppData() {
  }

  virtual ~InstallAppData() throw();
  std::map<std::string, std::string>  installData;

  _InstallAppData__isset __isset;

  void __set_installData(const std::map<std::string, std::string> & val);

  bool operator == (const InstallAppData & rhs) const
  {
    if (!(installData == rhs.installData))
      return false;
    return true;
  }
  bool operator != (const InstallAppData &rhs) const {
  ...
  bool operator < (const InstallAppData & ) const;
...
class JumpUrlData : public virtual ::apache::thrift::TBase {
 public:

  JumpUrlData(const JumpUrlData&);
  JumpUrlData& operator=(const JumpUrlData&);
  JumpUrlData() {
  }

  virtual ~JumpUrlData() throw();

  bool operator == (const JumpUrlData & /* rhs */) const
  {
    return true;
  }
  bool operator != (const JumpUrlData &rhs) const {
  ...
  bool operator < (const JumpUrlData & ) const;
...
typedef struct _ButtonActionData__isset {
  _ButtonActionData__isset() : addFriendData(false), installAppData(false), jumpUrlData(false) {}
  bool addFriendData :1;
  bool installAppData :1;
  bool jumpUrlData :1;
} _ButtonActionData__isset;

class ButtonActionData : public virtual ::apache::thrift::TBase {
 public:

  ButtonActionData(const ButtonActionData&);
  ButtonActionData& operator=(const ButtonActionData&);
  ButtonActionData() {
  }

  virtual ~ButtonActionData() throw();
  AddFriendData addFriendData;
  InstallAppData installAppData;
  JumpUrlData jumpUrlData;

  _ButtonActionData__isset __isset;

  void __set_addFriendData(const AddFriendData& val);

  void __set_installAppData(const InstallAppData& val);

  void __set_jumpUrlData(const JumpUrlData& val);

  bool operator == (const ButtonActionData & rhs) const
  {
    if (!(addFriendData == rhs.addFriendData))
      return false;
    if (!(installAppData == rhs.installAppData))
      return false;
    if (!(jumpUrlData == rhs.jumpUrlData))
      return false;
    return true;
  }
  bool operator != (const ButtonActionData &rhs) const {
  ...
  bool operator < (const ButtonActionData & ) const;
...
typedef struct _ShortcutButtonAction__isset {
  _ShortcutButtonAction__isset() : actionType(false), actionData(false) {}
  bool actionType :1;
  bool actionData :1;
} _ShortcutButtonAction__isset;

class ShortcutButtonAction : public virtual ::apache::thrift::TBase {
 public:

  ShortcutButtonAction(const ShortcutButtonAction&);
  ShortcutButtonAction& operator=(const ShortcutButtonAction&);
  ShortcutButtonAction() : actionType(0) {
  }

  virtual ~ShortcutButtonAction() throw();
  int32_t actionType;
  ButtonActionData actionData;

  _ShortcutButtonAction__isset __isset;

  void __set_actionType(const int32_t val);

  void __set_actionData(const ButtonActionData& val);

  bool operator == (const ShortcutButtonAction & rhs) const
  {
    if (!(actionType == rhs.actionType))
      return false;
    if (!(actionData == rhs.actionData))
      return false;
    return true;
  }
  bool operator != (const ShortcutButtonAction &rhs) const {
  ...
  bool operator < (const ShortcutButtonAction & ) const;
...
typedef struct _ShortcutButton__isset {
  _ShortcutButton__isset() : id(false), title(false), url(false), iconPath(false), action(false) {}
  bool id :1;
  bool title :1;
  bool url :1;
  bool iconPath :1;
  bool action :1;
} _ShortcutButton__isset;

class ShortcutButton : public virtual ::apache::thrift::TBase {
 public:

  ShortcutButton(const ShortcutButton&);
  ShortcutButton& operator=(const ShortcutButton&);
  ShortcutButton() : id(), title(), url(), iconPath() {
  }

  virtual ~ShortcutButton() throw();
  std::string id;
  std::string title;
  std::string url;
  std::string iconPath;
  ...
  _ShortcutButton__isset __isset;
  ...
  void __set_iconPath(const std::string& val);

  void __set_action(const ShortcutButtonAction& val);

  bool operator == (const ShortcutButton & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(title == rhs.title))
  ...
  bool operator < (const ShortcutButton & ) const;
...
typedef struct _ShortcutItem__isset {
  _ShortcutItem__isset() : id(false), title(false), descr(false), iconPath(false), url(false), buttons(false), action(false) {}
  bool id :1;
  bool title :1;
  bool descr :1;
  bool iconPath :1;
  ...
  bool buttons :1;
  bool action :1;
} _ShortcutItem__isset;

class ShortcutItem : public virtual ::apache::thrift::TBase {
 public:

  ShortcutItem(const ShortcutItem&);
  ShortcutItem& operator=(const ShortcutItem&);
  ShortcutItem() : id(), title(), descr(), iconPath(), url() {
  }

  virtual ~ShortcutItem() throw();
  std::string id;
  std::string title;
  std::string descr;
  std::string iconPath;
  std::string url;
  std::vector<ShortcutButton>  buttons;
  ShortcutButtonAction action;

  _ShortcutItem__isset __isset;
  ...
  void __set_buttons(const std::vector<ShortcutButton> & val);

  void __set_action(const ShortcutButtonAction& val);

  bool operator == (const ShortcutItem & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(title == rhs.title))
  ...
  bool operator < (const ShortcutItem & ) const;
...
typedef struct _SQCat__isset {
  _SQCat__isset() : id(false), name(false) {}
  bool id :1;
  bool name :1;
} _SQCat__isset;

class SQCat : public virtual ::apache::thrift::TBase {
 public:

  SQCat(const SQCat&);
  SQCat& operator=(const SQCat&);
  SQCat() : id(0), name() {
  }
  ...
  _SQCat__isset __isset;

  void __set_id(const int32_t val);

  void __set_name(const std::string& val);

  bool operator == (const SQCat & rhs) const
  {
    if (!(id == rhs.id))
      return false;
    if (!(name == rhs.name))
  ...
  bool operator < (const SQCat & ) const;
...
typedef struct _SearchItemUnion__isset {
  _SearchItemUnion__isset() : categoryItem(false), spotItem(false), productItem(false), serviceItem(false), yellowpageItem(false), oaItem(false), geoAddressItem(false), shortcutItem(false), squareItem(false), squareCategoryItem(false) {}
  bool categoryItem :1;
  bool spotItem :1;
  bool productItem :1;
  bool serviceItem :1;
  bool yellowpageItem :1;
  bool oaItem :1;
  bool geoAddressItem :1;
  bool shortcutItem :1;
  bool squareItem :1;
  bool squareCategoryItem :1;
} _SearchItemUnion__isset;

class SearchItemUnion : public virtual ::apache::thrift::TBase {
 public:

  SearchItemUnion(const SearchItemUnion&);
  SearchItemUnion& operator=(const SearchItemUnion&);
  SearchItemUnion() {
  }

  virtual ~SearchItemUnion() throw();
  ...
  _SearchItemUnion__isset __isset;

  void __set_categoryItem(const CategoryItem& val);

  void __set_spotItem(const SpotItem& val);

  void __set_productItem(const ProductSearchSummary& val);

  void __set_serviceItem(const ServiceItem& val);

  void __set_yellowpageItem(const YellowpageItem& val);

  void __set_oaItem(const BuddySearchResult& val);

  void __set_geoAddressItem(const GeoAddressItem& val);

  void __set_shortcutItem(const ShortcutItem& val);

  void __set_squareItem(const SquareInfo& val);

  void __set_squareCategoryItem(const SQCat& val);

  bool operator == (const SearchItemUnion & rhs) const
  {
    if (!(categoryItem == rhs.categoryItem))
      return false;
    if (!(spotItem == rhs.spotItem))
      return false;
    if (!(productItem == rhs.productItem))
      return false;
    if (!(serviceItem == rhs.serviceItem))
      return false;
    if (!(yellowpageItem == rhs.yellowpageItem))
      return false;
    if (!(oaItem == rhs.oaItem))
      return false;
    if (!(geoAddressItem == rhs.geoAddressItem))
      return false;
    if (!(shortcutItem == rhs.shortcutItem))
      return false;
    if (!(squareItem == rhs.squareItem))
      return false;
    if (!(squareCategoryItem == rhs.squareCategoryItem))
      return false;
    return true;
  }
  bool operator != (const SearchItemUnion &rhs) const {
  ...
  bool operator < (const SearchItemUnion & ) const;
...
typedef struct _SearchResultItem__isset {
  _SearchResultItem__isset() : id(false), ItemType(false), item(false), title(false), sub1(false), sub2(false), iconUrl(false), titleLink(false), iconLink(false), displayTemplate(false), additionalInfo(false) {}
  bool id :1;
  bool ItemType :1;
  bool item :1;
  bool title :1;
  ...
  bool titleLink :1;
  bool iconLink :1;
  bool displayTemplate :1;
  bool additionalInfo :1;
} _SearchResultItem__isset;

class SearchResultItem : public virtual ::apache::thrift::TBase {
 public:

  SearchResultItem(const SearchResultItem&);
  SearchResultItem& operator=(const SearchResultItem&);
  SearchResultItem() : id(), ItemType(0), title(), sub1(), sub2(), iconUrl(), titleLink(), iconLink(), displayTemplate() {
  }

  virtual ~SearchResultItem() throw();
  std::string id;
  int32_t ItemType;
  ...
  _SearchResultItem__isset __isset;

  void __set_id(const std::string& val);

  void __set_ItemType(const int32_t val);

  void __set_item(const SearchItemUnion& val);

  void __set_title(const std::string& val);

  void __set_sub1(const std::string& val);

  void __set_sub2(const std::string& val);

  void __set_iconUrl(const std::string& val);

  void __set_titleLink(const std::string& val);

  void __set_iconLink(const std::string& val);

  void __set_displayTemplate(const std::string& val);
  ...
  bool operator == (const SearchResultItem & rhs) const
  {
    ...
    if (!(iconUrl == rhs.iconUrl))
      return false;
    if (!(titleLink == rhs.titleLink))
      return false;
    if (!(iconLink == rhs.iconLink))
      return false;
    if (!(displayTemplate == rhs.displayTemplate))
      return false;
    if (!(additionalInfo == rhs.additionalInfo))
      return false;
    return true;
  ...
  bool operator < (const SearchResultItem & ) const;
...
typedef struct _SearchResultCollection__isset {
  _SearchResultCollection__isset() : collection(false), title(false), rank(false), hits(false), items(false), hasNext(false), cat(false), error(false), tabTitle(false), start(false), length(false), squareCategoryId(false) {}
  bool collection :1;
  bool title :1;
  bool rank :1;
  bool hits :1;
  ...
  bool start :1;
  bool length :1;
  bool squareCategoryId :1;
} _SearchResultCollection__isset;

class SearchResultCollection : public virtual ::apache::thrift::TBase {
 public:

  SearchResultCollection(const SearchResultCollection&);
  SearchResultCollection& operator=(const SearchResultCollection&);
  SearchResultCollection() : collection(0), title(), rank(0), hits(0), hasNext(0), error(), tabTitle(), start(0), length(0), squareCategoryId(0) {
  }

  virtual ~SearchResultCollection() throw();
  int32_t collection;
  std::string title;
  int32_t rank;
  int32_t hits;
  ...
  bool hasNext;
  std::vector<int32_t>  cat;
  std::string error;
  std::string tabTitle;
  int32_t start;
  int32_t length;
  int32_t squareCategoryId;

  _SearchResultCollection__isset __isset;
  ...
  void __set_hits(const int32_t val);

  void __set_items(const std::vector<SearchResultItem> & val);

  void __set_hasNext(const bool val);

  void __set_cat(const std::vector<int32_t> & val);

  void __set_error(const std::string& val);

  void __set_tabTitle(const std::string& val);

  void __set_start(const int32_t val);

  void __set_length(const int32_t val);

  void __set_squareCategoryId(const int32_t val);

  bool operator == (const SearchResultCollection & rhs) const
  {
    if (!(collection == rhs.collection))
      return false;
    if (!(title == rhs.title))
    ...
    if (!(error == rhs.error))
      return false;
    if (!(tabTitle == rhs.tabTitle))
      return false;
    if (!(start == rhs.start))
      return false;
    if (!(length == rhs.length))
      return false;
    if (!(squareCategoryId == rhs.squareCategoryId))
      return false;
    return true;
  }
  bool operator != (const SearchResultCollection &rhs) const {
  ...
  bool operator < (const SearchResultCollection & ) const;
...
typedef struct _SearchResult__isset {
  _SearchResult__isset() : sid(false), collections(false), start(false), length(false) {}
  bool sid :1;
  bool collections :1;
  bool start :1;
  bool length :1;
...
class SearchResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  SearchResult() : sid(), start(0), length(0) {
  }

  virtual ~SearchResult() throw();
  std::string sid;
  std::vector<SearchResultCollection>  collections;
  int32_t start;
  int32_t length;
  ...
  void __set_collections(const std::vector<SearchResultCollection> & val);
...
typedef struct _SearchCommonParameter__isset {
  _SearchCommonParameter__isset() : latitude(false), longitude(false), source(false), region(false), sid(false), queryType(false) {}
  bool latitude :1;
  bool longitude :1;
  bool source :1;
  bool region :1;
  bool sid :1;
  bool queryType :1;
} _SearchCommonParameter__isset;

class SearchCommonParameter : public virtual ::apache::thrift::TBase {
 public:

  SearchCommonParameter(const SearchCommonParameter&);
  SearchCommonParameter& operator=(const SearchCommonParameter&);
  SearchCommonParameter() : latitude(0), longitude(0), source(), region(), sid(), queryType(0) {
  }

  virtual ~SearchCommonParameter() throw();
  double latitude;
  double longitude;
  std::string source;
  std::string region;
  ...
  _SearchCommonParameter__isset __isset;
  ...
  bool operator == (const SearchCommonParameter & rhs) const
  {
    if (!(latitude == rhs.latitude))
      return false;
    if (!(longitude == rhs.longitude))
  ...
  bool operator < (const SearchCommonParameter & ) const;
...
typedef struct _SearchPagingParameter__isset {
  _SearchPagingParameter__isset() : collection(false), start(false), length(false), commonParam(false) {}
  bool collection :1;
  bool start :1;
  bool length :1;
  bool commonParam :1;
} _SearchPagingParameter__isset;

class SearchPagingParameter : public virtual ::apache::thrift::TBase {
 public:

  SearchPagingParameter(const SearchPagingParameter&);
  SearchPagingParameter& operator=(const SearchPagingParameter&);
  SearchPagingParameter() : collection(0), start(0), length(0) {
  }

  virtual ~SearchPagingParameter() throw();
  int32_t collection;
  int32_t start;
  int32_t length;
  SearchCommonParameter commonParam;

  _SearchPagingParameter__isset __isset;
  ...
  void __set_commonParam(const SearchCommonParameter& val);

  bool operator == (const SearchPagingParameter & rhs) const
  {
    if (!(collection == rhs.collection))
      return false;
    if (!(start == rhs.start))
    ...
    if (!(length == rhs.length))
      return false;
    if (!(commonParam == rhs.commonParam))
      return false;
    return true;
  }
  bool operator != (const SearchPagingParameter &rhs) const {
  ...
  bool operator < (const SearchPagingParameter & ) const;
...
class MessageBoxV2MessageId : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~MessageBoxV2MessageId() throw();
...
class MessageCommitResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~MessageCommitResult() throw();
...
class AgeCheckDocomoResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~AgeCheckDocomoResult() throw();
  std::string authUrl;
...
class AgeCheckRequestResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~AgeCheckRequestResult() throw();
  std::string authUrl;
...
class TextMessageAnnouncementContents : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~TextMessageAnnouncementContents() throw();
...
class SquareChatAnnouncementContents : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareChatAnnouncementContents() throw();
...
class SquareChatAnnouncement : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareChatAnnouncement() throw();
...
class E2EENegotiationResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~E2EENegotiationResult() throw();
...
class SquarePreference : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquarePreference() throw();
...
class SquareMemberRelation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareMemberRelation() throw();
...
class SquareFeatureSet : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareFeatureSet() throw();
  std::string squareMid;
  int64_t revision;
...
class PaidCallAdCountry : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallAdCountry() throw();
...
class PaidCallAdResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallAdResult() throw();
  int32_t adRemains;
...
class PaidCallCurrencyExchangeRate : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallCurrencyExchangeRate() throw();
...
class ExtendedProfileBirthday : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ExtendedProfileBirthday() throw();
  std::string year;
...
class SpotNearbyResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SpotNearbyResponse() throw();
...
class SpotPhoneNumberResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SpotPhoneNumberResponse() throw();
...
class PaidCallHistoryResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallHistoryResult() throw();
...
class PaidCallMetadataResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallMetadataResult() throw();
...
class PaidCallRedeemResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallRedeemResult() throw();
...
class PaidCallResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallResponse() throw();
  CallHost host;
...
class PaidCallUserRate : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaidCallUserRate() throw();
  std::string countryCode;
  int32_t rate;
  std::string rateDivision;
  std::string rateName;
...
class ApprovedChannelInfo : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ApprovedChannelInfo() throw();
...
class ApprovedChannelInfos : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ApprovedChannelInfos() throw();
...
class ContactTransition : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ContactTransition() throw();
  std::string ownerMid;
...
class UserTicketResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UserTicketResponse() throw();
  std::string mid;
...
class RegisterWithPhoneNumberResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RegisterWithPhoneNumberResult() throw();
...
class BuddyMessageRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~BuddyMessageRequest() throw();
...
class CommitMessageResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CommitMessageResult() throw();
  Message message;
...
class SyncParamContact : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SyncParamContact() throw();
...
class ChannelNotificationSetting : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ChannelNotificationSetting() throw();
  std::string channelId;
  std::string name;
...
class ChannelSyncDatas : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ChannelSyncDatas() throw();
  std::vector<ChannelInfo>  channelInfos;
  std::vector<ChannelDomain>  channelDomains;
  int64_t revision;
  int64_t expires;
...
class NotiCenterEventData : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~NotiCenterEventData() throw();
  std::string id;
  std::string to;
  std::string from_;
...
class ChannelIdWithLastUpdated : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ChannelIdWithLastUpdated() throw();
  std::string channelId;
  int64_t lastUpdated;
...
class CoinHistoryCondition : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinHistoryCondition() throw();
  int64_t start;
  int32_t size;
  std::string language;
  std::string eddt;
...
class CoinHistoryResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinHistoryResult() throw();
...
class CoinPurchaseConfirm : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinPurchaseConfirm() throw();
  std::string orderId;
  PaymentType::type appStoreCode;
  std::string receipt;
...
class CoinPurchaseReservation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinPurchaseReservation() throw();
...
class CoinUseReservationItem : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinUseReservationItem() throw();
  std::string itemId;
  std::string itemName;
  int32_t amount;
...
class CoinUseReservation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CoinUseReservation() throw();
  std::string channelId;
...
class ContactModification : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ContactModification() throw();
...
class ContactRegistration : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ContactRegistration() throw();
  Contact contact;
  std::string luid;
...
class ContactReportResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ContactReportResult() throw();
  std::string mid;
  bool exists;
...
class EmailConfirmation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~EmailConfirmation() throw();
  bool usePasswordSet;
  std::string email;
  std::string password;
...
class EmailConfirmationSession : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~EmailConfirmationSession() throw();
...
class FriendChannelMatrix : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FriendChannelMatrix() throw();
  std::string channelId;
...
class FriendChannelMatricesResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FriendChannelMatricesResponse() throw();
  int64_t expires;
...
class FriendRequestsInfo : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FriendRequestsInfo() throw();
...
typedef struct _Group__isset {
  _Group__isset() : id(false), createdTime(false), name(false), pictureStatus(false), preventedJoinByTicket(false), groupPreference(false), members(false), creator(false), invitee(false), notificationDisabled(false), picturePath(false), memberMids(false), inviteeMids(false) {}
  bool id :1;
  bool createdTime :1;
  bool name :1;
  bool pictureStatus :1;
...
class Group : public virtual ::apache::thrift::TBase {
 public:
  ...
  Group() : id(), createdTime(0), name(), pictureStatus(), preventedJoinByTicket(0), notificationDisabled(0), picturePath() {
  }
...
class IdentityCredential : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~IdentityCredential() throw();
...
class LastReadMessageId : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LastReadMessageId() throw();
  std::string mid;
...
class LastReadMessageIds : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LastReadMessageIds() throw();
  std::string chatId;
...
typedef struct _VerificationSessionData__isset {
  _VerificationSessionData__isset() : sessionId(false), method(false), callback(false), normalizedPhone(false), countryCode(false), nationalSignificantNumber(false), availableVerificationMethods(false), callerIdMask(false) {}
  bool sessionId :1;
  bool method :1;
  bool callback :1;
...
class VerificationSessionData : public virtual ::apache::thrift::TBase {
 public:
  ...
  VerificationSessionData() : sessionId(), method((VerificationMethod::type)0), callback(), normalizedPhone(), countryCode(), nationalSignificantNumber(), callerIdMask() {
  }

  virtual ~VerificationSessionData() throw();
  std::string sessionId;
  ...
  void __set_callerIdMask(const std::string& val);
  ...
  bool operator == (const VerificationSessionData & rhs) const
  {
    ...
    if (!(availableVerificationMethods == rhs.availableVerificationMethods))
      return false;
    if (!(callerIdMask == rhs.callerIdMask))
      return false;
    return true;
  }
  bool operator != (const VerificationSessionData &rhs) const {
...
class Message : public virtual ::apache::thrift::TBase {
 public:
  ...
  Message() : _from(), displayName(), picturePath(), type(), person(), person2(), personName(), personName2(), to(), toType((MIDType::type)0), id(), createdTime(0), deliveredTime(0), text(), hasContent(0), contentType((ContentType::type)0), contentPreview(), sessionId(0), relatedMessageId(), messageRelationType((MessageRelationType::type)0), readCount(0), relatedMessageServiceCode((ServiceCode::type)0) {
  }
  ...
  void __set_person(const std::string& val);

  void __set_person2(const std::string& val);

  void __set_personName(const std::string& val);

  void __set_personName2(const std::string& val);
  ...
  bool operator == (const Message & rhs) const
  {
    ...
    if (!(person == rhs.person))
      return false;
    if (!(person2 == rhs.person2))
      return false;
    if (!(personName == rhs.personName))
      return false;
    if (!(personName2 == rhs.personName2))
      return false;
    if (!(to == rhs.to))
      return false;
...
class SquareChatStatusWithoutMessage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareChatStatusWithoutMessage() throw();
  int32_t memberCount;
...
class SquareChatStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareChatStatus() throw();
...
class SquareChatMember : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareChatMember() throw();
  std::string squareMemberMid;
  std::string squareChatMid;
  int64_t revision;
...
class MessageStoreResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~MessageStoreResult() throw();
  std::string requestId;
  std::vector<std::string>  messageIds;
...
class NotificationItem : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~NotificationItem() throw();
  std::string id;
  std::string _from;
  std::string to;
  std::string fromChannel;
...
class NotificationFetchResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~NotificationFetchResult() throw();
...
class PaymentReservation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaymentReservation() throw();
...
class PaymentReservationResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PaymentReservationResult() throw();
  std::string orderId;
...
class ProductSimpleList : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ProductSimpleList() throw();
  bool hasNext;
...
class ProximityMatchCandidateResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ProximityMatchCandidateResult() throw();
...
class RegisterWithSnsIdResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RegisterWithSnsIdResult() throw();
  std::string authToken;
  bool userCreated;
...
class RequestTokenResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RequestTokenResponse() throw();
...
class SuggestDictionary : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestDictionary() throw();
  std::string language;
  std::string name;
...
class SuggestItemDictionaryIncrement : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestItemDictionaryIncrement() throw();
...
class SuggestTagDictionaryIncrement : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestTagDictionaryIncrement() throw();
  SuggestDictionaryIncrementStatus status;
  std::string language;
  int64_t revision;
  std::string scheme;
...
class SuggestDictionaryIncrements : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestDictionaryIncrements() throw();
...
class SuggestItemDictionaryRevision : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestItemDictionaryRevision() throw();
  int64_t revision;
  std::string scheme;
...
class SuggestTagDictionaryRevision : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestTagDictionaryRevision() throw();
  std::string language;
  int64_t revision;
  std::string scheme;
...
class SuggestDictionaryRevisions : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestDictionaryRevisions() throw();
...
class SuggestDictionarySettings : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SuggestDictionarySettings() throw();
  int64_t revision;
  int64_t newRevision;
...
class PhoneInfoForChannel : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PhoneInfoForChannel() throw();
  std::string mid;
...
class PhoneVerificationResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~PhoneVerificationResult() throw();
...
class SecurityCenterResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SecurityCenterResult() throw();
  std::string uri;
  std::string token;
...
class SendBuddyMessageResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SendBuddyMessageResult() throw();
  std::string requestId;
  BuddyResultState::type state;
  std::string messageId;
  int32_t eventNo;
...
class SetBuddyOnAirResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SetBuddyOnAirResult() throw();
  std::string requestId;
  BuddyResultState::type state;
  int32_t eventNo;
  int64_t receiverCount;
...
class SimpleChannelClient : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SimpleChannelClient() throw();
  std::string applicationType;
  std::string applicationVersion;
  std::string locale;
...
class SimpleChannelContact : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SimpleChannelContact() throw();
  std::string mid;
  std::string displayName;
  std::string pictureStatus;
  std::string picturePath;
...
class SnsFriendContactRegistration : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SnsFriendContactRegistration() throw();
  Contact contact;
  SnsIdType::type snsIdType;
  std::string snsUserId;
...
class SnsFriendModification : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SnsFriendModification() throw();
  ModificationType::type type;
  SnsFriend snsFriend;
...
class SystemConfiguration : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SystemConfiguration() throw();
  std::string endpoint;
...
class TMessageBoxWrapUp : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~TMessageBoxWrapUp() throw();
...
class TMessageBoxWrapUpResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~TMessageBoxWrapUpResponse() throw();
...
class TMessageReadRangeEntry : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~TMessageReadRangeEntry() throw();
...
class TMessageReadRange : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~TMessageReadRange() throw();
  std::string chatId;
...
class ChatRoomAnnouncementContents : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ChatRoomAnnouncementContents() throw();
...
class ChatRoomAnnouncement : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ChatRoomAnnouncement() throw();
  int64_t announcementSeq;
...
class JoinSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~JoinSquareResponse() throw();
  Square square;
...
class JoinSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~JoinSquareRequest() throw();
  std::string squareMid;
  SquareMember member;
...
class JoinSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~JoinSquareChatResponse() throw();
...
class JoinSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~JoinSquareChatRequest() throw();
  std::string squareChatMid;
...
class MarkAsReadRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~MarkAsReadRequest() throw();
  std::string squareChatMid;
  std::string messageId;
...
class MarkAsReadResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~MarkAsReadResponse() throw();
...
class SubscriptionState : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SubscriptionState() throw();
...
class ApproveSquareMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ApproveSquareMembersResponse() throw();
...
class ApproveSquareMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ApproveSquareMembersRequest() throw();
  std::string squareMid;
...
class CreateSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareChatResponse() throw();
  SquareChat squareChat;
  SquareChatStatus squareChatStatus;
  SquareChatMember squareChatMember;
...
class CreateSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareChatRequest() throw();
  int32_t reqSeq;
  SquareChat squareChat;
...
class CreateSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareResponse() throw();
  Square square;
...
class CreateSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareRequest() throw();
  int32_t reqSeq;
  Square square;
  SquareMember creator;
...
class DeleteSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareResponse() throw();
...
class DeleteSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareRequest() throw();
  std::string mid;
  int64_t revision;
...
class DestroyMessageResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DestroyMessageResponse() throw();
...
class DestroyMessageRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DestroyMessageRequest() throw();
  std::string squareChatMid;
  std::string messageId;
...
class GetSquareChatMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatMembersRequest() throw();
  std::string squareChatMid;
  std::string continuationToken;
  int32_t limit;
...
class GetSquareChatMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatMembersResponse() throw();
...
class GetSquareChatStatusRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatStatusRequest() throw();
  std::string squareChatMid;
...
class GetSquareChatStatusResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatStatusResponse() throw();
...
class GetSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatRequest() throw();
  std::string squareChatMid;
...
class GetSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatResponse() throw();
  SquareChat squareChat;
  SquareChatMember squareChatMember;
  SquareChatStatus squareChatStatus;
...
class GetSquareAuthorityRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareAuthorityRequest() throw();
  std::string squareMid;
...
class GetSquareAuthorityResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareAuthorityResponse() throw();
  SquareAuthority authority;
...
class GetJoinedSquaresRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinedSquaresRequest() throw();
  std::string continuationToken;
  int32_t limit;
...
class GetJoinedSquaresResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinedSquaresResponse() throw();
...
class GetJoinableSquareChatsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinableSquareChatsRequest() throw();
  std::string squareMid;
  std::string continuationToken;
  int32_t limit;
...
class GetJoinableSquareChatsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinableSquareChatsResponse() throw();
...
class GetInvitationTicketUrlRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetInvitationTicketUrlRequest() throw();
  std::string mid;
...
class GetInvitationTicketUrlResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetInvitationTicketUrlResponse() throw();
  std::string invitationURL;
...
class LeaveSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LeaveSquareRequest() throw();
  std::string squareMid;
...
class LeaveSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LeaveSquareResponse() throw();
...
class LeaveSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LeaveSquareChatRequest() throw();
  std::string squareChatMid;
  bool sayGoodbye;
...
class LeaveSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LeaveSquareChatResponse() throw();
...
class SquareMemberSearchOption : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareMemberSearchOption() throw();
  SquareMembershipState::type membershipState;
...
class SearchSquareMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SearchSquareMembersRequest() throw();
  std::string squareMid;
...
class SearchSquareMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SearchSquareMembersResponse() throw();
...
class FindSquareByInvitationTicketRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FindSquareByInvitationTicketRequest() throw();
  std::string invitationTicket;
...
class FindSquareByInvitationTicketResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FindSquareByInvitationTicketResponse() throw();
  Square square;
...
class SquareEventReceiveMessage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventReceiveMessage() throw();
  std::string squareChatMid;
  SquareMessage squareMessage;
...
class SquareEventSendMessage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventSendMessage() throw();
  std::string squareChatMid;
  SquareMessage squareMessage;
  int32_t reqSeq;
...
class SquareEventNotifiedJoinSquareChat : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedJoinSquareChat() throw();
  std::string squareChatMid;
...
class SquareEventNotifiedInviteIntoSquareChat : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedInviteIntoSquareChat() throw();
  std::string squareChatMid;
...
class SquareEventNotifiedLeaveSquareChat : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedLeaveSquareChat() throw();
  std::string squareChatMid;
  std::string squareMemberMid;
  bool sayGoodbye;
  SquareMember squareMember;
...
class SquareEventNotifiedDestroyMessage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedDestroyMessage() throw();
  std::string squareChatMid;
  std::string messageId;
...
class SquareEventNotifiedMarkAsRead : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedMarkAsRead() throw();
  std::string squareChatMid;
...
class SquareEventNotifiedUpdateSquareMemberProfile : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareMemberProfile() throw();
  std::string squareChatMid;
  SquareMember squareMember;
...
class SquareEventNotifiedKickoutFromSquare : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedKickoutFromSquare() throw();
  std::string squareChatMid;
...
class SquareEventNotifiedShutdownSquare : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedShutdownSquare() throw();
  std::string squareChatMid;
  Square square;
...
class SquareEventNotifiedDeleteSquareChat : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedDeleteSquareChat() throw();
  SquareChat squareChat;
...
class SquareEventNotifiedUpdateSquareChatProfileName : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareChatProfileName() throw();
  std::string squareChatMid;
  SquareMember editor;
...
class SquareEventNotifiedUpdateSquareChatProfileImage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareChatProfileImage() throw();
  std::string squareChatMid;
  SquareMember editor;
...
class SquareEventNotifiedUpdateSquareChatStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareChatStatus() throw();
  std::string squareChatMid;
...
class SquareEventNotifiedUpdateSquareStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareStatus() throw();
  std::string squareMid;
  SquareStatus squareStatus;
...
class SquareEventNotifiedCreateSquareMember : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedCreateSquareMember() throw();
  Square square;
  SquareAuthority squareAuthority;
  SquareStatus squareStatus;
  SquareMember squareMember;
...
class SquareEventNotifiedCreateSquareChatMember : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedCreateSquareChatMember() throw();
  std::string squareChatMid;
  std::string squareMemberMid;
  SquareChatMember squareChatMember;
...
class SquareEventNotifiedUpdateSquareMemberRelation : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareMemberRelation() throw();
  std::string squareMid;
...
class SquareEventNotifiedUpdateSquare : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquare() throw();
  std::string squareMid;
  Square square;
...
class SquareEventNotifiedUpdateSquareMember : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareMember() throw();
  std::string squareMid;
  std::string squareMemberMid;
  SquareMember squareMember;
...
class SquareEventNotifiedUpdateSquareChat : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareChat() throw();
  std::string squareMid;
  std::string squareChatMid;
  SquareChat squareChat;
...
class SquareEventNotificationJoinRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotificationJoinRequest() throw();
  std::string squareMid;
...
class SquareEventNotificationMemberUpdate : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotificationMemberUpdate() throw();
  std::string squareMid;
  std::string squareName;
  std::string profileImageObsHash;
...
class SquareEventNotificationSquareDelete : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotificationSquareDelete() throw();
  std::string squareMid;
  std::string squareName;
  std::string profileImageObsHash;
...
class SquareEventNotificationSquareChatDelete : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotificationSquareChatDelete() throw();
  std::string squareChatMid;
...
class SquareEventNotificationMessage : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotificationMessage() throw();
  std::string squareChatMid;
  SquareMessage squareMessage;
  std::string senderDisplayName;
  int32_t unreadCount;
...
class SquareEventNotifiedUpdateSquareChatMember : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareChatMember() throw();
  std::string squareChatMid;
  std::string squareMemberMid;
  SquareChatMember squareChatMember;
...
class SquareEventNotifiedUpdateSquareAuthority : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareAuthority() throw();
  std::string squareMid;
  SquareAuthority squareAuthority;
...
class SquareEventNotifiedUpdateSquareFeatureSet : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventNotifiedUpdateSquareFeatureSet() throw();
  SquareFeatureSet squareFeatureSet;
...
class SquareEventPayload : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SquareEventPayload() throw();
...
class FetchMyEventsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FetchMyEventsRequest() throw();
  int64_t subscriptionId;
  std::string syncToken;
  int32_t limit;
  std::string continuationToken;
...
class FetchMyEventsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FetchMyEventsResponse() throw();
...
class FetchSquareChatEventsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FetchSquareChatEventsRequest() throw();
  int64_t subscriptionId;
  std::string squareChatMid;
  std::string syncToken;
  int32_t limit;
...
class FetchSquareChatEventsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~FetchSquareChatEventsResponse() throw();
  SubscriptionState subscription;
  std::vector<SquareEvent>  events;
  std::string syncToken;
  std::string continuationToken;
...
class InviteToSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~InviteToSquareRequest() throw();
  std::string squareMid;
...
class InviteToSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~InviteToSquareResponse() throw();
...
class InviteToSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~InviteToSquareChatRequest() throw();
  std::vector<std::string>  inviteeMids;
  std::string squareChatMid;
...
class InviteToSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~InviteToSquareChatResponse() throw();
  std::vector<std::string>  inviteeMids;
...
class GetSquareMemberRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberRequest() throw();
  std::string squareMemberMid;
...
class GetSquareMemberResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberResponse() throw();
  SquareMember squareMember;
...
class GetSquareMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMembersRequest() throw();
...
class GetSquareMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMembersResponse() throw();
...
class GetSquareMemberRelationsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberRelationsRequest() throw();
  SquareMemberRelationState::type state;
  std::string continuationToken;
  int32_t limit;
...
class GetSquareMemberRelationsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberRelationsResponse() throw();
...
class GetSquareMemberRelationRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberRelationRequest() throw();
  std::string squareMid;
  std::string targetSquareMemberMid;
...
class GetSquareMemberRelationResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareMemberRelationResponse() throw();
  std::string squareMid;
  std::string targetSquareMemberMid;
  SquareMemberRelation relation;
...
class GetSquareCategoriesRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareCategoriesRequest() throw();
...
class GetSquareCategoriesResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareCategoriesResponse() throw();
...
class UpdateSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareRequest() throw();
...
class UpdateSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareResponse() throw();
  std::set<SquareAttribute::type>  updatedAttrs;
  Square square;
...
class SearchSquaresRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SearchSquaresRequest() throw();
  std::string query;
  std::string continuationToken;
  int32_t limit;
...
class SearchSquaresResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~SearchSquaresResponse() throw();
  std::vector<Square>  squares;
...
class GetSquareFeatureSetRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareFeatureSetRequest() throw();
  std::string squareMid;
...
class GetSquareFeatureSetResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareFeatureSetResponse() throw();
  SquareFeatureSet squareFeatureSet;
...
class UpdateSquareFeatureSetRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareFeatureSetRequest() throw();
...
class UpdateSquareFeatureSetResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareFeatureSetResponse() throw();
  std::set<SquareFeatureSetAttribute::type>  updateAttributes;
  SquareFeatureSet squareFeatureSet;
...
class UpdateSquareMemberRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMemberRequest() throw();
...
class UpdateSquareMemberResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMemberResponse() throw();
  std::set<SquareMemberAttribute::type>  updatedAttrs;
  SquareMember squareMember;
  std::set<SquarePreferenceAttribute::type>  updatedPreferenceAttrs;
...
class UpdateSquareMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMembersRequest() throw();
  std::set<SquareMemberAttribute::type>  updatedAttrs;
  std::vector<SquareMember>  members;
...
class UpdateSquareMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMembersResponse() throw();
  std::set<SquareMemberAttribute::type>  updatedAttrs;
  SquareMember editor;
  std::map<std::string, SquareMember>  members;
...
class RejectSquareMembersRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RejectSquareMembersRequest() throw();
  std::string squareMid;
  std::vector<std::string>  requestedMemberMids;
...
class RejectSquareMembersResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RejectSquareMembersResponse() throw();
...
class RemoveSubscriptionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RemoveSubscriptionsRequest() throw();
...
class RemoveSubscriptionsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RemoveSubscriptionsResponse() throw();
...
class RefreshSubscriptionsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RefreshSubscriptionsRequest() throw();
...
class RefreshSubscriptionsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~RefreshSubscriptionsResponse() throw();
  int64_t ttlMillis;
...
class UpdateSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareChatRequest() throw();
...
class UpdateSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareChatResponse() throw();
  std::set<SquareChatAttribute::type>  updatedAttrs;
  SquareChat squareChat;
...
class DeleteSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareChatRequest() throw();
  std::string squareChatMid;
  int64_t revision;
...
class DeleteSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareChatResponse() throw();
...
class UpdateSquareChatMemberRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareChatMemberRequest() throw();
...
class UpdateSquareChatMemberResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareChatMemberResponse() throw();
...
class UpdateSquareAuthorityRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareAuthorityRequest() throw();
...
class UpdateSquareAuthorityResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareAuthorityResponse() throw();
...
class UpdateSquareMemberRelationRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMemberRelationRequest() throw();
  std::string squareMid;
  std::string targetSquareMemberMid;
...
class UpdateSquareMemberRelationResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateSquareMemberRelationResponse() throw();
  std::string squareMid;
  std::string targetSquareMemberMid;
  std::set<SquareMemberRelationAttribute::type>  updatedAttrs;
  SquareMemberRelation relation;
...
class ReportSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareRequest() throw();
  std::string squareMid;
...
class ReportSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareResponse() throw();
...
class ReportSquareChatRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareChatRequest() throw();
  std::string squareMid;
  std::string squareChatMid;
  ReportType::type reportType;
  std::string otherReason;
...
class ReportSquareChatResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareChatResponse() throw();
...
class ReportSquareMessageRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareMessageRequest() throw();
  std::string squareMid;
  std::string squareChatMid;
...
class ReportSquareMessageResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareMessageResponse() throw();
...
class ReportSquareMemberRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareMemberRequest() throw();
  std::string squareMemberMid;
  ReportType::type reportType;
  std::string otherReason;
  std::string squareChatMid;
...
class ReportSquareMemberResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReportSquareMemberResponse() throw();
...
class GetSquareRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareRequest() throw();
  std::string mid;
...
class GetSquareResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareResponse() throw();
  Square square;
  SquareMember myMembership;
  SquareAuthority squareAuthority;
  SquareStatus squareStatus;
...
class GetSquareStatusRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareStatusRequest() throw();
  std::string squareMid;
...
class GetSquareStatusResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareStatusResponse() throw();
  SquareStatus squareStatus;
...
class GetNoteStatusRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetNoteStatusRequest() throw();
  std::string squareMid;
...
class GetNoteStatusResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetNoteStatusResponse() throw();
  std::string squareMid;
  NoteStatus status;
...
class CreateSquareChatAnnouncementRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareChatAnnouncementRequest() throw();
  int32_t reqSeq;
  std::string squareChatMid;
...
class CreateSquareChatAnnouncementResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~CreateSquareChatAnnouncementResponse() throw();
...
class DeleteSquareChatAnnouncementRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareChatAnnouncementRequest() throw();
  std::string squareChatMid;
  int64_t announcementSeq;
...
class DeleteSquareChatAnnouncementResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~DeleteSquareChatAnnouncementResponse() throw();
...
class GetSquareChatAnnouncementsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatAnnouncementsRequest() throw();
  std::string squareChatMid;
...
class GetSquareChatAnnouncementsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetSquareChatAnnouncementsResponse() throw();
...
class GetJoinedSquareChatsRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinedSquareChatsRequest() throw();
  std::string continuationToken;
  int32_t limit;
...
class GetJoinedSquareChatsResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~GetJoinedSquareChatsResponse() throw();
...
class ShouldSyncException : public ::apache::thrift::TException {
 public:
  ...
  virtual ~ShouldSyncException() throw();
...
class UniversalNotificationServiceException : public ::apache::thrift::TException {
 public:
  ...
  virtual ~UniversalNotificationServiceException() throw();
...
class UpdateBuddyProfileResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~UpdateBuddyProfileResult() throw();
  std::string requestId;
  BuddyResultState::type state;
  int32_t eventNo;
  int64_t receiverCount;
...
typedef struct _UserAuthStatus__isset {
  _UserAuthStatus__isset() : phoneNumberRegistered(false), registeredSnsIdTypes(false), accountMigrationCheckType(false) {}
  bool phoneNumberRegistered :1;
...
class UserAuthStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  UserAuthStatus() : phoneNumberRegistered(0), accountMigrationCheckType((AccountMigrationCheckType::type)0) {
  }

  virtual ~UserAuthStatus() throw();
  bool phoneNumberRegistered;
