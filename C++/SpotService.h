...
class SpotServiceIfSingletonFactory : virtual public SpotServiceIfFactory {
 public:
  SpotServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<SpotServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<SpotServiceIf> iface_;
};
...
class SpotService_lookupByPhoneNumber_args {
 public:
  ...
  virtual ~SpotService_lookupByPhoneNumber_args() throw();
...
class SpotService_lookupByPhoneNumber_pargs {
 public:
  ...
  virtual ~SpotService_lookupByPhoneNumber_pargs() throw();
...
class SpotService_lookupByPhoneNumber_result {
 public:
  ...
  virtual ~SpotService_lookupByPhoneNumber_result() throw();
...
class SpotService_lookupByPhoneNumber_presult {
 public:
  ...
  virtual ~SpotService_lookupByPhoneNumber_presult() throw();
  SpotPhoneNumberResponse* success;
  TalkException e;
...
class SpotService_lookupNearby_args {
 public:
  ...
  virtual ~SpotService_lookupNearby_args() throw();
  Location location;
...
class SpotService_lookupNearby_pargs {
 public:
  ...
  virtual ~SpotService_lookupNearby_pargs() throw();
...
class SpotService_lookupNearby_result {
 public:
  ...
  virtual ~SpotService_lookupNearby_result() throw();
...
class SpotService_lookupNearby_presult {
 public:
  ...
  virtual ~SpotService_lookupNearby_presult() throw();
  SpotNearbyResponse* success;
  TalkException e;
...
class SpotServiceClient : virtual public SpotServiceIf {
 public:
  SpotServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SpotServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class SpotServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  SpotServiceProcessor(::apache::thrift::stdcxx::shared_ptr<SpotServiceIf> iface) :
    iface_(iface) {
...
class SpotServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  SpotServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< SpotServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< SpotServiceIfFactory > handlerFactory_;
};

class SpotServiceMultiface : virtual public SpotServiceIf {
 public:
  SpotServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<SpotServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~SpotServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<SpotServiceIf> > ifaces_;
  SpotServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<SpotServiceIf> iface) {
...
class SpotServiceConcurrentClient : virtual public SpotServiceIf {
 public:
  SpotServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SpotServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
