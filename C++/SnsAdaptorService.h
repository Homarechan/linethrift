...
class SnsAdaptorServiceIfSingletonFactory : virtual public SnsAdaptorServiceIfFactory {
 public:
  SnsAdaptorServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf> iface_;
};
...
class SnsAdaptorService_getSnsFriends_args {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsFriends_args() throw();
...
class SnsAdaptorService_getSnsFriends_pargs {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsFriends_pargs() throw();
...
class SnsAdaptorService_getSnsFriends_result {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsFriends_result() throw();
  SnsFriends success;
  TalkException e;
...
class SnsAdaptorService_getSnsFriends_presult {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsFriends_presult() throw();
  SnsFriends* success;
  TalkException e;
...
class SnsAdaptorService_getSnsMyProfile_args {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsMyProfile_args() throw();
  SnsIdType::type snsIdType;
  std::string snsAccessToken;
...
class SnsAdaptorService_getSnsMyProfile_pargs {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsMyProfile_pargs() throw();
  const SnsIdType::type* snsIdType;
  const std::string* snsAccessToken;
...
class SnsAdaptorService_getSnsMyProfile_result {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsMyProfile_result() throw();
  SnsProfile success;
  TalkException e;
...
class SnsAdaptorService_getSnsMyProfile_presult {
 public:
  ...
  virtual ~SnsAdaptorService_getSnsMyProfile_presult() throw();
  SnsProfile* success;
  TalkException e;
...
class SnsAdaptorService_postSnsInvitationMessage_args {
 public:
  ...
  virtual ~SnsAdaptorService_postSnsInvitationMessage_args() throw();
  SnsIdType::type snsIdType;
  std::string snsAccessToken;
...
class SnsAdaptorService_postSnsInvitationMessage_pargs {
 public:
  ...
  virtual ~SnsAdaptorService_postSnsInvitationMessage_pargs() throw();
  const SnsIdType::type* snsIdType;
  const std::string* snsAccessToken;
...
class SnsAdaptorService_postSnsInvitationMessage_result {
 public:
  ...
  virtual ~SnsAdaptorService_postSnsInvitationMessage_result() throw();
  TalkException e;
...
class SnsAdaptorService_postSnsInvitationMessage_presult {
 public:
  ...
  virtual ~SnsAdaptorService_postSnsInvitationMessage_presult() throw();
  TalkException e;
...
class SnsAdaptorServiceClient : virtual public SnsAdaptorServiceIf {
 public:
  SnsAdaptorServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SnsAdaptorServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class SnsAdaptorServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  SnsAdaptorServiceProcessor(::apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf> iface) :
    iface_(iface) {
...
class SnsAdaptorServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  SnsAdaptorServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< SnsAdaptorServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< SnsAdaptorServiceIfFactory > handlerFactory_;
};

class SnsAdaptorServiceMultiface : virtual public SnsAdaptorServiceIf {
 public:
  SnsAdaptorServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~SnsAdaptorServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf> > ifaces_;
  SnsAdaptorServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<SnsAdaptorServiceIf> iface) {
...
class SnsAdaptorServiceConcurrentClient : virtual public SnsAdaptorServiceIf {
 public:
  SnsAdaptorServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SnsAdaptorServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
