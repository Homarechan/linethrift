...
class AuthService_normalizePhoneNumber_args {
 public:
  ...
  virtual ~AuthService_normalizePhoneNumber_args() noexcept;
...
class AuthService_normalizePhoneNumber_pargs {
 public:
  ...
  virtual ~AuthService_normalizePhoneNumber_pargs() noexcept;
...
class AuthService_normalizePhoneNumber_result {
 public:
  ...
  virtual ~AuthService_normalizePhoneNumber_result() noexcept;
  std::string success;
  TalkException e;
...
class AuthService_normalizePhoneNumber_presult {
 public:
  ...
  virtual ~AuthService_normalizePhoneNumber_presult() noexcept;
  std::string* success;
  TalkException e;
...
class AuthService_respondE2EELoginRequest_args {
 public:
  ...
  virtual ~AuthService_respondE2EELoginRequest_args() noexcept;
  std::string verifier;
...
class AuthService_respondE2EELoginRequest_pargs {
 public:
  ...
  virtual ~AuthService_respondE2EELoginRequest_pargs() noexcept;
...
class AuthService_respondE2EELoginRequest_result {
 public:
  ...
  virtual ~AuthService_respondE2EELoginRequest_result() noexcept;
  TalkException e;
...
class AuthService_respondE2EELoginRequest_presult {
 public:
  ...
  virtual ~AuthService_respondE2EELoginRequest_presult() noexcept;
  TalkException e;
...
class AuthService_confirmE2EELogin_args {
 public:
  ...
  virtual ~AuthService_confirmE2EELogin_args() noexcept;
  std::string verifier;
...
class AuthService_confirmE2EELogin_pargs {
 public:
  ...
  virtual ~AuthService_confirmE2EELogin_pargs() noexcept;
  const std::string* verifier;
...
class AuthService_confirmE2EELogin_result {
 public:
  ...
  virtual ~AuthService_confirmE2EELogin_result() noexcept;
  std::string success;
  TalkException e;
...
class AuthService_confirmE2EELogin_presult {
 public:
  ...
  virtual ~AuthService_confirmE2EELogin_presult() noexcept;
  std::string* success;
  TalkException e;
...
class AuthService_logoutZ_args {
 public:
  ...
  virtual ~AuthService_logoutZ_args() noexcept;
...
class AuthService_logoutZ_pargs {
 public:
  ...
  virtual ~AuthService_logoutZ_pargs() noexcept;
...
class AuthService_logoutZ_result {
 public:
  ...
  virtual ~AuthService_logoutZ_result() noexcept;
  TalkException e;
...
class AuthService_logoutZ_presult {
 public:
  ...
  virtual ~AuthService_logoutZ_presult() noexcept;
  TalkException e;
...
class AuthService_loginZ_args {
 public:
  ...
  virtual ~AuthService_loginZ_args() noexcept;
...
class AuthService_loginZ_pargs {
 public:
  ...
  virtual ~AuthService_loginZ_pargs() noexcept;
...
class AuthService_loginZ_result {
 public:
  ...
  virtual ~AuthService_loginZ_result() noexcept;
  LoginResult success;
  TalkException e;
...
class AuthService_loginZ_presult {
 public:
  ...
  virtual ~AuthService_loginZ_presult() noexcept;
  LoginResult* success;
  TalkException e;
...
class AuthService_issueTokenForAccountMigrationSettings_args {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigrationSettings_args() noexcept;
  bool enforce;
...
class AuthService_issueTokenForAccountMigrationSettings_pargs {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigrationSettings_pargs() noexcept;
  const bool* enforce;
...
class AuthService_issueTokenForAccountMigrationSettings_result {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigrationSettings_result() noexcept;
...
class AuthService_issueTokenForAccountMigrationSettings_presult {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigrationSettings_presult() noexcept;
  SecurityCenterResult* success;
  TalkException e;
...
class AuthService_issueTokenForAccountMigration_args {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigration_args() noexcept;
...
class AuthService_issueTokenForAccountMigration_pargs {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigration_pargs() noexcept;
...
class AuthService_issueTokenForAccountMigration_result {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigration_result() noexcept;
  SecurityCenterResult success;
  TalkException e;
...
class AuthService_issueTokenForAccountMigration_presult {
 public:
  ...
  virtual ~AuthService_issueTokenForAccountMigration_presult() noexcept;
  SecurityCenterResult* success;
  TalkException e;
...
class AuthService_verifyQrcodeWithE2EE_args {
 public:
  ...
  virtual ~AuthService_verifyQrcodeWithE2EE_args() noexcept;
  std::string verifier;
  std::string pinCode;
  ErrorCode::type errorCode;
  E2EEPublicKey publicKey;
...
class AuthService_verifyQrcodeWithE2EE_pargs {
 public:
  ...
  virtual ~AuthService_verifyQrcodeWithE2EE_pargs() noexcept;
  const std::string* verifier;
...
class AuthService_verifyQrcodeWithE2EE_result {
 public:
  ...
  virtual ~AuthService_verifyQrcodeWithE2EE_result() noexcept;
  std::string success;
  TalkException e;
...
class AuthService_verifyQrcodeWithE2EE_presult {
 public:
  ...
  virtual ~AuthService_verifyQrcodeWithE2EE_presult() noexcept;
  std::string* success;
  TalkException e;
...
class AuthServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  AuthServiceProcessorFactory(const ::std::shared_ptr< AuthServiceIfFactory >& handlerFactory) :
