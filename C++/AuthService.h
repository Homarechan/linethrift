...
class AuthServiceIf {
 public:
  ...
  virtual void updatePassword(IdentityCredentialResponse& _return, const std::string& authSessionId, const IdentityCredentialRequest& request) = 0;
  virtual void getAuthRSAKey(RSAKey& _return, const std::string& authSessionId, const IdentityProvider::type identityProvider) = 0;
  virtual void openAuthSession(std::string& _return, const AuthSessionRequest& request) = 0;
...
typedef struct _AuthService_updatePassword_args__isset {
  _AuthService_updatePassword_args__isset() : authSessionId(false), request(false) {}
  bool authSessionId :1;
  bool request :1;
} _AuthService_updatePassword_args__isset;

class AuthService_updatePassword_args {
 public:

  AuthService_updatePassword_args(const AuthService_updatePassword_args&);
  AuthService_updatePassword_args& operator=(const AuthService_updatePassword_args&);
  AuthService_updatePassword_args() : authSessionId() {
  }

  virtual ~AuthService_updatePassword_args() throw();
  std::string authSessionId;
  IdentityCredentialRequest request;

  _AuthService_updatePassword_args__isset __isset;

  void __set_authSessionId(const std::string& val);

  void __set_request(const IdentityCredentialRequest& val);

  bool operator == (const AuthService_updatePassword_args & rhs) const
  {
  ...
  bool operator < (const AuthService_updatePassword_args & ) const;
...
class AuthService_updatePassword_pargs {
 public:


  virtual ~AuthService_updatePassword_pargs() throw();
  const std::string* authSessionId;
  const IdentityCredentialRequest* request;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _AuthService_updatePassword_result__isset {
  _AuthService_updatePassword_result__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_updatePassword_result__isset;

class AuthService_updatePassword_result {
 public:

  AuthService_updatePassword_result(const AuthService_updatePassword_result&);
  AuthService_updatePassword_result& operator=(const AuthService_updatePassword_result&);
  AuthService_updatePassword_result() {
  }

  virtual ~AuthService_updatePassword_result() throw();
  IdentityCredentialResponse success;
  TalkException e;

  _AuthService_updatePassword_result__isset __isset;

  void __set_success(const IdentityCredentialResponse& val);

  void __set_e(const TalkException& val);

  bool operator == (const AuthService_updatePassword_result & rhs) const
  {
  ...
  bool operator < (const AuthService_updatePassword_result & ) const;
...
typedef struct _AuthService_updatePassword_presult__isset {
  _AuthService_updatePassword_presult__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_updatePassword_presult__isset;

class AuthService_updatePassword_presult {
 public:


  virtual ~AuthService_updatePassword_presult() throw();
  IdentityCredentialResponse* success;
  TalkException e;

  _AuthService_updatePassword_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _AuthService_getAuthRSAKey_args__isset {
  _AuthService_getAuthRSAKey_args__isset() : authSessionId(false), identityProvider(false) {}
  bool authSessionId :1;
  bool identityProvider :1;
} _AuthService_getAuthRSAKey_args__isset;

class AuthService_getAuthRSAKey_args {
 public:

  AuthService_getAuthRSAKey_args(const AuthService_getAuthRSAKey_args&);
  AuthService_getAuthRSAKey_args& operator=(const AuthService_getAuthRSAKey_args&);
  AuthService_getAuthRSAKey_args() : authSessionId(), identityProvider((IdentityProvider::type)0) {
  }

  virtual ~AuthService_getAuthRSAKey_args() throw();
  std::string authSessionId;
  IdentityProvider::type identityProvider;

  _AuthService_getAuthRSAKey_args__isset __isset;

  void __set_authSessionId(const std::string& val);

  void __set_identityProvider(const IdentityProvider::type val);

  bool operator == (const AuthService_getAuthRSAKey_args & rhs) const
  {
    if (!(authSessionId == rhs.authSessionId))
      return false;
  ...
  bool operator < (const AuthService_getAuthRSAKey_args & ) const;
...
class AuthService_getAuthRSAKey_pargs {
 public:


  virtual ~AuthService_getAuthRSAKey_pargs() throw();
  const std::string* authSessionId;
...
typedef struct _AuthService_getAuthRSAKey_result__isset {
  _AuthService_getAuthRSAKey_result__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_getAuthRSAKey_result__isset;

class AuthService_getAuthRSAKey_result {
 public:

  AuthService_getAuthRSAKey_result(const AuthService_getAuthRSAKey_result&);
  AuthService_getAuthRSAKey_result& operator=(const AuthService_getAuthRSAKey_result&);
  AuthService_getAuthRSAKey_result() {
  }

  virtual ~AuthService_getAuthRSAKey_result() throw();
  RSAKey success;
  TalkException e;

  _AuthService_getAuthRSAKey_result__isset __isset;

  void __set_success(const RSAKey& val);

  void __set_e(const TalkException& val);

  bool operator == (const AuthService_getAuthRSAKey_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(e == rhs.e))
  ...
  bool operator < (const AuthService_getAuthRSAKey_result & ) const;
...
typedef struct _AuthService_getAuthRSAKey_presult__isset {
  _AuthService_getAuthRSAKey_presult__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_getAuthRSAKey_presult__isset;

class AuthService_getAuthRSAKey_presult {
 public:


  virtual ~AuthService_getAuthRSAKey_presult() throw();
  RSAKey* success;
  TalkException e;

  _AuthService_getAuthRSAKey_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _AuthService_openAuthSession_args__isset {
  _AuthService_openAuthSession_args__isset() : request(false) {}
  bool request :1;
} _AuthService_openAuthSession_args__isset;

class AuthService_openAuthSession_args {
 public:

  AuthService_openAuthSession_args(const AuthService_openAuthSession_args&);
  AuthService_openAuthSession_args& operator=(const AuthService_openAuthSession_args&);
  AuthService_openAuthSession_args() {
  }

  virtual ~AuthService_openAuthSession_args() throw();
  AuthSessionRequest request;

  _AuthService_openAuthSession_args__isset __isset;

  void __set_request(const AuthSessionRequest& val);

  bool operator == (const AuthService_openAuthSession_args & rhs) const
  {
    if (!(request == rhs.request))
      return false;
    return true;
  ...
  bool operator < (const AuthService_openAuthSession_args & ) const;
...
class AuthService_openAuthSession_pargs {
 public:


  virtual ~AuthService_openAuthSession_pargs() throw();
  const AuthSessionRequest* request;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _AuthService_openAuthSession_result__isset {
  _AuthService_openAuthSession_result__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_openAuthSession_result__isset;

class AuthService_openAuthSession_result {
 public:

  AuthService_openAuthSession_result(const AuthService_openAuthSession_result&);
  AuthService_openAuthSession_result& operator=(const AuthService_openAuthSession_result&);
  AuthService_openAuthSession_result() : success() {
  }

  virtual ~AuthService_openAuthSession_result() throw();
  std::string success;
  TalkException e;

  _AuthService_openAuthSession_result__isset __isset;

  void __set_success(const std::string& val);

  void __set_e(const TalkException& val);

  bool operator == (const AuthService_openAuthSession_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(e == rhs.e))
  ...
  bool operator < (const AuthService_openAuthSession_result & ) const;
...
typedef struct _AuthService_openAuthSession_presult__isset {
  _AuthService_openAuthSession_presult__isset() : success(false), e(false) {}
  bool success :1;
  bool e :1;
} _AuthService_openAuthSession_presult__isset;

class AuthService_openAuthSession_presult {
 public:


  virtual ~AuthService_openAuthSession_presult() throw();
  std::string* success;
  TalkException e;

  _AuthService_openAuthSession_presult__isset __isset;
...
class AuthServiceClient : virtual public AuthServiceIf {
 ...
 public:
  ...
  void updatePassword(IdentityCredentialResponse& _return, const std::string& authSessionId, const IdentityCredentialRequest& request);
  void send_updatePassword(const std::string& authSessionId, const IdentityCredentialRequest& request);
  void recv_updatePassword(IdentityCredentialResponse& _return);
  void getAuthRSAKey(RSAKey& _return, const std::string& authSessionId, const IdentityProvider::type identityProvider);
  void send_getAuthRSAKey(const std::string& authSessionId, const IdentityProvider::type identityProvider);
  void recv_getAuthRSAKey(RSAKey& _return);
  void openAuthSession(std::string& _return, const AuthSessionRequest& request);
  void send_openAuthSession(const AuthSessionRequest& request);
  void recv_openAuthSession(std::string& _return);
  void normalizePhoneNumber(std::string& _return, const std::string& countryCode, const std::string& phoneNumber, const std::string& countryCodeHint);
...
class AuthServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_getAuthRSAKey(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_openAuthSession(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  AuthServiceProcessor(::apache::thrift::stdcxx::shared_ptr<AuthServiceIf> iface) :
    iface_(iface) {
    processMap_["updatePassword"] = &AuthServiceProcessor::process_updatePassword;
    processMap_["getAuthRSAKey"] = &AuthServiceProcessor::process_getAuthRSAKey;
    processMap_["openAuthSession"] = &AuthServiceProcessor::process_openAuthSession;
...
class AuthServiceMultiface : virtual public AuthServiceIf {
 ...
 public:
  void updatePassword(IdentityCredentialResponse& _return, const std::string& authSessionId, const IdentityCredentialRequest& request) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->updatePassword(_return, authSessionId, request);
    }
    ifaces_[i]->updatePassword(_return, authSessionId, request);
    return;
  }
  ...
  void getAuthRSAKey(RSAKey& _return, const std::string& authSessionId, const IdentityProvider::type identityProvider) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getAuthRSAKey(_return, authSessionId, identityProvider);
    }
    ifaces_[i]->getAuthRSAKey(_return, authSessionId, identityProvider);
    return;
  }
  ...
  void openAuthSession(std::string& _return, const AuthSessionRequest& request) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->openAuthSession(_return, request);
    }
    ifaces_[i]->openAuthSession(_return, request);
    return;
  }
...
class AuthServiceConcurrentClient : virtual public AuthServiceIf {
 ...
 public:
  ...
  void updatePassword(IdentityCredentialResponse& _return, const std::string& authSessionId, const IdentityCredentialRequest& request);
  int32_t send_updatePassword(const std::string& authSessionId, const IdentityCredentialRequest& request);
  void recv_updatePassword(IdentityCredentialResponse& _return, const int32_t seqid);
  void getAuthRSAKey(RSAKey& _return, const std::string& authSessionId, const IdentityProvider::type identityProvider);
  int32_t send_getAuthRSAKey(const std::string& authSessionId, const IdentityProvider::type identityProvider);
  void recv_getAuthRSAKey(RSAKey& _return, const int32_t seqid);
  void openAuthSession(std::string& _return, const AuthSessionRequest& request);
  int32_t send_openAuthSession(const AuthSessionRequest& request);
  void recv_openAuthSession(std::string& _return, const int32_t seqid);
  void normalizePhoneNumber(std::string& _return, const std::string& countryCode, const std::string& phoneNumber, const std::string& countryCodeHint);
