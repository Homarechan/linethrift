...
AgeCheckService_checkUserAge_args::~AgeCheckService_checkUserAge_args() throw() {
}
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1887;
          xfer += iprot->readI32(ecast1887);
          this->carrier = (CarrierCode::type)ecast1887;
...
AgeCheckService_checkUserAge_pargs::~AgeCheckService_checkUserAge_pargs() throw() {
}
...
AgeCheckService_checkUserAge_result::~AgeCheckService_checkUserAge_result() throw() {
}
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (UserAgeType::type)ecast1888;
...
AgeCheckService_checkUserAge_presult::~AgeCheckService_checkUserAge_presult() throw() {
}
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1889;
          xfer += iprot->readI32(ecast1889);
          (*(this->success)) = (UserAgeType::type)ecast1889;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
AgeCheckService_checkUserAgeWithDocomo_args::~AgeCheckService_checkUserAgeWithDocomo_args() throw() {
}
...
AgeCheckService_checkUserAgeWithDocomo_pargs::~AgeCheckService_checkUserAgeWithDocomo_pargs() throw() {
}
...
AgeCheckService_checkUserAgeWithDocomo_result::~AgeCheckService_checkUserAgeWithDocomo_result() throw() {
}
...
AgeCheckService_checkUserAgeWithDocomo_presult::~AgeCheckService_checkUserAgeWithDocomo_presult() throw() {
}
...
AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_args::~AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_args() throw() {
}
...
AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_pargs::~AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_pargs() throw() {
}
...
AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result::~AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result() throw() {
}
...
AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_presult::~AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_presult() throw() {
}
...
AgeCheckService_retrieveRequestToken_args::~AgeCheckService_retrieveRequestToken_args() throw() {
}
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1890;
          xfer += iprot->readI32(ecast1890);
          this->carrier = (CarrierCode::type)ecast1890;
          this->__isset.carrier = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
AgeCheckService_retrieveRequestToken_pargs::~AgeCheckService_retrieveRequestToken_pargs() throw() {
}
...
AgeCheckService_retrieveRequestToken_result::~AgeCheckService_retrieveRequestToken_result() throw() {
}
...
AgeCheckService_retrieveRequestToken_presult::~AgeCheckService_retrieveRequestToken_presult() throw() {
}
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > AgeCheckServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< AgeCheckServiceIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< AgeCheckServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new AgeCheckServiceProcessor(handler));
  return processor;
}
