...
class UniversalNotificationServiceIfSingletonFactory : virtual public UniversalNotificationServiceIfFactory {
 public:
  UniversalNotificationServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf> iface_;
};
...
class UniversalNotificationService_notify_args {
 public:
  ...
  virtual ~UniversalNotificationService_notify_args() throw();
  GlobalEvent event;
...
class UniversalNotificationService_notify_pargs {
 public:
  ...
  virtual ~UniversalNotificationService_notify_pargs() throw();
...
class UniversalNotificationService_notify_result {
 public:
  ...
  virtual ~UniversalNotificationService_notify_result() throw();
...
class UniversalNotificationService_notify_presult {
 public:
  ...
  virtual ~UniversalNotificationService_notify_presult() throw();
  UniversalNotificationServiceException e;
...
class UniversalNotificationServiceClient : virtual public UniversalNotificationServiceIf {
 public:
  UniversalNotificationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UniversalNotificationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class UniversalNotificationServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  UniversalNotificationServiceProcessor(::apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf> iface) :
    iface_(iface) {
...
class UniversalNotificationServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UniversalNotificationServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< UniversalNotificationServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< UniversalNotificationServiceIfFactory > handlerFactory_;
};

class UniversalNotificationServiceMultiface : virtual public UniversalNotificationServiceIf {
 public:
  UniversalNotificationServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~UniversalNotificationServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf> > ifaces_;
  UniversalNotificationServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<UniversalNotificationServiceIf> iface) {
...
class UniversalNotificationServiceConcurrentClient : virtual public UniversalNotificationServiceIf {
 public:
  UniversalNotificationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UniversalNotificationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
