    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast2394;
          xfer += iprot->readI32(ecast2394);
          this->snsIdType = (SnsIdType::type)ecast2394;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast2395;
          xfer += iprot->readI32(ecast2395);
          this->snsIdType = (SnsIdType::type)ecast2395;
          this->__isset.snsIdType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast2396;
          xfer += iprot->readI32(ecast2396);
          this->snsIdType = (SnsIdType::type)ecast2396;
          this->__isset.snsIdType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
