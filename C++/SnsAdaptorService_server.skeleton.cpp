...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<SnsAdaptorServiceHandler> handler(new SnsAdaptorServiceHandler());
  ::std::shared_ptr<TProcessor> processor(new SnsAdaptorServiceProcessor(handler));
