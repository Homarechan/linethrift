...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<BuddyServiceHandler> handler(new BuddyServiceHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new BuddyServiceProcessor(handler));
