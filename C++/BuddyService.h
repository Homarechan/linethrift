...
class BuddyServiceIfSingletonFactory : virtual public BuddyServiceIfFactory {
 public:
  BuddyServiceIfSingletonFactory(const ::std::shared_ptr<BuddyServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<BuddyServiceIf> iface_;
};
...
class BuddyService_findBuddyContactsByQuery_args {
 public:
  ...
  virtual ~BuddyService_findBuddyContactsByQuery_args() noexcept;
  std::string language;
  std::string country;
  std::string query;
  int32_t fromIndex;
...
class BuddyService_findBuddyContactsByQuery_pargs {
 public:
  ...
  virtual ~BuddyService_findBuddyContactsByQuery_pargs() noexcept;
...
class BuddyService_findBuddyContactsByQuery_result {
 public:
  ...
  virtual ~BuddyService_findBuddyContactsByQuery_result() noexcept;
...
class BuddyService_findBuddyContactsByQuery_presult {
 public:
  ...
  virtual ~BuddyService_findBuddyContactsByQuery_presult() noexcept;
  std::vector<BuddySearchResult> * success;
  TalkException e;
...
class BuddyService_getBuddyContacts_args {
 public:
  ...
  virtual ~BuddyService_getBuddyContacts_args() noexcept;
  std::string language;
  std::string country;
...
class BuddyService_getBuddyContacts_pargs {
 public:
  ...
  virtual ~BuddyService_getBuddyContacts_pargs() noexcept;
  const std::string* language;
  const std::string* country;
...
class BuddyService_getBuddyContacts_result {
 public:
  ...
  virtual ~BuddyService_getBuddyContacts_result() noexcept;
...
class BuddyService_getBuddyContacts_presult {
 public:
  ...
  virtual ~BuddyService_getBuddyContacts_presult() noexcept;
  std::vector<Contact> * success;
  TalkException e;
...
class BuddyService_getBuddyDetail_args {
 public:
  ...
  virtual ~BuddyService_getBuddyDetail_args() noexcept;
  std::string buddyMid;
...
class BuddyService_getBuddyDetail_pargs {
 public:
  ...
  virtual ~BuddyService_getBuddyDetail_pargs() noexcept;
...
class BuddyService_getBuddyDetail_result {
 public:
  ...
  virtual ~BuddyService_getBuddyDetail_result() noexcept;
  BuddyDetail success;
  TalkException e;
...
class BuddyService_getBuddyDetail_presult {
 public:
  ...
  virtual ~BuddyService_getBuddyDetail_presult() noexcept;
  BuddyDetail* success;
  TalkException e;
...
class BuddyService_getBuddyOnAir_args {
 public:
  ...
  virtual ~BuddyService_getBuddyOnAir_args() noexcept;
  std::string buddyMid;
...
class BuddyService_getBuddyOnAir_pargs {
 public:
  ...
  virtual ~BuddyService_getBuddyOnAir_pargs() noexcept;
  const std::string* buddyMid;
...
class BuddyService_getBuddyOnAir_result {
 public:
  ...
  virtual ~BuddyService_getBuddyOnAir_result() noexcept;
  BuddyOnAir success;
  TalkException e;
...
class BuddyService_getBuddyOnAir_presult {
 public:
  ...
  virtual ~BuddyService_getBuddyOnAir_presult() noexcept;
  BuddyOnAir* success;
  TalkException e;
...
class BuddyService_getCountriesHavingBuddy_args {
 public:
  ...
  virtual ~BuddyService_getCountriesHavingBuddy_args() noexcept;
...
class BuddyService_getCountriesHavingBuddy_pargs {
 public:
  ...
  virtual ~BuddyService_getCountriesHavingBuddy_pargs() noexcept;
...
class BuddyService_getCountriesHavingBuddy_result {
 public:
  ...
  virtual ~BuddyService_getCountriesHavingBuddy_result() noexcept;
...
class BuddyService_getCountriesHavingBuddy_presult {
 public:
  ...
  virtual ~BuddyService_getCountriesHavingBuddy_presult() noexcept;
  std::vector<std::string> * success;
  TalkException e;
...
class BuddyService_getNewlyReleasedBuddyIds_args {
 public:
  ...
  virtual ~BuddyService_getNewlyReleasedBuddyIds_args() noexcept;
  std::string country;
...
class BuddyService_getNewlyReleasedBuddyIds_pargs {
 public:
  ...
  virtual ~BuddyService_getNewlyReleasedBuddyIds_pargs() noexcept;
  const std::string* country;
...
class BuddyService_getNewlyReleasedBuddyIds_result {
 public:
  ...
  virtual ~BuddyService_getNewlyReleasedBuddyIds_result() noexcept;
...
class BuddyService_getNewlyReleasedBuddyIds_presult {
 public:
  ...
  virtual ~BuddyService_getNewlyReleasedBuddyIds_presult() noexcept;
  std::map<std::string, int64_t> * success;
  TalkException e;
...
class BuddyService_getPopularBuddyBanner_args {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyBanner_args() noexcept;
  std::string language;
  std::string country;
...
class BuddyService_getPopularBuddyBanner_pargs {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyBanner_pargs() noexcept;
  const std::string* language;
  const std::string* country;
...
class BuddyService_getPopularBuddyBanner_result {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyBanner_result() noexcept;
  BuddyBanner success;
  TalkException e;
...
class BuddyService_getPopularBuddyBanner_presult {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyBanner_presult() noexcept;
  BuddyBanner* success;
  TalkException e;
...
class BuddyService_getPopularBuddyLists_args {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyLists_args() noexcept;
  std::string language;
  std::string country;
...
class BuddyService_getPopularBuddyLists_pargs {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyLists_pargs() noexcept;
  const std::string* language;
  const std::string* country;
...
class BuddyService_getPopularBuddyLists_result {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyLists_result() noexcept;
...
class BuddyService_getPopularBuddyLists_presult {
 public:
  ...
  virtual ~BuddyService_getPopularBuddyLists_presult() noexcept;
  std::vector<BuddyList> * success;
  TalkException e;
...
class BuddyService_getPromotedBuddyContacts_args {
 public:
  ...
  virtual ~BuddyService_getPromotedBuddyContacts_args() noexcept;
  std::string language;
  std::string country;
...
class BuddyService_getPromotedBuddyContacts_pargs {
 public:
  ...
  virtual ~BuddyService_getPromotedBuddyContacts_pargs() noexcept;
  const std::string* language;
  const std::string* country;
...
class BuddyService_getPromotedBuddyContacts_result {
 public:
  ...
  virtual ~BuddyService_getPromotedBuddyContacts_result() noexcept;
  std::vector<Contact>  success;
  TalkException e;
...
class BuddyService_getPromotedBuddyContacts_presult {
 public:
  ...
  virtual ~BuddyService_getPromotedBuddyContacts_presult() noexcept;
  std::vector<Contact> * success;
  TalkException e;
...
class BuddyServiceClient : virtual public BuddyServiceIf {
 public:
  BuddyServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  BuddyServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class BuddyServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  BuddyServiceProcessor(::std::shared_ptr<BuddyServiceIf> iface) :
    iface_(iface) {
...
class BuddyServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  BuddyServiceProcessorFactory(const ::std::shared_ptr< BuddyServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< BuddyServiceIfFactory > handlerFactory_;
};

class BuddyServiceMultiface : virtual public BuddyServiceIf {
 public:
  BuddyServiceMultiface(std::vector<std::shared_ptr<BuddyServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~BuddyServiceMultiface() {}
 protected:
  std::vector<std::shared_ptr<BuddyServiceIf> > ifaces_;
  BuddyServiceMultiface() {}
  void add(::std::shared_ptr<BuddyServiceIf> iface) {
...
class BuddyServiceConcurrentClient : virtual public BuddyServiceIf {
 public:
  BuddyServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  BuddyServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
