...
public partial class UpdateSquareChatResponse : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          case 1:
            ...
            {
              {
                TSet _set475 = await iprot.ReadSetBeginAsync(cancellationToken);
                UpdatedAttrs = new THashSet<SquareChatAttribute>(_set475.Count);
                for(int _i476 = 0; _i476 < _set475.Count; ++_i476)
                {
                  SquareChatAttribute _elem477;
                  _elem477 = (SquareChatAttribute)await iprot.ReadI32Async(cancellationToken);
                  UpdatedAttrs.Add(_elem477);
                }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("UpdateSquareChatResponse");
      ...
      if (UpdatedAttrs != null && __isset.updatedAttrs)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (SquareChatAttribute _iter478 in UpdatedAttrs)
          {
            await oprot.WriteI32Async((int)_iter478, cancellationToken);
          }
  ...
  {
    var other = that as UpdateSquareChatResponse;
  ...
  {
    var sb = new StringBuilder("UpdateSquareChatResponse(");
    bool __first = true;
    if (UpdatedAttrs != null && __isset.updatedAttrs)
    {
