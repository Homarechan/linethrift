...
public partial class LeaveSquareRequest : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("LeaveSquareRequest");
  ...
  {
    var other = that as LeaveSquareRequest;
  ...
  {
    var sb = new StringBuilder("LeaveSquareRequest(");
    bool __first = true;
    if (SquareMid != null && __isset.squareMid)
    {
