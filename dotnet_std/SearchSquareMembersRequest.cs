...
public partial class SearchSquareMembersRequest : TBase
{
  ...
  {
    var other = that as SearchSquareMembersRequest;
    ...
    return ((__isset.squareMid == other.__isset.squareMid) && ((!__isset.squareMid) || (System.Object.Equals(SquareMid, other.SquareMid))))
      && ((__isset.searchOption == other.__isset.searchOption) && ((!__isset.searchOption) || (System.Object.Equals(SearchOption, other.SearchOption))))
  ...
  public override int GetHashCode() {
    ...
    unchecked {
      ...
      if(__isset.searchOption)
        hashcode = (hashcode * 397) + SearchOption.GetHashCode();
