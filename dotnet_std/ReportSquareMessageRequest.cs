...
public partial class ReportSquareMessageRequest : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 4:
            if (field.Type == TType.String)
            {
              SquareMessageId = await iprot.ReadStringAsync(cancellationToken);
            }
            else
            {
              await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("ReportSquareMessageRequest");
      ...
      if (SquareMessageId != null && __isset.squareMessageId)
      {
        ...
        field.ID = 4;
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        await oprot.WriteStringAsync(SquareMessageId, cancellationToken);
        await oprot.WriteFieldEndAsync(cancellationToken);
      }
  ...
  {
    var other = that as ReportSquareMessageRequest;
    ...
    return ((__isset.squareMid == other.__isset.squareMid) && ((!__isset.squareMid) || (System.Object.Equals(SquareMid, other.SquareMid))))
      ...
      && ((__isset.squareMessageId == other.__isset.squareMessageId) && ((!__isset.squareMessageId) || (System.Object.Equals(SquareMessageId, other.SquareMessageId))))
