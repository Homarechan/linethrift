...
public partial class GetSquareStatusRequest : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("GetSquareStatusRequest");
  ...
  {
    var other = that as GetSquareStatusRequest;
  ...
  {
    var sb = new StringBuilder("GetSquareStatusRequest(");
    bool __first = true;
    if (SquareMid != null && __isset.squareMid)
    {
