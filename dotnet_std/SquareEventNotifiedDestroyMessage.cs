...
public partial class SquareEventNotifiedDestroyMessage : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotifiedDestroyMessage");
  ...
  {
    var other = that as SquareEventNotifiedDestroyMessage;
  ...
  {
    var sb = new StringBuilder("SquareEventNotifiedDestroyMessage(");
    bool __first = true;
    if (SquareChatMid != null && __isset.squareChatMid)
    {
