...
public partial class SquareEventNotifiedMarkAsRead : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 2:
            if (field.Type == TType.String)
            {
              SMemberMid = await iprot.ReadStringAsync(cancellationToken);
            }
            else
            {
              await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotifiedMarkAsRead");
      ...
      if (SMemberMid != null && __isset.sMemberMid)
      {
        ...
        field.ID = 2;
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        await oprot.WriteStringAsync(SMemberMid, cancellationToken);
        await oprot.WriteFieldEndAsync(cancellationToken);
      }
  ...
  {
    var other = that as SquareEventNotifiedMarkAsRead;
    ...
    return ((__isset.squareChatMid == other.__isset.squareChatMid) && ((!__isset.squareChatMid) || (System.Object.Equals(SquareChatMid, other.SquareChatMid))))
      && ((__isset.sMemberMid == other.__isset.sMemberMid) && ((!__isset.sMemberMid) || (System.Object.Equals(SMemberMid, other.SMemberMid))))
  ...
  public override int GetHashCode() {
    ...
    unchecked {
      ...
      if(__isset.sMemberMid)
        hashcode = (hashcode * 397) + SMemberMid.GetHashCode();
