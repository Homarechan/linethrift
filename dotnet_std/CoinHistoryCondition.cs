...
public partial class CoinHistoryCondition : TBase
{
  ...
  {
    var other = that as CoinHistoryCondition;
    ...
    return ((__isset.start == other.__isset.start) && ((!__isset.start) || (System.Object.Equals(Start, other.Start))))
      ...
      && ((__isset.eddt == other.__isset.eddt) && ((!__isset.eddt) || (System.Object.Equals(Eddt, other.Eddt))))
  ...
  public override int GetHashCode() {
    ...
    unchecked {
      ...
      if(__isset.eddt)
        hashcode = (hashcode * 397) + Eddt.GetHashCode();
      if(__isset.appStoreCode)
