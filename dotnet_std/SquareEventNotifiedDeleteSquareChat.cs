...
public partial class SquareEventNotifiedDeleteSquareChat : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotifiedDeleteSquareChat");
  ...
  {
    var other = that as SquareEventNotifiedDeleteSquareChat;
  ...
  {
    var sb = new StringBuilder("SquareEventNotifiedDeleteSquareChat(");
    bool __first = true;
    if (SquareChat != null && __isset.squareChat)
    {
