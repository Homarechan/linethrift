...
public partial class UpdateSquareMemberRelationResponse : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 3:
            ...
            {
              {
                TSet _set495 = await iprot.ReadSetBeginAsync(cancellationToken);
                UpdatedAttrs = new THashSet<SquareMemberRelationAttribute>(_set495.Count);
                for(int _i496 = 0; _i496 < _set495.Count; ++_i496)
                {
                  SquareMemberRelationAttribute _elem497;
                  _elem497 = (SquareMemberRelationAttribute)await iprot.ReadI32Async(cancellationToken);
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("UpdateSquareMemberRelationResponse");
      ...
      if (UpdatedAttrs != null && __isset.updatedAttrs)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          {
            await oprot.WriteI32Async((int)_iter498, cancellationToken);
          }
  ...
  {
    var other = that as UpdateSquareMemberRelationResponse;
