...
public partial class GetSquareChatAnnouncementsRequest : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("GetSquareChatAnnouncementsRequest");
  ...
  {
    var other = that as GetSquareChatAnnouncementsRequest;
  ...
  {
    var sb = new StringBuilder("GetSquareChatAnnouncementsRequest(");
    bool __first = true;
    if (SquareChatMid != null && __isset.squareChatMid)
    {
