...
public partial class UpdateSquareChatMemberResponse : TBase
{
  ...
  {
    var other = that as UpdateSquareChatMemberResponse;
    if (other == null) return false;
    if (ReferenceEquals(this, other)) return true;
    return ((__isset.updatedChatMember == other.__isset.updatedChatMember) && ((!__isset.updatedChatMember) || (System.Object.Equals(UpdatedChatMember, other.UpdatedChatMember))));
  }

  public override int GetHashCode() {
    int hashcode = 157;
    unchecked {
      if(__isset.updatedChatMember)
        hashcode = (hashcode * 397) + UpdatedChatMember.GetHashCode();
    }
    return hashcode;
  }
