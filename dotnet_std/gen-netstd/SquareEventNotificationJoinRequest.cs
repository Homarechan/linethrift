...
public partial class SquareEventNotificationJoinRequest : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 3:
            if (field.Type == TType.String)
            {
              RequestMemberName = await iprot.ReadStringAsync(cancellationToken);
            }
            else
            {
              await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotificationJoinRequest");
      ...
      if (RequestMemberName != null && __isset.requestMemberName)
      {
        ...
        field.ID = 3;
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        await oprot.WriteStringAsync(RequestMemberName, cancellationToken);
        await oprot.WriteFieldEndAsync(cancellationToken);
      }
  ...
  {
    var other = that as SquareEventNotificationJoinRequest;
    ...
    return ((__isset.squareMid == other.__isset.squareMid) && ((!__isset.squareMid) || (System.Object.Equals(SquareMid, other.SquareMid))))
      ...
      && ((__isset.requestMemberName == other.__isset.requestMemberName) && ((!__isset.requestMemberName) || (System.Object.Equals(RequestMemberName, other.RequestMemberName))))
  ...
  public override int GetHashCode() {
    ...
    unchecked {
      ...
      if(__isset.requestMemberName)
        hashcode = (hashcode * 397) + RequestMemberName.GetHashCode();
