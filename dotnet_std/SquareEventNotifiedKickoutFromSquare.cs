...
public partial class SquareEventNotifiedKickoutFromSquare : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotifiedKickoutFromSquare");
      ...
      if (Kickees != null && __isset.kickees)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          await oprot.WriteListBeginAsync(new TList(TType.Struct, Kickees.Count), cancellationToken);
  ...
  {
    var other = that as SquareEventNotifiedKickoutFromSquare;
    ...
    return ((__isset.squareChatMid == other.__isset.squareChatMid) && ((!__isset.squareChatMid) || (System.Object.Equals(SquareChatMid, other.SquareChatMid))))
      && ((__isset.kickees == other.__isset.kickees) && ((!__isset.kickees) || (TCollections.Equals(Kickees, other.Kickees))));
  }
  ...
  {
    var sb = new StringBuilder("SquareEventNotifiedKickoutFromSquare(");
    bool __first = true;
    if (SquareChatMid != null && __isset.squareChatMid)
    {
