...
public partial class GetSquareAuthorityResponse : TBase
{
  ...
  {
    var other = that as GetSquareAuthorityResponse;
    if (other == null) return false;
    if (ReferenceEquals(this, other)) return true;
    return ((__isset.authority == other.__isset.authority) && ((!__isset.authority) || (System.Object.Equals(Authority, other.Authority))));
  }
