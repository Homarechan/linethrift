...
public partial class ChannelException : TException, TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          case 1:
            ...
            {
              Code = (ChannelErrorCode)await iprot.ReadI32Async(cancellationToken);
            }
            else
            {
          ...
          case 3:
            ...
            {
              {
                TMap _map527 = await iprot.ReadMapBeginAsync(cancellationToken);
                ParameterMap = new Dictionary<string, string>(_map527.Count);
                for(int _i528 = 0; _i528 < _map527.Count; ++_i528)
                {
                  string _key529;
                  string _val530;
                  _key529 = await iprot.ReadStringAsync(cancellationToken);
                  _val530 = await iprot.ReadStringAsync(cancellationToken);
                  ParameterMap[_key529] = _val530;
                }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("ChannelException");
      ...
      if (ParameterMap != null && __isset.parameterMap)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (string _iter531 in ParameterMap.Keys)
          {
            await oprot.WriteStringAsync(_iter531, cancellationToken);
            await oprot.WriteStringAsync(ParameterMap[_iter531], cancellationToken);
          }
  ...
  {
    var other = that as ChannelException;
  ...
  {
    var sb = new StringBuilder("ChannelException(");
    bool __first = true;
    if (__isset.code)
    {
