...
public partial class MessageOperation : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 3:
            ...
            {
              Type = (MessageOperationType)await iprot.ReadI32Async(cancellationToken);
            }
            else
            {
              await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("MessageOperation");
  ...
  {
    var other = that as MessageOperation;
  ...
  {
    var sb = new StringBuilder("MessageOperation(");
    bool __first = true;
    if (__isset.revision)
    {
