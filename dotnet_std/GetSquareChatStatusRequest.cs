...
public partial class GetSquareChatStatusRequest : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("GetSquareChatStatusRequest");
  ...
  {
    var other = that as GetSquareChatStatusRequest;
  ...
  {
    var sb = new StringBuilder("GetSquareChatStatusRequest(");
    bool __first = true;
    if (SquareChatMid != null && __isset.squareChatMid)
    {
