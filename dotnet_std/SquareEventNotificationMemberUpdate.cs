...
public partial class SquareEventNotificationMemberUpdate : TBase
{
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SquareEventNotificationMemberUpdate");
  ...
  {
    var other = that as SquareEventNotificationMemberUpdate;
  ...
  {
    var sb = new StringBuilder("SquareEventNotificationMemberUpdate(");
    bool __first = true;
    if (SquareMid != null && __isset.squareMid)
    {
