...
public partial class SnsAdaptorService
{
  ...
  {
    Task<SnsFriends> getSnsFriendsAsync(SnsIdType snsIdType, string snsAccessToken, int startIdx, int limit, CancellationToken cancellationToken = default(CancellationToken));

    Task<SnsProfile> getSnsMyProfileAsync(SnsIdType snsIdType, string snsAccessToken, CancellationToken cancellationToken = default(CancellationToken));

    Task postSnsInvitationMessageAsync(SnsIdType snsIdType, string snsAccessToken, string toSnsUserId, CancellationToken cancellationToken = default(CancellationToken));
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task<SnsFriends> getSnsFriendsAsync(SnsIdType snsIdType, string snsAccessToken, int startIdx, int limit, CancellationToken cancellationToken = default(CancellationToken))
    {
    ...
    public async Task<SnsProfile> getSnsMyProfileAsync(SnsIdType snsIdType, string snsAccessToken, CancellationToken cancellationToken = default(CancellationToken))
    {
    ...
    public async Task postSnsInvitationMessageAsync(SnsIdType snsIdType, string snsAccessToken, string toSnsUserId, CancellationToken cancellationToken = default(CancellationToken))
    {
  ...
  public partial class getSnsFriendsArgs : TBase
  {
    ...
    {
      var other = that as getSnsFriendsArgs;
      ...
      return ((__isset.snsIdType == other.__isset.snsIdType) && ((!__isset.snsIdType) || (System.Object.Equals(SnsIdType, other.SnsIdType))))
        ...
        && ((__isset.startIdx == other.__isset.startIdx) && ((!__isset.startIdx) || (System.Object.Equals(StartIdx, other.StartIdx))))
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if(__isset.startIdx)
          hashcode = (hashcode * 397) + StartIdx.GetHashCode();
        if(__isset.limit)
  ...
  public partial class getSnsFriendsResult : TBase
  {
    ...
    public override bool Equals(object that)
    {
      var other = that as getSnsFriendsResult;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
  ...
  public partial class getSnsMyProfileArgs : TBase
  {
    ...
    public override bool Equals(object that)
    {
      var other = that as getSnsMyProfileArgs;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.snsIdType == other.__isset.snsIdType) && ((!__isset.snsIdType) || (System.Object.Equals(SnsIdType, other.SnsIdType))))
        && ((__isset.snsAccessToken == other.__isset.snsAccessToken) && ((!__isset.snsAccessToken) || (System.Object.Equals(SnsAccessToken, other.SnsAccessToken))));
  ...
  public partial class getSnsMyProfileResult : TBase
  {
    ...
    public override bool Equals(object that)
    {
      var other = that as getSnsMyProfileResult;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.success == other.__isset.success) && ((!__isset.success) || (System.Object.Equals(Success, other.Success))))
        && ((__isset.e == other.__isset.e) && ((!__isset.e) || (System.Object.Equals(E, other.E))));
  ...
  public partial class postSnsInvitationMessageArgs : TBase
  {
    ...
    public override bool Equals(object that)
    {
      var other = that as postSnsInvitationMessageArgs;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.snsIdType == other.__isset.snsIdType) && ((!__isset.snsIdType) || (System.Object.Equals(SnsIdType, other.SnsIdType))))
        && ((__isset.snsAccessToken == other.__isset.snsAccessToken) && ((!__isset.snsAccessToken) || (System.Object.Equals(SnsAccessToken, other.SnsAccessToken))))
        && ((__isset.toSnsUserId == other.__isset.toSnsUserId) && ((!__isset.toSnsUserId) || (System.Object.Equals(ToSnsUserId, other.ToSnsUserId))));
    }
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if(__isset.snsAccessToken)
          hashcode = (hashcode * 397) + SnsAccessToken.GetHashCode();
        if(__isset.toSnsUserId)
          hashcode = (hashcode * 397) + ToSnsUserId.GetHashCode();
      }
      return hashcode;
    }
  ...
  public partial class postSnsInvitationMessageResult : TBase
  {
    ...
    public override bool Equals(object that)
    {
      var other = that as postSnsInvitationMessageResult;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
