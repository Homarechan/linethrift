...
class GetSquareStatus_result implements TBase {
  ...
  public function get_success() : GetSquareStatusResponse {
    return this.success;
  }

  public function set_success(success:GetSquareStatusResponse) : GetSquareStatusResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareStatus_result(";
    var first : Bool = true;
