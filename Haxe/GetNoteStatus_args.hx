...
class GetNoteStatus_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getNoteStatus_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetNoteStatusRequest;
  ...
  public function get_request() : GetNoteStatusRequest {
    return this.request;
  }

  public function set_request(request:GetNoteStatusRequest) : GetNoteStatusRequest {
  ...
  public function toString() : String {
    var ret : String = "getNoteStatus_args(";
    var first : Bool = true;
