...
class GetSquare_result implements TBase {
  ...
  public function get_success() : GetSquareResponse {
    return this.success;
  }

  public function set_success(success:GetSquareResponse) : GetSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquare_result(";
    var first : Bool = true;
