...
class LookupByPhoneNumber_result implements TBase {
  ...
  public function get_success() : SpotPhoneNumberResponse {
    return this.success;
  }

  public function set_success(success:SpotPhoneNumberResponse) : SpotPhoneNumberResponse {
  ...
  public function toString() : String {
    var ret : String = "LookupByPhoneNumber_result(";
    var first : Bool = true;
