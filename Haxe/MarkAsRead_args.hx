...
class MarkAsRead_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("markAsRead_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : MarkAsReadRequest;
  ...
  public function get_request() : MarkAsReadRequest {
    return this.request;
  }

  public function set_request(request:MarkAsReadRequest) : MarkAsReadRequest {
  ...
  public function toString() : String {
    var ret : String = "markAsRead_args(";
    var first : Bool = true;
