...
class SquareEventNotifiedUpdateSquareChatMember implements TBase {
  
  static var STRUCT_DESC = { new TStruct("SquareEventNotifiedUpdateSquareChatMember"); };
  ...
  public function toString() : String {
    var ret : String = "SquareEventNotifiedUpdateSquareChatMember(";
    var first : Bool = true;
