...
class Geolocation implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("Geolocation"); };
  static var LONGITUDE_FIELD_DESC = { new TField("longitude", TType.DOUBLE, 1); };
  static var LATITUDE_FIELD_DESC = { new TField("latitude", TType.DOUBLE, 2); };
  ...
  inline static var LONGITUDE_FIELD_ID : Int = 1;
  inline static var LATITUDE_FIELD_ID : Int = 2;
