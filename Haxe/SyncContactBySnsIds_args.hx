        ...
        switch (field.id)
        {
          ...
          case MODIFICATIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1360 = iprot.readListBegin();
                this.modifications = new List< SnsFriendModification>();
                for( _i1361 in 0 ... _list1360.size)
                {
                  var _elem1362 : SnsFriendModification;
                  _elem1362 = new SnsFriendModification();
                  _elem1362.read(iprot);
                  this.modifications.add(_elem1362);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.modifications != null) {
        oprot.writeFieldBegin(MODIFICATIONS_FIELD_DESC);
        {
          ...
          for( elem1363 in this.modifications)
          {
            elem1363.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
