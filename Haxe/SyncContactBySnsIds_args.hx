...
class SyncContactBySnsIds_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("syncContactBySnsIds_args"); };
  static var REQ_SEQ_FIELD_DESC = { new TField("reqSeq", TType.I32, 1); };
  static var MODIFICATIONS_FIELD_DESC = { new TField("modifications", TType.LIST, 2); };

  @:isVar
  public var reqSeq(get,set) : haxe.Int32;
  @:isVar
  public var modifications(get,set) : List< SnsFriendModification>;

  inline static var REQSEQ_FIELD_ID : Int = 1;
  inline static var MODIFICATIONS_FIELD_ID : Int = 2;
  ...
  public function get_modifications() : List< SnsFriendModification> {
    return this.modifications;
  }

  public function set_modifications(modifications:List< SnsFriendModification>) : List< SnsFriendModification> {
    this.modifications = modifications;
    return this.modifications;
  }

  public function unsetModifications() : Void {
    this.modifications = null;
  }

  // Returns true if field modifications is set (has been assigned a value) and false otherwise
  public function isSetModifications() : Bool {
        ...
        switch (field.id)
        {
          ...
          case MODIFICATIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1256 = iprot.readListBegin();
                this.modifications = new List< SnsFriendModification>();
                for( _i1257 in 0 ... _list1256.size)
                {
                  var _elem1258 : SnsFriendModification;
                  _elem1258 = new SnsFriendModification();
                  _elem1258.read(iprot);
                  this.modifications.add(_elem1258);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.modifications != null) {
        oprot.writeFieldBegin(MODIFICATIONS_FIELD_DESC);
        {
          ...
          for( elem1259 in this.modifications)
          {
            elem1259.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "syncContactBySnsIds_args(";
    var first : Bool = true;
