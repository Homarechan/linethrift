...
class GetSnsMyProfile_result implements TBase {
  ...
  public function get_success() : SnsProfile {
    return this.success;
  }

  public function set_success(success:SnsProfile) : SnsProfile {
  ...
  public function toString() : String {
    var ret : String = "GetSnsMyProfile_result(";
    var first : Bool = true;
