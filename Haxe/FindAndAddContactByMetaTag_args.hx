...
class FindAndAddContactByMetaTag_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("findAndAddContactByMetaTag_args"); };
  static var REQ_SEQ_FIELD_DESC = { new TField("reqSeq", TType.I32, 1); };
  static var USERID_FIELD_DESC = { new TField("userid", TType.STRING, 2); };
  static var REFERENCE_FIELD_DESC = { new TField("reference", TType.STRING, 3); };
  ...
  inline static var REFERENCE_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "findAndAddContactByMetaTag_args(";
    var first : Bool = true;
