...
class GetUpdatedChannelIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetUpdatedChannelIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list807 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i808 in 0 ... _list807.size)
                {
                  var _elem809 : String;
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem810 in this.success)
          {
            oprot.writeString(elem810);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetUpdatedChannelIds_result(";
    var first : Bool = true;
