...
class GetSquareMemberRelationResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareMemberRelationResponse"); };
  ...
  static var RELATION_FIELD_DESC = { new TField("relation", TType.STRUCT, 3); };
  ...
  inline static var RELATION_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "GetSquareMemberRelationResponse(";
    var first : Bool = true;
