...
class GetJoinedSquares_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getJoinedSquares_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetJoinedSquaresRequest;
  ...
  public function get_request() : GetJoinedSquaresRequest {
    return this.request;
  }

  public function set_request(request:GetJoinedSquaresRequest) : GetJoinedSquaresRequest {
  ...
  public function toString() : String {
    var ret : String = "getJoinedSquares_args(";
    var first : Bool = true;
