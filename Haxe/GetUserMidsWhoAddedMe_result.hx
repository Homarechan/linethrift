...
class GetUserMidsWhoAddedMe_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetUserMidsWhoAddedMe_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1572 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1573 in 0 ... _list1572.size)
                {
                  var _elem1574 : String;
                  _elem1574 = iprot.readString();
                  this.success.add(_elem1574);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1575 in this.success)
          {
            oprot.writeString(elem1575);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetUserMidsWhoAddedMe_result(";
    var first : Bool = true;
