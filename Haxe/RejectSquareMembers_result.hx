...
class RejectSquareMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RejectSquareMembers_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : RejectSquareMembersResponse;
  @:isVar
  ...
  public function get_success() : RejectSquareMembersResponse {
    return this.success;
  }

  public function set_success(success:RejectSquareMembersResponse) : RejectSquareMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "RejectSquareMembers_result(";
    var first : Bool = true;
