        ...
        switch (field.id)
        {
          ...
          case RECEIVERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1251 = iprot.readListBegin();
                this.receiverMids = new List< String>();
                for( _i1252 in 0 ... _list1251.size)
                {
                  var _elem1253 : String;
                  _elem1253 = iprot.readString();
                  this.receiverMids.add(_elem1253);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.receiverMids != null) {
        oprot.writeFieldBegin(RECEIVER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1254 in this.receiverMids)
          {
            oprot.writeString(elem1254);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
