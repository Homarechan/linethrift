...
class ReportSquareMessageRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ReportSquareMessageRequest"); };
  static var SQUARE_MID_FIELD_DESC = { new TField("squareMid", TType.STRING, 2); };
  static var SQUARE_CHAT_MID_FIELD_DESC = { new TField("squareChatMid", TType.STRING, 3); };
  static var SQUARE_MESSAGE_ID_FIELD_DESC = { new TField("squareMessageId", TType.STRING, 4); };
  static var REPORT_TYPE_FIELD_DESC = { new TField("reportType", TType.I32, 5); };
  static var OTHER_REASON_FIELD_DESC = { new TField("otherReason", TType.STRING, 6); };
  ...
  @:isVar
  public var squareMessageId(get,set) : String;
  @:isVar
  ...
  inline static var SQUARECHATMID_FIELD_ID : Int = 3;
  inline static var SQUAREMESSAGEID_FIELD_ID : Int = 4;
  inline static var REPORTTYPE_FIELD_ID : Int = 5;
  inline static var OTHERREASON_FIELD_ID : Int = 6;
  ...
  public function get_squareMessageId() : String {
    return this.squareMessageId;
  }

  public function set_squareMessageId(squareMessageId:String) : String {
    this.squareMessageId = squareMessageId;
    return this.squareMessageId;
  }

  public function unsetSquareMessageId() : Void {
    this.squareMessageId = null;
  }

  // Returns true if field squareMessageId is set (has been assigned a value) and false otherwise
  public function isSetSquareMessageId() : Bool {
  ...
  public function toString() : String {
    var ret : String = "ReportSquareMessageRequest(";
    var first : Bool = true;
