...
class GetSquareChatMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareChatMembers_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetSquareChatMembersResponse;
  @:isVar
  ...
  public function get_success() : GetSquareChatMembersResponse {
    return this.success;
  }

  public function set_success(success:GetSquareChatMembersResponse) : GetSquareChatMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareChatMembers_result(";
    var first : Bool = true;
