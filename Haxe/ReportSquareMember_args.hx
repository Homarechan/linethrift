...
class ReportSquareMember_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("reportSquareMember_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : ReportSquareMemberRequest;
  ...
  public function get_request() : ReportSquareMemberRequest {
    return this.request;
  }

  public function set_request(request:ReportSquareMemberRequest) : ReportSquareMemberRequest {
  ...
  public function toString() : String {
    var ret : String = "reportSquareMember_args(";
    var first : Bool = true;
