...
class GetPromotedBuddyContacts_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetPromotedBuddyContacts_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list832 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i833 in 0 ... _list832.size)
                {
                  var _elem834 : Contact;
                  _elem834 = new Contact();
                  _elem834.read(iprot);
  ...
  public function toString() : String {
    var ret : String = "GetPromotedBuddyContacts_result(";
    var first : Bool = true;
