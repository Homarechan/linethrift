...
class UpdatePassword_result implements TBase {
  ...
  public function get_success() : IdentityCredentialResponse {
    return this.success;
  }

  public function set_success(success:IdentityCredentialResponse) : IdentityCredentialResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdatePassword_result(";
    var first : Bool = true;
