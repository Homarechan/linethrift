...
class LeaveSquare_result implements TBase {
  ...
  public function get_success() : LeaveSquareResponse {
    return this.success;
  }

  public function set_success(success:LeaveSquareResponse) : LeaveSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "LeaveSquare_result(";
    var first : Bool = true;
