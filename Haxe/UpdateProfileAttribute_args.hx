...
class UpdateProfileAttribute_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateProfileAttribute_args"); };
  ...
  public function toString() : String {
    var ret : String = "updateProfileAttribute_args(";
    var first : Bool = true;
    ...
    if (!first) ret +=  ", ";
    ret += "attr:";
    var attr_name : String = .ProfileAttribute.VALUES_TO_NAMES[this.attr];
    if (attr_name != null) {
      ret += attr_name;
      ret += " (";
    }
