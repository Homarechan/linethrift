...
class GetGroupWithoutMembers_result implements TBase {
  ...
  public function get_success() : Group {
    return this.success;
  }

  public function set_success(success:Group) : Group {
  ...
  public function toString() : String {
    var ret : String = "GetGroupWithoutMembers_result(";
    var first : Bool = true;
