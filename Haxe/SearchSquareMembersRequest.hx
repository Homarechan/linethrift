...
class SearchSquareMembersRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("SearchSquareMembersRequest"); };
  static var SQUARE_MID_FIELD_DESC = { new TField("squareMid", TType.STRING, 2); };
  static var SEARCH_OPTION_FIELD_DESC = { new TField("searchOption", TType.STRUCT, 3); };
  ...
  @:isVar
  public var searchOption(get,set) : SquareMemberSearchOption;
  @:isVar
  ...
  inline static var SEARCHOPTION_FIELD_ID : Int = 3;
  ...
  public function get_searchOption() : SquareMemberSearchOption {
    return this.searchOption;
  }

  public function set_searchOption(searchOption:SquareMemberSearchOption) : SquareMemberSearchOption {
    this.searchOption = searchOption;
    return this.searchOption;
  }

  public function unsetSearchOption() : Void {
    this.searchOption = null;
  }

  // Returns true if field searchOption is set (has been assigned a value) and false otherwise
  public function isSetSearchOption() : Bool {
  ...
  public function toString() : String {
    var ret : String = "SearchSquareMembersRequest(";
    var first : Bool = true;
