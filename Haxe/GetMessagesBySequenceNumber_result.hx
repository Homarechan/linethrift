...
class GetMessagesBySequenceNumber_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetMessagesBySequenceNumber_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1177 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1178 in 0 ... _list1177.size)
                {
                  var _elem1179 : Message;
                  _elem1179 = new Message();
                  _elem1179.read(iprot);
                  this.success.add(_elem1179);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1180 in this.success)
          {
            elem1180.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetMessagesBySequenceNumber_result(";
    var first : Bool = true;
