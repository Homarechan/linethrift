        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1073 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1074 in 0 ... _list1073.size)
                {
                  var _elem1075 : Message;
                  _elem1075 = new Message();
                  _elem1075.read(iprot);
                  this.success.add(_elem1075);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1076 in this.success)
          {
            elem1076.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
