...
class GetRecentMessagesV2_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetRecentMessagesV2_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1383 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1384 in 0 ... _list1383.size)
                {
                  var _elem1385 : Message;
                  _elem1385 = new Message();
                  _elem1385.read(iprot);
                  this.success.add(_elem1385);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1386 in this.success)
          {
            elem1386.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetRecentMessagesV2_result(";
    var first : Bool = true;
