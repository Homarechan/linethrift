...
class UserTicketResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UserTicketResponse"); };
  static var MID_FIELD_DESC = { new TField("mid", TType.STRING, 1); };
  static var USER_TICKET_FIELD_DESC = { new TField("userTicket", TType.STRING, 2); };

  @:isVar
  public var mid(get,set) : String;
  @:isVar
  public var userTicket(get,set) : String;

  inline static var MID_FIELD_ID : Int = 1;
  inline static var USERTICKET_FIELD_ID : Int = 2;
  ...
  public function get_userTicket() : String {
    return this.userTicket;
  }

  public function set_userTicket(userTicket:String) : String {
    this.userTicket = userTicket;
    return this.userTicket;
  }

  public function unsetUserTicket() : Void {
    this.userTicket = null;
  }

  // Returns true if field userTicket is set (has been assigned a value) and false otherwise
  public function isSetUserTicket() : Bool {
  ...
  public function toString() : String {
    var ret : String = "UserTicketResponse(";
    var first : Bool = true;
