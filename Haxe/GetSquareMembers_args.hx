...
class GetSquareMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareMembersRequest;
  ...
  public function get_request() : GetSquareMembersRequest {
    return this.request;
  }

  public function set_request(request:GetSquareMembersRequest) : GetSquareMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareMembers_args(";
    var first : Bool = true;
