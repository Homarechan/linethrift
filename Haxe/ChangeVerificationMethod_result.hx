...
class ChangeVerificationMethod_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ChangeVerificationMethod_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : VerificationSessionData;
  @:isVar
  ...
  public function get_success() : VerificationSessionData {
    return this.success;
  }

  public function set_success(success:VerificationSessionData) : VerificationSessionData {
  ...
  public function toString() : String {
    var ret : String = "ChangeVerificationMethod_result(";
    var first : Bool = true;
