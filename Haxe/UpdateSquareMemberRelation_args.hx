...
class UpdateSquareMemberRelation_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareMemberRelation_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareMemberRelationRequest;
  ...
  public function get_request() : UpdateSquareMemberRelationRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareMemberRelationRequest) : UpdateSquareMemberRelationRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareMemberRelation_args(";
    var first : Bool = true;
