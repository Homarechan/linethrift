        ...
        switch (field.id)
        {
          case APPROVEDMEMBERS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list412 = iprot.readListBegin();
                this.approvedMembers = new List< SquareMember>();
                for( _i413 in 0 ... _list412.size)
                {
                  var _elem414 : SquareMember;
                  _elem414 = new SquareMember();
                  _elem414.read(iprot);
                  this.approvedMembers.add(_elem414);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.approvedMembers != null) {
        oprot.writeFieldBegin(APPROVED_MEMBERS_FIELD_DESC);
        {
          ...
          for( elem415 in this.approvedMembers)
          {
            elem415.write(oprot);
          }
          oprot.writeListEnd();
