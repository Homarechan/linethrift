...
class GetFavoriteMidsForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetFavoriteMidsForChannel_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1544 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1545 in 0 ... _list1544.size)
                {
                  var _elem1546 : String;
                  _elem1546 = iprot.readString();
                  this.success.add(_elem1546);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1547 in this.success)
          {
            oprot.writeString(elem1547);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetFavoriteMidsForChannel_result(";
    var first : Bool = true;
