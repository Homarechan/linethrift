...
class UpdateSquareFeatureSet_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareFeatureSet_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UpdateSquareFeatureSetResponse;
  @:isVar
  ...
  public function get_success() : UpdateSquareFeatureSetResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareFeatureSetResponse) : UpdateSquareFeatureSetResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareFeatureSet_result(";
    var first : Bool = true;
