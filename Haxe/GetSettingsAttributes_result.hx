...
class GetSettingsAttributes_result implements TBase {
  ...
  public function get_success() : Settings {
    return this.success;
  }

  public function set_success(success:Settings) : Settings {
  ...
  public function toString() : String {
    var ret : String = "GetSettingsAttributes_result(";
    var first : Bool = true;
