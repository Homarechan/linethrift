...
class GetGroupsV2_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroupsV2_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1213 = iprot.readListBegin();
                this.success = new List< Group>();
                for( _i1214 in 0 ... _list1213.size)
                {
                  var _elem1215 : Group;
                  _elem1215 = new Group();
                  _elem1215.read(iprot);
                  this.success.add(_elem1215);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1216 in this.success)
          {
            elem1216.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupsV2_result(";
    var first : Bool = true;
