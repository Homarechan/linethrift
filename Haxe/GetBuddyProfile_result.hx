...
class GetBuddyProfile_result implements TBase {
  ...
  public function get_success() : BuddyProfile {
    return this.success;
  }

  public function set_success(success:BuddyProfile) : BuddyProfile {
  ...
  public function toString() : String {
    var ret : String = "GetBuddyProfile_result(";
    var first : Bool = true;
