        ...
        switch (field.id)
        {
          case APPROVEDCHANNELINFOS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list141 = iprot.readListBegin();
                this.approvedChannelInfos = new List< ApprovedChannelInfo>();
                for( _i142 in 0 ... _list141.size)
                {
                  var _elem143 : ApprovedChannelInfo;
                  _elem143 = new ApprovedChannelInfo();
                  _elem143.read(iprot);
                  this.approvedChannelInfos.add(_elem143);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.approvedChannelInfos != null) {
        oprot.writeFieldBegin(APPROVED_CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for( elem144 in this.approvedChannelInfos)
          {
            elem144.write(oprot);
          }
          oprot.writeListEnd();
