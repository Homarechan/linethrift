...
class FetchAnnouncements_result implements TBase {
  ...
  public function get_success() : List< Announcement> {
    return this.success;
  }

  public function set_success(success:List< Announcement>) : List< Announcement> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1023 = iprot.readListBegin();
                this.success = new List< Announcement>();
                for( _i1024 in 0 ... _list1023.size)
                {
                  var _elem1025 : Announcement;
                  _elem1025 = new Announcement();
                  _elem1025.read(iprot);
                  this.success.add(_elem1025);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "FetchAnnouncements_result(";
    var first : Bool = true;
