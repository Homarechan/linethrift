        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list919 = iprot.readListBegin();
                this.success = new List< Announcement>();
                for( _i920 in 0 ... _list919.size)
                {
                  var _elem921 : Announcement;
                  _elem921 = new Announcement();
                  _elem921.read(iprot);
                  this.success.add(_elem921);
                }
                iprot.readListEnd();
              }
            } else { 
