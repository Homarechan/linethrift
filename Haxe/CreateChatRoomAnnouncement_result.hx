...
class CreateChatRoomAnnouncement_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("CreateChatRoomAnnouncement_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ChatRoomAnnouncement;
  @:isVar
  ...
  public function get_success() : ChatRoomAnnouncement {
    return this.success;
  }

  public function set_success(success:ChatRoomAnnouncement) : ChatRoomAnnouncement {
  ...
  public function toString() : String {
    var ret : String = "CreateChatRoomAnnouncement_result(";
    var first : Bool = true;
