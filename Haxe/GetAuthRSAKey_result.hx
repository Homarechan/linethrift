...
class GetAuthRSAKey_result implements TBase {
  ...
  public function get_success() : RSAKey {
    return this.success;
  }

  public function set_success(success:RSAKey) : RSAKey {
  ...
  public function toString() : String {
    var ret : String = "GetAuthRSAKey_result(";
    var first : Bool = true;
