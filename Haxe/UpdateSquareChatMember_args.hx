...
class UpdateSquareChatMember_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareChatMember_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareChatMemberRequest;
  ...
  public function get_request() : UpdateSquareChatMemberRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareChatMemberRequest) : UpdateSquareChatMemberRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareChatMember_args(";
    var first : Bool = true;
