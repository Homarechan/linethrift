...
class UpdateSquareMemberRelationResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareMemberRelationResponse"); };
  static var SQUARE_MID_FIELD_DESC = { new TField("squareMid", TType.STRING, 1); };
  static var TARGET_SQUARE_MEMBER_MID_FIELD_DESC = { new TField("targetSquareMemberMid", TType.STRING, 2); };
  static var UPDATED_ATTRS_FIELD_DESC = { new TField("updatedAttrs", TType.SET, 3); };
  static var RELATION_FIELD_DESC = { new TField("relation", TType.STRUCT, 4); };
  ...
  inline static var TARGETSQUAREMEMBERMID_FIELD_ID : Int = 2;
  inline static var UPDATEDATTRS_FIELD_ID : Int = 3;
  inline static var RELATION_FIELD_ID : Int = 4;
        ...
        switch (field.id)
        {
          ...
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set645 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i646 in 0 ... _set645.size)
                {
                  var _elem647 : Int;
                  _elem647 = iprot.readI32();
                  this.updatedAttrs.add(_elem647);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem648 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem648);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareMemberRelationResponse(";
    var first : Bool = true;
