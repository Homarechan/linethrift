        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set579 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i580 in 0 ... _set579.size)
                {
                  var _elem581 : Int;
                  _elem581 = iprot.readI32();
                  this.updatedAttrs.add(_elem581);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case MEMBERS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list582 = iprot.readListBegin();
                this.members = new List< SquareMember>();
                for( _i583 in 0 ... _list582.size)
                {
                  var _elem584 : SquareMember;
                  _elem584 = new SquareMember();
                  _elem584.read(iprot);
                  this.members.add(_elem584);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem585 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem585);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
