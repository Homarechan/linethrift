...
class LoginWithIdentityCredentialForCertificate_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("LoginWithIdentityCredentialForCertificate_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : LoginResult;
  @:isVar
  ...
  public function get_success() : LoginResult {
    return this.success;
  }

  public function set_success(success:LoginResult) : LoginResult {
  ...
  public function toString() : String {
    var ret : String = "LoginWithIdentityCredentialForCertificate_result(";
    var first : Bool = true;
