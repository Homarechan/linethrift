...
class RemoveSubscriptions_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("removeSubscriptions_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : RemoveSubscriptionsRequest;
  ...
  public function get_request() : RemoveSubscriptionsRequest {
    return this.request;
  }

  public function set_request(request:RemoveSubscriptionsRequest) : RemoveSubscriptionsRequest {
  ...
  public function toString() : String {
    var ret : String = "removeSubscriptions_args(";
    var first : Bool = true;
