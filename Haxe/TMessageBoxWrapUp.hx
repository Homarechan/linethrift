        ...
        switch (field.id)
        {
          ...
          case CONTACTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list385 = iprot.readListBegin();
                this.contacts = new List< Contact>();
                for( _i386 in 0 ... _list385.size)
                {
                  var _elem387 : Contact;
                  _elem387 = new Contact();
                  _elem387.read(iprot);
                  this.contacts.add(_elem387);
                }
                iprot.readListEnd();
              }
            } else { 
