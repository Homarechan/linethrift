        ...
        switch (field.id)
        {
          case UPDATEATTRIBUTES_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set451 = iprot.readSetBegin();
                this.updateAttributes = new IntSet();
                for( _i452 in 0 ... _set451.size)
                {
                  var _elem453 : Int;
                  _elem453 = iprot.readI32();
                  this.updateAttributes.add(_elem453);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updateAttributes != null) {
        oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
        {
          ...
          for( elem454 in this.updateAttributes.toArray())
          {
            oprot.writeI32(elem454);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
