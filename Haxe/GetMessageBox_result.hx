...
class GetMessageBox_result implements TBase {
  ...
  public function get_success() : TMessageBox {
    return this.success;
  }

  public function set_success(success:TMessageBox) : TMessageBox {
  ...
  public function toString() : String {
    var ret : String = "GetMessageBox_result(";
    var first : Bool = true;
