...
class CreateSquare_result implements TBase {
  ...
  public function get_success() : CreateSquareResponse {
    return this.success;
  }

  public function set_success(success:CreateSquareResponse) : CreateSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "CreateSquare_result(";
    var first : Bool = true;
