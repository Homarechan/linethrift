...
class ReportContacts_result implements TBase {
  ...
  public function get_success() : List< ContactReportResult> {
    return this.success;
  }

  public function set_success(success:List< ContactReportResult>) : List< ContactReportResult> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1163 = iprot.readListBegin();
                this.success = new List< ContactReportResult>();
                for( _i1164 in 0 ... _list1163.size)
                {
                  var _elem1165 : ContactReportResult;
                  _elem1165 = new ContactReportResult();
                  _elem1165.read(iprot);
                  this.success.add(_elem1165);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1166 in this.success)
          {
            elem1166.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "ReportContacts_result(";
    var first : Bool = true;
