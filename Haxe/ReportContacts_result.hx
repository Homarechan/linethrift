        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1267 = iprot.readListBegin();
                this.success = new List< ContactReportResult>();
                for( _i1268 in 0 ... _list1267.size)
                {
                  var _elem1269 : ContactReportResult;
                  _elem1269 = new ContactReportResult();
                  _elem1269.read(iprot);
                  this.success.add(_elem1269);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1270 in this.success)
          {
            elem1270.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
