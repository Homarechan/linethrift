        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1463 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1464 in 0 ... _list1463.size)
                {
                  var _elem1465 : String;
                  _elem1465 = iprot.readString();
                  this.success.add(_elem1465);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1466 in this.success)
          {
            oprot.writeString(elem1466);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
