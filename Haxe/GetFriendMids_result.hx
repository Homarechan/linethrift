...
class GetFriendMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetFriendMids_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1359 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1360 in 0 ... _list1359.size)
                {
                  var _elem1361 : String;
                  _elem1361 = iprot.readString();
                  this.success.add(_elem1361);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1362 in this.success)
          {
            oprot.writeString(elem1362);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetFriendMids_result(";
    var first : Bool = true;
