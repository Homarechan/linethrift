...
class JoinSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("joinSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : JoinSquareChatRequest;
  ...
  public function get_request() : JoinSquareChatRequest {
    return this.request;
  }

  public function set_request(request:JoinSquareChatRequest) : JoinSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "joinSquareChat_args(";
    var first : Bool = true;
