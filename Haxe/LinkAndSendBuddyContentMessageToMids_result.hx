...
class LinkAndSendBuddyContentMessageToMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("LinkAndSendBuddyContentMessageToMids_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SendBuddyMessageResult;
  @:isVar
  ...
  public function get_success() : SendBuddyMessageResult {
    return this.success;
  }

  public function set_success(success:SendBuddyMessageResult) : SendBuddyMessageResult {
  ...
  public function toString() : String {
    var ret : String = "LinkAndSendBuddyContentMessageToMids_result(";
    var first : Bool = true;
