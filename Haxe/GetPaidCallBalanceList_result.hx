        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1483 = iprot.readListBegin();
                this.success = new List< PaidCallBalance>();
                for( _i1484 in 0 ... _list1483.size)
                {
                  var _elem1485 : PaidCallBalance;
                  _elem1485 = new PaidCallBalance();
                  _elem1485.read(iprot);
                  this.success.add(_elem1485);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1486 in this.success)
          {
            elem1486.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
