        ...
        switch (field.id)
        {
          ...
          case MESSAGEIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1341 = iprot.readListBegin();
                this.messageIds = new List< String>();
                for( _i1342 in 0 ... _list1341.size)
                {
                  var _elem1343 : String;
                  _elem1343 = iprot.readString();
                  this.messageIds.add(_elem1343);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.messageIds != null) {
        oprot.writeFieldBegin(MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for( elem1344 in this.messageIds)
          {
            oprot.writeString(elem1344);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
