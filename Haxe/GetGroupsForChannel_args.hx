        ...
        switch (field.id)
        {
          case GROUPIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1363 = iprot.readListBegin();
                this.groupIds = new List< String>();
                for( _i1364 in 0 ... _list1363.size)
                {
                  var _elem1365 : String;
                  _elem1365 = iprot.readString();
                  this.groupIds.add(_elem1365);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.groupIds != null) {
        oprot.writeFieldBegin(GROUP_IDS_FIELD_DESC);
        {
          ...
          for( elem1366 in this.groupIds)
          {
            oprot.writeString(elem1366);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
