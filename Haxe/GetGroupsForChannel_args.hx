...
class GetGroupsForChannel_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getGroupsForChannel_args"); };
  static var GROUP_IDS_FIELD_DESC = { new TField("groupIds", TType.LIST, 1); };

  @:isVar
  public var groupIds(get,set) : List< String>;

  inline static var GROUPIDS_FIELD_ID : Int = 1;
        ...
        switch (field.id)
        {
          case GROUPIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1467 = iprot.readListBegin();
                this.groupIds = new List< String>();
                for( _i1468 in 0 ... _list1467.size)
                {
                  var _elem1469 : String;
                  _elem1469 = iprot.readString();
                  this.groupIds.add(_elem1469);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.groupIds != null) {
        oprot.writeFieldBegin(GROUP_IDS_FIELD_DESC);
        {
          ...
          for( elem1470 in this.groupIds)
          {
            oprot.writeString(elem1470);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "getGroupsForChannel_args(";
    var first : Bool = true;
