        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1109 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1110 in 0 ... _list1109.size)
                {
                  var _elem1111 : String;
                  _elem1111 = iprot.readString();
                  this.success.add(_elem1111);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1112 in this.success)
          {
            oprot.writeString(elem1112);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
