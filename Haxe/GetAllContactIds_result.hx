...
class GetAllContactIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetAllContactIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1005 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1006 in 0 ... _list1005.size)
                {
                  var _elem1007 : String;
                  _elem1007 = iprot.readString();
                  this.success.add(_elem1007);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1008 in this.success)
          {
            oprot.writeString(elem1008);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetAllContactIds_result(";
    var first : Bool = true;
