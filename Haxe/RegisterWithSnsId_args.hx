...
class RegisterWithSnsId_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("registerWithSnsId_args"); };
  ...
  static var MID_FIELD_DESC = { new TField("mid", TType.STRING, 7); };
  ...
  inline static var MID_FIELD_ID : Int = 7;
  ...
  public function toString() : String {
    var ret : String = "registerWithSnsId_args(";
    var first : Bool = true;
