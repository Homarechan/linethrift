...
class CreateSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("createSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : CreateSquareChatRequest;
  ...
  public function get_request() : CreateSquareChatRequest {
    return this.request;
  }

  public function set_request(request:CreateSquareChatRequest) : CreateSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "createSquareChat_args(";
    var first : Bool = true;
