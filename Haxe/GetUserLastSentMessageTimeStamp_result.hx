...
class GetUserLastSentMessageTimeStamp_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetUserLastSentMessageTimeStamp_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.I64, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : haxe.Int64;
  @:isVar
  ...
  public function get_success() : haxe.Int64 {
    return this.success;
  }

  public function set_success(success:haxe.Int64) : haxe.Int64 {
  ...
  public function toString() : String {
    var ret : String = "GetUserLastSentMessageTimeStamp_result(";
    var first : Bool = true;
