...
class GetSquareChatMembersResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareChatMembersResponse"); };
  static var SQUARE_CHAT_MEMBERS_FIELD_DESC = { new TField("squareChatMembers", TType.STRUCT, 1); };
  static var CONTINUATION_TOKEN_FIELD_DESC = { new TField("continuationToken", TType.STRING, 2); };

  @:isVar
  public var squareChatMembers(get,set) : SquareMember;
  @:isVar
  public var continuationToken(get,set) : String;

  inline static var SQUARECHATMEMBERS_FIELD_ID : Int = 1;
  ...
  public function get_squareChatMembers() : SquareMember {
    return this.squareChatMembers;
  }

  public function set_squareChatMembers(squareChatMembers:SquareMember) : SquareMember {
    this.squareChatMembers = squareChatMembers;
    return this.squareChatMembers;
  }

  public function unsetSquareChatMembers() : Void {
    this.squareChatMembers = null;
  }

  // Returns true if field squareChatMembers is set (has been assigned a value) and false otherwise
  public function isSetSquareChatMembers() : Bool {
  ...
  public function setFieldValue(fieldID : Int, value : Dynamic) : Void {
    switch (fieldID) {
    case SQUARECHATMEMBERS_FIELD_ID:
      if (value == null) {
  ...
  public function toString() : String {
    var ret : String = "GetSquareChatMembersResponse(";
    var first : Bool = true;

    ret += "squareChatMembers:";
    if (this.squareChatMembers == null) {
      ret += "null";
    } else {
      ret += this.squareChatMembers;
    }
    first = false;
    if (!first) ret +=  ", ";
