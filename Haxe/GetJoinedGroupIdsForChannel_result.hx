...
class GetJoinedGroupIdsForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetJoinedGroupIdsForChannel_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1568 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1569 in 0 ... _list1568.size)
                {
                  var _elem1570 : String;
                  _elem1570 = iprot.readString();
                  this.success.add(_elem1570);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1571 in this.success)
          {
            oprot.writeString(elem1571);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetJoinedGroupIdsForChannel_result(";
    var first : Bool = true;
