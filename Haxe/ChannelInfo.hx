        ...
        switch (field.id)
        {
          ...
          case PERMISSIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list125 = iprot.readListBegin();
                this.permissions = new List< String>();
                for( _i126 in 0 ... _list125.size)
                {
                  var _elem127 : String;
                  _elem127 = iprot.readString();
                  this.permissions.add(_elem127);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case CHANNELCONFIGURATIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list128 = iprot.readListBegin();
                this.channelConfigurations = new List< Int>();
                for( _i129 in 0 ... _list128.size)
                {
                  var _elem130 : Int;
                  _elem130 = iprot.readI32();
                  this.channelConfigurations.add(_elem130);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case ALLOWEDPERMISSIONS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set131 = iprot.readSetBegin();
                this.allowedPermissions = new IntSet();
                for( _i132 in 0 ... _set131.size)
                {
                  var _elem133 : Int;
                  _elem133 = iprot.readI32();
                  this.allowedPermissions.add(_elem133);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case CHANNELDOMAINS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list134 = iprot.readListBegin();
                this.channelDomains = new List< ChannelDomain>();
                for( _i135 in 0 ... _list134.size)
                {
                  var _elem136 : ChannelDomain;
                  _elem136 = new ChannelDomain();
                  _elem136.read(iprot);
                  this.channelDomains.add(_elem136);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.permissions != null) {
        oprot.writeFieldBegin(PERMISSIONS_FIELD_DESC);
        {
          ...
          for( elem137 in this.permissions)
          {
      ...
      if (this.channelConfigurations != null) {
        oprot.writeFieldBegin(CHANNEL_CONFIGURATIONS_FIELD_DESC);
        {
          ...
          for( elem138 in this.channelConfigurations)
          {
      ...
      if (this.allowedPermissions != null) {
        oprot.writeFieldBegin(ALLOWED_PERMISSIONS_FIELD_DESC);
        {
          ...
          for( elem139 in this.allowedPermissions.toArray())
          {
      ...
      if (this.channelDomains != null) {
        oprot.writeFieldBegin(CHANNEL_DOMAINS_FIELD_DESC);
        {
          ...
          for( elem140 in this.channelDomains)
          {
            elem140.write(oprot);
          }
          oprot.writeListEnd();
