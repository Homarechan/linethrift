...
class RegisterDeviceWithoutPhoneNumberWithIdentityCredential_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RegisterDeviceWithoutPhoneNumberWithIdentityCredential_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRING, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : String;
  @:isVar
  ...
  public function set_success(success:String) : String {
  ...
  public function toString() : String {
    var ret : String = "RegisterDeviceWithoutPhoneNumberWithIdentityCredential_result(";
    var first : Bool = true;
