...
class GetBlockedRecommendationIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBlockedRecommendationIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1121 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1122 in 0 ... _list1121.size)
                {
                  var _elem1123 : String;
                  _elem1123 = iprot.readString();
                  this.success.add(_elem1123);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1124 in this.success)
          {
            oprot.writeString(elem1124);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetBlockedRecommendationIds_result(";
    var first : Bool = true;
