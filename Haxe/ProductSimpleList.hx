        ...
        switch (field.id)
        {
          ...
          case PRODUCTLIST_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list327 = iprot.readListBegin();
                this.productList = new List< ProductSimple>();
                for( _i328 in 0 ... _list327.size)
                {
                  var _elem329 : ProductSimple;
                  _elem329 = new ProductSimple();
                  _elem329.read(iprot);
                  this.productList.add(_elem329);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for( elem330 in this.productList)
          {
            elem330.write(oprot);
          }
          oprot.writeListEnd();
