...
class GetActiveMemberMidsByBuddyMid_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetActiveMemberMidsByBuddyMid_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list738 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i739 in 0 ... _list738.size)
                {
                  var _elem740 : String;
                  _elem740 = iprot.readString();
                  this.success.add(_elem740);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetActiveMemberMidsByBuddyMid_result(";
    var first : Bool = true;
