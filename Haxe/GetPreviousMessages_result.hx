        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1189 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1190 in 0 ... _list1189.size)
                {
                  var _elem1191 : Message;
                  _elem1191 = new Message();
                  _elem1191.read(iprot);
                  this.success.add(_elem1191);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1192 in this.success)
          {
            elem1192.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
