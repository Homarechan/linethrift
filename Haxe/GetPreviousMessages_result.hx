...
class GetPreviousMessages_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetPreviousMessages_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1085 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1086 in 0 ... _list1085.size)
                {
                  var _elem1087 : Message;
                  _elem1087 = new Message();
                  _elem1087.read(iprot);
                  this.success.add(_elem1087);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1088 in this.success)
          {
            elem1088.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetPreviousMessages_result(";
    var first : Bool = true;
