...
class GetSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareChatRequest;
  ...
  public function get_request() : GetSquareChatRequest {
    return this.request;
  }

  public function set_request(request:GetSquareChatRequest) : GetSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareChat_args(";
    var first : Bool = true;
