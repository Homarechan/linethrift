        ...
        switch (field.id)
        {
          ...
          case RECEIVERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1240 = iprot.readListBegin();
                this.receiverMids = new List< String>();
                for( _i1241 in 0 ... _list1240.size)
                {
                  var _elem1242 : String;
                  _elem1242 = iprot.readString();
                  this.receiverMids.add(_elem1242);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.receiverMids != null) {
        oprot.writeFieldBegin(RECEIVER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1243 in this.receiverMids)
          {
            oprot.writeString(elem1243);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
