...
class GetSquareChatStatus_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareChatStatus_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetSquareChatStatusResponse;
  @:isVar
  ...
  public function get_success() : GetSquareChatStatusResponse {
    return this.success;
  }

  public function set_success(success:GetSquareChatStatusResponse) : GetSquareChatStatusResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareChatStatus_result(";
    var first : Bool = true;
