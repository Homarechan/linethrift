        ...
        switch (field.id)
        {
          ...
          case CONTACTIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1356 = iprot.readListBegin();
                this.contactIds = new List< String>();
                for( _i1357 in 0 ... _list1356.size)
                {
                  var _elem1358 : String;
                  _elem1358 = iprot.readString();
                  this.contactIds.add(_elem1358);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem1359 in this.contactIds)
          {
            oprot.writeString(elem1359);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
