...
class CreateRoomV2_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("createRoomV2_args"); };
        ...
        switch (field.id)
        {
          ...
          case CONTACTIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1252 = iprot.readListBegin();
                this.contactIds = new List< String>();
                for( _i1253 in 0 ... _list1252.size)
                {
                  var _elem1254 : String;
                  _elem1254 = iprot.readString();
                  this.contactIds.add(_elem1254);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem1255 in this.contactIds)
          {
            oprot.writeString(elem1255);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "createRoomV2_args(";
    var first : Bool = true;
