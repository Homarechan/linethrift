        ...
        switch (field.id)
        {
          case SQUARECHATS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list456 = iprot.readListBegin();
                this.squareChats = new List< SquareChat>();
                for( _i457 in 0 ... _list456.size)
                {
                  var _elem458 : SquareChat;
                  _elem458 = new SquareChat();
                  _elem458.read(iprot);
                  this.squareChats.add(_elem458);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SQUARECHATSTATUSES_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map459 = iprot.readMapBegin();
                this.squareChatStatuses = new StringMap< SquareChatStatus>();
                for( _i460 in 0 ... _map459.size)
                {
                  var _key461 : String;
                  var _val462 : SquareChatStatus;
                  _key461 = iprot.readString();
                  _val462 = new SquareChatStatus();
                  _val462.read(iprot);
                  this.squareChatStatuses.set( _key461, _val462);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.squareChats != null) {
        oprot.writeFieldBegin(SQUARE_CHATS_FIELD_DESC);
        {
          ...
          for( elem463 in this.squareChats)
          {
            elem463.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (this.squareChatStatuses != null) {
        ...
        {
          var _sizeCounter465 : Int = 0;
          for( _key464 in this.squareChatStatuses) {
            _sizeCounter465++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _sizeCounter465));
          for( elem466 in this.squareChatStatuses.keys())
          {
            oprot.writeString(elem466);
            this.squareChatStatuses.get(elem466).write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
