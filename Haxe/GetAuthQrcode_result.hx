...
class GetAuthQrcode_result implements TBase {
  ...
  public function get_success() : AuthQrcode {
    return this.success;
  }

  public function set_success(success:AuthQrcode) : AuthQrcode {
  ...
  public function toString() : String {
    var ret : String = "GetAuthQrcode_result(";
    var first : Bool = true;
