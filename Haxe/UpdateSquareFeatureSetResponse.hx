        ...
        switch (field.id)
        {
          case UPDATEATTRIBUTES_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set559 = iprot.readSetBegin();
                this.updateAttributes = new IntSet();
                for( _i560 in 0 ... _set559.size)
                {
                  var _elem561 : Int;
                  _elem561 = iprot.readI32();
                  this.updateAttributes.add(_elem561);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updateAttributes != null) {
        oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
        {
          ...
          for( elem562 in this.updateAttributes.toArray())
          {
            oprot.writeI32(elem562);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
