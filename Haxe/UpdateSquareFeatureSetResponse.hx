...
class UpdateSquareFeatureSetResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareFeatureSetResponse"); };
  static var UPDATE_ATTRIBUTES_FIELD_DESC = { new TField("updateAttributes", TType.SET, 1); };
  static var SQUARE_FEATURE_SET_FIELD_DESC = { new TField("squareFeatureSet", TType.STRUCT, 2); };
  ...
  inline static var UPDATEATTRIBUTES_FIELD_ID : Int = 1;
  inline static var SQUAREFEATURESET_FIELD_ID : Int = 2;
        ...
        switch (field.id)
        {
          case UPDATEATTRIBUTES_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set455 = iprot.readSetBegin();
                this.updateAttributes = new IntSet();
                for( _i456 in 0 ... _set455.size)
                {
                  var _elem457 : Int;
                  _elem457 = iprot.readI32();
                  this.updateAttributes.add(_elem457);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updateAttributes != null) {
        oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
        {
          ...
          for( elem458 in this.updateAttributes.toArray())
          {
            oprot.writeI32(elem458);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareFeatureSetResponse(";
    var first : Bool = true;
