...
class FetchSquareChatEventsRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FetchSquareChatEventsRequest"); };
  ...
  static var DIRECTION_FIELD_DESC = { new TField("direction", TType.I32, 5); };
  ...
  inline static var DIRECTION_FIELD_ID : Int = 5;
  ...
  public function toString() : String {
    var ret : String = "FetchSquareChatEventsRequest(";
    var first : Bool = true;
    ...
    if (!first) ret +=  ", ";
    ret += "direction:";
    var direction_name : String = .FetchDirection.VALUES_TO_NAMES[this.direction];
