...
class GetCountriesHavingBuddy_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCountriesHavingBuddy_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list713 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i714 in 0 ... _list713.size)
                {
                  var _elem715 : String;
                  _elem715 = iprot.readString();
                  this.success.add(_elem715);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem716 in this.success)
          {
            oprot.writeString(elem716);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetCountriesHavingBuddy_result(";
    var first : Bool = true;
