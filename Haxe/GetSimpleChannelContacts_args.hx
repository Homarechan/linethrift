        ...
        switch (field.id)
        {
          case IDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1576 = iprot.readListBegin();
                this.ids = new List< String>();
                for( _i1577 in 0 ... _list1576.size)
                {
                  var _elem1578 : String;
                  _elem1578 = iprot.readString();
                  this.ids.add(_elem1578);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.ids != null) {
        oprot.writeFieldBegin(IDS_FIELD_DESC);
        {
          ...
          for( elem1579 in this.ids)
          {
            oprot.writeString(elem1579);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
