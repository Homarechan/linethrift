...
class IssueOTP_result implements TBase {
  ...
  public function get_success() : OTPResult {
    return this.success;
  }

  public function set_success(success:OTPResult) : OTPResult {
  ...
  public function toString() : String {
    var ret : String = "IssueOTP_result(";
    var first : Bool = true;
