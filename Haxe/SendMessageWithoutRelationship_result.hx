...
class SendMessageWithoutRelationship_result implements TBase {
  ...
  public function get_success() : Message {
    return this.success;
  }

  public function set_success(success:Message) : Message {
  ...
  public function toString() : String {
    var ret : String = "SendMessageWithoutRelationship_result(";
    var first : Bool = true;
