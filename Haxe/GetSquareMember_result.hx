...
class GetSquareMember_result implements TBase {
  ...
  public function get_success() : GetSquareMemberResponse {
    return this.success;
  }

  public function set_success(success:GetSquareMemberResponse) : GetSquareMemberResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareMember_result(";
    var first : Bool = true;
