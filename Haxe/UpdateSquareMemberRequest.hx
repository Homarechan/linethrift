        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set563 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i564 in 0 ... _set563.size)
                {
                  var _elem565 : Int;
                  _elem565 = iprot.readI32();
                  this.updatedAttrs.add(_elem565);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case UPDATEDPREFERENCEATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set566 = iprot.readSetBegin();
                this.updatedPreferenceAttrs = new IntSet();
                for( _i567 in 0 ... _set566.size)
                {
                  var _elem568 : Int;
                  _elem568 = iprot.readI32();
                  this.updatedPreferenceAttrs.add(_elem568);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem569 in this.updatedAttrs.toArray())
          {
      ...
      if (this.updatedPreferenceAttrs != null) {
        oprot.writeFieldBegin(UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
        {
          ...
          for( elem570 in this.updatedPreferenceAttrs.toArray())
          {
            oprot.writeI32(elem570);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
