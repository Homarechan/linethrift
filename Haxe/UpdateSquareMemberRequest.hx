...
class UpdateSquareMemberRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareMemberRequest"); };
        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set459 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i460 in 0 ... _set459.size)
                {
                  var _elem461 : Int;
                  _elem461 = iprot.readI32();
                  this.updatedAttrs.add(_elem461);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case UPDATEDPREFERENCEATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set462 = iprot.readSetBegin();
                this.updatedPreferenceAttrs = new IntSet();
                for( _i463 in 0 ... _set462.size)
                {
                  var _elem464 : Int;
                  _elem464 = iprot.readI32();
                  this.updatedPreferenceAttrs.add(_elem464);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem465 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem465);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.updatedPreferenceAttrs != null) {
        oprot.writeFieldBegin(UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
        {
          ...
          for( elem466 in this.updatedPreferenceAttrs.toArray())
          {
            oprot.writeI32(elem466);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareMemberRequest(";
    var first : Bool = true;
