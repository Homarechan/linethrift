...
class GetSquareChat_result implements TBase {
  ...
  public function get_success() : GetSquareChatResponse {
    return this.success;
  }

  public function set_success(success:GetSquareChatResponse) : GetSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareChat_result(";
    var first : Bool = true;
