...
class GetSquareAuthority_result implements TBase {
  ...
  public function get_success() : GetSquareAuthorityResponse {
    return this.success;
  }

  public function set_success(success:GetSquareAuthorityResponse) : GetSquareAuthorityResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareAuthority_result(";
    var first : Bool = true;
