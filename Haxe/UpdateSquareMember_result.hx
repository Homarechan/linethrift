...
class UpdateSquareMember_result implements TBase {
  ...
  public function get_success() : UpdateSquareMemberResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareMemberResponse) : UpdateSquareMemberResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareMember_result(";
    var first : Bool = true;
