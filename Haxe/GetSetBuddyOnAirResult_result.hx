...
class GetSetBuddyOnAirResult_result implements TBase {
  ...
  public function get_success() : SetBuddyOnAirResult {
    return this.success;
  }

  public function set_success(success:SetBuddyOnAirResult) : SetBuddyOnAirResult {
  ...
  public function toString() : String {
    var ret : String = "GetSetBuddyOnAirResult_result(";
    var first : Bool = true;
