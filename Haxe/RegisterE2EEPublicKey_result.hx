...
class RegisterE2EEPublicKey_result implements TBase {
  ...
  public function get_success() : E2EEPublicKey {
    return this.success;
  }

  public function set_success(success:E2EEPublicKey) : E2EEPublicKey {
  ...
  public function toString() : String {
    var ret : String = "RegisterE2EEPublicKey_result(";
    var first : Bool = true;
