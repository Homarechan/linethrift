        ...
        switch (field.id)
        {
          case REJECTEDMEMBERS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list602 = iprot.readListBegin();
                this.rejectedMembers = new List< SquareMember>();
                for( _i603 in 0 ... _list602.size)
                {
                  var _elem604 : SquareMember;
                  _elem604 = new SquareMember();
                  _elem604.read(iprot);
                  this.rejectedMembers.add(_elem604);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.rejectedMembers != null) {
        oprot.writeFieldBegin(REJECTED_MEMBERS_FIELD_DESC);
        {
          ...
          for( elem605 in this.rejectedMembers)
          {
            elem605.write(oprot);
          }
          oprot.writeListEnd();
