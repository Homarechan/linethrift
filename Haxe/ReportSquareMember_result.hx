...
class ReportSquareMember_result implements TBase {
  ...
  public function get_success() : ReportSquareMemberResponse {
    return this.success;
  }

  public function set_success(success:ReportSquareMemberResponse) : ReportSquareMemberResponse {
  ...
  public function toString() : String {
    var ret : String = "ReportSquareMember_result(";
    var first : Bool = true;
