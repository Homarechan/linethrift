...
class UpdateSquareAuthority_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareAuthority_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UpdateSquareAuthorityResponse;
  @:isVar
  ...
  public function get_success() : UpdateSquareAuthorityResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareAuthorityResponse) : UpdateSquareAuthorityResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareAuthority_result(";
    var first : Bool = true;
