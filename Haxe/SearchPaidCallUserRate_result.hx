...
class SearchPaidCallUserRate_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("SearchPaidCallUserRate_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< PaidCallUserRate>;
  @:isVar
  ...
  public function get_success() : List< PaidCallUserRate> {
    return this.success;
  }

  public function set_success(success:List< PaidCallUserRate>) : List< PaidCallUserRate> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1460 = iprot.readListBegin();
                this.success = new List< PaidCallUserRate>();
                for( _i1461 in 0 ... _list1460.size)
                {
                  var _elem1462 : PaidCallUserRate;
                  _elem1462 = new PaidCallUserRate();
                  _elem1462.read(iprot);
                  this.success.add(_elem1462);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1463 in this.success)
          {
            elem1463.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "SearchPaidCallUserRate_result(";
    var first : Bool = true;
