        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1564 = iprot.readListBegin();
                this.success = new List< PaidCallUserRate>();
                for( _i1565 in 0 ... _list1564.size)
                {
                  var _elem1566 : PaidCallUserRate;
                  _elem1566 = new PaidCallUserRate();
                  _elem1566.read(iprot);
                  this.success.add(_elem1566);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1567 in this.success)
          {
            elem1567.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
