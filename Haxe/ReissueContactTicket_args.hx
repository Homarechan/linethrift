...
class ReissueContactTicket_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("reissueContactTicket_args"); };
  static var EXPIRATION_TIME_FIELD_DESC = { new TField("expirationTime", TType.I64, 3); };
  static var MAX_USE_COUNT_FIELD_DESC = { new TField("maxUseCount", TType.I32, 4); };
  ...
  inline static var MAXUSECOUNT_FIELD_ID : Int = 4;
  ...
  public function toString() : String {
    var ret : String = "reissueContactTicket_args(";
    var first : Bool = true;
