...
class GetJoinedSquareChats_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetJoinedSquareChats_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetJoinedSquareChatsResponse;
  @:isVar
  ...
  public function get_success() : GetJoinedSquareChatsResponse {
    return this.success;
  }

  public function set_success(success:GetJoinedSquareChatsResponse) : GetJoinedSquareChatsResponse {
  ...
  public function toString() : String {
    var ret : String = "GetJoinedSquareChats_result(";
    var first : Bool = true;
