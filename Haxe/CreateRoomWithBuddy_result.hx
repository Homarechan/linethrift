...
class CreateRoomWithBuddy_result implements TBase {
  ...
  public function get_success() : Room {
    return this.success;
  }

  public function set_success(success:Room) : Room {
  ...
  public function toString() : String {
    var ret : String = "CreateRoomWithBuddy_result(";
    var first : Bool = true;
