...
class DeleteSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("deleteSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : DeleteSquareChatRequest;
  ...
  public function get_request() : DeleteSquareChatRequest {
    return this.request;
  }

  public function set_request(request:DeleteSquareChatRequest) : DeleteSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "deleteSquareChat_args(";
    var first : Bool = true;
