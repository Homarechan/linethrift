        ...
        switch (field.id)
        {
          ...
          case SPAMMERREASONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1299 = iprot.readListBegin();
                this.spammerReasons = new List< Int>();
                for( _i1300 in 0 ... _list1299.size)
                {
                  var _elem1301 : Int;
                  _elem1301 = iprot.readI32();
                  this.spammerReasons.add(_elem1301);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SPAMMESSAGEIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1302 = iprot.readListBegin();
                this.spamMessageIds = new List< String>();
                for( _i1303 in 0 ... _list1302.size)
                {
                  var _elem1304 : String;
                  _elem1304 = iprot.readString();
                  this.spamMessageIds.add(_elem1304);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.spammerReasons != null) {
        oprot.writeFieldBegin(SPAMMER_REASONS_FIELD_DESC);
        {
          ...
          for( elem1305 in this.spammerReasons)
          {
            oprot.writeI32(elem1305);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.spamMessageIds != null) {
        oprot.writeFieldBegin(SPAM_MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for( elem1306 in this.spamMessageIds)
          {
            oprot.writeString(elem1306);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
