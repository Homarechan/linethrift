...
class GetOAFriendMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetOAFriendMids_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1456 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1457 in 0 ... _list1456.size)
                {
                  var _elem1458 : String;
                  _elem1458 = iprot.readString();
                  this.success.add(_elem1458);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1459 in this.success)
          {
            oprot.writeString(elem1459);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetOAFriendMids_result(";
    var first : Bool = true;
