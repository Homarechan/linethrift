        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1560 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1561 in 0 ... _list1560.size)
                {
                  var _elem1562 : String;
                  _elem1562 = iprot.readString();
                  this.success.add(_elem1562);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1563 in this.success)
          {
            oprot.writeString(elem1563);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
