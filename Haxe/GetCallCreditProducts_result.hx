        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1435 = iprot.readListBegin();
                this.success = new List< CoinProductItem>();
                for( _i1436 in 0 ... _list1435.size)
                {
                  var _elem1437 : CoinProductItem;
                  _elem1437 = new CoinProductItem();
                  _elem1437.read(iprot);
                  this.success.add(_elem1437);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1438 in this.success)
          {
            elem1438.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
