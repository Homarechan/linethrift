        ...
        switch (field.id)
        {
          ...
          case EXTRA_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map678 = iprot.readMapBegin();
                this.extra = new StringMap< String>();
                for( _i679 in 0 ... _map678.size)
                {
                  var _key680 : String;
                  var _val681 : String;
                  _key680 = iprot.readString();
                  _val681 = iprot.readString();
                  this.extra.set( _key680, _val681);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.extra != null) {
        ...
        {
          var _sizeCounter683 : Int = 0;
          for( _key682 in this.extra) {
            _sizeCounter683++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter683));
          for( elem684 in this.extra.keys())
          {
            oprot.writeString(elem684);
            oprot.writeString(this.extra.get(elem684));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
