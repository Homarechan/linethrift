...
class UpdateGroup_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateGroup_args"); };
  static var REQ_SEQ_FIELD_DESC = { new TField("reqSeq", TType.I32, 1); };
  static var GROUP_FIELD_DESC = { new TField("group", TType.STRUCT, 2); };
  ...
  inline static var GROUP_FIELD_ID : Int = 2;
  ...
  public function set_group(group:Group) : Group {
    this.group = group;
    return this.group;
  }
  ...
  public function toString() : String {
    var ret : String = "updateGroup_args(";
    var first : Bool = true;
