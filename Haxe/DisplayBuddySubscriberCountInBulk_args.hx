        ...
        switch (field.id)
        {
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1525 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i1526 in 0 ... _list1525.size)
                {
                  var _elem1527 : String;
                  _elem1527 = iprot.readString();
                  this.mids.add(_elem1527);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem1528 in this.mids)
          {
            oprot.writeString(elem1528);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
