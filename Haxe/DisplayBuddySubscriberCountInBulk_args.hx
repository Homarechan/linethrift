...
class DisplayBuddySubscriberCountInBulk_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("displayBuddySubscriberCountInBulk_args"); };
        ...
        switch (field.id)
        {
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1421 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i1422 in 0 ... _list1421.size)
                {
                  var _elem1423 : String;
                  _elem1423 = iprot.readString();
                  this.mids.add(_elem1423);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem1424 in this.mids)
          {
            oprot.writeString(elem1424);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "displayBuddySubscriberCountInBulk_args(";
    var first : Bool = true;
