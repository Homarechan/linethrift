...
class InviteIntoRoom_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("inviteIntoRoom_args"); };
  static var REQ_SEQ_FIELD_DESC = { new TField("reqSeq", TType.I32, 1); };
  static var ROOM_ID_FIELD_DESC = { new TField("roomId", TType.STRING, 2); };
  ...
  inline static var ROOMID_FIELD_ID : Int = 2;
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem1124 in this.contactIds)
          {
  ...
  public function toString() : String {
    var ret : String = "inviteIntoRoom_args(";
    var first : Bool = true;
