...
class GetPaidCallMetadata_result implements TBase {
  ...
  public function get_success() : PaidCallMetadataResult {
    return this.success;
  }

  public function set_success(success:PaidCallMetadataResult) : PaidCallMetadataResult {
  ...
  public function toString() : String {
    var ret : String = "GetPaidCallMetadata_result(";
    var first : Bool = true;
