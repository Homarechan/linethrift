...
class SendMessage_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("sendMessage_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : SendMessageRequest;
  ...
  public function get_request() : SendMessageRequest {
    return this.request;
  }

  public function set_request(request:SendMessageRequest) : SendMessageRequest {
  ...
  public function toString() : String {
    var ret : String = "sendMessage_args(";
    var first : Bool = true;
