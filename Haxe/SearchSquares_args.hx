...
class SearchSquares_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("searchSquares_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : SearchSquaresRequest;
  ...
  public function get_request() : SearchSquaresRequest {
    return this.request;
  }

  public function set_request(request:SearchSquaresRequest) : SearchSquaresRequest {
  ...
  public function toString() : String {
    var ret : String = "searchSquares_args(";
    var first : Bool = true;
