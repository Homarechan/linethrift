...
class SendBuddyContentMessageToMidsAsync_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("sendBuddyContentMessageToMidsAsync_args"); };
        ...
        switch (field.id)
        {
          ...
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list665 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i666 in 0 ... _list665.size)
                {
                  var _elem667 : String;
                  _elem667 = iprot.readString();
                  this.mids.add(_elem667);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem668 in this.mids)
          {
            oprot.writeString(elem668);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "sendBuddyContentMessageToMidsAsync_args(";
    var first : Bool = true;
