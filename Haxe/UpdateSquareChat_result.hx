...
class UpdateSquareChat_result implements TBase {
  ...
  public function get_success() : UpdateSquareChatResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareChatResponse) : UpdateSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareChat_result(";
    var first : Bool = true;
