        ...
        switch (field.id)
        {
          ...
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1443 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i1444 in 0 ... _list1443.size)
                {
                  var _elem1445 : String;
                  _elem1445 = iprot.readString();
                  this.mids.add(_elem1445);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem1446 in this.mids)
          {
            oprot.writeString(elem1446);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
