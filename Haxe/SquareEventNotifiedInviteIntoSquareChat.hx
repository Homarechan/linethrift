        ...
        switch (field.id)
        {
          ...
          case INVITEES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list371 = iprot.readListBegin();
                this.invitees = new List< SquareMember>();
                for( _i372 in 0 ... _list371.size)
                {
                  var _elem373 : SquareMember;
                  _elem373 = new SquareMember();
                  _elem373.read(iprot);
                  this.invitees.add(_elem373);
                }
                iprot.readListEnd();
              }
            } else { 
