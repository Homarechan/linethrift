...
class InviteToSquare_result implements TBase {
  ...
  public function get_success() : InviteToSquareResponse {
    return this.success;
  }

  public function set_success(success:InviteToSquareResponse) : InviteToSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "InviteToSquare_result(";
    var first : Bool = true;
