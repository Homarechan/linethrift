        ...
        switch (field.id)
        {
          case CHATIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1255 = iprot.readListBegin();
                this.chatIds = new List< String>();
                for( _i1256 in 0 ... _list1255.size)
                {
                  var _elem1257 : String;
                  _elem1257 = iprot.readString();
                  this.chatIds.add(_elem1257);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.chatIds != null) {
        oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
        {
          ...
          for( elem1258 in this.chatIds)
          {
            oprot.writeString(elem1258);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
