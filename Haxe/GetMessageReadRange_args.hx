...
class GetMessageReadRange_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getMessageReadRange_args"); };
        ...
        switch (field.id)
        {
          case CHATIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1151 = iprot.readListBegin();
                this.chatIds = new List< String>();
                for( _i1152 in 0 ... _list1151.size)
                {
                  var _elem1153 : String;
                  _elem1153 = iprot.readString();
                  this.chatIds.add(_elem1153);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.chatIds != null) {
        oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
        {
          ...
          for( elem1154 in this.chatIds)
          {
            oprot.writeString(elem1154);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "getMessageReadRange_args(";
    var first : Bool = true;
