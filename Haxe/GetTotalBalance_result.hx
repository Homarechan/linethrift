...
class GetTotalBalance_result implements TBase {
  ...
  public function get_success() : Coin {
    return this.success;
  }

  public function set_success(success:Coin) : Coin {
  ...
  public function toString() : String {
    var ret : String = "GetTotalBalance_result(";
    var first : Bool = true;
