        ...
        switch (field.id)
        {
          ...
          case ITEMLIST_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list304 = iprot.readListBegin();
                this.itemList = new List< NotificationItem>();
                for( _i305 in 0 ... _list304.size)
                {
                  var _elem306 : NotificationItem;
                  _elem306 = new NotificationItem();
                  _elem306.read(iprot);
                  this.itemList.add(_elem306);
                }
                iprot.readListEnd();
              }
            } else { 
