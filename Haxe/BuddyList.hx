        ...
        switch (field.id)
        {
          ...
          case POPULARCONTACTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list156 = iprot.readListBegin();
                this.popularContacts = new List< Contact>();
                for( _i157 in 0 ... _list156.size)
                {
                  var _elem158 : Contact;
                  _elem158 = new Contact();
                  _elem158.read(iprot);
                  this.popularContacts.add(_elem158);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.popularContacts != null) {
        oprot.writeFieldBegin(POPULAR_CONTACTS_FIELD_DESC);
        {
          ...
          for( elem159 in this.popularContacts)
          {
            elem159.write(oprot);
          }
          oprot.writeListEnd();
