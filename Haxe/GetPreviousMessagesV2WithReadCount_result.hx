...
class GetPreviousMessagesV2WithReadCount_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetPreviousMessagesV2WithReadCount_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< Message>;
  @:isVar
  ...
  public function get_success() : List< Message> {
    return this.success;
  }

  public function set_success(success:List< Message>) : List< Message> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1165 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1166 in 0 ... _list1165.size)
                {
                  var _elem1167 : Message;
                  _elem1167 = new Message();
                  _elem1167.read(iprot);
                  this.success.add(_elem1167);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1168 in this.success)
          {
            elem1168.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetPreviousMessagesV2WithReadCount_result(";
    var first : Bool = true;
