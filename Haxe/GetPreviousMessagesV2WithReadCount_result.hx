        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1061 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1062 in 0 ... _list1061.size)
                {
                  var _elem1063 : Message;
                  _elem1063 = new Message();
                  _elem1063.read(iprot);
                  this.success.add(_elem1063);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1064 in this.success)
          {
            elem1064.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
