...
class GetGroupsForChannel_result implements TBase {
  ...
  public function get_success() : List< Group> {
    return this.success;
  }

  public function set_success(success:List< Group>) : List< Group> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1367 = iprot.readListBegin();
                this.success = new List< Group>();
                for( _i1368 in 0 ... _list1367.size)
                {
                  var _elem1369 : Group;
                  _elem1369 = new Group();
                  _elem1369.read(iprot);
                  this.success.add(_elem1369);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1370 in this.success)
          {
            elem1370.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupsForChannel_result(";
    var first : Bool = true;
