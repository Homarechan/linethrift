...
class Contact implements TBase {
  ...
  static var STATUS_MESSAGE_CONTENT_METADATA_FIELD_DESC = { new TField("statusMessageContentMetadata", TType.MAP, 43); };
  ...
  @:isVar
  public var statusMessageContentMetadata(get,set) : StringMap< String>;
  ...
  inline static var STATUSMESSAGECONTENTMETADATA_FIELD_ID : Int = 43;
  ...
  public function get_statusMessageContentMetadata() : StringMap< String> {
    return this.statusMessageContentMetadata;
  }

  public function set_statusMessageContentMetadata(statusMessageContentMetadata:StringMap< String>) : StringMap< String> {
    this.statusMessageContentMetadata = statusMessageContentMetadata;
    return this.statusMessageContentMetadata;
  }

  public function unsetStatusMessageContentMetadata() : Void {
  ...
  public function isSetStatusMessageContentMetadata() : Bool {
  ...
  public function setFieldValue(fieldID : Int, value : Dynamic) : Void {
    ...
    case STATUSMESSAGECONTENTMETADATA_FIELD_ID:
      if (value == null) {
        unsetStatusMessageContentMetadata();
      } else {
        this.statusMessageContentMetadata = value;
      }
        ...
        switch (field.id)
        {
          ...
          case STATUSMESSAGECONTENTMETADATA_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map149 = iprot.readMapBegin();
                this.statusMessageContentMetadata = new StringMap< String>();
                for( _i150 in 0 ... _map149.size)
                {
                  var _key151 : String;
                  var _val152 : String;
                  _key151 = iprot.readString();
                  _val152 = iprot.readString();
                  this.statusMessageContentMetadata.set( _key151, _val152);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.statusMessageContentMetadata != null) {
        ...
        {
          var _sizeCounter154 : Int = 0;
          for( _key153 in this.statusMessageContentMetadata) {
            _sizeCounter154++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter154));
          for( elem155 in this.statusMessageContentMetadata.keys())
          {
            oprot.writeString(elem155);
            oprot.writeString(this.statusMessageContentMetadata.get(elem155));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    ...
    first = false;
    if (!first) ret +=  ", ";
    ret += "statusMessageContentMetadata:";
    if (this.statusMessageContentMetadata == null) {
      ret += "null";
    } else {
      ret += this.statusMessageContentMetadata;
    }
    first = false;
    ret += ")";
    return ret;
