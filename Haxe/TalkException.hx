        ...
        switch (field.id)
        {
          ...
          case PARAMETERMAP_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map671 = iprot.readMapBegin();
                this.parameterMap = new StringMap< String>();
                for( _i672 in 0 ... _map671.size)
                {
                  var _key673 : String;
                  var _val674 : String;
                  _key673 = iprot.readString();
                  _val674 = iprot.readString();
                  this.parameterMap.set( _key673, _val674);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.parameterMap != null) {
        ...
        {
          var _sizeCounter676 : Int = 0;
          for( _key675 in this.parameterMap) {
            _sizeCounter676++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter676));
          for( elem677 in this.parameterMap.keys())
          {
            oprot.writeString(elem677);
            oprot.writeString(this.parameterMap.get(elem677));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
