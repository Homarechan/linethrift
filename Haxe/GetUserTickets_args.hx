        ...
        switch (field.id)
        {
          case USERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1448 = iprot.readListBegin();
                this.userMids = new List< String>();
                for( _i1449 in 0 ... _list1448.size)
                {
                  var _elem1450 : String;
                  _elem1450 = iprot.readString();
                  this.userMids.add(_elem1450);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.userMids != null) {
        oprot.writeFieldBegin(USER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1451 in this.userMids)
          {
            oprot.writeString(elem1451);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
