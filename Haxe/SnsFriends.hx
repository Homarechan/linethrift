        ...
        switch (field.id)
        {
          case SNSFRIENDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list377 = iprot.readListBegin();
                this.snsFriends = new List< SnsFriend>();
                for( _i378 in 0 ... _list377.size)
                {
                  var _elem379 : SnsFriend;
                  _elem379 = new SnsFriend();
                  _elem379.read(iprot);
                  this.snsFriends.add(_elem379);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.snsFriends != null) {
        oprot.writeFieldBegin(SNS_FRIENDS_FIELD_DESC);
        {
          ...
          for( elem380 in this.snsFriends)
          {
            elem380.write(oprot);
          }
          oprot.writeListEnd();
