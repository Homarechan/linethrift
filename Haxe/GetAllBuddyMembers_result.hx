...
class GetAllBuddyMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetAllBuddyMembers_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list742 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i743 in 0 ... _list742.size)
                {
                  var _elem744 : String;
                  _elem744 = iprot.readString();
                  this.success.add(_elem744);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem745 in this.success)
          {
            oprot.writeString(elem745);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetAllBuddyMembers_result(";
    var first : Bool = true;
