...
class GetSquareMembers_result implements TBase {
  ...
  public function get_success() : GetSquareMembersResponse {
    return this.success;
  }

  public function set_success(success:GetSquareMembersResponse) : GetSquareMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareMembers_result(";
    var first : Bool = true;
