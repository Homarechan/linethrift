...
class GetIdentityCredential_result implements TBase {
  ...
  public function get_success() : IdentityCredential {
    return this.success;
  }

  public function set_success(success:IdentityCredential) : IdentityCredential {
  ...
  public function toString() : String {
    var ret : String = "GetIdentityCredential_result(";
    var first : Bool = true;
