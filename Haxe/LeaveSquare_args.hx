...
class LeaveSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("leaveSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : LeaveSquareRequest;
  ...
  public function get_request() : LeaveSquareRequest {
    return this.request;
  }

  public function set_request(request:LeaveSquareRequest) : LeaveSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "leaveSquare_args(";
    var first : Bool = true;
