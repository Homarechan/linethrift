...
class ReportSquareChat_result implements TBase {
  ...
  public function get_success() : ReportSquareChatResponse {
    return this.success;
  }

  public function set_success(success:ReportSquareChatResponse) : ReportSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "ReportSquareChat_result(";
    var first : Bool = true;
