...
class GetSquareMemberRelations_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareMemberRelations_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareMemberRelationsRequest;
  ...
  public function get_request() : GetSquareMemberRelationsRequest {
    return this.request;
  }

  public function set_request(request:GetSquareMemberRelationsRequest) : GetSquareMemberRelationsRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareMemberRelations_args(";
    var first : Bool = true;
