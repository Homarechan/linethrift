...
class DeleteSquare_result implements TBase {
  ...
  public function get_success() : DeleteSquareResponse {
    return this.success;
  }

  public function set_success(success:DeleteSquareResponse) : DeleteSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "DeleteSquare_result(";
    var first : Bool = true;
