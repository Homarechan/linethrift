        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1476 = iprot.readListBegin();
                this.success = new List< SimpleChannelContact>();
                for( _i1477 in 0 ... _list1476.size)
                {
                  var _elem1478 : SimpleChannelContact;
                  _elem1478 = new SimpleChannelContact();
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1479 in this.success)
          {
            elem1479.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
