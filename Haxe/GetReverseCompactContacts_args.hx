        ...
        switch (field.id)
        {
          case IDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1510 = iprot.readListBegin();
                this.ids = new List< String>();
                for( _i1511 in 0 ... _list1510.size)
                {
                  var _elem1512 : String;
                  _elem1512 = iprot.readString();
                  this.ids.add(_elem1512);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.ids != null) {
        oprot.writeFieldBegin(IDS_FIELD_DESC);
        {
          ...
          for( elem1513 in this.ids)
          {
            oprot.writeString(elem1513);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
