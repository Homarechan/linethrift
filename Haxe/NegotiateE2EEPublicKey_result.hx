...
class NegotiateE2EEPublicKey_result implements TBase {
  ...
  public function get_success() : E2EENegotiationResult {
    return this.success;
  }

  public function set_success(success:E2EENegotiationResult) : E2EENegotiationResult {
  ...
  public function toString() : String {
    var ret : String = "NegotiateE2EEPublicKey_result(";
    var first : Bool = true;
