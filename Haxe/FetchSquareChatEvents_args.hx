...
class FetchSquareChatEvents_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("fetchSquareChatEvents_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : FetchSquareChatEventsRequest;
  ...
  public function get_request() : FetchSquareChatEventsRequest {
    return this.request;
  }

  public function set_request(request:FetchSquareChatEventsRequest) : FetchSquareChatEventsRequest {
  ...
  public function toString() : String {
    var ret : String = "fetchSquareChatEvents_args(";
    var first : Bool = true;
