...
class GetChannelNotificationSetting_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetChannelNotificationSetting_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ChannelNotificationSetting;
  @:isVar
  ...
  public function get_success() : ChannelNotificationSetting {
    return this.success;
  }

  public function set_success(success:ChannelNotificationSetting) : ChannelNotificationSetting {
  ...
  public function toString() : String {
    var ret : String = "GetChannelNotificationSetting_result(";
    var first : Bool = true;
