        ...
        switch (field.id)
        {
          ...
          case PARAMETERMAP_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map581 = iprot.readMapBegin();
                this.parameterMap = new StringMap< String>();
                for( _i582 in 0 ... _map581.size)
                {
                  var _key583 : String;
                  var _val584 : String;
                  _key583 = iprot.readString();
                  _val584 = iprot.readString();
                  this.parameterMap.set( _key583, _val584);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.parameterMap != null) {
        ...
        {
          var _sizeCounter586 : Int = 0;
          for( _key585 in this.parameterMap) {
            _sizeCounter586++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter586));
          for( elem587 in this.parameterMap.keys())
          {
            oprot.writeString(elem587);
            oprot.writeString(this.parameterMap.get(elem587));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
