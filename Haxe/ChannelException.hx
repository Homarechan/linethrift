...
class ChannelException extends TException implements TBase {
  
  static var STRUCT_DESC = { new TStruct("ChannelException"); };
        ...
        switch (field.id)
        {
          ...
          case PARAMETERMAP_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map685 = iprot.readMapBegin();
                this.parameterMap = new StringMap< String>();
                for( _i686 in 0 ... _map685.size)
                {
                  var _key687 : String;
                  var _val688 : String;
                  _key687 = iprot.readString();
                  _val688 = iprot.readString();
                  this.parameterMap.set( _key687, _val688);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.parameterMap != null) {
        ...
        {
          var _sizeCounter690 : Int = 0;
          for( _key689 in this.parameterMap) {
            _sizeCounter690++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter690));
          for( elem691 in this.parameterMap.keys())
          {
            oprot.writeString(elem691);
            oprot.writeString(this.parameterMap.get(elem691));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "ChannelException(";
    var first : Bool = true;

    ret += "code:";
    var code_name : String = .ChannelErrorCode.VALUES_TO_NAMES[this.code];
    if (code_name != null) {
      ret += code_name;
      ret += " (";
    }
  ...
  public function validate() : Void {
    ...
    if (isSetCode() && !.ChannelErrorCode.VALID_VALUES.contains(code)){
