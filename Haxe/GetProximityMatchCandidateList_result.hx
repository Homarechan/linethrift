...
class GetProximityMatchCandidateList_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetProximityMatchCandidateList_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ProximityMatchCandidateResult;
  @:isVar
  ...
  public function get_success() : ProximityMatchCandidateResult {
    return this.success;
  }

  public function set_success(success:ProximityMatchCandidateResult) : ProximityMatchCandidateResult {
  ...
  public function toString() : String {
    var ret : String = "GetProximityMatchCandidateList_result(";
    var first : Bool = true;
