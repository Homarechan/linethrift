...
class FindContactByUseridWithoutAbuseBlockForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FindContactByUseridWithoutAbuseBlockForChannel_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : Contact;
  @:isVar
  ...
  public function get_success() : Contact {
    return this.success;
  }

  public function set_success(success:Contact) : Contact {
  ...
  public function toString() : String {
    var ret : String = "FindContactByUseridWithoutAbuseBlockForChannel_result(";
    var first : Bool = true;
