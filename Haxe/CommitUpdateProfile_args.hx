        ...
        switch (field.id)
        {
          ...
          case ATTRS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1000 = iprot.readListBegin();
                this.attrs = new List< Int>();
                for( _i1001 in 0 ... _list1000.size)
                {
                  var _elem1002 : Int;
                  _elem1002 = iprot.readI32();
                  this.attrs.add(_elem1002);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case RECEIVERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1003 = iprot.readListBegin();
                this.receiverMids = new List< String>();
                for( _i1004 in 0 ... _list1003.size)
                {
                  var _elem1005 : String;
                  _elem1005 = iprot.readString();
                  this.receiverMids.add(_elem1005);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.attrs != null) {
        oprot.writeFieldBegin(ATTRS_FIELD_DESC);
        {
          ...
          for( elem1006 in this.attrs)
          {
            oprot.writeI32(elem1006);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.receiverMids != null) {
        oprot.writeFieldBegin(RECEIVER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1007 in this.receiverMids)
          {
