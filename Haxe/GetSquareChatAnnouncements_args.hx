...
class GetSquareChatAnnouncements_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareChatAnnouncements_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareChatAnnouncementsRequest;
  ...
  public function get_request() : GetSquareChatAnnouncementsRequest {
    return this.request;
  }

  public function set_request(request:GetSquareChatAnnouncementsRequest) : GetSquareChatAnnouncementsRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareChatAnnouncements_args(";
    var first : Bool = true;
