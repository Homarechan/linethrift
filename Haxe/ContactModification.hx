      ...
      while (true)
      {
        ...
        switch (field.id)
        {
          ...
          case EMAILS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list222 = iprot.readListBegin();
                this.emails = new List< String>();
                for( _i223 in 0 ... _list222.size)
                {
                  var _elem224 : String;
                  _elem224 = iprot.readString();
                  this.emails.add(_elem224);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case USERIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list225 = iprot.readListBegin();
                this.userids = new List< String>();
                for( _i226 in 0 ... _list225.size)
                {
                  var _elem227 : String;
                  _elem227 = iprot.readString();
                  this.userids.add(_elem227);
                }
                iprot.readListEnd();
              }
            } else { 
