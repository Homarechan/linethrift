...
class DestroyMessage_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("destroyMessage_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : DestroyMessageRequest;
  ...
  public function get_request() : DestroyMessageRequest {
    return this.request;
  }

  public function set_request(request:DestroyMessageRequest) : DestroyMessageRequest {
  ...
  public function toString() : String {
    var ret : String = "destroyMessage_args(";
    var first : Bool = true;
