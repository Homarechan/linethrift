...
class GetCategories_result implements TBase {
  ...
  public function get_success() : GetSquareCategoriesResponse {
    return this.success;
  }

  public function set_success(success:GetSquareCategoriesResponse) : GetSquareCategoriesResponse {
  ...
  public function toString() : String {
    var ret : String = "GetCategories_result(";
    var first : Bool = true;
