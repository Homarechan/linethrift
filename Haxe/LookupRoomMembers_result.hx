        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1436 = iprot.readListBegin();
                this.success = new List< SimpleChannelContact>();
                for( _i1437 in 0 ... _list1436.size)
                {
                  var _elem1438 : SimpleChannelContact;
                  _elem1438 = new SimpleChannelContact();
