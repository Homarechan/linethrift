...
class LookupRoomMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("LookupRoomMembers_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1540 = iprot.readListBegin();
                this.success = new List< SimpleChannelContact>();
                for( _i1541 in 0 ... _list1540.size)
                {
                  var _elem1542 : SimpleChannelContact;
                  _elem1542 = new SimpleChannelContact();
                  _elem1542.read(iprot);
                  this.success.add(_elem1542);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1543 in this.success)
          {
            elem1543.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "LookupRoomMembers_result(";
    var first : Bool = true;
