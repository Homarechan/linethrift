...
class RemoveSubscriptions_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RemoveSubscriptions_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : RemoveSubscriptionsResponse;
  @:isVar
  ...
  public function get_success() : RemoveSubscriptionsResponse {
    return this.success;
  }

  public function set_success(success:RemoveSubscriptionsResponse) : RemoveSubscriptionsResponse {
  ...
  public function toString() : String {
    var ret : String = "RemoveSubscriptions_result(";
    var first : Bool = true;
