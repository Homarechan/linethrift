...
class MarkPaidCallAd_result implements TBase {
  ...
  public function get_success() : PaidCallDialing {
    return this.success;
  }

  public function set_success(success:PaidCallDialing) : PaidCallDialing {
  ...
  public function toString() : String {
    var ret : String = "MarkPaidCallAd_result(";
    var first : Bool = true;
