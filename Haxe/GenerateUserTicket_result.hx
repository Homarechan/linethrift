...
class GenerateUserTicket_result implements TBase {
  ...
  public function get_success() : Ticket {
    return this.success;
  }

  public function set_success(success:Ticket) : Ticket {
  ...
  public function toString() : String {
    var ret : String = "GenerateUserTicket_result(";
    var first : Bool = true;
