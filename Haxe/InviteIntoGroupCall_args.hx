        ...
        switch (field.id)
        {
          ...
          case MEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1459 = iprot.readListBegin();
                this.memberMids = new List< String>();
                for( _i1460 in 0 ... _list1459.size)
                {
                  var _elem1461 : String;
                  _elem1461 = iprot.readString();
                  this.memberMids.add(_elem1461);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.memberMids != null) {
        oprot.writeFieldBegin(MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1462 in this.memberMids)
          {
            oprot.writeString(elem1462);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
