...
class NotificationTarget implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("NotificationTarget"); };
  ...
  static var REGION_FIELD_DESC = { new TField("region", TType.STRING, 3); };
  ...
  inline static var REGION_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "NotificationTarget(";
    var first : Bool = true;
