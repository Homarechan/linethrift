...
class GetSystemConfiguration_result implements TBase {
  ...
  public function get_success() : SystemConfiguration {
    return this.success;
  }

  public function set_success(success:SystemConfiguration) : SystemConfiguration {
  ...
  public function toString() : String {
    var ret : String = "GetSystemConfiguration_result(";
    var first : Bool = true;
