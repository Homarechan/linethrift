...
class UpdateSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareRequest;
  ...
  public function get_request() : UpdateSquareRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareRequest) : UpdateSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquare_args(";
    var first : Bool = true;
