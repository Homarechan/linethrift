        ...
        switch (field.id)
        {
          ...
          case LASTREADMESSAGEIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list263 = iprot.readListBegin();
                this.lastReadMessageIds = new List< LastReadMessageId>();
                for( _i264 in 0 ... _list263.size)
                {
                  var _elem265 : LastReadMessageId;
                  _elem265 = new LastReadMessageId();
                  _elem265.read(iprot);
                  this.lastReadMessageIds.add(_elem265);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.lastReadMessageIds != null) {
        oprot.writeFieldBegin(LAST_READ_MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for( elem266 in this.lastReadMessageIds)
          {
            elem266.write(oprot);
          }
          oprot.writeListEnd();
