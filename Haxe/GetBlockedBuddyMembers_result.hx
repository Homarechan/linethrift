...
class GetBlockedBuddyMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBlockedBuddyMembers_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list746 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i747 in 0 ... _list746.size)
                {
                  var _elem748 : String;
                  _elem748 = iprot.readString();
                  this.success.add(_elem748);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem749 in this.success)
          {
            oprot.writeString(elem749);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetBlockedBuddyMembers_result(";
    var first : Bool = true;
