...
class GetBuddyBlockerIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBuddyBlockerIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1021 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1022 in 0 ... _list1021.size)
                {
                  var _elem1023 : String;
                  _elem1023 = iprot.readString();
                  this.success.add(_elem1023);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1024 in this.success)
          {
            oprot.writeString(elem1024);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetBuddyBlockerIds_result(";
    var first : Bool = true;
