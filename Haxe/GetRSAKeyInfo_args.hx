...
class GetRSAKeyInfo_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getRSAKeyInfo_args"); };
  static var PROVIDER_FIELD_DESC = { new TField("provider", TType.I32, 2); };

  @:isVar
  public var provider(get,set) : Int;

  inline static var PROVIDER_FIELD_ID : Int = 2;
  ...
  public function toString() : String {
    var ret : String = "getRSAKeyInfo_args(";
    var first : Bool = true;
