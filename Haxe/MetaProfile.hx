        ...
        switch (field.id)
        {
          ...
          case IDENTITIES_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map290 = iprot.readMapBegin();
                this.identities = new IntMap< String>();
                for( _i291 in 0 ... _map290.size)
                {
                  var _key292 : Int;
                  var _val293 : String;
                  _key292 = iprot.readI32();
                  _val293 = iprot.readString();
                  this.identities.set( _key292, _val293);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.identities != null) {
        ...
        {
          var _sizeCounter295 : Int = 0;
          for( _key294 in this.identities) {
            _sizeCounter295++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.STRING, _sizeCounter295));
          for( elem296 in this.identities.keys())
          {
            oprot.writeI32(elem296);
            oprot.writeString(this.identities.get(elem296));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
