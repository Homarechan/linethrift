        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1233 = iprot.readListBegin();
                this.success = new List< Operation>();
                for( _i1234 in 0 ... _list1233.size)
                {
                  var _elem1235 : Operation;
                  _elem1235 = new Operation();
                  _elem1235.read(iprot);
                  this.success.add(_elem1235);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1236 in this.success)
          {
            elem1236.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
