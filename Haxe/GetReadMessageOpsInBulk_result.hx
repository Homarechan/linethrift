...
class GetReadMessageOpsInBulk_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetReadMessageOpsInBulk_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1337 = iprot.readListBegin();
                this.success = new List< Operation>();
                for( _i1338 in 0 ... _list1337.size)
                {
                  var _elem1339 : Operation;
                  _elem1339 = new Operation();
                  _elem1339.read(iprot);
                  this.success.add(_elem1339);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1340 in this.success)
          {
            elem1340.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetReadMessageOpsInBulk_result(";
    var first : Bool = true;
