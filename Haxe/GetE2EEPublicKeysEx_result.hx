...
class GetE2EEPublicKeysEx_result implements TBase {
  ...
  public function get_success() : List< E2EEPublicKey> {
    return this.success;
  }

  public function set_success(success:List< E2EEPublicKey>) : List< E2EEPublicKey> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1225 = iprot.readListBegin();
                this.success = new List< E2EEPublicKey>();
                for( _i1226 in 0 ... _list1225.size)
                {
                  var _elem1227 : E2EEPublicKey;
                  _elem1227 = new E2EEPublicKey();
                  _elem1227.read(iprot);
                  this.success.add(_elem1227);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1228 in this.success)
          {
            elem1228.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetE2EEPublicKeysEx_result(";
    var first : Bool = true;
