        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1329 = iprot.readListBegin();
                this.success = new List< E2EEPublicKey>();
                for( _i1330 in 0 ... _list1329.size)
                {
                  var _elem1331 : E2EEPublicKey;
                  _elem1331 = new E2EEPublicKey();
                  _elem1331.read(iprot);
                  this.success.add(_elem1331);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1332 in this.success)
          {
            elem1332.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
