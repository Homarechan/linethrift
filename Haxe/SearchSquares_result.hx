...
class SearchSquares_result implements TBase {
  ...
  public function get_success() : SearchSquaresResponse {
    return this.success;
  }

  public function set_success(success:SearchSquaresResponse) : SearchSquaresResponse {
  ...
  public function toString() : String {
    var ret : String = "SearchSquares_result(";
    var first : Bool = true;
