...
class ReportSquareMessage_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ReportSquareMessage_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ReportSquareMessageResponse;
  @:isVar
  ...
  public function get_success() : ReportSquareMessageResponse {
    return this.success;
  }

  public function set_success(success:ReportSquareMessageResponse) : ReportSquareMessageResponse {
  ...
  public function toString() : String {
    var ret : String = "ReportSquareMessage_result(";
    var first : Bool = true;
