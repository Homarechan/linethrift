...
class FetchMyEvents_result implements TBase {
  ...
  public function get_success() : FetchMyEventsResponse {
    return this.success;
  }

  public function set_success(success:FetchMyEventsResponse) : FetchMyEventsResponse {
  ...
  public function toString() : String {
    var ret : String = "FetchMyEvents_result(";
    var first : Bool = true;
