        ...
        switch (field.id)
        {
          ...
          case RECENTINCOMINGS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list139 = iprot.readListBegin();
                this.recentIncomings = new List< FriendRequest>();
                for( _i140 in 0 ... _list139.size)
                {
                  var _elem141 : FriendRequest;
                  _elem141 = new FriendRequest();
                  _elem141.read(iprot);
                  this.recentIncomings.add(_elem141);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case RECENTOUTGOINGS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list142 = iprot.readListBegin();
                this.recentOutgoings = new List< FriendRequest>();
                for( _i143 in 0 ... _list142.size)
                {
                  var _elem144 : FriendRequest;
                  _elem144 = new FriendRequest();
                  _elem144.read(iprot);
                  this.recentOutgoings.add(_elem144);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.recentIncomings != null) {
        oprot.writeFieldBegin(RECENT_INCOMINGS_FIELD_DESC);
        {
          ...
          for( elem145 in this.recentIncomings)
          {
            elem145.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (this.recentOutgoings != null) {
        oprot.writeFieldBegin(RECENT_OUTGOINGS_FIELD_DESC);
        {
          ...
          for( elem146 in this.recentOutgoings)
          {
            elem146.write(oprot);
          }
          oprot.writeListEnd();
