...
class GetCategories_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getCategories_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareCategoriesRequest;
  ...
  public function get_request() : GetSquareCategoriesRequest {
    return this.request;
  }

  public function set_request(request:GetSquareCategoriesRequest) : GetSquareCategoriesRequest {
  ...
  public function toString() : String {
    var ret : String = "getCategories_args(";
    var first : Bool = true;
