...
class GetSquareAuthority_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareAuthority_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareAuthorityRequest;
  ...
  public function get_request() : GetSquareAuthorityRequest {
    return this.request;
  }

  public function set_request(request:GetSquareAuthorityRequest) : GetSquareAuthorityRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareAuthority_args(";
    var first : Bool = true;
