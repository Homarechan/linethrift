...
class AddBuddyMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("addBuddyMembers_args"); };
    ...
    try
    {
      ...
      if (this.userMids != null) {
        oprot.writeFieldBegin(USER_MIDS_FIELD_DESC);
        {
          ...
          for( elem613 in this.userMids)
          {
            oprot.writeString(elem613);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "addBuddyMembers_args(";
    var first : Bool = true;
