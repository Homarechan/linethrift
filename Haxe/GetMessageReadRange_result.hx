...
class GetMessageReadRange_result implements TBase {
  ...
  public function get_success() : List< TMessageReadRange> {
    return this.success;
  }

  public function set_success(success:List< TMessageReadRange>) : List< TMessageReadRange> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1259 = iprot.readListBegin();
                this.success = new List< TMessageReadRange>();
                for( _i1260 in 0 ... _list1259.size)
                {
                  var _elem1261 : TMessageReadRange;
                  _elem1261 = new TMessageReadRange();
                  _elem1261.read(iprot);
                  this.success.add(_elem1261);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1262 in this.success)
          {
            elem1262.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetMessageReadRange_result(";
    var first : Bool = true;
