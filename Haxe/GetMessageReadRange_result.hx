        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1155 = iprot.readListBegin();
                this.success = new List< TMessageReadRange>();
                for( _i1156 in 0 ... _list1155.size)
                {
                  var _elem1157 : TMessageReadRange;
                  _elem1157 = new TMessageReadRange();
                  _elem1157.read(iprot);
                  this.success.add(_elem1157);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1158 in this.success)
          {
            elem1158.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
