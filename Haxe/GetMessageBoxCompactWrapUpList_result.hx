...
class GetMessageBoxCompactWrapUpList_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetMessageBoxCompactWrapUpList_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : TMessageBoxWrapUpResponse;
  @:isVar
  ...
  public function get_success() : TMessageBoxWrapUpResponse {
    return this.success;
  }

  public function set_success(success:TMessageBoxWrapUpResponse) : TMessageBoxWrapUpResponse {
  ...
  public function toString() : String {
    var ret : String = "GetMessageBoxCompactWrapUpList_result(";
    var first : Bool = true;
