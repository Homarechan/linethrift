...
class GetApprovedChannels_result implements TBase {
  ...
  public function get_success() : ApprovedChannelInfos {
    return this.success;
  }

  public function set_success(success:ApprovedChannelInfos) : ApprovedChannelInfos {
  ...
  public function toString() : String {
    var ret : String = "GetApprovedChannels_result(";
    var first : Bool = true;
