        ...
        switch (field.id)
        {
          ...
          case CONTACTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list339 = iprot.readListBegin();
                this.contacts = new List< Contact>();
                for( _i340 in 0 ... _list339.size)
                {
                  var _elem341 : Contact;
                  _elem341 = new Contact();
                  _elem341.read(iprot);
                  this.contacts.add(_elem341);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case MEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list342 = iprot.readListBegin();
                this.memberMids = new List< String>();
                for( _i343 in 0 ... _list342.size)
                {
                  var _elem344 : String;
                  _elem344 = iprot.readString();
                  this.memberMids.add(_elem344);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.memberMids != null) {
        oprot.writeFieldBegin(MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem346 in this.memberMids)
          {
