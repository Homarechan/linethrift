        ...
        switch (field.id)
        {
          ...
          case SYNCPARAMCONTACT_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list300 = iprot.readListBegin();
                this.syncParamContact = new List< SyncParamContact>();
                for( _i301 in 0 ... _list300.size)
                {
                  var _elem302 : SyncParamContact;
                  _elem302 = new SyncParamContact();
                  _elem302.read(iprot);
                  this.syncParamContact.add(_elem302);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SYNCPARAMMID_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list303 = iprot.readListBegin();
                this.syncParamMid = new List< SyncParamMid>();
                for( _i304 in 0 ... _list303.size)
                {
                  var _elem305 : SyncParamMid;
                  _elem305 = new SyncParamMid();
                  _elem305.read(iprot);
                  this.syncParamMid.add(_elem305);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.syncParamContact != null) {
        oprot.writeFieldBegin(SYNC_PARAM_CONTACT_FIELD_DESC);
        {
          ...
          for( elem306 in this.syncParamContact)
          {
            elem306.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (this.syncParamMid != null) {
        oprot.writeFieldBegin(SYNC_PARAM_MID_FIELD_DESC);
        {
          ...
          for( elem307 in this.syncParamMid)
          {
            elem307.write(oprot);
          }
          oprot.writeListEnd();
