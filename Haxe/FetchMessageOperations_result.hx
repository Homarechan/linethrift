...
class FetchMessageOperations_result implements TBase {
  ...
  public function get_success() : MessageOperations {
    return this.success;
  }

  public function set_success(success:MessageOperations) : MessageOperations {
  ...
  public function toString() : String {
    var ret : String = "FetchMessageOperations_result(";
    var first : Bool = true;
