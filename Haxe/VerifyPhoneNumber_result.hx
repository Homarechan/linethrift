...
class VerifyPhoneNumber_result implements TBase {
  ...
  public function get_success() : PhoneVerificationResult {
    return this.success;
  }

  public function set_success(success:PhoneVerificationResult) : PhoneVerificationResult {
  ...
  public function toString() : String {
    var ret : String = "VerifyPhoneNumber_result(";
    var first : Bool = true;
