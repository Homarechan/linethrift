...
class GetBuddyLocation_result implements TBase {
  ...
  public function get_success() : Geolocation {
    return this.success;
  }

  public function set_success(success:Geolocation) : Geolocation {
  ...
  public function toString() : String {
    var ret : String = "GetBuddyLocation_result(";
    var first : Bool = true;
