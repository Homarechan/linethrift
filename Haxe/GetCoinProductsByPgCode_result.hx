...
class GetCoinProductsByPgCode_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCoinProductsByPgCode_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list827 = iprot.readListBegin();
                this.success = new List< CoinProductItem>();
                for( _i828 in 0 ... _list827.size)
                {
                  var _elem829 : CoinProductItem;
                  _elem829 = new CoinProductItem();
                  _elem829.read(iprot);
                  this.success.add(_elem829);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetCoinProductsByPgCode_result(";
    var first : Bool = true;
