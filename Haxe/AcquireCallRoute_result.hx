...
class AcquireCallRoute_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("AcquireCallRoute_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list862 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i863 in 0 ... _list862.size)
                {
                  var _elem864 : String;
                  _elem864 = iprot.readString();
                  this.success.add(_elem864);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem865 in this.success)
          {
            oprot.writeString(elem865);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "AcquireCallRoute_result(";
    var first : Bool = true;
