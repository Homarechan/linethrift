        ...
        switch (field.id)
        {
          ...
          case REQUESTEDMEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list416 = iprot.readListBegin();
                this.requestedMemberMids = new List< String>();
                for( _i417 in 0 ... _list416.size)
                {
                  var _elem418 : String;
                  _elem418 = iprot.readString();
                  this.requestedMemberMids.add(_elem418);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.requestedMemberMids != null) {
        oprot.writeFieldBegin(REQUESTED_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem419 in this.requestedMemberMids)
          {
            oprot.writeString(elem419);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
