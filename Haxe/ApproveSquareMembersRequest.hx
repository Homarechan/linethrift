...
class ApproveSquareMembersRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ApproveSquareMembersRequest"); };
        ...
        switch (field.id)
        {
          ...
          case REQUESTEDMEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list312 = iprot.readListBegin();
                this.requestedMemberMids = new List< String>();
                for( _i313 in 0 ... _list312.size)
                {
                  var _elem314 : String;
                  _elem314 = iprot.readString();
                  this.requestedMemberMids.add(_elem314);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.requestedMemberMids != null) {
        oprot.writeFieldBegin(REQUESTED_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem315 in this.requestedMemberMids)
          {
            oprot.writeString(elem315);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "ApproveSquareMembersRequest(";
    var first : Bool = true;
