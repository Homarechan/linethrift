...
class RejectSquareMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("rejectSquareMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : RejectSquareMembersRequest;
  ...
  public function get_request() : RejectSquareMembersRequest {
    return this.request;
  }

  public function set_request(request:RejectSquareMembersRequest) : RejectSquareMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "rejectSquareMembers_args(";
    var first : Bool = true;
