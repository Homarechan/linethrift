...
class GetSquareFeatureSet_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareFeatureSet_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareFeatureSetRequest;
  ...
  public function get_request() : GetSquareFeatureSetRequest {
    return this.request;
  }

  public function set_request(request:GetSquareFeatureSetRequest) : GetSquareFeatureSetRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareFeatureSet_args(";
    var first : Bool = true;
