...
class GetRoomMemberMidsForAppPlatform_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetRoomMemberMidsForAppPlatform_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1479 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1480 in 0 ... _list1479.size)
                {
                  var _elem1481 : String;
                  _elem1481 = iprot.readString();
                  this.success.add(_elem1481);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1482 in this.success)
          {
            oprot.writeString(elem1482);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetRoomMemberMidsForAppPlatform_result(";
    var first : Bool = true;
