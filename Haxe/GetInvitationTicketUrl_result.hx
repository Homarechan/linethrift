...
class GetInvitationTicketUrl_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetInvitationTicketUrl_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetInvitationTicketUrlResponse;
  @:isVar
  ...
  public function get_success() : GetInvitationTicketUrlResponse {
    return this.success;
  }

  public function set_success(success:GetInvitationTicketUrlResponse) : GetInvitationTicketUrlResponse {
  ...
  public function toString() : String {
    var ret : String = "GetInvitationTicketUrl_result(";
    var first : Bool = true;
