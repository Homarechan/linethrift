...
class InviteToSquareChatResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("InviteToSquareChatResponse"); };
        ...
        switch (field.id)
        {
          case INVITEEMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list395 = iprot.readListBegin();
                this.inviteeMids = new List< String>();
                for( _i396 in 0 ... _list395.size)
                {
                  var _elem397 : String;
                  _elem397 = iprot.readString();
                  this.inviteeMids.add(_elem397);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.inviteeMids != null) {
        oprot.writeFieldBegin(INVITEE_MIDS_FIELD_DESC);
        {
          ...
          for( elem398 in this.inviteeMids)
          {
            oprot.writeString(elem398);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "InviteToSquareChatResponse(";
    var first : Bool = true;
