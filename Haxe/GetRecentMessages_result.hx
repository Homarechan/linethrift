...
class GetRecentMessages_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetRecentMessages_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1197 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1198 in 0 ... _list1197.size)
                {
                  var _elem1199 : Message;
                  _elem1199 = new Message();
                  _elem1199.read(iprot);
                  this.success.add(_elem1199);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1200 in this.success)
          {
            elem1200.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetRecentMessages_result(";
    var first : Bool = true;
