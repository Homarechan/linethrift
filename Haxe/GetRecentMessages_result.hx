        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1093 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1094 in 0 ... _list1093.size)
                {
                  var _elem1095 : Message;
                  _elem1095 = new Message();
                  _elem1095.read(iprot);
                  this.success.add(_elem1095);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1096 in this.success)
          {
            elem1096.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
