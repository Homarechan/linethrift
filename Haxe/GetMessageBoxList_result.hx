        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1169 = iprot.readListBegin();
                this.success = new List< TMessageBox>();
                for( _i1170 in 0 ... _list1169.size)
                {
                  var _elem1171 : TMessageBox;
                  _elem1171 = new TMessageBox();
                  _elem1171.read(iprot);
                  this.success.add(_elem1171);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1172 in this.success)
          {
            elem1172.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
