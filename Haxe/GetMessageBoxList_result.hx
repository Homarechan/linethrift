...
class GetMessageBoxList_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetMessageBoxList_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1065 = iprot.readListBegin();
                this.success = new List< TMessageBox>();
                for( _i1066 in 0 ... _list1065.size)
                {
                  var _elem1067 : TMessageBox;
                  _elem1067 = new TMessageBox();
                  _elem1067.read(iprot);
                  this.success.add(_elem1067);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1068 in this.success)
          {
            elem1068.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetMessageBoxList_result(";
    var first : Bool = true;
