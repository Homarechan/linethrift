        ...
        switch (field.id)
        {
          ...
          case CATEGORIES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list315 = iprot.readListBegin();
                this.categories = new List< ProductCategory>();
                for( _i316 in 0 ... _list315.size)
                {
                  var _elem317 : ProductCategory;
                  _elem317 = new ProductCategory();
                  _elem317.read(iprot);
                  this.categories.add(_elem317);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.categories != null) {
        oprot.writeFieldBegin(CATEGORIES_FIELD_DESC);
        {
          ...
          for( elem318 in this.categories)
          {
            elem318.write(oprot);
          }
          oprot.writeListEnd();
