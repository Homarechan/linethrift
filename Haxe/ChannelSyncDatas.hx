        ...
        switch (field.id)
        {
          case CHANNELINFOS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list189 = iprot.readListBegin();
                this.channelInfos = new List< ChannelInfo>();
                for( _i190 in 0 ... _list189.size)
                {
                  var _elem191 : ChannelInfo;
                  _elem191 = new ChannelInfo();
                  _elem191.read(iprot);
                  this.channelInfos.add(_elem191);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case CHANNELDOMAINS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list192 = iprot.readListBegin();
                this.channelDomains = new List< ChannelDomain>();
                for( _i193 in 0 ... _list192.size)
                {
                  var _elem194 : ChannelDomain;
                  _elem194 = new ChannelDomain();
                  _elem194.read(iprot);
                  this.channelDomains.add(_elem194);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.channelInfos != null) {
        oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for( elem195 in this.channelInfos)
          {
            elem195.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (this.channelDomains != null) {
        oprot.writeFieldBegin(CHANNEL_DOMAINS_FIELD_DESC);
        {
          ...
          for( elem196 in this.channelDomains)
          {
            elem196.write(oprot);
          }
          oprot.writeListEnd();
