...
class GetCompactContacts_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCompactContacts_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1335 = iprot.readListBegin();
                this.success = new List< CompactContact>();
                for( _i1336 in 0 ... _list1335.size)
                {
                  var _elem1337 : CompactContact;
                  _elem1337 = new CompactContact();
                  _elem1337.read(iprot);
                  this.success.add(_elem1337);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1338 in this.success)
          {
            elem1338.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetCompactContacts_result(";
    var first : Bool = true;
