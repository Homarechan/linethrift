        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1439 = iprot.readListBegin();
                this.success = new List< CompactContact>();
                for( _i1440 in 0 ... _list1439.size)
                {
                  var _elem1441 : CompactContact;
                  _elem1441 = new CompactContact();
                  _elem1441.read(iprot);
                  this.success.add(_elem1441);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1442 in this.success)
          {
            elem1442.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
