...
class GetSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareRequest;
  ...
  public function get_request() : GetSquareRequest {
    return this.request;
  }

  public function set_request(request:GetSquareRequest) : GetSquareRequest {
