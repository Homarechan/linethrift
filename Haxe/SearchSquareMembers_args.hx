...
class SearchSquareMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("searchSquareMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : SearchSquareMembersRequest;
  ...
  public function get_request() : SearchSquareMembersRequest {
    return this.request;
  }

  public function set_request(request:SearchSquareMembersRequest) : SearchSquareMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "searchSquareMembers_args(";
    var first : Bool = true;
