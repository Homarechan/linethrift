...
class UserAuthStatus implements TBase {
  ...
  static var ACCOUNT_MIGRATION_CHECK_TYPE_FIELD_DESC = { new TField("accountMigrationCheckType", TType.I32, 3); };
  ...
  inline static var ACCOUNTMIGRATIONCHECKTYPE_FIELD_ID : Int = 3;
        ...
        switch (field.id)
        {
          ...
          case REGISTEREDSNSIDTYPES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list699 = iprot.readListBegin();
                this.registeredSnsIdTypes = new List< Int>();
                for( _i700 in 0 ... _list699.size)
                {
                  var _elem701 : Int;
                  _elem701 = iprot.readI32();
                  this.registeredSnsIdTypes.add(_elem701);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.registeredSnsIdTypes != null) {
        oprot.writeFieldBegin(REGISTERED_SNS_ID_TYPES_FIELD_DESC);
        {
          ...
          for( elem702 in this.registeredSnsIdTypes)
          {
            oprot.writeI32(elem702);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
