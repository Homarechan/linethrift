...
class GetPaidCallHistory_result implements TBase {
  ...
  public function get_success() : PaidCallHistoryResult {
    return this.success;
  }

  public function set_success(success:PaidCallHistoryResult) : PaidCallHistoryResult {
  ...
  public function toString() : String {
    var ret : String = "GetPaidCallHistory_result(";
    var first : Bool = true;
