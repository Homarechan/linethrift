...
class GetCompactContactsModifiedSince_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCompactContactsModifiedSince_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< CompactContact>;
  @:isVar
  ...
  public function get_success() : List< CompactContact> {
    return this.success;
  }

  public function set_success(success:List< CompactContact>) : List< CompactContact> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1025 = iprot.readListBegin();
                this.success = new List< CompactContact>();
                for( _i1026 in 0 ... _list1025.size)
                {
                  var _elem1027 : CompactContact;
                  _elem1027 = new CompactContact();
                  _elem1027.read(iprot);
                  this.success.add(_elem1027);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1028 in this.success)
          {
            elem1028.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetCompactContactsModifiedSince_result(";
    var first : Bool = true;
