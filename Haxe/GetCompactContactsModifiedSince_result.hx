        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1129 = iprot.readListBegin();
                this.success = new List< CompactContact>();
                for( _i1130 in 0 ... _list1129.size)
                {
                  var _elem1131 : CompactContact;
                  _elem1131 = new CompactContact();
                  _elem1131.read(iprot);
                  this.success.add(_elem1131);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1132 in this.success)
          {
            elem1132.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
