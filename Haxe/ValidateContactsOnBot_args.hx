        ...
        switch (field.id)
        {
          case CONTACTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1387 = iprot.readListBegin();
                this.contacts = new List< String>();
                for( _i1388 in 0 ... _list1387.size)
                {
                  var _elem1389 : String;
                  _elem1389 = iprot.readString();
                  this.contacts.add(_elem1389);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contacts != null) {
        oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
        {
          ...
          for( elem1390 in this.contacts)
          {
            oprot.writeString(elem1390);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
