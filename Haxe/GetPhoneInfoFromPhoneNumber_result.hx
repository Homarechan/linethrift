...
class GetPhoneInfoFromPhoneNumber_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetPhoneInfoFromPhoneNumber_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : PhoneInfoForChannel;
  @:isVar
  ...
  public function get_success() : PhoneInfoForChannel {
    return this.success;
  }

  public function set_success(success:PhoneInfoForChannel) : PhoneInfoForChannel {
  ...
  public function toString() : String {
    var ret : String = "GetPhoneInfoFromPhoneNumber_result(";
    var first : Bool = true;
