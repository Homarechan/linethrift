...
class GetPrimaryClientForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetPrimaryClientForChannel_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SimpleChannelClient;
  @:isVar
  ...
  public function get_success() : SimpleChannelClient {
    return this.success;
  }

  public function set_success(success:SimpleChannelClient) : SimpleChannelClient {
  ...
  public function toString() : String {
    var ret : String = "GetPrimaryClientForChannel_result(";
    var first : Bool = true;
