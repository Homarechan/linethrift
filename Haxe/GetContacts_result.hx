        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1137 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i1138 in 0 ... _list1137.size)
                {
                  var _elem1139 : Contact;
                  _elem1139 = new Contact();
                  _elem1139.read(iprot);
                  this.success.add(_elem1139);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1140 in this.success)
          {
            elem1140.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
