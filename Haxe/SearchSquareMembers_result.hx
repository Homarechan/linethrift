...
class SearchSquareMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("SearchSquareMembers_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SearchSquareMembersResponse;
  @:isVar
  ...
  public function get_success() : SearchSquareMembersResponse {
    return this.success;
  }

  public function set_success(success:SearchSquareMembersResponse) : SearchSquareMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "SearchSquareMembers_result(";
    var first : Bool = true;
