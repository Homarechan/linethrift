        ...
        switch (field.id)
        {
          case REQUESTIDLIST_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list726 = iprot.readListBegin();
                this.requestIdList = new List< String>();
                for( _i727 in 0 ... _list726.size)
                {
                  var _elem728 : String;
                  _elem728 = iprot.readString();
                  this.requestIdList.add(_elem728);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list729 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i730 in 0 ... _list729.size)
                {
                  var _elem731 : String;
                  _elem731 = iprot.readString();
                  this.mids.add(_elem731);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.requestIdList != null) {
        oprot.writeFieldBegin(REQUEST_ID_LIST_FIELD_DESC);
        {
          ...
          for( elem732 in this.requestIdList)
          {
            oprot.writeString(elem732);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
