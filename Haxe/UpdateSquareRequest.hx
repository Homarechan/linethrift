...
class UpdateSquareRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareRequest"); };
  static var UPDATED_ATTRS_FIELD_DESC = { new TField("updatedAttrs", TType.SET, 2); };
  static var SQUARE_FIELD_DESC = { new TField("square", TType.STRUCT, 3); };
  ...
  inline static var SQUARE_FIELD_ID : Int = 3;
        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set522 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i523 in 0 ... _set522.size)
                {
                  var _elem524 : Int;
                  _elem524 = iprot.readI32();
                  this.updatedAttrs.add(_elem524);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem525 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem525);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareRequest(";
    var first : Bool = true;
