...
class RegisterWithSnsId_result implements TBase {
  ...
  public function get_success() : RegisterWithSnsIdResult {
    return this.success;
  }

  public function set_success(success:RegisterWithSnsIdResult) : RegisterWithSnsIdResult {
  ...
  public function toString() : String {
    var ret : String = "RegisterWithSnsId_result(";
    var first : Bool = true;
