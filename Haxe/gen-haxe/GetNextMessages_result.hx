...
class GetNextMessages_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetNextMessages_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1077 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1078 in 0 ... _list1077.size)
                {
                  var _elem1079 : Message;
                  _elem1079 = new Message();
                  _elem1079.read(iprot);
                  this.success.add(_elem1079);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1080 in this.success)
          {
            elem1080.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetNextMessages_result(";
    var first : Bool = true;
