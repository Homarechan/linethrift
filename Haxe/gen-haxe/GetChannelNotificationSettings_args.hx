...
class GetChannelNotificationSettings_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getChannelNotificationSettings_args"); };
  static var LOCALE_FIELD_DESC = { new TField("locale", TType.STRING, 1); };

  @:isVar
  public var locale(get,set) : String;

  inline static var LOCALE_FIELD_ID : Int = 1;
  ...
  public function toString() : String {
    var ret : String = "getChannelNotificationSettings_args(";
    var first : Bool = true;
