...
class LookupNearby_result implements TBase {
  ...
  public function get_success() : SpotNearbyResponse {
    return this.success;
  }

  public function set_success(success:SpotNearbyResponse) : SpotNearbyResponse {
  ...
  public function toString() : String {
    var ret : String = "LookupNearby_result(";
    var first : Bool = true;
