...
class UpdateSquareMember_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareMember_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareMemberRequest;
  ...
  public function get_request() : UpdateSquareMemberRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareMemberRequest) : UpdateSquareMemberRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareMember_args(";
    var first : Bool = true;
