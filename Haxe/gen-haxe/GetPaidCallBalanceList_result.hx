...
class GetPaidCallBalanceList_result implements TBase {
  ...
  public function get_success() : List< PaidCallBalance> {
    return this.success;
  }

  public function set_success(success:List< PaidCallBalance>) : List< PaidCallBalance> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1379 = iprot.readListBegin();
                this.success = new List< PaidCallBalance>();
                for( _i1380 in 0 ... _list1379.size)
                {
                  var _elem1381 : PaidCallBalance;
                  _elem1381 = new PaidCallBalance();
                  _elem1381.read(iprot);
                  this.success.add(_elem1381);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1382 in this.success)
          {
            elem1382.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetPaidCallBalanceList_result(";
    var first : Bool = true;
