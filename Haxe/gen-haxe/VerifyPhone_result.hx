...
class VerifyPhone_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("VerifyPhone_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.I32, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : Int;
  @:isVar
  ...
  private var __isset_success : Bool = false;
  ...
  public function set_success(success:Int) : Int {
  ...
  public function toString() : String {
    var ret : String = "VerifyPhone_result(";
    var first : Bool = true;

    ret += "success:";
    var success_name : String = .VerificationResult.VALUES_TO_NAMES[this.success];
  ...
  public function validate() : Void {
    ...
    if (isSetSuccess() && !.VerificationResult.VALID_VALUES.contains(success)){
      throw new TProtocolException(TProtocolException.UNKNOWN, "The field 'success' has been assigned the invalid value " + success);
    }
  }
