...
class SendMessageAwaitCommit_result implements TBase {
  ...
  public function get_success() : CommitMessageResult {
    return this.success;
  }

  public function set_success(success:CommitMessageResult) : CommitMessageResult {
  ...
  public function toString() : String {
    var ret : String = "SendMessageAwaitCommit_result(";
    var first : Bool = true;
