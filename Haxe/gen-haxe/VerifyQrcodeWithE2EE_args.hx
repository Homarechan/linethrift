...
class VerifyQrcodeWithE2EE_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("verifyQrcodeWithE2EE_args"); };
  ...
  static var ERROR_CODE_FIELD_DESC = { new TField("errorCode", TType.I32, 4); };
  static var PUBLIC_KEY_FIELD_DESC = { new TField("publicKey", TType.STRUCT, 5); };
  static var ENCRYPTED_KEY_CHAIN_FIELD_DESC = { new TField("encryptedKeyChain", TType.STRING, 6); };
  static var HASH_KEY_CHAIN_FIELD_DESC = { new TField("hashKeyChain", TType.STRING, 7); };
  ...
  inline static var ERRORCODE_FIELD_ID : Int = 4;
  inline static var PUBLICKEY_FIELD_ID : Int = 5;
  inline static var ENCRYPTEDKEYCHAIN_FIELD_ID : Int = 6;
  inline static var HASHKEYCHAIN_FIELD_ID : Int = 7;
  ...
  public function toString() : String {
    var ret : String = "verifyQrcodeWithE2EE_args(";
    var first : Bool = true;
