...
class UpdateSquareChatMember_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareChatMember_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UpdateSquareChatMemberResponse;
  @:isVar
  ...
  public function get_success() : UpdateSquareChatMemberResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareChatMemberResponse) : UpdateSquareChatMemberResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareChatMember_result(";
    var first : Bool = true;
