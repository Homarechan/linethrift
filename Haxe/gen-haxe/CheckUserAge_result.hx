...
class CheckUserAge_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("CheckUserAge_result"); };
  ...
  public function toString() : String {
    var ret : String = "CheckUserAge_result(";
    var first : Bool = true;

    ret += "success:";
    var success_name : String = .UserAgeType.VALUES_TO_NAMES[this.success];
