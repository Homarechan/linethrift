...
class GetMessageBoxListByStatus_result implements TBase {
  ...
  public function get_success() : List< TMessageBox> {
    return this.success;
  }

  public function set_success(success:List< TMessageBox>) : List< TMessageBox> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1069 = iprot.readListBegin();
                this.success = new List< TMessageBox>();
                for( _i1070 in 0 ... _list1069.size)
                {
                  var _elem1071 : TMessageBox;
                  _elem1071 = new TMessageBox();
                  _elem1071.read(iprot);
                  this.success.add(_elem1071);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1072 in this.success)
          {
            elem1072.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetMessageBoxListByStatus_result(";
    var first : Bool = true;
