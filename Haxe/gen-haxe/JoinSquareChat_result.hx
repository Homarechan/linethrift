...
class JoinSquareChat_result implements TBase {
  ...
  public function get_success() : JoinSquareChatResponse {
    return this.success;
  }

  public function set_success(success:JoinSquareChatResponse) : JoinSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "JoinSquareChat_result(";
    var first : Bool = true;
