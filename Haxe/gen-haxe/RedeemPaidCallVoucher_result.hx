...
class RedeemPaidCallVoucher_result implements TBase {
  ...
  public function get_success() : PaidCallRedeemResult {
    return this.success;
  }

  public function set_success(success:PaidCallRedeemResult) : PaidCallRedeemResult {
  ...
  public function toString() : String {
    var ret : String = "RedeemPaidCallVoucher_result(";
    var first : Bool = true;
