        ...
        switch (field.id)
        {
          case CHATIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1229 = iprot.readListBegin();
                this.chatIds = new List< String>();
                for( _i1230 in 0 ... _list1229.size)
                {
                  var _elem1231 : String;
                  _elem1231 = iprot.readString();
                  this.chatIds.add(_elem1231);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.chatIds != null) {
        oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
        {
          ...
          for( elem1232 in this.chatIds)
          {
            oprot.writeString(elem1232);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
