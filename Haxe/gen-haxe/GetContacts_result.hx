...
class GetContacts_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetContacts_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1033 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i1034 in 0 ... _list1033.size)
                {
                  var _elem1035 : Contact;
                  _elem1035 = new Contact();
                  _elem1035.read(iprot);
                  this.success.add(_elem1035);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1036 in this.success)
          {
            elem1036.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetContacts_result(";
    var first : Bool = true;
