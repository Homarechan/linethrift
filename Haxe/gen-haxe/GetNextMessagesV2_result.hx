...
class GetNextMessagesV2_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetNextMessagesV2_result"); };
            ...
            if (field.type == TType.LIST) {
              {
                ...
                {
                  var _elem1277 : Message;
                  _elem1277 = new Message();
                  _elem1277.read(iprot);
                  this.success.add(_elem1277);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetNextMessagesV2_result(";
    var first : Bool = true;
