...
class IssueTokenForAccountMigrationSettings_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("IssueTokenForAccountMigrationSettings_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SecurityCenterResult;
  @:isVar
  ...
  public function get_success() : SecurityCenterResult {
    return this.success;
  }

  public function set_success(success:SecurityCenterResult) : SecurityCenterResult {
  ...
  public function toString() : String {
    var ret : String = "IssueTokenForAccountMigrationSettings_result(";
    var first : Bool = true;
