...
class GetProductWithCarrier_result implements TBase {
  ...
  public function get_success() : Product {
    return this.success;
  }

  public function set_success(success:Product) : Product {
  ...
  public function toString() : String {
    var ret : String = "GetProductWithCarrier_result(";
    var first : Bool = true;
