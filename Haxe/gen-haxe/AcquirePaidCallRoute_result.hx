...
class AcquirePaidCallRoute_result implements TBase {
  ...
  public function get_success() : PaidCallResponse {
    return this.success;
  }

  public function set_success(success:PaidCallResponse) : PaidCallResponse {
  ...
  public function toString() : String {
    var ret : String = "AcquirePaidCallRoute_result(";
    var first : Bool = true;
