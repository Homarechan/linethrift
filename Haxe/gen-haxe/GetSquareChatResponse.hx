...
class GetSquareChatResponse implements TBase {
  
  static var STRUCT_DESC = { new TStruct("GetSquareChatResponse"); };
  static var SQUARE_CHAT_FIELD_DESC = { new TField("squareChat", TType.STRUCT, 1); };
  static var SQUARE_CHAT_MEMBER_FIELD_DESC = { new TField("squareChatMember", TType.STRUCT, 2); };
  static var SQUARE_CHAT_STATUS_FIELD_DESC = { new TField("squareChatStatus", TType.STRUCT, 3); };
  ...
  inline static var SQUARECHATMEMBER_FIELD_ID : Int = 2;
  inline static var SQUARECHATSTATUS_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "GetSquareChatResponse(";
    var first : Bool = true;
