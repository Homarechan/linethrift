...
class GetGroupIdsInvited_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroupIdsInvited_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1041 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1042 in 0 ... _list1041.size)
                {
                  var _elem1043 : String;
                  _elem1043 = iprot.readString();
                  this.success.add(_elem1043);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1044 in this.success)
          {
            oprot.writeString(elem1044);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupIdsInvited_result(";
    var first : Bool = true;
