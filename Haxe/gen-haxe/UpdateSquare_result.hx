...
class UpdateSquare_result implements TBase {
  ...
  public function get_success() : UpdateSquareResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareResponse) : UpdateSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquare_result(";
    var first : Bool = true;
