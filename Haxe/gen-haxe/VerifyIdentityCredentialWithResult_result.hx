...
class VerifyIdentityCredentialWithResult_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("VerifyIdentityCredentialWithResult_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UserAuthStatus;
  @:isVar
  ...
  public function get_success() : UserAuthStatus {
    return this.success;
  }

  public function set_success(success:UserAuthStatus) : UserAuthStatus {
  ...
  public function toString() : String {
    var ret : String = "VerifyIdentityCredentialWithResult_result(";
    var first : Bool = true;
