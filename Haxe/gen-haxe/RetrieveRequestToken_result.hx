...
class RetrieveRequestToken_result implements TBase {
  ...
  public function get_success() : AgeCheckRequestResult {
    return this.success;
  }

  public function set_success(success:AgeCheckRequestResult) : AgeCheckRequestResult {
  ...
  public function toString() : String {
    var ret : String = "RetrieveRequestToken_result(";
    var first : Bool = true;
