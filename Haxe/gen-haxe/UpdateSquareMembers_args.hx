...
class UpdateSquareMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareMembersRequest;
  ...
  public function get_request() : UpdateSquareMembersRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareMembersRequest) : UpdateSquareMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareMembers_args(";
    var first : Bool = true;
