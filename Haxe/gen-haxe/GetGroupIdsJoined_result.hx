...
class GetGroupIdsJoined_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroupIdsJoined_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1045 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1046 in 0 ... _list1045.size)
                {
                  var _elem1047 : String;
                  _elem1047 = iprot.readString();
                  this.success.add(_elem1047);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1048 in this.success)
          {
            oprot.writeString(elem1048);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupIdsJoined_result(";
    var first : Bool = true;
