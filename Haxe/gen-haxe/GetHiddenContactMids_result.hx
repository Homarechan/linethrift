...
class GetHiddenContactMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetHiddenContactMids_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1057 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1058 in 0 ... _list1057.size)
                {
                  var _elem1059 : String;
                  _elem1059 = iprot.readString();
                  this.success.add(_elem1059);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1060 in this.success)
          {
            oprot.writeString(elem1060);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetHiddenContactMids_result(";
    var first : Bool = true;
