...
class UpdateBuddyProfileImageAsync_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateBuddyProfileImageAsync_args"); };
  static var REQUEST_ID_FIELD_DESC = { new TField("requestId", TType.STRING, 1); };
  static var IMAGE_FIELD_DESC = { new TField("image", TType.STRING, 2); };

  @:isVar
  public var requestId(get,set) : String;
  @:isVar
  public var image(get,set) : haxe.io.Bytes;

  inline static var REQUESTID_FIELD_ID : Int = 1;
  inline static var IMAGE_FIELD_ID : Int = 2;
  ...
  public function get_image() : haxe.io.Bytes {
    return this.image;
  }

  public function set_image(image:haxe.io.Bytes) : haxe.io.Bytes {
    this.image = image;
    return this.image;
  }
  ...
  public function toString() : String {
    var ret : String = "updateBuddyProfileImageAsync_args(";
    var first : Bool = true;
