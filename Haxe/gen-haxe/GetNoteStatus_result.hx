...
class GetNoteStatus_result implements TBase {
  ...
  public function get_success() : GetNoteStatusResponse {
    return this.success;
  }

  public function set_success(success:GetNoteStatusResponse) : GetNoteStatusResponse {
  ...
  public function toString() : String {
    var ret : String = "GetNoteStatus_result(";
    var first : Bool = true;
