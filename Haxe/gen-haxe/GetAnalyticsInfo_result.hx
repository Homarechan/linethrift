...
class GetAnalyticsInfo_result implements TBase {
  ...
  public function get_success() : AnalyticsInfo {
    return this.success;
  }

  public function set_success(success:AnalyticsInfo) : AnalyticsInfo {
  ...
  public function toString() : String {
    var ret : String = "GetAnalyticsInfo_result(";
    var first : Bool = true;
