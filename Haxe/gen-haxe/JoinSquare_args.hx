...
class JoinSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("joinSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : JoinSquareRequest;
  ...
  public function get_request() : JoinSquareRequest {
    return this.request;
  }

  public function set_request(request:JoinSquareRequest) : JoinSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "joinSquare_args(";
    var first : Bool = true;
