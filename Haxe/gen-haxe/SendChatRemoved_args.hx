...
class SendChatRemoved_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("sendChatRemoved_args"); };
  static var SEQ_FIELD_DESC = { new TField("seq", TType.I32, 1); };
  static var CONSUMER_FIELD_DESC = { new TField("consumer", TType.STRING, 2); };
  static var LAST_MESSAGE_ID_FIELD_DESC = { new TField("lastMessageId", TType.STRING, 3); };
  ...
  inline static var LASTMESSAGEID_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "sendChatRemoved_args(";
    var first : Bool = true;
