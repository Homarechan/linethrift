...
class GetNextMessages_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getNextMessages_args"); };
  static var MESSAGE_BOX_ID_FIELD_DESC = { new TField("messageBoxId", TType.STRING, 2); };
  static var START_SEQ_FIELD_DESC = { new TField("startSeq", TType.I64, 3); };
  ...
  inline static var STARTSEQ_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "getNextMessages_args(";
    var first : Bool = true;
