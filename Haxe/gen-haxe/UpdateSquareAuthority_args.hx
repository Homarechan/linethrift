...
class UpdateSquareAuthority_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareAuthority_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareAuthorityRequest;
  ...
  public function get_request() : UpdateSquareAuthorityRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareAuthorityRequest) : UpdateSquareAuthorityRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareAuthority_args(";
    var first : Bool = true;
