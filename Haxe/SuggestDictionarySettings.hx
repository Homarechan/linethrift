        ...
        switch (field.id)
        {
          ...
          case DICTIONARIES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list251 = iprot.readListBegin();
                this.dictionaries = new List< SuggestDictionary>();
                for( _i252 in 0 ... _list251.size)
                {
                  var _elem253 : SuggestDictionary;
                  _elem253 = new SuggestDictionary();
                  _elem253.read(iprot);
                  this.dictionaries.add(_elem253);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case PRELOADEDDICTIONARIES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list254 = iprot.readListBegin();
                this.preloadedDictionaries = new List< String>();
                for( _i255 in 0 ... _list254.size)
                {
                  var _elem256 : String;
                  _elem256 = iprot.readString();
                  this.preloadedDictionaries.add(_elem256);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.dictionaries != null) {
        oprot.writeFieldBegin(DICTIONARIES_FIELD_DESC);
        {
          ...
          for( elem257 in this.dictionaries)
          {
            elem257.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (this.preloadedDictionaries != null) {
        oprot.writeFieldBegin(PRELOADED_DICTIONARIES_FIELD_DESC);
        {
          ...
          for( elem258 in this.preloadedDictionaries)
          {
