...
class AuthServiceProcessor implements TProcessor {
  ...
  public function new( iface : AuthService)
  {
    ...
    PROCESS_MAP.set("updatePassword", updatePassword());
    PROCESS_MAP.set("getAuthRSAKey", getAuthRSAKey());
    PROCESS_MAP.set("openAuthSession", openAuthSession());
  ...
  private function updatePassword() : Int->TProtocol->TProtocol->Void {
    return function( seqid : Int, iprot : TProtocol, oprot : TProtocol) : Void
    {
      var args : UpdatePassword_args = new UpdatePassword_args();
      args.read(iprot);
      iprot.readMessageEnd();
      var result : UpdatePassword_result = new UpdatePassword_result();
      try {
        result.success = AuthService_iface_.updatePassword(args.authSessionId, args.request);
      } catch (e:TalkException) {
        result.e = e;
      } catch (th : Dynamic) {
        trace("Internal error processing updatePassword", th);
        var x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing updatePassword");
  ...
  private function getAuthRSAKey() : Int->TProtocol->TProtocol->Void {
    return function( seqid : Int, iprot : TProtocol, oprot : TProtocol) : Void
    {
      var args : GetAuthRSAKey_args = new GetAuthRSAKey_args();
      args.read(iprot);
      iprot.readMessageEnd();
      var result : GetAuthRSAKey_result = new GetAuthRSAKey_result();
      try {
        result.success = AuthService_iface_.getAuthRSAKey(args.authSessionId, args.identityProvider);
      } catch (e:TalkException) {
        result.e = e;
      } catch (th : Dynamic) {
        trace("Internal error processing getAuthRSAKey", th);
        var x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing getAuthRSAKey");
  ...
  private function openAuthSession() : Int->TProtocol->TProtocol->Void {
    return function( seqid : Int, iprot : TProtocol, oprot : TProtocol) : Void
    {
      var args : OpenAuthSession_args = new OpenAuthSession_args();
      args.read(iprot);
      iprot.readMessageEnd();
      var result : OpenAuthSession_result = new OpenAuthSession_result();
      try {
        result.success = AuthService_iface_.openAuthSession(args.request);
      } catch (e:TalkException) {
        result.e = e;
      } catch (th : Dynamic) {
        trace("Internal error processing openAuthSession", th);
        var x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing openAuthSession");
