...
class GetSquareStatus_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareStatus_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareStatusRequest;
  ...
  public function get_request() : GetSquareStatusRequest {
    return this.request;
  }

  public function set_request(request:GetSquareStatusRequest) : GetSquareStatusRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareStatus_args(";
    var first : Bool = true;
