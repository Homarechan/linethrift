...
class GetSquareChatMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareChatMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareChatMembersRequest;
  ...
  public function get_request() : GetSquareChatMembersRequest {
    return this.request;
  }

  public function set_request(request:GetSquareChatMembersRequest) : GetSquareChatMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareChatMembers_args(";
    var first : Bool = true;
