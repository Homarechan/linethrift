        ...
        switch (field.id)
        {
          case SETTINGS_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map802 = iprot.readMapBegin();
                this.settings = new StringMap< String>();
                for( _i803 in 0 ... _map802.size)
                {
                  var _key804 : String;
                  var _val805 : String;
                  _key804 = iprot.readString();
                  _val805 = iprot.readString();
                  this.settings.set( _key804, _val805);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.settings != null) {
        ...
        {
          var _sizeCounter807 : Int = 0;
          for( _key806 in this.settings) {
            _sizeCounter807++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter807));
          for( elem808 in this.settings.keys())
          {
            oprot.writeString(elem808);
            oprot.writeString(this.settings.get(elem808));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
