...
class GetReadMessageOpsInBulk_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getReadMessageOpsInBulk_args"); };
        ...
        switch (field.id)
        {
          case CHATIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1333 = iprot.readListBegin();
                this.chatIds = new List< String>();
                for( _i1334 in 0 ... _list1333.size)
                {
                  var _elem1335 : String;
                  _elem1335 = iprot.readString();
                  this.chatIds.add(_elem1335);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.chatIds != null) {
        oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
        {
          ...
          for( elem1336 in this.chatIds)
          {
            oprot.writeString(elem1336);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "getReadMessageOpsInBulk_args(";
    var first : Bool = true;
