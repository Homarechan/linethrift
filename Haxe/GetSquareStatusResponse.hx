...
class GetSquareStatusResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareStatusResponse"); };
  static var SQUARE_STATUS_FIELD_DESC = { new TField("squareStatus", TType.STRUCT, 1); };

  @:isVar
  public var squareStatus(get,set) : SquareStatus;

  inline static var SQUARESTATUS_FIELD_ID : Int = 1;
  ...
  public function toString() : String {
    var ret : String = "GetSquareStatusResponse(";
    var first : Bool = true;
