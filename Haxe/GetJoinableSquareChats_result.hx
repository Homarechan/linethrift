...
class GetJoinableSquareChats_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetJoinableSquareChats_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetJoinableSquareChatsResponse;
  @:isVar
  ...
  public function get_success() : GetJoinableSquareChatsResponse {
    return this.success;
  }

  public function set_success(success:GetJoinableSquareChatsResponse) : GetJoinableSquareChatsResponse {
  ...
  public function toString() : String {
    var ret : String = "GetJoinableSquareChats_result(";
    var first : Bool = true;
