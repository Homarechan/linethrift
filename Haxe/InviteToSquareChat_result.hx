...
class InviteToSquareChat_result implements TBase {
  ...
  public function get_success() : InviteToSquareChatResponse {
    return this.success;
  }

  public function set_success(success:InviteToSquareChatResponse) : InviteToSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "InviteToSquareChat_result(";
    var first : Bool = true;
