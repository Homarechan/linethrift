...
class FetchMyEvents_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("fetchMyEvents_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : FetchMyEventsRequest;
  ...
  public function get_request() : FetchMyEventsRequest {
    return this.request;
  }

  public function set_request(request:FetchMyEventsRequest) : FetchMyEventsRequest {
  ...
  public function toString() : String {
    var ret : String = "fetchMyEvents_args(";
    var first : Bool = true;
