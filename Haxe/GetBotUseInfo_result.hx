...
class GetBotUseInfo_result implements TBase {
  ...
  public function get_success() : BotUseInfo {
    return this.success;
  }

  public function set_success(success:BotUseInfo) : BotUseInfo {
  ...
  public function toString() : String {
    var ret : String = "GetBotUseInfo_result(";
    var first : Bool = true;
