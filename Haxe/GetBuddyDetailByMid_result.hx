...
class GetBuddyDetailByMid_result implements TBase {
  ...
  public function get_success() : BuddyDetail {
    return this.success;
  }

  public function set_success(success:BuddyDetail) : BuddyDetail {
  ...
  public function toString() : String {
    var ret : String = "GetBuddyDetailByMid_result(";
    var first : Bool = true;
