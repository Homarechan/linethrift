        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1161 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1162 in 0 ... _list1161.size)
                {
                  var _elem1163 : String;
                  _elem1163 = iprot.readString();
                  this.success.add(_elem1163);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1164 in this.success)
          {
            oprot.writeString(elem1164);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
