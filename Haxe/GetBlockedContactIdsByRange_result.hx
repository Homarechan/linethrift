...
class GetBlockedContactIdsByRange_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBlockedContactIdsByRange_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1013 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1014 in 0 ... _list1013.size)
                {
                  var _elem1015 : String;
                  _elem1015 = iprot.readString();
                  this.success.add(_elem1015);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1016 in this.success)
          {
            oprot.writeString(elem1016);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetBlockedContactIdsByRange_result(";
    var first : Bool = true;
