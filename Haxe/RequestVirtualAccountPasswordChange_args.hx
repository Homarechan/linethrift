...
class RequestVirtualAccountPasswordChange_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("requestVirtualAccountPasswordChange_args"); };
  ...
  static var ENCRYPTED_OLD_PASSWORD_FIELD_DESC = { new TField("encryptedOldPassword", TType.STRING, 4); };
  static var ENCRYPTED_NEW_PASSWORD_FIELD_DESC = { new TField("encryptedNewPassword", TType.STRING, 5); };
  ...
  @:isVar
  public var encryptedOldPassword(get,set) : String;
  @:isVar
  ...
  inline static var ENCRYPTEDOLDPASSWORD_FIELD_ID : Int = 4;
  inline static var ENCRYPTEDNEWPASSWORD_FIELD_ID : Int = 5;
  ...
  public function get_encryptedOldPassword() : String {
    return this.encryptedOldPassword;
  }

  public function set_encryptedOldPassword(encryptedOldPassword:String) : String {
    this.encryptedOldPassword = encryptedOldPassword;
    return this.encryptedOldPassword;
  }

  public function unsetEncryptedOldPassword() : Void {
  ...
  public function isSetEncryptedOldPassword() : Bool {
  ...
  public function setFieldValue(fieldID : Int, value : Dynamic) : Void {
    ...
    case ENCRYPTEDOLDPASSWORD_FIELD_ID:
      if (value == null) {
  ...
  public function toString() : String {
    var ret : String = "requestVirtualAccountPasswordChange_args(";
    var first : Bool = true;
    ...
    first = false;
    if (!first) ret +=  ", ";
    ret += "encryptedOldPassword:";
    if (this.encryptedOldPassword == null) {
      ret += "null";
    } else {
      ret += this.encryptedOldPassword;
    }
    first = false;
    if (!first) ret +=  ", ";
