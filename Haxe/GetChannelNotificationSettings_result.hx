        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list791 = iprot.readListBegin();
                this.success = new List< ChannelNotificationSetting>();
                for( _i792 in 0 ... _list791.size)
                {
                  var _elem793 : ChannelNotificationSetting;
                  _elem793 = new ChannelNotificationSetting();
                  _elem793.read(iprot);
