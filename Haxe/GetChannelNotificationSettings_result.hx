...
class GetChannelNotificationSettings_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetChannelNotificationSettings_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< ChannelNotificationSetting>;
  @:isVar
  ...
  public function get_success() : List< ChannelNotificationSetting> {
    return this.success;
  }

  public function set_success(success:List< ChannelNotificationSetting>) : List< ChannelNotificationSetting> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list895 = iprot.readListBegin();
                this.success = new List< ChannelNotificationSetting>();
                for( _i896 in 0 ... _list895.size)
                {
                  var _elem897 : ChannelNotificationSetting;
                  _elem897 = new ChannelNotificationSetting();
                  _elem897.read(iprot);
                  this.success.add(_elem897);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetChannelNotificationSettings_result(";
    var first : Bool = true;
