...
class UpdateBuddyProfileResult implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateBuddyProfileResult"); };
  ...
  static var EVENT_NO_FIELD_DESC = { new TField("eventNo", TType.I32, 3); };
  ...
  static var UNREGISTER_COUNT_FIELD_DESC = { new TField("unregisterCount", TType.I64, 15); };
  ...
  inline static var EVENTNO_FIELD_ID : Int = 3;
  ...
  inline static var UNREGISTERCOUNT_FIELD_ID : Int = 15;
  ...
  public function toString() : String {
    var ret : String = "UpdateBuddyProfileResult(";
    var first : Bool = true;
