...
class LeaveSquareChat_result implements TBase {
  ...
  public function get_success() : LeaveSquareChatResponse {
    return this.success;
  }

  public function set_success(success:LeaveSquareChatResponse) : LeaveSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "LeaveSquareChat_result(";
    var first : Bool = true;
