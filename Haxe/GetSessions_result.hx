        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1205 = iprot.readListBegin();
                this.success = new List< LoginSession>();
                for( _i1206 in 0 ... _list1205.size)
                {
                  var _elem1207 : LoginSession;
                  _elem1207 = new LoginSession();
                  _elem1207.read(iprot);
                  this.success.add(_elem1207);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1208 in this.success)
          {
            elem1208.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
