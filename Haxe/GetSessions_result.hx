...
class GetSessions_result implements TBase {
  ...
  public function get_success() : List< LoginSession> {
    return this.success;
  }

  public function set_success(success:List< LoginSession>) : List< LoginSession> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1101 = iprot.readListBegin();
                this.success = new List< LoginSession>();
                for( _i1102 in 0 ... _list1101.size)
                {
                  var _elem1103 : LoginSession;
                  _elem1103 = new LoginSession();
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1104 in this.success)
          {
            elem1104.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetSessions_result(";
    var first : Bool = true;
