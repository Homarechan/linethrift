...
class GetGroups_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroups_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1053 = iprot.readListBegin();
                this.success = new List< Group>();
                for( _i1054 in 0 ... _list1053.size)
                {
                  var _elem1055 : Group;
                  _elem1055 = new Group();
                  _elem1055.read(iprot);
                  this.success.add(_elem1055);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1056 in this.success)
          {
            elem1056.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroups_result(";
    var first : Bool = true;
