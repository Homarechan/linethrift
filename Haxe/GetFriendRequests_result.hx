...
class GetFriendRequests_result implements TBase {
  ...
  public function get_success() : List< FriendRequest> {
    return this.success;
  }

  public function set_success(success:List< FriendRequest>) : List< FriendRequest> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1068 = iprot.readListBegin();
                this.success = new List< FriendRequest>();
                for( _i1069 in 0 ... _list1068.size)
                {
                  var _elem1070 : FriendRequest;
                  _elem1070 = new FriendRequest();
                  _elem1070.read(iprot);
                  this.success.add(_elem1070);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1071 in this.success)
          {
            elem1071.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetFriendRequests_result(";
    var first : Bool = true;
