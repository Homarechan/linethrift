        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list964 = iprot.readListBegin();
                this.success = new List< FriendRequest>();
                for( _i965 in 0 ... _list964.size)
                {
                  var _elem966 : FriendRequest;
                  _elem966 = new FriendRequest();
                  _elem966.read(iprot);
                  this.success.add(_elem966);
                }
                iprot.readListEnd();
              }
            } else { 
