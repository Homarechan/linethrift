...
class CreateSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("createSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : CreateSquareRequest;
  ...
  public function get_request() : CreateSquareRequest {
    return this.request;
  }

  public function set_request(request:CreateSquareRequest) : CreateSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "createSquare_args(";
    var first : Bool = true;
