...
class GetNoteStatusResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetNoteStatusResponse"); };
  ...
  @:isVar
  public var status(get,set) : NoteStatus;
  ...
  public function get_status() : NoteStatus {
    return this.status;
  }

  public function set_status(status:NoteStatus) : NoteStatus {
    this.status = status;
    return this.status;
  }
  ...
  public function toString() : String {
    var ret : String = "GetNoteStatusResponse(";
    var first : Bool = true;
