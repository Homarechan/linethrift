...
class UpdateBuddyProfileAttributes_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateBuddyProfileAttributes_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UpdateBuddyProfileResult;
  @:isVar
  ...
  public function get_success() : UpdateBuddyProfileResult {
    return this.success;
  }

  public function set_success(success:UpdateBuddyProfileResult) : UpdateBuddyProfileResult {
  ...
  public function toString() : String {
    var ret : String = "UpdateBuddyProfileAttributes_result(";
    var first : Bool = true;
