...
class GetProductListWithCarrier_result implements TBase {
  ...
  public function get_success() : ProductList {
    return this.success;
  }

  public function set_success(success:ProductList) : ProductList {
  ...
  public function toString() : String {
    var ret : String = "GetProductListWithCarrier_result(";
    var first : Bool = true;
