...
class GetAcceptedProximityMatches_result implements TBase {
  ...
  public function get_success() : StringSet {
    return this.success;
  }

  public function set_success(success:StringSet) : StringSet {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set1101 = iprot.readSetBegin();
                this.success = new StringSet();
                for( _i1102 in 0 ... _set1101.size)
                {
                  var _elem1103 : String;
                  _elem1103 = iprot.readString();
                  this.success.add(_elem1103);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1104 in this.success.toArray())
          {
            oprot.writeString(elem1104);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetAcceptedProximityMatches_result(";
    var first : Bool = true;
