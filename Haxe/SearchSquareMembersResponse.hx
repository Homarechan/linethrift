        ...
        switch (field.id)
        {
          case MEMBERS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list471 = iprot.readListBegin();
                this.members = new List< SquareMember>();
                for( _i472 in 0 ... _list471.size)
                {
                  var _elem473 : SquareMember;
                  _elem473 = new SquareMember();
                  _elem473.read(iprot);
                  this.members.add(_elem473);
                }
                iprot.readListEnd();
              }
            } else { 
