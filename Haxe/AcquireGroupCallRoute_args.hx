...
class AcquireGroupCallRoute_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("acquireGroupCallRoute_args"); };
  static var CHAT_MID_FIELD_DESC = { new TField("chatMid", TType.STRING, 2); };
  static var MEDIA_TYPE_FIELD_DESC = { new TField("mediaType", TType.I32, 3); };
  ...
  inline static var MEDIATYPE_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "acquireGroupCallRoute_args(";
    var first : Bool = true;
