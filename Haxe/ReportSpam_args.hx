        ...
        switch (field.id)
        {
          ...
          case MEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1279 = iprot.readListBegin();
                this.memberMids = new List< String>();
                for( _i1280 in 0 ... _list1279.size)
                {
                  var _elem1281 : String;
                  _elem1281 = iprot.readString();
                  this.memberMids.add(_elem1281);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SPAMMERREASONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1282 = iprot.readListBegin();
                this.spammerReasons = new List< Int>();
                for( _i1283 in 0 ... _list1282.size)
                {
                  var _elem1284 : Int;
                  _elem1284 = iprot.readI32();
                  this.spammerReasons.add(_elem1284);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SENDERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1285 = iprot.readListBegin();
                this.senderMids = new List< String>();
                for( _i1286 in 0 ... _list1285.size)
                {
                  var _elem1287 : String;
                  _elem1287 = iprot.readString();
                  this.senderMids.add(_elem1287);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SPAMMESSAGEIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1288 = iprot.readListBegin();
                this.spamMessageIds = new List< String>();
                for( _i1289 in 0 ... _list1288.size)
                {
                  var _elem1290 : String;
                  _elem1290 = iprot.readString();
                  this.spamMessageIds.add(_elem1290);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SPAMMESSAGES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1291 = iprot.readListBegin();
                this.spamMessages = new List< String>();
                for( _i1292 in 0 ... _list1291.size)
                {
                  var _elem1293 : String;
                  _elem1293 = iprot.readString();
                  this.spamMessages.add(_elem1293);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.memberMids != null) {
        oprot.writeFieldBegin(MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1294 in this.memberMids)
          {
            oprot.writeString(elem1294);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.spammerReasons != null) {
        oprot.writeFieldBegin(SPAMMER_REASONS_FIELD_DESC);
        {
          ...
          for( elem1295 in this.spammerReasons)
          {
            oprot.writeI32(elem1295);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.senderMids != null) {
        oprot.writeFieldBegin(SENDER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1296 in this.senderMids)
          {
            oprot.writeString(elem1296);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.spamMessageIds != null) {
        oprot.writeFieldBegin(SPAM_MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for( elem1297 in this.spamMessageIds)
          {
      ...
      if (this.spamMessages != null) {
        oprot.writeFieldBegin(SPAM_MESSAGES_FIELD_DESC);
        {
          ...
          for( elem1298 in this.spamMessages)
          {
            oprot.writeString(elem1298);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
