...
class JoinSquare_result implements TBase {
  ...
  public function get_success() : JoinSquareResponse {
    return this.success;
  }

  public function set_success(success:JoinSquareResponse) : JoinSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "JoinSquare_result(";
    var first : Bool = true;
