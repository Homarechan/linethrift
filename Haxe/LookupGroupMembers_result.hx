        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1447 = iprot.readListBegin();
                this.success = new List< SimpleChannelContact>();
                for( _i1448 in 0 ... _list1447.size)
                {
                  var _elem1449 : SimpleChannelContact;
                  _elem1449 = new SimpleChannelContact();
                  _elem1449.read(iprot);
                  this.success.add(_elem1449);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1450 in this.success)
          {
            elem1450.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
