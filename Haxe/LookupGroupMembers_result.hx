...
class LookupGroupMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("LookupGroupMembers_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1343 = iprot.readListBegin();
                this.success = new List< SimpleChannelContact>();
                for( _i1344 in 0 ... _list1343.size)
                {
                  var _elem1345 : SimpleChannelContact;
                  _elem1345 = new SimpleChannelContact();
                  _elem1345.read(iprot);
                  this.success.add(_elem1345);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1346 in this.success)
          {
            elem1346.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "LookupGroupMembers_result(";
    var first : Bool = true;
