...
class GetWapInvitation_result implements TBase {
  ...
  public function get_success() : WapInvitation {
    return this.success;
  }

  public function set_success(success:WapInvitation) : WapInvitation {
  ...
  public function toString() : String {
    var ret : String = "GetWapInvitation_result(";
    var first : Bool = true;
