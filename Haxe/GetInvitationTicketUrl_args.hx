...
class GetInvitationTicketUrl_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getInvitationTicketUrl_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetInvitationTicketUrlRequest;
  ...
  public function get_request() : GetInvitationTicketUrlRequest {
    return this.request;
  }

  public function set_request(request:GetInvitationTicketUrlRequest) : GetInvitationTicketUrlRequest {
  ...
  public function toString() : String {
    var ret : String = "getInvitationTicketUrl_args(";
    var first : Bool = true;
