...
class UpdateSquareFeatureSet_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareFeatureSet_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareFeatureSetRequest;
  ...
  public function get_request() : UpdateSquareFeatureSetRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareFeatureSetRequest) : UpdateSquareFeatureSetRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareFeatureSet_args(";
    var first : Bool = true;
