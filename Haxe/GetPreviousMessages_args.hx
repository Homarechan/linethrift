...
class GetPreviousMessages_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getPreviousMessages_args"); };
  static var MESSAGE_BOX_ID_FIELD_DESC = { new TField("messageBoxId", TType.STRING, 2); };
  static var END_SEQ_FIELD_DESC = { new TField("endSeq", TType.I64, 3); };
  ...
  inline static var ENDSEQ_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "getPreviousMessages_args(";
    var first : Bool = true;
