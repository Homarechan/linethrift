...
class FetchSquareChatEvents_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FetchSquareChatEvents_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : FetchSquareChatEventsResponse;
  @:isVar
  ...
  public function get_success() : FetchSquareChatEventsResponse {
    return this.success;
  }

  public function set_success(success:FetchSquareChatEventsResponse) : FetchSquareChatEventsResponse {
  ...
  public function toString() : String {
    var ret : String = "FetchSquareChatEvents_result(";
    var first : Bool = true;
