...
class DeleteSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("deleteSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : DeleteSquareRequest;
  ...
  public function get_request() : DeleteSquareRequest {
    return this.request;
  }

  public function set_request(request:DeleteSquareRequest) : DeleteSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "deleteSquare_args(";
    var first : Bool = true;
