        ...
        switch (field.id)
        {
          ...
          case CONTACTIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1451 = iprot.readListBegin();
                this.contactIds = new List< String>();
                for( _i1452 in 0 ... _list1451.size)
                {
                  var _elem1453 : String;
                  _elem1453 = iprot.readString();
                  this.contactIds.add(_elem1453);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem1454 in this.contactIds)
          {
            oprot.writeString(elem1454);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
