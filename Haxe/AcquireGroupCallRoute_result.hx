...
class AcquireGroupCallRoute_result implements TBase {
  ...
  public function get_success() : GroupCallRoute {
    return this.success;
  }

  public function set_success(success:GroupCallRoute) : GroupCallRoute {
  ...
  public function toString() : String {
    var ret : String = "AcquireGroupCallRoute_result(";
    var first : Bool = true;
