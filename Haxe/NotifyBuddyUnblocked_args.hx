...
class NotifyBuddyUnblocked_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("notifyBuddyUnblocked_args"); };
  static var BUDDY_MID_FIELD_DESC = { new TField("buddyMid", TType.STRING, 1); };
  static var BLOCKER_MID_FIELD_DESC = { new TField("blockerMid", TType.STRING, 2); };

  @:isVar
  public var buddyMid(get,set) : String;
  @:isVar
  public var blockerMid(get,set) : String;

  inline static var BUDDYMID_FIELD_ID : Int = 1;
  inline static var BLOCKERMID_FIELD_ID : Int = 2;
  ...
  public function get_blockerMid() : String {
    return this.blockerMid;
  }

  public function set_blockerMid(blockerMid:String) : String {
    this.blockerMid = blockerMid;
    return this.blockerMid;
  }

  public function unsetBlockerMid() : Void {
    this.blockerMid = null;
  }

  // Returns true if field blockerMid is set (has been assigned a value) and false otherwise
  public function isSetBlockerMid() : Bool {
  ...
  public function toString() : String {
    var ret : String = "notifyBuddyUnblocked_args(";
    var first : Bool = true;
