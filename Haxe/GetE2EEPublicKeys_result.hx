...
class GetE2EEPublicKeys_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetE2EEPublicKeys_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1221 = iprot.readListBegin();
                this.success = new List< E2EEPublicKey>();
                for( _i1222 in 0 ... _list1221.size)
                {
                  var _elem1223 : E2EEPublicKey;
                  _elem1223 = new E2EEPublicKey();
                  _elem1223.read(iprot);
                  this.success.add(_elem1223);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1224 in this.success)
          {
            elem1224.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetE2EEPublicKeys_result(";
    var first : Bool = true;
