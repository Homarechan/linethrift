        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1325 = iprot.readListBegin();
                this.success = new List< E2EEPublicKey>();
                for( _i1326 in 0 ... _list1325.size)
                {
                  var _elem1327 : E2EEPublicKey;
                  _elem1327 = new E2EEPublicKey();
                  _elem1327.read(iprot);
                  this.success.add(_elem1327);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1328 in this.success)
          {
            elem1328.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
