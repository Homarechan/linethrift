...
class CheckUserAgeWithDocomo_result implements TBase {
  ...
  public function get_success() : AgeCheckDocomoResult {
    return this.success;
  }

  public function set_success(success:AgeCheckDocomoResult) : AgeCheckDocomoResult {
  ...
  public function toString() : String {
    var ret : String = "CheckUserAgeWithDocomo_result(";
    var first : Bool = true;
