...
class GetNotificationBadgeCount_result implements TBase {
  ...
  public function get_success() : haxe.Int32 {
    return this.success;
  }

  public function set_success(success:haxe.Int32) : haxe.Int32 {
  ...
  public function toString() : String {
    var ret : String = "GetNotificationBadgeCount_result(";
    var first : Bool = true;
