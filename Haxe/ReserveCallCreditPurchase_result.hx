...
class ReserveCallCreditPurchase_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ReserveCallCreditPurchase_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : PaymentReservationResult;
  @:isVar
  ...
  public function get_success() : PaymentReservationResult {
    return this.success;
  }

  public function set_success(success:PaymentReservationResult) : PaymentReservationResult {
  ...
  public function toString() : String {
    var ret : String = "ReserveCallCreditPurchase_result(";
    var first : Bool = true;
