...
class GetGroupCall_result implements TBase {
  ...
  public function get_success() : GroupCall {
    return this.success;
  }

  public function set_success(success:GroupCall) : GroupCall {
  ...
  public function toString() : String {
    var ret : String = "GetGroupCall_result(";
    var first : Bool = true;
