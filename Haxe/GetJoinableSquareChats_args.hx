...
class GetJoinableSquareChats_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getJoinableSquareChats_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetJoinableSquareChatsRequest;
  ...
  public function get_request() : GetJoinableSquareChatsRequest {
    return this.request;
  }

  public function set_request(request:GetJoinableSquareChatsRequest) : GetJoinableSquareChatsRequest {
  ...
  public function toString() : String {
    var ret : String = "getJoinableSquareChats_args(";
    var first : Bool = true;
