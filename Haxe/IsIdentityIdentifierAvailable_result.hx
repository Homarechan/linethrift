...
class IsIdentityIdentifierAvailable_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("IsIdentityIdentifierAvailable_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.BOOL, 0); };
  ...
  public function set_success(success:Bool) : Bool {
  ...
  public function toString() : String {
    var ret : String = "IsIdentityIdentifierAvailable_result(";
    var first : Bool = true;
