        ...
        switch (field.id)
        {
          ...
          case SETTINGS_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map754 = iprot.readMapBegin();
                this.settings = new StringMap< String>();
                for( _i755 in 0 ... _map754.size)
                {
                  var _key756 : String;
                  var _val757 : String;
                  _key756 = iprot.readString();
                  _val757 = iprot.readString();
                  this.settings.set( _key756, _val757);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.settings != null) {
        ...
        {
          var _sizeCounter759 : Int = 0;
          for( _key758 in this.settings) {
            _sizeCounter759++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter759));
          for( elem760 in this.settings.keys())
          {
            oprot.writeString(elem760);
            oprot.writeString(this.settings.get(elem760));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
