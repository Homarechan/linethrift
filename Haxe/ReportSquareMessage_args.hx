...
class ReportSquareMessage_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("reportSquareMessage_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : ReportSquareMessageRequest;
  ...
  public function get_request() : ReportSquareMessageRequest {
    return this.request;
  }

  public function set_request(request:ReportSquareMessageRequest) : ReportSquareMessageRequest {
  ...
  public function toString() : String {
    var ret : String = "reportSquareMessage_args(";
    var first : Bool = true;
