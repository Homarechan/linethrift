...
class AuthServiceImpl implements AuthService {
  ...
  public function updatePassword(authSessionId : String, request : IdentityCredentialRequest) : IdentityCredentialResponse {
    ...
    oprot_.getTransport().flush(function(error:Dynamic) : Void {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
                                  "updatePassword failed: unknown result");
    });
    return retval;
  }

  public function getAuthRSAKey(authSessionId : String, identityProvider : Int) : RSAKey {
    ...
    oprot_.getTransport().flush(function(error:Dynamic) : Void {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
                                  "getAuthRSAKey failed: unknown result");
    });
    return retval;
  }

  public function openAuthSession(request : AuthSessionRequest) : String {
    ...
    oprot_.getTransport().flush(function(error:Dynamic) : Void {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
                                  "openAuthSession failed: unknown result");
    });
    return retval;
  }
