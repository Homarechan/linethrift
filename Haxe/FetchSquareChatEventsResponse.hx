...
class FetchSquareChatEventsResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FetchSquareChatEventsResponse"); };
        ...
        switch (field.id)
        {
          ...
          case EVENTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list383 = iprot.readListBegin();
                this.events = new List< SquareEvent>();
                for( _i384 in 0 ... _list383.size)
                {
                  var _elem385 : SquareEvent;
                  _elem385 = new SquareEvent();
                  _elem385.read(iprot);
                  this.events.add(_elem385);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "FetchSquareChatEventsResponse(";
    var first : Bool = true;
