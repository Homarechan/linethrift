        ...
        switch (field.id)
        {
          ...
          case EVENTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list487 = iprot.readListBegin();
                this.events = new List< SquareEvent>();
                for( _i488 in 0 ... _list487.size)
                {
                  var _elem489 : SquareEvent;
                  _elem489 = new SquareEvent();
                  _elem489.read(iprot);
                  this.events.add(_elem489);
                }
                iprot.readListEnd();
              }
            } else { 
