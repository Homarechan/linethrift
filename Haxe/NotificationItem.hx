        ...
        switch (field.id)
        {
          ...
          case CONTENT_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map297 = iprot.readMapBegin();
                this.content = new StringMap< String>();
                for( _i298 in 0 ... _map297.size)
                {
                  var _key299 : String;
                  var _val300 : String;
                  _key299 = iprot.readString();
                  _val300 = iprot.readString();
                  this.content.set( _key299, _val300);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.content != null) {
        ...
        {
          var _sizeCounter302 : Int = 0;
          for( _key301 in this.content) {
            _sizeCounter302++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter302));
          for( elem303 in this.content.keys())
          {
            oprot.writeString(elem303);
            oprot.writeString(this.content.get(elem303));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
