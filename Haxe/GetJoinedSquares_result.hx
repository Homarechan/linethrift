...
class GetJoinedSquares_result implements TBase {
  ...
  public function get_success() : GetJoinedSquaresResponse {
    return this.success;
  }

  public function set_success(success:GetJoinedSquaresResponse) : GetJoinedSquaresResponse {
  ...
  public function toString() : String {
    var ret : String = "GetJoinedSquares_result(";
    var first : Bool = true;
