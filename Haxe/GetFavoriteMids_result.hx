...
class GetFavoriteMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetFavoriteMids_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1037 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1038 in 0 ... _list1037.size)
                {
                  var _elem1039 : String;
                  _elem1039 = iprot.readString();
                  this.success.add(_elem1039);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1040 in this.success)
          {
            oprot.writeString(elem1040);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetFavoriteMids_result(";
    var first : Bool = true;
