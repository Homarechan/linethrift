...
class SendBuddyContentMessageToMids_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("sendBuddyContentMessageToMids_args"); };
        ...
        switch (field.id)
        {
          ...
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list765 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i766 in 0 ... _list765.size)
                {
                  var _elem767 : String;
                  _elem767 = iprot.readString();
                  this.mids.add(_elem767);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem768 in this.mids)
          {
            oprot.writeString(elem768);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "sendBuddyContentMessageToMids_args(";
    var first : Bool = true;
