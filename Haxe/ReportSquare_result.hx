...
class ReportSquare_result implements TBase {
  ...
  public function get_success() : ReportSquareResponse {
    return this.success;
  }

  public function set_success(success:ReportSquareResponse) : ReportSquareResponse {
  ...
  public function toString() : String {
    var ret : String = "ReportSquare_result(";
    var first : Bool = true;
