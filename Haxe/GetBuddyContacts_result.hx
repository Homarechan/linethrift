...
class GetBuddyContacts_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBuddyContacts_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list813 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i814 in 0 ... _list813.size)
                {
                  var _elem815 : Contact;
                  _elem815 = new Contact();
                  _elem815.read(iprot);
                  this.success.add(_elem815);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetBuddyContacts_result(";
    var first : Bool = true;
