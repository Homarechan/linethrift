        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list709 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i710 in 0 ... _list709.size)
                {
                  var _elem711 : Contact;
                  _elem711 = new Contact();
                  _elem711.read(iprot);
                  this.success.add(_elem711);
                }
                iprot.readListEnd();
              }
            } else { 
