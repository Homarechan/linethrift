...
class DestroyMessage_result implements TBase {
  ...
  public function get_success() : DestroyMessageResponse {
    return this.success;
  }

  public function set_success(success:DestroyMessageResponse) : DestroyMessageResponse {
  ...
  public function toString() : String {
    var ret : String = "DestroyMessage_result(";
    var first : Bool = true;
