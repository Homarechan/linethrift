...
class GetUserTickets_result implements TBase {
  ...
  public function get_success() : List< UserTicketResponse> {
    return this.success;
  }

  public function set_success(success:List< UserTicketResponse>) : List< UserTicketResponse> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1452 = iprot.readListBegin();
                this.success = new List< UserTicketResponse>();
                for( _i1453 in 0 ... _list1452.size)
                {
                  var _elem1454 : UserTicketResponse;
                  _elem1454 = new UserTicketResponse();
                  _elem1454.read(iprot);
                  this.success.add(_elem1454);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1455 in this.success)
          {
            elem1455.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetUserTickets_result(";
    var first : Bool = true;
