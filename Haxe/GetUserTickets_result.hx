        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1556 = iprot.readListBegin();
                this.success = new List< UserTicketResponse>();
                for( _i1557 in 0 ... _list1556.size)
                {
                  var _elem1558 : UserTicketResponse;
                  _elem1558 = new UserTicketResponse();
                  _elem1558.read(iprot);
                  this.success.add(_elem1558);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1559 in this.success)
          {
            elem1559.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
