...
class GetFavoriteGroupIdsForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetFavoriteGroupIdsForChannel_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1351 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1352 in 0 ... _list1351.size)
                {
                  var _elem1353 : String;
                  _elem1353 = iprot.readString();
                  this.success.add(_elem1353);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1354 in this.success)
          {
            oprot.writeString(elem1354);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetFavoriteGroupIdsForChannel_result(";
    var first : Bool = true;
