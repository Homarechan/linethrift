        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1455 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1456 in 0 ... _list1455.size)
                {
                  var _elem1457 : String;
                  _elem1457 = iprot.readString();
                  this.success.add(_elem1457);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1458 in this.success)
          {
            oprot.writeString(elem1458);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
