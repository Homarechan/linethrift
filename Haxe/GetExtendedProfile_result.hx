...
class GetExtendedProfile_result implements TBase {
  ...
  public function get_success() : ExtendedProfile {
    return this.success;
  }

  public function set_success(success:ExtendedProfile) : ExtendedProfile {
  ...
  public function toString() : String {
    var ret : String = "GetExtendedProfile_result(";
    var first : Bool = true;
