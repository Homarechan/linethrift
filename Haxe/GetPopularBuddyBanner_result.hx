...
class GetPopularBuddyBanner_result implements TBase {
  ...
  public function get_success() : BuddyBanner {
    return this.success;
  }

  public function set_success(success:BuddyBanner) : BuddyBanner {
  ...
  public function toString() : String {
    var ret : String = "GetPopularBuddyBanner_result(";
    var first : Bool = true;
