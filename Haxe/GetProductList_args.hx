...
class GetProductList_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getProductList_args"); };
        ...
        switch (field.id)
        {
          case PRODUCTIDLIST_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list935 = iprot.readListBegin();
                this.productIdList = new List< String>();
                for( _i936 in 0 ... _list935.size)
                {
                  var _elem937 : String;
                  _elem937 = iprot.readString();
                  this.productIdList.add(_elem937);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.productIdList != null) {
        oprot.writeFieldBegin(PRODUCT_ID_LIST_FIELD_DESC);
        {
          ...
          for( elem938 in this.productIdList)
          {
  ...
  public function toString() : String {
    var ret : String = "getProductList_args(";
    var first : Bool = true;
