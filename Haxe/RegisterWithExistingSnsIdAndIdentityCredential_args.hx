...
class RegisterWithExistingSnsIdAndIdentityCredential_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("registerWithExistingSnsIdAndIdentityCredential_args"); };
  ...
  public function toString() : String {
    var ret : String = "registerWithExistingSnsIdAndIdentityCredential_args(";
    var first : Bool = true;
