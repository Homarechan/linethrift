...
class GetSquareChatStatus_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareChatStatus_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareChatStatusRequest;
  ...
  public function get_request() : GetSquareChatStatusRequest {
    return this.request;
  }

  public function set_request(request:GetSquareChatStatusRequest) : GetSquareChatStatusRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareChatStatus_args(";
    var first : Bool = true;
