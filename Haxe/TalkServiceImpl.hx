...
class TalkServiceImpl implements TalkService {
  ...
  public function searchCollection(query : String, param : SearchPagingParameter) : SearchResult {
    oprot_.writeMessageBegin(new TMessage("searchCollection", TMessageType.CALL, seqid_));
    ...
    oprot_.getTransport().flush(function(error:Dynamic) : Void {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
                                  "searchCollection failed: unknown result");
    });
    return retval;
  }
  ...
  public function updateProfileAttributes(reqSeq : haxe.Int32, request : UpdateProfileAttributesRequest) : Void {
    oprot_.writeMessageBegin(new TMessage("updateProfileAttributes", TMessageType.CALL, seqid_));
