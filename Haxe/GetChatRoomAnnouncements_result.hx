        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list958 = iprot.readListBegin();
                this.success = new List< ChatRoomAnnouncement>();
                for( _i959 in 0 ... _list958.size)
                {
                  var _elem960 : ChatRoomAnnouncement;
                  _elem960 = new ChatRoomAnnouncement();
                  _elem960.read(iprot);
