...
class GetChatRoomAnnouncements_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetChatRoomAnnouncements_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< ChatRoomAnnouncement>;
  @:isVar
  ...
  public function get_success() : List< ChatRoomAnnouncement> {
    return this.success;
  }

  public function set_success(success:List< ChatRoomAnnouncement>) : List< ChatRoomAnnouncement> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list854 = iprot.readListBegin();
                this.success = new List< ChatRoomAnnouncement>();
                for( _i855 in 0 ... _list854.size)
                {
                  var _elem856 : ChatRoomAnnouncement;
                  _elem856 = new ChatRoomAnnouncement();
                  _elem856.read(iprot);
                  this.success.add(_elem856);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetChatRoomAnnouncements_result(";
    var first : Bool = true;
