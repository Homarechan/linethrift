        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1149 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1150 in 0 ... _list1149.size)
                {
                  var _elem1151 : String;
                  _elem1151 = iprot.readString();
                  this.success.add(_elem1151);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1152 in this.success)
          {
            oprot.writeString(elem1152);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
