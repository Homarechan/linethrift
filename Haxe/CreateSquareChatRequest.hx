        ...
        switch (field.id)
        {
          ...
          case SQUAREMEMBERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list420 = iprot.readListBegin();
                this.squareMemberMids = new List< String>();
                for( _i421 in 0 ... _list420.size)
                {
                  var _elem422 : String;
                  _elem422 = iprot.readString();
                  this.squareMemberMids.add(_elem422);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.squareMemberMids != null) {
        oprot.writeFieldBegin(SQUARE_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for( elem423 in this.squareMemberMids)
          {
            oprot.writeString(elem423);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
