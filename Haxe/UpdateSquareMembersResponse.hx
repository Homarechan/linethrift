        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set587 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i588 in 0 ... _set587.size)
                {
                  var _elem589 : Int;
                  _elem589 = iprot.readI32();
                  this.updatedAttrs.add(_elem589);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case MEMBERS_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map590 = iprot.readMapBegin();
                this.members = new StringMap< SquareMember>();
                for( _i591 in 0 ... _map590.size)
                {
                  var _key592 : String;
                  var _val593 : SquareMember;
                  _key592 = iprot.readString();
                  _val593 = new SquareMember();
                  _val593.read(iprot);
                  this.members.set( _key592, _val593);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem594 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem594);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.members != null) {
        ...
        {
          var _sizeCounter596 : Int = 0;
          for( _key595 in this.members) {
            _sizeCounter596++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _sizeCounter596));
          for( elem597 in this.members.keys())
          {
            oprot.writeString(elem597);
            this.members.get(elem597).write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
