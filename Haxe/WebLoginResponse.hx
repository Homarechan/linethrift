...
class WebLoginResponse implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("WebLoginResponse"); };
  static var RETURN_URL_FIELD_DESC = { new TField("returnUrl", TType.STRING, 1); };

  @:isVar
  public var returnUrl(get,set) : String;

  inline static var RETURNURL_FIELD_ID : Int = 1;
  ...
  public function toString() : String {
    var ret : String = "WebLoginResponse(";
    var first : Bool = true;
