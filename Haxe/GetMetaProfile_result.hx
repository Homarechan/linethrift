...
class GetMetaProfile_result implements TBase {
  ...
  public function get_success() : MetaProfile {
    return this.success;
  }

  public function set_success(success:MetaProfile) : MetaProfile {
  ...
  public function toString() : String {
    var ret : String = "GetMetaProfile_result(";
    var first : Bool = true;
