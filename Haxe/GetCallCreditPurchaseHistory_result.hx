...
class GetCallCreditPurchaseHistory_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCallCreditPurchaseHistory_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : CoinHistoryResult;
  @:isVar
  ...
  public function get_success() : CoinHistoryResult {
    return this.success;
  }

  public function set_success(success:CoinHistoryResult) : CoinHistoryResult {
  ...
  public function toString() : String {
    var ret : String = "GetCallCreditPurchaseHistory_result(";
    var first : Bool = true;
