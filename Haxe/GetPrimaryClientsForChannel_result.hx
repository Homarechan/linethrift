        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1398 = iprot.readListBegin();
                this.success = new List< SimpleChannelClient>();
                for( _i1399 in 0 ... _list1398.size)
                {
                  var _elem1400 : SimpleChannelClient;
                  _elem1400 = new SimpleChannelClient();
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1401 in this.success)
          {
            elem1401.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
