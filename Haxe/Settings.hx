        ...
        switch (field.id)
        {
          ...
          case SNSACCOUNTS_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map363 = iprot.readMapBegin();
                this.snsAccounts = new IntMap< String>();
                for( _i364 in 0 ... _map363.size)
                {
                  var _key365 : Int;
                  var _val366 : String;
                  _key365 = iprot.readI32();
                  _val366 = iprot.readString();
                  this.snsAccounts.set( _key365, _val366);
                }
                iprot.readMapEnd();
              }
            } else { 
          ...
          case CUSTOMMODES_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map367 = iprot.readMapBegin();
                this.customModes = new IntMap< String>();
                for( _i368 in 0 ... _map367.size)
                {
                  var _key369 : Int;
                  var _val370 : String;
                  _key369 = iprot.readI32();
                  _val370 = iprot.readString();
                  this.customModes.set( _key369, _val370);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.snsAccounts != null) {
        ...
        {
          var _sizeCounter372 : Int = 0;
          for( _key371 in this.snsAccounts) {
            _sizeCounter372++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.STRING, _sizeCounter372));
          for( elem373 in this.snsAccounts.keys())
          {
            oprot.writeI32(elem373);
            oprot.writeString(this.snsAccounts.get(elem373));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.customModes != null) {
        ...
        {
          var _sizeCounter375 : Int = 0;
          for( _key374 in this.customModes) {
            _sizeCounter375++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.STRING, _sizeCounter375));
          for( elem376 in this.customModes.keys())
          {
            oprot.writeI32(elem376);
            oprot.writeString(this.customModes.get(elem376));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
