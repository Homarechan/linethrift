...
class GetMessageBoxCompactWrapUpV2_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetMessageBoxCompactWrapUpV2_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : TMessageBoxWrapUp;
  @:isVar
  ...
  public function get_success() : TMessageBoxWrapUp {
    return this.success;
  }

  public function set_success(success:TMessageBoxWrapUp) : TMessageBoxWrapUp {
  ...
  public function toString() : String {
    var ret : String = "GetMessageBoxCompactWrapUpV2_result(";
    var first : Bool = true;
