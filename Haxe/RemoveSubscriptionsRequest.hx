        ...
        switch (field.id)
        {
          case UNSUBSCRIPTIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list502 = iprot.readListBegin();
                this.unsubscriptions = new List< haxe.Int64>();
                for( _i503 in 0 ... _list502.size)
                {
                  var _elem504 : haxe.Int64;
                  _elem504 = iprot.readI64();
                  this.unsubscriptions.add(_elem504);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.unsubscriptions != null) {
        oprot.writeFieldBegin(UNSUBSCRIPTIONS_FIELD_DESC);
        {
          ...
          for( elem505 in this.unsubscriptions)
          {
            oprot.writeI64(elem505);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
