...
class CreateSquareChatAnnouncementRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("CreateSquareChatAnnouncementRequest"); };
  ...
  static var SQUARE_CHAT_ANNOUNCEMENT_FIELD_DESC = { new TField("squareChatAnnouncement", TType.STRUCT, 3); };
  ...
  @:isVar
  public var squareChatAnnouncement(get,set) : SquareChatAnnouncement;

  inline static var REQSEQ_FIELD_ID : Int = 1;
  inline static var SQUARECHATMID_FIELD_ID : Int = 2;
  inline static var SQUARECHATANNOUNCEMENT_FIELD_ID : Int = 3;
  ...
  public function get_squareChatAnnouncement() : SquareChatAnnouncement {
    return this.squareChatAnnouncement;
  }

  public function set_squareChatAnnouncement(squareChatAnnouncement:SquareChatAnnouncement) : SquareChatAnnouncement {
    this.squareChatAnnouncement = squareChatAnnouncement;
    return this.squareChatAnnouncement;
  }

  public function unsetSquareChatAnnouncement() : Void {
  ...
  public function isSetSquareChatAnnouncement() : Bool {
  ...
  public function setFieldValue(fieldID : Int, value : Dynamic) : Void {
    ...
    case SQUARECHATANNOUNCEMENT_FIELD_ID:
      if (value == null) {
  ...
  public function toString() : String {
    var ret : String = "CreateSquareChatAnnouncementRequest(";
    var first : Bool = true;
    ...
    first = false;
    if (!first) ret +=  ", ";
    ret += "squareChatAnnouncement:";
    if (this.squareChatAnnouncement == null) {
      ret += "null";
    } else {
      ret += this.squareChatAnnouncement;
    }
    first = false;
    ret += ")";
    return ret;
