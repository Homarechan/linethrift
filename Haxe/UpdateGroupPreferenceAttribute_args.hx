        ...
        switch (field.id)
        {
          ...
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map1349 = iprot.readMapBegin();
                this.updatedAttrs = new IntMap< String>();
                for( _i1350 in 0 ... _map1349.size)
                {
                  var _key1351 : Int;
                  var _val1352 : String;
                  _key1351 = iprot.readI32();
                  _val1352 = iprot.readString();
                  this.updatedAttrs.set( _key1351, _val1352);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        ...
        {
          var _sizeCounter1354 : Int = 0;
          for( _key1353 in this.updatedAttrs) {
            _sizeCounter1354++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.STRING, _sizeCounter1354));
          for( elem1355 in this.updatedAttrs.keys())
          {
            oprot.writeI32(elem1355);
            oprot.writeString(this.updatedAttrs.get(elem1355));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
