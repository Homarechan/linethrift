...
class GetChannels_result implements TBase {
  ...
  public function get_success() : ChannelInfos {
    return this.success;
  }

  public function set_success(success:ChannelInfos) : ChannelInfos {
  ...
  public function toString() : String {
    var ret : String = "GetChannels_result(";
    var first : Bool = true;
