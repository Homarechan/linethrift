...
class SyncChannelData_result implements TBase {
  ...
  public function get_success() : ChannelSyncDatas {
    return this.success;
  }

  public function set_success(success:ChannelSyncDatas) : ChannelSyncDatas {
  ...
  public function toString() : String {
    var ret : String = "SyncChannelData_result(";
    var first : Bool = true;
