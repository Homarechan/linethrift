...
class UpdateProfileAttributes_args implements TBase {
  
  static var STRUCT_DESC = { new TStruct("updateProfileAttributes_args"); };
  ...
  @:isVar
  public var request(get,set) : UpdateProfileAttributesRequest;
  ...
  public function get_request() : UpdateProfileAttributesRequest {
    return this.request;
  }

  public function set_request(request:UpdateProfileAttributesRequest) : UpdateProfileAttributesRequest {
  ...
  public function toString() : String {
    var ret : String = "updateProfileAttributes_args(";
    var first : Bool = true;
