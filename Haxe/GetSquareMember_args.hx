...
class GetSquareMember_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareMember_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareMemberRequest;
  ...
  public function get_request() : GetSquareMemberRequest {
    return this.request;
  }

  public function set_request(request:GetSquareMemberRequest) : GetSquareMemberRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareMember_args(";
    var first : Bool = true;
