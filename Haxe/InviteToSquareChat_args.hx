...
class InviteToSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("inviteToSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : InviteToSquareChatRequest;
  ...
  public function get_request() : InviteToSquareChatRequest {
    return this.request;
  }

  public function set_request(request:InviteToSquareChatRequest) : InviteToSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "inviteToSquareChat_args(";
    var first : Bool = true;
