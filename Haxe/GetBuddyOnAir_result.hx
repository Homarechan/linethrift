...
class GetBuddyOnAir_result implements TBase {
  ...
  public function get_success() : BuddyOnAir {
    return this.success;
  }

  public function set_success(success:BuddyOnAir) : BuddyOnAir {
  ...
  public function toString() : String {
    var ret : String = "GetBuddyOnAir_result(";
    var first : Bool = true;
