...
class GetPreviousMessagesV2WithReadCount_args implements TBase {
  ...
  public function get_endMessageId() : MessageBoxV2MessageId {
    return this.endMessageId;
  }

  public function set_endMessageId(endMessageId:MessageBoxV2MessageId) : MessageBoxV2MessageId {
  ...
  public function toString() : String {
    var ret : String = "getPreviousMessagesV2WithReadCount_args(";
    var first : Bool = true;
