...
class DownloadMessageContentPreview_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("DownloadMessageContentPreview_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRING, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : haxe.io.Bytes;
  @:isVar
  ...
  public function get_success() : haxe.io.Bytes {
    return this.success;
  }

  public function set_success(success:haxe.io.Bytes) : haxe.io.Bytes {
  ...
  public function toString() : String {
    var ret : String = "DownloadMessageContentPreview_result(";
    var first : Bool = true;
