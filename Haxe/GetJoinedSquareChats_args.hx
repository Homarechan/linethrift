...
class GetJoinedSquareChats_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getJoinedSquareChats_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetJoinedSquareChatsRequest;
  ...
  public function get_request() : GetJoinedSquareChatsRequest {
    return this.request;
  }

  public function set_request(request:GetJoinedSquareChatsRequest) : GetJoinedSquareChatsRequest {
  ...
  public function toString() : String {
    var ret : String = "getJoinedSquareChats_args(";
    var first : Bool = true;
