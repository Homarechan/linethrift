...
class CancelGroupInvitation_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("cancelGroupInvitation_args"); };
        ...
        switch (field.id)
        {
          ...
          case CONTACTIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list866 = iprot.readListBegin();
                this.contactIds = new List< String>();
                for( _i867 in 0 ... _list866.size)
                {
                  var _elem868 : String;
                  _elem868 = iprot.readString();
                  this.contactIds.add(_elem868);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem869 in this.contactIds)
          {
  ...
  public function toString() : String {
    var ret : String = "cancelGroupInvitation_args(";
    var first : Bool = true;
