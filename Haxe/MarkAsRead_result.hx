...
class MarkAsRead_result implements TBase {
  ...
  public function get_success() : MarkAsReadResponse {
    return this.success;
  }

  public function set_success(success:MarkAsReadResponse) : MarkAsReadResponse {
  ...
  public function toString() : String {
    var ret : String = "MarkAsRead_result(";
    var first : Bool = true;
