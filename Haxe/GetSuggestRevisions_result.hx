...
class GetSuggestRevisions_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSuggestRevisions_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SuggestDictionaryRevisions;
  @:isVar
  ...
  public function get_success() : SuggestDictionaryRevisions {
    return this.success;
  }

  public function set_success(success:SuggestDictionaryRevisions) : SuggestDictionaryRevisions {
  ...
  public function toString() : String {
    var ret : String = "GetSuggestRevisions_result(";
    var first : Bool = true;
