...
class IssueRequestTokenWithAuthScheme_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("IssueRequestTokenWithAuthScheme_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : RequestTokenResponse;
  @:isVar
  ...
  public function get_success() : RequestTokenResponse {
    return this.success;
  }

  public function set_success(success:RequestTokenResponse) : RequestTokenResponse {
  ...
  public function toString() : String {
    var ret : String = "IssueRequestTokenWithAuthScheme_result(";
    var first : Bool = true;
