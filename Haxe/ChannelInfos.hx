        ...
        switch (field.id)
        {
          case CHANNELINFOS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list185 = iprot.readListBegin();
                this.channelInfos = new List< ChannelInfo>();
                for( _i186 in 0 ... _list185.size)
                {
                  var _elem187 : ChannelInfo;
                  _elem187 = new ChannelInfo();
                  _elem187.read(iprot);
                  this.channelInfos.add(_elem187);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.channelInfos != null) {
        oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for( elem188 in this.channelInfos)
          {
            elem188.write(oprot);
          }
          oprot.writeListEnd();
