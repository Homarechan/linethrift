...
class LeaveSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("leaveSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : LeaveSquareChatRequest;
  ...
  public function get_request() : LeaveSquareChatRequest {
    return this.request;
  }

  public function set_request(request:LeaveSquareChatRequest) : LeaveSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "leaveSquareChat_args(";
    var first : Bool = true;
