...
class CreateGroup_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("createGroup_args"); };
        ...
        switch (field.id)
        {
          ...
          case CONTACTIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1015 = iprot.readListBegin();
                this.contactIds = new List< String>();
                for( _i1016 in 0 ... _list1015.size)
                {
                  var _elem1017 : String;
                  _elem1017 = iprot.readString();
                  this.contactIds.add(_elem1017);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contactIds != null) {
        oprot.writeFieldBegin(CONTACT_IDS_FIELD_DESC);
        {
          ...
          for( elem1018 in this.contactIds)
          {
            oprot.writeString(elem1018);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "createGroup_args(";
    var first : Bool = true;
