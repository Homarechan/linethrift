...
class ReportSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("reportSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : ReportSquareChatRequest;
  ...
  public function get_request() : ReportSquareChatRequest {
    return this.request;
  }

  public function set_request(request:ReportSquareChatRequest) : ReportSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "reportSquareChat_args(";
    var first : Bool = true;
