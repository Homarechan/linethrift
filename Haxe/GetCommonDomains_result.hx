...
class GetCommonDomains_result implements TBase {
  ...
  public function get_success() : ChannelDomains {
    return this.success;
  }

  public function set_success(success:ChannelDomains) : ChannelDomains {
  ...
  public function toString() : String {
    var ret : String = "GetCommonDomains_result(";
    var first : Bool = true;
