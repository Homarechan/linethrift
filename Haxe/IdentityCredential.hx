...
class IdentityCredential implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("IdentityCredential"); };
  static var PROVIDER_FIELD_DESC = { new TField("provider", TType.I32, 1); };
  ...
  inline static var PROVIDER_FIELD_ID : Int = 1;
  ...
  public function toString() : String {
    var ret : String = "IdentityCredential(";
    var first : Bool = true;
