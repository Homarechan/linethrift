        ...
        switch (field.id)
        {
          ...
          case SUBSCRIPTIONSTATES_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map614 = iprot.readMapBegin();
                this.subscriptionStates = new Int64Map< SubscriptionState>();
                for( _i615 in 0 ... _map614.size)
                {
                  var _key616 : haxe.Int64;
                  var _val617 : SubscriptionState;
                  _key616 = iprot.readI64();
                  _val617 = new SubscriptionState();
                  _val617.read(iprot);
                  this.subscriptionStates.set( _key616, _val617);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.subscriptionStates != null) {
        ...
        {
          var _sizeCounter619 : Int = 0;
          for( _key618 in this.subscriptionStates) {
            _sizeCounter619++;
          }
          oprot.writeMapBegin(new TMap(TType.I64, TType.STRUCT, _sizeCounter619));
          for( elem620 in this.subscriptionStates.keys())
          {
            oprot.writeI64(elem620);
            this.subscriptionStates.get(elem620).write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
