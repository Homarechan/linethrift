...
class ApproveSquareMembers_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("approveSquareMembers_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : ApproveSquareMembersRequest;
  ...
  public function get_request() : ApproveSquareMembersRequest {
    return this.request;
  }

  public function set_request(request:ApproveSquareMembersRequest) : ApproveSquareMembersRequest {
  ...
  public function toString() : String {
    var ret : String = "approveSquareMembers_args(";
    var first : Bool = true;
