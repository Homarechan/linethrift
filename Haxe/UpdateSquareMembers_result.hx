...
class UpdateSquareMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("UpdateSquareMembers_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : UpdateSquareMembersResponse;
  @:isVar
  ...
  public function get_success() : UpdateSquareMembersResponse {
    return this.success;
  }

  public function set_success(success:UpdateSquareMembersResponse) : UpdateSquareMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "UpdateSquareMembers_result(";
    var first : Bool = true;
