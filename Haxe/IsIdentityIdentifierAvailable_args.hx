...
class IsIdentityIdentifierAvailable_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("isIdentityIdentifierAvailable_args"); };
  static var PROVIDER_FIELD_DESC = { new TField("provider", TType.I32, 3); };
  ...
  inline static var PROVIDER_FIELD_ID : Int = 3;
  ...
  public function toString() : String {
    var ret : String = "isIdentityIdentifierAvailable_args(";
    var first : Bool = true;
