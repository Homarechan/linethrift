...
class IssueRequestTokenWithAuthScheme_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("issueRequestTokenWithAuthScheme_args"); };
  ...
  static var AUTH_SCHEME_FIELD_DESC = { new TField("authScheme", TType.LIST, 3); };
  static var RETURN_URL_FIELD_DESC = { new TField("returnUrl", TType.STRING, 4); };
  ...
  @:isVar
  public var authScheme(get,set) : List< String>;
  @:isVar
  public var returnUrl(get,set) : String;

  inline static var CHANNELID_FIELD_ID : Int = 1;
  inline static var OTPID_FIELD_ID : Int = 2;
  inline static var AUTHSCHEME_FIELD_ID : Int = 3;
  inline static var RETURNURL_FIELD_ID : Int = 4;
  ...
  public function get_authScheme() : List< String> {
    return this.authScheme;
  }

  public function set_authScheme(authScheme:List< String>) : List< String> {
    this.authScheme = authScheme;
    return this.authScheme;
  }

  public function unsetAuthScheme() : Void {
    this.authScheme = null;
  }

  // Returns true if field authScheme is set (has been assigned a value) and false otherwise
  public function isSetAuthScheme() : Bool {
        ...
        switch (field.id)
        {
          ...
          case AUTHSCHEME_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list799 = iprot.readListBegin();
                this.authScheme = new List< String>();
                for( _i800 in 0 ... _list799.size)
                {
                  var _elem801 : String;
                  _elem801 = iprot.readString();
                  this.authScheme.add(_elem801);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.authScheme != null) {
        oprot.writeFieldBegin(AUTH_SCHEME_FIELD_DESC);
        {
          ...
          for( elem802 in this.authScheme)
          {
            oprot.writeString(elem802);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "issueRequestTokenWithAuthScheme_args(";
    var first : Bool = true;
