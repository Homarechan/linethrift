        ...
        switch (field.id)
        {
          case OPERATIONS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list282 = iprot.readListBegin();
                this.operations = new List< MessageOperation>();
                for( _i283 in 0 ... _list282.size)
                {
                  var _elem284 : MessageOperation;
                  _elem284 = new MessageOperation();
                  _elem284.read(iprot);
                  this.operations.add(_elem284);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.operations != null) {
        oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
        {
          ...
          for( elem285 in this.operations)
          {
            elem285.write(oprot);
          }
          oprot.writeListEnd();
