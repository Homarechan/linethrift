        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1521 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1522 in 0 ... _list1521.size)
                {
                  var _elem1523 : String;
                  _elem1523 = iprot.readString();
                  this.success.add(_elem1523);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1524 in this.success)
          {
            oprot.writeString(elem1524);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
