...
class GetGroupMemberMids_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroupMemberMids_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1417 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1418 in 0 ... _list1417.size)
                {
                  var _elem1419 : String;
                  _elem1419 = iprot.readString();
                  this.success.add(_elem1419);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1420 in this.success)
          {
            oprot.writeString(elem1420);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupMemberMids_result(";
    var first : Bool = true;
