...
class RegisterWithPhoneNumberAndPassword_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RegisterWithPhoneNumberAndPassword_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : RegisterWithPhoneNumberResult;
  @:isVar
  ...
  public function get_success() : RegisterWithPhoneNumberResult {
    return this.success;
  }

  public function set_success(success:RegisterWithPhoneNumberResult) : RegisterWithPhoneNumberResult {
  ...
  public function toString() : String {
    var ret : String = "RegisterWithPhoneNumberAndPassword_result(";
    var first : Bool = true;
