...
class ApproveSquareMembers_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ApproveSquareMembers_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ApproveSquareMembersResponse;
  @:isVar
  ...
  public function get_success() : ApproveSquareMembersResponse {
    return this.success;
  }

  public function set_success(success:ApproveSquareMembersResponse) : ApproveSquareMembersResponse {
  ...
  public function toString() : String {
    var ret : String = "ApproveSquareMembers_result(";
    var first : Bool = true;
