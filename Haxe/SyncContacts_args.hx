        ...
        switch (field.id)
        {
          ...
          case LOCALCONTACTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1264 = iprot.readListBegin();
                this.localContacts = new List< ContactModification>();
                for( _i1265 in 0 ... _list1264.size)
                {
                  var _elem1266 : ContactModification;
                  _elem1266 = new ContactModification();
                  _elem1266.read(iprot);
                  this.localContacts.add(_elem1266);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.localContacts != null) {
        oprot.writeFieldBegin(LOCAL_CONTACTS_FIELD_DESC);
        {
          ...
          for( elem1267 in this.localContacts)
          {
            elem1267.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
