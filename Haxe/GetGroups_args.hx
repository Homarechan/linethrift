        ...
        switch (field.id)
        {
          case GROUPIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1153 = iprot.readListBegin();
                this.groupIds = new List< String>();
                for( _i1154 in 0 ... _list1153.size)
                {
                  var _elem1155 : String;
                  _elem1155 = iprot.readString();
                  this.groupIds.add(_elem1155);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.groupIds != null) {
        oprot.writeFieldBegin(GROUP_IDS_FIELD_DESC);
        {
          ...
          for( elem1156 in this.groupIds)
          {
            oprot.writeString(elem1156);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
