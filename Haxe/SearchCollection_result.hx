...
class SearchCollection_result implements TBase {
  
  static var STRUCT_DESC = { new TStruct("SearchCollection_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : SearchResult;
  @:isVar
  ...
  public function get_success() : SearchResult {
    return this.success;
  }

  public function set_success(success:SearchResult) : SearchResult {
  ...
  public function toString() : String {
    var ret : String = "SearchCollection_result(";
    var first : Bool = true;
