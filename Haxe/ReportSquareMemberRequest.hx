...
class ReportSquareMemberRequest implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ReportSquareMemberRequest"); };
  ...
  static var SQUARE_CHAT_MID_FIELD_DESC = { new TField("squareChatMid", TType.STRING, 5); };
  ...
  inline static var SQUARECHATMID_FIELD_ID : Int = 5;
  ...
  public function toString() : String {
    var ret : String = "ReportSquareMemberRequest(";
    var first : Bool = true;
