...
class GetLastReadMessageIds_result implements TBase {
  ...
  public function get_success() : LastReadMessageIds {
    return this.success;
  }

  public function set_success(success:LastReadMessageIds) : LastReadMessageIds {
  ...
  public function toString() : String {
    var ret : String = "GetLastReadMessageIds_result(";
    var first : Bool = true;
