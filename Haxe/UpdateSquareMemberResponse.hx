        ...
        switch (field.id)
        {
          case UPDATEDATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set571 = iprot.readSetBegin();
                this.updatedAttrs = new IntSet();
                for( _i572 in 0 ... _set571.size)
                {
                  var _elem573 : Int;
                  _elem573 = iprot.readI32();
                  this.updatedAttrs.add(_elem573);
                }
                iprot.readSetEnd();
              }
            } else { 
          ...
          case UPDATEDPREFERENCEATTRS_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set574 = iprot.readSetBegin();
                this.updatedPreferenceAttrs = new IntSet();
                for( _i575 in 0 ... _set574.size)
                {
                  var _elem576 : Int;
                  _elem576 = iprot.readI32();
                  this.updatedPreferenceAttrs.add(_elem576);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for( elem577 in this.updatedAttrs.toArray())
          {
            oprot.writeI32(elem577);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.updatedPreferenceAttrs != null) {
        oprot.writeFieldBegin(UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
        {
          ...
          for( elem578 in this.updatedPreferenceAttrs.toArray())
          {
            oprot.writeI32(elem578);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
