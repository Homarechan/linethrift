        ...
        switch (field.id)
        {
          ...
          case PARAMETERMAP_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map692 = iprot.readMapBegin();
                this.parameterMap = new StringMap< String>();
                for( _i693 in 0 ... _map692.size)
                {
                  var _key694 : String;
                  var _val695 : String;
                  _key694 = iprot.readString();
                  _val695 = iprot.readString();
                  this.parameterMap.set( _key694, _val695);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.parameterMap != null) {
        ...
        {
          var _sizeCounter697 : Int = 0;
          for( _key696 in this.parameterMap) {
            _sizeCounter697++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter697));
          for( elem698 in this.parameterMap.keys())
          {
            oprot.writeString(elem698);
            oprot.writeString(this.parameterMap.get(elem698));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
