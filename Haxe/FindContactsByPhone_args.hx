        ...
        switch (field.id)
        {
          case PHONES_FIELD_ID:
            if (field.type == TType.SET) {
              {
                var _set1090 = iprot.readSetBegin();
                this.phones = new StringSet();
                for( _i1091 in 0 ... _set1090.size)
                {
                  var _elem1092 : String;
                  _elem1092 = iprot.readString();
                  this.phones.add(_elem1092);
                }
                iprot.readSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.phones != null) {
        oprot.writeFieldBegin(PHONES_FIELD_DESC);
        {
          ...
          for( elem1093 in this.phones.toArray())
          {
            oprot.writeString(elem1093);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
