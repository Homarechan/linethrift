...
class GetContactsForChannel_result implements TBase {
  ...
  public function get_success() : List< Contact> {
    return this.success;
  }

  public function set_success(success:List< Contact>) : List< Contact> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1431 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i1432 in 0 ... _list1431.size)
                {
                  var _elem1433 : Contact;
                  _elem1433 = new Contact();
                  _elem1433.read(iprot);
                  this.success.add(_elem1433);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1434 in this.success)
          {
            elem1434.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetContactsForChannel_result(";
    var first : Bool = true;
