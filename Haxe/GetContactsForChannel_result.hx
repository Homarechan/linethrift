        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1327 = iprot.readListBegin();
                this.success = new List< Contact>();
                for( _i1328 in 0 ... _list1327.size)
                {
                  var _elem1329 : Contact;
                  _elem1329 = new Contact();
                  _elem1329.read(iprot);
                  this.success.add(_elem1329);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1330 in this.success)
          {
            elem1330.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
