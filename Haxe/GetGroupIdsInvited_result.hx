        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1145 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1146 in 0 ... _list1145.size)
                {
                  var _elem1147 : String;
                  _elem1147 = iprot.readString();
                  this.success.add(_elem1147);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1148 in this.success)
          {
            oprot.writeString(elem1148);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
