...
class GetSnsFriends_result implements TBase {
  ...
  public function get_success() : SnsFriends {
    return this.success;
  }

  public function set_success(success:SnsFriends) : SnsFriends {
  ...
  public function toString() : String {
    var ret : String = "GetSnsFriends_result(";
    var first : Bool = true;
