...
class GetRecommendationIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetRecommendationIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1201 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1202 in 0 ... _list1201.size)
                {
                  var _elem1203 : String;
                  _elem1203 = iprot.readString();
                  this.success.add(_elem1203);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1204 in this.success)
          {
            oprot.writeString(elem1204);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetRecommendationIds_result(";
    var first : Bool = true;
