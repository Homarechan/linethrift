...
class FetchMessages_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FetchMessages_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1027 = iprot.readListBegin();
                this.success = new List< Message>();
                for( _i1028 in 0 ... _list1027.size)
                {
                  var _elem1029 : Message;
                  _elem1029 = new Message();
                  _elem1029.read(iprot);
                  this.success.add(_elem1029);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1030 in this.success)
          {
            elem1030.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "FetchMessages_result(";
    var first : Bool = true;
