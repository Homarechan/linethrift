...
class RefreshSubscriptions_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RefreshSubscriptions_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : RefreshSubscriptionsResponse;
  @:isVar
  ...
  public function get_success() : RefreshSubscriptionsResponse {
    return this.success;
  }

  public function set_success(success:RefreshSubscriptionsResponse) : RefreshSubscriptionsResponse {
  ...
  public function toString() : String {
    var ret : String = "RefreshSubscriptions_result(";
    var first : Bool = true;
