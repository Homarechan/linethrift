...
class GetBlockedContactIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetBlockedContactIds_result"); };
  ...
  public function toString() : String {
    var ret : String = "GetBlockedContactIds_result(";
    var first : Bool = true;
