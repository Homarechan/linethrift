        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1009 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1010 in 0 ... _list1009.size)
                {
                  var _elem1011 : String;
                  _elem1011 = iprot.readString();
                  this.success.add(_elem1011);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1012 in this.success)
          {
            oprot.writeString(elem1012);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
