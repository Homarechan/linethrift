...
class DeleteSquareChat_result implements TBase {
  ...
  public function get_success() : DeleteSquareChatResponse {
    return this.success;
  }

  public function set_success(success:DeleteSquareChatResponse) : DeleteSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "DeleteSquareChat_result(";
    var first : Bool = true;
