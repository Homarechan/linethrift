...
class RegisterWithExistingSnsIdAndIdentityCredential_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RegisterWithExistingSnsIdAndIdentityCredential_result"); };
  ...
  public function toString() : String {
    var ret : String = "RegisterWithExistingSnsIdAndIdentityCredential_result(";
    var first : Bool = true;
