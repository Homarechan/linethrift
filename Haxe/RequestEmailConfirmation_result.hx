...
class RequestEmailConfirmation_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("RequestEmailConfirmation_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : EmailConfirmationSession;
  @:isVar
  ...
  public function get_success() : EmailConfirmationSession {
    return this.success;
  }

  public function set_success(success:EmailConfirmationSession) : EmailConfirmationSession {
  ...
  public function toString() : String {
    var ret : String = "RequestEmailConfirmation_result(";
    var first : Bool = true;
