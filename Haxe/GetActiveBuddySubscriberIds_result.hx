...
class GetActiveBuddySubscriberIds_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetActiveBuddySubscriberIds_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1001 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1002 in 0 ... _list1001.size)
                {
                  var _elem1003 : String;
                  _elem1003 = iprot.readString();
                  this.success.add(_elem1003);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "GetActiveBuddySubscriberIds_result(";
    var first : Bool = true;
