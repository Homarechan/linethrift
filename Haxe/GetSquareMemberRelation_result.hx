...
class GetSquareMemberRelation_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareMemberRelation_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetSquareMemberRelationResponse;
  @:isVar
  ...
  public function get_success() : GetSquareMemberRelationResponse {
    return this.success;
  }

  public function set_success(success:GetSquareMemberRelationResponse) : GetSquareMemberRelationResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareMemberRelation_result(";
    var first : Bool = true;
