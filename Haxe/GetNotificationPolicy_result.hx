...
class GetNotificationPolicy_result implements TBase {
  ...
  public function get_success() : List< Int> {
    return this.success;
  }

  public function set_success(success:List< Int>) : List< Int> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1185 = iprot.readListBegin();
                this.success = new List< Int>();
                for( _i1186 in 0 ... _list1185.size)
                {
                  var _elem1187 : Int;
                  _elem1187 = iprot.readI32();
                  this.success.add(_elem1187);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1188 in this.success)
          {
            oprot.writeI32(elem1188);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetNotificationPolicy_result(";
    var first : Bool = true;
