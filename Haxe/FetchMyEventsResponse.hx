        ...
        switch (field.id)
        {
          ...
          case EVENTS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list379 = iprot.readListBegin();
                this.events = new List< SquareEvent>();
                for( _i380 in 0 ... _list379.size)
                {
                  var _elem381 : SquareEvent;
                  _elem381 = new SquareEvent();
                  _elem381.read(iprot);
                  this.events.add(_elem381);
                }
                iprot.readListEnd();
              }
            } else { 
