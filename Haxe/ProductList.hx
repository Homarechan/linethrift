        ...
        switch (field.id)
        {
          ...
          case PRODUCTLIST_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list319 = iprot.readListBegin();
                this.productList = new List< Product>();
                for( _i320 in 0 ... _list319.size)
                {
                  var _elem321 : Product;
                  _elem321 = new Product();
                  _elem321.read(iprot);
                  this.productList.add(_elem321);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for( elem322 in this.productList)
          {
            elem322.write(oprot);
          }
          oprot.writeListEnd();
