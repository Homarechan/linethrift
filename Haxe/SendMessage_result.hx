...
class SendMessage_result implements TBase {
  ...
  public function get_success() : SendMessageResponse {
    return this.success;
  }

  public function set_success(success:SendMessageResponse) : SendMessageResponse {
  ...
  public function toString() : String {
    var ret : String = "SendMessage_result(";
    var first : Bool = true;
