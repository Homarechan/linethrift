        ...
        switch (field.id)
        {
          ...
          case RECEIVERMIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1307 = iprot.readListBegin();
                this.receiverMids = new List< String>();
                for( _i1308 in 0 ... _list1307.size)
                {
                  var _elem1309 : String;
                  _elem1309 = iprot.readString();
                  this.receiverMids.add(_elem1309);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.receiverMids != null) {
        oprot.writeFieldBegin(RECEIVER_MIDS_FIELD_DESC);
        {
          ...
          for( elem1310 in this.receiverMids)
          {
            oprot.writeString(elem1310);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
