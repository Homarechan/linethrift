...
class StoreMessage_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("storeMessage_args"); };
  static var REQUEST_ID_FIELD_DESC = { new TField("requestId", TType.STRING, 1); };
  static var MESSAGE_REQUEST_FIELD_DESC = { new TField("messageRequest", TType.STRUCT, 2); };

  @:isVar
  public var requestId(get,set) : String;
  @:isVar
  public var messageRequest(get,set) : BuddyMessageRequest;

  inline static var REQUESTID_FIELD_ID : Int = 1;
  inline static var MESSAGEREQUEST_FIELD_ID : Int = 2;
  ...
  public function get_messageRequest() : BuddyMessageRequest {
    return this.messageRequest;
  }

  public function set_messageRequest(messageRequest:BuddyMessageRequest) : BuddyMessageRequest {
    this.messageRequest = messageRequest;
    return this.messageRequest;
  }

  public function unsetMessageRequest() : Void {
    this.messageRequest = null;
  }

  // Returns true if field messageRequest is set (has been assigned a value) and false otherwise
  public function isSetMessageRequest() : Bool {
  ...
  public function toString() : String {
    var ret : String = "storeMessage_args(";
    var first : Bool = true;
