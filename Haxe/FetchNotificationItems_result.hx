...
class FetchNotificationItems_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FetchNotificationItems_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : NotificationFetchResult;
  @:isVar
  ...
  public function get_success() : NotificationFetchResult {
    return this.success;
  }

  public function set_success(success:NotificationFetchResult) : NotificationFetchResult {
  ...
  public function toString() : String {
    var ret : String = "FetchNotificationItems_result(";
    var first : Bool = true;
