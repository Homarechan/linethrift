        ...
        switch (field.id)
        {
          case PARAMETERMAP_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map707 = iprot.readMapBegin();
                this.parameterMap = new StringMap< String>();
                for( _i708 in 0 ... _map707.size)
                {
                  var _key709 : String;
                  var _val710 : String;
                  _key709 = iprot.readString();
                  _val710 = iprot.readString();
                  this.parameterMap.set( _key709, _val710);
                }
                iprot.readMapEnd();
              }
            } else { 
  ...
  public function write(oprot:TProtocol) : Void {
    ...
    try
    {
      ...
      if (this.parameterMap != null) {
        ...
        {
          var _sizeCounter712 : Int = 0;
          for( _key711 in this.parameterMap) {
            _sizeCounter712++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter712));
          for( elem713 in this.parameterMap.keys())
          {
            oprot.writeString(elem713);
            oprot.writeString(this.parameterMap.get(elem713));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
