...
class GetSquareFeatureSet_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetSquareFeatureSet_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : GetSquareFeatureSetResponse;
  @:isVar
  ...
  public function get_success() : GetSquareFeatureSetResponse {
    return this.success;
  }

  public function set_success(success:GetSquareFeatureSetResponse) : GetSquareFeatureSetResponse {
  ...
  public function toString() : String {
    var ret : String = "GetSquareFeatureSet_result(";
    var first : Bool = true;
