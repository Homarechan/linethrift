...
class CreateSquareChat_result implements TBase {
  ...
  public function get_success() : CreateSquareChatResponse {
    return this.success;
  }

  public function set_success(success:CreateSquareChatResponse) : CreateSquareChatResponse {
  ...
  public function toString() : String {
    var ret : String = "CreateSquareChat_result(";
    var first : Bool = true;
