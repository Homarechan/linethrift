        ...
        switch (field.id)
        {
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1312 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i1313 in 0 ... _list1312.size)
                {
                  var _elem1314 : String;
                  _elem1314 = iprot.readString();
                  this.mids.add(_elem1314);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem1315 in this.mids)
          {
            oprot.writeString(elem1315);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
