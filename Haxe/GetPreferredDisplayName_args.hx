...
class GetPreferredDisplayName_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getPreferredDisplayName_args"); };
  static var MIDS_FIELD_DESC = { new TField("mids", TType.LIST, 1); };

  @:isVar
  public var mids(get,set) : List< String>;

  inline static var MIDS_FIELD_ID : Int = 1;
        ...
        switch (field.id)
        {
          case MIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1416 = iprot.readListBegin();
                this.mids = new List< String>();
                for( _i1417 in 0 ... _list1416.size)
                {
                  var _elem1418 : String;
                  _elem1418 = iprot.readString();
                  this.mids.add(_elem1418);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for( elem1419 in this.mids)
          {
            oprot.writeString(elem1419);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "getPreferredDisplayName_args(";
    var first : Bool = true;
