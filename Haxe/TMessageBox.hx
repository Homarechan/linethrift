        ...
        switch (field.id)
        {
          ...
          case LASTMESSAGES_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list381 = iprot.readListBegin();
                this.lastMessages = new List< Message>();
                for( _i382 in 0 ... _list381.size)
                {
                  var _elem383 : Message;
                  _elem383 = new Message();
                  _elem383.read(iprot);
                  this.lastMessages.add(_elem383);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.lastMessages != null) {
        oprot.writeFieldBegin(LAST_MESSAGES_FIELD_DESC);
        {
          ...
          for( elem384 in this.lastMessages)
          {
            elem384.write(oprot);
          }
          oprot.writeListEnd();
