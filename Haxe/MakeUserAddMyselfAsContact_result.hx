...
class MakeUserAddMyselfAsContact_result implements TBase {
  ...
  public function get_success() : ContactTransition {
    return this.success;
  }

  public function set_success(success:ContactTransition) : ContactTransition {
  ...
  public function toString() : String {
    var ret : String = "MakeUserAddMyselfAsContact_result(";
    var first : Bool = true;
