...
interface TalkService {
  ...
  function searchCollection(query : String, param : SearchPagingParameter) : SearchResult;
  ...
  function updateProfileAttributes(reqSeq : haxe.Int32, request : UpdateProfileAttributesRequest) : Void;
