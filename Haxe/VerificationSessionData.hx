...
class VerificationSessionData implements TBase {
  ...
  static var CALLER_ID_MASK_FIELD_DESC = { new TField("callerIdMask", TType.STRING, 8); };
  ...
  @:isVar
  public var callerIdMask(get,set) : String;
  ...
  inline static var CALLERIDMASK_FIELD_ID : Int = 8;
  ...
  public function get_callerIdMask() : String {
    return this.callerIdMask;
  }

  public function set_callerIdMask(callerIdMask:String) : String {
    this.callerIdMask = callerIdMask;
    return this.callerIdMask;
  }

  public function unsetCallerIdMask() : Void {
    this.callerIdMask = null;
  }

  // Returns true if field callerIdMask is set (has been assigned a value) and false otherwise
  public function isSetCallerIdMask() : Bool {
        ...
        switch (field.id)
        {
          ...
          case AVAILABLEVERIFICATIONMETHODS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list267 = iprot.readListBegin();
                this.availableVerificationMethods = new List< Int>();
                for( _i268 in 0 ... _list267.size)
                {
                  var _elem269 : Int;
                  _elem269 = iprot.readI32();
                  this.availableVerificationMethods.add(_elem269);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.availableVerificationMethods != null) {
        oprot.writeFieldBegin(AVAILABLE_VERIFICATION_METHODS_FIELD_DESC);
        {
          ...
          for( elem270 in this.availableVerificationMethods)
          {
