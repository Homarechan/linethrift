...
class GetUserStatus_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetUserStatus_result"); };
  ...
  public function toString() : String {
    var ret : String = "GetUserStatus_result(";
    var first : Bool = true;

    ret += "success:";
    var success_name : String = .UserStatus.VALUES_TO_NAMES[this.success];
