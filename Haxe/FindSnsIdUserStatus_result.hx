...
class FindSnsIdUserStatus_result implements TBase {
  ...
  public function get_success() : SnsIdUserStatus {
    return this.success;
  }

  public function set_success(success:SnsIdUserStatus) : SnsIdUserStatus {
  ...
  public function toString() : String {
    var ret : String = "FindSnsIdUserStatus_result(";
    var first : Bool = true;
