...
class GetCoinProducts_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetCoinProducts_result"); };
            ...
            if (field.type == TType.LIST) {
              {
                ...
                {
                  var _elem929 : CoinProductItem;
                  _elem929 = new CoinProductItem();
                  _elem929.read(iprot);
  ...
  public function toString() : String {
    var ret : String = "GetCoinProducts_result(";
    var first : Bool = true;
