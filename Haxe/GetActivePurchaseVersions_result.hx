...
class GetActivePurchaseVersions_result implements TBase {
  ...
  public function get_success() : ProductSimpleList {
    return this.success;
  }

  public function set_success(success:ProductSimpleList) : ProductSimpleList {
  ...
  public function toString() : String {
    var ret : String = "GetActivePurchaseVersions_result(";
    var first : Bool = true;
