...
class InviteToSquare_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("inviteToSquare_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : InviteToSquareRequest;
  ...
  public function get_request() : InviteToSquareRequest {
    return this.request;
  }

  public function set_request(request:InviteToSquareRequest) : InviteToSquareRequest {
  ...
  public function toString() : String {
    var ret : String = "inviteToSquare_args(";
    var first : Bool = true;
