...
class GetPaidCallAdStatus_result implements TBase {
  ...
  public function get_success() : PaidCallAdResult {
    return this.success;
  }

  public function set_success(success:PaidCallAdResult) : PaidCallAdResult {
  ...
  public function toString() : String {
    var ret : String = "GetPaidCallAdStatus_result(";
    var first : Bool = true;
