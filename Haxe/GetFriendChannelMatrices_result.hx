...
class GetFriendChannelMatrices_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetFriendChannelMatrices_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : FriendChannelMatricesResponse;
  @:isVar
  ...
  public function get_success() : FriendChannelMatricesResponse {
    return this.success;
  }

  public function set_success(success:FriendChannelMatricesResponse) : FriendChannelMatricesResponse {
  ...
  public function toString() : String {
    var ret : String = "GetFriendChannelMatrices_result(";
    var first : Bool = true;
