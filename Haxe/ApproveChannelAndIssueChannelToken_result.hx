...
class ApproveChannelAndIssueChannelToken_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("ApproveChannelAndIssueChannelToken_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.STRUCT, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : ChannelToken;
  @:isVar
  ...
  public function get_success() : ChannelToken {
    return this.success;
  }

  public function set_success(success:ChannelToken) : ChannelToken {
  ...
  public function toString() : String {
    var ret : String = "ApproveChannelAndIssueChannelToken_result(";
    var first : Bool = true;
