...
class GetSquareMemberRelation_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("getSquareMemberRelation_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : GetSquareMemberRelationRequest;
  ...
  public function get_request() : GetSquareMemberRelationRequest {
    return this.request;
  }

  public function set_request(request:GetSquareMemberRelationRequest) : GetSquareMemberRelationRequest {
  ...
  public function toString() : String {
    var ret : String = "getSquareMemberRelation_args(";
    var first : Bool = true;
