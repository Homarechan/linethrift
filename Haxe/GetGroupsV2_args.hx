        ...
        switch (field.id)
        {
          case GROUPIDS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1209 = iprot.readListBegin();
                this.groupIds = new List< String>();
                for( _i1210 in 0 ... _list1209.size)
                {
                  var _elem1211 : String;
                  _elem1211 = iprot.readString();
                  this.groupIds.add(_elem1211);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.groupIds != null) {
        oprot.writeFieldBegin(GROUP_IDS_FIELD_DESC);
        {
          ...
          for( elem1212 in this.groupIds)
          {
            oprot.writeString(elem1212);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
