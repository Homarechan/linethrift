...
class TalkServiceProcessor implements TProcessor {
  ...
  public function new( iface : TalkService)
  {
    ...
    PROCESS_MAP.set("searchCollection", searchCollection());
    ...
    PROCESS_MAP.set("updateProfileAttributes", updateProfileAttributes());
  ...
  private function searchCollection() : Int->TProtocol->TProtocol->Void {
    return function( seqid : Int, iprot : TProtocol, oprot : TProtocol) : Void
    {
      var args : SearchCollection_args = new SearchCollection_args();
      args.read(iprot);
      iprot.readMessageEnd();
      var result : SearchCollection_result = new SearchCollection_result();
      try {
        result.success = TalkService_iface_.searchCollection(args.query, args.param);
      } catch (e:TalkException) {
        result.e = e;
      } catch (th : Dynamic) {
        trace("Internal error processing searchCollection", th);
        var x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing searchCollection");
        oprot.writeMessageBegin(new TMessage("searchCollection", TMessageType.EXCEPTION, seqid));
        x.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
        return;
      }
      oprot.writeMessageBegin(new TMessage("searchCollection", TMessageType.REPLY, seqid));
      result.write(oprot);
      oprot.writeMessageEnd();
      oprot.getTransport().flush();
    }
  ...
  private function updateProfileAttributes() : Int->TProtocol->TProtocol->Void {
    return function( seqid : Int, iprot : TProtocol, oprot : TProtocol) : Void
    {
      var args : UpdateProfileAttributes_args = new UpdateProfileAttributes_args();
      args.read(iprot);
      iprot.readMessageEnd();
      var result : UpdateProfileAttributes_result = new UpdateProfileAttributes_result();
      try {
        TalkService_iface_.updateProfileAttributes(args.reqSeq, args.request);
      } catch (th : Dynamic) {
        trace("Internal error processing updateProfileAttributes", th);
        var x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing updateProfileAttributes");
        oprot.writeMessageBegin(new TMessage("updateProfileAttributes", TMessageType.EXCEPTION, seqid));
        x.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
        return;
      }
      oprot.writeMessageBegin(new TMessage("updateProfileAttributes", TMessageType.REPLY, seqid));
      result.write(oprot);
      oprot.writeMessageEnd();
      oprot.getTransport().flush();
    }
