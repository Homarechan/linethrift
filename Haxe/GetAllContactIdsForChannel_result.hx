...
class GetAllContactIdsForChannel_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetAllContactIdsForChannel_result"); };
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1548 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1549 in 0 ... _list1548.size)
                {
                  var _elem1550 : String;
                  _elem1550 = iprot.readString();
                  this.success.add(_elem1550);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1551 in this.success)
          {
            oprot.writeString(elem1551);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetAllContactIdsForChannel_result(";
    var first : Bool = true;
