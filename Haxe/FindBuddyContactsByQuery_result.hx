...
class FindBuddyContactsByQuery_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("FindBuddyContactsByQuery_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< BuddySearchResult>;
  @:isVar
  ...
  public function get_success() : List< BuddySearchResult> {
    return this.success;
  }

  public function set_success(success:List< BuddySearchResult>) : List< BuddySearchResult> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list705 = iprot.readListBegin();
                this.success = new List< BuddySearchResult>();
                for( _i706 in 0 ... _list705.size)
                {
                  var _elem707 : BuddySearchResult;
                  _elem707 = new BuddySearchResult();
                  _elem707.read(iprot);
                  this.success.add(_elem707);
                }
                iprot.readListEnd();
              }
            } else { 
  ...
  public function toString() : String {
    var ret : String = "FindBuddyContactsByQuery_result(";
    var first : Bool = true;
