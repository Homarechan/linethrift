        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list809 = iprot.readListBegin();
                this.success = new List< BuddySearchResult>();
                for( _i810 in 0 ... _list809.size)
                {
                  var _elem811 : BuddySearchResult;
                  _elem811 = new BuddySearchResult();
                  _elem811.read(iprot);
                  this.success.add(_elem811);
                }
                iprot.readListEnd();
              }
            } else { 
