...
class GetProfileForChannel_result implements TBase {
  ...
  public function get_success() : Profile {
    return this.success;
  }

  public function set_success(success:Profile) : Profile {
  ...
  public function toString() : String {
    var ret : String = "GetProfileForChannel_result(";
    var first : Bool = true;
