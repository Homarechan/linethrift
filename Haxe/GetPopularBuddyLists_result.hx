...
class GetPopularBuddyLists_result implements TBase {
  ...
  public function get_success() : List< BuddyList> {
    return this.success;
  }

  public function set_success(success:List< BuddyList>) : List< BuddyList> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list724 = iprot.readListBegin();
                this.success = new List< BuddyList>();
                for( _i725 in 0 ... _list724.size)
                {
                  var _elem726 : BuddyList;
                  _elem726 = new BuddyList();
                  _elem726.read(iprot);
  ...
  public function toString() : String {
    var ret : String = "GetPopularBuddyLists_result(";
    var first : Bool = true;
