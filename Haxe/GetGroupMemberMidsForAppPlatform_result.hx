...
class GetGroupMemberMidsForAppPlatform_result implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("GetGroupMemberMidsForAppPlatform_result"); };
  static var SUCCESS_FIELD_DESC = { new TField("success", TType.LIST, 0); };
  static var E_FIELD_DESC = { new TField("e", TType.STRUCT, 1); };

  @:isVar
  public var success(get,set) : List< String>;
  @:isVar
  ...
  public function get_success() : List< String> {
    return this.success;
  }

  public function set_success(success:List< String>) : List< String> {
        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1506 = iprot.readListBegin();
                this.success = new List< String>();
                for( _i1507 in 0 ... _list1506.size)
                {
                  var _elem1508 : String;
                  _elem1508 = iprot.readString();
                  this.success.add(_elem1508);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for( elem1509 in this.success)
          {
            oprot.writeString(elem1509);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  public function toString() : String {
    var ret : String = "GetGroupMemberMidsForAppPlatform_result(";
    var first : Bool = true;
