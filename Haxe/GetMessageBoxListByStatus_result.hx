        ...
        switch (field.id)
        {
          case SUCCESS_FIELD_ID:
            if (field.type == TType.LIST) {
              {
                var _list1173 = iprot.readListBegin();
                this.success = new List< TMessageBox>();
                for( _i1174 in 0 ... _list1173.size)
                {
                  var _elem1175 : TMessageBox;
                  _elem1175 = new TMessageBox();
                  _elem1175.read(iprot);
                  this.success.add(_elem1175);
                }
                iprot.readListEnd();
              }
            } else { 
