        ...
        switch (field.id)
        {
          ...
          case CONTENTMETADATA_FIELD_ID:
            if (field.type == TType.MAP) {
              {
                var _map160 = iprot.readMapBegin();
                this.contentMetadata = new StringMap< String>();
                for( _i161 in 0 ... _map160.size)
                {
                  var _key162 : String;
                  var _val163 : String;
                  _key162 = iprot.readString();
                  _val163 = iprot.readString();
                  this.contentMetadata.set( _key162, _val163);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (this.contentMetadata != null) {
        oprot.writeFieldBegin(CONTENT_METADATA_FIELD_DESC);
        {
          ...
          for( _key164 in this.contentMetadata) {
            _sizeCounter165++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter165));
          for( elem166 in this.contentMetadata.keys())
          {
            oprot.writeString(elem166);
            oprot.writeString(this.contentMetadata.get(elem166));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
