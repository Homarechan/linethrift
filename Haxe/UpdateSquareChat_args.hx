...
class UpdateSquareChat_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("updateSquareChat_args"); };
  static var REQUEST_FIELD_DESC = { new TField("request", TType.STRUCT, 1); };

  @:isVar
  public var request(get,set) : UpdateSquareChatRequest;
  ...
  public function get_request() : UpdateSquareChatRequest {
    return this.request;
  }

  public function set_request(request:UpdateSquareChatRequest) : UpdateSquareChatRequest {
  ...
  public function toString() : String {
    var ret : String = "updateSquareChat_args(";
    var first : Bool = true;
