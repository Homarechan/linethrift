...
class FindContactByUseridWithoutAbuseBlockForChannel_args implements TBase {
  ...
  static var STRUCT_DESC = { new TStruct("findContactByUseridWithoutAbuseBlockForChannel_args"); };
  ...
  public function toString() : String {
    var ret : String = "findContactByUseridWithoutAbuseBlockForChannel_args(";
    var first : Bool = true;
