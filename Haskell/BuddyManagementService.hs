...
from_AddBuddyMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4188 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4188))) $ addBuddyMember_args_requestId record
  , (\_v4188 -> P.Just (2, ("userMid",T.TString $ E.encodeUtf8 _v4188))) $ addBuddyMember_args_userMid record
  ]
...
to_AddBuddyMember_args (T.TStruct fields) = AddBuddyMember_args{
  addBuddyMember_args_requestId = P.maybe (addBuddyMember_args_requestId default_AddBuddyMember_args) (\(_,_val4190) -> (case _val4190 of {T.TString _val4191 -> E.decodeUtf8 _val4191; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  addBuddyMember_args_userMid = P.maybe (addBuddyMember_args_userMid default_AddBuddyMember_args) (\(_,_val4190) -> (case _val4190 of {T.TString _val4192 -> E.decodeUtf8 _val4192; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_AddBuddyMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4195 -> (1, ("e",from_TalkException _v4195))) <$> addBuddyMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4195 -> (1, ("e",from_TalkException _v4195))) <$> addBuddyMember_result_e record
    ]
    )
...
to_AddBuddyMember_result (T.TStruct fields) = AddBuddyMember_result{
  addBuddyMember_result_e = P.maybe (P.Nothing) (\(_,_val4197) -> P.Just (case _val4197 of {T.TStruct _val4198 -> (to_TalkException (T.TStruct _val4198)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_AddBuddyMembers_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4201 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4201))) $ addBuddyMembers_args_requestId record
  , (\_v4201 -> P.Just (2, ("userMids",T.TList T.T_STRING $ P.map (\_v4203 -> T.TString $ E.encodeUtf8 _v4203) $ Vector.toList _v4201))) $ addBuddyMembers_args_userMids record
  ]
...
to_AddBuddyMembers_args (T.TStruct fields) = AddBuddyMembers_args{
  addBuddyMembers_args_requestId = P.maybe (addBuddyMembers_args_requestId default_AddBuddyMembers_args) (\(_,_val4205) -> (case _val4205 of {T.TString _val4206 -> E.decodeUtf8 _val4206; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  addBuddyMembers_args_userMids = P.maybe (addBuddyMembers_args_userMids default_AddBuddyMembers_args) (\(_,_val4205) -> (case _val4205 of {T.TList _ _val4207 -> (Vector.fromList $ P.map (\_v4208 -> (case _v4208 of {T.TString _val4209 -> E.decodeUtf8 _val4209; _ -> P.error "wrong type"})) _val4207); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_AddBuddyMembers_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4212 -> (1, ("e",from_TalkException _v4212))) <$> addBuddyMembers_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4212 -> (1, ("e",from_TalkException _v4212))) <$> addBuddyMembers_result_e record
    ]
    )
...
to_AddBuddyMembers_result (T.TStruct fields) = AddBuddyMembers_result{
  addBuddyMembers_result_e = P.maybe (P.Nothing) (\(_,_val4214) -> P.Just (case _val4214 of {T.TStruct _val4215 -> (to_TalkException (T.TStruct _val4215)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_BlockBuddyMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4218 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4218))) $ blockBuddyMember_args_requestId record
  , (\_v4218 -> P.Just (2, ("mid",T.TString $ E.encodeUtf8 _v4218))) $ blockBuddyMember_args_mid record
  ]
...
to_BlockBuddyMember_args (T.TStruct fields) = BlockBuddyMember_args{
  blockBuddyMember_args_requestId = P.maybe (blockBuddyMember_args_requestId default_BlockBuddyMember_args) (\(_,_val4220) -> (case _val4220 of {T.TString _val4221 -> E.decodeUtf8 _val4221; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  blockBuddyMember_args_mid = P.maybe (blockBuddyMember_args_mid default_BlockBuddyMember_args) (\(_,_val4220) -> (case _val4220 of {T.TString _val4222 -> E.decodeUtf8 _val4222; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_BlockBuddyMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4225 -> (1, ("e",from_TalkException _v4225))) <$> blockBuddyMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4225 -> (1, ("e",from_TalkException _v4225))) <$> blockBuddyMember_result_e record
    ]
    )
...
to_BlockBuddyMember_result (T.TStruct fields) = BlockBuddyMember_result{
  blockBuddyMember_result_e = P.maybe (P.Nothing) (\(_,_val4227) -> P.Just (case _val4227 of {T.TStruct _val4228 -> (to_TalkException (T.TStruct _val4228)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CommitSendMessagesToAll_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4231 -> P.Just (1, ("requestIdList",T.TList T.T_STRING $ P.map (\_v4233 -> T.TString $ E.encodeUtf8 _v4233) $ Vector.toList _v4231))) $ commitSendMessagesToAll_args_requestIdList record
  ]
...
to_CommitSendMessagesToAll_args (T.TStruct fields) = CommitSendMessagesToAll_args{
  commitSendMessagesToAll_args_requestIdList = P.maybe (commitSendMessagesToAll_args_requestIdList default_CommitSendMessagesToAll_args) (\(_,_val4235) -> (case _val4235 of {T.TList _ _val4236 -> (Vector.fromList $ P.map (\_v4237 -> (case _v4237 of {T.TString _val4238 -> E.decodeUtf8 _val4238; _ -> P.error "wrong type"})) _val4236); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CommitSendMessagesToAll_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4241 -> (1, ("e",from_TalkException _v4241))) <$> commitSendMessagesToAll_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4241 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_SendBuddyMessageResult) $ P.map (\_v4243 -> from_SendBuddyMessageResult _v4243) $ Vector.toList _v4241))) $ commitSendMessagesToAll_result_success record
    , (\_v4241 -> (1, ("e",from_TalkException _v4241))) <$> commitSendMessagesToAll_result_e record
    ]
    )
...
to_CommitSendMessagesToAll_result (T.TStruct fields) = CommitSendMessagesToAll_result{
  commitSendMessagesToAll_result_success = P.maybe (commitSendMessagesToAll_result_success default_CommitSendMessagesToAll_result) (\(_,_val4245) -> (case _val4245 of {T.TList _ _val4246 -> (Vector.fromList $ P.map (\_v4247 -> (case _v4247 of {T.TStruct _val4248 -> (to_SendBuddyMessageResult (T.TStruct _val4248)); _ -> P.error "wrong type"})) _val4246); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  commitSendMessagesToAll_result_e = P.maybe (P.Nothing) (\(_,_val4245) -> P.Just (case _val4245 of {T.TStruct _val4249 -> (to_TalkException (T.TStruct _val4249)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CommitSendMessagesToMids_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4252 -> P.Just (1, ("requestIdList",T.TList T.T_STRING $ P.map (\_v4254 -> T.TString $ E.encodeUtf8 _v4254) $ Vector.toList _v4252))) $ commitSendMessagesToMids_args_requestIdList record
  , (\_v4252 -> P.Just (2, ("mids",T.TList T.T_STRING $ P.map (\_v4256 -> T.TString $ E.encodeUtf8 _v4256) $ Vector.toList _v4252))) $ commitSendMessagesToMids_args_mids record
  ]
...
to_CommitSendMessagesToMids_args (T.TStruct fields) = CommitSendMessagesToMids_args{
  commitSendMessagesToMids_args_requestIdList = P.maybe (commitSendMessagesToMids_args_requestIdList default_CommitSendMessagesToMids_args) (\(_,_val4258) -> (case _val4258 of {T.TList _ _val4259 -> (Vector.fromList $ P.map (\_v4260 -> (case _v4260 of {T.TString _val4261 -> E.decodeUtf8 _val4261; _ -> P.error "wrong type"})) _val4259); _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  commitSendMessagesToMids_args_mids = P.maybe (commitSendMessagesToMids_args_mids default_CommitSendMessagesToMids_args) (\(_,_val4258) -> (case _val4258 of {T.TList _ _val4262 -> (Vector.fromList $ P.map (\_v4263 -> (case _v4263 of {T.TString _val4264 -> E.decodeUtf8 _val4264; _ -> P.error "wrong type"})) _val4262); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_CommitSendMessagesToMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4267 -> (1, ("e",from_TalkException _v4267))) <$> commitSendMessagesToMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4267 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_SendBuddyMessageResult) $ P.map (\_v4269 -> from_SendBuddyMessageResult _v4269) $ Vector.toList _v4267))) $ commitSendMessagesToMids_result_success record
    , (\_v4267 -> (1, ("e",from_TalkException _v4267))) <$> commitSendMessagesToMids_result_e record
    ]
    )
...
to_CommitSendMessagesToMids_result (T.TStruct fields) = CommitSendMessagesToMids_result{
  commitSendMessagesToMids_result_success = P.maybe (commitSendMessagesToMids_result_success default_CommitSendMessagesToMids_result) (\(_,_val4271) -> (case _val4271 of {T.TList _ _val4272 -> (Vector.fromList $ P.map (\_v4273 -> (case _v4273 of {T.TStruct _val4274 -> (to_SendBuddyMessageResult (T.TStruct _val4274)); _ -> P.error "wrong type"})) _val4272); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  commitSendMessagesToMids_result_e = P.maybe (P.Nothing) (\(_,_val4271) -> P.Just (case _val4271 of {T.TStruct _val4275 -> (to_TalkException (T.TStruct _val4275)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ContainsBuddyMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4278 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4278))) $ containsBuddyMember_args_requestId record
  , (\_v4278 -> P.Just (2, ("userMid",T.TString $ E.encodeUtf8 _v4278))) $ containsBuddyMember_args_userMid record
  ]
...
to_ContainsBuddyMember_args (T.TStruct fields) = ContainsBuddyMember_args{
  containsBuddyMember_args_requestId = P.maybe (containsBuddyMember_args_requestId default_ContainsBuddyMember_args) (\(_,_val4280) -> (case _val4280 of {T.TString _val4281 -> E.decodeUtf8 _val4281; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  containsBuddyMember_args_userMid = P.maybe (containsBuddyMember_args_userMid default_ContainsBuddyMember_args) (\(_,_val4280) -> (case _val4280 of {T.TString _val4282 -> E.decodeUtf8 _val4282; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_ContainsBuddyMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4285 -> (1, ("e",from_TalkException _v4285))) <$> containsBuddyMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4285 -> P.Just (0, ("success",T.TBool _v4285))) $ containsBuddyMember_result_success record
    , (\_v4285 -> (1, ("e",from_TalkException _v4285))) <$> containsBuddyMember_result_e record
    ]
    )
...
to_ContainsBuddyMember_result (T.TStruct fields) = ContainsBuddyMember_result{
  containsBuddyMember_result_success = P.maybe (containsBuddyMember_result_success default_ContainsBuddyMember_result) (\(_,_val4287) -> (case _val4287 of {T.TBool _val4288 -> _val4288; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  containsBuddyMember_result_e = P.maybe (P.Nothing) (\(_,_val4287) -> P.Just (case _val4287 of {T.TStruct _val4289 -> (to_TalkException (T.TStruct _val4289)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadMessageContent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4292 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4292))) $ downloadMessageContent_args_requestId record
  , (\_v4292 -> P.Just (2, ("messageId",T.TString $ E.encodeUtf8 _v4292))) $ downloadMessageContent_args_messageId record
  ]
...
to_DownloadMessageContent_args (T.TStruct fields) = DownloadMessageContent_args{
  downloadMessageContent_args_requestId = P.maybe (downloadMessageContent_args_requestId default_DownloadMessageContent_args) (\(_,_val4294) -> (case _val4294 of {T.TString _val4295 -> E.decodeUtf8 _val4295; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  downloadMessageContent_args_messageId = P.maybe (downloadMessageContent_args_messageId default_DownloadMessageContent_args) (\(_,_val4294) -> (case _val4294 of {T.TString _val4296 -> E.decodeUtf8 _val4296; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_DownloadMessageContent_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4299 -> (1, ("e",from_TalkException _v4299))) <$> downloadMessageContent_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4299 -> P.Just (0, ("success",T.TBinary _v4299))) $ downloadMessageContent_result_success record
    , (\_v4299 -> (1, ("e",from_TalkException _v4299))) <$> downloadMessageContent_result_e record
    ]
    )
...
to_DownloadMessageContent_result (T.TStruct fields) = DownloadMessageContent_result{
  downloadMessageContent_result_success = P.maybe (downloadMessageContent_result_success default_DownloadMessageContent_result) (\(_,_val4301) -> (case _val4301 of {T.TBinary _val4302 -> _val4302; T.TString _val4302 -> _val4302; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  downloadMessageContent_result_e = P.maybe (P.Nothing) (\(_,_val4301) -> P.Just (case _val4301 of {T.TStruct _val4303 -> (to_TalkException (T.TStruct _val4303)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadMessageContentPreview_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4306 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4306))) $ downloadMessageContentPreview_args_requestId record
  , (\_v4306 -> P.Just (2, ("messageId",T.TString $ E.encodeUtf8 _v4306))) $ downloadMessageContentPreview_args_messageId record
  ]
...
to_DownloadMessageContentPreview_args (T.TStruct fields) = DownloadMessageContentPreview_args{
  downloadMessageContentPreview_args_requestId = P.maybe (downloadMessageContentPreview_args_requestId default_DownloadMessageContentPreview_args) (\(_,_val4308) -> (case _val4308 of {T.TString _val4309 -> E.decodeUtf8 _val4309; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  downloadMessageContentPreview_args_messageId = P.maybe (downloadMessageContentPreview_args_messageId default_DownloadMessageContentPreview_args) (\(_,_val4308) -> (case _val4308 of {T.TString _val4310 -> E.decodeUtf8 _val4310; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_DownloadMessageContentPreview_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4313 -> (1, ("e",from_TalkException _v4313))) <$> downloadMessageContentPreview_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4313 -> P.Just (0, ("success",T.TBinary _v4313))) $ downloadMessageContentPreview_result_success record
    , (\_v4313 -> (1, ("e",from_TalkException _v4313))) <$> downloadMessageContentPreview_result_e record
    ]
    )
...
to_DownloadMessageContentPreview_result (T.TStruct fields) = DownloadMessageContentPreview_result{
  downloadMessageContentPreview_result_success = P.maybe (downloadMessageContentPreview_result_success default_DownloadMessageContentPreview_result) (\(_,_val4315) -> (case _val4315 of {T.TBinary _val4316 -> _val4316; T.TString _val4316 -> _val4316; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  downloadMessageContentPreview_result_e = P.maybe (P.Nothing) (\(_,_val4315) -> P.Just (case _val4315 of {T.TStruct _val4317 -> (to_TalkException (T.TStruct _val4317)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadProfileImage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4320 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4320))) $ downloadProfileImage_args_requestId record
  ]
...
to_DownloadProfileImage_args (T.TStruct fields) = DownloadProfileImage_args{
  downloadProfileImage_args_requestId = P.maybe (downloadProfileImage_args_requestId default_DownloadProfileImage_args) (\(_,_val4322) -> (case _val4322 of {T.TString _val4323 -> E.decodeUtf8 _val4323; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadProfileImage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4326 -> (1, ("e",from_TalkException _v4326))) <$> downloadProfileImage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4326 -> P.Just (0, ("success",T.TBinary _v4326))) $ downloadProfileImage_result_success record
    , (\_v4326 -> (1, ("e",from_TalkException _v4326))) <$> downloadProfileImage_result_e record
    ]
    )
...
to_DownloadProfileImage_result (T.TStruct fields) = DownloadProfileImage_result{
  downloadProfileImage_result_success = P.maybe (downloadProfileImage_result_success default_DownloadProfileImage_result) (\(_,_val4328) -> (case _val4328 of {T.TBinary _val4329 -> _val4329; T.TString _val4329 -> _val4329; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  downloadProfileImage_result_e = P.maybe (P.Nothing) (\(_,_val4328) -> P.Just (case _val4328 of {T.TStruct _val4330 -> (to_TalkException (T.TStruct _val4330)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadProfileImagePreview_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4333 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4333))) $ downloadProfileImagePreview_args_requestId record
  ]
...
to_DownloadProfileImagePreview_args (T.TStruct fields) = DownloadProfileImagePreview_args{
  downloadProfileImagePreview_args_requestId = P.maybe (downloadProfileImagePreview_args_requestId default_DownloadProfileImagePreview_args) (\(_,_val4335) -> (case _val4335 of {T.TString _val4336 -> E.decodeUtf8 _val4336; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DownloadProfileImagePreview_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4339 -> (1, ("e",from_TalkException _v4339))) <$> downloadProfileImagePreview_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4339 -> P.Just (0, ("success",T.TBinary _v4339))) $ downloadProfileImagePreview_result_success record
    , (\_v4339 -> (1, ("e",from_TalkException _v4339))) <$> downloadProfileImagePreview_result_e record
    ]
    )
...
to_DownloadProfileImagePreview_result (T.TStruct fields) = DownloadProfileImagePreview_result{
  downloadProfileImagePreview_result_success = P.maybe (downloadProfileImagePreview_result_success default_DownloadProfileImagePreview_result) (\(_,_val4341) -> (case _val4341 of {T.TBinary _val4342 -> _val4342; T.TString _val4342 -> _val4342; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  downloadProfileImagePreview_result_e = P.maybe (P.Nothing) (\(_,_val4341) -> P.Just (case _val4341 of {T.TStruct _val4343 -> (to_TalkException (T.TStruct _val4343)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActiveMemberCountByBuddyMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4346 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4346))) $ getActiveMemberCountByBuddyMid_args_buddyMid record
  ]
...
to_GetActiveMemberCountByBuddyMid_args (T.TStruct fields) = GetActiveMemberCountByBuddyMid_args{
  getActiveMemberCountByBuddyMid_args_buddyMid = P.maybe (getActiveMemberCountByBuddyMid_args_buddyMid default_GetActiveMemberCountByBuddyMid_args) (\(_,_val4348) -> (case _val4348 of {T.TString _val4349 -> E.decodeUtf8 _val4349; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetActiveMemberCountByBuddyMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4352 -> (1, ("e",from_TalkException _v4352))) <$> getActiveMemberCountByBuddyMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4352 -> P.Just (0, ("success",T.TI64 _v4352))) $ getActiveMemberCountByBuddyMid_result_success record
    , (\_v4352 -> (1, ("e",from_TalkException _v4352))) <$> getActiveMemberCountByBuddyMid_result_e record
    ]
    )
...
to_GetActiveMemberCountByBuddyMid_result (T.TStruct fields) = GetActiveMemberCountByBuddyMid_result{
  getActiveMemberCountByBuddyMid_result_success = P.maybe (getActiveMemberCountByBuddyMid_result_success default_GetActiveMemberCountByBuddyMid_result) (\(_,_val4354) -> (case _val4354 of {T.TI64 _val4355 -> _val4355; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActiveMemberCountByBuddyMid_result_e = P.maybe (P.Nothing) (\(_,_val4354) -> P.Just (case _val4354 of {T.TStruct _val4356 -> (to_TalkException (T.TStruct _val4356)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActiveMemberMidsByBuddyMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4359 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4359))) $ getActiveMemberMidsByBuddyMid_args_buddyMid record
  ]
...
to_GetActiveMemberMidsByBuddyMid_args (T.TStruct fields) = GetActiveMemberMidsByBuddyMid_args{
  getActiveMemberMidsByBuddyMid_args_buddyMid = P.maybe (getActiveMemberMidsByBuddyMid_args_buddyMid default_GetActiveMemberMidsByBuddyMid_args) (\(_,_val4361) -> (case _val4361 of {T.TString _val4362 -> E.decodeUtf8 _val4362; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetActiveMemberMidsByBuddyMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4365 -> (1, ("e",from_TalkException _v4365))) <$> getActiveMemberMidsByBuddyMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4365 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v4367 -> T.TString $ E.encodeUtf8 _v4367) $ Vector.toList _v4365))) $ getActiveMemberMidsByBuddyMid_result_success record
    , (\_v4365 -> (1, ("e",from_TalkException _v4365))) <$> getActiveMemberMidsByBuddyMid_result_e record
    ]
    )
...
to_GetActiveMemberMidsByBuddyMid_result (T.TStruct fields) = GetActiveMemberMidsByBuddyMid_result{
  getActiveMemberMidsByBuddyMid_result_success = P.maybe (getActiveMemberMidsByBuddyMid_result_success default_GetActiveMemberMidsByBuddyMid_result) (\(_,_val4369) -> (case _val4369 of {T.TList _ _val4370 -> (Vector.fromList $ P.map (\_v4371 -> (case _v4371 of {T.TString _val4372 -> E.decodeUtf8 _val4372; _ -> P.error "wrong type"})) _val4370); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActiveMemberMidsByBuddyMid_result_e = P.maybe (P.Nothing) (\(_,_val4369) -> P.Just (case _val4369 of {T.TStruct _val4373 -> (to_TalkException (T.TStruct _val4373)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetAllBuddyMembers_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4381 -> (1, ("e",from_TalkException _v4381))) <$> getAllBuddyMembers_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4381 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v4383 -> T.TString $ E.encodeUtf8 _v4383) $ Vector.toList _v4381))) $ getAllBuddyMembers_result_success record
    , (\_v4381 -> (1, ("e",from_TalkException _v4381))) <$> getAllBuddyMembers_result_e record
    ]
    )
...
to_GetAllBuddyMembers_result (T.TStruct fields) = GetAllBuddyMembers_result{
  getAllBuddyMembers_result_success = P.maybe (getAllBuddyMembers_result_success default_GetAllBuddyMembers_result) (\(_,_val4385) -> (case _val4385 of {T.TList _ _val4386 -> (Vector.fromList $ P.map (\_v4387 -> (case _v4387 of {T.TString _val4388 -> E.decodeUtf8 _val4388; _ -> P.error "wrong type"})) _val4386); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getAllBuddyMembers_result_e = P.maybe (P.Nothing) (\(_,_val4385) -> P.Just (case _val4385 of {T.TStruct _val4389 -> (to_TalkException (T.TStruct _val4389)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBlockedBuddyMembers_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4397 -> (1, ("e",from_TalkException _v4397))) <$> getBlockedBuddyMembers_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4397 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v4399 -> T.TString $ E.encodeUtf8 _v4399) $ Vector.toList _v4397))) $ getBlockedBuddyMembers_result_success record
    , (\_v4397 -> (1, ("e",from_TalkException _v4397))) <$> getBlockedBuddyMembers_result_e record
    ]
    )
...
to_GetBlockedBuddyMembers_result (T.TStruct fields) = GetBlockedBuddyMembers_result{
  getBlockedBuddyMembers_result_success = P.maybe (getBlockedBuddyMembers_result_success default_GetBlockedBuddyMembers_result) (\(_,_val4401) -> (case _val4401 of {T.TList _ _val4402 -> (Vector.fromList $ P.map (\_v4403 -> (case _v4403 of {T.TString _val4404 -> E.decodeUtf8 _val4404; _ -> P.error "wrong type"})) _val4402); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBlockedBuddyMembers_result_e = P.maybe (P.Nothing) (\(_,_val4401) -> P.Just (case _val4401 of {T.TStruct _val4405 -> (to_TalkException (T.TStruct _val4405)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBlockerCountByBuddyMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4408 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4408))) $ getBlockerCountByBuddyMid_args_buddyMid record
  ]
...
to_GetBlockerCountByBuddyMid_args (T.TStruct fields) = GetBlockerCountByBuddyMid_args{
  getBlockerCountByBuddyMid_args_buddyMid = P.maybe (getBlockerCountByBuddyMid_args_buddyMid default_GetBlockerCountByBuddyMid_args) (\(_,_val4410) -> (case _val4410 of {T.TString _val4411 -> E.decodeUtf8 _val4411; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetBlockerCountByBuddyMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4414 -> (1, ("e",from_TalkException _v4414))) <$> getBlockerCountByBuddyMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4414 -> P.Just (0, ("success",T.TI64 _v4414))) $ getBlockerCountByBuddyMid_result_success record
    , (\_v4414 -> (1, ("e",from_TalkException _v4414))) <$> getBlockerCountByBuddyMid_result_e record
    ]
    )
...
to_GetBlockerCountByBuddyMid_result (T.TStruct fields) = GetBlockerCountByBuddyMid_result{
  getBlockerCountByBuddyMid_result_success = P.maybe (getBlockerCountByBuddyMid_result_success default_GetBlockerCountByBuddyMid_result) (\(_,_val4416) -> (case _val4416 of {T.TI64 _val4417 -> _val4417; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBlockerCountByBuddyMid_result_e = P.maybe (P.Nothing) (\(_,_val4416) -> P.Just (case _val4416 of {T.TStruct _val4418 -> (to_TalkException (T.TStruct _val4418)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyDetailByMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4421 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4421))) $ getBuddyDetailByMid_args_buddyMid record
  ]
...
to_GetBuddyDetailByMid_args (T.TStruct fields) = GetBuddyDetailByMid_args{
  getBuddyDetailByMid_args_buddyMid = P.maybe (getBuddyDetailByMid_args_buddyMid default_GetBuddyDetailByMid_args) (\(_,_val4423) -> (case _val4423 of {T.TString _val4424 -> E.decodeUtf8 _val4424; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetBuddyDetailByMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4427 -> (1, ("e",from_TalkException _v4427))) <$> getBuddyDetailByMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4427 -> P.Just (0, ("success",from_BuddyDetail _v4427))) $ getBuddyDetailByMid_result_success record
    , (\_v4427 -> (1, ("e",from_TalkException _v4427))) <$> getBuddyDetailByMid_result_e record
    ]
    )
...
to_GetBuddyDetailByMid_result (T.TStruct fields) = GetBuddyDetailByMid_result{
  getBuddyDetailByMid_result_success = P.maybe (getBuddyDetailByMid_result_success default_GetBuddyDetailByMid_result) (\(_,_val4429) -> (case _val4429 of {T.TStruct _val4430 -> (to_BuddyDetail (T.TStruct _val4430)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyDetailByMid_result_e = P.maybe (P.Nothing) (\(_,_val4429) -> P.Just (case _val4429 of {T.TStruct _val4431 -> (to_TalkException (T.TStruct _val4431)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyProfile_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4439 -> (1, ("e",from_TalkException _v4439))) <$> getBuddyProfile_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4439 -> P.Just (0, ("success",from_BuddyProfile _v4439))) $ getBuddyProfile_result_success record
    , (\_v4439 -> (1, ("e",from_TalkException _v4439))) <$> getBuddyProfile_result_e record
    ]
    )
...
to_GetBuddyProfile_result (T.TStruct fields) = GetBuddyProfile_result{
  getBuddyProfile_result_success = P.maybe (getBuddyProfile_result_success default_GetBuddyProfile_result) (\(_,_val4441) -> (case _val4441 of {T.TStruct _val4442 -> (to_BuddyProfile (T.TStruct _val4442)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyProfile_result_e = P.maybe (P.Nothing) (\(_,_val4441) -> P.Just (case _val4441 of {T.TStruct _val4443 -> (to_TalkException (T.TStruct _val4443)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetContactTicket_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4451 -> (1, ("e",from_TalkException _v4451))) <$> getContactTicket_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4451 -> P.Just (0, ("success",from_Ticket _v4451))) $ getContactTicket_result_success record
    , (\_v4451 -> (1, ("e",from_TalkException _v4451))) <$> getContactTicket_result_e record
    ]
    )
...
to_GetContactTicket_result (T.TStruct fields) = GetContactTicket_result{
  getContactTicket_result_success = P.maybe (getContactTicket_result_success default_GetContactTicket_result) (\(_,_val4453) -> (case _val4453 of {T.TStruct _val4454 -> (to_Ticket (T.TStruct _val4454)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getContactTicket_result_e = P.maybe (P.Nothing) (\(_,_val4453) -> P.Just (case _val4453 of {T.TStruct _val4455 -> (to_TalkException (T.TStruct _val4455)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetMemberCountByBuddyMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4458 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4458))) $ getMemberCountByBuddyMid_args_buddyMid record
  ]
...
to_GetMemberCountByBuddyMid_args (T.TStruct fields) = GetMemberCountByBuddyMid_args{
  getMemberCountByBuddyMid_args_buddyMid = P.maybe (getMemberCountByBuddyMid_args_buddyMid default_GetMemberCountByBuddyMid_args) (\(_,_val4460) -> (case _val4460 of {T.TString _val4461 -> E.decodeUtf8 _val4461; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetMemberCountByBuddyMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4464 -> (1, ("e",from_TalkException _v4464))) <$> getMemberCountByBuddyMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4464 -> P.Just (0, ("success",T.TI64 _v4464))) $ getMemberCountByBuddyMid_result_success record
    , (\_v4464 -> (1, ("e",from_TalkException _v4464))) <$> getMemberCountByBuddyMid_result_e record
    ]
    )
...
to_GetMemberCountByBuddyMid_result (T.TStruct fields) = GetMemberCountByBuddyMid_result{
  getMemberCountByBuddyMid_result_success = P.maybe (getMemberCountByBuddyMid_result_success default_GetMemberCountByBuddyMid_result) (\(_,_val4466) -> (case _val4466 of {T.TI64 _val4467 -> _val4467; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getMemberCountByBuddyMid_result_e = P.maybe (P.Nothing) (\(_,_val4466) -> P.Just (case _val4466 of {T.TStruct _val4468 -> (to_TalkException (T.TStruct _val4468)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSendBuddyMessageResult_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4471 -> P.Just (1, ("sendBuddyMessageRequestId",T.TString $ E.encodeUtf8 _v4471))) $ getSendBuddyMessageResult_args_sendBuddyMessageRequestId record
  ]
...
to_GetSendBuddyMessageResult_args (T.TStruct fields) = GetSendBuddyMessageResult_args{
  getSendBuddyMessageResult_args_sendBuddyMessageRequestId = P.maybe (getSendBuddyMessageResult_args_sendBuddyMessageRequestId default_GetSendBuddyMessageResult_args) (\(_,_val4473) -> (case _val4473 of {T.TString _val4474 -> E.decodeUtf8 _val4474; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSendBuddyMessageResult_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4477 -> (1, ("e",from_TalkException _v4477))) <$> getSendBuddyMessageResult_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4477 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4477))) $ getSendBuddyMessageResult_result_success record
    , (\_v4477 -> (1, ("e",from_TalkException _v4477))) <$> getSendBuddyMessageResult_result_e record
    ]
    )
...
to_GetSendBuddyMessageResult_result (T.TStruct fields) = GetSendBuddyMessageResult_result{
  getSendBuddyMessageResult_result_success = P.maybe (getSendBuddyMessageResult_result_success default_GetSendBuddyMessageResult_result) (\(_,_val4479) -> (case _val4479 of {T.TStruct _val4480 -> (to_SendBuddyMessageResult (T.TStruct _val4480)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSendBuddyMessageResult_result_e = P.maybe (P.Nothing) (\(_,_val4479) -> P.Just (case _val4479 of {T.TStruct _val4481 -> (to_TalkException (T.TStruct _val4481)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSetBuddyOnAirResult_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4484 -> P.Just (1, ("setBuddyOnAirRequestId",T.TString $ E.encodeUtf8 _v4484))) $ getSetBuddyOnAirResult_args_setBuddyOnAirRequestId record
  ]
...
to_GetSetBuddyOnAirResult_args (T.TStruct fields) = GetSetBuddyOnAirResult_args{
  getSetBuddyOnAirResult_args_setBuddyOnAirRequestId = P.maybe (getSetBuddyOnAirResult_args_setBuddyOnAirRequestId default_GetSetBuddyOnAirResult_args) (\(_,_val4486) -> (case _val4486 of {T.TString _val4487 -> E.decodeUtf8 _val4487; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSetBuddyOnAirResult_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4490 -> (1, ("e",from_TalkException _v4490))) <$> getSetBuddyOnAirResult_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4490 -> P.Just (0, ("success",from_SetBuddyOnAirResult _v4490))) $ getSetBuddyOnAirResult_result_success record
    , (\_v4490 -> (1, ("e",from_TalkException _v4490))) <$> getSetBuddyOnAirResult_result_e record
    ]
    )
...
to_GetSetBuddyOnAirResult_result (T.TStruct fields) = GetSetBuddyOnAirResult_result{
  getSetBuddyOnAirResult_result_success = P.maybe (getSetBuddyOnAirResult_result_success default_GetSetBuddyOnAirResult_result) (\(_,_val4492) -> (case _val4492 of {T.TStruct _val4493 -> (to_SetBuddyOnAirResult (T.TStruct _val4493)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSetBuddyOnAirResult_result_e = P.maybe (P.Nothing) (\(_,_val4492) -> P.Just (case _val4492 of {T.TStruct _val4494 -> (to_TalkException (T.TStruct _val4494)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUpdateBuddyProfileResult_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4497 -> P.Just (1, ("updateBuddyProfileRequestId",T.TString $ E.encodeUtf8 _v4497))) $ getUpdateBuddyProfileResult_args_updateBuddyProfileRequestId record
  ]
...
to_GetUpdateBuddyProfileResult_args (T.TStruct fields) = GetUpdateBuddyProfileResult_args{
  getUpdateBuddyProfileResult_args_updateBuddyProfileRequestId = P.maybe (getUpdateBuddyProfileResult_args_updateBuddyProfileRequestId default_GetUpdateBuddyProfileResult_args) (\(_,_val4499) -> (case _val4499 of {T.TString _val4500 -> E.decodeUtf8 _val4500; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUpdateBuddyProfileResult_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4503 -> (1, ("e",from_TalkException _v4503))) <$> getUpdateBuddyProfileResult_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4503 -> P.Just (0, ("success",from_UpdateBuddyProfileResult _v4503))) $ getUpdateBuddyProfileResult_result_success record
    , (\_v4503 -> (1, ("e",from_TalkException _v4503))) <$> getUpdateBuddyProfileResult_result_e record
    ]
    )
...
to_GetUpdateBuddyProfileResult_result (T.TStruct fields) = GetUpdateBuddyProfileResult_result{
  getUpdateBuddyProfileResult_result_success = P.maybe (getUpdateBuddyProfileResult_result_success default_GetUpdateBuddyProfileResult_result) (\(_,_val4505) -> (case _val4505 of {T.TStruct _val4506 -> (to_UpdateBuddyProfileResult (T.TStruct _val4506)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUpdateBuddyProfileResult_result_e = P.maybe (P.Nothing) (\(_,_val4505) -> P.Just (case _val4505 of {T.TStruct _val4507 -> (to_TalkException (T.TStruct _val4507)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_IsBuddyOnAirByMid_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4510 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4510))) $ isBuddyOnAirByMid_args_buddyMid record
  ]
...
to_IsBuddyOnAirByMid_args (T.TStruct fields) = IsBuddyOnAirByMid_args{
  isBuddyOnAirByMid_args_buddyMid = P.maybe (isBuddyOnAirByMid_args_buddyMid default_IsBuddyOnAirByMid_args) (\(_,_val4512) -> (case _val4512 of {T.TString _val4513 -> E.decodeUtf8 _val4513; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_IsBuddyOnAirByMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4516 -> (1, ("e",from_TalkException _v4516))) <$> isBuddyOnAirByMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4516 -> P.Just (0, ("success",T.TBool _v4516))) $ isBuddyOnAirByMid_result_success record
    , (\_v4516 -> (1, ("e",from_TalkException _v4516))) <$> isBuddyOnAirByMid_result_e record
    ]
    )
...
to_IsBuddyOnAirByMid_result (T.TStruct fields) = IsBuddyOnAirByMid_result{
  isBuddyOnAirByMid_result_success = P.maybe (isBuddyOnAirByMid_result_success default_IsBuddyOnAirByMid_result) (\(_,_val4518) -> (case _val4518 of {T.TBool _val4519 -> _val4519; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  isBuddyOnAirByMid_result_e = P.maybe (P.Nothing) (\(_,_val4518) -> P.Just (case _val4518 of {T.TStruct _val4520 -> (to_TalkException (T.TStruct _val4520)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_LinkAndSendBuddyContentMessageToAllAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4523 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4523))) $ linkAndSendBuddyContentMessageToAllAsync_args_requestId record
  , (\_v4523 -> P.Just (2, ("msg",from_Message _v4523))) $ linkAndSendBuddyContentMessageToAllAsync_args_msg record
  , (\_v4523 -> P.Just (3, ("sourceContentId",T.TString $ E.encodeUtf8 _v4523))) $ linkAndSendBuddyContentMessageToAllAsync_args_sourceContentId record
  ]
...
to_LinkAndSendBuddyContentMessageToAllAsync_args (T.TStruct fields) = LinkAndSendBuddyContentMessageToAllAsync_args{
  linkAndSendBuddyContentMessageToAllAsync_args_requestId = P.maybe (linkAndSendBuddyContentMessageToAllAsync_args_requestId default_LinkAndSendBuddyContentMessageToAllAsync_args) (\(_,_val4525) -> (case _val4525 of {T.TString _val4526 -> E.decodeUtf8 _val4526; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  linkAndSendBuddyContentMessageToAllAsync_args_msg = P.maybe (linkAndSendBuddyContentMessageToAllAsync_args_msg default_LinkAndSendBuddyContentMessageToAllAsync_args) (\(_,_val4525) -> (case _val4525 of {T.TStruct _val4527 -> (to_Message (T.TStruct _val4527)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  linkAndSendBuddyContentMessageToAllAsync_args_sourceContentId = P.maybe (linkAndSendBuddyContentMessageToAllAsync_args_sourceContentId default_LinkAndSendBuddyContentMessageToAllAsync_args) (\(_,_val4525) -> (case _val4525 of {T.TString _val4528 -> E.decodeUtf8 _val4528; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_LinkAndSendBuddyContentMessageToAllAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4531 -> (1, ("e",from_TalkException _v4531))) <$> linkAndSendBuddyContentMessageToAllAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4531 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4531))) $ linkAndSendBuddyContentMessageToAllAsync_result_success record
    , (\_v4531 -> (1, ("e",from_TalkException _v4531))) <$> linkAndSendBuddyContentMessageToAllAsync_result_e record
    ]
    )
...
to_LinkAndSendBuddyContentMessageToAllAsync_result (T.TStruct fields) = LinkAndSendBuddyContentMessageToAllAsync_result{
  linkAndSendBuddyContentMessageToAllAsync_result_success = P.maybe (linkAndSendBuddyContentMessageToAllAsync_result_success default_LinkAndSendBuddyContentMessageToAllAsync_result) (\(_,_val4533) -> (case _val4533 of {T.TString _val4534 -> E.decodeUtf8 _val4534; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  linkAndSendBuddyContentMessageToAllAsync_result_e = P.maybe (P.Nothing) (\(_,_val4533) -> P.Just (case _val4533 of {T.TStruct _val4535 -> (to_TalkException (T.TStruct _val4535)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_LinkAndSendBuddyContentMessageToMids_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4538 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4538))) $ linkAndSendBuddyContentMessageToMids_args_requestId record
  , (\_v4538 -> P.Just (2, ("msg",from_Message _v4538))) $ linkAndSendBuddyContentMessageToMids_args_msg record
  , (\_v4538 -> P.Just (3, ("sourceContentId",T.TString $ E.encodeUtf8 _v4538))) $ linkAndSendBuddyContentMessageToMids_args_sourceContentId record
  , (\_v4538 -> P.Just (4, ("mids",T.TList T.T_STRING $ P.map (\_v4540 -> T.TString $ E.encodeUtf8 _v4540) $ Vector.toList _v4538))) $ linkAndSendBuddyContentMessageToMids_args_mids record
  ]
...
to_LinkAndSendBuddyContentMessageToMids_args (T.TStruct fields) = LinkAndSendBuddyContentMessageToMids_args{
  linkAndSendBuddyContentMessageToMids_args_requestId = P.maybe (linkAndSendBuddyContentMessageToMids_args_requestId default_LinkAndSendBuddyContentMessageToMids_args) (\(_,_val4542) -> (case _val4542 of {T.TString _val4543 -> E.decodeUtf8 _val4543; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  linkAndSendBuddyContentMessageToMids_args_msg = P.maybe (linkAndSendBuddyContentMessageToMids_args_msg default_LinkAndSendBuddyContentMessageToMids_args) (\(_,_val4542) -> (case _val4542 of {T.TStruct _val4544 -> (to_Message (T.TStruct _val4544)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  linkAndSendBuddyContentMessageToMids_args_sourceContentId = P.maybe (linkAndSendBuddyContentMessageToMids_args_sourceContentId default_LinkAndSendBuddyContentMessageToMids_args) (\(_,_val4542) -> (case _val4542 of {T.TString _val4545 -> E.decodeUtf8 _val4545; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  linkAndSendBuddyContentMessageToMids_args_mids = P.maybe (linkAndSendBuddyContentMessageToMids_args_mids default_LinkAndSendBuddyContentMessageToMids_args) (\(_,_val4542) -> (case _val4542 of {T.TList _ _val4546 -> (Vector.fromList $ P.map (\_v4547 -> (case _v4547 of {T.TString _val4548 -> E.decodeUtf8 _val4548; _ -> P.error "wrong type"})) _val4546); _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_LinkAndSendBuddyContentMessageToMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4551 -> (1, ("e",from_TalkException _v4551))) <$> linkAndSendBuddyContentMessageToMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4551 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4551))) $ linkAndSendBuddyContentMessageToMids_result_success record
    , (\_v4551 -> (1, ("e",from_TalkException _v4551))) <$> linkAndSendBuddyContentMessageToMids_result_e record
    ]
    )
...
to_LinkAndSendBuddyContentMessageToMids_result (T.TStruct fields) = LinkAndSendBuddyContentMessageToMids_result{
  linkAndSendBuddyContentMessageToMids_result_success = P.maybe (linkAndSendBuddyContentMessageToMids_result_success default_LinkAndSendBuddyContentMessageToMids_result) (\(_,_val4553) -> (case _val4553 of {T.TStruct _val4554 -> (to_SendBuddyMessageResult (T.TStruct _val4554)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  linkAndSendBuddyContentMessageToMids_result_e = P.maybe (P.Nothing) (\(_,_val4553) -> P.Just (case _val4553 of {T.TStruct _val4555 -> (to_TalkException (T.TStruct _val4555)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyBuddyBlocked_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4558 -> P.Just (1, ("buddyMid",T.TString $ E.encodeUtf8 _v4558))) $ notifyBuddyBlocked_args_buddyMid record
  , (\_v4558 -> P.Just (2, ("blockerMid",T.TString $ E.encodeUtf8 _v4558))) $ notifyBuddyBlocked_args_blockerMid record
  ]
...
to_NotifyBuddyBlocked_args (T.TStruct fields) = NotifyBuddyBlocked_args{
  notifyBuddyBlocked_args_buddyMid = P.maybe (notifyBuddyBlocked_args_buddyMid default_NotifyBuddyBlocked_args) (\(_,_val4560) -> (case _val4560 of {T.TString _val4561 -> E.decodeUtf8 _val4561; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  notifyBuddyBlocked_args_blockerMid = P.maybe (notifyBuddyBlocked_args_blockerMid default_NotifyBuddyBlocked_args) (\(_,_val4560) -> (case _val4560 of {T.TString _val4562 -> E.decodeUtf8 _val4562; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_NotifyBuddyBlocked_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4565 -> (1, ("e",from_TalkException _v4565))) <$> notifyBuddyBlocked_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4565 -> (1, ("e",from_TalkException _v4565))) <$> notifyBuddyBlocked_result_e record
    ]
    )
...
to_NotifyBuddyBlocked_result (T.TStruct fields) = NotifyBuddyBlocked_result{
  notifyBuddyBlocked_result_e = P.maybe (P.Nothing) (\(_,_val4567) -> P.Just (case _val4567 of {T.TStruct _val4568 -> (to_TalkException (T.TStruct _val4568)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyBuddyUnblocked_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4571 -> P.Just (1, ("buddyMid",T.TString $ E.encodeUtf8 _v4571))) $ notifyBuddyUnblocked_args_buddyMid record
  , (\_v4571 -> P.Just (2, ("blockerMid",T.TString $ E.encodeUtf8 _v4571))) $ notifyBuddyUnblocked_args_blockerMid record
  ]
...
to_NotifyBuddyUnblocked_args (T.TStruct fields) = NotifyBuddyUnblocked_args{
  notifyBuddyUnblocked_args_buddyMid = P.maybe (notifyBuddyUnblocked_args_buddyMid default_NotifyBuddyUnblocked_args) (\(_,_val4573) -> (case _val4573 of {T.TString _val4574 -> E.decodeUtf8 _val4574; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  notifyBuddyUnblocked_args_blockerMid = P.maybe (notifyBuddyUnblocked_args_blockerMid default_NotifyBuddyUnblocked_args) (\(_,_val4573) -> (case _val4573 of {T.TString _val4575 -> E.decodeUtf8 _val4575; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_NotifyBuddyUnblocked_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4578 -> (1, ("e",from_TalkException _v4578))) <$> notifyBuddyUnblocked_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4578 -> (1, ("e",from_TalkException _v4578))) <$> notifyBuddyUnblocked_result_e record
    ]
    )
...
to_NotifyBuddyUnblocked_result (T.TStruct fields) = NotifyBuddyUnblocked_result{
  notifyBuddyUnblocked_result_e = P.maybe (P.Nothing) (\(_,_val4580) -> P.Just (case _val4580 of {T.TStruct _val4581 -> (to_TalkException (T.TStruct _val4581)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RegisterBuddy_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4584 -> P.Just (2, ("buddyId",T.TString $ E.encodeUtf8 _v4584))) $ registerBuddy_args_buddyId record
  , (\_v4584 -> P.Just (3, ("searchId",T.TString $ E.encodeUtf8 _v4584))) $ registerBuddy_args_searchId record
  , (\_v4584 -> P.Just (4, ("displayName",T.TString $ E.encodeUtf8 _v4584))) $ registerBuddy_args_displayName record
  , (\_v4584 -> P.Just (5, ("statusMeessage",T.TString $ E.encodeUtf8 _v4584))) $ registerBuddy_args_statusMeessage record
  , (\_v4584 -> P.Just (6, ("picture",T.TBinary _v4584))) $ registerBuddy_args_picture record
  , (\_v4584 -> P.Just (7, ("settings",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k4585,_v4586) -> (T.TString $ E.encodeUtf8 _k4585, T.TString $ E.encodeUtf8 _v4586)) $ Map.toList _v4584))) $ registerBuddy_args_settings record
  ]
...
to_RegisterBuddy_args (T.TStruct fields) = RegisterBuddy_args{
  registerBuddy_args_buddyId = P.maybe (registerBuddy_args_buddyId default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TString _val4589 -> E.decodeUtf8 _val4589; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  registerBuddy_args_searchId = P.maybe (registerBuddy_args_searchId default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TString _val4590 -> E.decodeUtf8 _val4590; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  registerBuddy_args_displayName = P.maybe (registerBuddy_args_displayName default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TString _val4591 -> E.decodeUtf8 _val4591; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  registerBuddy_args_statusMeessage = P.maybe (registerBuddy_args_statusMeessage default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TString _val4592 -> E.decodeUtf8 _val4592; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  registerBuddy_args_picture = P.maybe (registerBuddy_args_picture default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TBinary _val4593 -> _val4593; T.TString _val4593 -> _val4593; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  registerBuddy_args_settings = P.maybe (registerBuddy_args_settings default_RegisterBuddy_args) (\(_,_val4588) -> (case _val4588 of {T.TMap _ _ _val4594 -> (Map.fromList $ P.map (\(_k4596,_v4595) -> ((case _k4596 of {T.TString _val4597 -> E.decodeUtf8 _val4597; _ -> P.error "wrong type"}),(case _v4595 of {T.TString _val4598 -> E.decodeUtf8 _val4598; _ -> P.error "wrong type"}))) _val4594); _ -> P.error "wrong type"})) (Map.lookup (7) fields)
  }
...
from_RegisterBuddy_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4601 -> (1, ("e",from_TalkException _v4601))) <$> registerBuddy_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4601 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4601))) $ registerBuddy_result_success record
    , (\_v4601 -> (1, ("e",from_TalkException _v4601))) <$> registerBuddy_result_e record
    ]
    )
...
to_RegisterBuddy_result (T.TStruct fields) = RegisterBuddy_result{
  registerBuddy_result_success = P.maybe (registerBuddy_result_success default_RegisterBuddy_result) (\(_,_val4603) -> (case _val4603 of {T.TString _val4604 -> E.decodeUtf8 _val4604; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  registerBuddy_result_e = P.maybe (P.Nothing) (\(_,_val4603) -> P.Just (case _val4603 of {T.TStruct _val4605 -> (to_TalkException (T.TStruct _val4605)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RegisterBuddyAdmin_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4608 -> P.Just (2, ("buddyId",T.TString $ E.encodeUtf8 _v4608))) $ registerBuddyAdmin_args_buddyId record
  , (\_v4608 -> P.Just (3, ("searchId",T.TString $ E.encodeUtf8 _v4608))) $ registerBuddyAdmin_args_searchId record
  , (\_v4608 -> P.Just (4, ("displayName",T.TString $ E.encodeUtf8 _v4608))) $ registerBuddyAdmin_args_displayName record
  , (\_v4608 -> P.Just (5, ("statusMessage",T.TString $ E.encodeUtf8 _v4608))) $ registerBuddyAdmin_args_statusMessage record
  , (\_v4608 -> P.Just (6, ("picture",T.TBinary _v4608))) $ registerBuddyAdmin_args_picture record
  ]
...
to_RegisterBuddyAdmin_args (T.TStruct fields) = RegisterBuddyAdmin_args{
  registerBuddyAdmin_args_buddyId = P.maybe (registerBuddyAdmin_args_buddyId default_RegisterBuddyAdmin_args) (\(_,_val4610) -> (case _val4610 of {T.TString _val4611 -> E.decodeUtf8 _val4611; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  registerBuddyAdmin_args_searchId = P.maybe (registerBuddyAdmin_args_searchId default_RegisterBuddyAdmin_args) (\(_,_val4610) -> (case _val4610 of {T.TString _val4612 -> E.decodeUtf8 _val4612; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  registerBuddyAdmin_args_displayName = P.maybe (registerBuddyAdmin_args_displayName default_RegisterBuddyAdmin_args) (\(_,_val4610) -> (case _val4610 of {T.TString _val4613 -> E.decodeUtf8 _val4613; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  registerBuddyAdmin_args_statusMessage = P.maybe (registerBuddyAdmin_args_statusMessage default_RegisterBuddyAdmin_args) (\(_,_val4610) -> (case _val4610 of {T.TString _val4614 -> E.decodeUtf8 _val4614; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  registerBuddyAdmin_args_picture = P.maybe (registerBuddyAdmin_args_picture default_RegisterBuddyAdmin_args) (\(_,_val4610) -> (case _val4610 of {T.TBinary _val4615 -> _val4615; T.TString _val4615 -> _val4615; _ -> P.error "wrong type"})) (Map.lookup (6) fields)
  }
...
from_RegisterBuddyAdmin_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4618 -> (1, ("e",from_TalkException _v4618))) <$> registerBuddyAdmin_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4618 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4618))) $ registerBuddyAdmin_result_success record
    , (\_v4618 -> (1, ("e",from_TalkException _v4618))) <$> registerBuddyAdmin_result_e record
    ]
    )
...
to_RegisterBuddyAdmin_result (T.TStruct fields) = RegisterBuddyAdmin_result{
  registerBuddyAdmin_result_success = P.maybe (registerBuddyAdmin_result_success default_RegisterBuddyAdmin_result) (\(_,_val4620) -> (case _val4620 of {T.TString _val4621 -> E.decodeUtf8 _val4621; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  registerBuddyAdmin_result_e = P.maybe (P.Nothing) (\(_,_val4620) -> P.Just (case _val4620 of {T.TStruct _val4622 -> (to_TalkException (T.TStruct _val4622)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ReissueContactTicket_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4625 -> P.Just (3, ("expirationTime",T.TI64 _v4625))) $ reissueContactTicket_args_expirationTime record
  , (\_v4625 -> P.Just (4, ("maxUseCount",T.TI32 _v4625))) $ reissueContactTicket_args_maxUseCount record
  ]
...
to_ReissueContactTicket_args (T.TStruct fields) = ReissueContactTicket_args{
  reissueContactTicket_args_expirationTime = P.maybe (reissueContactTicket_args_expirationTime default_ReissueContactTicket_args) (\(_,_val4627) -> (case _val4627 of {T.TI64 _val4628 -> _val4628; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  reissueContactTicket_args_maxUseCount = P.maybe (reissueContactTicket_args_maxUseCount default_ReissueContactTicket_args) (\(_,_val4627) -> (case _val4627 of {T.TI32 _val4629 -> _val4629; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_ReissueContactTicket_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4632 -> (1, ("e",from_TalkException _v4632))) <$> reissueContactTicket_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4632 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4632))) $ reissueContactTicket_result_success record
    , (\_v4632 -> (1, ("e",from_TalkException _v4632))) <$> reissueContactTicket_result_e record
    ]
    )
...
to_ReissueContactTicket_result (T.TStruct fields) = ReissueContactTicket_result{
  reissueContactTicket_result_success = P.maybe (reissueContactTicket_result_success default_ReissueContactTicket_result) (\(_,_val4634) -> (case _val4634 of {T.TString _val4635 -> E.decodeUtf8 _val4635; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  reissueContactTicket_result_e = P.maybe (P.Nothing) (\(_,_val4634) -> P.Just (case _val4634 of {T.TStruct _val4636 -> (to_TalkException (T.TStruct _val4636)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RemoveBuddyMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4639 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4639))) $ removeBuddyMember_args_requestId record
  , (\_v4639 -> P.Just (2, ("userMid",T.TString $ E.encodeUtf8 _v4639))) $ removeBuddyMember_args_userMid record
  ]
...
to_RemoveBuddyMember_args (T.TStruct fields) = RemoveBuddyMember_args{
  removeBuddyMember_args_requestId = P.maybe (removeBuddyMember_args_requestId default_RemoveBuddyMember_args) (\(_,_val4641) -> (case _val4641 of {T.TString _val4642 -> E.decodeUtf8 _val4642; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  removeBuddyMember_args_userMid = P.maybe (removeBuddyMember_args_userMid default_RemoveBuddyMember_args) (\(_,_val4641) -> (case _val4641 of {T.TString _val4643 -> E.decodeUtf8 _val4643; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_RemoveBuddyMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4646 -> (1, ("e",from_TalkException _v4646))) <$> removeBuddyMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4646 -> (1, ("e",from_TalkException _v4646))) <$> removeBuddyMember_result_e record
    ]
    )
...
to_RemoveBuddyMember_result (T.TStruct fields) = RemoveBuddyMember_result{
  removeBuddyMember_result_e = P.maybe (P.Nothing) (\(_,_val4648) -> P.Just (case _val4648 of {T.TStruct _val4649 -> (to_TalkException (T.TStruct _val4649)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RemoveBuddyMembers_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4652 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4652))) $ removeBuddyMembers_args_requestId record
  , (\_v4652 -> P.Just (2, ("userMids",T.TList T.T_STRING $ P.map (\_v4654 -> T.TString $ E.encodeUtf8 _v4654) $ Vector.toList _v4652))) $ removeBuddyMembers_args_userMids record
  ]
...
to_RemoveBuddyMembers_args (T.TStruct fields) = RemoveBuddyMembers_args{
  removeBuddyMembers_args_requestId = P.maybe (removeBuddyMembers_args_requestId default_RemoveBuddyMembers_args) (\(_,_val4656) -> (case _val4656 of {T.TString _val4657 -> E.decodeUtf8 _val4657; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  removeBuddyMembers_args_userMids = P.maybe (removeBuddyMembers_args_userMids default_RemoveBuddyMembers_args) (\(_,_val4656) -> (case _val4656 of {T.TList _ _val4658 -> (Vector.fromList $ P.map (\_v4659 -> (case _v4659 of {T.TString _val4660 -> E.decodeUtf8 _val4660; _ -> P.error "wrong type"})) _val4658); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_RemoveBuddyMembers_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4663 -> (1, ("e",from_TalkException _v4663))) <$> removeBuddyMembers_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4663 -> (1, ("e",from_TalkException _v4663))) <$> removeBuddyMembers_result_e record
    ]
    )
...
to_RemoveBuddyMembers_result (T.TStruct fields) = RemoveBuddyMembers_result{
  removeBuddyMembers_result_e = P.maybe (P.Nothing) (\(_,_val4665) -> P.Just (case _val4665 of {T.TStruct _val4666 -> (to_TalkException (T.TStruct _val4666)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyContentMessageToAll_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4669 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4669))) $ sendBuddyContentMessageToAll_args_requestId record
  , (\_v4669 -> P.Just (2, ("msg",from_Message _v4669))) $ sendBuddyContentMessageToAll_args_msg record
  , (\_v4669 -> P.Just (3, ("content",T.TBinary _v4669))) $ sendBuddyContentMessageToAll_args_content record
  ]
...
to_SendBuddyContentMessageToAll_args (T.TStruct fields) = SendBuddyContentMessageToAll_args{
  sendBuddyContentMessageToAll_args_requestId = P.maybe (sendBuddyContentMessageToAll_args_requestId default_SendBuddyContentMessageToAll_args) (\(_,_val4671) -> (case _val4671 of {T.TString _val4672 -> E.decodeUtf8 _val4672; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyContentMessageToAll_args_msg = P.maybe (sendBuddyContentMessageToAll_args_msg default_SendBuddyContentMessageToAll_args) (\(_,_val4671) -> (case _val4671 of {T.TStruct _val4673 -> (to_Message (T.TStruct _val4673)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyContentMessageToAll_args_content = P.maybe (sendBuddyContentMessageToAll_args_content default_SendBuddyContentMessageToAll_args) (\(_,_val4671) -> (case _val4671 of {T.TBinary _val4674 -> _val4674; T.TString _val4674 -> _val4674; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_SendBuddyContentMessageToAll_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4677 -> (1, ("e",from_TalkException _v4677))) <$> sendBuddyContentMessageToAll_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4677 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4677))) $ sendBuddyContentMessageToAll_result_success record
    , (\_v4677 -> (1, ("e",from_TalkException _v4677))) <$> sendBuddyContentMessageToAll_result_e record
    ]
    )
...
to_SendBuddyContentMessageToAll_result (T.TStruct fields) = SendBuddyContentMessageToAll_result{
  sendBuddyContentMessageToAll_result_success = P.maybe (sendBuddyContentMessageToAll_result_success default_SendBuddyContentMessageToAll_result) (\(_,_val4679) -> (case _val4679 of {T.TStruct _val4680 -> (to_SendBuddyMessageResult (T.TStruct _val4680)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyContentMessageToAll_result_e = P.maybe (P.Nothing) (\(_,_val4679) -> P.Just (case _val4679 of {T.TStruct _val4681 -> (to_TalkException (T.TStruct _val4681)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyContentMessageToAllAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4684 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4684))) $ sendBuddyContentMessageToAllAsync_args_requestId record
  , (\_v4684 -> P.Just (2, ("msg",from_Message _v4684))) $ sendBuddyContentMessageToAllAsync_args_msg record
  , (\_v4684 -> P.Just (3, ("content",T.TBinary _v4684))) $ sendBuddyContentMessageToAllAsync_args_content record
  ]
...
to_SendBuddyContentMessageToAllAsync_args (T.TStruct fields) = SendBuddyContentMessageToAllAsync_args{
  sendBuddyContentMessageToAllAsync_args_requestId = P.maybe (sendBuddyContentMessageToAllAsync_args_requestId default_SendBuddyContentMessageToAllAsync_args) (\(_,_val4686) -> (case _val4686 of {T.TString _val4687 -> E.decodeUtf8 _val4687; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyContentMessageToAllAsync_args_msg = P.maybe (sendBuddyContentMessageToAllAsync_args_msg default_SendBuddyContentMessageToAllAsync_args) (\(_,_val4686) -> (case _val4686 of {T.TStruct _val4688 -> (to_Message (T.TStruct _val4688)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyContentMessageToAllAsync_args_content = P.maybe (sendBuddyContentMessageToAllAsync_args_content default_SendBuddyContentMessageToAllAsync_args) (\(_,_val4686) -> (case _val4686 of {T.TBinary _val4689 -> _val4689; T.TString _val4689 -> _val4689; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_SendBuddyContentMessageToAllAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4692 -> (1, ("e",from_TalkException _v4692))) <$> sendBuddyContentMessageToAllAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4692 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4692))) $ sendBuddyContentMessageToAllAsync_result_success record
    , (\_v4692 -> (1, ("e",from_TalkException _v4692))) <$> sendBuddyContentMessageToAllAsync_result_e record
    ]
    )
...
to_SendBuddyContentMessageToAllAsync_result (T.TStruct fields) = SendBuddyContentMessageToAllAsync_result{
  sendBuddyContentMessageToAllAsync_result_success = P.maybe (sendBuddyContentMessageToAllAsync_result_success default_SendBuddyContentMessageToAllAsync_result) (\(_,_val4694) -> (case _val4694 of {T.TString _val4695 -> E.decodeUtf8 _val4695; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyContentMessageToAllAsync_result_e = P.maybe (P.Nothing) (\(_,_val4694) -> P.Just (case _val4694 of {T.TStruct _val4696 -> (to_TalkException (T.TStruct _val4696)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyContentMessageToMids_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4699 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4699))) $ sendBuddyContentMessageToMids_args_requestId record
  , (\_v4699 -> P.Just (2, ("msg",from_Message _v4699))) $ sendBuddyContentMessageToMids_args_msg record
  , (\_v4699 -> P.Just (3, ("content",T.TBinary _v4699))) $ sendBuddyContentMessageToMids_args_content record
  , (\_v4699 -> P.Just (4, ("mids",T.TList T.T_STRING $ P.map (\_v4701 -> T.TString $ E.encodeUtf8 _v4701) $ Vector.toList _v4699))) $ sendBuddyContentMessageToMids_args_mids record
  ]
...
to_SendBuddyContentMessageToMids_args (T.TStruct fields) = SendBuddyContentMessageToMids_args{
  sendBuddyContentMessageToMids_args_requestId = P.maybe (sendBuddyContentMessageToMids_args_requestId default_SendBuddyContentMessageToMids_args) (\(_,_val4703) -> (case _val4703 of {T.TString _val4704 -> E.decodeUtf8 _val4704; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyContentMessageToMids_args_msg = P.maybe (sendBuddyContentMessageToMids_args_msg default_SendBuddyContentMessageToMids_args) (\(_,_val4703) -> (case _val4703 of {T.TStruct _val4705 -> (to_Message (T.TStruct _val4705)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyContentMessageToMids_args_content = P.maybe (sendBuddyContentMessageToMids_args_content default_SendBuddyContentMessageToMids_args) (\(_,_val4703) -> (case _val4703 of {T.TBinary _val4706 -> _val4706; T.TString _val4706 -> _val4706; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  sendBuddyContentMessageToMids_args_mids = P.maybe (sendBuddyContentMessageToMids_args_mids default_SendBuddyContentMessageToMids_args) (\(_,_val4703) -> (case _val4703 of {T.TList _ _val4707 -> (Vector.fromList $ P.map (\_v4708 -> (case _v4708 of {T.TString _val4709 -> E.decodeUtf8 _val4709; _ -> P.error "wrong type"})) _val4707); _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_SendBuddyContentMessageToMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4712 -> (1, ("e",from_TalkException _v4712))) <$> sendBuddyContentMessageToMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4712 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4712))) $ sendBuddyContentMessageToMids_result_success record
    , (\_v4712 -> (1, ("e",from_TalkException _v4712))) <$> sendBuddyContentMessageToMids_result_e record
    ]
    )
...
to_SendBuddyContentMessageToMids_result (T.TStruct fields) = SendBuddyContentMessageToMids_result{
  sendBuddyContentMessageToMids_result_success = P.maybe (sendBuddyContentMessageToMids_result_success default_SendBuddyContentMessageToMids_result) (\(_,_val4714) -> (case _val4714 of {T.TStruct _val4715 -> (to_SendBuddyMessageResult (T.TStruct _val4715)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyContentMessageToMids_result_e = P.maybe (P.Nothing) (\(_,_val4714) -> P.Just (case _val4714 of {T.TStruct _val4716 -> (to_TalkException (T.TStruct _val4716)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyContentMessageToMidsAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4719 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4719))) $ sendBuddyContentMessageToMidsAsync_args_requestId record
  , (\_v4719 -> P.Just (2, ("msg",from_Message _v4719))) $ sendBuddyContentMessageToMidsAsync_args_msg record
  , (\_v4719 -> P.Just (3, ("content",T.TBinary _v4719))) $ sendBuddyContentMessageToMidsAsync_args_content record
  , (\_v4719 -> P.Just (4, ("mids",T.TList T.T_STRING $ P.map (\_v4721 -> T.TString $ E.encodeUtf8 _v4721) $ Vector.toList _v4719))) $ sendBuddyContentMessageToMidsAsync_args_mids record
  ]
...
to_SendBuddyContentMessageToMidsAsync_args (T.TStruct fields) = SendBuddyContentMessageToMidsAsync_args{
  sendBuddyContentMessageToMidsAsync_args_requestId = P.maybe (sendBuddyContentMessageToMidsAsync_args_requestId default_SendBuddyContentMessageToMidsAsync_args) (\(_,_val4723) -> (case _val4723 of {T.TString _val4724 -> E.decodeUtf8 _val4724; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyContentMessageToMidsAsync_args_msg = P.maybe (sendBuddyContentMessageToMidsAsync_args_msg default_SendBuddyContentMessageToMidsAsync_args) (\(_,_val4723) -> (case _val4723 of {T.TStruct _val4725 -> (to_Message (T.TStruct _val4725)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyContentMessageToMidsAsync_args_content = P.maybe (sendBuddyContentMessageToMidsAsync_args_content default_SendBuddyContentMessageToMidsAsync_args) (\(_,_val4723) -> (case _val4723 of {T.TBinary _val4726 -> _val4726; T.TString _val4726 -> _val4726; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  sendBuddyContentMessageToMidsAsync_args_mids = P.maybe (sendBuddyContentMessageToMidsAsync_args_mids default_SendBuddyContentMessageToMidsAsync_args) (\(_,_val4723) -> (case _val4723 of {T.TList _ _val4727 -> (Vector.fromList $ P.map (\_v4728 -> (case _v4728 of {T.TString _val4729 -> E.decodeUtf8 _val4729; _ -> P.error "wrong type"})) _val4727); _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_SendBuddyContentMessageToMidsAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4732 -> (1, ("e",from_TalkException _v4732))) <$> sendBuddyContentMessageToMidsAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4732 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4732))) $ sendBuddyContentMessageToMidsAsync_result_success record
    , (\_v4732 -> (1, ("e",from_TalkException _v4732))) <$> sendBuddyContentMessageToMidsAsync_result_e record
    ]
    )
...
to_SendBuddyContentMessageToMidsAsync_result (T.TStruct fields) = SendBuddyContentMessageToMidsAsync_result{
  sendBuddyContentMessageToMidsAsync_result_success = P.maybe (sendBuddyContentMessageToMidsAsync_result_success default_SendBuddyContentMessageToMidsAsync_result) (\(_,_val4734) -> (case _val4734 of {T.TString _val4735 -> E.decodeUtf8 _val4735; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyContentMessageToMidsAsync_result_e = P.maybe (P.Nothing) (\(_,_val4734) -> P.Just (case _val4734 of {T.TStruct _val4736 -> (to_TalkException (T.TStruct _val4736)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyMessageToAll_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4739 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4739))) $ sendBuddyMessageToAll_args_requestId record
  , (\_v4739 -> P.Just (2, ("msg",from_Message _v4739))) $ sendBuddyMessageToAll_args_msg record
  ]
...
to_SendBuddyMessageToAll_args (T.TStruct fields) = SendBuddyMessageToAll_args{
  sendBuddyMessageToAll_args_requestId = P.maybe (sendBuddyMessageToAll_args_requestId default_SendBuddyMessageToAll_args) (\(_,_val4741) -> (case _val4741 of {T.TString _val4742 -> E.decodeUtf8 _val4742; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyMessageToAll_args_msg = P.maybe (sendBuddyMessageToAll_args_msg default_SendBuddyMessageToAll_args) (\(_,_val4741) -> (case _val4741 of {T.TStruct _val4743 -> (to_Message (T.TStruct _val4743)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_SendBuddyMessageToAll_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4746 -> (1, ("e",from_TalkException _v4746))) <$> sendBuddyMessageToAll_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4746 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4746))) $ sendBuddyMessageToAll_result_success record
    , (\_v4746 -> (1, ("e",from_TalkException _v4746))) <$> sendBuddyMessageToAll_result_e record
    ]
    )
...
to_SendBuddyMessageToAll_result (T.TStruct fields) = SendBuddyMessageToAll_result{
  sendBuddyMessageToAll_result_success = P.maybe (sendBuddyMessageToAll_result_success default_SendBuddyMessageToAll_result) (\(_,_val4748) -> (case _val4748 of {T.TStruct _val4749 -> (to_SendBuddyMessageResult (T.TStruct _val4749)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyMessageToAll_result_e = P.maybe (P.Nothing) (\(_,_val4748) -> P.Just (case _val4748 of {T.TStruct _val4750 -> (to_TalkException (T.TStruct _val4750)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyMessageToAllAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4753 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4753))) $ sendBuddyMessageToAllAsync_args_requestId record
  , (\_v4753 -> P.Just (2, ("msg",from_Message _v4753))) $ sendBuddyMessageToAllAsync_args_msg record
  ]
...
to_SendBuddyMessageToAllAsync_args (T.TStruct fields) = SendBuddyMessageToAllAsync_args{
  sendBuddyMessageToAllAsync_args_requestId = P.maybe (sendBuddyMessageToAllAsync_args_requestId default_SendBuddyMessageToAllAsync_args) (\(_,_val4755) -> (case _val4755 of {T.TString _val4756 -> E.decodeUtf8 _val4756; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyMessageToAllAsync_args_msg = P.maybe (sendBuddyMessageToAllAsync_args_msg default_SendBuddyMessageToAllAsync_args) (\(_,_val4755) -> (case _val4755 of {T.TStruct _val4757 -> (to_Message (T.TStruct _val4757)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_SendBuddyMessageToAllAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4760 -> (1, ("e",from_TalkException _v4760))) <$> sendBuddyMessageToAllAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4760 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4760))) $ sendBuddyMessageToAllAsync_result_success record
    , (\_v4760 -> (1, ("e",from_TalkException _v4760))) <$> sendBuddyMessageToAllAsync_result_e record
    ]
    )
...
to_SendBuddyMessageToAllAsync_result (T.TStruct fields) = SendBuddyMessageToAllAsync_result{
  sendBuddyMessageToAllAsync_result_success = P.maybe (sendBuddyMessageToAllAsync_result_success default_SendBuddyMessageToAllAsync_result) (\(_,_val4762) -> (case _val4762 of {T.TString _val4763 -> E.decodeUtf8 _val4763; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyMessageToAllAsync_result_e = P.maybe (P.Nothing) (\(_,_val4762) -> P.Just (case _val4762 of {T.TStruct _val4764 -> (to_TalkException (T.TStruct _val4764)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyMessageToMids_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4767 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4767))) $ sendBuddyMessageToMids_args_requestId record
  , (\_v4767 -> P.Just (2, ("msg",from_Message _v4767))) $ sendBuddyMessageToMids_args_msg record
  , (\_v4767 -> P.Just (3, ("mids",T.TList T.T_STRING $ P.map (\_v4769 -> T.TString $ E.encodeUtf8 _v4769) $ Vector.toList _v4767))) $ sendBuddyMessageToMids_args_mids record
  ]
...
to_SendBuddyMessageToMids_args (T.TStruct fields) = SendBuddyMessageToMids_args{
  sendBuddyMessageToMids_args_requestId = P.maybe (sendBuddyMessageToMids_args_requestId default_SendBuddyMessageToMids_args) (\(_,_val4771) -> (case _val4771 of {T.TString _val4772 -> E.decodeUtf8 _val4772; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyMessageToMids_args_msg = P.maybe (sendBuddyMessageToMids_args_msg default_SendBuddyMessageToMids_args) (\(_,_val4771) -> (case _val4771 of {T.TStruct _val4773 -> (to_Message (T.TStruct _val4773)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyMessageToMids_args_mids = P.maybe (sendBuddyMessageToMids_args_mids default_SendBuddyMessageToMids_args) (\(_,_val4771) -> (case _val4771 of {T.TList _ _val4774 -> (Vector.fromList $ P.map (\_v4775 -> (case _v4775 of {T.TString _val4776 -> E.decodeUtf8 _val4776; _ -> P.error "wrong type"})) _val4774); _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_SendBuddyMessageToMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4779 -> (1, ("e",from_TalkException _v4779))) <$> sendBuddyMessageToMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4779 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4779))) $ sendBuddyMessageToMids_result_success record
    , (\_v4779 -> (1, ("e",from_TalkException _v4779))) <$> sendBuddyMessageToMids_result_e record
    ]
    )
...
to_SendBuddyMessageToMids_result (T.TStruct fields) = SendBuddyMessageToMids_result{
  sendBuddyMessageToMids_result_success = P.maybe (sendBuddyMessageToMids_result_success default_SendBuddyMessageToMids_result) (\(_,_val4781) -> (case _val4781 of {T.TStruct _val4782 -> (to_SendBuddyMessageResult (T.TStruct _val4782)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyMessageToMids_result_e = P.maybe (P.Nothing) (\(_,_val4781) -> P.Just (case _val4781 of {T.TStruct _val4783 -> (to_TalkException (T.TStruct _val4783)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendBuddyMessageToMidsAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4786 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4786))) $ sendBuddyMessageToMidsAsync_args_requestId record
  , (\_v4786 -> P.Just (2, ("msg",from_Message _v4786))) $ sendBuddyMessageToMidsAsync_args_msg record
  , (\_v4786 -> P.Just (3, ("mids",T.TList T.T_STRING $ P.map (\_v4788 -> T.TString $ E.encodeUtf8 _v4788) $ Vector.toList _v4786))) $ sendBuddyMessageToMidsAsync_args_mids record
  ]
...
to_SendBuddyMessageToMidsAsync_args (T.TStruct fields) = SendBuddyMessageToMidsAsync_args{
  sendBuddyMessageToMidsAsync_args_requestId = P.maybe (sendBuddyMessageToMidsAsync_args_requestId default_SendBuddyMessageToMidsAsync_args) (\(_,_val4790) -> (case _val4790 of {T.TString _val4791 -> E.decodeUtf8 _val4791; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendBuddyMessageToMidsAsync_args_msg = P.maybe (sendBuddyMessageToMidsAsync_args_msg default_SendBuddyMessageToMidsAsync_args) (\(_,_val4790) -> (case _val4790 of {T.TStruct _val4792 -> (to_Message (T.TStruct _val4792)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendBuddyMessageToMidsAsync_args_mids = P.maybe (sendBuddyMessageToMidsAsync_args_mids default_SendBuddyMessageToMidsAsync_args) (\(_,_val4790) -> (case _val4790 of {T.TList _ _val4793 -> (Vector.fromList $ P.map (\_v4794 -> (case _v4794 of {T.TString _val4795 -> E.decodeUtf8 _val4795; _ -> P.error "wrong type"})) _val4793); _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_SendBuddyMessageToMidsAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4798 -> (1, ("e",from_TalkException _v4798))) <$> sendBuddyMessageToMidsAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4798 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4798))) $ sendBuddyMessageToMidsAsync_result_success record
    , (\_v4798 -> (1, ("e",from_TalkException _v4798))) <$> sendBuddyMessageToMidsAsync_result_e record
    ]
    )
...
to_SendBuddyMessageToMidsAsync_result (T.TStruct fields) = SendBuddyMessageToMidsAsync_result{
  sendBuddyMessageToMidsAsync_result_success = P.maybe (sendBuddyMessageToMidsAsync_result_success default_SendBuddyMessageToMidsAsync_result) (\(_,_val4800) -> (case _val4800 of {T.TString _val4801 -> E.decodeUtf8 _val4801; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendBuddyMessageToMidsAsync_result_e = P.maybe (P.Nothing) (\(_,_val4800) -> P.Just (case _val4800 of {T.TStruct _val4802 -> (to_TalkException (T.TStruct _val4802)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendIndividualEventToAllAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4805 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4805))) $ sendIndividualEventToAllAsync_args_requestId record
  , (\_v4805 -> P.Just (2, ("buddyMid",T.TString $ E.encodeUtf8 _v4805))) $ sendIndividualEventToAllAsync_args_buddyMid record
  , (\_v4805 -> P.Just (3, ("notificationStatus",T.TI32 $ P.fromIntegral $ P.fromEnum _v4805))) $ sendIndividualEventToAllAsync_args_notificationStatus record
  ]
...
to_SendIndividualEventToAllAsync_args (T.TStruct fields) = SendIndividualEventToAllAsync_args{
  sendIndividualEventToAllAsync_args_requestId = P.maybe (sendIndividualEventToAllAsync_args_requestId default_SendIndividualEventToAllAsync_args) (\(_,_val4807) -> (case _val4807 of {T.TString _val4808 -> E.decodeUtf8 _val4808; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendIndividualEventToAllAsync_args_buddyMid = P.maybe (sendIndividualEventToAllAsync_args_buddyMid default_SendIndividualEventToAllAsync_args) (\(_,_val4807) -> (case _val4807 of {T.TString _val4809 -> E.decodeUtf8 _val4809; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendIndividualEventToAllAsync_args_notificationStatus = P.maybe (sendIndividualEventToAllAsync_args_notificationStatus default_SendIndividualEventToAllAsync_args) (\(_,_val4807) -> (case _val4807 of {T.TI32 _val4810 -> P.toEnum $ P.fromIntegral _val4810; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_SendIndividualEventToAllAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4813 -> (1, ("e",from_TalkException _v4813))) <$> sendIndividualEventToAllAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4813 -> (1, ("e",from_TalkException _v4813))) <$> sendIndividualEventToAllAsync_result_e record
    ]
    )
...
to_SendIndividualEventToAllAsync_result (T.TStruct fields) = SendIndividualEventToAllAsync_result{
  sendIndividualEventToAllAsync_result_e = P.maybe (P.Nothing) (\(_,_val4815) -> P.Just (case _val4815 of {T.TStruct _val4816 -> (to_TalkException (T.TStruct _val4816)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SetBuddyOnAir_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4819 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4819))) $ setBuddyOnAir_args_requestId record
  , (\_v4819 -> P.Just (2, ("onAir",T.TBool _v4819))) $ setBuddyOnAir_args_onAir record
  ]
...
to_SetBuddyOnAir_args (T.TStruct fields) = SetBuddyOnAir_args{
  setBuddyOnAir_args_requestId = P.maybe (setBuddyOnAir_args_requestId default_SetBuddyOnAir_args) (\(_,_val4821) -> (case _val4821 of {T.TString _val4822 -> E.decodeUtf8 _val4822; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  setBuddyOnAir_args_onAir = P.maybe (setBuddyOnAir_args_onAir default_SetBuddyOnAir_args) (\(_,_val4821) -> (case _val4821 of {T.TBool _val4823 -> _val4823; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_SetBuddyOnAir_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4826 -> (1, ("e",from_TalkException _v4826))) <$> setBuddyOnAir_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4826 -> P.Just (0, ("success",from_SetBuddyOnAirResult _v4826))) $ setBuddyOnAir_result_success record
    , (\_v4826 -> (1, ("e",from_TalkException _v4826))) <$> setBuddyOnAir_result_e record
    ]
    )
...
to_SetBuddyOnAir_result (T.TStruct fields) = SetBuddyOnAir_result{
  setBuddyOnAir_result_success = P.maybe (setBuddyOnAir_result_success default_SetBuddyOnAir_result) (\(_,_val4828) -> (case _val4828 of {T.TStruct _val4829 -> (to_SetBuddyOnAirResult (T.TStruct _val4829)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  setBuddyOnAir_result_e = P.maybe (P.Nothing) (\(_,_val4828) -> P.Just (case _val4828 of {T.TStruct _val4830 -> (to_TalkException (T.TStruct _val4830)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SetBuddyOnAirAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4833 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4833))) $ setBuddyOnAirAsync_args_requestId record
  , (\_v4833 -> P.Just (2, ("onAir",T.TBool _v4833))) $ setBuddyOnAirAsync_args_onAir record
  ]
...
to_SetBuddyOnAirAsync_args (T.TStruct fields) = SetBuddyOnAirAsync_args{
  setBuddyOnAirAsync_args_requestId = P.maybe (setBuddyOnAirAsync_args_requestId default_SetBuddyOnAirAsync_args) (\(_,_val4835) -> (case _val4835 of {T.TString _val4836 -> E.decodeUtf8 _val4836; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  setBuddyOnAirAsync_args_onAir = P.maybe (setBuddyOnAirAsync_args_onAir default_SetBuddyOnAirAsync_args) (\(_,_val4835) -> (case _val4835 of {T.TBool _val4837 -> _val4837; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_SetBuddyOnAirAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4840 -> (1, ("e",from_TalkException _v4840))) <$> setBuddyOnAirAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4840 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4840))) $ setBuddyOnAirAsync_result_success record
    , (\_v4840 -> (1, ("e",from_TalkException _v4840))) <$> setBuddyOnAirAsync_result_e record
    ]
    )
...
to_SetBuddyOnAirAsync_result (T.TStruct fields) = SetBuddyOnAirAsync_result{
  setBuddyOnAirAsync_result_success = P.maybe (setBuddyOnAirAsync_result_success default_SetBuddyOnAirAsync_result) (\(_,_val4842) -> (case _val4842 of {T.TString _val4843 -> E.decodeUtf8 _val4843; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  setBuddyOnAirAsync_result_e = P.maybe (P.Nothing) (\(_,_val4842) -> P.Just (case _val4842 of {T.TStruct _val4844 -> (to_TalkException (T.TStruct _val4844)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_StoreMessage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4847 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4847))) $ storeMessage_args_requestId record
  , (\_v4847 -> P.Just (2, ("messageRequest",from_BuddyMessageRequest _v4847))) $ storeMessage_args_messageRequest record
  ]
...
to_StoreMessage_args (T.TStruct fields) = StoreMessage_args{
  storeMessage_args_requestId = P.maybe (storeMessage_args_requestId default_StoreMessage_args) (\(_,_val4849) -> (case _val4849 of {T.TString _val4850 -> E.decodeUtf8 _val4850; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  storeMessage_args_messageRequest = P.maybe (storeMessage_args_messageRequest default_StoreMessage_args) (\(_,_val4849) -> (case _val4849 of {T.TStruct _val4851 -> (to_BuddyMessageRequest (T.TStruct _val4851)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_StoreMessage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4854 -> (1, ("e",from_TalkException _v4854))) <$> storeMessage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4854 -> P.Just (0, ("success",from_SendBuddyMessageResult _v4854))) $ storeMessage_result_success record
    , (\_v4854 -> (1, ("e",from_TalkException _v4854))) <$> storeMessage_result_e record
    ]
    )
...
to_StoreMessage_result (T.TStruct fields) = StoreMessage_result{
  storeMessage_result_success = P.maybe (storeMessage_result_success default_StoreMessage_result) (\(_,_val4856) -> (case _val4856 of {T.TStruct _val4857 -> (to_SendBuddyMessageResult (T.TStruct _val4857)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  storeMessage_result_e = P.maybe (P.Nothing) (\(_,_val4856) -> P.Just (case _val4856 of {T.TStruct _val4858 -> (to_TalkException (T.TStruct _val4858)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnblockBuddyMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4861 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4861))) $ unblockBuddyMember_args_requestId record
  , (\_v4861 -> P.Just (2, ("mid",T.TString $ E.encodeUtf8 _v4861))) $ unblockBuddyMember_args_mid record
  ]
...
to_UnblockBuddyMember_args (T.TStruct fields) = UnblockBuddyMember_args{
  unblockBuddyMember_args_requestId = P.maybe (unblockBuddyMember_args_requestId default_UnblockBuddyMember_args) (\(_,_val4863) -> (case _val4863 of {T.TString _val4864 -> E.decodeUtf8 _val4864; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  unblockBuddyMember_args_mid = P.maybe (unblockBuddyMember_args_mid default_UnblockBuddyMember_args) (\(_,_val4863) -> (case _val4863 of {T.TString _val4865 -> E.decodeUtf8 _val4865; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UnblockBuddyMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4868 -> (1, ("e",from_TalkException _v4868))) <$> unblockBuddyMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4868 -> (1, ("e",from_TalkException _v4868))) <$> unblockBuddyMember_result_e record
    ]
    )
...
to_UnblockBuddyMember_result (T.TStruct fields) = UnblockBuddyMember_result{
  unblockBuddyMember_result_e = P.maybe (P.Nothing) (\(_,_val4870) -> P.Just (case _val4870 of {T.TStruct _val4871 -> (to_TalkException (T.TStruct _val4871)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnregisterBuddy_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4874 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4874))) $ unregisterBuddy_args_requestId record
  ]
...
to_UnregisterBuddy_args (T.TStruct fields) = UnregisterBuddy_args{
  unregisterBuddy_args_requestId = P.maybe (unregisterBuddy_args_requestId default_UnregisterBuddy_args) (\(_,_val4876) -> (case _val4876 of {T.TString _val4877 -> E.decodeUtf8 _val4877; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnregisterBuddy_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4880 -> (1, ("e",from_TalkException _v4880))) <$> unregisterBuddy_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4880 -> (1, ("e",from_TalkException _v4880))) <$> unregisterBuddy_result_e record
    ]
    )
...
to_UnregisterBuddy_result (T.TStruct fields) = UnregisterBuddy_result{
  unregisterBuddy_result_e = P.maybe (P.Nothing) (\(_,_val4882) -> P.Just (case _val4882 of {T.TStruct _val4883 -> (to_TalkException (T.TStruct _val4883)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnregisterBuddyAdmin_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4886 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4886))) $ unregisterBuddyAdmin_args_requestId record
  ]
...
to_UnregisterBuddyAdmin_args (T.TStruct fields) = UnregisterBuddyAdmin_args{
  unregisterBuddyAdmin_args_requestId = P.maybe (unregisterBuddyAdmin_args_requestId default_UnregisterBuddyAdmin_args) (\(_,_val4888) -> (case _val4888 of {T.TString _val4889 -> E.decodeUtf8 _val4889; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnregisterBuddyAdmin_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4892 -> (1, ("e",from_TalkException _v4892))) <$> unregisterBuddyAdmin_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4892 -> (1, ("e",from_TalkException _v4892))) <$> unregisterBuddyAdmin_result_e record
    ]
    )
...
to_UnregisterBuddyAdmin_result (T.TStruct fields) = UnregisterBuddyAdmin_result{
  unregisterBuddyAdmin_result_e = P.maybe (P.Nothing) (\(_,_val4894) -> P.Just (case _val4894 of {T.TStruct _val4895 -> (to_TalkException (T.TStruct _val4895)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyAdminProfileAttribute_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4898 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4898))) $ updateBuddyAdminProfileAttribute_args_requestId record
  , (\_v4898 -> P.Just (2, ("attributes",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k4899,_v4900) -> (T.TString $ E.encodeUtf8 _k4899, T.TString $ E.encodeUtf8 _v4900)) $ Map.toList _v4898))) $ updateBuddyAdminProfileAttribute_args_attributes record
  ]
...
to_UpdateBuddyAdminProfileAttribute_args (T.TStruct fields) = UpdateBuddyAdminProfileAttribute_args{
  updateBuddyAdminProfileAttribute_args_requestId = P.maybe (updateBuddyAdminProfileAttribute_args_requestId default_UpdateBuddyAdminProfileAttribute_args) (\(_,_val4902) -> (case _val4902 of {T.TString _val4903 -> E.decodeUtf8 _val4903; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyAdminProfileAttribute_args_attributes = P.maybe (updateBuddyAdminProfileAttribute_args_attributes default_UpdateBuddyAdminProfileAttribute_args) (\(_,_val4902) -> (case _val4902 of {T.TMap _ _ _val4904 -> (Map.fromList $ P.map (\(_k4906,_v4905) -> ((case _k4906 of {T.TString _val4907 -> E.decodeUtf8 _val4907; _ -> P.error "wrong type"}),(case _v4905 of {T.TString _val4908 -> E.decodeUtf8 _val4908; _ -> P.error "wrong type"}))) _val4904); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyAdminProfileAttribute_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4911 -> (1, ("e",from_TalkException _v4911))) <$> updateBuddyAdminProfileAttribute_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4911 -> (1, ("e",from_TalkException _v4911))) <$> updateBuddyAdminProfileAttribute_result_e record
    ]
    )
...
to_UpdateBuddyAdminProfileAttribute_result (T.TStruct fields) = UpdateBuddyAdminProfileAttribute_result{
  updateBuddyAdminProfileAttribute_result_e = P.maybe (P.Nothing) (\(_,_val4913) -> P.Just (case _val4913 of {T.TStruct _val4914 -> (to_TalkException (T.TStruct _val4914)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyAdminProfileImage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4917 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4917))) $ updateBuddyAdminProfileImage_args_requestId record
  , (\_v4917 -> P.Just (2, ("picture",T.TBinary _v4917))) $ updateBuddyAdminProfileImage_args_picture record
  ]
...
to_UpdateBuddyAdminProfileImage_args (T.TStruct fields) = UpdateBuddyAdminProfileImage_args{
  updateBuddyAdminProfileImage_args_requestId = P.maybe (updateBuddyAdminProfileImage_args_requestId default_UpdateBuddyAdminProfileImage_args) (\(_,_val4919) -> (case _val4919 of {T.TString _val4920 -> E.decodeUtf8 _val4920; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyAdminProfileImage_args_picture = P.maybe (updateBuddyAdminProfileImage_args_picture default_UpdateBuddyAdminProfileImage_args) (\(_,_val4919) -> (case _val4919 of {T.TBinary _val4921 -> _val4921; T.TString _val4921 -> _val4921; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyAdminProfileImage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4924 -> (1, ("e",from_TalkException _v4924))) <$> updateBuddyAdminProfileImage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4924 -> (1, ("e",from_TalkException _v4924))) <$> updateBuddyAdminProfileImage_result_e record
    ]
    )
...
to_UpdateBuddyAdminProfileImage_result (T.TStruct fields) = UpdateBuddyAdminProfileImage_result{
  updateBuddyAdminProfileImage_result_e = P.maybe (P.Nothing) (\(_,_val4926) -> P.Just (case _val4926 of {T.TStruct _val4927 -> (to_TalkException (T.TStruct _val4927)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyProfileAttributes_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4930 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4930))) $ updateBuddyProfileAttributes_args_requestId record
  , (\_v4930 -> P.Just (2, ("attributes",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k4931,_v4932) -> (T.TString $ E.encodeUtf8 _k4931, T.TString $ E.encodeUtf8 _v4932)) $ Map.toList _v4930))) $ updateBuddyProfileAttributes_args_attributes record
  ]
...
to_UpdateBuddyProfileAttributes_args (T.TStruct fields) = UpdateBuddyProfileAttributes_args{
  updateBuddyProfileAttributes_args_requestId = P.maybe (updateBuddyProfileAttributes_args_requestId default_UpdateBuddyProfileAttributes_args) (\(_,_val4934) -> (case _val4934 of {T.TString _val4935 -> E.decodeUtf8 _val4935; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyProfileAttributes_args_attributes = P.maybe (updateBuddyProfileAttributes_args_attributes default_UpdateBuddyProfileAttributes_args) (\(_,_val4934) -> (case _val4934 of {T.TMap _ _ _val4936 -> (Map.fromList $ P.map (\(_k4938,_v4937) -> ((case _k4938 of {T.TString _val4939 -> E.decodeUtf8 _val4939; _ -> P.error "wrong type"}),(case _v4937 of {T.TString _val4940 -> E.decodeUtf8 _val4940; _ -> P.error "wrong type"}))) _val4936); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyProfileAttributes_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4943 -> (1, ("e",from_TalkException _v4943))) <$> updateBuddyProfileAttributes_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4943 -> P.Just (0, ("success",from_UpdateBuddyProfileResult _v4943))) $ updateBuddyProfileAttributes_result_success record
    , (\_v4943 -> (1, ("e",from_TalkException _v4943))) <$> updateBuddyProfileAttributes_result_e record
    ]
    )
...
to_UpdateBuddyProfileAttributes_result (T.TStruct fields) = UpdateBuddyProfileAttributes_result{
  updateBuddyProfileAttributes_result_success = P.maybe (updateBuddyProfileAttributes_result_success default_UpdateBuddyProfileAttributes_result) (\(_,_val4945) -> (case _val4945 of {T.TStruct _val4946 -> (to_UpdateBuddyProfileResult (T.TStruct _val4946)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  updateBuddyProfileAttributes_result_e = P.maybe (P.Nothing) (\(_,_val4945) -> P.Just (case _val4945 of {T.TStruct _val4947 -> (to_TalkException (T.TStruct _val4947)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyProfileAttributesAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4950 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4950))) $ updateBuddyProfileAttributesAsync_args_requestId record
  , (\_v4950 -> P.Just (2, ("attributes",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k4951,_v4952) -> (T.TString $ E.encodeUtf8 _k4951, T.TString $ E.encodeUtf8 _v4952)) $ Map.toList _v4950))) $ updateBuddyProfileAttributesAsync_args_attributes record
  ]
...
to_UpdateBuddyProfileAttributesAsync_args (T.TStruct fields) = UpdateBuddyProfileAttributesAsync_args{
  updateBuddyProfileAttributesAsync_args_requestId = P.maybe (updateBuddyProfileAttributesAsync_args_requestId default_UpdateBuddyProfileAttributesAsync_args) (\(_,_val4954) -> (case _val4954 of {T.TString _val4955 -> E.decodeUtf8 _val4955; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyProfileAttributesAsync_args_attributes = P.maybe (updateBuddyProfileAttributesAsync_args_attributes default_UpdateBuddyProfileAttributesAsync_args) (\(_,_val4954) -> (case _val4954 of {T.TMap _ _ _val4956 -> (Map.fromList $ P.map (\(_k4958,_v4957) -> ((case _k4958 of {T.TString _val4959 -> E.decodeUtf8 _val4959; _ -> P.error "wrong type"}),(case _v4957 of {T.TString _val4960 -> E.decodeUtf8 _val4960; _ -> P.error "wrong type"}))) _val4956); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyProfileAttributesAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4963 -> (1, ("e",from_TalkException _v4963))) <$> updateBuddyProfileAttributesAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4963 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4963))) $ updateBuddyProfileAttributesAsync_result_success record
    , (\_v4963 -> (1, ("e",from_TalkException _v4963))) <$> updateBuddyProfileAttributesAsync_result_e record
    ]
    )
...
to_UpdateBuddyProfileAttributesAsync_result (T.TStruct fields) = UpdateBuddyProfileAttributesAsync_result{
  updateBuddyProfileAttributesAsync_result_success = P.maybe (updateBuddyProfileAttributesAsync_result_success default_UpdateBuddyProfileAttributesAsync_result) (\(_,_val4965) -> (case _val4965 of {T.TString _val4966 -> E.decodeUtf8 _val4966; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  updateBuddyProfileAttributesAsync_result_e = P.maybe (P.Nothing) (\(_,_val4965) -> P.Just (case _val4965 of {T.TStruct _val4967 -> (to_TalkException (T.TStruct _val4967)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyProfileImage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4970 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4970))) $ updateBuddyProfileImage_args_requestId record
  , (\_v4970 -> P.Just (2, ("image",T.TBinary _v4970))) $ updateBuddyProfileImage_args_image record
  ]
...
to_UpdateBuddyProfileImage_args (T.TStruct fields) = UpdateBuddyProfileImage_args{
  updateBuddyProfileImage_args_requestId = P.maybe (updateBuddyProfileImage_args_requestId default_UpdateBuddyProfileImage_args) (\(_,_val4972) -> (case _val4972 of {T.TString _val4973 -> E.decodeUtf8 _val4973; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyProfileImage_args_image = P.maybe (updateBuddyProfileImage_args_image default_UpdateBuddyProfileImage_args) (\(_,_val4972) -> (case _val4972 of {T.TBinary _val4974 -> _val4974; T.TString _val4974 -> _val4974; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyProfileImage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4977 -> (1, ("e",from_TalkException _v4977))) <$> updateBuddyProfileImage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4977 -> P.Just (0, ("success",from_UpdateBuddyProfileResult _v4977))) $ updateBuddyProfileImage_result_success record
    , (\_v4977 -> (1, ("e",from_TalkException _v4977))) <$> updateBuddyProfileImage_result_e record
    ]
    )
...
to_UpdateBuddyProfileImage_result (T.TStruct fields) = UpdateBuddyProfileImage_result{
  updateBuddyProfileImage_result_success = P.maybe (updateBuddyProfileImage_result_success default_UpdateBuddyProfileImage_result) (\(_,_val4979) -> (case _val4979 of {T.TStruct _val4980 -> (to_UpdateBuddyProfileResult (T.TStruct _val4980)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  updateBuddyProfileImage_result_e = P.maybe (P.Nothing) (\(_,_val4979) -> P.Just (case _val4979 of {T.TStruct _val4981 -> (to_TalkException (T.TStruct _val4981)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddyProfileImageAsync_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4984 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4984))) $ updateBuddyProfileImageAsync_args_requestId record
  , (\_v4984 -> P.Just (2, ("image",T.TBinary _v4984))) $ updateBuddyProfileImageAsync_args_image record
  ]
...
to_UpdateBuddyProfileImageAsync_args (T.TStruct fields) = UpdateBuddyProfileImageAsync_args{
  updateBuddyProfileImageAsync_args_requestId = P.maybe (updateBuddyProfileImageAsync_args_requestId default_UpdateBuddyProfileImageAsync_args) (\(_,_val4986) -> (case _val4986 of {T.TString _val4987 -> E.decodeUtf8 _val4987; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddyProfileImageAsync_args_image = P.maybe (updateBuddyProfileImageAsync_args_image default_UpdateBuddyProfileImageAsync_args) (\(_,_val4986) -> (case _val4986 of {T.TBinary _val4988 -> _val4988; T.TString _val4988 -> _val4988; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddyProfileImageAsync_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v4991 -> (1, ("e",from_TalkException _v4991))) <$> updateBuddyProfileImageAsync_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v4991 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v4991))) $ updateBuddyProfileImageAsync_result_success record
    , (\_v4991 -> (1, ("e",from_TalkException _v4991))) <$> updateBuddyProfileImageAsync_result_e record
    ]
    )
...
to_UpdateBuddyProfileImageAsync_result (T.TStruct fields) = UpdateBuddyProfileImageAsync_result{
  updateBuddyProfileImageAsync_result_success = P.maybe (updateBuddyProfileImageAsync_result_success default_UpdateBuddyProfileImageAsync_result) (\(_,_val4993) -> (case _val4993 of {T.TString _val4994 -> E.decodeUtf8 _val4994; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  updateBuddyProfileImageAsync_result_e = P.maybe (P.Nothing) (\(_,_val4993) -> P.Just (case _val4993 of {T.TStruct _val4995 -> (to_TalkException (T.TStruct _val4995)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddySearchId_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4998 -> P.Just (1, ("requestId",T.TString $ E.encodeUtf8 _v4998))) $ updateBuddySearchId_args_requestId record
  , (\_v4998 -> P.Just (2, ("searchId",T.TString $ E.encodeUtf8 _v4998))) $ updateBuddySearchId_args_searchId record
  ]
...
to_UpdateBuddySearchId_args (T.TStruct fields) = UpdateBuddySearchId_args{
  updateBuddySearchId_args_requestId = P.maybe (updateBuddySearchId_args_requestId default_UpdateBuddySearchId_args) (\(_,_val5000) -> (case _val5000 of {T.TString _val5001 -> E.decodeUtf8 _val5001; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  updateBuddySearchId_args_searchId = P.maybe (updateBuddySearchId_args_searchId default_UpdateBuddySearchId_args) (\(_,_val5000) -> (case _val5000 of {T.TString _val5002 -> E.decodeUtf8 _val5002; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddySearchId_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5005 -> (1, ("e",from_TalkException _v5005))) <$> updateBuddySearchId_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5005 -> (1, ("e",from_TalkException _v5005))) <$> updateBuddySearchId_result_e record
    ]
    )
...
to_UpdateBuddySearchId_result (T.TStruct fields) = UpdateBuddySearchId_result{
  updateBuddySearchId_result_e = P.maybe (P.Nothing) (\(_,_val5007) -> P.Just (case _val5007 of {T.TStruct _val5008 -> (to_TalkException (T.TStruct _val5008)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateBuddySettings_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5011 -> P.Just (2, ("settings",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k5012,_v5013) -> (T.TString $ E.encodeUtf8 _k5012, T.TString $ E.encodeUtf8 _v5013)) $ Map.toList _v5011))) $ updateBuddySettings_args_settings record
  ]
...
to_UpdateBuddySettings_args (T.TStruct fields) = UpdateBuddySettings_args{
  updateBuddySettings_args_settings = P.maybe (updateBuddySettings_args_settings default_UpdateBuddySettings_args) (\(_,_val5015) -> (case _val5015 of {T.TMap _ _ _val5016 -> (Map.fromList $ P.map (\(_k5018,_v5017) -> ((case _k5018 of {T.TString _val5019 -> E.decodeUtf8 _val5019; _ -> P.error "wrong type"}),(case _v5017 of {T.TString _val5020 -> E.decodeUtf8 _val5020; _ -> P.error "wrong type"}))) _val5016); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UpdateBuddySettings_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5023 -> (1, ("e",from_TalkException _v5023))) <$> updateBuddySettings_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5023 -> (1, ("e",from_TalkException _v5023))) <$> updateBuddySettings_result_e record
    ]
    )
...
to_UpdateBuddySettings_result (T.TStruct fields) = UpdateBuddySettings_result{
  updateBuddySettings_result_e = P.maybe (P.Nothing) (\(_,_val5025) -> P.Just (case _val5025 of {T.TStruct _val5026 -> (to_TalkException (T.TStruct _val5026)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UploadBuddyContent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5029 -> P.Just (2, ("contentType",T.TI32 $ P.fromIntegral $ P.fromEnum _v5029))) $ uploadBuddyContent_args_contentType record
  , (\_v5029 -> P.Just (3, ("content",T.TBinary _v5029))) $ uploadBuddyContent_args_content record
  ]
...
to_UploadBuddyContent_args (T.TStruct fields) = UploadBuddyContent_args{
  uploadBuddyContent_args_contentType = P.maybe (uploadBuddyContent_args_contentType default_UploadBuddyContent_args) (\(_,_val5031) -> (case _val5031 of {T.TI32 _val5032 -> P.toEnum $ P.fromIntegral _val5032; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  uploadBuddyContent_args_content = P.maybe (uploadBuddyContent_args_content default_UploadBuddyContent_args) (\(_,_val5031) -> (case _val5031 of {T.TBinary _val5033 -> _val5033; T.TString _val5033 -> _val5033; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_UploadBuddyContent_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5036 -> (1, ("e",from_TalkException _v5036))) <$> uploadBuddyContent_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5036 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5036))) $ uploadBuddyContent_result_success record
    , (\_v5036 -> (1, ("e",from_TalkException _v5036))) <$> uploadBuddyContent_result_e record
    ]
    )
...
to_UploadBuddyContent_result (T.TStruct fields) = UploadBuddyContent_result{
  uploadBuddyContent_result_success = P.maybe (uploadBuddyContent_result_success default_UploadBuddyContent_result) (\(_,_val5038) -> (case _val5038 of {T.TString _val5039 -> E.decodeUtf8 _val5039; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  uploadBuddyContent_result_e = P.maybe (P.Nothing) (\(_,_val5038) -> P.Just (case _val5038 of {T.TStruct _val5040 -> (to_TalkException (T.TStruct _val5040)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
