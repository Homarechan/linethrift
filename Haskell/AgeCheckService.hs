...
from_CheckUserAge_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4132 -> P.Just (2, ("carrier",T.TI32 $ P.fromIntegral $ P.fromEnum _v4132))) $ checkUserAge_args_carrier record
  , (\_v4132 -> P.Just (3, ("sessionId",T.TString $ E.encodeUtf8 _v4132))) $ checkUserAge_args_sessionId record
  , (\_v4132 -> P.Just (4, ("verifier",T.TString $ E.encodeUtf8 _v4132))) $ checkUserAge_args_verifier record
  , (\_v4132 -> P.Just (5, ("standardAge",T.TI32 _v4132))) $ checkUserAge_args_standardAge record
  ]
...
to_CheckUserAge_args (T.TStruct fields) = CheckUserAge_args{
  checkUserAge_args_carrier = P.maybe (checkUserAge_args_carrier default_CheckUserAge_args) (\(_,_val4134) -> (case _val4134 of {T.TI32 _val4135 -> P.toEnum $ P.fromIntegral _val4135; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkUserAge_args_sessionId = P.maybe (checkUserAge_args_sessionId default_CheckUserAge_args) (\(_,_val4134) -> (case _val4134 of {T.TString _val4136 -> E.decodeUtf8 _val4136; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkUserAge_args_verifier = P.maybe (checkUserAge_args_verifier default_CheckUserAge_args) (\(_,_val4134) -> (case _val4134 of {T.TString _val4137 -> E.decodeUtf8 _val4137; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  checkUserAge_args_standardAge = P.maybe (checkUserAge_args_standardAge default_CheckUserAge_args) (\(_,_val4134) -> (case _val4134 of {T.TI32 _val4138 -> _val4138; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_CheckUserAge_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4141 -> (1, ("e",from_TalkException _v4141))) <$> checkUserAge_result_e record
    ]
    )
...
to_CheckUserAge_result (T.TStruct fields) = CheckUserAge_result{
  checkUserAge_result_success = P.maybe (checkUserAge_result_success default_CheckUserAge_result) (\(_,_val4143) -> (case _val4143 of {T.TI32 _val4144 -> P.toEnum $ P.fromIntegral _val4144; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  checkUserAge_result_e = P.maybe (P.Nothing) (\(_,_val4143) -> P.Just (case _val4143 of {T.TStruct _val4145 -> (to_TalkException (T.TStruct _val4145)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CheckUserAgeWithDocomo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4148 -> P.Just (2, ("openIdRedirectUrl",T.TString $ E.encodeUtf8 _v4148))) $ checkUserAgeWithDocomo_args_openIdRedirectUrl record
  , (\_v4148 -> P.Just (3, ("standardAge",T.TI32 _v4148))) $ checkUserAgeWithDocomo_args_standardAge record
  , (\_v4148 -> P.Just (4, ("verifier",T.TString $ E.encodeUtf8 _v4148))) $ checkUserAgeWithDocomo_args_verifier record
  ]
...
to_CheckUserAgeWithDocomo_args (T.TStruct fields) = CheckUserAgeWithDocomo_args{
  checkUserAgeWithDocomo_args_openIdRedirectUrl = P.maybe (checkUserAgeWithDocomo_args_openIdRedirectUrl default_CheckUserAgeWithDocomo_args) (\(_,_val4150) -> (case _val4150 of {T.TString _val4151 -> E.decodeUtf8 _val4151; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkUserAgeWithDocomo_args_standardAge = P.maybe (checkUserAgeWithDocomo_args_standardAge default_CheckUserAgeWithDocomo_args) (\(_,_val4150) -> (case _val4150 of {T.TI32 _val4152 -> _val4152; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkUserAgeWithDocomo_args_verifier = P.maybe (checkUserAgeWithDocomo_args_verifier default_CheckUserAgeWithDocomo_args) (\(_,_val4150) -> (case _val4150 of {T.TString _val4153 -> E.decodeUtf8 _val4153; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_CheckUserAgeWithDocomo_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4156 -> (1, ("e",from_TalkException _v4156))) <$> checkUserAgeWithDocomo_result_e record
    ]
    )
...
to_CheckUserAgeWithDocomo_result (T.TStruct fields) = CheckUserAgeWithDocomo_result{
  checkUserAgeWithDocomo_result_success = P.maybe (checkUserAgeWithDocomo_result_success default_CheckUserAgeWithDocomo_result) (\(_,_val4158) -> (case _val4158 of {T.TStruct _val4159 -> (to_AgeCheckDocomoResult (T.TStruct _val4159)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  checkUserAgeWithDocomo_result_e = P.maybe (P.Nothing) (\(_,_val4158) -> P.Just (case _val4158 of {T.TStruct _val4160 -> (to_TalkException (T.TStruct _val4160)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RetrieveOpenIdAuthUrlWithDocomo_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4168 -> (1, ("e",from_TalkException _v4168))) <$> retrieveOpenIdAuthUrlWithDocomo_result_e record
    ]
    )
...
to_RetrieveOpenIdAuthUrlWithDocomo_result (T.TStruct fields) = RetrieveOpenIdAuthUrlWithDocomo_result{
  retrieveOpenIdAuthUrlWithDocomo_result_success = P.maybe (retrieveOpenIdAuthUrlWithDocomo_result_success default_RetrieveOpenIdAuthUrlWithDocomo_result) (\(_,_val4170) -> (case _val4170 of {T.TString _val4171 -> E.decodeUtf8 _val4171; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  retrieveOpenIdAuthUrlWithDocomo_result_e = P.maybe (P.Nothing) (\(_,_val4170) -> P.Just (case _val4170 of {T.TStruct _val4172 -> (to_TalkException (T.TStruct _val4172)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RetrieveRequestToken_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4175 -> P.Just (2, ("carrier",T.TI32 $ P.fromIntegral $ P.fromEnum _v4175))) $ retrieveRequestToken_args_carrier record
  ]
...
to_RetrieveRequestToken_args (T.TStruct fields) = RetrieveRequestToken_args{
  retrieveRequestToken_args_carrier = P.maybe (retrieveRequestToken_args_carrier default_RetrieveRequestToken_args) (\(_,_val4177) -> (case _val4177 of {T.TI32 _val4178 -> P.toEnum $ P.fromIntegral _val4178; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_RetrieveRequestToken_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4181 -> (1, ("e",from_TalkException _v4181))) <$> retrieveRequestToken_result_e record
    ]
    )
...
to_RetrieveRequestToken_result (T.TStruct fields) = RetrieveRequestToken_result{
  retrieveRequestToken_result_success = P.maybe (retrieveRequestToken_result_success default_RetrieveRequestToken_result) (\(_,_val4183) -> (case _val4183 of {T.TStruct _val4184 -> (to_AgeCheckRequestResult (T.TStruct _val4184)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  retrieveRequestToken_result_e = P.maybe (P.Nothing) (\(_,_val4183) -> P.Just (case _val4183 of {T.TStruct _val4185 -> (to_TalkException (T.TStruct _val4185)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
