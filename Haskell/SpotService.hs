...
from_LookupByPhoneNumber_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4050 -> P.Just (2, ("countryAreaCode",T.TString $ E.encodeUtf8 _v4050))) $ lookupByPhoneNumber_args_countryAreaCode record
  , (\_v4050 -> P.Just (3, ("phoneNumber",T.TString $ E.encodeUtf8 _v4050))) $ lookupByPhoneNumber_args_phoneNumber record
  ]
...
to_LookupByPhoneNumber_args (T.TStruct fields) = LookupByPhoneNumber_args{
  lookupByPhoneNumber_args_countryAreaCode = P.maybe (lookupByPhoneNumber_args_countryAreaCode default_LookupByPhoneNumber_args) (\(_,_val4052) -> (case _val4052 of {T.TString _val4053 -> E.decodeUtf8 _val4053; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  lookupByPhoneNumber_args_phoneNumber = P.maybe (lookupByPhoneNumber_args_phoneNumber default_LookupByPhoneNumber_args) (\(_,_val4052) -> (case _val4052 of {T.TString _val4054 -> E.decodeUtf8 _val4054; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_LookupByPhoneNumber_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4057 -> (1, ("e",from_TalkException _v4057))) <$> lookupByPhoneNumber_result_e record
    ]
    )
...
to_LookupByPhoneNumber_result (T.TStruct fields) = LookupByPhoneNumber_result{
  lookupByPhoneNumber_result_success = P.maybe (lookupByPhoneNumber_result_success default_LookupByPhoneNumber_result) (\(_,_val4059) -> (case _val4059 of {T.TStruct _val4060 -> (to_SpotPhoneNumberResponse (T.TStruct _val4060)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  lookupByPhoneNumber_result_e = P.maybe (P.Nothing) (\(_,_val4059) -> P.Just (case _val4059 of {T.TStruct _val4061 -> (to_TalkException (T.TStruct _val4061)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_LookupNearby_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v4064 -> P.Just (2, ("location",from_Location _v4064))) $ lookupNearby_args_location record
  , (\_v4064 -> P.Just (3, ("category",T.TI32 $ P.fromIntegral $ P.fromEnum _v4064))) $ lookupNearby_args_category record
  , (\_v4064 -> P.Just (4, ("query",T.TString $ E.encodeUtf8 _v4064))) $ lookupNearby_args_query record
  , (\_v4064 -> P.Just (5, ("countryAreaCode",T.TString $ E.encodeUtf8 _v4064))) $ lookupNearby_args_countryAreaCode record
  ]
...
to_LookupNearby_args (T.TStruct fields) = LookupNearby_args{
  lookupNearby_args_location = P.maybe (lookupNearby_args_location default_LookupNearby_args) (\(_,_val4066) -> (case _val4066 of {T.TStruct _val4067 -> (to_Location (T.TStruct _val4067)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  lookupNearby_args_category = P.maybe (lookupNearby_args_category default_LookupNearby_args) (\(_,_val4066) -> (case _val4066 of {T.TI32 _val4068 -> P.toEnum $ P.fromIntegral _val4068; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  lookupNearby_args_query = P.maybe (lookupNearby_args_query default_LookupNearby_args) (\(_,_val4066) -> (case _val4066 of {T.TString _val4069 -> E.decodeUtf8 _val4069; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  lookupNearby_args_countryAreaCode = P.maybe (lookupNearby_args_countryAreaCode default_LookupNearby_args) (\(_,_val4066) -> (case _val4066 of {T.TString _val4070 -> E.decodeUtf8 _val4070; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_LookupNearby_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v4073 -> (1, ("e",from_TalkException _v4073))) <$> lookupNearby_result_e record
    ]
    )
...
to_LookupNearby_result (T.TStruct fields) = LookupNearby_result{
  lookupNearby_result_success = P.maybe (lookupNearby_result_success default_LookupNearby_result) (\(_,_val4075) -> (case _val4075 of {T.TStruct _val4076 -> (to_SpotNearbyResponse (T.TStruct _val4076)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  lookupNearby_result_e = P.maybe (P.Nothing) (\(_,_val4075) -> P.Just (case _val4075 of {T.TStruct _val4077 -> (to_TalkException (T.TStruct _val4077)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
