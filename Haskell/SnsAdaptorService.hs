...
from_GetSnsFriends_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6424 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v6424))) $ getSnsFriends_args_snsIdType record
  , (\_v6424 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v6424))) $ getSnsFriends_args_snsAccessToken record
  , (\_v6424 -> P.Just (4, ("startIdx",T.TI32 _v6424))) $ getSnsFriends_args_startIdx record
  , (\_v6424 -> P.Just (5, ("limit",T.TI32 _v6424))) $ getSnsFriends_args_limit record
  ]
...
to_GetSnsFriends_args (T.TStruct fields) = GetSnsFriends_args{
  getSnsFriends_args_snsIdType = P.maybe (getSnsFriends_args_snsIdType default_GetSnsFriends_args) (\(_,_val6426) -> (case _val6426 of {T.TI32 _val6427 -> P.toEnum $ P.fromIntegral _val6427; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getSnsFriends_args_snsAccessToken = P.maybe (getSnsFriends_args_snsAccessToken default_GetSnsFriends_args) (\(_,_val6426) -> (case _val6426 of {T.TString _val6428 -> E.decodeUtf8 _val6428; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getSnsFriends_args_startIdx = P.maybe (getSnsFriends_args_startIdx default_GetSnsFriends_args) (\(_,_val6426) -> (case _val6426 of {T.TI32 _val6429 -> _val6429; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getSnsFriends_args_limit = P.maybe (getSnsFriends_args_limit default_GetSnsFriends_args) (\(_,_val6426) -> (case _val6426 of {T.TI32 _val6430 -> _val6430; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetSnsFriends_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6433 -> (1, ("e",from_TalkException _v6433))) <$> getSnsFriends_result_e record
    ]
    )
...
to_GetSnsFriends_result (T.TStruct fields) = GetSnsFriends_result{
  getSnsFriends_result_success = P.maybe (getSnsFriends_result_success default_GetSnsFriends_result) (\(_,_val6435) -> (case _val6435 of {T.TStruct _val6436 -> (to_SnsFriends (T.TStruct _val6436)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSnsFriends_result_e = P.maybe (P.Nothing) (\(_,_val6435) -> P.Just (case _val6435 of {T.TStruct _val6437 -> (to_TalkException (T.TStruct _val6437)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSnsMyProfile_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6440 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v6440))) $ getSnsMyProfile_args_snsIdType record
  , (\_v6440 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v6440))) $ getSnsMyProfile_args_snsAccessToken record
  ]
...
to_GetSnsMyProfile_args (T.TStruct fields) = GetSnsMyProfile_args{
  getSnsMyProfile_args_snsIdType = P.maybe (getSnsMyProfile_args_snsIdType default_GetSnsMyProfile_args) (\(_,_val6442) -> (case _val6442 of {T.TI32 _val6443 -> P.toEnum $ P.fromIntegral _val6443; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getSnsMyProfile_args_snsAccessToken = P.maybe (getSnsMyProfile_args_snsAccessToken default_GetSnsMyProfile_args) (\(_,_val6442) -> (case _val6442 of {T.TString _val6444 -> E.decodeUtf8 _val6444; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetSnsMyProfile_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6447 -> (1, ("e",from_TalkException _v6447))) <$> getSnsMyProfile_result_e record
    ]
    )
...
to_GetSnsMyProfile_result (T.TStruct fields) = GetSnsMyProfile_result{
  getSnsMyProfile_result_success = P.maybe (getSnsMyProfile_result_success default_GetSnsMyProfile_result) (\(_,_val6449) -> (case _val6449 of {T.TStruct _val6450 -> (to_SnsProfile (T.TStruct _val6450)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSnsMyProfile_result_e = P.maybe (P.Nothing) (\(_,_val6449) -> P.Just (case _val6449 of {T.TStruct _val6451 -> (to_TalkException (T.TStruct _val6451)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_PostSnsInvitationMessage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6454 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v6454))) $ postSnsInvitationMessage_args_snsIdType record
  , (\_v6454 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v6454))) $ postSnsInvitationMessage_args_snsAccessToken record
  , (\_v6454 -> P.Just (4, ("toSnsUserId",T.TString $ E.encodeUtf8 _v6454))) $ postSnsInvitationMessage_args_toSnsUserId record
  ]
...
to_PostSnsInvitationMessage_args (T.TStruct fields) = PostSnsInvitationMessage_args{
  postSnsInvitationMessage_args_snsIdType = P.maybe (postSnsInvitationMessage_args_snsIdType default_PostSnsInvitationMessage_args) (\(_,_val6456) -> (case _val6456 of {T.TI32 _val6457 -> P.toEnum $ P.fromIntegral _val6457; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  postSnsInvitationMessage_args_snsAccessToken = P.maybe (postSnsInvitationMessage_args_snsAccessToken default_PostSnsInvitationMessage_args) (\(_,_val6456) -> (case _val6456 of {T.TString _val6458 -> E.decodeUtf8 _val6458; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  postSnsInvitationMessage_args_toSnsUserId = P.maybe (postSnsInvitationMessage_args_toSnsUserId default_PostSnsInvitationMessage_args) (\(_,_val6456) -> (case _val6456 of {T.TString _val6459 -> E.decodeUtf8 _val6459; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
to_PostSnsInvitationMessage_result (T.TStruct fields) = PostSnsInvitationMessage_result{
  postSnsInvitationMessage_result_e = P.maybe (P.Nothing) (\(_,_val6464) -> P.Just (case _val6464 of {T.TStruct _val6465 -> (to_TalkException (T.TStruct _val6465)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
