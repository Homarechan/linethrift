...
from_NotifyLeaveGroup_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3557 -> P.Just (1, ("groupMid",T.TString $ E.encodeUtf8 _v3557))) $ notifyLeaveGroup_args_groupMid record
  ]
...
to_NotifyLeaveGroup_args (T.TStruct fields) = NotifyLeaveGroup_args{
  notifyLeaveGroup_args_groupMid = P.maybe (notifyLeaveGroup_args_groupMid default_NotifyLeaveGroup_args) (\(_,_val3559) -> (case _val3559 of {T.TString _val3560 -> E.decodeUtf8 _val3560; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyLeaveGroup_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3563 -> (1, ("e",from_TalkException _v3563))) <$> notifyLeaveGroup_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3563 -> (1, ("e",from_TalkException _v3563))) <$> notifyLeaveGroup_result_e record
    ]
    )
...
to_NotifyLeaveGroup_result (T.TStruct fields) = NotifyLeaveGroup_result{
  notifyLeaveGroup_result_e = P.maybe (P.Nothing) (\(_,_val3565) -> P.Just (case _val3565 of {T.TStruct _val3566 -> (to_TalkException (T.TStruct _val3566)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyLeaveRoom_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3569 -> P.Just (1, ("roomMid",T.TString $ E.encodeUtf8 _v3569))) $ notifyLeaveRoom_args_roomMid record
  ]
...
to_NotifyLeaveRoom_args (T.TStruct fields) = NotifyLeaveRoom_args{
  notifyLeaveRoom_args_roomMid = P.maybe (notifyLeaveRoom_args_roomMid default_NotifyLeaveRoom_args) (\(_,_val3571) -> (case _val3571 of {T.TString _val3572 -> E.decodeUtf8 _val3572; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyLeaveRoom_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3575 -> (1, ("e",from_TalkException _v3575))) <$> notifyLeaveRoom_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3575 -> (1, ("e",from_TalkException _v3575))) <$> notifyLeaveRoom_result_e record
    ]
    )
...
to_NotifyLeaveRoom_result (T.TStruct fields) = NotifyLeaveRoom_result{
  notifyLeaveRoom_result_e = P.maybe (P.Nothing) (\(_,_val3577) -> P.Just (case _val3577 of {T.TStruct _val3578 -> (to_TalkException (T.TStruct _val3578)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBotUseInfo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3581 -> P.Just (2, ("botMid",T.TString $ E.encodeUtf8 _v3581))) $ getBotUseInfo_args_botMid record
  ]
...
to_GetBotUseInfo_args (T.TStruct fields) = GetBotUseInfo_args{
  getBotUseInfo_args_botMid = P.maybe (getBotUseInfo_args_botMid default_GetBotUseInfo_args) (\(_,_val3583) -> (case _val3583 of {T.TString _val3584 -> E.decodeUtf8 _val3584; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetBotUseInfo_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3587 -> (1, ("e",from_TalkException _v3587))) <$> getBotUseInfo_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3587 -> P.Just (0, ("success",from_BotUseInfo _v3587))) $ getBotUseInfo_result_success record
    , (\_v3587 -> (1, ("e",from_TalkException _v3587))) <$> getBotUseInfo_result_e record
    ]
    )
...
to_GetBotUseInfo_result (T.TStruct fields) = GetBotUseInfo_result{
  getBotUseInfo_result_success = P.maybe (getBotUseInfo_result_success default_GetBotUseInfo_result) (\(_,_val3589) -> (case _val3589 of {T.TStruct _val3590 -> (to_BotUseInfo (T.TStruct _val3590)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBotUseInfo_result_e = P.maybe (P.Nothing) (\(_,_val3589) -> P.Just (case _val3589 of {T.TStruct _val3591 -> (to_TalkException (T.TStruct _val3591)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
data SendChatCheckedByWatermark_args = SendChatCheckedByWatermark_args  { sendChatCheckedByWatermark_args_seq :: I.Int32
  ...
  , sendChatCheckedByWatermark_args_sessionId :: I.Int8
  } deriving (P.Show,P.Eq,G.Generic,TY.Typeable)
...
from_SendChatCheckedByWatermark_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3594 -> P.Just (1, ("seq",T.TI32 _v3594))) $ sendChatCheckedByWatermark_args_seq record
  , (\_v3594 -> P.Just (2, ("mid",T.TString $ E.encodeUtf8 _v3594))) $ sendChatCheckedByWatermark_args_mid record
  , (\_v3594 -> P.Just (3, ("watermark",T.TI64 _v3594))) $ sendChatCheckedByWatermark_args_watermark record
  , (\_v3594 -> P.Just (4, ("sessionId",T.TByte _v3594))) $ sendChatCheckedByWatermark_args_sessionId record
  ]
...
to_SendChatCheckedByWatermark_args (T.TStruct fields) = SendChatCheckedByWatermark_args{
  sendChatCheckedByWatermark_args_seq = P.maybe (sendChatCheckedByWatermark_args_seq default_SendChatCheckedByWatermark_args) (\(_,_val3596) -> (case _val3596 of {T.TI32 _val3597 -> _val3597; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sendChatCheckedByWatermark_args_mid = P.maybe (sendChatCheckedByWatermark_args_mid default_SendChatCheckedByWatermark_args) (\(_,_val3596) -> (case _val3596 of {T.TString _val3598 -> E.decodeUtf8 _val3598; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sendChatCheckedByWatermark_args_watermark = P.maybe (sendChatCheckedByWatermark_args_watermark default_SendChatCheckedByWatermark_args) (\(_,_val3596) -> (case _val3596 of {T.TI64 _val3599 -> _val3599; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  sendChatCheckedByWatermark_args_sessionId = P.maybe (sendChatCheckedByWatermark_args_sessionId default_SendChatCheckedByWatermark_args) (\(_,_val3596) -> (case _val3596 of {T.TByte _val3600 -> _val3600; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
typemap_SendChatCheckedByWatermark_args = Map.fromList [(1,("seq",T.T_I32)),(2,("mid",T.T_STRING)),(3,("watermark",T.T_I64)),(4,("sessionId",T.T_BYTE))]
...
from_SendChatCheckedByWatermark_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3603 -> (1, ("e",from_TalkException _v3603))) <$> sendChatCheckedByWatermark_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3603 -> (1, ("e",from_TalkException _v3603))) <$> sendChatCheckedByWatermark_result_e record
    ]
    )
...
to_SendChatCheckedByWatermark_result (T.TStruct fields) = SendChatCheckedByWatermark_result{
  sendChatCheckedByWatermark_result_e = P.maybe (P.Nothing) (\(_,_val3605) -> P.Just (case _val3605 of {T.TStruct _val3606 -> (to_TalkException (T.TStruct _val3606)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
