...
from_ActiveBuddySubscriberCount_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5204 -> (1, ("e",from_TalkException _v5204))) <$> activeBuddySubscriberCount_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5204 -> P.Just (0, ("success",T.TI64 _v5204))) $ activeBuddySubscriberCount_result_success record
    , (\_v5204 -> (1, ("e",from_TalkException _v5204))) <$> activeBuddySubscriberCount_result_e record
    ]
    )
...
to_ActiveBuddySubscriberCount_result (T.TStruct fields) = ActiveBuddySubscriberCount_result{
  activeBuddySubscriberCount_result_success = P.maybe (activeBuddySubscriberCount_result_success default_ActiveBuddySubscriberCount_result) (\(_,_val5206) -> (case _val5206 of {T.TI64 _val5207 -> _val5207; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  activeBuddySubscriberCount_result_e = P.maybe (P.Nothing) (\(_,_val5206) -> P.Just (case _val5206 of {T.TStruct _val5208 -> (to_TalkException (T.TStruct _val5208)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_AddOperationForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5211 -> P.Just (1, ("opType",T.TI32 $ P.fromIntegral $ P.fromEnum _v5211))) $ addOperationForChannel_args_opType record
  , (\_v5211 -> P.Just (2, ("param1",T.TString $ E.encodeUtf8 _v5211))) $ addOperationForChannel_args_param1 record
  , (\_v5211 -> P.Just (3, ("param2",T.TString $ E.encodeUtf8 _v5211))) $ addOperationForChannel_args_param2 record
  , (\_v5211 -> P.Just (4, ("param3",T.TString $ E.encodeUtf8 _v5211))) $ addOperationForChannel_args_param3 record
  ]
...
to_AddOperationForChannel_args (T.TStruct fields) = AddOperationForChannel_args{
  addOperationForChannel_args_opType = P.maybe (addOperationForChannel_args_opType default_AddOperationForChannel_args) (\(_,_val5213) -> (case _val5213 of {T.TI32 _val5214 -> P.toEnum $ P.fromIntegral _val5214; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  addOperationForChannel_args_param1 = P.maybe (addOperationForChannel_args_param1 default_AddOperationForChannel_args) (\(_,_val5213) -> (case _val5213 of {T.TString _val5215 -> E.decodeUtf8 _val5215; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  addOperationForChannel_args_param2 = P.maybe (addOperationForChannel_args_param2 default_AddOperationForChannel_args) (\(_,_val5213) -> (case _val5213 of {T.TString _val5216 -> E.decodeUtf8 _val5216; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  addOperationForChannel_args_param3 = P.maybe (addOperationForChannel_args_param3 default_AddOperationForChannel_args) (\(_,_val5213) -> (case _val5213 of {T.TString _val5217 -> E.decodeUtf8 _val5217; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_AddOperationForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5220 -> (1, ("e",from_TalkException _v5220))) <$> addOperationForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5220 -> (1, ("e",from_TalkException _v5220))) <$> addOperationForChannel_result_e record
    ]
    )
...
to_AddOperationForChannel_result (T.TStruct fields) = AddOperationForChannel_result{
  addOperationForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5222) -> P.Just (case _val5222 of {T.TStruct _val5223 -> (to_TalkException (T.TStruct _val5223)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_DisplayBuddySubscriberCount_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5231 -> (1, ("e",from_TalkException _v5231))) <$> displayBuddySubscriberCount_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5231 -> P.Just (0, ("success",T.TI64 _v5231))) $ displayBuddySubscriberCount_result_success record
    , (\_v5231 -> (1, ("e",from_TalkException _v5231))) <$> displayBuddySubscriberCount_result_e record
    ]
    )
...
to_DisplayBuddySubscriberCount_result (T.TStruct fields) = DisplayBuddySubscriberCount_result{
  displayBuddySubscriberCount_result_success = P.maybe (displayBuddySubscriberCount_result_success default_DisplayBuddySubscriberCount_result) (\(_,_val5233) -> (case _val5233 of {T.TI64 _val5234 -> _val5234; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  displayBuddySubscriberCount_result_e = P.maybe (P.Nothing) (\(_,_val5233) -> P.Just (case _val5233 of {T.TStruct _val5235 -> (to_TalkException (T.TStruct _val5235)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_FindContactByUseridWithoutAbuseBlockForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5238 -> P.Just (2, ("userid",T.TString $ E.encodeUtf8 _v5238))) $ findContactByUseridWithoutAbuseBlockForChannel_args_userid record
  ]
...
to_FindContactByUseridWithoutAbuseBlockForChannel_args (T.TStruct fields) = FindContactByUseridWithoutAbuseBlockForChannel_args{
  findContactByUseridWithoutAbuseBlockForChannel_args_userid = P.maybe (findContactByUseridWithoutAbuseBlockForChannel_args_userid default_FindContactByUseridWithoutAbuseBlockForChannel_args) (\(_,_val5240) -> (case _val5240 of {T.TString _val5241 -> E.decodeUtf8 _val5241; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_FindContactByUseridWithoutAbuseBlockForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5244 -> (1, ("e",from_TalkException _v5244))) <$> findContactByUseridWithoutAbuseBlockForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5244 -> P.Just (0, ("success",from_Contact _v5244))) $ findContactByUseridWithoutAbuseBlockForChannel_result_success record
    , (\_v5244 -> (1, ("e",from_TalkException _v5244))) <$> findContactByUseridWithoutAbuseBlockForChannel_result_e record
    ]
    )
...
to_FindContactByUseridWithoutAbuseBlockForChannel_result (T.TStruct fields) = FindContactByUseridWithoutAbuseBlockForChannel_result{
  findContactByUseridWithoutAbuseBlockForChannel_result_success = P.maybe (findContactByUseridWithoutAbuseBlockForChannel_result_success default_FindContactByUseridWithoutAbuseBlockForChannel_result) (\(_,_val5246) -> (case _val5246 of {T.TStruct _val5247 -> (to_Contact (T.TStruct _val5247)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  findContactByUseridWithoutAbuseBlockForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5246) -> P.Just (case _val5246 of {T.TStruct _val5248 -> (to_TalkException (T.TStruct _val5248)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetAllContactIdsForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5256 -> (1, ("e",from_TalkException _v5256))) <$> getAllContactIdsForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5256 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5258 -> T.TString $ E.encodeUtf8 _v5258) $ Vector.toList _v5256))) $ getAllContactIdsForChannel_result_success record
    , (\_v5256 -> (1, ("e",from_TalkException _v5256))) <$> getAllContactIdsForChannel_result_e record
    ]
    )
...
to_GetAllContactIdsForChannel_result (T.TStruct fields) = GetAllContactIdsForChannel_result{
  getAllContactIdsForChannel_result_success = P.maybe (getAllContactIdsForChannel_result_success default_GetAllContactIdsForChannel_result) (\(_,_val5260) -> (case _val5260 of {T.TList _ _val5261 -> (Vector.fromList $ P.map (\_v5262 -> (case _v5262 of {T.TString _val5263 -> E.decodeUtf8 _val5263; _ -> P.error "wrong type"})) _val5261); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getAllContactIdsForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5260) -> P.Just (case _val5260 of {T.TStruct _val5264 -> (to_TalkException (T.TStruct _val5264)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCompactContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5267 -> P.Just (2, ("lastModifiedTimestamp",T.TI64 _v5267))) $ getCompactContacts_args_lastModifiedTimestamp record
  ]
...
to_GetCompactContacts_args (T.TStruct fields) = GetCompactContacts_args{
  getCompactContacts_args_lastModifiedTimestamp = P.maybe (getCompactContacts_args_lastModifiedTimestamp default_GetCompactContacts_args) (\(_,_val5269) -> (case _val5269 of {T.TI64 _val5270 -> _val5270; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetCompactContacts_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5273 -> (1, ("e",from_TalkException _v5273))) <$> getCompactContacts_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5273 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_CompactContact) $ P.map (\_v5275 -> from_CompactContact _v5275) $ Vector.toList _v5273))) $ getCompactContacts_result_success record
    , (\_v5273 -> (1, ("e",from_TalkException _v5273))) <$> getCompactContacts_result_e record
    ]
    )
...
to_GetCompactContacts_result (T.TStruct fields) = GetCompactContacts_result{
  getCompactContacts_result_success = P.maybe (getCompactContacts_result_success default_GetCompactContacts_result) (\(_,_val5277) -> (case _val5277 of {T.TList _ _val5278 -> (Vector.fromList $ P.map (\_v5279 -> (case _v5279 of {T.TStruct _val5280 -> (to_CompactContact (T.TStruct _val5280)); _ -> P.error "wrong type"})) _val5278); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCompactContacts_result_e = P.maybe (P.Nothing) (\(_,_val5277) -> P.Just (case _val5277 of {T.TStruct _val5281 -> (to_TalkException (T.TStruct _val5281)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetContactsForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5284 -> P.Just (2, ("ids",T.TList T.T_STRING $ P.map (\_v5286 -> T.TString $ E.encodeUtf8 _v5286) $ Vector.toList _v5284))) $ getContactsForChannel_args_ids record
  ]
...
to_GetContactsForChannel_args (T.TStruct fields) = GetContactsForChannel_args{
  getContactsForChannel_args_ids = P.maybe (getContactsForChannel_args_ids default_GetContactsForChannel_args) (\(_,_val5288) -> (case _val5288 of {T.TList _ _val5289 -> (Vector.fromList $ P.map (\_v5290 -> (case _v5290 of {T.TString _val5291 -> E.decodeUtf8 _val5291; _ -> P.error "wrong type"})) _val5289); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetContactsForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5294 -> (1, ("e",from_TalkException _v5294))) <$> getContactsForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5294 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_Contact) $ P.map (\_v5296 -> from_Contact _v5296) $ Vector.toList _v5294))) $ getContactsForChannel_result_success record
    , (\_v5294 -> (1, ("e",from_TalkException _v5294))) <$> getContactsForChannel_result_e record
    ]
    )
...
to_GetContactsForChannel_result (T.TStruct fields) = GetContactsForChannel_result{
  getContactsForChannel_result_success = P.maybe (getContactsForChannel_result_success default_GetContactsForChannel_result) (\(_,_val5298) -> (case _val5298 of {T.TList _ _val5299 -> (Vector.fromList $ P.map (\_v5300 -> (case _v5300 of {T.TStruct _val5301 -> (to_Contact (T.TStruct _val5301)); _ -> P.error "wrong type"})) _val5299); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getContactsForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5298) -> P.Just (case _val5298 of {T.TStruct _val5302 -> (to_TalkException (T.TStruct _val5302)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetDisplayName_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5305 -> P.Just (2, ("mid",T.TString $ E.encodeUtf8 _v5305))) $ getDisplayName_args_mid record
  ]
...
to_GetDisplayName_args (T.TStruct fields) = GetDisplayName_args{
  getDisplayName_args_mid = P.maybe (getDisplayName_args_mid default_GetDisplayName_args) (\(_,_val5307) -> (case _val5307 of {T.TString _val5308 -> E.decodeUtf8 _val5308; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetDisplayName_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5311 -> (1, ("e",from_TalkException _v5311))) <$> getDisplayName_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5311 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5311))) $ getDisplayName_result_success record
    , (\_v5311 -> (1, ("e",from_TalkException _v5311))) <$> getDisplayName_result_e record
    ]
    )
...
to_GetDisplayName_result (T.TStruct fields) = GetDisplayName_result{
  getDisplayName_result_success = P.maybe (getDisplayName_result_success default_GetDisplayName_result) (\(_,_val5313) -> (case _val5313 of {T.TString _val5314 -> E.decodeUtf8 _val5314; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getDisplayName_result_e = P.maybe (P.Nothing) (\(_,_val5313) -> P.Just (case _val5313 of {T.TStruct _val5315 -> (to_TalkException (T.TStruct _val5315)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetFavoriteMidsForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5323 -> (1, ("e",from_TalkException _v5323))) <$> getFavoriteMidsForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5323 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5325 -> T.TString $ E.encodeUtf8 _v5325) $ Vector.toList _v5323))) $ getFavoriteMidsForChannel_result_success record
    , (\_v5323 -> (1, ("e",from_TalkException _v5323))) <$> getFavoriteMidsForChannel_result_e record
    ]
    )
...
to_GetFavoriteMidsForChannel_result (T.TStruct fields) = GetFavoriteMidsForChannel_result{
  getFavoriteMidsForChannel_result_success = P.maybe (getFavoriteMidsForChannel_result_success default_GetFavoriteMidsForChannel_result) (\(_,_val5327) -> (case _val5327 of {T.TList _ _val5328 -> (Vector.fromList $ P.map (\_v5329 -> (case _v5329 of {T.TString _val5330 -> E.decodeUtf8 _val5330; _ -> P.error "wrong type"})) _val5328); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getFavoriteMidsForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5327) -> P.Just (case _val5327 of {T.TStruct _val5331 -> (to_TalkException (T.TStruct _val5331)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetFriendMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5339 -> (1, ("e",from_TalkException _v5339))) <$> getFriendMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5339 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5341 -> T.TString $ E.encodeUtf8 _v5341) $ Vector.toList _v5339))) $ getFriendMids_result_success record
    , (\_v5339 -> (1, ("e",from_TalkException _v5339))) <$> getFriendMids_result_e record
    ]
    )
...
to_GetFriendMids_result (T.TStruct fields) = GetFriendMids_result{
  getFriendMids_result_success = P.maybe (getFriendMids_result_success default_GetFriendMids_result) (\(_,_val5343) -> (case _val5343 of {T.TList _ _val5344 -> (Vector.fromList $ P.map (\_v5345 -> (case _v5345 of {T.TString _val5346 -> E.decodeUtf8 _val5346; _ -> P.error "wrong type"})) _val5344); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getFriendMids_result_e = P.maybe (P.Nothing) (\(_,_val5343) -> P.Just (case _val5343 of {T.TStruct _val5347 -> (to_TalkException (T.TStruct _val5347)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetGroupMemberMids_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5350 -> P.Just (1, ("groupId",T.TString $ E.encodeUtf8 _v5350))) $ getGroupMemberMids_args_groupId record
  ]
...
to_GetGroupMemberMids_args (T.TStruct fields) = GetGroupMemberMids_args{
  getGroupMemberMids_args_groupId = P.maybe (getGroupMemberMids_args_groupId default_GetGroupMemberMids_args) (\(_,_val5352) -> (case _val5352 of {T.TString _val5353 -> E.decodeUtf8 _val5353; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetGroupMemberMids_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5356 -> (1, ("e",from_TalkException _v5356))) <$> getGroupMemberMids_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5356 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5358 -> T.TString $ E.encodeUtf8 _v5358) $ Vector.toList _v5356))) $ getGroupMemberMids_result_success record
    , (\_v5356 -> (1, ("e",from_TalkException _v5356))) <$> getGroupMemberMids_result_e record
    ]
    )
...
to_GetGroupMemberMids_result (T.TStruct fields) = GetGroupMemberMids_result{
  getGroupMemberMids_result_success = P.maybe (getGroupMemberMids_result_success default_GetGroupMemberMids_result) (\(_,_val5360) -> (case _val5360 of {T.TList _ _val5361 -> (Vector.fromList $ P.map (\_v5362 -> (case _v5362 of {T.TString _val5363 -> E.decodeUtf8 _val5363; _ -> P.error "wrong type"})) _val5361); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getGroupMemberMids_result_e = P.maybe (P.Nothing) (\(_,_val5360) -> P.Just (case _val5360 of {T.TStruct _val5364 -> (to_TalkException (T.TStruct _val5364)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetGroupsForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5367 -> P.Just (1, ("groupIds",T.TList T.T_STRING $ P.map (\_v5369 -> T.TString $ E.encodeUtf8 _v5369) $ Vector.toList _v5367))) $ getGroupsForChannel_args_groupIds record
  ]
...
to_GetGroupsForChannel_args (T.TStruct fields) = GetGroupsForChannel_args{
  getGroupsForChannel_args_groupIds = P.maybe (getGroupsForChannel_args_groupIds default_GetGroupsForChannel_args) (\(_,_val5371) -> (case _val5371 of {T.TList _ _val5372 -> (Vector.fromList $ P.map (\_v5373 -> (case _v5373 of {T.TString _val5374 -> E.decodeUtf8 _val5374; _ -> P.error "wrong type"})) _val5372); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetGroupsForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5377 -> (1, ("e",from_TalkException _v5377))) <$> getGroupsForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5377 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_Group) $ P.map (\_v5379 -> from_Group _v5379) $ Vector.toList _v5377))) $ getGroupsForChannel_result_success record
    , (\_v5377 -> (1, ("e",from_TalkException _v5377))) <$> getGroupsForChannel_result_e record
    ]
    )
...
to_GetGroupsForChannel_result (T.TStruct fields) = GetGroupsForChannel_result{
  getGroupsForChannel_result_success = P.maybe (getGroupsForChannel_result_success default_GetGroupsForChannel_result) (\(_,_val5381) -> (case _val5381 of {T.TList _ _val5382 -> (Vector.fromList $ P.map (\_v5383 -> (case _v5383 of {T.TStruct _val5384 -> (to_Group (T.TStruct _val5384)); _ -> P.error "wrong type"})) _val5382); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getGroupsForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5381) -> P.Just (case _val5381 of {T.TStruct _val5385 -> (to_TalkException (T.TStruct _val5385)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetIdentityCredential_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5393 -> (1, ("e",from_TalkException _v5393))) <$> getIdentityCredential_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5393 -> P.Just (0, ("success",from_IdentityCredential _v5393))) $ getIdentityCredential_result_success record
    , (\_v5393 -> (1, ("e",from_TalkException _v5393))) <$> getIdentityCredential_result_e record
    ]
    )
...
to_GetIdentityCredential_result (T.TStruct fields) = GetIdentityCredential_result{
  getIdentityCredential_result_success = P.maybe (getIdentityCredential_result_success default_GetIdentityCredential_result) (\(_,_val5395) -> (case _val5395 of {T.TStruct _val5396 -> (to_IdentityCredential (T.TStruct _val5396)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getIdentityCredential_result_e = P.maybe (P.Nothing) (\(_,_val5395) -> P.Just (case _val5395 of {T.TStruct _val5397 -> (to_TalkException (T.TStruct _val5397)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetJoinedGroupIdsForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5405 -> (1, ("e",from_TalkException _v5405))) <$> getJoinedGroupIdsForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5405 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5407 -> T.TString $ E.encodeUtf8 _v5407) $ Vector.toList _v5405))) $ getJoinedGroupIdsForChannel_result_success record
    , (\_v5405 -> (1, ("e",from_TalkException _v5405))) <$> getJoinedGroupIdsForChannel_result_e record
    ]
    )
...
to_GetJoinedGroupIdsForChannel_result (T.TStruct fields) = GetJoinedGroupIdsForChannel_result{
  getJoinedGroupIdsForChannel_result_success = P.maybe (getJoinedGroupIdsForChannel_result_success default_GetJoinedGroupIdsForChannel_result) (\(_,_val5409) -> (case _val5409 of {T.TList _ _val5410 -> (Vector.fromList $ P.map (\_v5411 -> (case _v5411 of {T.TString _val5412 -> E.decodeUtf8 _val5412; _ -> P.error "wrong type"})) _val5410); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getJoinedGroupIdsForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5409) -> P.Just (case _val5409 of {T.TStruct _val5413 -> (to_TalkException (T.TStruct _val5413)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetMetaProfile_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5421 -> (1, ("e",from_TalkException _v5421))) <$> getMetaProfile_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5421 -> P.Just (0, ("success",from_MetaProfile _v5421))) $ getMetaProfile_result_success record
    , (\_v5421 -> (1, ("e",from_TalkException _v5421))) <$> getMetaProfile_result_e record
    ]
    )
...
to_GetMetaProfile_result (T.TStruct fields) = GetMetaProfile_result{
  getMetaProfile_result_success = P.maybe (getMetaProfile_result_success default_GetMetaProfile_result) (\(_,_val5423) -> (case _val5423 of {T.TStruct _val5424 -> (to_MetaProfile (T.TStruct _val5424)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getMetaProfile_result_e = P.maybe (P.Nothing) (\(_,_val5423) -> P.Just (case _val5423 of {T.TStruct _val5425 -> (to_TalkException (T.TStruct _val5425)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetMid_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5433 -> (1, ("e",from_TalkException _v5433))) <$> getMid_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5433 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5433))) $ getMid_result_success record
    , (\_v5433 -> (1, ("e",from_TalkException _v5433))) <$> getMid_result_e record
    ]
    )
...
to_GetMid_result (T.TStruct fields) = GetMid_result{
  getMid_result_success = P.maybe (getMid_result_success default_GetMid_result) (\(_,_val5435) -> (case _val5435 of {T.TString _val5436 -> E.decodeUtf8 _val5436; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getMid_result_e = P.maybe (P.Nothing) (\(_,_val5435) -> P.Just (case _val5435 of {T.TStruct _val5437 -> (to_TalkException (T.TStruct _val5437)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPrimaryClientForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5445 -> (1, ("e",from_TalkException _v5445))) <$> getPrimaryClientForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5445 -> P.Just (0, ("success",from_SimpleChannelClient _v5445))) $ getPrimaryClientForChannel_result_success record
    , (\_v5445 -> (1, ("e",from_TalkException _v5445))) <$> getPrimaryClientForChannel_result_e record
    ]
    )
...
to_GetPrimaryClientForChannel_result (T.TStruct fields) = GetPrimaryClientForChannel_result{
  getPrimaryClientForChannel_result_success = P.maybe (getPrimaryClientForChannel_result_success default_GetPrimaryClientForChannel_result) (\(_,_val5447) -> (case _val5447 of {T.TStruct _val5448 -> (to_SimpleChannelClient (T.TStruct _val5448)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPrimaryClientForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5447) -> P.Just (case _val5447 of {T.TStruct _val5449 -> (to_TalkException (T.TStruct _val5449)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProfileForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5457 -> (1, ("e",from_TalkException _v5457))) <$> getProfileForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5457 -> P.Just (0, ("success",from_Profile _v5457))) $ getProfileForChannel_result_success record
    , (\_v5457 -> (1, ("e",from_TalkException _v5457))) <$> getProfileForChannel_result_e record
    ]
    )
...
to_GetProfileForChannel_result (T.TStruct fields) = GetProfileForChannel_result{
  getProfileForChannel_result_success = P.maybe (getProfileForChannel_result_success default_GetProfileForChannel_result) (\(_,_val5459) -> (case _val5459 of {T.TStruct _val5460 -> (to_Profile (T.TStruct _val5460)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProfileForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5459) -> P.Just (case _val5459 of {T.TStruct _val5461 -> (to_TalkException (T.TStruct _val5461)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSimpleChannelContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5464 -> P.Just (1, ("ids",T.TList T.T_STRING $ P.map (\_v5466 -> T.TString $ E.encodeUtf8 _v5466) $ Vector.toList _v5464))) $ getSimpleChannelContacts_args_ids record
  ]
...
from_GetSimpleChannelContacts_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5474 -> (1, ("e",from_TalkException _v5474))) <$> getSimpleChannelContacts_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5474 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_SimpleChannelContact) $ P.map (\_v5476 -> from_SimpleChannelContact _v5476) $ Vector.toList _v5474))) $ getSimpleChannelContacts_result_success record
    , (\_v5474 -> (1, ("e",from_TalkException _v5474))) <$> getSimpleChannelContacts_result_e record
    ]
    )
...
to_GetSimpleChannelContacts_result (T.TStruct fields) = GetSimpleChannelContacts_result{
  getSimpleChannelContacts_result_success = P.maybe (getSimpleChannelContacts_result_success default_GetSimpleChannelContacts_result) (\(_,_val5478) -> (case _val5478 of {T.TList _ _val5479 -> (Vector.fromList $ P.map (\_v5480 -> (case _v5480 of {T.TStruct _val5481 -> (to_SimpleChannelContact (T.TStruct _val5481)); _ -> P.error "wrong type"})) _val5479); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSimpleChannelContacts_result_e = P.maybe (P.Nothing) (\(_,_val5478) -> P.Just (case _val5478 of {T.TStruct _val5482 -> (to_TalkException (T.TStruct _val5482)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUserCountryForBilling_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5485 -> P.Just (2, ("country",T.TString $ E.encodeUtf8 _v5485))) $ getUserCountryForBilling_args_country record
  , (\_v5485 -> P.Just (3, ("remoteIp",T.TString $ E.encodeUtf8 _v5485))) $ getUserCountryForBilling_args_remoteIp record
  ]
...
to_GetUserCountryForBilling_args (T.TStruct fields) = GetUserCountryForBilling_args{
  getUserCountryForBilling_args_country = P.maybe (getUserCountryForBilling_args_country default_GetUserCountryForBilling_args) (\(_,_val5487) -> (case _val5487 of {T.TString _val5488 -> E.decodeUtf8 _val5488; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getUserCountryForBilling_args_remoteIp = P.maybe (getUserCountryForBilling_args_remoteIp default_GetUserCountryForBilling_args) (\(_,_val5487) -> (case _val5487 of {T.TString _val5489 -> E.decodeUtf8 _val5489; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetUserCountryForBilling_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5492 -> (1, ("e",from_TalkException _v5492))) <$> getUserCountryForBilling_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5492 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5492))) $ getUserCountryForBilling_result_success record
    , (\_v5492 -> (1, ("e",from_TalkException _v5492))) <$> getUserCountryForBilling_result_e record
    ]
    )
...
to_GetUserCountryForBilling_result (T.TStruct fields) = GetUserCountryForBilling_result{
  getUserCountryForBilling_result_success = P.maybe (getUserCountryForBilling_result_success default_GetUserCountryForBilling_result) (\(_,_val5494) -> (case _val5494 of {T.TString _val5495 -> E.decodeUtf8 _val5495; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUserCountryForBilling_result_e = P.maybe (P.Nothing) (\(_,_val5494) -> P.Just (case _val5494 of {T.TStruct _val5496 -> (to_TalkException (T.TStruct _val5496)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUserCreateTime_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5504 -> (1, ("e",from_TalkException _v5504))) <$> getUserCreateTime_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5504 -> P.Just (0, ("success",T.TI64 _v5504))) $ getUserCreateTime_result_success record
    , (\_v5504 -> (1, ("e",from_TalkException _v5504))) <$> getUserCreateTime_result_e record
    ]
    )
...
to_GetUserCreateTime_result (T.TStruct fields) = GetUserCreateTime_result{
  getUserCreateTime_result_success = P.maybe (getUserCreateTime_result_success default_GetUserCreateTime_result) (\(_,_val5506) -> (case _val5506 of {T.TI64 _val5507 -> _val5507; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUserCreateTime_result_e = P.maybe (P.Nothing) (\(_,_val5506) -> P.Just (case _val5506 of {T.TStruct _val5508 -> (to_TalkException (T.TStruct _val5508)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUserIdentities_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5516 -> (1, ("e",from_TalkException _v5516))) <$> getUserIdentities_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5516 -> P.Just (0, ("success",T.TMap T.T_I32 T.T_STRING $ P.map (\(_k5517,_v5518) -> (T.TI32 $ P.fromIntegral $ P.fromEnum _k5517, T.TString $ E.encodeUtf8 _v5518)) $ Map.toList _v5516))) $ getUserIdentities_result_success record
    , (\_v5516 -> (1, ("e",from_TalkException _v5516))) <$> getUserIdentities_result_e record
    ]
    )
...
to_GetUserIdentities_result (T.TStruct fields) = GetUserIdentities_result{
  getUserIdentities_result_success = P.maybe (getUserIdentities_result_success default_GetUserIdentities_result) (\(_,_val5520) -> (case _val5520 of {T.TMap _ _ _val5521 -> (Map.fromList $ P.map (\(_k5523,_v5522) -> ((case _k5523 of {T.TI32 _val5524 -> P.toEnum $ P.fromIntegral _val5524; _ -> P.error "wrong type"}),(case _v5522 of {T.TString _val5525 -> E.decodeUtf8 _val5525; _ -> P.error "wrong type"}))) _val5521); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUserIdentities_result_e = P.maybe (P.Nothing) (\(_,_val5520) -> P.Just (case _val5520 of {T.TStruct _val5526 -> (to_TalkException (T.TStruct _val5526)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUserLanguage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5534 -> (1, ("e",from_TalkException _v5534))) <$> getUserLanguage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5534 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5534))) $ getUserLanguage_result_success record
    , (\_v5534 -> (1, ("e",from_TalkException _v5534))) <$> getUserLanguage_result_e record
    ]
    )
...
to_GetUserLanguage_result (T.TStruct fields) = GetUserLanguage_result{
  getUserLanguage_result_success = P.maybe (getUserLanguage_result_success default_GetUserLanguage_result) (\(_,_val5536) -> (case _val5536 of {T.TString _val5537 -> E.decodeUtf8 _val5537; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUserLanguage_result_e = P.maybe (P.Nothing) (\(_,_val5536) -> P.Just (case _val5536 of {T.TStruct _val5538 -> (to_TalkException (T.TStruct _val5538)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetUserMidsWhoAddedMe_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5546 -> (1, ("e",from_TalkException _v5546))) <$> getUserMidsWhoAddedMe_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5546 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v5548 -> T.TString $ E.encodeUtf8 _v5548) $ Vector.toList _v5546))) $ getUserMidsWhoAddedMe_result_success record
    , (\_v5546 -> (1, ("e",from_TalkException _v5546))) <$> getUserMidsWhoAddedMe_result_e record
    ]
    )
...
to_GetUserMidsWhoAddedMe_result (T.TStruct fields) = GetUserMidsWhoAddedMe_result{
  getUserMidsWhoAddedMe_result_success = P.maybe (getUserMidsWhoAddedMe_result_success default_GetUserMidsWhoAddedMe_result) (\(_,_val5550) -> (case _val5550 of {T.TList _ _val5551 -> (Vector.fromList $ P.map (\_v5552 -> (case _v5552 of {T.TString _val5553 -> E.decodeUtf8 _val5553; _ -> P.error "wrong type"})) _val5551); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getUserMidsWhoAddedMe_result_e = P.maybe (P.Nothing) (\(_,_val5550) -> P.Just (case _val5550 of {T.TStruct _val5554 -> (to_TalkException (T.TStruct _val5554)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_IsGroupMember_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5557 -> P.Just (1, ("groupId",T.TString $ E.encodeUtf8 _v5557))) $ isGroupMember_args_groupId record
  ]
...
to_IsGroupMember_args (T.TStruct fields) = IsGroupMember_args{
  isGroupMember_args_groupId = P.maybe (isGroupMember_args_groupId default_IsGroupMember_args) (\(_,_val5559) -> (case _val5559 of {T.TString _val5560 -> E.decodeUtf8 _val5560; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_IsGroupMember_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5563 -> (1, ("e",from_TalkException _v5563))) <$> isGroupMember_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5563 -> P.Just (0, ("success",T.TBool _v5563))) $ isGroupMember_result_success record
    , (\_v5563 -> (1, ("e",from_TalkException _v5563))) <$> isGroupMember_result_e record
    ]
    )
...
to_IsGroupMember_result (T.TStruct fields) = IsGroupMember_result{
  isGroupMember_result_success = P.maybe (isGroupMember_result_success default_IsGroupMember_result) (\(_,_val5565) -> (case _val5565 of {T.TBool _val5566 -> _val5566; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  isGroupMember_result_e = P.maybe (P.Nothing) (\(_,_val5565) -> P.Just (case _val5565 of {T.TStruct _val5567 -> (to_TalkException (T.TStruct _val5567)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_IsInContact_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5570 -> P.Just (2, ("mid",T.TString $ E.encodeUtf8 _v5570))) $ isInContact_args_mid record
  ]
...
to_IsInContact_args (T.TStruct fields) = IsInContact_args{
  isInContact_args_mid = P.maybe (isInContact_args_mid default_IsInContact_args) (\(_,_val5572) -> (case _val5572 of {T.TString _val5573 -> E.decodeUtf8 _val5573; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_IsInContact_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5576 -> (1, ("e",from_TalkException _v5576))) <$> isInContact_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5576 -> P.Just (0, ("success",T.TBool _v5576))) $ isInContact_result_success record
    , (\_v5576 -> (1, ("e",from_TalkException _v5576))) <$> isInContact_result_e record
    ]
    )
...
to_IsInContact_result (T.TStruct fields) = IsInContact_result{
  isInContact_result_success = P.maybe (isInContact_result_success default_IsInContact_result) (\(_,_val5578) -> (case _val5578 of {T.TBool _val5579 -> _val5579; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  isInContact_result_e = P.maybe (P.Nothing) (\(_,_val5578) -> P.Just (case _val5578 of {T.TStruct _val5580 -> (to_TalkException (T.TStruct _val5580)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RegisterChannelCP_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5583 -> P.Just (2, ("cpId",T.TString $ E.encodeUtf8 _v5583))) $ registerChannelCP_args_cpId record
  , (\_v5583 -> P.Just (3, ("registerPassword",T.TString $ E.encodeUtf8 _v5583))) $ registerChannelCP_args_registerPassword record
  ]
...
to_RegisterChannelCP_args (T.TStruct fields) = RegisterChannelCP_args{
  registerChannelCP_args_cpId = P.maybe (registerChannelCP_args_cpId default_RegisterChannelCP_args) (\(_,_val5585) -> (case _val5585 of {T.TString _val5586 -> E.decodeUtf8 _val5586; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  registerChannelCP_args_registerPassword = P.maybe (registerChannelCP_args_registerPassword default_RegisterChannelCP_args) (\(_,_val5585) -> (case _val5585 of {T.TString _val5587 -> E.decodeUtf8 _val5587; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_RegisterChannelCP_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5590 -> (1, ("e",from_TalkException _v5590))) <$> registerChannelCP_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5590 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v5590))) $ registerChannelCP_result_success record
    , (\_v5590 -> (1, ("e",from_TalkException _v5590))) <$> registerChannelCP_result_e record
    ]
    )
...
to_RegisterChannelCP_result (T.TStruct fields) = RegisterChannelCP_result{
  registerChannelCP_result_success = P.maybe (registerChannelCP_result_success default_RegisterChannelCP_result) (\(_,_val5592) -> (case _val5592 of {T.TString _val5593 -> E.decodeUtf8 _val5593; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  registerChannelCP_result_e = P.maybe (P.Nothing) (\(_,_val5592) -> P.Just (case _val5592 of {T.TStruct _val5594 -> (to_TalkException (T.TStruct _val5594)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RemoveNotificationStatus_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5597 -> P.Just (2, ("notificationStatus",T.TI32 $ P.fromIntegral $ P.fromEnum _v5597))) $ removeNotificationStatus_args_notificationStatus record
  ]
...
to_RemoveNotificationStatus_args (T.TStruct fields) = RemoveNotificationStatus_args{
  removeNotificationStatus_args_notificationStatus = P.maybe (removeNotificationStatus_args_notificationStatus default_RemoveNotificationStatus_args) (\(_,_val5599) -> (case _val5599 of {T.TI32 _val5600 -> P.toEnum $ P.fromIntegral _val5600; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_RemoveNotificationStatus_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5603 -> (1, ("e",from_TalkException _v5603))) <$> removeNotificationStatus_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5603 -> (1, ("e",from_TalkException _v5603))) <$> removeNotificationStatus_result_e record
    ]
    )
...
to_RemoveNotificationStatus_result (T.TStruct fields) = RemoveNotificationStatus_result{
  removeNotificationStatus_result_e = P.maybe (P.Nothing) (\(_,_val5605) -> P.Just (case _val5605 of {T.TStruct _val5606 -> (to_TalkException (T.TStruct _val5606)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendMessageForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5609 -> P.Just (2, ("message",from_Message _v5609))) $ sendMessageForChannel_args_message record
  ]
...
to_SendMessageForChannel_args (T.TStruct fields) = SendMessageForChannel_args{
  sendMessageForChannel_args_message = P.maybe (sendMessageForChannel_args_message default_SendMessageForChannel_args) (\(_,_val5611) -> (case _val5611 of {T.TStruct _val5612 -> (to_Message (T.TStruct _val5612)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_SendMessageForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5615 -> (1, ("e",from_TalkException _v5615))) <$> sendMessageForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5615 -> P.Just (0, ("success",from_Message _v5615))) $ sendMessageForChannel_result_success record
    , (\_v5615 -> (1, ("e",from_TalkException _v5615))) <$> sendMessageForChannel_result_e record
    ]
    )
...
to_SendMessageForChannel_result (T.TStruct fields) = SendMessageForChannel_result{
  sendMessageForChannel_result_success = P.maybe (sendMessageForChannel_result_success default_SendMessageForChannel_result) (\(_,_val5617) -> (case _val5617 of {T.TStruct _val5618 -> (to_Message (T.TStruct _val5618)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  sendMessageForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5617) -> P.Just (case _val5617 of {T.TStruct _val5619 -> (to_TalkException (T.TStruct _val5619)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendPinCodeOperation_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5622 -> P.Just (1, ("verifier",T.TString $ E.encodeUtf8 _v5622))) $ sendPinCodeOperation_args_verifier record
  ]
...
to_SendPinCodeOperation_args (T.TStruct fields) = SendPinCodeOperation_args{
  sendPinCodeOperation_args_verifier = P.maybe (sendPinCodeOperation_args_verifier default_SendPinCodeOperation_args) (\(_,_val5624) -> (case _val5624 of {T.TString _val5625 -> E.decodeUtf8 _val5625; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_SendPinCodeOperation_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5628 -> (1, ("e",from_TalkException _v5628))) <$> sendPinCodeOperation_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5628 -> (1, ("e",from_TalkException _v5628))) <$> sendPinCodeOperation_result_e record
    ]
    )
...
to_SendPinCodeOperation_result (T.TStruct fields) = SendPinCodeOperation_result{
  sendPinCodeOperation_result_e = P.maybe (P.Nothing) (\(_,_val5630) -> P.Just (case _val5630 of {T.TStruct _val5631 -> (to_TalkException (T.TStruct _val5631)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateProfileAttributeForChannel_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5634 -> P.Just (2, ("profileAttribute",T.TI32 $ P.fromIntegral $ P.fromEnum _v5634))) $ updateProfileAttributeForChannel_args_profileAttribute record
  , (\_v5634 -> P.Just (3, ("value",T.TString $ E.encodeUtf8 _v5634))) $ updateProfileAttributeForChannel_args_value record
  ]
...
to_UpdateProfileAttributeForChannel_args (T.TStruct fields) = UpdateProfileAttributeForChannel_args{
  updateProfileAttributeForChannel_args_profileAttribute = P.maybe (updateProfileAttributeForChannel_args_profileAttribute default_UpdateProfileAttributeForChannel_args) (\(_,_val5636) -> (case _val5636 of {T.TI32 _val5637 -> P.toEnum $ P.fromIntegral _val5637; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  updateProfileAttributeForChannel_args_value = P.maybe (updateProfileAttributeForChannel_args_value default_UpdateProfileAttributeForChannel_args) (\(_,_val5636) -> (case _val5636 of {T.TString _val5638 -> E.decodeUtf8 _val5638; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_UpdateProfileAttributeForChannel_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v5641 -> (1, ("e",from_TalkException _v5641))) <$> updateProfileAttributeForChannel_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v5641 -> (1, ("e",from_TalkException _v5641))) <$> updateProfileAttributeForChannel_result_e record
    ]
    )
...
to_UpdateProfileAttributeForChannel_result (T.TStruct fields) = UpdateProfileAttributeForChannel_result{
  updateProfileAttributeForChannel_result_e = P.maybe (P.Nothing) (\(_,_val5643) -> P.Just (case _val5643 of {T.TStruct _val5644 -> (to_TalkException (T.TStruct _val5644)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
