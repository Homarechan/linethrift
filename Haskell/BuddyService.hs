...
from_FindBuddyContactsByQuery_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5043 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v5043))) $ findBuddyContactsByQuery_args_language record
  , (\_v5043 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5043))) $ findBuddyContactsByQuery_args_country record
  , (\_v5043 -> P.Just (4, ("query",T.TString $ E.encodeUtf8 _v5043))) $ findBuddyContactsByQuery_args_query record
  , (\_v5043 -> P.Just (5, ("fromIndex",T.TI32 _v5043))) $ findBuddyContactsByQuery_args_fromIndex record
  , (\_v5043 -> P.Just (6, ("count",T.TI32 _v5043))) $ findBuddyContactsByQuery_args_count record
  , (\_v5043 -> P.Just (7, ("requestSource",T.TI32 $ P.fromIntegral $ P.fromEnum _v5043))) $ findBuddyContactsByQuery_args_requestSource record
  ]
...
to_FindBuddyContactsByQuery_args (T.TStruct fields) = FindBuddyContactsByQuery_args{
  findBuddyContactsByQuery_args_language = P.maybe (findBuddyContactsByQuery_args_language default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TString _val5046 -> E.decodeUtf8 _val5046; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  findBuddyContactsByQuery_args_country = P.maybe (findBuddyContactsByQuery_args_country default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TString _val5047 -> E.decodeUtf8 _val5047; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  findBuddyContactsByQuery_args_query = P.maybe (findBuddyContactsByQuery_args_query default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TString _val5048 -> E.decodeUtf8 _val5048; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  findBuddyContactsByQuery_args_fromIndex = P.maybe (findBuddyContactsByQuery_args_fromIndex default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TI32 _val5049 -> _val5049; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  findBuddyContactsByQuery_args_count = P.maybe (findBuddyContactsByQuery_args_count default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TI32 _val5050 -> _val5050; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  findBuddyContactsByQuery_args_requestSource = P.maybe (findBuddyContactsByQuery_args_requestSource default_FindBuddyContactsByQuery_args) (\(_,_val5045) -> (case _val5045 of {T.TI32 _val5051 -> P.toEnum $ P.fromIntegral _val5051; _ -> P.error "wrong type"})) (Map.lookup (7) fields)
  }
...
from_FindBuddyContactsByQuery_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5054 -> (1, ("e",from_TalkException _v5054))) <$> findBuddyContactsByQuery_result_e record
    ]
    )
...
to_FindBuddyContactsByQuery_result (T.TStruct fields) = FindBuddyContactsByQuery_result{
  findBuddyContactsByQuery_result_success = P.maybe (findBuddyContactsByQuery_result_success default_FindBuddyContactsByQuery_result) (\(_,_val5058) -> (case _val5058 of {T.TList _ _val5059 -> (Vector.fromList $ P.map (\_v5060 -> (case _v5060 of {T.TStruct _val5061 -> (to_BuddySearchResult (T.TStruct _val5061)); _ -> P.error "wrong type"})) _val5059); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  findBuddyContactsByQuery_result_e = P.maybe (P.Nothing) (\(_,_val5058) -> P.Just (case _val5058 of {T.TStruct _val5062 -> (to_TalkException (T.TStruct _val5062)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5065 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v5065))) $ getBuddyContacts_args_language record
  , (\_v5065 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5065))) $ getBuddyContacts_args_country record
  , (\_v5065 -> P.Just (4, ("classification",T.TString $ E.encodeUtf8 _v5065))) $ getBuddyContacts_args_classification record
  , (\_v5065 -> P.Just (5, ("fromIndex",T.TI32 _v5065))) $ getBuddyContacts_args_fromIndex record
  , (\_v5065 -> P.Just (6, ("count",T.TI32 _v5065))) $ getBuddyContacts_args_count record
  ]
...
to_GetBuddyContacts_args (T.TStruct fields) = GetBuddyContacts_args{
  getBuddyContacts_args_language = P.maybe (getBuddyContacts_args_language default_GetBuddyContacts_args) (\(_,_val5067) -> (case _val5067 of {T.TString _val5068 -> E.decodeUtf8 _val5068; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getBuddyContacts_args_country = P.maybe (getBuddyContacts_args_country default_GetBuddyContacts_args) (\(_,_val5067) -> (case _val5067 of {T.TString _val5069 -> E.decodeUtf8 _val5069; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getBuddyContacts_args_classification = P.maybe (getBuddyContacts_args_classification default_GetBuddyContacts_args) (\(_,_val5067) -> (case _val5067 of {T.TString _val5070 -> E.decodeUtf8 _val5070; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getBuddyContacts_args_fromIndex = P.maybe (getBuddyContacts_args_fromIndex default_GetBuddyContacts_args) (\(_,_val5067) -> (case _val5067 of {T.TI32 _val5071 -> _val5071; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  getBuddyContacts_args_count = P.maybe (getBuddyContacts_args_count default_GetBuddyContacts_args) (\(_,_val5067) -> (case _val5067 of {T.TI32 _val5072 -> _val5072; _ -> P.error "wrong type"})) (Map.lookup (6) fields)
  }
...
from_GetBuddyContacts_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5075 -> (1, ("e",from_TalkException _v5075))) <$> getBuddyContacts_result_e record
    ]
    )
...
to_GetBuddyContacts_result (T.TStruct fields) = GetBuddyContacts_result{
  getBuddyContacts_result_success = P.maybe (getBuddyContacts_result_success default_GetBuddyContacts_result) (\(_,_val5079) -> (case _val5079 of {T.TList _ _val5080 -> (Vector.fromList $ P.map (\_v5081 -> (case _v5081 of {T.TStruct _val5082 -> (to_Contact (T.TStruct _val5082)); _ -> P.error "wrong type"})) _val5080); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyContacts_result_e = P.maybe (P.Nothing) (\(_,_val5079) -> P.Just (case _val5079 of {T.TStruct _val5083 -> (to_TalkException (T.TStruct _val5083)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyDetail_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5086 -> P.Just (4, ("buddyMid",T.TString $ E.encodeUtf8 _v5086))) $ getBuddyDetail_args_buddyMid record
  ]
...
to_GetBuddyDetail_args (T.TStruct fields) = GetBuddyDetail_args{
  getBuddyDetail_args_buddyMid = P.maybe (getBuddyDetail_args_buddyMid default_GetBuddyDetail_args) (\(_,_val5088) -> (case _val5088 of {T.TString _val5089 -> E.decodeUtf8 _val5089; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetBuddyDetail_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5092 -> (1, ("e",from_TalkException _v5092))) <$> getBuddyDetail_result_e record
    ]
    )
...
to_GetBuddyDetail_result (T.TStruct fields) = GetBuddyDetail_result{
  getBuddyDetail_result_success = P.maybe (getBuddyDetail_result_success default_GetBuddyDetail_result) (\(_,_val5094) -> (case _val5094 of {T.TStruct _val5095 -> (to_BuddyDetail (T.TStruct _val5095)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyDetail_result_e = P.maybe (P.Nothing) (\(_,_val5094) -> P.Just (case _val5094 of {T.TStruct _val5096 -> (to_TalkException (T.TStruct _val5096)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyOnAir_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5099 -> P.Just (4, ("buddyMid",T.TString $ E.encodeUtf8 _v5099))) $ getBuddyOnAir_args_buddyMid record
  ]
...
to_GetBuddyOnAir_args (T.TStruct fields) = GetBuddyOnAir_args{
  getBuddyOnAir_args_buddyMid = P.maybe (getBuddyOnAir_args_buddyMid default_GetBuddyOnAir_args) (\(_,_val5101) -> (case _val5101 of {T.TString _val5102 -> E.decodeUtf8 _val5102; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetBuddyOnAir_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5105 -> (1, ("e",from_TalkException _v5105))) <$> getBuddyOnAir_result_e record
    ]
    )
...
to_GetBuddyOnAir_result (T.TStruct fields) = GetBuddyOnAir_result{
  getBuddyOnAir_result_success = P.maybe (getBuddyOnAir_result_success default_GetBuddyOnAir_result) (\(_,_val5107) -> (case _val5107 of {T.TStruct _val5108 -> (to_BuddyOnAir (T.TStruct _val5108)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyOnAir_result_e = P.maybe (P.Nothing) (\(_,_val5107) -> P.Just (case _val5107 of {T.TStruct _val5109 -> (to_TalkException (T.TStruct _val5109)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCountriesHavingBuddy_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5117 -> (1, ("e",from_TalkException _v5117))) <$> getCountriesHavingBuddy_result_e record
    ]
    )
...
to_GetCountriesHavingBuddy_result (T.TStruct fields) = GetCountriesHavingBuddy_result{
  getCountriesHavingBuddy_result_success = P.maybe (getCountriesHavingBuddy_result_success default_GetCountriesHavingBuddy_result) (\(_,_val5121) -> (case _val5121 of {T.TList _ _val5122 -> (Vector.fromList $ P.map (\_v5123 -> (case _v5123 of {T.TString _val5124 -> E.decodeUtf8 _val5124; _ -> P.error "wrong type"})) _val5122); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCountriesHavingBuddy_result_e = P.maybe (P.Nothing) (\(_,_val5121) -> P.Just (case _val5121 of {T.TStruct _val5125 -> (to_TalkException (T.TStruct _val5125)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetNewlyReleasedBuddyIds_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5128 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5128))) $ getNewlyReleasedBuddyIds_args_country record
  ]
...
to_GetNewlyReleasedBuddyIds_args (T.TStruct fields) = GetNewlyReleasedBuddyIds_args{
  getNewlyReleasedBuddyIds_args_country = P.maybe (getNewlyReleasedBuddyIds_args_country default_GetNewlyReleasedBuddyIds_args) (\(_,_val5130) -> (case _val5130 of {T.TString _val5131 -> E.decodeUtf8 _val5131; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetNewlyReleasedBuddyIds_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5134 -> (1, ("e",from_TalkException _v5134))) <$> getNewlyReleasedBuddyIds_result_e record
    ]
    )
...
to_GetNewlyReleasedBuddyIds_result (T.TStruct fields) = GetNewlyReleasedBuddyIds_result{
  getNewlyReleasedBuddyIds_result_success = P.maybe (getNewlyReleasedBuddyIds_result_success default_GetNewlyReleasedBuddyIds_result) (\(_,_val5138) -> (case _val5138 of {T.TMap _ _ _val5139 -> (Map.fromList $ P.map (\(_k5141,_v5140) -> ((case _k5141 of {T.TString _val5142 -> E.decodeUtf8 _val5142; _ -> P.error "wrong type"}),(case _v5140 of {T.TI64 _val5143 -> _val5143; _ -> P.error "wrong type"}))) _val5139); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getNewlyReleasedBuddyIds_result_e = P.maybe (P.Nothing) (\(_,_val5138) -> P.Just (case _val5138 of {T.TStruct _val5144 -> (to_TalkException (T.TStruct _val5144)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularBuddyBanner_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5147 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v5147))) $ getPopularBuddyBanner_args_language record
  , (\_v5147 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5147))) $ getPopularBuddyBanner_args_country record
  , (\_v5147 -> P.Just (4, ("applicationType",T.TI32 $ P.fromIntegral $ P.fromEnum _v5147))) $ getPopularBuddyBanner_args_applicationType record
  , (\_v5147 -> P.Just (5, ("resourceSpecification",T.TString $ E.encodeUtf8 _v5147))) $ getPopularBuddyBanner_args_resourceSpecification record
  ]
...
to_GetPopularBuddyBanner_args (T.TStruct fields) = GetPopularBuddyBanner_args{
  getPopularBuddyBanner_args_language = P.maybe (getPopularBuddyBanner_args_language default_GetPopularBuddyBanner_args) (\(_,_val5149) -> (case _val5149 of {T.TString _val5150 -> E.decodeUtf8 _val5150; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularBuddyBanner_args_country = P.maybe (getPopularBuddyBanner_args_country default_GetPopularBuddyBanner_args) (\(_,_val5149) -> (case _val5149 of {T.TString _val5151 -> E.decodeUtf8 _val5151; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPopularBuddyBanner_args_applicationType = P.maybe (getPopularBuddyBanner_args_applicationType default_GetPopularBuddyBanner_args) (\(_,_val5149) -> (case _val5149 of {T.TI32 _val5152 -> P.toEnum $ P.fromIntegral _val5152; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPopularBuddyBanner_args_resourceSpecification = P.maybe (getPopularBuddyBanner_args_resourceSpecification default_GetPopularBuddyBanner_args) (\(_,_val5149) -> (case _val5149 of {T.TString _val5153 -> E.decodeUtf8 _val5153; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPopularBuddyBanner_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5156 -> (1, ("e",from_TalkException _v5156))) <$> getPopularBuddyBanner_result_e record
    ]
    )
...
to_GetPopularBuddyBanner_result (T.TStruct fields) = GetPopularBuddyBanner_result{
  getPopularBuddyBanner_result_success = P.maybe (getPopularBuddyBanner_result_success default_GetPopularBuddyBanner_result) (\(_,_val5158) -> (case _val5158 of {T.TStruct _val5159 -> (to_BuddyBanner (T.TStruct _val5159)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularBuddyBanner_result_e = P.maybe (P.Nothing) (\(_,_val5158) -> P.Just (case _val5158 of {T.TStruct _val5160 -> (to_TalkException (T.TStruct _val5160)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularBuddyLists_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5163 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v5163))) $ getPopularBuddyLists_args_language record
  , (\_v5163 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5163))) $ getPopularBuddyLists_args_country record
  ]
...
to_GetPopularBuddyLists_args (T.TStruct fields) = GetPopularBuddyLists_args{
  getPopularBuddyLists_args_language = P.maybe (getPopularBuddyLists_args_language default_GetPopularBuddyLists_args) (\(_,_val5165) -> (case _val5165 of {T.TString _val5166 -> E.decodeUtf8 _val5166; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularBuddyLists_args_country = P.maybe (getPopularBuddyLists_args_country default_GetPopularBuddyLists_args) (\(_,_val5165) -> (case _val5165 of {T.TString _val5167 -> E.decodeUtf8 _val5167; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetPopularBuddyLists_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5170 -> (1, ("e",from_TalkException _v5170))) <$> getPopularBuddyLists_result_e record
    ]
    )
...
to_GetPopularBuddyLists_result (T.TStruct fields) = GetPopularBuddyLists_result{
  getPopularBuddyLists_result_success = P.maybe (getPopularBuddyLists_result_success default_GetPopularBuddyLists_result) (\(_,_val5174) -> (case _val5174 of {T.TList _ _val5175 -> (Vector.fromList $ P.map (\_v5176 -> (case _v5176 of {T.TStruct _val5177 -> (to_BuddyList (T.TStruct _val5177)); _ -> P.error "wrong type"})) _val5175); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularBuddyLists_result_e = P.maybe (P.Nothing) (\(_,_val5174) -> P.Just (case _val5174 of {T.TStruct _val5178 -> (to_TalkException (T.TStruct _val5178)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPromotedBuddyContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5181 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v5181))) $ getPromotedBuddyContacts_args_language record
  , (\_v5181 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v5181))) $ getPromotedBuddyContacts_args_country record
  ]
...
to_GetPromotedBuddyContacts_args (T.TStruct fields) = GetPromotedBuddyContacts_args{
  getPromotedBuddyContacts_args_language = P.maybe (getPromotedBuddyContacts_args_language default_GetPromotedBuddyContacts_args) (\(_,_val5183) -> (case _val5183 of {T.TString _val5184 -> E.decodeUtf8 _val5184; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPromotedBuddyContacts_args_country = P.maybe (getPromotedBuddyContacts_args_country default_GetPromotedBuddyContacts_args) (\(_,_val5183) -> (case _val5183 of {T.TString _val5185 -> E.decodeUtf8 _val5185; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetPromotedBuddyContacts_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5188 -> (1, ("e",from_TalkException _v5188))) <$> getPromotedBuddyContacts_result_e record
    ]
    )
...
to_GetPromotedBuddyContacts_result (T.TStruct fields) = GetPromotedBuddyContacts_result{
  getPromotedBuddyContacts_result_success = P.maybe (getPromotedBuddyContacts_result_success default_GetPromotedBuddyContacts_result) (\(_,_val5192) -> (case _val5192 of {T.TList _ _val5193 -> (Vector.fromList $ P.map (\_v5194 -> (case _v5194 of {T.TStruct _val5195 -> (to_Contact (T.TStruct _val5195)); _ -> P.error "wrong type"})) _val5193); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPromotedBuddyContacts_result_e = P.maybe (P.Nothing) (\(_,_val5192) -> P.Just (case _val5192 of {T.TStruct _val5196 -> (to_TalkException (T.TStruct _val5196)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
