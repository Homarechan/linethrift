...
from_BuyCoinProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6030 -> P.Just (2, ("paymentReservation",from_PaymentReservation _v6030))) $ buyCoinProduct_args_paymentReservation record
  ]
...
to_BuyCoinProduct_args (T.TStruct fields) = BuyCoinProduct_args{
  buyCoinProduct_args_paymentReservation = P.maybe (buyCoinProduct_args_paymentReservation default_BuyCoinProduct_args) (\(_,_val6032) -> (case _val6032 of {T.TStruct _val6033 -> (to_PaymentReservation (T.TStruct _val6033)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
to_BuyCoinProduct_result (T.TStruct fields) = BuyCoinProduct_result{
  buyCoinProduct_result_e = P.maybe (P.Nothing) (\(_,_val6038) -> P.Just (case _val6038 of {T.TStruct _val6039 -> (to_TalkException (T.TStruct _val6039)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_BuyFreeProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6042 -> P.Just (2, ("receiverMid",T.TString $ E.encodeUtf8 _v6042))) $ buyFreeProduct_args_receiverMid record
  , (\_v6042 -> P.Just (3, ("productId",T.TString $ E.encodeUtf8 _v6042))) $ buyFreeProduct_args_productId record
  , (\_v6042 -> P.Just (4, ("messageTemplate",T.TI32 _v6042))) $ buyFreeProduct_args_messageTemplate record
  , (\_v6042 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v6042))) $ buyFreeProduct_args_language record
  , (\_v6042 -> P.Just (6, ("country",T.TString $ E.encodeUtf8 _v6042))) $ buyFreeProduct_args_country record
  , (\_v6042 -> P.Just (7, ("packageId",T.TI64 _v6042))) $ buyFreeProduct_args_packageId record
  ]
...
to_BuyFreeProduct_args (T.TStruct fields) = BuyFreeProduct_args{
  buyFreeProduct_args_receiverMid = P.maybe (buyFreeProduct_args_receiverMid default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TString _val6045 -> E.decodeUtf8 _val6045; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  buyFreeProduct_args_productId = P.maybe (buyFreeProduct_args_productId default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TString _val6046 -> E.decodeUtf8 _val6046; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  buyFreeProduct_args_messageTemplate = P.maybe (buyFreeProduct_args_messageTemplate default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TI32 _val6047 -> _val6047; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  buyFreeProduct_args_language = P.maybe (buyFreeProduct_args_language default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TString _val6048 -> E.decodeUtf8 _val6048; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  buyFreeProduct_args_country = P.maybe (buyFreeProduct_args_country default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TString _val6049 -> E.decodeUtf8 _val6049; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  buyFreeProduct_args_packageId = P.maybe (buyFreeProduct_args_packageId default_BuyFreeProduct_args) (\(_,_val6044) -> (case _val6044 of {T.TI64 _val6050 -> _val6050; _ -> P.error "wrong type"})) (Map.lookup (7) fields)
  }
...
to_BuyFreeProduct_result (T.TStruct fields) = BuyFreeProduct_result{
  buyFreeProduct_result_e = P.maybe (P.Nothing) (\(_,_val6055) -> P.Just (case _val6055 of {T.TStruct _val6056 -> (to_TalkException (T.TStruct _val6056)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_BuyMustbuyProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6059 -> P.Just (2, ("receiverMid",T.TString $ E.encodeUtf8 _v6059))) $ buyMustbuyProduct_args_receiverMid record
  , (\_v6059 -> P.Just (3, ("productId",T.TString $ E.encodeUtf8 _v6059))) $ buyMustbuyProduct_args_productId record
  , (\_v6059 -> P.Just (4, ("messageTemplate",T.TI32 _v6059))) $ buyMustbuyProduct_args_messageTemplate record
  , (\_v6059 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v6059))) $ buyMustbuyProduct_args_language record
  , (\_v6059 -> P.Just (6, ("country",T.TString $ E.encodeUtf8 _v6059))) $ buyMustbuyProduct_args_country record
  , (\_v6059 -> P.Just (7, ("packageId",T.TI64 _v6059))) $ buyMustbuyProduct_args_packageId record
  , (\_v6059 -> P.Just (8, ("serialNumber",T.TString $ E.encodeUtf8 _v6059))) $ buyMustbuyProduct_args_serialNumber record
  ]
...
to_BuyMustbuyProduct_args (T.TStruct fields) = BuyMustbuyProduct_args{
  buyMustbuyProduct_args_receiverMid = P.maybe (buyMustbuyProduct_args_receiverMid default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TString _val6062 -> E.decodeUtf8 _val6062; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  buyMustbuyProduct_args_productId = P.maybe (buyMustbuyProduct_args_productId default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TString _val6063 -> E.decodeUtf8 _val6063; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  buyMustbuyProduct_args_messageTemplate = P.maybe (buyMustbuyProduct_args_messageTemplate default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TI32 _val6064 -> _val6064; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  buyMustbuyProduct_args_language = P.maybe (buyMustbuyProduct_args_language default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TString _val6065 -> E.decodeUtf8 _val6065; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  buyMustbuyProduct_args_country = P.maybe (buyMustbuyProduct_args_country default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TString _val6066 -> E.decodeUtf8 _val6066; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  buyMustbuyProduct_args_packageId = P.maybe (buyMustbuyProduct_args_packageId default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TI64 _val6067 -> _val6067; _ -> P.error "wrong type"})) (Map.lookup (7) fields),
  buyMustbuyProduct_args_serialNumber = P.maybe (buyMustbuyProduct_args_serialNumber default_BuyMustbuyProduct_args) (\(_,_val6061) -> (case _val6061 of {T.TString _val6068 -> E.decodeUtf8 _val6068; _ -> P.error "wrong type"})) (Map.lookup (8) fields)
  }
...
to_BuyMustbuyProduct_result (T.TStruct fields) = BuyMustbuyProduct_result{
  buyMustbuyProduct_result_e = P.maybe (P.Nothing) (\(_,_val6073) -> P.Just (case _val6073 of {T.TStruct _val6074 -> (to_TalkException (T.TStruct _val6074)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CheckCanReceivePresent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6077 -> P.Just (2, ("recipientMid",T.TString $ E.encodeUtf8 _v6077))) $ checkCanReceivePresent_args_recipientMid record
  , (\_v6077 -> P.Just (3, ("packageId",T.TI64 _v6077))) $ checkCanReceivePresent_args_packageId record
  , (\_v6077 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6077))) $ checkCanReceivePresent_args_language record
  , (\_v6077 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6077))) $ checkCanReceivePresent_args_country record
  ]
...
to_CheckCanReceivePresent_args (T.TStruct fields) = CheckCanReceivePresent_args{
  checkCanReceivePresent_args_recipientMid = P.maybe (checkCanReceivePresent_args_recipientMid default_CheckCanReceivePresent_args) (\(_,_val6079) -> (case _val6079 of {T.TString _val6080 -> E.decodeUtf8 _val6080; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkCanReceivePresent_args_packageId = P.maybe (checkCanReceivePresent_args_packageId default_CheckCanReceivePresent_args) (\(_,_val6079) -> (case _val6079 of {T.TI64 _val6081 -> _val6081; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkCanReceivePresent_args_language = P.maybe (checkCanReceivePresent_args_language default_CheckCanReceivePresent_args) (\(_,_val6079) -> (case _val6079 of {T.TString _val6082 -> E.decodeUtf8 _val6082; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  checkCanReceivePresent_args_country = P.maybe (checkCanReceivePresent_args_country default_CheckCanReceivePresent_args) (\(_,_val6079) -> (case _val6079 of {T.TString _val6083 -> E.decodeUtf8 _val6083; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
to_CheckCanReceivePresent_result (T.TStruct fields) = CheckCanReceivePresent_result{
  checkCanReceivePresent_result_e = P.maybe (P.Nothing) (\(_,_val6088) -> P.Just (case _val6088 of {T.TStruct _val6089 -> (to_TalkException (T.TStruct _val6089)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActivePurchases_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6092 -> P.Just (2, ("start",T.TI64 _v6092))) $ getActivePurchases_args_start record
  , (\_v6092 -> P.Just (3, ("size",T.TI32 _v6092))) $ getActivePurchases_args_size record
  , (\_v6092 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6092))) $ getActivePurchases_args_language record
  , (\_v6092 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6092))) $ getActivePurchases_args_country record
  ]
...
to_GetActivePurchases_args (T.TStruct fields) = GetActivePurchases_args{
  getActivePurchases_args_start = P.maybe (getActivePurchases_args_start default_GetActivePurchases_args) (\(_,_val6094) -> (case _val6094 of {T.TI64 _val6095 -> _val6095; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getActivePurchases_args_size = P.maybe (getActivePurchases_args_size default_GetActivePurchases_args) (\(_,_val6094) -> (case _val6094 of {T.TI32 _val6096 -> _val6096; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getActivePurchases_args_language = P.maybe (getActivePurchases_args_language default_GetActivePurchases_args) (\(_,_val6094) -> (case _val6094 of {T.TString _val6097 -> E.decodeUtf8 _val6097; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getActivePurchases_args_country = P.maybe (getActivePurchases_args_country default_GetActivePurchases_args) (\(_,_val6094) -> (case _val6094 of {T.TString _val6098 -> E.decodeUtf8 _val6098; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetActivePurchases_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6101 -> (1, ("e",from_TalkException _v6101))) <$> getActivePurchases_result_e record
    ]
    )
...
to_GetActivePurchases_result (T.TStruct fields) = GetActivePurchases_result{
  getActivePurchases_result_success = P.maybe (getActivePurchases_result_success default_GetActivePurchases_result) (\(_,_val6103) -> (case _val6103 of {T.TStruct _val6104 -> (to_ProductList (T.TStruct _val6104)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActivePurchases_result_e = P.maybe (P.Nothing) (\(_,_val6103) -> P.Just (case _val6103 of {T.TStruct _val6105 -> (to_TalkException (T.TStruct _val6105)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActivePurchaseVersions_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6108 -> P.Just (2, ("start",T.TI64 _v6108))) $ getActivePurchaseVersions_args_start record
  , (\_v6108 -> P.Just (3, ("size",T.TI32 _v6108))) $ getActivePurchaseVersions_args_size record
  , (\_v6108 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6108))) $ getActivePurchaseVersions_args_language record
  , (\_v6108 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6108))) $ getActivePurchaseVersions_args_country record
  ]
...
to_GetActivePurchaseVersions_args (T.TStruct fields) = GetActivePurchaseVersions_args{
  getActivePurchaseVersions_args_start = P.maybe (getActivePurchaseVersions_args_start default_GetActivePurchaseVersions_args) (\(_,_val6110) -> (case _val6110 of {T.TI64 _val6111 -> _val6111; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getActivePurchaseVersions_args_size = P.maybe (getActivePurchaseVersions_args_size default_GetActivePurchaseVersions_args) (\(_,_val6110) -> (case _val6110 of {T.TI32 _val6112 -> _val6112; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getActivePurchaseVersions_args_language = P.maybe (getActivePurchaseVersions_args_language default_GetActivePurchaseVersions_args) (\(_,_val6110) -> (case _val6110 of {T.TString _val6113 -> E.decodeUtf8 _val6113; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getActivePurchaseVersions_args_country = P.maybe (getActivePurchaseVersions_args_country default_GetActivePurchaseVersions_args) (\(_,_val6110) -> (case _val6110 of {T.TString _val6114 -> E.decodeUtf8 _val6114; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetActivePurchaseVersions_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6117 -> (1, ("e",from_TalkException _v6117))) <$> getActivePurchaseVersions_result_e record
    ]
    )
...
to_GetActivePurchaseVersions_result (T.TStruct fields) = GetActivePurchaseVersions_result{
  getActivePurchaseVersions_result_success = P.maybe (getActivePurchaseVersions_result_success default_GetActivePurchaseVersions_result) (\(_,_val6119) -> (case _val6119 of {T.TStruct _val6120 -> (to_ProductSimpleList (T.TStruct _val6120)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActivePurchaseVersions_result_e = P.maybe (P.Nothing) (\(_,_val6119) -> P.Just (case _val6119 of {T.TStruct _val6121 -> (to_TalkException (T.TStruct _val6121)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinProducts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6124 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v6124))) $ getCoinProducts_args_appStoreCode record
  , (\_v6124 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v6124))) $ getCoinProducts_args_country record
  , (\_v6124 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6124))) $ getCoinProducts_args_language record
  ]
...
to_GetCoinProducts_args (T.TStruct fields) = GetCoinProducts_args{
  getCoinProducts_args_appStoreCode = P.maybe (getCoinProducts_args_appStoreCode default_GetCoinProducts_args) (\(_,_val6126) -> (case _val6126 of {T.TI32 _val6127 -> P.toEnum $ P.fromIntegral _val6127; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getCoinProducts_args_country = P.maybe (getCoinProducts_args_country default_GetCoinProducts_args) (\(_,_val6126) -> (case _val6126 of {T.TString _val6128 -> E.decodeUtf8 _val6128; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getCoinProducts_args_language = P.maybe (getCoinProducts_args_language default_GetCoinProducts_args) (\(_,_val6126) -> (case _val6126 of {T.TString _val6129 -> E.decodeUtf8 _val6129; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetCoinProducts_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6132 -> (1, ("e",from_TalkException _v6132))) <$> getCoinProducts_result_e record
    ]
    )
...
to_GetCoinProducts_result (T.TStruct fields) = GetCoinProducts_result{
  getCoinProducts_result_success = P.maybe (getCoinProducts_result_success default_GetCoinProducts_result) (\(_,_val6136) -> (case _val6136 of {T.TList _ _val6137 -> (Vector.fromList $ P.map (\_v6138 -> (case _v6138 of {T.TStruct _val6139 -> (to_CoinProductItem (T.TStruct _val6139)); _ -> P.error "wrong type"})) _val6137); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinProducts_result_e = P.maybe (P.Nothing) (\(_,_val6136) -> P.Just (case _val6136 of {T.TStruct _val6140 -> (to_TalkException (T.TStruct _val6140)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinProductsByPgCode_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6143 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v6143))) $ getCoinProductsByPgCode_args_appStoreCode record
  , (\_v6143 -> P.Just (3, ("pgCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v6143))) $ getCoinProductsByPgCode_args_pgCode record
  , (\_v6143 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v6143))) $ getCoinProductsByPgCode_args_country record
  , (\_v6143 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v6143))) $ getCoinProductsByPgCode_args_language record
  ]
...
to_GetCoinProductsByPgCode_args (T.TStruct fields) = GetCoinProductsByPgCode_args{
  getCoinProductsByPgCode_args_appStoreCode = P.maybe (getCoinProductsByPgCode_args_appStoreCode default_GetCoinProductsByPgCode_args) (\(_,_val6145) -> (case _val6145 of {T.TI32 _val6146 -> P.toEnum $ P.fromIntegral _val6146; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getCoinProductsByPgCode_args_pgCode = P.maybe (getCoinProductsByPgCode_args_pgCode default_GetCoinProductsByPgCode_args) (\(_,_val6145) -> (case _val6145 of {T.TI32 _val6147 -> P.toEnum $ P.fromIntegral _val6147; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getCoinProductsByPgCode_args_country = P.maybe (getCoinProductsByPgCode_args_country default_GetCoinProductsByPgCode_args) (\(_,_val6145) -> (case _val6145 of {T.TString _val6148 -> E.decodeUtf8 _val6148; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getCoinProductsByPgCode_args_language = P.maybe (getCoinProductsByPgCode_args_language default_GetCoinProductsByPgCode_args) (\(_,_val6145) -> (case _val6145 of {T.TString _val6149 -> E.decodeUtf8 _val6149; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetCoinProductsByPgCode_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6152 -> (1, ("e",from_TalkException _v6152))) <$> getCoinProductsByPgCode_result_e record
    ]
    )
...
to_GetCoinProductsByPgCode_result (T.TStruct fields) = GetCoinProductsByPgCode_result{
  getCoinProductsByPgCode_result_success = P.maybe (getCoinProductsByPgCode_result_success default_GetCoinProductsByPgCode_result) (\(_,_val6156) -> (case _val6156 of {T.TList _ _val6157 -> (Vector.fromList $ P.map (\_v6158 -> (case _v6158 of {T.TStruct _val6159 -> (to_CoinProductItem (T.TStruct _val6159)); _ -> P.error "wrong type"})) _val6157); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinProductsByPgCode_result_e = P.maybe (P.Nothing) (\(_,_val6156) -> P.Just (case _val6156 of {T.TStruct _val6160 -> (to_TalkException (T.TStruct _val6160)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinPurchaseHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6163 -> P.Just (2, ("request",from_CoinHistoryCondition _v6163))) $ getCoinPurchaseHistory_args_request record
  ]
...
to_GetCoinPurchaseHistory_args (T.TStruct fields) = GetCoinPurchaseHistory_args{
  getCoinPurchaseHistory_args_request = P.maybe (getCoinPurchaseHistory_args_request default_GetCoinPurchaseHistory_args) (\(_,_val6165) -> (case _val6165 of {T.TStruct _val6166 -> (to_CoinHistoryCondition (T.TStruct _val6166)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetCoinPurchaseHistory_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6169 -> (1, ("e",from_TalkException _v6169))) <$> getCoinPurchaseHistory_result_e record
    ]
    )
...
to_GetCoinPurchaseHistory_result (T.TStruct fields) = GetCoinPurchaseHistory_result{
  getCoinPurchaseHistory_result_success = P.maybe (getCoinPurchaseHistory_result_success default_GetCoinPurchaseHistory_result) (\(_,_val6171) -> (case _val6171 of {T.TStruct _val6172 -> (to_CoinHistoryResult (T.TStruct _val6172)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinPurchaseHistory_result_e = P.maybe (P.Nothing) (\(_,_val6171) -> P.Just (case _val6171 of {T.TStruct _val6173 -> (to_TalkException (T.TStruct _val6173)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinUseAndRefundHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6176 -> P.Just (2, ("request",from_CoinHistoryCondition _v6176))) $ getCoinUseAndRefundHistory_args_request record
  ]
...
to_GetCoinUseAndRefundHistory_args (T.TStruct fields) = GetCoinUseAndRefundHistory_args{
  getCoinUseAndRefundHistory_args_request = P.maybe (getCoinUseAndRefundHistory_args_request default_GetCoinUseAndRefundHistory_args) (\(_,_val6178) -> (case _val6178 of {T.TStruct _val6179 -> (to_CoinHistoryCondition (T.TStruct _val6179)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetCoinUseAndRefundHistory_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6182 -> (1, ("e",from_TalkException _v6182))) <$> getCoinUseAndRefundHistory_result_e record
    ]
    )
...
to_GetCoinUseAndRefundHistory_result (T.TStruct fields) = GetCoinUseAndRefundHistory_result{
  getCoinUseAndRefundHistory_result_success = P.maybe (getCoinUseAndRefundHistory_result_success default_GetCoinUseAndRefundHistory_result) (\(_,_val6184) -> (case _val6184 of {T.TStruct _val6185 -> (to_CoinHistoryResult (T.TStruct _val6185)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinUseAndRefundHistory_result_e = P.maybe (P.Nothing) (\(_,_val6184) -> P.Just (case _val6184 of {T.TStruct _val6186 -> (to_TalkException (T.TStruct _val6186)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetDownloads_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6189 -> P.Just (2, ("start",T.TI64 _v6189))) $ getDownloads_args_start record
  , (\_v6189 -> P.Just (3, ("size",T.TI32 _v6189))) $ getDownloads_args_size record
  , (\_v6189 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6189))) $ getDownloads_args_language record
  , (\_v6189 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6189))) $ getDownloads_args_country record
  ]
...
to_GetDownloads_args (T.TStruct fields) = GetDownloads_args{
  getDownloads_args_start = P.maybe (getDownloads_args_start default_GetDownloads_args) (\(_,_val6191) -> (case _val6191 of {T.TI64 _val6192 -> _val6192; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getDownloads_args_size = P.maybe (getDownloads_args_size default_GetDownloads_args) (\(_,_val6191) -> (case _val6191 of {T.TI32 _val6193 -> _val6193; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getDownloads_args_language = P.maybe (getDownloads_args_language default_GetDownloads_args) (\(_,_val6191) -> (case _val6191 of {T.TString _val6194 -> E.decodeUtf8 _val6194; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getDownloads_args_country = P.maybe (getDownloads_args_country default_GetDownloads_args) (\(_,_val6191) -> (case _val6191 of {T.TString _val6195 -> E.decodeUtf8 _val6195; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetDownloads_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6198 -> (1, ("e",from_TalkException _v6198))) <$> getDownloads_result_e record
    ]
    )
...
to_GetDownloads_result (T.TStruct fields) = GetDownloads_result{
  getDownloads_result_success = P.maybe (getDownloads_result_success default_GetDownloads_result) (\(_,_val6200) -> (case _val6200 of {T.TStruct _val6201 -> (to_ProductList (T.TStruct _val6201)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getDownloads_result_e = P.maybe (P.Nothing) (\(_,_val6200) -> P.Just (case _val6200 of {T.TStruct _val6202 -> (to_TalkException (T.TStruct _val6202)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetEventPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6205 -> P.Just (2, ("start",T.TI64 _v6205))) $ getEventPackages_args_start record
  , (\_v6205 -> P.Just (3, ("size",T.TI32 _v6205))) $ getEventPackages_args_size record
  , (\_v6205 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6205))) $ getEventPackages_args_language record
  , (\_v6205 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6205))) $ getEventPackages_args_country record
  ]
...
to_GetEventPackages_args (T.TStruct fields) = GetEventPackages_args{
  getEventPackages_args_start = P.maybe (getEventPackages_args_start default_GetEventPackages_args) (\(_,_val6207) -> (case _val6207 of {T.TI64 _val6208 -> _val6208; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getEventPackages_args_size = P.maybe (getEventPackages_args_size default_GetEventPackages_args) (\(_,_val6207) -> (case _val6207 of {T.TI32 _val6209 -> _val6209; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getEventPackages_args_language = P.maybe (getEventPackages_args_language default_GetEventPackages_args) (\(_,_val6207) -> (case _val6207 of {T.TString _val6210 -> E.decodeUtf8 _val6210; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getEventPackages_args_country = P.maybe (getEventPackages_args_country default_GetEventPackages_args) (\(_,_val6207) -> (case _val6207 of {T.TString _val6211 -> E.decodeUtf8 _val6211; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetEventPackages_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6214 -> (1, ("e",from_TalkException _v6214))) <$> getEventPackages_result_e record
    ]
    )
...
to_GetEventPackages_result (T.TStruct fields) = GetEventPackages_result{
  getEventPackages_result_success = P.maybe (getEventPackages_result_success default_GetEventPackages_result) (\(_,_val6216) -> (case _val6216 of {T.TStruct _val6217 -> (to_ProductList (T.TStruct _val6217)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getEventPackages_result_e = P.maybe (P.Nothing) (\(_,_val6216) -> P.Just (case _val6216 of {T.TStruct _val6218 -> (to_TalkException (T.TStruct _val6218)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetNewlyReleasedPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6221 -> P.Just (2, ("start",T.TI64 _v6221))) $ getNewlyReleasedPackages_args_start record
  , (\_v6221 -> P.Just (3, ("size",T.TI32 _v6221))) $ getNewlyReleasedPackages_args_size record
  , (\_v6221 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6221))) $ getNewlyReleasedPackages_args_language record
  , (\_v6221 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6221))) $ getNewlyReleasedPackages_args_country record
  ]
...
to_GetNewlyReleasedPackages_args (T.TStruct fields) = GetNewlyReleasedPackages_args{
  getNewlyReleasedPackages_args_start = P.maybe (getNewlyReleasedPackages_args_start default_GetNewlyReleasedPackages_args) (\(_,_val6223) -> (case _val6223 of {T.TI64 _val6224 -> _val6224; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getNewlyReleasedPackages_args_size = P.maybe (getNewlyReleasedPackages_args_size default_GetNewlyReleasedPackages_args) (\(_,_val6223) -> (case _val6223 of {T.TI32 _val6225 -> _val6225; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getNewlyReleasedPackages_args_language = P.maybe (getNewlyReleasedPackages_args_language default_GetNewlyReleasedPackages_args) (\(_,_val6223) -> (case _val6223 of {T.TString _val6226 -> E.decodeUtf8 _val6226; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getNewlyReleasedPackages_args_country = P.maybe (getNewlyReleasedPackages_args_country default_GetNewlyReleasedPackages_args) (\(_,_val6223) -> (case _val6223 of {T.TString _val6227 -> E.decodeUtf8 _val6227; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetNewlyReleasedPackages_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6230 -> (1, ("e",from_TalkException _v6230))) <$> getNewlyReleasedPackages_result_e record
    ]
    )
...
to_GetNewlyReleasedPackages_result (T.TStruct fields) = GetNewlyReleasedPackages_result{
  getNewlyReleasedPackages_result_success = P.maybe (getNewlyReleasedPackages_result_success default_GetNewlyReleasedPackages_result) (\(_,_val6232) -> (case _val6232 of {T.TStruct _val6233 -> (to_ProductList (T.TStruct _val6233)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getNewlyReleasedPackages_result_e = P.maybe (P.Nothing) (\(_,_val6232) -> P.Just (case _val6232 of {T.TStruct _val6234 -> (to_TalkException (T.TStruct _val6234)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6237 -> P.Just (2, ("start",T.TI64 _v6237))) $ getPopularPackages_args_start record
  , (\_v6237 -> P.Just (3, ("size",T.TI32 _v6237))) $ getPopularPackages_args_size record
  , (\_v6237 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6237))) $ getPopularPackages_args_language record
  , (\_v6237 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6237))) $ getPopularPackages_args_country record
  ]
...
to_GetPopularPackages_args (T.TStruct fields) = GetPopularPackages_args{
  getPopularPackages_args_start = P.maybe (getPopularPackages_args_start default_GetPopularPackages_args) (\(_,_val6239) -> (case _val6239 of {T.TI64 _val6240 -> _val6240; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularPackages_args_size = P.maybe (getPopularPackages_args_size default_GetPopularPackages_args) (\(_,_val6239) -> (case _val6239 of {T.TI32 _val6241 -> _val6241; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPopularPackages_args_language = P.maybe (getPopularPackages_args_language default_GetPopularPackages_args) (\(_,_val6239) -> (case _val6239 of {T.TString _val6242 -> E.decodeUtf8 _val6242; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPopularPackages_args_country = P.maybe (getPopularPackages_args_country default_GetPopularPackages_args) (\(_,_val6239) -> (case _val6239 of {T.TString _val6243 -> E.decodeUtf8 _val6243; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPopularPackages_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6246 -> (1, ("e",from_TalkException _v6246))) <$> getPopularPackages_result_e record
    ]
    )
...
to_GetPopularPackages_result (T.TStruct fields) = GetPopularPackages_result{
  getPopularPackages_result_success = P.maybe (getPopularPackages_result_success default_GetPopularPackages_result) (\(_,_val6248) -> (case _val6248 of {T.TStruct _val6249 -> (to_ProductList (T.TStruct _val6249)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularPackages_result_e = P.maybe (P.Nothing) (\(_,_val6248) -> P.Just (case _val6248 of {T.TStruct _val6250 -> (to_TalkException (T.TStruct _val6250)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPresentsReceived_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6253 -> P.Just (2, ("start",T.TI64 _v6253))) $ getPresentsReceived_args_start record
  , (\_v6253 -> P.Just (3, ("size",T.TI32 _v6253))) $ getPresentsReceived_args_size record
  , (\_v6253 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6253))) $ getPresentsReceived_args_language record
  , (\_v6253 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6253))) $ getPresentsReceived_args_country record
  ]
...
to_GetPresentsReceived_args (T.TStruct fields) = GetPresentsReceived_args{
  getPresentsReceived_args_start = P.maybe (getPresentsReceived_args_start default_GetPresentsReceived_args) (\(_,_val6255) -> (case _val6255 of {T.TI64 _val6256 -> _val6256; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPresentsReceived_args_size = P.maybe (getPresentsReceived_args_size default_GetPresentsReceived_args) (\(_,_val6255) -> (case _val6255 of {T.TI32 _val6257 -> _val6257; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPresentsReceived_args_language = P.maybe (getPresentsReceived_args_language default_GetPresentsReceived_args) (\(_,_val6255) -> (case _val6255 of {T.TString _val6258 -> E.decodeUtf8 _val6258; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPresentsReceived_args_country = P.maybe (getPresentsReceived_args_country default_GetPresentsReceived_args) (\(_,_val6255) -> (case _val6255 of {T.TString _val6259 -> E.decodeUtf8 _val6259; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPresentsReceived_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6262 -> (1, ("e",from_TalkException _v6262))) <$> getPresentsReceived_result_e record
    ]
    )
...
to_GetPresentsReceived_result (T.TStruct fields) = GetPresentsReceived_result{
  getPresentsReceived_result_success = P.maybe (getPresentsReceived_result_success default_GetPresentsReceived_result) (\(_,_val6264) -> (case _val6264 of {T.TStruct _val6265 -> (to_ProductList (T.TStruct _val6265)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPresentsReceived_result_e = P.maybe (P.Nothing) (\(_,_val6264) -> P.Just (case _val6264 of {T.TStruct _val6266 -> (to_TalkException (T.TStruct _val6266)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPresentsSent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6269 -> P.Just (2, ("start",T.TI64 _v6269))) $ getPresentsSent_args_start record
  , (\_v6269 -> P.Just (3, ("size",T.TI32 _v6269))) $ getPresentsSent_args_size record
  , (\_v6269 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6269))) $ getPresentsSent_args_language record
  , (\_v6269 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6269))) $ getPresentsSent_args_country record
  ]
...
to_GetPresentsSent_args (T.TStruct fields) = GetPresentsSent_args{
  getPresentsSent_args_start = P.maybe (getPresentsSent_args_start default_GetPresentsSent_args) (\(_,_val6271) -> (case _val6271 of {T.TI64 _val6272 -> _val6272; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPresentsSent_args_size = P.maybe (getPresentsSent_args_size default_GetPresentsSent_args) (\(_,_val6271) -> (case _val6271 of {T.TI32 _val6273 -> _val6273; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPresentsSent_args_language = P.maybe (getPresentsSent_args_language default_GetPresentsSent_args) (\(_,_val6271) -> (case _val6271 of {T.TString _val6274 -> E.decodeUtf8 _val6274; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPresentsSent_args_country = P.maybe (getPresentsSent_args_country default_GetPresentsSent_args) (\(_,_val6271) -> (case _val6271 of {T.TString _val6275 -> E.decodeUtf8 _val6275; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPresentsSent_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6278 -> (1, ("e",from_TalkException _v6278))) <$> getPresentsSent_result_e record
    ]
    )
...
to_GetPresentsSent_result (T.TStruct fields) = GetPresentsSent_result{
  getPresentsSent_result_success = P.maybe (getPresentsSent_result_success default_GetPresentsSent_result) (\(_,_val6280) -> (case _val6280 of {T.TStruct _val6281 -> (to_ProductList (T.TStruct _val6281)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPresentsSent_result_e = P.maybe (P.Nothing) (\(_,_val6280) -> P.Just (case _val6280 of {T.TStruct _val6282 -> (to_TalkException (T.TStruct _val6282)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6285 -> P.Just (2, ("packageID",T.TI64 _v6285))) $ getProduct_args_packageID record
  , (\_v6285 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v6285))) $ getProduct_args_language record
  , (\_v6285 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v6285))) $ getProduct_args_country record
  ]
...
to_GetProduct_args (T.TStruct fields) = GetProduct_args{
  getProduct_args_packageID = P.maybe (getProduct_args_packageID default_GetProduct_args) (\(_,_val6287) -> (case _val6287 of {T.TI64 _val6288 -> _val6288; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProduct_args_language = P.maybe (getProduct_args_language default_GetProduct_args) (\(_,_val6287) -> (case _val6287 of {T.TString _val6289 -> E.decodeUtf8 _val6289; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProduct_args_country = P.maybe (getProduct_args_country default_GetProduct_args) (\(_,_val6287) -> (case _val6287 of {T.TString _val6290 -> E.decodeUtf8 _val6290; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetProduct_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6293 -> (1, ("e",from_TalkException _v6293))) <$> getProduct_result_e record
    ]
    )
...
to_GetProduct_result (T.TStruct fields) = GetProduct_result{
  getProduct_result_success = P.maybe (getProduct_result_success default_GetProduct_result) (\(_,_val6295) -> (case _val6295 of {T.TStruct _val6296 -> (to_Product (T.TStruct _val6296)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProduct_result_e = P.maybe (P.Nothing) (\(_,_val6295) -> P.Just (case _val6295 of {T.TStruct _val6297 -> (to_TalkException (T.TStruct _val6297)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductList_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6300 -> P.Just (2, ("productIdList",T.TList T.T_STRING $ P.map (\_v6302 -> T.TString $ E.encodeUtf8 _v6302) $ Vector.toList _v6300))) $ getProductList_args_productIdList record
  , (\_v6300 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v6300))) $ getProductList_args_language record
  , (\_v6300 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v6300))) $ getProductList_args_country record
  ]
...
to_GetProductList_args (T.TStruct fields) = GetProductList_args{
  getProductList_args_productIdList = P.maybe (getProductList_args_productIdList default_GetProductList_args) (\(_,_val6304) -> (case _val6304 of {T.TList _ _val6305 -> (Vector.fromList $ P.map (\_v6306 -> (case _v6306 of {T.TString _val6307 -> E.decodeUtf8 _val6307; _ -> P.error "wrong type"})) _val6305); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductList_args_language = P.maybe (getProductList_args_language default_GetProductList_args) (\(_,_val6304) -> (case _val6304 of {T.TString _val6308 -> E.decodeUtf8 _val6308; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductList_args_country = P.maybe (getProductList_args_country default_GetProductList_args) (\(_,_val6304) -> (case _val6304 of {T.TString _val6309 -> E.decodeUtf8 _val6309; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetProductList_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6312 -> (1, ("e",from_TalkException _v6312))) <$> getProductList_result_e record
    ]
    )
...
to_GetProductList_result (T.TStruct fields) = GetProductList_result{
  getProductList_result_success = P.maybe (getProductList_result_success default_GetProductList_result) (\(_,_val6314) -> (case _val6314 of {T.TStruct _val6315 -> (to_ProductList (T.TStruct _val6315)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductList_result_e = P.maybe (P.Nothing) (\(_,_val6314) -> P.Just (case _val6314 of {T.TStruct _val6316 -> (to_TalkException (T.TStruct _val6316)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductListWithCarrier_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6319 -> P.Just (2, ("productIdList",T.TList T.T_STRING $ P.map (\_v6321 -> T.TString $ E.encodeUtf8 _v6321) $ Vector.toList _v6319))) $ getProductListWithCarrier_args_productIdList record
  , (\_v6319 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v6319))) $ getProductListWithCarrier_args_language record
  , (\_v6319 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v6319))) $ getProductListWithCarrier_args_country record
  , (\_v6319 -> P.Just (5, ("carrierCode",T.TString $ E.encodeUtf8 _v6319))) $ getProductListWithCarrier_args_carrierCode record
  ]
...
to_GetProductListWithCarrier_args (T.TStruct fields) = GetProductListWithCarrier_args{
  getProductListWithCarrier_args_productIdList = P.maybe (getProductListWithCarrier_args_productIdList default_GetProductListWithCarrier_args) (\(_,_val6323) -> (case _val6323 of {T.TList _ _val6324 -> (Vector.fromList $ P.map (\_v6325 -> (case _v6325 of {T.TString _val6326 -> E.decodeUtf8 _val6326; _ -> P.error "wrong type"})) _val6324); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductListWithCarrier_args_language = P.maybe (getProductListWithCarrier_args_language default_GetProductListWithCarrier_args) (\(_,_val6323) -> (case _val6323 of {T.TString _val6327 -> E.decodeUtf8 _val6327; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductListWithCarrier_args_country = P.maybe (getProductListWithCarrier_args_country default_GetProductListWithCarrier_args) (\(_,_val6323) -> (case _val6323 of {T.TString _val6328 -> E.decodeUtf8 _val6328; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getProductListWithCarrier_args_carrierCode = P.maybe (getProductListWithCarrier_args_carrierCode default_GetProductListWithCarrier_args) (\(_,_val6323) -> (case _val6323 of {T.TString _val6329 -> E.decodeUtf8 _val6329; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetProductListWithCarrier_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6332 -> (1, ("e",from_TalkException _v6332))) <$> getProductListWithCarrier_result_e record
    ]
    )
...
to_GetProductListWithCarrier_result (T.TStruct fields) = GetProductListWithCarrier_result{
  getProductListWithCarrier_result_success = P.maybe (getProductListWithCarrier_result_success default_GetProductListWithCarrier_result) (\(_,_val6334) -> (case _val6334 of {T.TStruct _val6335 -> (to_ProductList (T.TStruct _val6335)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductListWithCarrier_result_e = P.maybe (P.Nothing) (\(_,_val6334) -> P.Just (case _val6334 of {T.TStruct _val6336 -> (to_TalkException (T.TStruct _val6336)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductWithCarrier_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6339 -> P.Just (2, ("packageID",T.TI64 _v6339))) $ getProductWithCarrier_args_packageID record
  , (\_v6339 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v6339))) $ getProductWithCarrier_args_language record
  , (\_v6339 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v6339))) $ getProductWithCarrier_args_country record
  , (\_v6339 -> P.Just (5, ("carrierCode",T.TString $ E.encodeUtf8 _v6339))) $ getProductWithCarrier_args_carrierCode record
  ]
...
to_GetProductWithCarrier_args (T.TStruct fields) = GetProductWithCarrier_args{
  getProductWithCarrier_args_packageID = P.maybe (getProductWithCarrier_args_packageID default_GetProductWithCarrier_args) (\(_,_val6341) -> (case _val6341 of {T.TI64 _val6342 -> _val6342; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductWithCarrier_args_language = P.maybe (getProductWithCarrier_args_language default_GetProductWithCarrier_args) (\(_,_val6341) -> (case _val6341 of {T.TString _val6343 -> E.decodeUtf8 _val6343; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductWithCarrier_args_country = P.maybe (getProductWithCarrier_args_country default_GetProductWithCarrier_args) (\(_,_val6341) -> (case _val6341 of {T.TString _val6344 -> E.decodeUtf8 _val6344; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getProductWithCarrier_args_carrierCode = P.maybe (getProductWithCarrier_args_carrierCode default_GetProductWithCarrier_args) (\(_,_val6341) -> (case _val6341 of {T.TString _val6345 -> E.decodeUtf8 _val6345; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetProductWithCarrier_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6348 -> (1, ("e",from_TalkException _v6348))) <$> getProductWithCarrier_result_e record
    ]
    )
...
to_GetProductWithCarrier_result (T.TStruct fields) = GetProductWithCarrier_result{
  getProductWithCarrier_result_success = P.maybe (getProductWithCarrier_result_success default_GetProductWithCarrier_result) (\(_,_val6350) -> (case _val6350 of {T.TStruct _val6351 -> (to_Product (T.TStruct _val6351)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductWithCarrier_result_e = P.maybe (P.Nothing) (\(_,_val6350) -> P.Just (case _val6350 of {T.TStruct _val6352 -> (to_TalkException (T.TStruct _val6352)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPurchaseHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6355 -> P.Just (2, ("start",T.TI64 _v6355))) $ getPurchaseHistory_args_start record
  , (\_v6355 -> P.Just (3, ("size",T.TI32 _v6355))) $ getPurchaseHistory_args_size record
  , (\_v6355 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v6355))) $ getPurchaseHistory_args_language record
  , (\_v6355 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v6355))) $ getPurchaseHistory_args_country record
  ]
...
to_GetPurchaseHistory_args (T.TStruct fields) = GetPurchaseHistory_args{
  getPurchaseHistory_args_start = P.maybe (getPurchaseHistory_args_start default_GetPurchaseHistory_args) (\(_,_val6357) -> (case _val6357 of {T.TI64 _val6358 -> _val6358; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPurchaseHistory_args_size = P.maybe (getPurchaseHistory_args_size default_GetPurchaseHistory_args) (\(_,_val6357) -> (case _val6357 of {T.TI32 _val6359 -> _val6359; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPurchaseHistory_args_language = P.maybe (getPurchaseHistory_args_language default_GetPurchaseHistory_args) (\(_,_val6357) -> (case _val6357 of {T.TString _val6360 -> E.decodeUtf8 _val6360; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPurchaseHistory_args_country = P.maybe (getPurchaseHistory_args_country default_GetPurchaseHistory_args) (\(_,_val6357) -> (case _val6357 of {T.TString _val6361 -> E.decodeUtf8 _val6361; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPurchaseHistory_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6364 -> (1, ("e",from_TalkException _v6364))) <$> getPurchaseHistory_result_e record
    ]
    )
...
to_GetPurchaseHistory_result (T.TStruct fields) = GetPurchaseHistory_result{
  getPurchaseHistory_result_success = P.maybe (getPurchaseHistory_result_success default_GetPurchaseHistory_result) (\(_,_val6366) -> (case _val6366 of {T.TStruct _val6367 -> (to_ProductList (T.TStruct _val6367)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPurchaseHistory_result_e = P.maybe (P.Nothing) (\(_,_val6366) -> P.Just (case _val6366 of {T.TStruct _val6368 -> (to_TalkException (T.TStruct _val6368)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetTotalBalance_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6371 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v6371))) $ getTotalBalance_args_appStoreCode record
  ]
...
to_GetTotalBalance_args (T.TStruct fields) = GetTotalBalance_args{
  getTotalBalance_args_appStoreCode = P.maybe (getTotalBalance_args_appStoreCode default_GetTotalBalance_args) (\(_,_val6373) -> (case _val6373 of {T.TI32 _val6374 -> P.toEnum $ P.fromIntegral _val6374; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetTotalBalance_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6377 -> (1, ("e",from_TalkException _v6377))) <$> getTotalBalance_result_e record
    ]
    )
...
to_GetTotalBalance_result (T.TStruct fields) = GetTotalBalance_result{
  getTotalBalance_result_success = P.maybe (getTotalBalance_result_success default_GetTotalBalance_result) (\(_,_val6379) -> (case _val6379 of {T.TStruct _val6380 -> (to_Coin (T.TStruct _val6380)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getTotalBalance_result_e = P.maybe (P.Nothing) (\(_,_val6379) -> P.Just (case _val6379 of {T.TStruct _val6381 -> (to_TalkException (T.TStruct _val6381)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyDownloaded_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6384 -> P.Just (2, ("packageId",T.TI64 _v6384))) $ notifyDownloaded_args_packageId record
  , (\_v6384 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v6384))) $ notifyDownloaded_args_language record
  ]
...
to_NotifyDownloaded_args (T.TStruct fields) = NotifyDownloaded_args{
  notifyDownloaded_args_packageId = P.maybe (notifyDownloaded_args_packageId default_NotifyDownloaded_args) (\(_,_val6386) -> (case _val6386 of {T.TI64 _val6387 -> _val6387; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  notifyDownloaded_args_language = P.maybe (notifyDownloaded_args_language default_NotifyDownloaded_args) (\(_,_val6386) -> (case _val6386 of {T.TString _val6388 -> E.decodeUtf8 _val6388; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_NotifyDownloaded_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6391 -> (1, ("e",from_TalkException _v6391))) <$> notifyDownloaded_result_e record
    ]
    )
...
to_NotifyDownloaded_result (T.TStruct fields) = NotifyDownloaded_result{
  notifyDownloaded_result_success = P.maybe (notifyDownloaded_result_success default_NotifyDownloaded_result) (\(_,_val6393) -> (case _val6393 of {T.TI64 _val6394 -> _val6394; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  notifyDownloaded_result_e = P.maybe (P.Nothing) (\(_,_val6393) -> P.Just (case _val6393 of {T.TStruct _val6395 -> (to_TalkException (T.TStruct _val6395)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ReserveCoinPurchase_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6398 -> P.Just (2, ("request",from_CoinPurchaseReservation _v6398))) $ reserveCoinPurchase_args_request record
  ]
...
to_ReserveCoinPurchase_args (T.TStruct fields) = ReserveCoinPurchase_args{
  reserveCoinPurchase_args_request = P.maybe (reserveCoinPurchase_args_request default_ReserveCoinPurchase_args) (\(_,_val6400) -> (case _val6400 of {T.TStruct _val6401 -> (to_CoinPurchaseReservation (T.TStruct _val6401)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_ReserveCoinPurchase_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6404 -> (1, ("e",from_TalkException _v6404))) <$> reserveCoinPurchase_result_e record
    ]
    )
...
to_ReserveCoinPurchase_result (T.TStruct fields) = ReserveCoinPurchase_result{
  reserveCoinPurchase_result_success = P.maybe (reserveCoinPurchase_result_success default_ReserveCoinPurchase_result) (\(_,_val6406) -> (case _val6406 of {T.TStruct _val6407 -> (to_PaymentReservationResult (T.TStruct _val6407)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  reserveCoinPurchase_result_e = P.maybe (P.Nothing) (\(_,_val6406) -> P.Just (case _val6406 of {T.TStruct _val6408 -> (to_TalkException (T.TStruct _val6408)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ReservePayment_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6411 -> P.Just (2, ("paymentReservation",from_PaymentReservation _v6411))) $ reservePayment_args_paymentReservation record
  ]
...
to_ReservePayment_args (T.TStruct fields) = ReservePayment_args{
  reservePayment_args_paymentReservation = P.maybe (reservePayment_args_paymentReservation default_ReservePayment_args) (\(_,_val6413) -> (case _val6413 of {T.TStruct _val6414 -> (to_PaymentReservation (T.TStruct _val6414)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_ReservePayment_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6417 -> (1, ("e",from_TalkException _v6417))) <$> reservePayment_result_e record
    ]
    )
...
to_ReservePayment_result (T.TStruct fields) = ReservePayment_result{
  reservePayment_result_success = P.maybe (reservePayment_result_success default_ReservePayment_result) (\(_,_val6419) -> (case _val6419 of {T.TStruct _val6420 -> (to_PaymentReservationResult (T.TStruct _val6420)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  reservePayment_result_e = P.maybe (P.Nothing) (\(_,_val6419) -> P.Just (case _val6419 of {T.TStruct _val6421 -> (to_TalkException (T.TStruct _val6421)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
