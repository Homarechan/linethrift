...
from_FetchMessageOperations_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5981 -> P.Just (2, ("localRevision",T.TI64 _v5981))) $ fetchMessageOperations_args_localRevision record
  , (\_v5981 -> P.Just (3, ("lastOpTimestamp",T.TI64 _v5981))) $ fetchMessageOperations_args_lastOpTimestamp record
  , (\_v5981 -> P.Just (4, ("count",T.TI32 _v5981))) $ fetchMessageOperations_args_count record
  ]
...
to_FetchMessageOperations_args (T.TStruct fields) = FetchMessageOperations_args{
  fetchMessageOperations_args_localRevision = P.maybe (fetchMessageOperations_args_localRevision default_FetchMessageOperations_args) (\(_,_val5983) -> (case _val5983 of {T.TI64 _val5984 -> _val5984; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  fetchMessageOperations_args_lastOpTimestamp = P.maybe (fetchMessageOperations_args_lastOpTimestamp default_FetchMessageOperations_args) (\(_,_val5983) -> (case _val5983 of {T.TI64 _val5985 -> _val5985; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  fetchMessageOperations_args_count = P.maybe (fetchMessageOperations_args_count default_FetchMessageOperations_args) (\(_,_val5983) -> (case _val5983 of {T.TI32 _val5986 -> _val5986; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_FetchMessageOperations_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v5989 -> (1, ("e",from_TalkException _v5989))) <$> fetchMessageOperations_result_e record
    ]
    )
...
to_FetchMessageOperations_result (T.TStruct fields) = FetchMessageOperations_result{
  fetchMessageOperations_result_success = P.maybe (fetchMessageOperations_result_success default_FetchMessageOperations_result) (\(_,_val5991) -> (case _val5991 of {T.TStruct _val5992 -> (to_MessageOperations (T.TStruct _val5992)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  fetchMessageOperations_result_e = P.maybe (P.Nothing) (\(_,_val5991) -> P.Just (case _val5991 of {T.TStruct _val5993 -> (to_TalkException (T.TStruct _val5993)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetLastReadMessageIds_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v5996 -> P.Just (2, ("chatId",T.TString $ E.encodeUtf8 _v5996))) $ getLastReadMessageIds_args_chatId record
  ]
...
to_GetLastReadMessageIds_args (T.TStruct fields) = GetLastReadMessageIds_args{
  getLastReadMessageIds_args_chatId = P.maybe (getLastReadMessageIds_args_chatId default_GetLastReadMessageIds_args) (\(_,_val5998) -> (case _val5998 of {T.TString _val5999 -> E.decodeUtf8 _val5999; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetLastReadMessageIds_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6002 -> (1, ("e",from_TalkException _v6002))) <$> getLastReadMessageIds_result_e record
    ]
    )
...
to_GetLastReadMessageIds_result (T.TStruct fields) = GetLastReadMessageIds_result{
  getLastReadMessageIds_result_success = P.maybe (getLastReadMessageIds_result_success default_GetLastReadMessageIds_result) (\(_,_val6004) -> (case _val6004 of {T.TStruct _val6005 -> (to_LastReadMessageIds (T.TStruct _val6005)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getLastReadMessageIds_result_e = P.maybe (P.Nothing) (\(_,_val6004) -> P.Just (case _val6004 of {T.TStruct _val6006 -> (to_TalkException (T.TStruct _val6006)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_MultiGetLastReadMessageIds_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v6009 -> P.Just (2, ("chatIds",T.TList T.T_STRING $ P.map (\_v6011 -> T.TString $ E.encodeUtf8 _v6011) $ Vector.toList _v6009))) $ multiGetLastReadMessageIds_args_chatIds record
  ]
...
to_MultiGetLastReadMessageIds_args (T.TStruct fields) = MultiGetLastReadMessageIds_args{
  multiGetLastReadMessageIds_args_chatIds = P.maybe (multiGetLastReadMessageIds_args_chatIds default_MultiGetLastReadMessageIds_args) (\(_,_val6013) -> (case _val6013 of {T.TList _ _val6014 -> (Vector.fromList $ P.map (\_v6015 -> (case _v6015 of {T.TString _val6016 -> E.decodeUtf8 _val6016; _ -> P.error "wrong type"})) _val6014); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_MultiGetLastReadMessageIds_result record = T.TStruct $ Map.fromList 
  ...
  in if P.not (P.null exns) then exns else M.catMaybes
    ...
    , (\_v6019 -> (1, ("e",from_TalkException _v6019))) <$> multiGetLastReadMessageIds_result_e record
    ]
    )
...
to_MultiGetLastReadMessageIds_result (T.TStruct fields) = MultiGetLastReadMessageIds_result{
  multiGetLastReadMessageIds_result_success = P.maybe (multiGetLastReadMessageIds_result_success default_MultiGetLastReadMessageIds_result) (\(_,_val6023) -> (case _val6023 of {T.TList _ _val6024 -> (Vector.fromList $ P.map (\_v6025 -> (case _v6025 of {T.TStruct _val6026 -> (to_LastReadMessageIds (T.TStruct _val6026)); _ -> P.error "wrong type"})) _val6024); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  multiGetLastReadMessageIds_result_e = P.maybe (P.Nothing) (\(_,_val6023) -> P.Just (case _val6023 of {T.TStruct _val6027 -> (to_TalkException (T.TStruct _val6027)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
