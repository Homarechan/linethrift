...
public class MarkAsReadRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("MarkAsReadRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    MarkAsReadRequest other = (MarkAsReadRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("MarkAsReadRequest(");
    boolean first = true;
