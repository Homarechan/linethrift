...
public class GetSquareChatAnnouncementsRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetSquareChatAnnouncementsRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetSquareChatAnnouncementsRequest other = (GetSquareChatAnnouncementsRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetSquareChatAnnouncementsRequest(");
    boolean first = true;
