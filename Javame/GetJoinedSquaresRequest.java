...
public class GetJoinedSquaresRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetJoinedSquaresRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetJoinedSquaresRequest other = (GetJoinedSquaresRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetJoinedSquaresRequest(");
    boolean first = true;
