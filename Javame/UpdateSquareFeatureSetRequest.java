...
public class UpdateSquareFeatureSetRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("UpdateSquareFeatureSetRequest");

  private static final TField UPDATE_ATTRIBUTES_FIELD_DESC = new TField("updateAttributes", TType.SET, (short)2);
  private static final TField SQUARE_FEATURE_SET_FIELD_DESC = new TField("squareFeatureSet", TType.STRUCT, (short)3);
  ...
  public int compareTo(Object otherObject) {
    ...
    UpdateSquareFeatureSetRequest other = (UpdateSquareFeatureSetRequest)otherObject;    int lastComparison = 0;
          ...
          if (field.type == TType.SET) {
            {
              ...
              this.updateAttributes = new Hashtable(2*_set409.size);
              for (int _i410 = 0; _i410 < _set409.size; ++_i410)
              {
                SquareFeatureSetAttribute _elem411;
                _elem411 = SquareFeatureSetAttribute.findByValue(iprot.readI32());
                this.updateAttributes.put(_elem411, _elem411);
              }
              iprot.readSetEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.updateAttributes != null) {
      oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter412_enum = this.updateAttributes.keys(); _iter412_enum.hasMoreElements(); )         {
          SquareFeatureSetAttribute _iter412 = (SquareFeatureSetAttribute)_iter412_enum.nextElement();
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("UpdateSquareFeatureSetRequest(");
    boolean first = true;
