...
public class UpdateSquareResponse implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("UpdateSquareResponse");
  ...
  public int compareTo(Object otherObject) {
    ...
    UpdateSquareResponse other = (UpdateSquareResponse)otherObject;    int lastComparison = 0;
          ...
          if (field.type == TType.SET) {
            {
              ...
              this.updatedAttrs = new Hashtable(2*_set386.size);
              for (int _i387 = 0; _i387 < _set386.size; ++_i387)
              {
                SquareAttribute _elem388;
                _elem388 = SquareAttribute.findByValue(iprot.readI32());
                this.updatedAttrs.put(_elem388, _elem388);
              }
              iprot.readSetEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter389_enum = this.updatedAttrs.keys(); _iter389_enum.hasMoreElements(); )         {
          SquareAttribute _iter389 = (SquareAttribute)_iter389_enum.nextElement();
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("UpdateSquareResponse(");
    boolean first = true;
