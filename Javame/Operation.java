...
public class Operation implements TBase {
  ...
  private static final TField CHECKSUM_FIELD_DESC = new TField("checksum", TType.STRING, (short)5);
  ...
  public int compareTo(Object otherObject) {
    ...
    Operation other = (Operation)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetChecksum(), other.isSetChecksum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChecksum()) {
      lastComparison = TBaseHelper.compareTo(this.checksum, other.checksum);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      switch (field.id) {
        ...
        case 3: // TYPE
          if (field.type == TType.I32) {
            this.type = OpType.findByValue(iprot.readI32());
          } else { 
            TProtocolUtil.skip(iprot, field.type);
          }
          break;
