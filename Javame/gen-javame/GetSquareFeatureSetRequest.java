...
public class GetSquareFeatureSetRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetSquareFeatureSetRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetSquareFeatureSetRequest other = (GetSquareFeatureSetRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetSquareFeatureSetRequest(");
    boolean first = true;
