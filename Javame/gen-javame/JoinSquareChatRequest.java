...
public class JoinSquareChatRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("JoinSquareChatRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    JoinSquareChatRequest other = (JoinSquareChatRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("JoinSquareChatRequest(");
    boolean first = true;
