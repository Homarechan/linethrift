...
public class LeaveSquareRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("LeaveSquareRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    LeaveSquareRequest other = (LeaveSquareRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("LeaveSquareRequest(");
    boolean first = true;
