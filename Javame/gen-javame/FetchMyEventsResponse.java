...
public class FetchMyEventsResponse implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("FetchMyEventsResponse");
  ...
  public int compareTo(Object otherObject) {
    ...
    FetchMyEventsResponse other = (FetchMyEventsResponse)otherObject;    int lastComparison = 0;
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.events != null) {
      oprot.writeFieldBegin(EVENTS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter348_enum = this.events.elements(); _iter348_enum.hasMoreElements(); )         {
          SquareEvent _iter348 = (SquareEvent)_iter348_enum.nextElement();
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("FetchMyEventsResponse(");
    boolean first = true;
