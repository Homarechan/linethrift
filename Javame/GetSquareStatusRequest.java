...
public class GetSquareStatusRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetSquareStatusRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetSquareStatusRequest other = (GetSquareStatusRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetSquareStatusRequest(");
    boolean first = true;
