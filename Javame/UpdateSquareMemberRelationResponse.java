...
public class UpdateSquareMemberRelationResponse implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("UpdateSquareMemberRelationResponse");

  private static final TField SQUARE_MID_FIELD_DESC = new TField("squareMid", TType.STRING, (short)1);
  private static final TField TARGET_SQUARE_MEMBER_MID_FIELD_DESC = new TField("targetSquareMemberMid", TType.STRING, (short)2);
  private static final TField UPDATED_ATTRS_FIELD_DESC = new TField("updatedAttrs", TType.SET, (short)3);
  private static final TField RELATION_FIELD_DESC = new TField("relation", TType.STRUCT, (short)4);
  ...
  public int compareTo(Object otherObject) {
    ...
    UpdateSquareMemberRelationResponse other = (UpdateSquareMemberRelationResponse)otherObject;    int lastComparison = 0;
          ...
          if (field.type == TType.SET) {
            {
              ...
              this.updatedAttrs = new Hashtable(2*_set495.size);
              for (int _i496 = 0; _i496 < _set495.size; ++_i496)
              {
                SquareMemberRelationAttribute _elem497;
                _elem497 = SquareMemberRelationAttribute.findByValue(iprot.readI32());
                this.updatedAttrs.put(_elem497, _elem497);
              }
              iprot.readSetEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter498_enum = this.updatedAttrs.keys(); _iter498_enum.hasMoreElements(); )         {
          SquareMemberRelationAttribute _iter498 = (SquareMemberRelationAttribute)_iter498_enum.nextElement();
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("UpdateSquareMemberRelationResponse(");
    boolean first = true;
