...
public class SendBuddyMessageResult implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("SendBuddyMessageResult");
  ...
  private static final TField EVENT_NO_FIELD_DESC = new TField("eventNo", TType.I32, (short)4);
  ...
  private static final TField BLOCK_COUNT_FIELD_DESC = new TField("blockCount", TType.I64, (short)15);
  private static final TField UNREGISTER_COUNT_FIELD_DESC = new TField("unregisterCount", TType.I64, (short)16);
  ...
  public int compareTo(Object otherObject) {
    ...
    SendBuddyMessageResult other = (SendBuddyMessageResult)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("SendBuddyMessageResult(");
    boolean first = true;
