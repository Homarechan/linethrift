...
public class ApprovedChannelInfos implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("ApprovedChannelInfos");

  private static final TField APPROVED_CHANNEL_INFOS_FIELD_DESC = new TField("approvedChannelInfos", TType.LIST, (short)1);
  private static final TField REVISION_FIELD_DESC = new TField("revision", TType.I64, (short)2);

  private Vector approvedChannelInfos;
  ...
  public ApprovedChannelInfos(ApprovedChannelInfos other) {
    ...
    if (other.isSetApprovedChannelInfos()) {
      Vector __this__approvedChannelInfos = new Vector();
      for (Enumeration other_enum = other.approvedChannelInfos.elements(); other_enum.hasMoreElements(); ) {
        ApprovedChannelInfo other_element = (ApprovedChannelInfo)other_enum.nextElement();
        __this__approvedChannelInfos.addElement(new ApprovedChannelInfo(other_element));
      }
  ...
  public Enumeration getApprovedChannelInfosEnumeration() {
    return (this.approvedChannelInfos == null) ? null : this.approvedChannelInfos.elements();
  }

  public void addToApprovedChannelInfos(ApprovedChannelInfo elem) {
    if (this.approvedChannelInfos == null) {
      this.approvedChannelInfos = new Vector();
    }
    this.approvedChannelInfos.addElement(elem);
  }

  public Vector getApprovedChannelInfos() {
    return this.approvedChannelInfos;
  }

  public void setApprovedChannelInfos(Vector approvedChannelInfos) {
    this.approvedChannelInfos = approvedChannelInfos;
  }
  ...
  public int compareTo(Object otherObject) {
    ...
    ApprovedChannelInfos other = (ApprovedChannelInfos)otherObject;    int lastComparison = 0;

    lastComparison = TBaseHelper.compareTo(isSetApprovedChannelInfos(), other.isSetApprovedChannelInfos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApprovedChannelInfos()) {
      lastComparison = TBaseHelper.compareTo(this.approvedChannelInfos, other.approvedChannelInfos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.approvedChannelInfos = new Vector(_list52.size);
              for (int _i53 = 0; _i53 < _list52.size; ++_i53)
              {
                ApprovedChannelInfo _elem54;
                _elem54 = new ApprovedChannelInfo();
                _elem54.read(iprot);
                this.approvedChannelInfos.addElement(_elem54);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.approvedChannelInfos != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.approvedChannelInfos.size()));
        for (Enumeration _iter55_enum = this.approvedChannelInfos.elements(); _iter55_enum.hasMoreElements(); )         {
          ApprovedChannelInfo _iter55 = (ApprovedChannelInfo)_iter55_enum.nextElement();
          _iter55.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("ApprovedChannelInfos(");
    boolean first = true;
