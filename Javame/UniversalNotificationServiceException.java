          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.parameterMap = new Hashtable(2*_map532.size);
              for (int _i533 = 0; _i533 < _map532.size; ++_i533)
              {
                ...
                this.parameterMap.put(_key534, _val535);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (Enumeration _iter536_enum = this.parameterMap.keys(); _iter536_enum.hasMoreElements(); )         {
          String _iter536 = (String)_iter536_enum.nextElement();
          oprot.writeString(_iter536);
          oprot.writeString(((String)this.parameterMap.get(_iter536)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
