...
public class SquareEventNotificationJoinRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("SquareEventNotificationJoinRequest");
  ...
  private static final TField REQUEST_MEMBER_NAME_FIELD_DESC = new TField("requestMemberName", TType.STRING, (short)3);
  ...
  public void setRequestMemberName(String requestMemberName) {
    this.requestMemberName = requestMemberName;
  }
  ...
  public int compareTo(Object otherObject) {
    ...
    SquareEventNotificationJoinRequest other = (SquareEventNotificationJoinRequest)otherObject;    int lastComparison = 0;
    ...
    lastComparison = TBaseHelper.compareTo(isSetRequestMemberName(), other.isSetRequestMemberName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRequestMemberName()) {
      lastComparison = TBaseHelper.compareTo(this.requestMemberName, other.requestMemberName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("SquareEventNotificationJoinRequest(");
    boolean first = true;
