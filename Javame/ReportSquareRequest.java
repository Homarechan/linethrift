...
public class ReportSquareRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("ReportSquareRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    ReportSquareRequest other = (ReportSquareRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("ReportSquareRequest(");
    boolean first = true;
