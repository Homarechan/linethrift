...
public class UpdateBuddyProfileResult implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("UpdateBuddyProfileResult");
  ...
  public int compareTo(Object otherObject) {
    ...
    UpdateBuddyProfileResult other = (UpdateBuddyProfileResult)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("UpdateBuddyProfileResult(");
    boolean first = true;
