...
public class GetSquareChatRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetSquareChatRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetSquareChatRequest other = (GetSquareChatRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetSquareChatRequest(");
    boolean first = true;
