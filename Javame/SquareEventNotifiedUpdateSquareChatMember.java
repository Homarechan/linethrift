...
public class SquareEventNotifiedUpdateSquareChatMember implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("SquareEventNotifiedUpdateSquareChatMember");
  ...
  public int compareTo(Object otherObject) {
    ...
    SquareEventNotifiedUpdateSquareChatMember other = (SquareEventNotifiedUpdateSquareChatMember)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("SquareEventNotifiedUpdateSquareChatMember(");
    boolean first = true;
