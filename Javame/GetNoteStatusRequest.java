...
public class GetNoteStatusRequest implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("GetNoteStatusRequest");
  ...
  public int compareTo(Object otherObject) {
    ...
    GetNoteStatusRequest other = (GetNoteStatusRequest)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("GetNoteStatusRequest(");
    boolean first = true;
