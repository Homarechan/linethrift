...
public class SquareEventNotifiedDestroyMessage implements TBase {
  private static final TStruct STRUCT_DESC = new TStruct("SquareEventNotifiedDestroyMessage");
  ...
  public int compareTo(Object otherObject) {
    ...
    SquareEventNotifiedDestroyMessage other = (SquareEventNotifiedDestroyMessage)otherObject;    int lastComparison = 0;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer("SquareEventNotifiedDestroyMessage(");
    boolean first = true;
