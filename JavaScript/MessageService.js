  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.chatIds = [];
        var _rtmp3955 = input.readListBegin();
        var _size954 = _rtmp3955.size || 0;
        for (var _i956 = 0; _i956 < _size954; ++_i956) {
          var elem957 = null;
          elem957 = input.readString().value;
          this.chatIds.push(elem957);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
MessageService_multiGetLastReadMessageIds_args.prototype.write = function(output) {
  ...
  if (this.chatIds !== null && this.chatIds !== undefined) {
    ...
    for (var iter958 in this.chatIds) {
      if (this.chatIds.hasOwnProperty(iter958)) {
        iter958 = this.chatIds[iter958];
        output.writeString(iter958);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
MessageService_multiGetLastReadMessageIds_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3960 = input.readListBegin();
        var _size959 = _rtmp3960.size || 0;
        for (var _i961 = 0; _i961 < _size959; ++_i961) {
          var elem962 = null;
          elem962 = new LastReadMessageIds();
          elem962.read(input);
          this.success.push(elem962);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
MessageService_multiGetLastReadMessageIds_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    ...
    for (var iter963 in this.success) {
      if (this.success.hasOwnProperty(iter963)) {
        iter963 = this.success[iter963];
        iter963.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
