...
AuthService_updatePassword_args = function(args) {
  ...
  if (args) {
    ...
    if (args.request !== undefined && args.request !== null) {
      this.request = new IdentityCredentialRequest(args.request);
    }
  }
};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.authSessionId = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_updatePassword_result = function(args) {
  this.success = null;
  this.e = null;
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new IdentityCredentialResponse(args.success);
    }
...
AuthService_getAuthRSAKey_args = function(args) {
  this.authSessionId = null;
...
AuthService_getAuthRSAKey_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_openAuthSession_args = function(args) {
  this.request = null;
  if (args) {
    if (args.request !== undefined && args.request !== null) {
      this.request = new AuthSessionRequest(args.request);
    }
  }
};
...
AuthService_openAuthSession_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_normalizePhoneNumber_args = function(args) {
...
AuthService_normalizePhoneNumber_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.countryCodeHint = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_normalizePhoneNumber_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_respondE2EELoginRequest_args = function(args) {
  this.verifier = null;
  this.publicKey = null;
...
AuthService_respondE2EELoginRequest_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.encryptedKeyChain = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.hashKeyChain = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_respondE2EELoginRequest_result = function(args) {
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
    return;
...
AuthService_confirmE2EELogin_args = function(args) {
  this.verifier = null;
...
AuthService_confirmE2EELogin_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.deviceSecret = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_confirmE2EELogin_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_logoutZ_args = function(args) {
};
...
AuthService_logoutZ_result = function(args) {
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
    return;
...
AuthService_loginZ_args = function(args) {
...
AuthService_loginZ_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_issueTokenForAccountMigrationSettings_args = function(args) {
  this.enforce = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.BOOL) {
        this.enforce = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_issueTokenForAccountMigrationSettings_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new SecurityCenterResult(args.success);
    }
    if (args.e !== undefined && args.e !== null) {
      this.e = args.e;
    }
...
AuthService_issueTokenForAccountMigration_args = function(args) {
...
AuthService_issueTokenForAccountMigration_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.migrationSessionId = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthService_issueTokenForAccountMigration_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthService_verifyQrcodeWithE2EE_args = function(args) {
  this.verifier = null;
  this.pinCode = null;
  this.errorCode = null;
  this.publicKey = null;
...
AuthService_verifyQrcodeWithE2EE_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof TalkException) {
    this.e = args;
...
AuthServiceClient.prototype.updatePassword = function(authSessionId, request, callback) {
  this.send_updatePassword(authSessionId, request, callback); 
  if (!callback) {
    return this.recv_updatePassword();
  }
};

AuthServiceClient.prototype.send_updatePassword = function(authSessionId, request, callback) {
...
AuthServiceClient.prototype.recv_updatePassword = function() {
  ...
  throw 'updatePassword failed: unknown result';
};
AuthServiceClient.prototype.getAuthRSAKey = function(authSessionId, identityProvider, callback) {
  this.send_getAuthRSAKey(authSessionId, identityProvider, callback); 
  if (!callback) {
    return this.recv_getAuthRSAKey();
  }
};

AuthServiceClient.prototype.send_getAuthRSAKey = function(authSessionId, identityProvider, callback) {
  this.output.writeMessageBegin('getAuthRSAKey', Thrift.MessageType.CALL, this.seqid);
  var params = {
    authSessionId: authSessionId,
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_getAuthRSAKey();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_getAuthRSAKey = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'getAuthRSAKey failed: unknown result';
};
AuthServiceClient.prototype.openAuthSession = function(request, callback) {
  this.send_openAuthSession(request, callback); 
  if (!callback) {
    return this.recv_openAuthSession();
  }
};

AuthServiceClient.prototype.send_openAuthSession = function(request, callback) {
  this.output.writeMessageBegin('openAuthSession', Thrift.MessageType.CALL, this.seqid);
  var params = {
    request: request
  };
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_openAuthSession();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_openAuthSession = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'openAuthSession failed: unknown result';
};
AuthServiceClient.prototype.normalizePhoneNumber = function(countryCode, phoneNumber, countryCodeHint, callback) {
  this.send_normalizePhoneNumber(countryCode, phoneNumber, countryCodeHint, callback); 
  if (!callback) {
    return this.recv_normalizePhoneNumber();
  }
};

AuthServiceClient.prototype.send_normalizePhoneNumber = function(countryCode, phoneNumber, countryCodeHint, callback) {
  this.output.writeMessageBegin('normalizePhoneNumber', Thrift.MessageType.CALL, this.seqid);
  var params = {
    countryCode: countryCode,
    phoneNumber: phoneNumber,
    countryCodeHint: countryCodeHint
  };
  var args = new AuthService_normalizePhoneNumber_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_normalizePhoneNumber();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_normalizePhoneNumber = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'normalizePhoneNumber failed: unknown result';
};
AuthServiceClient.prototype.respondE2EELoginRequest = function(verifier, publicKey, encryptedKeyChain, hashKeyChain, errorCode, callback) {
  this.send_respondE2EELoginRequest(verifier, publicKey, encryptedKeyChain, hashKeyChain, errorCode, callback); 
  if (!callback) {
  this.recv_respondE2EELoginRequest();
  }
};

AuthServiceClient.prototype.send_respondE2EELoginRequest = function(verifier, publicKey, encryptedKeyChain, hashKeyChain, errorCode, callback) {
  this.output.writeMessageBegin('respondE2EELoginRequest', Thrift.MessageType.CALL, this.seqid);
  var params = {
    verifier: verifier,
    publicKey: publicKey,
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_respondE2EELoginRequest();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_respondE2EELoginRequest = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
...
AuthServiceClient.prototype.confirmE2EELogin = function(verifier, deviceSecret, callback) {
  this.send_confirmE2EELogin(verifier, deviceSecret, callback); 
  if (!callback) {
    return this.recv_confirmE2EELogin();
  }
};

AuthServiceClient.prototype.send_confirmE2EELogin = function(verifier, deviceSecret, callback) {
  this.output.writeMessageBegin('confirmE2EELogin', Thrift.MessageType.CALL, this.seqid);
  var params = {
    verifier: verifier,
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_confirmE2EELogin();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_confirmE2EELogin = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'confirmE2EELogin failed: unknown result';
};
AuthServiceClient.prototype.logoutZ = function(callback) {
  this.send_logoutZ(callback); 
  if (!callback) {
  this.recv_logoutZ();
  }
};

AuthServiceClient.prototype.send_logoutZ = function(callback) {
  this.output.writeMessageBegin('logoutZ', Thrift.MessageType.CALL, this.seqid);
...
AuthServiceClient.prototype.recv_logoutZ = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
...
AuthServiceClient.prototype.send_loginZ = function(loginRequest, callback) {
...
AuthServiceClient.prototype.recv_loginZ = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
...
AuthServiceClient.prototype.issueTokenForAccountMigrationSettings = function(enforce, callback) {
  this.send_issueTokenForAccountMigrationSettings(enforce, callback); 
  if (!callback) {
    return this.recv_issueTokenForAccountMigrationSettings();
  }
};

AuthServiceClient.prototype.send_issueTokenForAccountMigrationSettings = function(enforce, callback) {
  this.output.writeMessageBegin('issueTokenForAccountMigrationSettings', Thrift.MessageType.CALL, this.seqid);
  var params = {
    enforce: enforce
  };
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_issueTokenForAccountMigrationSettings();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_issueTokenForAccountMigrationSettings = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'issueTokenForAccountMigrationSettings failed: unknown result';
};
AuthServiceClient.prototype.issueTokenForAccountMigration = function(migrationSessionId, callback) {
  this.send_issueTokenForAccountMigration(migrationSessionId, callback); 
  if (!callback) {
    return this.recv_issueTokenForAccountMigration();
  }
};

AuthServiceClient.prototype.send_issueTokenForAccountMigration = function(migrationSessionId, callback) {
  this.output.writeMessageBegin('issueTokenForAccountMigration', Thrift.MessageType.CALL, this.seqid);
  var params = {
    migrationSessionId: migrationSessionId
  };
  var args = new AuthService_issueTokenForAccountMigration_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_issueTokenForAccountMigration();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_issueTokenForAccountMigration = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'issueTokenForAccountMigration failed: unknown result';
};
AuthServiceClient.prototype.verifyQrcodeWithE2EE = function(verifier, pinCode, errorCode, publicKey, encryptedKeyChain, hashKeyChain, callback) {
  this.send_verifyQrcodeWithE2EE(verifier, pinCode, errorCode, publicKey, encryptedKeyChain, hashKeyChain, callback); 
  if (!callback) {
    return this.recv_verifyQrcodeWithE2EE();
  }
};

AuthServiceClient.prototype.send_verifyQrcodeWithE2EE = function(verifier, pinCode, errorCode, publicKey, encryptedKeyChain, hashKeyChain, callback) {
  this.output.writeMessageBegin('verifyQrcodeWithE2EE', Thrift.MessageType.CALL, this.seqid);
  var params = {
    verifier: verifier,
    pinCode: pinCode,
    errorCode: errorCode,
  ...
  if (callback) {
    ...
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_verifyQrcodeWithE2EE();
      } catch (e) {
        result = e;
      }
      callback(result);
...
AuthServiceClient.prototype.recv_verifyQrcodeWithE2EE = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  throw 'verifyQrcodeWithE2EE failed: unknown result';
};
