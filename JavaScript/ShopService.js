  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem1696 = null;
          elem1696 = input.readString().value;
          this.productIdList.push(elem1696);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ShopService_getProductList_args.prototype.write = function(output) {
  ...
  if (this.productIdList !== null && this.productIdList !== undefined) {
    ...
    for (var iter1697 in this.productIdList)
    {
      if (this.productIdList.hasOwnProperty(iter1697))
      {
        iter1697 = this.productIdList[iter1697];
        output.writeString(iter1697);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem1704 = null;
          elem1704 = input.readString().value;
          this.productIdList.push(elem1704);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ShopService_getProductListWithCarrier_args.prototype.write = function(output) {
  ...
  if (this.productIdList !== null && this.productIdList !== undefined) {
    output.writeFieldBegin('productIdList', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRING, this.productIdList.length);
    for (var iter1705 in this.productIdList)
    {
      if (this.productIdList.hasOwnProperty(iter1705))
      {
        iter1705 = this.productIdList[iter1705];
        output.writeString(iter1705);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
