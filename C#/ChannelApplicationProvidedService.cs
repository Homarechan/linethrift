        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter751 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list752 = iprot.ReadListBegin();
                  for( int _i753 = 0; _i753 < _list752.Count; ++_i753)
                  {
                    CompactContact _elem754;
                    _elem754 = new CompactContact();
                    _elem754.Read(iprot);
                    Success.Add(_elem754);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (CompactContact _iter755 in Success)
              {
          ...
          switch (field.ID)
          {
            case 2:
              if (field.Type == TType.List) {
                {
                  Ids = new List<string>();
                  TList _list756 = iprot.ReadListBegin();
                  for( int _i757 = 0; _i757 < _list756.Count; ++_i757)
                  {
                    string _elem758;
      ...
      try
      {
        ...
        if (Ids != null && __isset.ids) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter759 in Ids)
            {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Contact _iter763 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter767 in Success)
              {
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.List) {
                {
                  Success = new List<string>();
                  TList _list768 = iprot.ReadListBegin();
                  for( int _i769 = 0; _i769 < _list768.Count; ++_i769)
                  {
                    string _elem770;
                    _elem770 = iprot.ReadString();
                    Success.Add(_elem770);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter771 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter775 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list776 = iprot.ReadListBegin();
                  for( int _i777 = 0; _i777 < _list776.Count; ++_i777)
                  {
                    string _elem778;
                    _elem778 = iprot.ReadString();
                    GroupIds.Add(_elem778);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (GroupIds != null && __isset.groupIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter779 in GroupIds)
            {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list780 = iprot.ReadListBegin();
                  for( int _i781 = 0; _i781 < _list780.Count; ++_i781)
                  {
                    @Group _elem782;
                    _elem782 = new @Group();
                    _elem782.Read(iprot);
                    Success.Add(_elem782);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (@Group _iter783 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter787 in Success)
              {
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.List) {
                {
                  Ids = new List<string>();
                  TList _list788 = iprot.ReadListBegin();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Ids != null && __isset.ids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Ids.Count));
            foreach (string _iter791 in Ids)
            {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SimpleChannelContact _elem794;
                    _elem794 = new SimpleChannelContact();
                    _elem794.Read(iprot);
                    Success.Add(_elem794);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (SimpleChannelContact _iter795 in Success)
              {
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  TMap _map796 = iprot.ReadMapBegin();
                  for( int _i797 = 0; _i797 < _map796.Count; ++_i797)
                  {
                    RegistrationType _key798;
                    string _val799;
                    _key798 = (RegistrationType)iprot.ReadI32();
                    _val799 = iprot.ReadString();
                    Success[_key798] = _val799;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (RegistrationType _iter800 in Success.Keys)
              {
                oprot.WriteI32((int)_iter800);
                oprot.WriteString(Success[_iter800]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.List) {
                {
                  Success = new List<string>();
                  TList _list801 = iprot.ReadListBegin();
                  for( int _i802 = 0; _i802 < _list801.Count; ++_i802)
                  {
                    string _elem803;
                    _elem803 = iprot.ReadString();
                    Success.Add(_elem803);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter804 in Success)
              {
