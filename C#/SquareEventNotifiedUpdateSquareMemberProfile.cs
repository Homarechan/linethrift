...
public partial class SquareEventNotifiedUpdateSquareMemberProfile : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("SquareEventNotifiedUpdateSquareMemberProfile");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("SquareEventNotifiedUpdateSquareMemberProfile(");
    bool __first = true;
    if (SquareChatMid != null && __isset.squareChatMid) {
