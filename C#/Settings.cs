            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i242 = 0; _i242 < _map241.Count; ++_i242)
                {
                  SnsIdType _key243;
                  string _val244;
                  _key243 = (SnsIdType)iprot.ReadI32();
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i246 = 0; _i246 < _map245.Count; ++_i246)
                {
                  CustomMode _key247;
                  string _val248;
                  _key247 = (CustomMode)iprot.ReadI32();
    ...
    try
    {
      ...
      if (SnsAccounts != null && __isset.snsAccounts) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          {
            oprot.WriteI32((int)_iter249);
            oprot.WriteString(SnsAccounts[_iter249]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
      ...
      if (CustomModes != null && __isset.customModes) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          {
            oprot.WriteI32((int)_iter250);
            oprot.WriteString(CustomModes[_iter250]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
