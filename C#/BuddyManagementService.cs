        ...
        if (Settings != null && __isset.settings) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter594 in Settings.Keys)
            {
              ...
              oprot.WriteString(Settings[_iter594]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter619 in Attributes.Keys)
            {
              ...
              oprot.WriteString(Attributes[_iter619]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter624 in Attributes.Keys)
            {
              ...
              oprot.WriteString(Attributes[_iter624]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter629 in Attributes.Keys)
            {
              ...
              oprot.WriteString(Attributes[_iter629]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Settings != null && __isset.settings) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter634 in Settings.Keys)
            {
              ...
              oprot.WriteString(Settings[_iter634]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
