...
public partial class GetSquareChatMembersResponse : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("GetSquareChatMembersResponse");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("GetSquareChatMembersResponse(");
    bool __first = true;
    if (SquareChatMembers != null && __isset.squareChatMembers) {
      if(!__first) { __sb.Append(", "); }
      __first = false;
      __sb.Append("SquareChatMembers: ");
      __sb.Append(SquareChatMembers== null ? "<null>" : SquareChatMembers.ToString());
    }
    if (ContinuationToken != null && __isset.continuationToken) {
      if(!__first) { __sb.Append(", "); }
      __first = false;
