...
public partial class Contact : TBase
{
  ...
  private Dictionary<string, string> _statusMessageContentMetadata;
  ...
  public Dictionary<string, string> StatusMessageContentMetadata
  {
    get
    {
      return _statusMessageContentMetadata;
    }
    set
    {
      __isset.statusMessageContentMetadata = true;
      this._statusMessageContentMetadata = value;
    }
  }
  ...
  public struct Isset {
    ...
    public bool statusMessageContentMetadata;
  }
    ...
    try
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 39:
            if (field.Type == TType.I32) {
              FriendRequestStatus = (FriendRequestStatus)iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
          ...
          case 43:
            if (field.Type == TType.Map) {
              {
                StatusMessageContentMetadata = new Dictionary<string, string>();
                ...
                for( int _i136 = 0; _i136 < _map135.Count; ++_i136)
                {
                  ...
                  StatusMessageContentMetadata[_key137] = _val138;
                }
                iprot.ReadMapEnd();
              }
            } else { 
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      ...
      if (__isset.friendRequestStatus) {
        ...
        field.ID = 39;
        oprot.WriteFieldBegin(field);
        oprot.WriteI32((int)FriendRequestStatus);
        oprot.WriteFieldEnd();
      }
      ...
      if (StatusMessageContentMetadata != null && __isset.statusMessageContentMetadata) {
        field.Name = "statusMessageContentMetadata";
        field.Type = TType.Map;
        field.ID = 43;
        oprot.WriteFieldBegin(field);
        {
          oprot.WriteMapBegin(new TMap(TType.String, TType.String, StatusMessageContentMetadata.Count));
          foreach (string _iter139 in StatusMessageContentMetadata.Keys)
          {
            oprot.WriteString(_iter139);
            oprot.WriteString(StatusMessageContentMetadata[_iter139]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
  ...
  public override string ToString() {
    ...
    if (StatusMessageContentMetadata != null && __isset.statusMessageContentMetadata) {
      if(!__first) { __sb.Append(", "); }
      __first = false;
      __sb.Append("StatusMessageContentMetadata: ");
      __sb.Append(StatusMessageContentMetadata);
    }
    __sb.Append(")");
