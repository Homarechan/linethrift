              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i634 = 0; _i634 < _map633.Count; ++_i634)
                  {
                    string _key635;
                    string _val636;
                    _key635 = iprot.ReadString();
                    _val636 = iprot.ReadString();
                    ParameterMap[_key635] = _val636;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ParameterMap != null && __isset.parameterMap) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter637 in ParameterMap.Keys)
            {
              oprot.WriteString(_iter637);
              oprot.WriteString(ParameterMap[_iter637]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
