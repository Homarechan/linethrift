...
[Serializable]
#endif
public partial class UpdateBuddyProfileResult : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("UpdateBuddyProfileResult");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("UpdateBuddyProfileResult(");
    bool __first = true;
    if (RequestId != null && __isset.requestId) {
