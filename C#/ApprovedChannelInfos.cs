            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  ApprovedChannelInfo _elem129;
                  _elem129 = new ApprovedChannelInfo();
                  _elem129.Read(iprot);
                  ApprovedChannelInfos_.Add(_elem129);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (ApprovedChannelInfos_ != null && __isset.approvedChannelInfos) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (ApprovedChannelInfo _iter130 in ApprovedChannelInfos_)
          {
