            ...
            if (field.Type == TType.Set) {
              {
                ...
                TSet _set497 = iprot.ReadSetBegin();
                for( int _i498 = 0; _i498 < _set497.Count; ++_i498)
                {
                  SquareFeatureSetAttribute _elem499;
                  _elem499 = (SquareFeatureSetAttribute)iprot.ReadI32();
                  UpdateAttributes.Add(_elem499);
                }
                iprot.ReadSetEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (UpdateAttributes != null && __isset.updateAttributes) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (SquareFeatureSetAttribute _iter500 in UpdateAttributes)
          {
            oprot.WriteI32((int)_iter500);
          }
          oprot.WriteSetEnd();
        }
        oprot.WriteFieldEnd();
