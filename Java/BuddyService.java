              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<BuddySearchResult>(_list1446.size);
                  BuddySearchResult _elem1447;
                  for (int _i1448 = 0; _i1448 < _list1446.size; ++_i1448)
                  {
                    _elem1447 = new BuddySearchResult();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findBuddyContactsByQuery_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (BuddySearchResult _iter1449 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (BuddySearchResult _iter1450 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<BuddySearchResult>(_list1451.size);
            BuddySearchResult _elem1452;
            for (int _i1453 = 0; _i1453 < _list1451.size; ++_i1453)
            {
              _elem1452 = new BuddySearchResult();
    ...
    private static class getBuddyContacts_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getBuddyContacts_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Contact>(_list1454.size);
                  Contact _elem1455;
                  for (int _i1456 = 0; _i1456 < _list1454.size; ++_i1456)
                  {
                    _elem1455 = new Contact();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getBuddyContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Contact _iter1457 : struct.success)
            {
    ...
    private static class getBuddyContacts_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getBuddyContacts_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getBuddyContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Contact _iter1458 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Contact>(_list1459.size);
            Contact _elem1460;
            for (int _i1461 = 0; _i1461 < _list1459.size; ++_i1461)
            {
              _elem1460 = new Contact();
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<java.lang.String>(_list1462.size);
                  java.lang.String _elem1463;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCountriesHavingBuddy_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1465 : struct.success)
            {
    ...
    private static class getCountriesHavingBuddy_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getCountriesHavingBuddy_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCountriesHavingBuddy_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (java.lang.String _iter1466 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<java.lang.String>(_list1467.size);
            java.lang.String _elem1468;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.success = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map1470.size);
                  java.lang.String _key1471;
                  long _val1472;
                  for (int _i1473 = 0; _i1473 < _map1470.size; ++_i1473)
                  {
                    _key1471 = iprot.readString();
                    _val1472 = iprot.readI64();
                    struct.success.put(_key1471, _val1472);
                  }
                  iprot.readMapEnd();
                }
                struct.setSuccessIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getNewlyReleasedBuddyIds_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter1474 : struct.success.entrySet())
            {
              oprot.writeString(_iter1474.getKey());
              oprot.writeI64(_iter1474.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
    ...
    private static class getNewlyReleasedBuddyIds_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getNewlyReleasedBuddyIds_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getNewlyReleasedBuddyIds_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter1475 : struct.success.entrySet())
            {
              oprot.writeString(_iter1475.getKey());
              oprot.writeI64(_iter1475.getValue());
            }
          }
        }
        if (struct.isSetE()) {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getNewlyReleasedBuddyIds_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map1476 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
            struct.success = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map1476.size);
            java.lang.String _key1477;
            long _val1478;
            for (int _i1479 = 0; _i1479 < _map1476.size; ++_i1479)
            {
              _key1477 = iprot.readString();
              _val1478 = iprot.readI64();
              struct.success.put(_key1477, _val1478);
            }
          }
          struct.setSuccessIsSet(true);
        }
    ...
    private static class getPopularBuddyLists_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPopularBuddyLists_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<BuddyList>(_list1480.size);
                  BuddyList _elem1481;
                  for (int _i1482 = 0; _i1482 < _list1480.size; ++_i1482)
                  {
                    _elem1481 = new BuddyList();
                    _elem1481.read(iprot);
                    struct.success.add(_elem1481);
                  }
                  iprot.readListEnd();
                }
                struct.setSuccessIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPopularBuddyLists_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (BuddyList _iter1483 : struct.success)
            {
    ...
    private static class getPopularBuddyLists_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getPopularBuddyLists_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPopularBuddyLists_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (BuddyList _iter1484 : struct.success)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPopularBuddyLists_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list1485 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new java.util.ArrayList<BuddyList>(_list1485.size);
            BuddyList _elem1486;
            for (int _i1487 = 0; _i1487 < _list1485.size; ++_i1487)
            {
              _elem1486 = new BuddyList();
              _elem1486.read(iprot);
              struct.success.add(_elem1486);
            }
          }
          struct.setSuccessIsSet(true);
        }
    ...
    private static class getPromotedBuddyContacts_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPromotedBuddyContacts_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Contact>(_list1488.size);
                  Contact _elem1489;
                  for (int _i1490 = 0; _i1490 < _list1488.size; ++_i1490)
                  {
                    _elem1489 = new Contact();
                    _elem1489.read(iprot);
                    struct.success.add(_elem1489);
                  }
                  iprot.readListEnd();
                }
                struct.setSuccessIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPromotedBuddyContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Contact _iter1491 : struct.success)
            {
    ...
    private static class getPromotedBuddyContacts_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getPromotedBuddyContacts_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPromotedBuddyContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Contact _iter1492 : struct.success)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPromotedBuddyContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list1493 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new java.util.ArrayList<Contact>(_list1493.size);
            Contact _elem1494;
            for (int _i1495 = 0; _i1495 < _list1493.size; ++_i1495)
            {
              _elem1494 = new Contact();
              _elem1494.read(iprot);
              struct.success.add(_elem1494);
            }
          }
          struct.setSuccessIsSet(true);
        }
