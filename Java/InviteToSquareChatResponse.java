...
public class InviteToSquareChatResponse implements org.apache.thrift.TBase<InviteToSquareChatResponse, InviteToSquareChatResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InviteToSquareChatResponse> {
  ...
  public InviteToSquareChatResponse setInviteeMids(java.util.List<java.lang.String> inviteeMids) {
    this.inviteeMids = inviteeMids;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inviteeMids = new java.util.ArrayList<java.lang.String>(_list898.size);
                java.lang.String _elem899;
                for (int _i900 = 0; _i900 < _list898.size; ++_i900)
                {
                  _elem899 = iprot.readString();
                  struct.inviteeMids.add(_elem899);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InviteToSquareChatResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.inviteeMids != null) {
        oprot.writeFieldBegin(INVITEE_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter901 : struct.inviteeMids)
          {
      ...
      if (struct.isSetInviteeMids()) {
        {
          ...
          for (java.lang.String _iter902 : struct.inviteeMids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.inviteeMids = new java.util.ArrayList<java.lang.String>(_list903.size);
          java.lang.String _elem904;
          for (int _i905 = 0; _i905 < _list903.size; ++_i905)
          {
            _elem904 = iprot.readString();
            struct.inviteeMids.add(_elem904);
          }
        }
        struct.setInviteeMidsIsSet(true);
      }
