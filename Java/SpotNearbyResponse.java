...
public class SpotNearbyResponse implements org.apache.thrift.TBase<SpotNearbyResponse, SpotNearbyResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SpotNearbyResponse> {
  ...
  public java.util.List<SpotNearbyItem> spotNearbyItems; // required
  ...
  public SpotNearbyResponse setSpotNearbyItems(java.util.List<SpotNearbyItem> spotNearbyItems) {
    this.spotNearbyItems = spotNearbyItems;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spotNearbyItems = new java.util.ArrayList<SpotNearbyItem>(_list166.size);
                SpotNearbyItem _elem167;
                for (int _i168 = 0; _i168 < _list166.size; ++_i168)
                {
                  _elem167 = new SpotNearbyItem();
                  _elem167.read(iprot);
                  struct.spotNearbyItems.add(_elem167);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SpotNearbyResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.spotNearbyItems != null) {
        oprot.writeFieldBegin(SPOT_NEARBY_ITEMS_FIELD_DESC);
        {
          ...
          for (SpotNearbyItem _iter169 : struct.spotNearbyItems)
          {
      ...
      if (struct.isSetSpotNearbyItems()) {
        {
          ...
          for (SpotNearbyItem _iter170 : struct.spotNearbyItems)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.spotNearbyItems = new java.util.ArrayList<SpotNearbyItem>(_list171.size);
          SpotNearbyItem _elem172;
          for (int _i173 = 0; _i173 < _list171.size; ++_i173)
          {
            _elem172 = new SpotNearbyItem();
            _elem172.read(iprot);
            struct.spotNearbyItems.add(_elem172);
          }
        }
        struct.setSpotNearbyItemsIsSet(true);
      }
