...
public class ProximityMatchCandidateResult implements org.apache.thrift.TBase<ProximityMatchCandidateResult, ProximityMatchCandidateResult._Fields>, java.io.Serializable, Cloneable, Comparable<ProximityMatchCandidateResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Contact> users; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<Contact> buddies; // required
  ...
  public ProximityMatchCandidateResult setUsers(@org.apache.thrift.annotation.Nullable java.util.List<Contact> users) {
    this.users = users;
    return this;
  }
  ...
  public ProximityMatchCandidateResult setBuddies(@org.apache.thrift.annotation.Nullable java.util.List<Contact> buddies) {
    this.buddies = buddies;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new java.util.ArrayList<Contact>(_list418.size);
                @org.apache.thrift.annotation.Nullable Contact _elem419;
                for (int _i420 = 0; _i420 < _list418.size; ++_i420)
                {
                  _elem419 = new Contact();
                  _elem419.read(iprot);
                  struct.users.add(_elem419);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buddies = new java.util.ArrayList<Contact>(_list421.size);
                @org.apache.thrift.annotation.Nullable Contact _elem422;
                for (int _i423 = 0; _i423 < _list421.size; ++_i423)
                {
                  _elem422 = new Contact();
                  _elem422.read(iprot);
                  struct.buddies.add(_elem422);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProximityMatchCandidateResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.users != null) {
        oprot.writeFieldBegin(USERS_FIELD_DESC);
        {
          ...
          for (Contact _iter424 : struct.users)
          {
      ...
      if (struct.buddies != null) {
        oprot.writeFieldBegin(BUDDIES_FIELD_DESC);
        {
          ...
          for (Contact _iter425 : struct.buddies)
          {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (Contact _iter426 : struct.users)
          {
      ...
      if (struct.isSetBuddies()) {
        {
          ...
          for (Contact _iter427 : struct.buddies)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new java.util.ArrayList<Contact>(_list428.size);
          @org.apache.thrift.annotation.Nullable Contact _elem429;
          for (int _i430 = 0; _i430 < _list428.size; ++_i430)
          {
            _elem429 = new Contact();
            _elem429.read(iprot);
            struct.users.add(_elem429);
          }
        }
        struct.setUsersIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.buddies = new java.util.ArrayList<Contact>(_list431.size);
          @org.apache.thrift.annotation.Nullable Contact _elem432;
          for (int _i433 = 0; _i433 < _list431.size; ++_i433)
          {
            _elem432 = new Contact();
            _elem432.read(iprot);
            struct.buddies.add(_elem432);
          }
        }
        struct.setBuddiesIsSet(true);
      }
