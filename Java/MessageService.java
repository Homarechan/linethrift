...
public class MessageService {
  ...
  public static class fetchMessageOperations_result implements org.apache.thrift.TBase<fetchMessageOperations_result, fetchMessageOperations_result._Fields>, java.io.Serializable, Cloneable, Comparable<fetchMessageOperations_result>   {
    ...
    public MessageOperations success; // required
    ...
    public fetchMessageOperations_result setSuccess(MessageOperations success) {
      this.success = success;
      return this;
    }
    ...
    public fetchMessageOperations_result setE(TalkException e) {
      this.e = e;
      return this;
    }
  ...
  public static class getLastReadMessageIds_args implements org.apache.thrift.TBase<getLastReadMessageIds_args, getLastReadMessageIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<getLastReadMessageIds_args>   {
    ...
    public getLastReadMessageIds_args setChatId(java.lang.String chatId) {
      this.chatId = chatId;
      return this;
    }
  ...
  public static class getLastReadMessageIds_result implements org.apache.thrift.TBase<getLastReadMessageIds_result, getLastReadMessageIds_result._Fields>, java.io.Serializable, Cloneable, Comparable<getLastReadMessageIds_result>   {
    ...
    public LastReadMessageIds success; // required
    public TalkException e; // required
    ...
    public getLastReadMessageIds_result setSuccess(LastReadMessageIds success) {
      this.success = success;
      return this;
    }
    ...
    public getLastReadMessageIds_result setE(TalkException e) {
      this.e = e;
      return this;
    }
  ...
  public static class multiGetLastReadMessageIds_args implements org.apache.thrift.TBase<multiGetLastReadMessageIds_args, multiGetLastReadMessageIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<multiGetLastReadMessageIds_args>   {
    ...
    public java.util.List<java.lang.String> chatIds; // required
    ...
    public multiGetLastReadMessageIds_args setChatIds(java.util.List<java.lang.String> chatIds) {
      this.chatIds = chatIds;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.chatIds = new java.util.ArrayList<java.lang.String>(_list1658.size);
                  java.lang.String _elem1659;
                  for (int _i1660 = 0; _i1660 < _list1658.size; ++_i1660)
                  {
                    _elem1659 = iprot.readString();
                    struct.chatIds.add(_elem1659);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, multiGetLastReadMessageIds_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.chatIds != null) {
          oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1661 : struct.chatIds)
            {
    ...
    private static class multiGetLastReadMessageIds_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<multiGetLastReadMessageIds_args> {
        ...
        if (struct.isSetChatIds()) {
          {
            ...
            for (java.lang.String _iter1662 : struct.chatIds)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, multiGetLastReadMessageIds_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list1663 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.chatIds = new java.util.ArrayList<java.lang.String>(_list1663.size);
            java.lang.String _elem1664;
            for (int _i1665 = 0; _i1665 < _list1663.size; ++_i1665)
            {
              _elem1664 = iprot.readString();
              struct.chatIds.add(_elem1664);
            }
          }
          struct.setChatIdsIsSet(true);
        }
  ...
  public static class multiGetLastReadMessageIds_result implements org.apache.thrift.TBase<multiGetLastReadMessageIds_result, multiGetLastReadMessageIds_result._Fields>, java.io.Serializable, Cloneable, Comparable<multiGetLastReadMessageIds_result>   {
    ...
    public java.util.List<LastReadMessageIds> success; // required
    public TalkException e; // required
    ...
    public multiGetLastReadMessageIds_result setSuccess(java.util.List<LastReadMessageIds> success) {
      this.success = success;
      return this;
    }
    ...
    public multiGetLastReadMessageIds_result setE(TalkException e) {
      this.e = e;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<LastReadMessageIds>(_list1666.size);
                  LastReadMessageIds _elem1667;
                  for (int _i1668 = 0; _i1668 < _list1666.size; ++_i1668)
                  {
                    _elem1667 = new LastReadMessageIds();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, multiGetLastReadMessageIds_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (LastReadMessageIds _iter1669 : struct.success)
            {
    ...
    private static class multiGetLastReadMessageIds_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<multiGetLastReadMessageIds_result> {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (LastReadMessageIds _iter1670 : struct.success)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, multiGetLastReadMessageIds_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list1671 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new java.util.ArrayList<LastReadMessageIds>(_list1671.size);
            LastReadMessageIds _elem1672;
            for (int _i1673 = 0; _i1673 < _list1671.size; ++_i1673)
            {
              _elem1672 = new LastReadMessageIds();
