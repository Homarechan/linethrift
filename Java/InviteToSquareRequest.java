...
public class InviteToSquareRequest implements org.apache.thrift.TBase<InviteToSquareRequest, InviteToSquareRequest._Fields>, java.io.Serializable, Cloneable, Comparable<InviteToSquareRequest> {
  ...
  public java.util.List<java.lang.String> invitees; // required
  ...
  public InviteToSquareRequest setSquareMid(java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public InviteToSquareRequest setInvitees(java.util.List<java.lang.String> invitees) {
    this.invitees = invitees;
    return this;
  }
  ...
  public InviteToSquareRequest setSquareChatMid(java.lang.String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invitees = new java.util.ArrayList<java.lang.String>(_list882.size);
                java.lang.String _elem883;
                for (int _i884 = 0; _i884 < _list882.size; ++_i884)
                {
                  _elem883 = iprot.readString();
                  struct.invitees.add(_elem883);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InviteToSquareRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.invitees != null) {
        oprot.writeFieldBegin(INVITEES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter885 : struct.invitees)
          {
      ...
      if (struct.isSetInvitees()) {
        {
          ...
          for (java.lang.String _iter886 : struct.invitees)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.invitees = new java.util.ArrayList<java.lang.String>(_list887.size);
          java.lang.String _elem888;
          for (int _i889 = 0; _i889 < _list887.size; ++_i889)
          {
            _elem888 = iprot.readString();
            struct.invitees.add(_elem888);
          }
        }
        struct.setInviteesIsSet(true);
      }
