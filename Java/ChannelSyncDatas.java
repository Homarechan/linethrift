            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list334.size);
                ChannelInfo _elem335;
                for (int _i336 = 0; _i336 < _list334.size; ++_i336)
                {
                  _elem335 = new ChannelInfo();
                  _elem335.read(iprot);
                  struct.channelInfos.add(_elem335);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list337.size);
                ChannelDomain _elem338;
                for (int _i339 = 0; _i339 < _list337.size; ++_i339)
                {
                  _elem338 = new ChannelDomain();
                  _elem338.read(iprot);
                  struct.channelDomains.add(_elem338);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChannelSyncDatas struct) throws org.apache.thrift.TException {
      ...
      if (struct.channelInfos != null) {
        oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for (ChannelInfo _iter340 : struct.channelInfos)
          {
      ...
      if (struct.channelDomains != null) {
        oprot.writeFieldBegin(CHANNEL_DOMAINS_FIELD_DESC);
        {
          ...
          for (ChannelDomain _iter341 : struct.channelDomains)
          {
      ...
      if (struct.isSetChannelInfos()) {
        {
          ...
          for (ChannelInfo _iter342 : struct.channelInfos)
          {
      ...
      if (struct.isSetChannelDomains()) {
        {
          ...
          for (ChannelDomain _iter343 : struct.channelDomains)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list344.size);
          ChannelInfo _elem345;
          for (int _i346 = 0; _i346 < _list344.size; ++_i346)
          {
            _elem345 = new ChannelInfo();
            _elem345.read(iprot);
            struct.channelInfos.add(_elem345);
          }
        }
        struct.setChannelInfosIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list347.size);
          ChannelDomain _elem348;
          for (int _i349 = 0; _i349 < _list347.size; ++_i349)
          {
            _elem348 = new ChannelDomain();
            _elem348.read(iprot);
            struct.channelDomains.add(_elem348);
          }
        }
        struct.setChannelDomainsIsSet(true);
      }
