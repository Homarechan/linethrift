...
public class ProductSimpleList implements org.apache.thrift.TBase<ProductSimpleList, ProductSimpleList._Fields>, java.io.Serializable, Cloneable, Comparable<ProductSimpleList> {
  ...
  public int compareTo(ProductSimpleList other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReinvokeHour(), other.isSetReinvokeHour());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetLastVersionSeq(), other.isSetLastVersionSeq());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecentNewReleaseDate(), other.isSetRecentNewReleaseDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecentEventReleaseDate(), other.isSetRecentEventReleaseDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
