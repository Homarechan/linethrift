...
public class ChannelInfo implements org.apache.thrift.TBase<ChannelInfo, ChannelInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ChannelInfo> {
  ...
  public java.lang.String entryPageUrl; // required
  ...
  public java.lang.String iconImage; // required
  public java.util.List<java.lang.String> permissions; // required
  public java.lang.String iconThumbnailImage; // required
  public java.util.List<ChannelConfiguration> channelConfigurations; // required
  public boolean lcsAllApiUsable; // required
  public java.util.Set<ChannelPermission> allowedPermissions; // required
  ...
  public ChannelInfo setChannelId(java.lang.String channelId) {
    this.channelId = channelId;
    return this;
  }
  ...
  public ChannelInfo setEntryPageUrl(java.lang.String entryPageUrl) {
    this.entryPageUrl = entryPageUrl;
    return this;
  }
  ...
  public ChannelInfo setDescriptionText(java.lang.String descriptionText) {
    this.descriptionText = descriptionText;
    return this;
  }
  ...
  public ChannelInfo setIconImage(java.lang.String iconImage) {
    this.iconImage = iconImage;
    return this;
  }
  ...
  public ChannelInfo setPermissions(java.util.List<java.lang.String> permissions) {
    this.permissions = permissions;
    return this;
  }
  ...
  public ChannelInfo setIconThumbnailImage(java.lang.String iconThumbnailImage) {
    this.iconThumbnailImage = iconThumbnailImage;
    return this;
  }
  ...
  public ChannelInfo setChannelConfigurations(java.util.List<ChannelConfiguration> channelConfigurations) {
    this.channelConfigurations = channelConfigurations;
    return this;
  }
  ...
  public ChannelInfo setAllowedPermissions(java.util.Set<ChannelPermission> allowedPermissions) {
    this.allowedPermissions = allowedPermissions;
    return this;
  }
  ...
  public ChannelInfo setChannelDomains(java.util.List<ChannelDomain> channelDomains) {
    this.channelDomains = channelDomains;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.permissions = new java.util.ArrayList<java.lang.String>(_list222.size);
                java.lang.String _elem223;
                for (int _i224 = 0; _i224 < _list222.size; ++_i224)
                {
                  _elem223 = iprot.readString();
                  struct.permissions.add(_elem223);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelConfigurations = new java.util.ArrayList<ChannelConfiguration>(_list225.size);
                ChannelConfiguration _elem226;
                for (int _i227 = 0; _i227 < _list225.size; ++_i227)
                {
                  _elem226 = ChannelConfiguration.findByValue(iprot.readI32());
                  if (_elem226 != null)
                  {
                    struct.channelConfigurations.add(_elem226);
                  }
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                ChannelPermission _elem229;
                for (int _i230 = 0; _i230 < _set228.size; ++_i230)
                {
                  _elem229 = ChannelPermission.findByValue(iprot.readI32());
                  if (_elem229 != null)
                  {
                    struct.allowedPermissions.add(_elem229);
                  }
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list231.size);
                ChannelDomain _elem232;
                for (int _i233 = 0; _i233 < _list231.size; ++_i233)
                {
                  _elem232 = new ChannelDomain();
                  _elem232.read(iprot);
                  struct.channelDomains.add(_elem232);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChannelInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.permissions != null) {
        oprot.writeFieldBegin(PERMISSIONS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter234 : struct.permissions)
          {
      ...
      if (struct.channelConfigurations != null) {
        oprot.writeFieldBegin(CHANNEL_CONFIGURATIONS_FIELD_DESC);
        {
          ...
          for (ChannelConfiguration _iter235 : struct.channelConfigurations)
          {
      ...
      if (struct.allowedPermissions != null) {
        oprot.writeFieldBegin(ALLOWED_PERMISSIONS_FIELD_DESC);
        {
          ...
          for (ChannelPermission _iter236 : struct.allowedPermissions)
          {
      ...
      if (struct.channelDomains != null) {
        oprot.writeFieldBegin(CHANNEL_DOMAINS_FIELD_DESC);
        {
          ...
          for (ChannelDomain _iter237 : struct.channelDomains)
          {
  ...
  private static class ChannelInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<ChannelInfo> {
      ...
      if (struct.isSetPermissions()) {
        {
          ...
          for (java.lang.String _iter238 : struct.permissions)
          {
      ...
      if (struct.isSetChannelConfigurations()) {
        {
          ...
          for (ChannelConfiguration _iter239 : struct.channelConfigurations)
          {
      ...
      if (struct.isSetAllowedPermissions()) {
        {
          ...
          for (ChannelPermission _iter240 : struct.allowedPermissions)
          {
      ...
      if (struct.isSetChannelDomains()) {
        {
          ...
          for (ChannelDomain _iter241 : struct.channelDomains)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ChannelInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.permissions = new java.util.ArrayList<java.lang.String>(_list242.size);
          java.lang.String _elem243;
          for (int _i244 = 0; _i244 < _list242.size; ++_i244)
          {
            _elem243 = iprot.readString();
            struct.permissions.add(_elem243);
          }
        }
        struct.setPermissionsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.channelConfigurations = new java.util.ArrayList<ChannelConfiguration>(_list245.size);
          ChannelConfiguration _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = ChannelConfiguration.findByValue(iprot.readI32());
            if (_elem246 != null)
            {
              struct.channelConfigurations.add(_elem246);
            }
          }
        }
        struct.setChannelConfigurationsIsSet(true);
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TSet _set248 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.allowedPermissions = java.util.EnumSet.noneOf(ChannelPermission.class);
          ChannelPermission _elem249;
          for (int _i250 = 0; _i250 < _set248.size; ++_i250)
          {
            _elem249 = ChannelPermission.findByValue(iprot.readI32());
            if (_elem249 != null)
            {
              struct.allowedPermissions.add(_elem249);
            }
          }
        }
        struct.setAllowedPermissionsIsSet(true);
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list251.size);
          ChannelDomain _elem252;
          for (int _i253 = 0; _i253 < _list251.size; ++_i253)
          {
            _elem252 = new ChannelDomain();
            _elem252.read(iprot);
            struct.channelDomains.add(_elem252);
          }
        }
        struct.setChannelDomainsIsSet(true);
      }
