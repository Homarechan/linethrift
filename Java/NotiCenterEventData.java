...
public class NotiCenterEventData implements org.apache.thrift.TBase<NotiCenterEventData, NotiCenterEventData._Fields>, java.io.Serializable, Cloneable, Comparable<NotiCenterEventData> {
  ...
  public int compareTo(NotiCenterEventData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOperationRevision()).compareTo(other.isSetOperationRevision());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPush()).compareTo(other.isSetPush());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPush()) {
