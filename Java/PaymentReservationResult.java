...
public class PaymentReservationResult implements org.apache.thrift.TBase<PaymentReservationResult, PaymentReservationResult._Fields>, java.io.Serializable, Cloneable, Comparable<PaymentReservationResult> {
  ...
  public java.lang.String confirmUrl; // required
  ...
  public PaymentReservationResult setOrderId(java.lang.String orderId) {
    this.orderId = orderId;
    return this;
  }
  ...
  public PaymentReservationResult setConfirmUrl(java.lang.String confirmUrl) {
    this.confirmUrl = confirmUrl;
    return this;
  }
  ...
  public PaymentReservationResult setExtras(java.util.Map<java.lang.String,java.lang.String> extras) {
    this.extras = extras;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extras = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map552.size);
                java.lang.String _key553;
                java.lang.String _val554;
                for (int _i555 = 0; _i555 < _map552.size; ++_i555)
                {
                  _key553 = iprot.readString();
                  _val554 = iprot.readString();
                  struct.extras.put(_key553, _val554);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaymentReservationResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.extras != null) {
        oprot.writeFieldBegin(EXTRAS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter556 : struct.extras.entrySet())
          {
      ...
      if (struct.isSetExtras()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter557 : struct.extras.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.extras = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map558.size);
          java.lang.String _key559;
          java.lang.String _val560;
          for (int _i561 = 0; _i561 < _map558.size; ++_i561)
          {
            _key559 = iprot.readString();
            _val560 = iprot.readString();
            struct.extras.put(_key559, _val560);
          }
        }
        struct.setExtrasIsSet(true);
      }
