...
public class BuddyBanner implements org.apache.thrift.TBase<BuddyBanner, BuddyBanner._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyBanner> {
  ...
  public int compareTo(BuddyBanner other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuddyBannerLinkType(), other.isSetBuddyBannerLinkType());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuddyBannerLink(), other.isSetBuddyBannerLink());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuddyBannerLink()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuddyBannerImageUrl(), other.isSetBuddyBannerImageUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuddyBannerImageUrl()) {
