...
public class UpdateSquareMembersRequest implements org.apache.thrift.TBase<UpdateSquareMembersRequest, UpdateSquareMembersRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMembersRequest> {
        ...
        switch (schemeField.id) {
          case 2: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1042 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
                SquareMemberAttribute _elem1043;
                for (int _i1044 = 0; _i1044 < _set1042.size; ++_i1044)
                {
                  _elem1043 = SquareMemberAttribute.findByValue(iprot.readI32());
                  if (_elem1043 != null)
                  {
                    struct.updatedAttrs.add(_elem1043);
                  }
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.members = new java.util.ArrayList<SquareMember>(_list1045.size);
                SquareMember _elem1046;
                for (int _i1047 = 0; _i1047 < _list1045.size; ++_i1047)
                {
                  _elem1046 = new SquareMember();
                  _elem1046.read(iprot);
                  struct.members.add(_elem1046);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMembersRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberAttribute _iter1048 : struct.updatedAttrs)
          {
      ...
      if (struct.members != null) {
        oprot.writeFieldBegin(MEMBERS_FIELD_DESC);
        {
          ...
          for (SquareMember _iter1049 : struct.members)
          {
  ...
  private static class UpdateSquareMembersRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMembersRequest> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberAttribute _iter1050 : struct.updatedAttrs)
          {
      ...
      if (struct.isSetMembers()) {
        {
          ...
          for (SquareMember _iter1051 : struct.members)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMembersRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set1052 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
          SquareMemberAttribute _elem1053;
          for (int _i1054 = 0; _i1054 < _set1052.size; ++_i1054)
          {
            _elem1053 = SquareMemberAttribute.findByValue(iprot.readI32());
            if (_elem1053 != null)
            {
              struct.updatedAttrs.add(_elem1053);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.members = new java.util.ArrayList<SquareMember>(_list1055.size);
          SquareMember _elem1056;
          for (int _i1057 = 0; _i1057 < _list1055.size; ++_i1057)
          {
            _elem1056 = new SquareMember();
            _elem1056.read(iprot);
            struct.members.add(_elem1056);
          }
        }
        struct.setMembersIsSet(true);
      }
