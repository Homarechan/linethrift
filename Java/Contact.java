...
public class Contact implements org.apache.thrift.TBase<Contact, Contact._Fields>, java.io.Serializable, Cloneable, Comparable<Contact> {
  ...
  private static final org.apache.thrift.protocol.TField STATUS_MESSAGE_CONTENT_METADATA_FIELD_DESC = new org.apache.thrift.protocol.TField("statusMessageContentMetadata", org.apache.thrift.protocol.TType.MAP, (short)43);
  ...
  public java.util.Map<java.lang.String,java.lang.String> statusMessageContentMetadata; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    STATUS_MESSAGE_CONTENT_METADATA((short)43, "statusMessageContentMetadata");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 43: // STATUS_MESSAGE_CONTENT_METADATA
          return STATUS_MESSAGE_CONTENT_METADATA;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.VIDEO_PROFILE, new org.apache.thrift.meta_data.FieldMetaData("videoProfile", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.STATUS_MESSAGE_CONTENT_METADATA, new org.apache.thrift.meta_data.FieldMetaData("statusMessageContentMetadata", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Contact(
    ...
    java.util.Map<java.lang.String,java.lang.String> statusMessageContentMetadata)
  {
    this();
    this.mid = mid;
    ...
    this.statusMessageContentMetadata = statusMessageContentMetadata;
  }
  ...
  public Contact(Contact other) {
    ...
    if (other.isSetStatusMessageContentMetadata()) {
      java.util.Map<java.lang.String,java.lang.String> __this__statusMessageContentMetadata = new java.util.HashMap<java.lang.String,java.lang.String>(other.statusMessageContentMetadata);
      this.statusMessageContentMetadata = __this__statusMessageContentMetadata;
    }
  }
  ...
  public int getStatusMessageContentMetadataSize() {
    return (this.statusMessageContentMetadata == null) ? 0 : this.statusMessageContentMetadata.size();
  }

  public void putToStatusMessageContentMetadata(java.lang.String key, java.lang.String val) {
    if (this.statusMessageContentMetadata == null) {
      this.statusMessageContentMetadata = new java.util.HashMap<java.lang.String,java.lang.String>();
    }
    this.statusMessageContentMetadata.put(key, val);
  }

  public java.util.Map<java.lang.String,java.lang.String> getStatusMessageContentMetadata() {
    return this.statusMessageContentMetadata;
  }

  public Contact setStatusMessageContentMetadata(java.util.Map<java.lang.String,java.lang.String> statusMessageContentMetadata) {
    this.statusMessageContentMetadata = statusMessageContentMetadata;
    return this;
  }

  public void unsetStatusMessageContentMetadata() {
    this.statusMessageContentMetadata = null;
  }

  /** Returns true if field statusMessageContentMetadata is set (has been assigned a value) and false otherwise */
  public boolean isSetStatusMessageContentMetadata() {
    return this.statusMessageContentMetadata != null;
  }

  public void setStatusMessageContentMetadataIsSet(boolean value) {
    if (!value) {
      this.statusMessageContentMetadata = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case STATUS_MESSAGE_CONTENT_METADATA:
      if (value == null) {
        unsetStatusMessageContentMetadata();
      } else {
        setStatusMessageContentMetadata((java.util.Map<java.lang.String,java.lang.String>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case STATUS_MESSAGE_CONTENT_METADATA:
      return getStatusMessageContentMetadata();
  ...
  public boolean isSet(_Fields field) {
    ...
    case STATUS_MESSAGE_CONTENT_METADATA:
      return isSetStatusMessageContentMetadata();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(Contact that) {
    ...
    boolean this_present_statusMessageContentMetadata = true && this.isSetStatusMessageContentMetadata();
    boolean that_present_statusMessageContentMetadata = true && that.isSetStatusMessageContentMetadata();
    if (this_present_statusMessageContentMetadata || that_present_statusMessageContentMetadata) {
      if (!(this_present_statusMessageContentMetadata && that_present_statusMessageContentMetadata))
        return false;
      if (!this.statusMessageContentMetadata.equals(that.statusMessageContentMetadata))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetStatusMessageContentMetadata()) ? 131071 : 524287);
    if (isSetStatusMessageContentMetadata())
      hashCode = hashCode * 8191 + statusMessageContentMetadata.hashCode();
  ...
  public int compareTo(Contact other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStatusMessageContentMetadata()).compareTo(other.isSetStatusMessageContentMetadata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatusMessageContentMetadata()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.statusMessageContentMetadata, other.statusMessageContentMetadata);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("statusMessageContentMetadata:");
    if (this.statusMessageContentMetadata == null) {
      sb.append("null");
    } else {
      sb.append(this.statusMessageContentMetadata);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class ContactStandardScheme extends org.apache.thrift.scheme.StandardScheme<Contact> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.statusMessageContentMetadata = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map270.size);
                ...
                for (int _i273 = 0; _i273 < _map270.size; ++_i273)
                {
                  ...
                  struct.statusMessageContentMetadata.put(_key271, _val272);
                }
                iprot.readMapEnd();
              }
              struct.setStatusMessageContentMetadataIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Contact struct) throws org.apache.thrift.TException {
      ...
      if (struct.statusMessageContentMetadata != null) {
        oprot.writeFieldBegin(STATUS_MESSAGE_CONTENT_METADATA_FIELD_DESC);
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.statusMessageContentMetadata.size()));
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter274 : struct.statusMessageContentMetadata.entrySet())
          {
  ...
  private static class ContactTupleScheme extends org.apache.thrift.scheme.TupleScheme<Contact> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Contact struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetStatusMessageContentMetadata()) {
        optionals.set(23);
      }
      ...
      if (struct.isSetStatusMessageContentMetadata()) {
        {
          oprot.writeI32(struct.statusMessageContentMetadata.size());
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter275 : struct.statusMessageContentMetadata.entrySet())
          {
      ...
      if (incoming.get(23)) {
        {
          ...
          struct.statusMessageContentMetadata = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map276.size);
          ...
          for (int _i279 = 0; _i279 < _map276.size; ++_i279)
          {
            ...
            struct.statusMessageContentMetadata.put(_key277, _val278);
          }
        }
        struct.setStatusMessageContentMetadataIsSet(true);
      }
