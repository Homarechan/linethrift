...
public class UpdateSquareMemberRelationRequest implements org.apache.thrift.TBase<UpdateSquareMemberRelationRequest, UpdateSquareMemberRelationRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMemberRelationRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Set<SquareMemberRelationAttribute> updatedAttrs; // required
  ...
  public UpdateSquareMemberRelationRequest setSquareMid(@org.apache.thrift.annotation.Nullable java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public UpdateSquareMemberRelationRequest setTargetSquareMemberMid(@org.apache.thrift.annotation.Nullable java.lang.String targetSquareMemberMid) {
    this.targetSquareMemberMid = targetSquareMemberMid;
    return this;
  }
  ...
  public UpdateSquareMemberRelationRequest setUpdatedAttrs(@org.apache.thrift.annotation.Nullable java.util.Set<SquareMemberRelationAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareMemberRelationRequest setRelation(@org.apache.thrift.annotation.Nullable SquareMemberRelation relation) {
    this.relation = relation;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 4: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set982 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberRelationAttribute.class);
                @org.apache.thrift.annotation.Nullable SquareMemberRelationAttribute _elem983;
                for (int _i984 = 0; _i984 < _set982.size; ++_i984)
                {
                  _elem983 = SquareMemberRelationAttribute.findByValue(iprot.readI32());
                  if (_elem983 != null)
                  {
                    struct.updatedAttrs.add(_elem983);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMemberRelationRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberRelationAttribute _iter985 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter985.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UpdateSquareMemberRelationRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMemberRelationRequest> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberRelationAttribute _iter986 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter986.getValue());
          }
        }
      }
      if (struct.isSetRelation()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMemberRelationRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TSet _set987 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberRelationAttribute.class);
          @org.apache.thrift.annotation.Nullable SquareMemberRelationAttribute _elem988;
          for (int _i989 = 0; _i989 < _set987.size; ++_i989)
          {
            _elem988 = SquareMemberRelationAttribute.findByValue(iprot.readI32());
            if (_elem988 != null)
            {
              struct.updatedAttrs.add(_elem988);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
