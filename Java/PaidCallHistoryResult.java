...
public class PaidCallHistoryResult implements org.apache.thrift.TBase<PaidCallHistoryResult, PaidCallHistoryResult._Fields>, java.io.Serializable, Cloneable, Comparable<PaidCallHistoryResult> {
  ...
  public java.util.List<PaidCallHistory> historys; // required
  ...
  public PaidCallHistoryResult setHistorys(java.util.List<PaidCallHistory> historys) {
    this.historys = historys;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.historys = new java.util.ArrayList<PaidCallHistory>(_list182.size);
                PaidCallHistory _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new PaidCallHistory();
                  _elem183.read(iprot);
                  struct.historys.add(_elem183);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaidCallHistoryResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.historys != null) {
        oprot.writeFieldBegin(HISTORYS_FIELD_DESC);
        {
          ...
          for (PaidCallHistory _iter185 : struct.historys)
          {
      ...
      if (struct.isSetHistorys()) {
        {
          ...
          for (PaidCallHistory _iter186 : struct.historys)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.historys = new java.util.ArrayList<PaidCallHistory>(_list187.size);
          PaidCallHistory _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = new PaidCallHistory();
            _elem188.read(iprot);
            struct.historys.add(_elem188);
          }
        }
        struct.setHistorysIsSet(true);
      }
