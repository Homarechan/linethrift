...
public class GetSquareMemberRelationResponse implements org.apache.thrift.TBase<GetSquareMemberRelationResponse, GetSquareMemberRelationResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetSquareMemberRelationResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String targetSquareMemberMid; // required
  public @org.apache.thrift.annotation.Nullable SquareMemberRelation relation; // required
  ...
  public GetSquareMemberRelationResponse setSquareMid(@org.apache.thrift.annotation.Nullable java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public GetSquareMemberRelationResponse setTargetSquareMemberMid(@org.apache.thrift.annotation.Nullable java.lang.String targetSquareMemberMid) {
    this.targetSquareMemberMid = targetSquareMemberMid;
    return this;
  }
  ...
  public GetSquareMemberRelationResponse setRelation(@org.apache.thrift.annotation.Nullable SquareMemberRelation relation) {
    this.relation = relation;
    return this;
  }
  ...
  public int compareTo(GetSquareMemberRelationResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTargetSquareMemberMid(), other.isSetTargetSquareMemberMid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTargetSquareMemberMid()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRelation(), other.isSetRelation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRelation()) {
