            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rejectedMembers = new java.util.ArrayList<SquareMember>(_list1084.size);
                SquareMember _elem1085;
                for (int _i1086 = 0; _i1086 < _list1084.size; ++_i1086)
                {
                  _elem1085 = new SquareMember();
                  _elem1085.read(iprot);
                  struct.rejectedMembers.add(_elem1085);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RejectSquareMembersResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.rejectedMembers != null) {
        oprot.writeFieldBegin(REJECTED_MEMBERS_FIELD_DESC);
        {
          ...
          for (SquareMember _iter1087 : struct.rejectedMembers)
          {
      ...
      if (struct.isSetRejectedMembers()) {
        {
          ...
          for (SquareMember _iter1088 : struct.rejectedMembers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.rejectedMembers = new java.util.ArrayList<SquareMember>(_list1089.size);
          SquareMember _elem1090;
          for (int _i1091 = 0; _i1091 < _list1089.size; ++_i1091)
          {
            _elem1090 = new SquareMember();
            _elem1090.read(iprot);
            struct.rejectedMembers.add(_elem1090);
          }
        }
        struct.setRejectedMembersIsSet(true);
      }
