...
public class RejectSquareMembersResponse implements org.apache.thrift.TBase<RejectSquareMembersResponse, RejectSquareMembersResponse._Fields>, java.io.Serializable, Cloneable, Comparable<RejectSquareMembersResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SquareMember> rejectedMembers; // required
  ...
  public RejectSquareMembersResponse setRejectedMembers(@org.apache.thrift.annotation.Nullable java.util.List<SquareMember> rejectedMembers) {
    this.rejectedMembers = rejectedMembers;
    return this;
  }
  ...
  public RejectSquareMembersResponse setStatus(@org.apache.thrift.annotation.Nullable SquareStatus status) {
    this.status = status;
    return this;
  }
  ...
  public int compareTo(RejectSquareMembersResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRejectedMembers(), other.isSetRejectedMembers());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable SquareMember _elem909;
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable SquareMember _elem914;
