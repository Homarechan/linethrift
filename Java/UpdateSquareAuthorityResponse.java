...
public class UpdateSquareAuthorityResponse implements org.apache.thrift.TBase<UpdateSquareAuthorityResponse, UpdateSquareAuthorityResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareAuthorityResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Set<SquareAuthorityAttribute> updatdAttributes; // required
  ...
  public UpdateSquareAuthorityResponse setUpdatdAttributes(@org.apache.thrift.annotation.Nullable java.util.Set<SquareAuthorityAttribute> updatdAttributes) {
    this.updatdAttributes = updatdAttributes;
    return this;
  }
  ...
  public UpdateSquareAuthorityResponse setAuthority(@org.apache.thrift.annotation.Nullable SquareAuthority authority) {
    this.authority = authority;
    return this;
  }
  ...
  public int compareTo(UpdateSquareAuthorityResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUpdatdAttributes(), other.isSetUpdatdAttributes());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                @org.apache.thrift.annotation.Nullable SquareAuthorityAttribute _elem975;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.updatdAttributes = java.util.EnumSet.noneOf(SquareAuthorityAttribute.class);
          @org.apache.thrift.annotation.Nullable SquareAuthorityAttribute _elem980;
