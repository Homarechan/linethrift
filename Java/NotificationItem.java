            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.content = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map534.size);
                ...
                for (int _i537 = 0; _i537 < _map534.size; ++_i537)
                {
                  ...
                  struct.content.put(_key535, _val536);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NotificationItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.content != null) {
        oprot.writeFieldBegin(CONTENT_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter538 : struct.content.entrySet())
          {
      ...
      if (struct.isSetContent()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter539 : struct.content.entrySet())
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.content = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map540.size);
          java.lang.String _key541;
          java.lang.String _val542;
          for (int _i543 = 0; _i543 < _map540.size; ++_i543)
          {
            _key541 = iprot.readString();
            _val542 = iprot.readString();
            struct.content.put(_key541, _val542);
          }
        }
        struct.setContentIsSet(true);
      }
