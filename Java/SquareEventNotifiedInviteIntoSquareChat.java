...
public class SquareEventNotifiedInviteIntoSquareChat implements org.apache.thrift.TBase<SquareEventNotifiedInviteIntoSquareChat, SquareEventNotifiedInviteIntoSquareChat._Fields>, java.io.Serializable, Cloneable, Comparable<SquareEventNotifiedInviteIntoSquareChat> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SquareMember> invitees; // required
  public @org.apache.thrift.annotation.Nullable SquareMember invitor; // required
  public @org.apache.thrift.annotation.Nullable SquareMemberRelation invitorRelation; // required
  ...
  public SquareEventNotifiedInviteIntoSquareChat setSquareChatMid(@org.apache.thrift.annotation.Nullable java.lang.String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
  ...
  public SquareEventNotifiedInviteIntoSquareChat setInvitees(@org.apache.thrift.annotation.Nullable java.util.List<SquareMember> invitees) {
    this.invitees = invitees;
    return this;
  }
  ...
  public SquareEventNotifiedInviteIntoSquareChat setInvitor(@org.apache.thrift.annotation.Nullable SquareMember invitor) {
    this.invitor = invitor;
    return this;
  }
  ...
  public SquareEventNotifiedInviteIntoSquareChat setInvitorRelation(@org.apache.thrift.annotation.Nullable SquareMemberRelation invitorRelation) {
    this.invitorRelation = invitorRelation;
    return this;
  }
  ...
  public int compareTo(SquareEventNotifiedInviteIntoSquareChat other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInvitor(), other.isSetInvitor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInvitor()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInvitorRelation(), other.isSetInvitorRelation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInvitorRelation()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invitees = new java.util.ArrayList<SquareMember>(_list674.size);
                @org.apache.thrift.annotation.Nullable SquareMember _elem675;
                for (int _i676 = 0; _i676 < _list674.size; ++_i676)
                {
                  _elem675 = new SquareMember();
                  _elem675.read(iprot);
                  struct.invitees.add(_elem675);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SquareEventNotifiedInviteIntoSquareChat struct) throws org.apache.thrift.TException {
      ...
      if (struct.invitees != null) {
        oprot.writeFieldBegin(INVITEES_FIELD_DESC);
        {
          ...
          for (SquareMember _iter677 : struct.invitees)
          {
      ...
      if (struct.isSetInvitees()) {
        {
          ...
          for (SquareMember _iter678 : struct.invitees)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.invitees = new java.util.ArrayList<SquareMember>(_list679.size);
          @org.apache.thrift.annotation.Nullable SquareMember _elem680;
          for (int _i681 = 0; _i681 < _list679.size; ++_i681)
          {
            _elem680 = new SquareMember();
            _elem680.read(iprot);
            struct.invitees.add(_elem680);
          }
        }
        struct.setInviteesIsSet(true);
      }
