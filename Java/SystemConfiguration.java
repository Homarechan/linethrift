...
public class SystemConfiguration implements org.apache.thrift.TBase<SystemConfiguration, SystemConfiguration._Fields>, java.io.Serializable, Cloneable, Comparable<SystemConfiguration> {
  ...
  public java.lang.String endpoint; // required
  public java.lang.String endpointSsl; // required
  public java.lang.String updateUrl; // required
  public java.lang.String c2dmAccount; // required
  public java.lang.String nniServer; // required
  ...
  public SystemConfiguration setEndpoint(java.lang.String endpoint) {
    this.endpoint = endpoint;
    return this;
  }
  ...
  public SystemConfiguration setEndpointSsl(java.lang.String endpointSsl) {
    this.endpointSsl = endpointSsl;
    return this;
  }
  ...
  public SystemConfiguration setUpdateUrl(java.lang.String updateUrl) {
    this.updateUrl = updateUrl;
    return this;
  }
  ...
  public SystemConfiguration setC2dmAccount(java.lang.String c2dmAccount) {
    this.c2dmAccount = c2dmAccount;
    return this;
  }
  ...
  public SystemConfiguration setNniServer(java.lang.String nniServer) {
    this.nniServer = nniServer;
    return this;
  }
  ...
  public int compareTo(SystemConfiguration other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEndpointSsl()).compareTo(other.isSetEndpointSsl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEndpointSsl()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetC2dmAccount()).compareTo(other.isSetC2dmAccount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetC2dmAccount()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNniServer()).compareTo(other.isSetNniServer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNniServer()) {
