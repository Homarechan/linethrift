...
public class CoinHistory implements org.apache.thrift.TBase<CoinHistory, CoinHistory._Fields>, java.io.Serializable, Cloneable, Comparable<CoinHistory> {
  ...
  public int compareTo(CoinHistory other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPayDate(), other.isSetPayDate());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCoinBalance(), other.isSetCoinBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCoinBalance()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPaySeq(), other.isSetPaySeq());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPaySeq()) {
