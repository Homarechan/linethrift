...
public class FetchSquareChatEventsResponse implements org.apache.thrift.TBase<FetchSquareChatEventsResponse, FetchSquareChatEventsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FetchSquareChatEventsResponse> {
  ...
  public FetchSquareChatEventsResponse setSubscription(SubscriptionState subscription) {
    this.subscription = subscription;
    return this;
  }
  ...
  public FetchSquareChatEventsResponse setEvents(java.util.List<SquareEvent> events) {
    this.events = events;
    return this;
  }
  ...
  public FetchSquareChatEventsResponse setSyncToken(java.lang.String syncToken) {
    this.syncToken = syncToken;
    return this;
  }
  ...
  public FetchSquareChatEventsResponse setContinuationToken(java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<SquareEvent>(_list874.size);
                SquareEvent _elem875;
                for (int _i876 = 0; _i876 < _list874.size; ++_i876)
                {
                  _elem875 = new SquareEvent();
                  _elem875.read(iprot);
                  struct.events.add(_elem875);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FetchSquareChatEventsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.events != null) {
        oprot.writeFieldBegin(EVENTS_FIELD_DESC);
        {
          ...
          for (SquareEvent _iter877 : struct.events)
          {
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (SquareEvent _iter878 : struct.events)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.events = new java.util.ArrayList<SquareEvent>(_list879.size);
          SquareEvent _elem880;
          for (int _i881 = 0; _i881 < _list879.size; ++_i881)
          {
            _elem880 = new SquareEvent();
            _elem880.read(iprot);
            struct.events.add(_elem880);
          }
        }
        struct.setEventsIsSet(true);
      }
