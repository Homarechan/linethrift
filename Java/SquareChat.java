...
public class SquareChat implements org.apache.thrift.TBase<SquareChat, SquareChat._Fields>, java.io.Serializable, Cloneable, Comparable<SquareChat> {
  ...
  public int compareTo(SquareChat other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChatImageObsHash(), other.isSetChatImageObsHash());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatImageObsHash()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSquareChatRevision(), other.isSetSquareChatRevision());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetMaxMemberCount(), other.isSetMaxMemberCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
