...
public class UpdateSquareMemberRequest implements org.apache.thrift.TBase<UpdateSquareMemberRequest, UpdateSquareMemberRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMemberRequest> {
        ...
        switch (schemeField.id) {
          case 2: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1010 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
                SquareMemberAttribute _elem1011;
                for (int _i1012 = 0; _i1012 < _set1010.size; ++_i1012)
                {
                  _elem1011 = SquareMemberAttribute.findByValue(iprot.readI32());
                  if (_elem1011 != null)
                  {
                    struct.updatedAttrs.add(_elem1011);
                  }
                }
                iprot.readSetEnd();
              }
          ...
          case 3: // UPDATED_PREFERENCE_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1013 = iprot.readSetBegin();
                struct.updatedPreferenceAttrs = java.util.EnumSet.noneOf(SquarePreferenceAttribute.class);
                SquarePreferenceAttribute _elem1014;
                for (int _i1015 = 0; _i1015 < _set1013.size; ++_i1015)
                {
                  _elem1014 = SquarePreferenceAttribute.findByValue(iprot.readI32());
                  if (_elem1014 != null)
                  {
                    struct.updatedPreferenceAttrs.add(_elem1014);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMemberRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberAttribute _iter1016 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter1016.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.updatedPreferenceAttrs != null) {
        oprot.writeFieldBegin(UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
        {
          ...
          for (SquarePreferenceAttribute _iter1017 : struct.updatedPreferenceAttrs)
          {
            oprot.writeI32(_iter1017.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UpdateSquareMemberRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMemberRequest> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberAttribute _iter1018 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter1018.getValue());
          }
        }
      }
      if (struct.isSetUpdatedPreferenceAttrs()) {
        {
          ...
          for (SquarePreferenceAttribute _iter1019 : struct.updatedPreferenceAttrs)
          {
            oprot.writeI32(_iter1019.getValue());
          }
        }
      }
      if (struct.isSetSquareMember()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMemberRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set1020 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
          SquareMemberAttribute _elem1021;
          for (int _i1022 = 0; _i1022 < _set1020.size; ++_i1022)
          {
            _elem1021 = SquareMemberAttribute.findByValue(iprot.readI32());
            if (_elem1021 != null)
            {
              struct.updatedAttrs.add(_elem1021);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.updatedPreferenceAttrs = java.util.EnumSet.noneOf(SquarePreferenceAttribute.class);
          SquarePreferenceAttribute _elem1024;
          for (int _i1025 = 0; _i1025 < _set1023.size; ++_i1025)
          {
            _elem1024 = SquarePreferenceAttribute.findByValue(iprot.readI32());
            if (_elem1024 != null)
            {
              struct.updatedPreferenceAttrs.add(_elem1024);
            }
          }
        }
        struct.setUpdatedPreferenceAttrsIsSet(true);
