...
public class SuggestDictionaryRevisions implements org.apache.thrift.TBase<SuggestDictionaryRevisions, SuggestDictionaryRevisions._Fields>, java.io.Serializable, Cloneable, Comparable<SuggestDictionaryRevisions> {
  ...
  public SuggestItemDictionaryRevision itemRevision; // required
  public java.util.List<SuggestTagDictionaryRevision> tagRevisions; // required
  ...
  public SuggestDictionaryRevisions setItemRevision(SuggestItemDictionaryRevision itemRevision) {
    this.itemRevision = itemRevision;
    return this;
  }
  ...
  public SuggestDictionaryRevisions setTagRevisions(java.util.List<SuggestTagDictionaryRevision> tagRevisions) {
    this.tagRevisions = tagRevisions;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tagRevisions = new java.util.ArrayList<SuggestTagDictionaryRevision>(_list634.size);
                SuggestTagDictionaryRevision _elem635;
                for (int _i636 = 0; _i636 < _list634.size; ++_i636)
                {
                  _elem635 = new SuggestTagDictionaryRevision();
                  _elem635.read(iprot);
                  struct.tagRevisions.add(_elem635);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SuggestDictionaryRevisions struct) throws org.apache.thrift.TException {
      ...
      if (struct.tagRevisions != null) {
        oprot.writeFieldBegin(TAG_REVISIONS_FIELD_DESC);
        {
          ...
          for (SuggestTagDictionaryRevision _iter637 : struct.tagRevisions)
          {
      ...
      if (struct.isSetTagRevisions()) {
        {
          ...
          for (SuggestTagDictionaryRevision _iter638 : struct.tagRevisions)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.tagRevisions = new java.util.ArrayList<SuggestTagDictionaryRevision>(_list639.size);
          SuggestTagDictionaryRevision _elem640;
          for (int _i641 = 0; _i641 < _list639.size; ++_i641)
          {
            _elem640 = new SuggestTagDictionaryRevision();
            _elem640.read(iprot);
            struct.tagRevisions.add(_elem640);
          }
        }
        struct.setTagRevisionsIsSet(true);
      }
