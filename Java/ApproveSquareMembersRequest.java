            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requestedMemberMids = new java.util.ArrayList<java.lang.String>(_list752.size);
                java.lang.String _elem753;
                for (int _i754 = 0; _i754 < _list752.size; ++_i754)
                {
                  _elem753 = iprot.readString();
                  struct.requestedMemberMids.add(_elem753);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ApproveSquareMembersRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.requestedMemberMids != null) {
        oprot.writeFieldBegin(REQUESTED_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter755 : struct.requestedMemberMids)
          {
      ...
      if (struct.isSetRequestedMemberMids()) {
        {
          ...
          for (java.lang.String _iter756 : struct.requestedMemberMids)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.requestedMemberMids = new java.util.ArrayList<java.lang.String>(_list757.size);
          java.lang.String _elem758;
          for (int _i759 = 0; _i759 < _list757.size; ++_i759)
          {
            _elem758 = iprot.readString();
            struct.requestedMemberMids.add(_elem758);
          }
        }
        struct.setRequestedMemberMidsIsSet(true);
      }
