...
public class UpdateSquareMembersResponse implements org.apache.thrift.TBase<UpdateSquareMembersResponse, UpdateSquareMembersResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMembersResponse> {
  ...
  public UpdateSquareMembersResponse setUpdatedAttrs(@org.apache.thrift.annotation.Nullable java.util.Set<SquareMemberAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareMembersResponse setEditor(@org.apache.thrift.annotation.Nullable SquareMember editor) {
    this.editor = editor;
    return this;
  }
  ...
  public UpdateSquareMembersResponse setMembers(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SquareMember> members) {
    this.members = members;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set882 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
                @org.apache.thrift.annotation.Nullable SquareMemberAttribute _elem883;
                for (int _i884 = 0; _i884 < _set882.size; ++_i884)
                {
                  _elem883 = SquareMemberAttribute.findByValue(iprot.readI32());
                  if (_elem883 != null)
                  {
                    struct.updatedAttrs.add(_elem883);
                  }
                }
                iprot.readSetEnd();
              }
          ...
          case 3: // MEMBERS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map885 = iprot.readMapBegin();
                struct.members = new java.util.HashMap<java.lang.String,SquareMember>(2*_map885.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key886;
                @org.apache.thrift.annotation.Nullable SquareMember _val887;
                for (int _i888 = 0; _i888 < _map885.size; ++_i888)
                {
                  _key886 = iprot.readString();
                  _val887 = new SquareMember();
                  _val887.read(iprot);
                  struct.members.put(_key886, _val887);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMembersResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberAttribute _iter889 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter889.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.members != null) {
        oprot.writeFieldBegin(MEMBERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMember> _iter890 : struct.members.entrySet())
          {
  ...
  private static class UpdateSquareMembersResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMembersResponse> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberAttribute _iter891 : struct.updatedAttrs)
          {
      ...
      if (struct.isSetMembers()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMember> _iter892 : struct.members.entrySet())
          {
            oprot.writeString(_iter892.getKey());
            _iter892.getValue().write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMembersResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set893 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
          @org.apache.thrift.annotation.Nullable SquareMemberAttribute _elem894;
          for (int _i895 = 0; _i895 < _set893.size; ++_i895)
          {
            _elem894 = SquareMemberAttribute.findByValue(iprot.readI32());
            if (_elem894 != null)
            {
              struct.updatedAttrs.add(_elem894);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.members = new java.util.HashMap<java.lang.String,SquareMember>(2*_map896.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key897;
          @org.apache.thrift.annotation.Nullable SquareMember _val898;
          for (int _i899 = 0; _i899 < _map896.size; ++_i899)
          {
            _key897 = iprot.readString();
            _val898 = new SquareMember();
            _val898.read(iprot);
            struct.members.put(_key897, _val898);
          }
        }
        struct.setMembersIsSet(true);
      }
