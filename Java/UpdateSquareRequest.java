...
public class UpdateSquareRequest implements org.apache.thrift.TBase<UpdateSquareRequest, UpdateSquareRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareRequest> {
  ...
  public java.util.Set<SquareAttribute> updatedAttrs; // required
  ...
  public UpdateSquareRequest setUpdatedAttrs(java.util.Set<SquareAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareRequest setSquare(Square square) {
    this.square = square;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 2: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set940 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareAttribute.class);
                SquareAttribute _elem941;
                for (int _i942 = 0; _i942 < _set940.size; ++_i942)
                {
                  _elem941 = SquareAttribute.findByValue(iprot.readI32());
                  if (_elem941 != null)
                  {
                    struct.updatedAttrs.add(_elem941);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareAttribute _iter943 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter943.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UpdateSquareRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareRequest> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareAttribute _iter944 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter944.getValue());
          }
        }
      }
      if (struct.isSetSquare()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set945 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareAttribute.class);
          SquareAttribute _elem946;
          for (int _i947 = 0; _i947 < _set945.size; ++_i947)
          {
            _elem946 = SquareAttribute.findByValue(iprot.readI32());
            if (_elem946 != null)
            {
              struct.updatedAttrs.add(_elem946);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
