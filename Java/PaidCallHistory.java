...
public class PaidCallHistory implements org.apache.thrift.TBase<PaidCallHistory, PaidCallHistory._Fields>, java.io.Serializable, Cloneable, Comparable<PaidCallHistory> {
  ...
  public int compareTo(PaidCallHistory other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetToName(), other.isSetToName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetToName()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSetupTime(), other.isSetSetupTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSetupTime()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTerminate(), other.isSetTerminate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTerminate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCharge(), other.isSetCharge());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCharge()) {
