...
public class PhoneVerificationResult implements org.apache.thrift.TBase<PhoneVerificationResult, PhoneVerificationResult._Fields>, java.io.Serializable, Cloneable, Comparable<PhoneVerificationResult> {
  ...
  public int compareTo(PhoneVerificationResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetVerificationResult(), other.isSetVerificationResult());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAccountMigrationCheckType(), other.isSetAccountMigrationCheckType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAccountMigrationCheckType()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecommendAddFriends(), other.isSetRecommendAddFriends());
    if (lastComparison != 0) {
      return lastComparison;
    }
