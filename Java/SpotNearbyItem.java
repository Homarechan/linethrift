...
public class SpotNearbyItem implements org.apache.thrift.TBase<SpotNearbyItem, SpotNearbyItem._Fields>, java.io.Serializable, Cloneable, Comparable<SpotNearbyItem> {
  ...
  public @org.apache.thrift.annotation.Nullable SpotItem spotItem; // required
  ...
  public SpotNearbyItem setSpotItem(@org.apache.thrift.annotation.Nullable SpotItem spotItem) {
    this.spotItem = spotItem;
    return this;
  }
  ...
  public SpotNearbyItem setLocation(@org.apache.thrift.annotation.Nullable Location location) {
    this.location = location;
    return this;
  }
  ...
  public int compareTo(SpotNearbyItem other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSpotItem(), other.isSetSpotItem());
    if (lastComparison != 0) {
