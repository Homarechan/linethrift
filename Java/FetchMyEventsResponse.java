...
public class FetchMyEventsResponse implements org.apache.thrift.TBase<FetchMyEventsResponse, FetchMyEventsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FetchMyEventsResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FetchMyEventsResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FetchMyEventsResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FetchMyEventsResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FetchMyEventsResponse.class, metaDataMap);
  }
   ...
   */
  public FetchMyEventsResponse(FetchMyEventsResponse other) {
  ...
  public FetchMyEventsResponse deepCopy() {
  ...
  public FetchMyEventsResponse setSubscription(@org.apache.thrift.annotation.Nullable SubscriptionState subscription) {
    this.subscription = subscription;
    return this;
  }
  ...
  public FetchMyEventsResponse setEvents(@org.apache.thrift.annotation.Nullable java.util.List<SquareEvent> events) {
    this.events = events;
    return this;
  }
  ...
  public FetchMyEventsResponse setSyncToken(@org.apache.thrift.annotation.Nullable java.lang.String syncToken) {
    this.syncToken = syncToken;
    return this;
  }
  ...
  public FetchMyEventsResponse setContinuationToken(@org.apache.thrift.annotation.Nullable java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof FetchMyEventsResponse)
      return this.equals((FetchMyEventsResponse)that);
    return false;
  }

  public boolean equals(FetchMyEventsResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(FetchMyEventsResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSubscription()).compareTo(other.isSetSubscription());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("FetchMyEventsResponse(");
    boolean first = true;
  ...
  private static class FetchMyEventsResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FetchMyEventsResponseStandardScheme getScheme() {
      return new FetchMyEventsResponseStandardScheme();
    }
  }

  private static class FetchMyEventsResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<FetchMyEventsResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FetchMyEventsResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<SquareEvent>(_list690.size);
                @org.apache.thrift.annotation.Nullable SquareEvent _elem691;
                for (int _i692 = 0; _i692 < _list690.size; ++_i692)
                {
                  _elem691 = new SquareEvent();
                  _elem691.read(iprot);
                  struct.events.add(_elem691);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FetchMyEventsResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.events != null) {
        oprot.writeFieldBegin(EVENTS_FIELD_DESC);
        {
          ...
          for (SquareEvent _iter693 : struct.events)
          {
  ...
  private static class FetchMyEventsResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FetchMyEventsResponseTupleScheme getScheme() {
      return new FetchMyEventsResponseTupleScheme();
    }
  }

  private static class FetchMyEventsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<FetchMyEventsResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FetchMyEventsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (SquareEvent _iter694 : struct.events)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FetchMyEventsResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.events = new java.util.ArrayList<SquareEvent>(_list695.size);
          @org.apache.thrift.annotation.Nullable SquareEvent _elem696;
          for (int _i697 = 0; _i697 < _list695.size; ++_i697)
          {
            _elem696 = new SquareEvent();
            _elem696.read(iprot);
            struct.events.add(_elem696);
          }
        }
        struct.setEventsIsSet(true);
      }
