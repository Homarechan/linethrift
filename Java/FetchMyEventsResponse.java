...
public class FetchMyEventsResponse implements org.apache.thrift.TBase<FetchMyEventsResponse, FetchMyEventsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FetchMyEventsResponse> {
  ...
  public SubscriptionState subscription; // required
  public java.util.List<SquareEvent> events; // required
  ...
  public FetchMyEventsResponse setSubscription(SubscriptionState subscription) {
    this.subscription = subscription;
    return this;
  }
  ...
  public FetchMyEventsResponse setEvents(java.util.List<SquareEvent> events) {
    this.events = events;
    return this;
  }
  ...
  public FetchMyEventsResponse setSyncToken(java.lang.String syncToken) {
    this.syncToken = syncToken;
    return this;
  }
  ...
  public FetchMyEventsResponse setContinuationToken(java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new java.util.ArrayList<SquareEvent>(_list866.size);
                SquareEvent _elem867;
                for (int _i868 = 0; _i868 < _list866.size; ++_i868)
                {
                  _elem867 = new SquareEvent();
                  _elem867.read(iprot);
                  struct.events.add(_elem867);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FetchMyEventsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.events != null) {
        oprot.writeFieldBegin(EVENTS_FIELD_DESC);
        {
          ...
          for (SquareEvent _iter869 : struct.events)
          {
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (SquareEvent _iter870 : struct.events)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.events = new java.util.ArrayList<SquareEvent>(_list871.size);
          SquareEvent _elem872;
          for (int _i873 = 0; _i873 < _list871.size; ++_i873)
          {
            _elem872 = new SquareEvent();
            _elem872.read(iprot);
            struct.events.add(_elem872);
          }
        }
        struct.setEventsIsSet(true);
      }
