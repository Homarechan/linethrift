...
public class CommitMessageResult implements org.apache.thrift.TBase<CommitMessageResult, CommitMessageResult._Fields>, java.io.Serializable, Cloneable, Comparable<CommitMessageResult> {
   ...
   */
  public CommitMessageResultCode code; // required
  ...
  public CommitMessageResult setMessage(Message message) {
    this.message = message;
    return this;
  }
   ...
   * @see CommitMessageResultCode
   */
  public CommitMessageResult setCode(CommitMessageResultCode code) {
    this.code = code;
    return this;
  }
  ...
  public CommitMessageResult setReason(java.lang.String reason) {
    this.reason = reason;
    return this;
  }
