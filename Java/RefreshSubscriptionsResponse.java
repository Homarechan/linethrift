...
public class RefreshSubscriptionsResponse implements org.apache.thrift.TBase<RefreshSubscriptionsResponse, RefreshSubscriptionsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<RefreshSubscriptionsResponse> {
  ...
  public java.util.Map<java.lang.Long,SubscriptionState> subscriptionStates; // required
  ...
  public RefreshSubscriptionsResponse setSubscriptionStates(java.util.Map<java.lang.Long,SubscriptionState> subscriptionStates) {
    this.subscriptionStates = subscriptionStates;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subscriptionStates = new java.util.HashMap<java.lang.Long,SubscriptionState>(2*_map1108.size);
                long _key1109;
                SubscriptionState _val1110;
                for (int _i1111 = 0; _i1111 < _map1108.size; ++_i1111)
                {
                  _key1109 = iprot.readI64();
                  _val1110 = new SubscriptionState();
                  _val1110.read(iprot);
                  struct.subscriptionStates.put(_key1109, _val1110);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RefreshSubscriptionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.subscriptionStates != null) {
        oprot.writeFieldBegin(SUBSCRIPTION_STATES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, SubscriptionState> _iter1112 : struct.subscriptionStates.entrySet())
          {
            oprot.writeI64(_iter1112.getKey());
            _iter1112.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class RefreshSubscriptionsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<RefreshSubscriptionsResponse> {
      ...
      if (struct.isSetSubscriptionStates()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, SubscriptionState> _iter1113 : struct.subscriptionStates.entrySet())
          {
            oprot.writeI64(_iter1113.getKey());
            _iter1113.getValue().write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RefreshSubscriptionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map1114 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.subscriptionStates = new java.util.HashMap<java.lang.Long,SubscriptionState>(2*_map1114.size);
          long _key1115;
          SubscriptionState _val1116;
          for (int _i1117 = 0; _i1117 < _map1114.size; ++_i1117)
          {
            _key1115 = iprot.readI64();
            _val1116 = new SubscriptionState();
            _val1116.read(iprot);
            struct.subscriptionStates.put(_key1115, _val1116);
          }
        }
        struct.setSubscriptionStatesIsSet(true);
      }
