...
public class SquareEventNotifiedKickoutFromSquare implements org.apache.thrift.TBase<SquareEventNotifiedKickoutFromSquare, SquareEventNotifiedKickoutFromSquare._Fields>, java.io.Serializable, Cloneable, Comparable<SquareEventNotifiedKickoutFromSquare> {
  ...
  public java.util.List<SquareMember> kickees; // required
  ...
  public SquareEventNotifiedKickoutFromSquare setSquareChatMid(java.lang.String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
  ...
  public SquareEventNotifiedKickoutFromSquare setKickees(java.util.List<SquareMember> kickees) {
    this.kickees = kickees;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.kickees = new java.util.ArrayList<SquareMember>(_list858.size);
                SquareMember _elem859;
                for (int _i860 = 0; _i860 < _list858.size; ++_i860)
                {
                  _elem859 = new SquareMember();
                  _elem859.read(iprot);
                  struct.kickees.add(_elem859);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SquareEventNotifiedKickoutFromSquare struct) throws org.apache.thrift.TException {
      ...
      if (struct.kickees != null) {
        oprot.writeFieldBegin(KICKEES_FIELD_DESC);
        {
          ...
          for (SquareMember _iter861 : struct.kickees)
          {
      ...
      if (struct.isSetKickees()) {
        {
          ...
          for (SquareMember _iter862 : struct.kickees)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.kickees = new java.util.ArrayList<SquareMember>(_list863.size);
          SquareMember _elem864;
          for (int _i865 = 0; _i865 < _list863.size; ++_i865)
          {
            _elem864 = new SquareMember();
            _elem864.read(iprot);
            struct.kickees.add(_elem864);
          }
        }
        struct.setKickeesIsSet(true);
      }
