...
public class RejectSquareMembersRequest implements org.apache.thrift.TBase<RejectSquareMembersRequest, RejectSquareMembersRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RejectSquareMembersRequest> {
  ...
  public RejectSquareMembersRequest setSquareMid(java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public RejectSquareMembersRequest setRequestedMemberMids(java.util.List<java.lang.String> requestedMemberMids) {
    this.requestedMemberMids = requestedMemberMids;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requestedMemberMids = new java.util.ArrayList<java.lang.String>(_list1076.size);
                java.lang.String _elem1077;
                for (int _i1078 = 0; _i1078 < _list1076.size; ++_i1078)
                {
                  _elem1077 = iprot.readString();
                  struct.requestedMemberMids.add(_elem1077);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RejectSquareMembersRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.requestedMemberMids != null) {
        oprot.writeFieldBegin(REQUESTED_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter1079 : struct.requestedMemberMids)
          {
  ...
  private static class RejectSquareMembersRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<RejectSquareMembersRequest> {
      ...
      if (struct.isSetRequestedMemberMids()) {
        {
          ...
          for (java.lang.String _iter1080 : struct.requestedMemberMids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RejectSquareMembersRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1081 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.requestedMemberMids = new java.util.ArrayList<java.lang.String>(_list1081.size);
          java.lang.String _elem1082;
          for (int _i1083 = 0; _i1083 < _list1081.size; ++_i1083)
          {
            _elem1082 = iprot.readString();
            struct.requestedMemberMids.add(_elem1082);
          }
        }
        struct.setRequestedMemberMidsIsSet(true);
      }
