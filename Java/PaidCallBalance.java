...
public class PaidCallBalance implements org.apache.thrift.TBase<PaidCallBalance, PaidCallBalance._Fields>, java.io.Serializable, Cloneable, Comparable<PaidCallBalance> {
   ...
   * @see PaidCallProductType
   */
  public PaidCallBalance setProductType(@org.apache.thrift.annotation.Nullable PaidCallProductType productType) {
    this.productType = productType;
    return this;
  }
  ...
  public PaidCallBalance setProductName(@org.apache.thrift.annotation.Nullable java.lang.String productName) {
    this.productName = productName;
    return this;
  }
  ...
  public PaidCallBalance setUnit(@org.apache.thrift.annotation.Nullable java.lang.String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public int compareTo(PaidCallBalance other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLimitedPaidBalance(), other.isSetLimitedPaidBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetLimitedFreeBalance(), other.isSetLimitedFreeBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetUnlimitedPaidBalance(), other.isSetUnlimitedPaidBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetUnlimitedFreeBalance(), other.isSetUnlimitedFreeBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetAutopayEnabled(), other.isSetAutopayEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
