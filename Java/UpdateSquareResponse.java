...
public class UpdateSquareResponse implements org.apache.thrift.TBase<UpdateSquareResponse, UpdateSquareResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareResponse> {
  ...
  public UpdateSquareResponse setUpdatedAttrs(java.util.Set<SquareAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareResponse setSquare(Square square) {
    this.square = square;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set948 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareAttribute.class);
                SquareAttribute _elem949;
                for (int _i950 = 0; _i950 < _set948.size; ++_i950)
                {
                  _elem949 = SquareAttribute.findByValue(iprot.readI32());
                  if (_elem949 != null)
                  {
                    struct.updatedAttrs.add(_elem949);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareAttribute _iter951 : struct.updatedAttrs)
          {
  ...
  private static class UpdateSquareResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareResponse> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareAttribute _iter952 : struct.updatedAttrs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set953 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareAttribute.class);
          SquareAttribute _elem954;
          for (int _i955 = 0; _i955 < _set953.size; ++_i955)
          {
            _elem954 = SquareAttribute.findByValue(iprot.readI32());
            if (_elem954 != null)
            {
              struct.updatedAttrs.add(_elem954);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
