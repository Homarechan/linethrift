...
public class SnsFriends implements org.apache.thrift.TBase<SnsFriends, SnsFriends._Fields>, java.io.Serializable, Cloneable, Comparable<SnsFriends> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SnsFriend> snsFriends; // required
  ...
  public SnsFriends setSnsFriends(@org.apache.thrift.annotation.Nullable java.util.List<SnsFriend> snsFriends) {
    this.snsFriends = snsFriends;
    return this;
  }
  ...
  public int compareTo(SnsFriends other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSnsFriends(), other.isSetSnsFriends());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.snsFriends = new java.util.ArrayList<SnsFriend>(_list502.size);
                @org.apache.thrift.annotation.Nullable SnsFriend _elem503;
                for (int _i504 = 0; _i504 < _list502.size; ++_i504)
                {
                  _elem503 = new SnsFriend();
                  _elem503.read(iprot);
                  struct.snsFriends.add(_elem503);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SnsFriends struct) throws org.apache.thrift.TException {
      ...
      if (struct.snsFriends != null) {
        oprot.writeFieldBegin(SNS_FRIENDS_FIELD_DESC);
        {
          ...
          for (SnsFriend _iter505 : struct.snsFriends)
          {
      ...
      if (struct.isSetSnsFriends()) {
        {
          ...
          for (SnsFriend _iter506 : struct.snsFriends)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.snsFriends = new java.util.ArrayList<SnsFriend>(_list507.size);
          @org.apache.thrift.annotation.Nullable SnsFriend _elem508;
          for (int _i509 = 0; _i509 < _list507.size; ++_i509)
          {
            _elem508 = new SnsFriend();
            _elem508.read(iprot);
            struct.snsFriends.add(_elem508);
          }
        }
        struct.setSnsFriendsIsSet(true);
      }
