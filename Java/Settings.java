...
public class Settings implements org.apache.thrift.TBase<Settings, Settings._Fields>, java.io.Serializable, Cloneable, Comparable<Settings> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                SnsIdType _key659;
                java.lang.String _val660;
                for (int _i661 = 0; _i661 < _map658.size; ++_i661)
                {
                  _key659 = SnsIdType.findByValue(iprot.readI32());
                  _val660 = iprot.readString();
                  if (_key659 != null)
                  {
                    struct.snsAccounts.put(_key659, _val660);
                  }
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                CustomMode _key663;
                java.lang.String _val664;
                for (int _i665 = 0; _i665 < _map662.size; ++_i665)
                {
                  _key663 = CustomMode.findByValue(iprot.readI32());
                  _val664 = iprot.readString();
                  if (_key663 != null)
                  {
                    struct.customModes.put(_key663, _val664);
                  }
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Settings struct) throws org.apache.thrift.TException {
      ...
      if (struct.snsAccounts != null) {
        oprot.writeFieldBegin(SNS_ACCOUNTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<SnsIdType, java.lang.String> _iter666 : struct.snsAccounts.entrySet())
          {
            oprot.writeI32(_iter666.getKey().getValue());
      ...
      if (struct.customModes != null) {
        oprot.writeFieldBegin(CUSTOM_MODES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<CustomMode, java.lang.String> _iter667 : struct.customModes.entrySet())
          {
            oprot.writeI32(_iter667.getKey().getValue());
  ...
  private static class SettingsTupleScheme extends org.apache.thrift.scheme.TupleScheme<Settings> {
      ...
      if (struct.isSetSnsAccounts()) {
        {
          ...
          for (java.util.Map.Entry<SnsIdType, java.lang.String> _iter668 : struct.snsAccounts.entrySet())
          {
            oprot.writeI32(_iter668.getKey().getValue());
      ...
      if (struct.isSetCustomModes()) {
        {
          ...
          for (java.util.Map.Entry<CustomMode, java.lang.String> _iter669 : struct.customModes.entrySet())
          {
            oprot.writeI32(_iter669.getKey().getValue());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Settings struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(19)) {
        {
          org.apache.thrift.protocol.TMap _map670 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.snsAccounts = new java.util.EnumMap<SnsIdType,java.lang.String>(SnsIdType.class);
          SnsIdType _key671;
          java.lang.String _val672;
          for (int _i673 = 0; _i673 < _map670.size; ++_i673)
          {
            _key671 = SnsIdType.findByValue(iprot.readI32());
            _val672 = iprot.readString();
            if (_key671 != null)
            {
              struct.snsAccounts.put(_key671, _val672);
            }
          }
        }
        struct.setSnsAccountsIsSet(true);
      ...
      if (incoming.get(23)) {
        {
          org.apache.thrift.protocol.TMap _map674 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.customModes = new java.util.EnumMap<CustomMode,java.lang.String>(CustomMode.class);
          CustomMode _key675;
          java.lang.String _val676;
          for (int _i677 = 0; _i677 < _map674.size; ++_i677)
          {
            _key675 = CustomMode.findByValue(iprot.readI32());
            _val676 = iprot.readString();
            if (_key675 != null)
            {
              struct.customModes.put(_key675, _val676);
            }
          }
        }
        struct.setCustomModesIsSet(true);
