            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list326.size);
                ChannelInfo _elem327;
                for (int _i328 = 0; _i328 < _list326.size; ++_i328)
                {
                  _elem327 = new ChannelInfo();
                  _elem327.read(iprot);
                  struct.channelInfos.add(_elem327);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChannelInfos struct) throws org.apache.thrift.TException {
      ...
      if (struct.channelInfos != null) {
        oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for (ChannelInfo _iter329 : struct.channelInfos)
          {
      ...
      if (struct.isSetChannelInfos()) {
        {
          ...
          for (ChannelInfo _iter330 : struct.channelInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list331.size);
          ChannelInfo _elem332;
          for (int _i333 = 0; _i333 < _list331.size; ++_i333)
          {
            _elem332 = new ChannelInfo();
            _elem332.read(iprot);
            struct.channelInfos.add(_elem332);
          }
        }
        struct.setChannelInfosIsSet(true);
      }
