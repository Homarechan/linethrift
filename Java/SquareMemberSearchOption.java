...
public class SquareMemberSearchOption implements org.apache.thrift.TBase<SquareMemberSearchOption, SquareMemberSearchOption._Fields>, java.io.Serializable, Cloneable, Comparable<SquareMemberSearchOption> {
  ...
  public java.util.Set<SquareMemberRole> memberRoles; // required
  public java.lang.String displayName; // required
  /**
   * 
   * @see BooleanState
   */
  public BooleanState ableToReceiveMessage; // required
  /**
   * 
   * @see BooleanState
   */
  public BooleanState ableToReceiveFriendRequest; // required
  public java.lang.String chatMidToExcludeMembers; // required
   ...
   * @see SquareMembershipState
   */
  public SquareMemberSearchOption setMembershipState(SquareMembershipState membershipState) {
    this.membershipState = membershipState;
    return this;
  }
  ...
  public SquareMemberSearchOption setMemberRoles(java.util.Set<SquareMemberRole> memberRoles) {
    this.memberRoles = memberRoles;
    return this;
  }
  ...
  public SquareMemberSearchOption setDisplayName(java.lang.String displayName) {
    this.displayName = displayName;
    return this;
  }
   ...
   * @see BooleanState
   */
  public SquareMemberSearchOption setAbleToReceiveMessage(BooleanState ableToReceiveMessage) {
    this.ableToReceiveMessage = ableToReceiveMessage;
    return this;
  }
   ...
   * @see BooleanState
   */
  public SquareMemberSearchOption setAbleToReceiveFriendRequest(BooleanState ableToReceiveFriendRequest) {
    this.ableToReceiveFriendRequest = ableToReceiveFriendRequest;
    return this;
  }
  ...
  public SquareMemberSearchOption setChatMidToExcludeMembers(java.lang.String chatMidToExcludeMembers) {
    this.chatMidToExcludeMembers = chatMidToExcludeMembers;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                SquareMemberRole _elem835;
                for (int _i836 = 0; _i836 < _set834.size; ++_i836)
                {
                  _elem835 = SquareMemberRole.findByValue(iprot.readI32());
                  if (_elem835 != null)
                  {
                    struct.memberRoles.add(_elem835);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SquareMemberSearchOption struct) throws org.apache.thrift.TException {
      ...
      if (struct.memberRoles != null) {
        oprot.writeFieldBegin(MEMBER_ROLES_FIELD_DESC);
        {
          ...
          for (SquareMemberRole _iter837 : struct.memberRoles)
          {
            oprot.writeI32(_iter837.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class SquareMemberSearchOptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<SquareMemberSearchOption> {
      ...
      if (struct.isSetMemberRoles()) {
        {
          ...
          for (SquareMemberRole _iter838 : struct.memberRoles)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SquareMemberSearchOption struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TSet _set839 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.memberRoles = java.util.EnumSet.noneOf(SquareMemberRole.class);
          SquareMemberRole _elem840;
          for (int _i841 = 0; _i841 < _set839.size; ++_i841)
          {
            _elem840 = SquareMemberRole.findByValue(iprot.readI32());
            if (_elem840 != null)
            {
              struct.memberRoles.add(_elem840);
            }
          }
        }
        struct.setMemberRolesIsSet(true);
