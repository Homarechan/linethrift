...
public class SecurityCenterResult implements org.apache.thrift.TBase<SecurityCenterResult, SecurityCenterResult._Fields>, java.io.Serializable, Cloneable, Comparable<SecurityCenterResult> {
  ...
  public java.lang.String cookiePath; // required
  ...
  public SecurityCenterResult setUri(java.lang.String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public SecurityCenterResult setToken(java.lang.String token) {
    this.token = token;
    return this;
  }
  ...
  public SecurityCenterResult setCookiePath(java.lang.String cookiePath) {
    this.cookiePath = cookiePath;
    return this;
  }
  ...
  public int compareTo(SecurityCenterResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCookiePath()).compareTo(other.isSetCookiePath());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCookiePath()) {
