            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.squareMemberMids = new java.util.ArrayList<java.lang.String>(_list760.size);
                java.lang.String _elem761;
                for (int _i762 = 0; _i762 < _list760.size; ++_i762)
                {
                  _elem761 = iprot.readString();
                  struct.squareMemberMids.add(_elem761);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreateSquareChatRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.squareMemberMids != null) {
        oprot.writeFieldBegin(SQUARE_MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter763 : struct.squareMemberMids)
          {
      ...
      if (struct.isSetSquareMemberMids()) {
        {
          ...
          for (java.lang.String _iter764 : struct.squareMemberMids)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.squareMemberMids = new java.util.ArrayList<java.lang.String>(_list765.size);
          java.lang.String _elem766;
          for (int _i767 = 0; _i767 < _list765.size; ++_i767)
          {
            _elem766 = iprot.readString();
            struct.squareMemberMids.add(_elem766);
          }
        }
        struct.setSquareMemberMidsIsSet(true);
      }
