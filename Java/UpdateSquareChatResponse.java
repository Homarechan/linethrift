...
public class UpdateSquareChatResponse implements org.apache.thrift.TBase<UpdateSquareChatResponse, UpdateSquareChatResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareChatResponse> {
  ...
  public UpdateSquareChatResponse setUpdatedAttrs(java.util.Set<SquareChatAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareChatResponse setSquareChat(SquareChat squareChat) {
    this.squareChat = squareChat;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1126 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareChatAttribute.class);
                SquareChatAttribute _elem1127;
                for (int _i1128 = 0; _i1128 < _set1126.size; ++_i1128)
                {
                  _elem1127 = SquareChatAttribute.findByValue(iprot.readI32());
                  if (_elem1127 != null)
                  {
                    struct.updatedAttrs.add(_elem1127);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareChatResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareChatAttribute _iter1129 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter1129.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UpdateSquareChatResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareChatResponse> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareChatAttribute _iter1130 : struct.updatedAttrs)
          {
            oprot.writeI32(_iter1130.getValue());
          }
        }
      }
      if (struct.isSetSquareChat()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareChatResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set1131 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareChatAttribute.class);
          SquareChatAttribute _elem1132;
          for (int _i1133 = 0; _i1133 < _set1131.size; ++_i1133)
          {
            _elem1132 = SquareChatAttribute.findByValue(iprot.readI32());
            if (_elem1132 != null)
            {
              struct.updatedAttrs.add(_elem1132);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
