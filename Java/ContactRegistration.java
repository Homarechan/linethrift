...
public class ContactRegistration implements org.apache.thrift.TBase<ContactRegistration, ContactRegistration._Fields>, java.io.Serializable, Cloneable, Comparable<ContactRegistration> {
   ...
   * @see ContactType
   */
  public @org.apache.thrift.annotation.Nullable ContactType contactType; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String contactKey; // required
  ...
  public ContactRegistration setContact(@org.apache.thrift.annotation.Nullable Contact contact) {
    this.contact = contact;
    return this;
  }
  ...
  public ContactRegistration setLuid(@org.apache.thrift.annotation.Nullable java.lang.String luid) {
    this.luid = luid;
    return this;
  }
   ...
   * @see ContactType
   */
  public ContactRegistration setContactType(@org.apache.thrift.annotation.Nullable ContactType contactType) {
    this.contactType = contactType;
    return this;
  }
  ...
  public ContactRegistration setContactKey(@org.apache.thrift.annotation.Nullable java.lang.String contactKey) {
    this.contactKey = contactKey;
    return this;
  }
  ...
  public int compareTo(ContactRegistration other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetContactType(), other.isSetContactType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetContactType()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetContactKey(), other.isSetContactKey());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetContactKey()) {
