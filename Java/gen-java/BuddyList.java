...
public class BuddyList implements org.apache.thrift.TBase<BuddyList, BuddyList._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyList> {
  ...
  public int compareTo(BuddyList other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTotalBuddyCount(), other.isSetTotalBuddyCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetPopularContacts(), other.isSetPopularContacts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPopularContacts()) {
