...
public class E2EENegotiationResult implements org.apache.thrift.TBase<E2EENegotiationResult, E2EENegotiationResult._Fields>, java.io.Serializable, Cloneable, Comparable<E2EENegotiationResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Set<ContentType> allowedTypes; // required
  ...
  public E2EENegotiationResult setAllowedTypes(@org.apache.thrift.annotation.Nullable java.util.Set<ContentType> allowedTypes) {
    this.allowedTypes = allowedTypes;
    return this;
  }
  ...
  public E2EENegotiationResult setPublicKey(@org.apache.thrift.annotation.Nullable E2EEPublicKey publicKey) {
    this.publicKey = publicKey;
    return this;
  }
  ...
  public int compareTo(E2EENegotiationResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAllowedTypes(), other.isSetAllowedTypes());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                @org.apache.thrift.annotation.Nullable ContentType _elem9;
                for (int _i10 = 0; _i10 < _set8.size; ++_i10)
                {
                  _elem9 = ContentType.findByValue(iprot.readI32());
                  if (_elem9 != null)
                  {
                    struct.allowedTypes.add(_elem9);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, E2EENegotiationResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.allowedTypes != null) {
        oprot.writeFieldBegin(ALLOWED_TYPES_FIELD_DESC);
        {
          ...
          for (ContentType _iter11 : struct.allowedTypes)
          {
      ...
      if (struct.isSetAllowedTypes()) {
        {
          ...
          for (ContentType _iter12 : struct.allowedTypes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.allowedTypes = java.util.EnumSet.noneOf(ContentType.class);
          @org.apache.thrift.annotation.Nullable ContentType _elem14;
          for (int _i15 = 0; _i15 < _set13.size; ++_i15)
          {
            _elem14 = ContentType.findByValue(iprot.readI32());
            if (_elem14 != null)
            {
              struct.allowedTypes.add(_elem14);
            }
          }
        }
        struct.setAllowedTypesIsSet(true);
