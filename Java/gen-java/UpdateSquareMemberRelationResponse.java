...
public class UpdateSquareMemberRelationResponse implements org.apache.thrift.TBase<UpdateSquareMemberRelationResponse, UpdateSquareMemberRelationResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMemberRelationResponse> {
  ...
  public UpdateSquareMemberRelationResponse setSquareMid(@org.apache.thrift.annotation.Nullable java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public UpdateSquareMemberRelationResponse setTargetSquareMemberMid(@org.apache.thrift.annotation.Nullable java.lang.String targetSquareMemberMid) {
    this.targetSquareMemberMid = targetSquareMemberMid;
    return this;
  }
  ...
  public UpdateSquareMemberRelationResponse setUpdatedAttrs(@org.apache.thrift.annotation.Nullable java.util.Set<SquareMemberRelationAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareMemberRelationResponse setRelation(@org.apache.thrift.annotation.Nullable SquareMemberRelation relation) {
    this.relation = relation;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 3: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set990 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberRelationAttribute.class);
                @org.apache.thrift.annotation.Nullable SquareMemberRelationAttribute _elem991;
                for (int _i992 = 0; _i992 < _set990.size; ++_i992)
                {
                  _elem991 = SquareMemberRelationAttribute.findByValue(iprot.readI32());
                  if (_elem991 != null)
                  {
                    struct.updatedAttrs.add(_elem991);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMemberRelationResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberRelationAttribute _iter993 : struct.updatedAttrs)
          {
  ...
  private static class UpdateSquareMemberRelationResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMemberRelationResponse> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberRelationAttribute _iter994 : struct.updatedAttrs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMemberRelationResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TSet _set995 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberRelationAttribute.class);
          @org.apache.thrift.annotation.Nullable SquareMemberRelationAttribute _elem996;
          for (int _i997 = 0; _i997 < _set995.size; ++_i997)
          {
            _elem996 = SquareMemberRelationAttribute.findByValue(iprot.readI32());
            if (_elem996 != null)
            {
              struct.updatedAttrs.add(_elem996);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
