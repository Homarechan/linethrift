...
public class Coin implements org.apache.thrift.TBase<Coin, Coin._Fields>, java.io.Serializable, Cloneable, Comparable<Coin> {
  ...
  public int compareTo(Coin other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFreeCoinBalance(), other.isSetFreeCoinBalance());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPayedCoinBalance(), other.isSetPayedCoinBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetTotalCoinBalance(), other.isSetTotalCoinBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRewardCoinBalance(), other.isSetRewardCoinBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
