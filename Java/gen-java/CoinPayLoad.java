...
public class CoinPayLoad implements org.apache.thrift.TBase<CoinPayLoad, CoinPayLoad._Fields>, java.io.Serializable, Cloneable, Comparable<CoinPayLoad> {
  ...
  public int compareTo(CoinPayLoad other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPayCoin(), other.isSetPayCoin());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRewardCoin(), other.isSetRewardCoin());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRewardCoin()) {
