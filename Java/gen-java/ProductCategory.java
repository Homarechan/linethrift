...
public class ProductCategory implements org.apache.thrift.TBase<ProductCategory, ProductCategory._Fields>, java.io.Serializable, Cloneable, Comparable<ProductCategory> {
  ...
  public int compareTo(ProductCategory other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetProductCategoryId(), other.isSetProductCategoryId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetProductCount(), other.isSetProductCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
