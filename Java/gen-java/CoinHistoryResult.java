...
public class CoinHistoryResult implements org.apache.thrift.TBase<CoinHistoryResult, CoinHistoryResult._Fields>, java.io.Serializable, Cloneable, Comparable<CoinHistoryResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<CoinHistory> historys; // required
  public @org.apache.thrift.annotation.Nullable Coin balance; // required
  ...
  public CoinHistoryResult setHistorys(@org.apache.thrift.annotation.Nullable java.util.List<CoinHistory> historys) {
    this.historys = historys;
    return this;
  }
  ...
  public CoinHistoryResult setBalance(@org.apache.thrift.annotation.Nullable Coin balance) {
    this.balance = balance;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.historys = new java.util.ArrayList<CoinHistory>(_list210.size);
                @org.apache.thrift.annotation.Nullable CoinHistory _elem211;
                for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                {
                  _elem211 = new CoinHistory();
                  _elem211.read(iprot);
                  struct.historys.add(_elem211);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CoinHistoryResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.historys != null) {
        oprot.writeFieldBegin(HISTORYS_FIELD_DESC);
        {
          ...
          for (CoinHistory _iter213 : struct.historys)
          {
      ...
      if (struct.isSetHistorys()) {
        {
          ...
          for (CoinHistory _iter214 : struct.historys)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.historys = new java.util.ArrayList<CoinHistory>(_list215.size);
          @org.apache.thrift.annotation.Nullable CoinHistory _elem216;
          for (int _i217 = 0; _i217 < _list215.size; ++_i217)
          {
            _elem216 = new CoinHistory();
            _elem216.read(iprot);
            struct.historys.add(_elem216);
          }
        }
        struct.setHistorysIsSet(true);
      }
