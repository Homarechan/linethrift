...
public class SquareChatStatus implements org.apache.thrift.TBase<SquareChatStatus, SquareChatStatus._Fields>, java.io.Serializable, Cloneable, Comparable<SquareChatStatus> {
  ...
  public @org.apache.thrift.annotation.Nullable SquareMessage lastMessage; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String senderDisplayName; // required
  public @org.apache.thrift.annotation.Nullable SquareChatStatusWithoutMessage otherStatus; // required
  ...
  public SquareChatStatus setLastMessage(@org.apache.thrift.annotation.Nullable SquareMessage lastMessage) {
    this.lastMessage = lastMessage;
    return this;
  }
  ...
  public SquareChatStatus setSenderDisplayName(@org.apache.thrift.annotation.Nullable java.lang.String senderDisplayName) {
    this.senderDisplayName = senderDisplayName;
    return this;
  }
  ...
  public SquareChatStatus setOtherStatus(@org.apache.thrift.annotation.Nullable SquareChatStatusWithoutMessage otherStatus) {
    this.otherStatus = otherStatus;
    return this;
  }
  ...
  public int compareTo(SquareChatStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLastMessage(), other.isSetLastMessage());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSenderDisplayName(), other.isSetSenderDisplayName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSenderDisplayName()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOtherStatus(), other.isSetOtherStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOtherStatus()) {
