...
public class MessageOperations implements org.apache.thrift.TBase<MessageOperations, MessageOperations._Fields>, java.io.Serializable, Cloneable, Comparable<MessageOperations> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<MessageOperation> operations; // required
  ...
  public MessageOperations setOperations(@org.apache.thrift.annotation.Nullable java.util.List<MessageOperation> operations) {
    this.operations = operations;
    return this;
  }
  ...
  public int compareTo(MessageOperations other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEndFlag(), other.isSetEndFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEndFlag()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.operations = new java.util.ArrayList<MessageOperation>(_list332.size);
                @org.apache.thrift.annotation.Nullable MessageOperation _elem333;
                for (int _i334 = 0; _i334 < _list332.size; ++_i334)
                {
                  _elem333 = new MessageOperation();
                  _elem333.read(iprot);
                  struct.operations.add(_elem333);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageOperations struct) throws org.apache.thrift.TException {
      ...
      if (struct.operations != null) {
        oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
        {
          ...
          for (MessageOperation _iter335 : struct.operations)
          {
      ...
      if (struct.isSetOperations()) {
        {
          ...
          for (MessageOperation _iter336 : struct.operations)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.operations = new java.util.ArrayList<MessageOperation>(_list337.size);
          @org.apache.thrift.annotation.Nullable MessageOperation _elem338;
          for (int _i339 = 0; _i339 < _list337.size; ++_i339)
          {
            _elem338 = new MessageOperation();
            _elem338.read(iprot);
            struct.operations.add(_elem338);
          }
        }
        struct.setOperationsIsSet(true);
      }
