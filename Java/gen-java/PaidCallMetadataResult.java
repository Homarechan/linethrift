...
public class PaidCallMetadataResult implements org.apache.thrift.TBase<PaidCallMetadataResult, PaidCallMetadataResult._Fields>, java.io.Serializable, Cloneable, Comparable<PaidCallMetadataResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<PaidCallCurrencyExchangeRate> currencyExchangeRates; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> recommendedCountryCodes; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<PaidCallAdCountry> adCountries; // required
  ...
  public PaidCallMetadataResult setCurrencyExchangeRates(@org.apache.thrift.annotation.Nullable java.util.List<PaidCallCurrencyExchangeRate> currencyExchangeRates) {
    this.currencyExchangeRates = currencyExchangeRates;
    return this;
  }
  ...
  public PaidCallMetadataResult setRecommendedCountryCodes(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> recommendedCountryCodes) {
    this.recommendedCountryCodes = recommendedCountryCodes;
    return this;
  }
  ...
  public PaidCallMetadataResult setAdCountries(@org.apache.thrift.annotation.Nullable java.util.List<PaidCallAdCountry> adCountries) {
    this.adCountries = adCountries;
    return this;
  }
  ...
  public int compareTo(PaidCallMetadataResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCurrencyExchangeRates(), other.isSetCurrencyExchangeRates());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecommendedCountryCodes(), other.isSetRecommendedCountryCodes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecommendedCountryCodes()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAdCountries(), other.isSetAdCountries());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAdCountries()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable PaidCallCurrencyExchangeRate _elem41;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable PaidCallAdCountry _elem47;
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable PaidCallCurrencyExchangeRate _elem56;
      ...
      if (incoming.get(2)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable PaidCallAdCountry _elem62;
