...
public class LoginResult implements org.apache.thrift.TBase<LoginResult, LoginResult._Fields>, java.io.Serializable, Cloneable, Comparable<LoginResult> {
  ...
  public int compareTo(LoginResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLastPrimaryBindTime(), other.isSetLastPrimaryBindTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetSessionForSMSConfirm(), other.isSetSessionForSMSConfirm());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSessionForSMSConfirm()) {
