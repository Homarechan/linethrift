...
public class PaidCallResponse implements org.apache.thrift.TBase<PaidCallResponse, PaidCallResponse._Fields>, java.io.Serializable, Cloneable, Comparable<PaidCallResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable CallHost host; // required
  public @org.apache.thrift.annotation.Nullable PaidCallDialing dialing; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String token; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<SpotItem> spotItems; // required
  ...
  public PaidCallResponse setHost(@org.apache.thrift.annotation.Nullable CallHost host) {
    this.host = host;
    return this;
  }
  ...
  public PaidCallResponse setDialing(@org.apache.thrift.annotation.Nullable PaidCallDialing dialing) {
    this.dialing = dialing;
    return this;
  }
  ...
  public PaidCallResponse setToken(@org.apache.thrift.annotation.Nullable java.lang.String token) {
    this.token = token;
    return this;
  }
  ...
  public PaidCallResponse setSpotItems(@org.apache.thrift.annotation.Nullable java.util.List<SpotItem> spotItems) {
    this.spotItems = spotItems;
    return this;
  }
  ...
  public int compareTo(PaidCallResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDialing(), other.isSetDialing());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDialing()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSpotItems(), other.isSetSpotItems());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpotItems()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spotItems = new java.util.ArrayList<SpotItem>(_list64.size);
                @org.apache.thrift.annotation.Nullable SpotItem _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new SpotItem();
                  _elem65.read(iprot);
                  struct.spotItems.add(_elem65);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaidCallResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.spotItems != null) {
        oprot.writeFieldBegin(SPOT_ITEMS_FIELD_DESC);
        {
          ...
          for (SpotItem _iter67 : struct.spotItems)
          {
            _iter67.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSpotItems()) {
        {
          ...
          for (SpotItem _iter68 : struct.spotItems)
          {
            _iter68.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.spotItems = new java.util.ArrayList<SpotItem>(_list69.size);
          @org.apache.thrift.annotation.Nullable SpotItem _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new SpotItem();
            _elem70.read(iprot);
            struct.spotItems.add(_elem70);
          }
        }
        struct.setSpotItemsIsSet(true);
      }
