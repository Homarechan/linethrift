...
public class ShouldSyncException extends org.apache.thrift.TException implements org.apache.thrift.TBase<ShouldSyncException, ShouldSyncException._Fields>, java.io.Serializable, Cloneable, Comparable<ShouldSyncException> {
  ...
  public int compareTo(ShouldSyncException other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSyncOpRevision(), other.isSetSyncOpRevision());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSyncScope(), other.isSetSyncScope());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSyncScope()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSyncReason(), other.isSetSyncReason());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSyncReason()) {
