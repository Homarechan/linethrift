...
public class SnsIdUserStatus implements org.apache.thrift.TBase<SnsIdUserStatus, SnsIdUserStatus._Fields>, java.io.Serializable, Cloneable, Comparable<SnsIdUserStatus> {
  ...
  public int compareTo(SnsIdUserStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUserExisting(), other.isSetUserExisting());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSameDevice(), other.isSetSameDevice());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSameDevice()) {
