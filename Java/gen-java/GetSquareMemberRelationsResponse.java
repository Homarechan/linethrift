...
public class GetSquareMemberRelationsResponse implements org.apache.thrift.TBase<GetSquareMemberRelationsResponse, GetSquareMemberRelationsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetSquareMemberRelationsResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SquareMember> squareMembers; // required
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SquareMemberRelation> relations; // required
  ...
  public GetSquareMemberRelationsResponse setSquareMembers(@org.apache.thrift.annotation.Nullable java.util.List<SquareMember> squareMembers) {
    this.squareMembers = squareMembers;
    return this;
  }
  ...
  public GetSquareMemberRelationsResponse setRelations(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SquareMemberRelation> relations) {
    this.relations = relations;
    return this;
  }
  ...
  public GetSquareMemberRelationsResponse setContinuationToken(@org.apache.thrift.annotation.Nullable java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
  ...
  public int compareTo(GetSquareMemberRelationsResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSquareMembers(), other.isSetSquareMembers());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRelations(), other.isSetRelations());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRelations()) {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.squareMembers = new java.util.ArrayList<SquareMember>(_list738.size);
                @org.apache.thrift.annotation.Nullable SquareMember _elem739;
                for (int _i740 = 0; _i740 < _list738.size; ++_i740)
                {
                  _elem739 = new SquareMember();
                  _elem739.read(iprot);
                  struct.squareMembers.add(_elem739);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // RELATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map741 = iprot.readMapBegin();
                struct.relations = new java.util.HashMap<java.lang.String,SquareMemberRelation>(2*_map741.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key742;
                @org.apache.thrift.annotation.Nullable SquareMemberRelation _val743;
                for (int _i744 = 0; _i744 < _map741.size; ++_i744)
                {
                  _key742 = iprot.readString();
                  _val743 = new SquareMemberRelation();
                  _val743.read(iprot);
                  struct.relations.put(_key742, _val743);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetSquareMemberRelationsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.squareMembers != null) {
        oprot.writeFieldBegin(SQUARE_MEMBERS_FIELD_DESC);
        {
          ...
          for (SquareMember _iter745 : struct.squareMembers)
          {
      ...
      if (struct.relations != null) {
        oprot.writeFieldBegin(RELATIONS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMemberRelation> _iter746 : struct.relations.entrySet())
          {
  ...
  private static class GetSquareMemberRelationsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetSquareMemberRelationsResponse> {
      ...
      if (struct.isSetSquareMembers()) {
        {
          ...
          for (SquareMember _iter747 : struct.squareMembers)
          {
      ...
      if (struct.isSetRelations()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMemberRelation> _iter748 : struct.relations.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetSquareMemberRelationsResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.squareMembers = new java.util.ArrayList<SquareMember>(_list749.size);
          @org.apache.thrift.annotation.Nullable SquareMember _elem750;
          for (int _i751 = 0; _i751 < _list749.size; ++_i751)
          {
            _elem750 = new SquareMember();
            _elem750.read(iprot);
            struct.squareMembers.add(_elem750);
          }
        }
        struct.setSquareMembersIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map752 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.relations = new java.util.HashMap<java.lang.String,SquareMemberRelation>(2*_map752.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key753;
          @org.apache.thrift.annotation.Nullable SquareMemberRelation _val754;
          for (int _i755 = 0; _i755 < _map752.size; ++_i755)
          {
            _key753 = iprot.readString();
            _val754 = new SquareMemberRelation();
            _val754.read(iprot);
            struct.relations.put(_key753, _val754);
          }
        }
        struct.setRelationsIsSet(true);
      }
