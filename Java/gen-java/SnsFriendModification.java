...
public class SnsFriendModification implements org.apache.thrift.TBase<SnsFriendModification, SnsFriendModification._Fields>, java.io.Serializable, Cloneable, Comparable<SnsFriendModification> {
  ...
  public @org.apache.thrift.annotation.Nullable SnsFriend snsFriend; // required
   ...
   * @see ModificationType
   */
  public SnsFriendModification setType(@org.apache.thrift.annotation.Nullable ModificationType type) {
    this.type = type;
    return this;
  }
  ...
  public SnsFriendModification setSnsFriend(@org.apache.thrift.annotation.Nullable SnsFriend snsFriend) {
    this.snsFriend = snsFriend;
    return this;
  }
  ...
  public int compareTo(SnsFriendModification other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSnsFriend(), other.isSetSnsFriend());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSnsFriend()) {
