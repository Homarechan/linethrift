...
public class SquareMemberSearchOption implements org.apache.thrift.TBase<SquareMemberSearchOption, SquareMemberSearchOption._Fields>, java.io.Serializable, Cloneable, Comparable<SquareMemberSearchOption> {
  ...
  public int compareTo(SquareMemberSearchOption other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemberRoles(), other.isSetMemberRoles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemberRoles()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAbleToReceiveFriendRequest(), other.isSetAbleToReceiveFriendRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAbleToReceiveFriendRequest()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChatMidToExcludeMembers(), other.isSetChatMidToExcludeMembers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatMidToExcludeMembers()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIncludingMe(), other.isSetIncludingMe());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncludingMe()) {
