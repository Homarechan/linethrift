...
public class UpdateSquareFeatureSetResponse implements org.apache.thrift.TBase<UpdateSquareFeatureSetResponse, UpdateSquareFeatureSetResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareFeatureSetResponse> {
  ...
  public UpdateSquareFeatureSetResponse setUpdateAttributes(@org.apache.thrift.annotation.Nullable java.util.Set<SquareFeatureSetAttribute> updateAttributes) {
    this.updateAttributes = updateAttributes;
    return this;
  }
  ...
  public UpdateSquareFeatureSetResponse setSquareFeatureSet(@org.apache.thrift.annotation.Nullable SquareFeatureSet squareFeatureSet) {
    this.squareFeatureSet = squareFeatureSet;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // UPDATE_ATTRIBUTES
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set826 = iprot.readSetBegin();
                struct.updateAttributes = java.util.EnumSet.noneOf(SquareFeatureSetAttribute.class);
                @org.apache.thrift.annotation.Nullable SquareFeatureSetAttribute _elem827;
                for (int _i828 = 0; _i828 < _set826.size; ++_i828)
                {
                  _elem827 = SquareFeatureSetAttribute.findByValue(iprot.readI32());
                  if (_elem827 != null)
                  {
                    struct.updateAttributes.add(_elem827);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareFeatureSetResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateAttributes != null) {
        oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
        {
          ...
          for (SquareFeatureSetAttribute _iter829 : struct.updateAttributes)
          {
            oprot.writeI32(_iter829.getValue());
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UpdateSquareFeatureSetResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareFeatureSetResponse> {
      ...
      if (struct.isSetUpdateAttributes()) {
        {
          ...
          for (SquareFeatureSetAttribute _iter830 : struct.updateAttributes)
          {
            oprot.writeI32(_iter830.getValue());
          }
        }
      }
      if (struct.isSetSquareFeatureSet()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareFeatureSetResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set831 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updateAttributes = java.util.EnumSet.noneOf(SquareFeatureSetAttribute.class);
          @org.apache.thrift.annotation.Nullable SquareFeatureSetAttribute _elem832;
          for (int _i833 = 0; _i833 < _set831.size; ++_i833)
          {
            _elem832 = SquareFeatureSetAttribute.findByValue(iprot.readI32());
            if (_elem832 != null)
            {
              struct.updateAttributes.add(_elem832);
            }
          }
        }
        struct.setUpdateAttributesIsSet(true);
