...
public class DeviceInfo implements org.apache.thrift.TBase<DeviceInfo, DeviceInfo._Fields>, java.io.Serializable, Cloneable, Comparable<DeviceInfo> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String systemVersion; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String model; // required
  /**
   * 
   * @see CarrierCode
   */
  public @org.apache.thrift.annotation.Nullable CarrierCode carrierCode; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String carrierName; // required
  /**
   * 
   * @see ApplicationType
   */
  ...
  public DeviceInfo setDeviceName(@org.apache.thrift.annotation.Nullable java.lang.String deviceName) {
    this.deviceName = deviceName;
    return this;
  }
  ...
  public DeviceInfo setSystemName(@org.apache.thrift.annotation.Nullable java.lang.String systemName) {
    this.systemName = systemName;
    return this;
  }
  ...
  public DeviceInfo setSystemVersion(@org.apache.thrift.annotation.Nullable java.lang.String systemVersion) {
    this.systemVersion = systemVersion;
    return this;
  }
  ...
  public DeviceInfo setModel(@org.apache.thrift.annotation.Nullable java.lang.String model) {
    this.model = model;
    return this;
  }
   ...
   * @see CarrierCode
   */
  public DeviceInfo setCarrierCode(@org.apache.thrift.annotation.Nullable CarrierCode carrierCode) {
    this.carrierCode = carrierCode;
    return this;
  }
  ...
  public DeviceInfo setCarrierName(@org.apache.thrift.annotation.Nullable java.lang.String carrierName) {
    this.carrierName = carrierName;
    return this;
  }
   ...
   * @see ApplicationType
   */
  public DeviceInfo setApplicationType(@org.apache.thrift.annotation.Nullable ApplicationType applicationType) {
    this.applicationType = applicationType;
    return this;
  }
  ...
  public int compareTo(DeviceInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDeviceName(), other.isSetDeviceName());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSystemVersion(), other.isSetSystemVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSystemVersion()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCarrierCode(), other.isSetCarrierCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCarrierCode()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCarrierName(), other.isSetCarrierName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCarrierName()) {
