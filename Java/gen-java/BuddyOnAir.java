...
public class BuddyOnAir implements org.apache.thrift.TBase<BuddyOnAir, BuddyOnAir._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyOnAir> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String onAirId; // required
   ...
   * @see BuddyOnAirType
   */
  public @org.apache.thrift.annotation.Nullable BuddyOnAirType onAirType; // required
  public @org.apache.thrift.annotation.Nullable BuddyOnAirUrls onAirUrls; // required
  ...
  public BuddyOnAir setMid(@org.apache.thrift.annotation.Nullable java.lang.String mid) {
    this.mid = mid;
    return this;
  }
  ...
  public BuddyOnAir setOnAirId(@org.apache.thrift.annotation.Nullable java.lang.String onAirId) {
    this.onAirId = onAirId;
    return this;
  }
  ...
  public BuddyOnAir setText(@org.apache.thrift.annotation.Nullable java.lang.String text) {
    this.text = text;
    return this;
  }
   ...
   * @see BuddyOnAirType
   */
  public BuddyOnAir setOnAirType(@org.apache.thrift.annotation.Nullable BuddyOnAirType onAirType) {
    this.onAirType = onAirType;
    return this;
  }
  ...
  public BuddyOnAir setOnAirUrls(@org.apache.thrift.annotation.Nullable BuddyOnAirUrls onAirUrls) {
    this.onAirUrls = onAirUrls;
    return this;
  }
  ...
  public int compareTo(BuddyOnAir other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFreshnessLifetime(), other.isSetFreshnessLifetime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetOnAirId(), other.isSetOnAirId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOnAirId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTargetCount(), other.isSetTargetCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTargetCount()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOnAirType(), other.isSetOnAirType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOnAirType()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOnAirUrls(), other.isSetOnAirUrls());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOnAirUrls()) {
