...
public class MessageStoreResult implements org.apache.thrift.TBase<MessageStoreResult, MessageStoreResult._Fields>, java.io.Serializable, Cloneable, Comparable<MessageStoreResult> {
  ...
  public MessageStoreResult setRequestId(java.lang.String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public MessageStoreResult setMessageIds(java.util.List<java.lang.String> messageIds) {
    this.messageIds = messageIds;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageIds = new java.util.ArrayList<java.lang.String>(_list516.size);
                java.lang.String _elem517;
                for (int _i518 = 0; _i518 < _list516.size; ++_i518)
                {
                  _elem517 = iprot.readString();
                  struct.messageIds.add(_elem517);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageStoreResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.messageIds != null) {
        oprot.writeFieldBegin(MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter519 : struct.messageIds)
          {
      ...
      if (struct.isSetMessageIds()) {
        {
          ...
          for (java.lang.String _iter520 : struct.messageIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.messageIds = new java.util.ArrayList<java.lang.String>(_list521.size);
          java.lang.String _elem522;
          for (int _i523 = 0; _i523 < _list521.size; ++_i523)
          {
            _elem522 = iprot.readString();
            struct.messageIds.add(_elem522);
          }
        }
        struct.setMessageIdsIsSet(true);
      }
