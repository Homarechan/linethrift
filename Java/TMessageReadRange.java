            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                java.util.List<TMessageReadRangeEntry> _val536;
                for (int _i537 = 0; _i537 < _map534.size; ++_i537)
                {
                  _key535 = iprot.readString();
                  {
                    ...
                    TMessageReadRangeEntry _elem539;
      ...
      if (incoming.get(1)) {
        {
          ...
          java.lang.String _key546;
          java.util.List<TMessageReadRangeEntry> _val547;
          for (int _i548 = 0; _i548 < _map545.size; ++_i548)
          {
            _key546 = iprot.readString();
            {
              ...
              TMessageReadRangeEntry _elem550;
