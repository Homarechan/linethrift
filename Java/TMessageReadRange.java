...
public class TMessageReadRange implements org.apache.thrift.TBase<TMessageReadRange, TMessageReadRange._Fields>, java.io.Serializable, Cloneable, Comparable<TMessageReadRange> {
  ...
  public java.util.Map<java.lang.String,java.util.List<TMessageReadRangeEntry>> ranges; // required
  ...
  public TMessageReadRange setChatId(java.lang.String chatId) {
    this.chatId = chatId;
    return this;
  }
  ...
  public TMessageReadRange setRanges(java.util.Map<java.lang.String,java.util.List<TMessageReadRangeEntry>> ranges) {
    this.ranges = ranges;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ranges = new java.util.HashMap<java.lang.String,java.util.List<TMessageReadRangeEntry>>(2*_map710.size);
                java.lang.String _key711;
                java.util.List<TMessageReadRangeEntry> _val712;
                for (int _i713 = 0; _i713 < _map710.size; ++_i713)
                {
                  _key711 = iprot.readString();
                  {
                    ...
                    _val712 = new java.util.ArrayList<TMessageReadRangeEntry>(_list714.size);
                    TMessageReadRangeEntry _elem715;
                    for (int _i716 = 0; _i716 < _list714.size; ++_i716)
                    {
                      _elem715 = new TMessageReadRangeEntry();
                      _elem715.read(iprot);
                      _val712.add(_elem715);
                    }
                    iprot.readListEnd();
                  }
                  struct.ranges.put(_key711, _val712);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMessageReadRange struct) throws org.apache.thrift.TException {
      ...
      if (struct.ranges != null) {
        oprot.writeFieldBegin(RANGES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<TMessageReadRangeEntry>> _iter717 : struct.ranges.entrySet())
          {
            oprot.writeString(_iter717.getKey());
            {
              ...
              for (TMessageReadRangeEntry _iter718 : _iter717.getValue())
              {
  ...
  private static class TMessageReadRangeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMessageReadRange> {
      ...
      if (struct.isSetRanges()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<TMessageReadRangeEntry>> _iter719 : struct.ranges.entrySet())
          {
            oprot.writeString(_iter719.getKey());
            {
              oprot.writeI32(_iter719.getValue().size());
              for (TMessageReadRangeEntry _iter720 : _iter719.getValue())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMessageReadRange struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map721 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
          struct.ranges = new java.util.HashMap<java.lang.String,java.util.List<TMessageReadRangeEntry>>(2*_map721.size);
          java.lang.String _key722;
          java.util.List<TMessageReadRangeEntry> _val723;
          for (int _i724 = 0; _i724 < _map721.size; ++_i724)
          {
            _key722 = iprot.readString();
            {
              ...
              _val723 = new java.util.ArrayList<TMessageReadRangeEntry>(_list725.size);
              TMessageReadRangeEntry _elem726;
              for (int _i727 = 0; _i727 < _list725.size; ++_i727)
              {
                _elem726 = new TMessageReadRangeEntry();
                _elem726.read(iprot);
                _val723.add(_elem726);
              }
            }
            struct.ranges.put(_key722, _val723);
          }
        }
        struct.setRangesIsSet(true);
      }
