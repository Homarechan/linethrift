...
public class BuddyOnAirUrls implements org.apache.thrift.TBase<BuddyOnAirUrls, BuddyOnAirUrls._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyOnAirUrls> {
  ...
  public java.util.Map<java.lang.String,java.lang.String> hls; // required
  public java.util.Map<java.lang.String,java.lang.String> smoothStreaming; // required
  ...
  public BuddyOnAirUrls setHls(java.util.Map<java.lang.String,java.lang.String> hls) {
    this.hls = hls;
    return this;
  }
  ...
  public BuddyOnAirUrls setSmoothStreaming(java.util.Map<java.lang.String,java.lang.String> smoothStreaming) {
    this.smoothStreaming = smoothStreaming;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.hls = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map298.size);
                java.lang.String _key299;
                java.lang.String _val300;
                for (int _i301 = 0; _i301 < _map298.size; ++_i301)
                {
                  _key299 = iprot.readString();
                  _val300 = iprot.readString();
                  struct.hls.put(_key299, _val300);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.smoothStreaming = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map302.size);
                java.lang.String _key303;
                java.lang.String _val304;
                for (int _i305 = 0; _i305 < _map302.size; ++_i305)
                {
                  _key303 = iprot.readString();
                  _val304 = iprot.readString();
                  struct.smoothStreaming.put(_key303, _val304);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuddyOnAirUrls struct) throws org.apache.thrift.TException {
      ...
      if (struct.hls != null) {
        oprot.writeFieldBegin(HLS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter306 : struct.hls.entrySet())
          {
      ...
      if (struct.smoothStreaming != null) {
        oprot.writeFieldBegin(SMOOTH_STREAMING_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter307 : struct.smoothStreaming.entrySet())
          {
      ...
      if (struct.isSetHls()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter308 : struct.hls.entrySet())
          {
      ...
      if (struct.isSetSmoothStreaming()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter309 : struct.smoothStreaming.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hls = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map310.size);
          ...
          for (int _i313 = 0; _i313 < _map310.size; ++_i313)
          {
            ...
            struct.hls.put(_key311, _val312);
          }
        }
        struct.setHlsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.smoothStreaming = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map314.size);
          ...
          for (int _i317 = 0; _i317 < _map314.size; ++_i317)
          {
            ...
            struct.smoothStreaming.put(_key315, _val316);
          }
        }
        struct.setSmoothStreamingIsSet(true);
      }
