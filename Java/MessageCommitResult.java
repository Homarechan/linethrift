...
public class MessageCommitResult implements org.apache.thrift.TBase<MessageCommitResult, MessageCommitResult._Fields>, java.io.Serializable, Cloneable, Comparable<MessageCommitResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String messageStoreRequestId; // required
  ...
  public MessageCommitResult setRequestId(@org.apache.thrift.annotation.Nullable java.lang.String requestId) {
    this.requestId = requestId;
    return this;
  }
   ...
   * @see BuddyResultState
   */
  public MessageCommitResult setState(@org.apache.thrift.annotation.Nullable BuddyResultState state) {
    this.state = state;
    return this;
  }
  ...
  public MessageCommitResult setMessageStoreRequestId(@org.apache.thrift.annotation.Nullable java.lang.String messageStoreRequestId) {
    this.messageStoreRequestId = messageStoreRequestId;
    return this;
  }
  ...
  public MessageCommitResult setMessageIds(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> messageIds) {
    this.messageIds = messageIds;
    return this;
  }
  ...
  public MessageCommitResult setErrorDescription(@org.apache.thrift.annotation.Nullable java.lang.String errorDescription) {
    this.errorDescription = errorDescription;
    return this;
  }
  ...
  public int compareTo(MessageCommitResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMessageStoreRequestId(), other.isSetMessageStoreRequestId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMessageStoreRequestId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUnregisteredCount(), other.isSetUnregisteredCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetUnrelatedCount(), other.isSetUnrelatedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageIds = new java.util.ArrayList<java.lang.String>(_list0.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.messageIds.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageCommitResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.messageIds != null) {
        oprot.writeFieldBegin(MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter3 : struct.messageIds)
          {
      ...
      if (struct.isSetMessageIds()) {
        {
          ...
          for (java.lang.String _iter4 : struct.messageIds)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.messageIds = new java.util.ArrayList<java.lang.String>(_list5.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.messageIds.add(_elem6);
          }
        }
        struct.setMessageIdsIsSet(true);
      }
