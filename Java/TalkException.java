            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1210.size);
                java.lang.String _key1211;
                java.lang.String _val1212;
                for (int _i1213 = 0; _i1213 < _map1210.size; ++_i1213)
                {
                  _key1211 = iprot.readString();
                  _val1212 = iprot.readString();
                  struct.parameterMap.put(_key1211, _val1212);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TalkException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1214 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1215 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1216.size);
          java.lang.String _key1217;
          java.lang.String _val1218;
          for (int _i1219 = 0; _i1219 < _map1216.size; ++_i1219)
          {
            _key1217 = iprot.readString();
            _val1218 = iprot.readString();
            struct.parameterMap.put(_key1217, _val1218);
          }
        }
        struct.setParameterMapIsSet(true);
      }
