...
public class FriendChannelMatricesResponse implements org.apache.thrift.TBase<FriendChannelMatricesResponse, FriendChannelMatricesResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FriendChannelMatricesResponse> {
  ...
  public java.util.List<FriendChannelMatrix> matrices; // required
  ...
  public FriendChannelMatricesResponse setMatrices(java.util.List<FriendChannelMatrix> matrices) {
    this.matrices = matrices;
    return this;
  }
  ...
  public int compareTo(FriendChannelMatricesResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMatrices()).compareTo(other.isSetMatrices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMatrices()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.matrices = new java.util.ArrayList<FriendChannelMatrix>(_list410.size);
                FriendChannelMatrix _elem411;
                for (int _i412 = 0; _i412 < _list410.size; ++_i412)
                {
                  _elem411 = new FriendChannelMatrix();
                  _elem411.read(iprot);
                  struct.matrices.add(_elem411);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FriendChannelMatricesResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.matrices != null) {
        oprot.writeFieldBegin(MATRICES_FIELD_DESC);
        {
          ...
          for (FriendChannelMatrix _iter413 : struct.matrices)
          {
      ...
      if (struct.isSetMatrices()) {
        {
          ...
          for (FriendChannelMatrix _iter414 : struct.matrices)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.matrices = new java.util.ArrayList<FriendChannelMatrix>(_list415.size);
          FriendChannelMatrix _elem416;
          for (int _i417 = 0; _i417 < _list415.size; ++_i417)
          {
            _elem416 = new FriendChannelMatrix();
            _elem416.read(iprot);
            struct.matrices.add(_elem416);
          }
        }
        struct.setMatricesIsSet(true);
      }
