            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.memberMids = new java.util.ArrayList<java.lang.String>(_list1258.size);
                java.lang.String _elem1259;
                for (int _i1260 = 0; _i1260 < _list1258.size; ++_i1260)
                {
                  _elem1259 = iprot.readString();
                  struct.memberMids.add(_elem1259);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GroupCall struct) throws org.apache.thrift.TException {
      ...
      if (struct.memberMids != null) {
        oprot.writeFieldBegin(MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter1261 : struct.memberMids)
          {
      ...
      if (struct.isSetMemberMids()) {
        {
          ...
          for (java.lang.String _iter1262 : struct.memberMids)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.memberMids = new java.util.ArrayList<java.lang.String>(_list1263.size);
          java.lang.String _elem1264;
          for (int _i1265 = 0; _i1265 < _list1263.size; ++_i1265)
          {
            _elem1264 = iprot.readString();
            struct.memberMids.add(_elem1264);
          }
        }
        struct.setMemberMidsIsSet(true);
      }
