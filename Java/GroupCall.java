...
public class GroupCall implements org.apache.thrift.TBase<GroupCall, GroupCall._Fields>, java.io.Serializable, Cloneable, Comparable<GroupCall> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String chatMid; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String hostMids; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> memberMids; // required
  public long started; // required
  /**
   * 
   * @see GroupCallMediaType
   */
  public @org.apache.thrift.annotation.Nullable GroupCallMediaType mediaType; // required
  ...
  public GroupCall setChatMid(@org.apache.thrift.annotation.Nullable java.lang.String chatMid) {
    this.chatMid = chatMid;
    return this;
  }
  ...
  public GroupCall setHostMids(@org.apache.thrift.annotation.Nullable java.lang.String hostMids) {
    this.hostMids = hostMids;
    return this;
  }
  ...
  public GroupCall setMemberMids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> memberMids) {
    this.memberMids = memberMids;
    return this;
  }
   ...
   * @see GroupCallMediaType
   */
  public GroupCall setMediaType(@org.apache.thrift.annotation.Nullable GroupCallMediaType mediaType) {
    this.mediaType = mediaType;
    return this;
  }
  ...
  public int compareTo(GroupCall other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChatMid(), other.isSetChatMid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatMid()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHostMids(), other.isSetHostMids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHostMids()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemberMids(), other.isSetMemberMids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemberMids()) {
