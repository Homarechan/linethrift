...
public class ShouldSyncException extends org.apache.thrift.TException implements org.apache.thrift.TBase<ShouldSyncException, ShouldSyncException._Fields>, java.io.Serializable, Cloneable, Comparable<ShouldSyncException> {
  ...
  public SyncScope syncScope; // required
  /**
   * 
   * @see SyncTriggerReason
   */
  public SyncTriggerReason syncReason; // required
  ...
  public ShouldSyncException setSyncScope(SyncScope syncScope) {
    this.syncScope = syncScope;
    return this;
  }
   ...
   * @see SyncTriggerReason
   */
  public ShouldSyncException setSyncReason(SyncTriggerReason syncReason) {
    this.syncReason = syncReason;
    return this;
  }
  ...
  public ShouldSyncException setMessage(java.lang.String message) {
    this.message = message;
    return this;
  }
