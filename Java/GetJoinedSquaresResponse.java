...
public class GetJoinedSquaresResponse implements org.apache.thrift.TBase<GetJoinedSquaresResponse, GetJoinedSquaresResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetJoinedSquaresResponse> {
  ...
  public java.util.Map<java.lang.String,SquareAuthority> authorities; // required
  public java.util.Map<java.lang.String,SquareStatus> statuses; // required
  ...
  public GetJoinedSquaresResponse setSquares(java.util.List<Square> squares) {
    this.squares = squares;
    return this;
  }
  ...
  public GetJoinedSquaresResponse setMembers(java.util.Map<java.lang.String,SquareMember> members) {
    this.members = members;
    return this;
  }
  ...
  public GetJoinedSquaresResponse setAuthorities(java.util.Map<java.lang.String,SquareAuthority> authorities) {
    this.authorities = authorities;
    return this;
  }
  ...
  public GetJoinedSquaresResponse setStatuses(java.util.Map<java.lang.String,SquareStatus> statuses) {
    this.statuses = statuses;
    return this;
  }
  ...
  public GetJoinedSquaresResponse setContinuationToken(java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
  ...
  public GetJoinedSquaresResponse setNoteStatuses(java.util.Map<java.lang.String,NoteStatus> noteStatuses) {
    this.noteStatuses = noteStatuses;
    return this;
  }
  ...
  public int compareTo(GetJoinedSquaresResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAuthorities()).compareTo(other.isSetAuthorities());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAuthorities()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.squares = new java.util.ArrayList<Square>(_list768.size);
                Square _elem769;
                for (int _i770 = 0; _i770 < _list768.size; ++_i770)
                {
                  _elem769 = new Square();
                  _elem769.read(iprot);
                  struct.squares.add(_elem769);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.members = new java.util.HashMap<java.lang.String,SquareMember>(2*_map771.size);
                java.lang.String _key772;
                SquareMember _val773;
                for (int _i774 = 0; _i774 < _map771.size; ++_i774)
                {
                  _key772 = iprot.readString();
                  _val773 = new SquareMember();
                  _val773.read(iprot);
                  struct.members.put(_key772, _val773);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.authorities = new java.util.HashMap<java.lang.String,SquareAuthority>(2*_map775.size);
                java.lang.String _key776;
                SquareAuthority _val777;
                for (int _i778 = 0; _i778 < _map775.size; ++_i778)
                {
                  _key776 = iprot.readString();
                  _val777 = new SquareAuthority();
                  _val777.read(iprot);
                  struct.authorities.put(_key776, _val777);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.statuses = new java.util.HashMap<java.lang.String,SquareStatus>(2*_map779.size);
                java.lang.String _key780;
                SquareStatus _val781;
                for (int _i782 = 0; _i782 < _map779.size; ++_i782)
                {
                  _key780 = iprot.readString();
                  _val781 = new SquareStatus();
                  _val781.read(iprot);
                  struct.statuses.put(_key780, _val781);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.noteStatuses = new java.util.HashMap<java.lang.String,NoteStatus>(2*_map783.size);
                java.lang.String _key784;
                NoteStatus _val785;
                for (int _i786 = 0; _i786 < _map783.size; ++_i786)
                {
                  _key784 = iprot.readString();
                  _val785 = new NoteStatus();
                  _val785.read(iprot);
                  struct.noteStatuses.put(_key784, _val785);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetJoinedSquaresResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.squares != null) {
        oprot.writeFieldBegin(SQUARES_FIELD_DESC);
        {
          ...
          for (Square _iter787 : struct.squares)
          {
      ...
      if (struct.members != null) {
        oprot.writeFieldBegin(MEMBERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMember> _iter788 : struct.members.entrySet())
          {
      ...
      if (struct.authorities != null) {
        oprot.writeFieldBegin(AUTHORITIES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareAuthority> _iter789 : struct.authorities.entrySet())
          {
      ...
      if (struct.statuses != null) {
        oprot.writeFieldBegin(STATUSES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareStatus> _iter790 : struct.statuses.entrySet())
          {
            oprot.writeString(_iter790.getKey());
            _iter790.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.noteStatuses != null) {
        oprot.writeFieldBegin(NOTE_STATUSES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, NoteStatus> _iter791 : struct.noteStatuses.entrySet())
          {
            oprot.writeString(_iter791.getKey());
            _iter791.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class GetJoinedSquaresResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetJoinedSquaresResponse> {
      ...
      if (struct.isSetSquares()) {
        {
          ...
          for (Square _iter792 : struct.squares)
          {
      ...
      if (struct.isSetMembers()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareMember> _iter793 : struct.members.entrySet())
          {
      ...
      if (struct.isSetAuthorities()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareAuthority> _iter794 : struct.authorities.entrySet())
          {
      ...
      if (struct.isSetStatuses()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, SquareStatus> _iter795 : struct.statuses.entrySet())
          {
      ...
      if (struct.isSetNoteStatuses()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, NoteStatus> _iter796 : struct.noteStatuses.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetJoinedSquaresResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.squares = new java.util.ArrayList<Square>(_list797.size);
          Square _elem798;
          for (int _i799 = 0; _i799 < _list797.size; ++_i799)
          {
            _elem798 = new Square();
            _elem798.read(iprot);
            struct.squares.add(_elem798);
          }
        }
        struct.setSquaresIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map800 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.members = new java.util.HashMap<java.lang.String,SquareMember>(2*_map800.size);
          java.lang.String _key801;
          SquareMember _val802;
          for (int _i803 = 0; _i803 < _map800.size; ++_i803)
          {
            _key801 = iprot.readString();
            _val802 = new SquareMember();
            _val802.read(iprot);
            struct.members.put(_key801, _val802);
          }
        }
        struct.setMembersIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map804 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.authorities = new java.util.HashMap<java.lang.String,SquareAuthority>(2*_map804.size);
          java.lang.String _key805;
          SquareAuthority _val806;
          for (int _i807 = 0; _i807 < _map804.size; ++_i807)
          {
            _key805 = iprot.readString();
            _val806 = new SquareAuthority();
            _val806.read(iprot);
            struct.authorities.put(_key805, _val806);
          }
        }
        struct.setAuthoritiesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.statuses = new java.util.HashMap<java.lang.String,SquareStatus>(2*_map808.size);
          java.lang.String _key809;
          SquareStatus _val810;
          for (int _i811 = 0; _i811 < _map808.size; ++_i811)
          {
            _key809 = iprot.readString();
            _val810 = new SquareStatus();
            _val810.read(iprot);
            struct.statuses.put(_key809, _val810);
          }
        }
        struct.setStatusesIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map812 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.noteStatuses = new java.util.HashMap<java.lang.String,NoteStatus>(2*_map812.size);
          java.lang.String _key813;
          NoteStatus _val814;
          for (int _i815 = 0; _i815 < _map812.size; ++_i815)
          {
            _key813 = iprot.readString();
            _val814 = new NoteStatus();
            _val814.read(iprot);
            struct.noteStatuses.put(_key813, _val814);
          }
        }
        struct.setNoteStatusesIsSet(true);
      }
