...
public class ReportSquareMessageRequest implements org.apache.thrift.TBase<ReportSquareMessageRequest, ReportSquareMessageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ReportSquareMessageRequest> {
  ...
  public int compareTo(ReportSquareMessageRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSquareMessageId(), other.isSetSquareMessageId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSquareMessageId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReportType(), other.isSetReportType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReportType()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOtherReason(), other.isSetOtherReason());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOtherReason()) {
