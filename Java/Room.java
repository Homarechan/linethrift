...
public class Room implements org.apache.thrift.TBase<Room, Room._Fields>, java.io.Serializable, Cloneable, Comparable<Room> {
  ...
  public Room setMemberMids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> memberMids) {
    this.memberMids = memberMids;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contacts = new java.util.ArrayList<Contact>(_list434.size);
                @org.apache.thrift.annotation.Nullable Contact _elem435;
                for (int _i436 = 0; _i436 < _list434.size; ++_i436)
                {
                  _elem435 = new Contact();
                  _elem435.read(iprot);
                  struct.contacts.add(_elem435);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.memberMids = new java.util.ArrayList<java.lang.String>(_list437.size);
                ...
                for (int _i439 = 0; _i439 < _list437.size; ++_i439)
                {
                  ...
                  struct.memberMids.add(_elem438);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Room struct) throws org.apache.thrift.TException {
      ...
      if (struct.contacts != null) {
        oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
        {
          ...
          for (Contact _iter440 : struct.contacts)
          {
      ...
      if (struct.memberMids != null) {
        oprot.writeFieldBegin(MEMBER_MIDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter441 : struct.memberMids)
          {
      ...
      if (struct.isSetContacts()) {
        {
          ...
          for (Contact _iter442 : struct.contacts)
          {
      ...
      if (struct.isSetMemberMids()) {
        {
          ...
          for (java.lang.String _iter443 : struct.memberMids)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.contacts = new java.util.ArrayList<Contact>(_list444.size);
          @org.apache.thrift.annotation.Nullable Contact _elem445;
          for (int _i446 = 0; _i446 < _list444.size; ++_i446)
          {
            _elem445 = new Contact();
            _elem445.read(iprot);
            struct.contacts.add(_elem445);
          }
        }
        struct.setContactsIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.memberMids = new java.util.ArrayList<java.lang.String>(_list447.size);
          ...
          for (int _i449 = 0; _i449 < _list447.size; ++_i449)
          {
            ...
            struct.memberMids.add(_elem448);
          }
        }
        struct.setMemberMidsIsSet(true);
      }
