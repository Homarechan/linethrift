            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new java.util.ArrayList<Product>(_list570.size);
                Product _elem571;
                for (int _i572 = 0; _i572 < _list570.size; ++_i572)
                {
                  _elem571 = new Product();
                  _elem571.read(iprot);
                  struct.productList.add(_elem571);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductList struct) throws org.apache.thrift.TException {
      ...
      if (struct.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for (Product _iter573 : struct.productList)
          {
      ...
      if (struct.isSetProductList()) {
        {
          ...
          for (Product _iter574 : struct.productList)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.productList = new java.util.ArrayList<Product>(_list575.size);
          Product _elem576;
          for (int _i577 = 0; _i577 < _list575.size; ++_i577)
          {
            _elem576 = new Product();
            _elem576.read(iprot);
            struct.productList.add(_elem576);
          }
        }
        struct.setProductListIsSet(true);
      }
