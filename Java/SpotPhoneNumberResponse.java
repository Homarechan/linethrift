            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spotItems = new java.util.ArrayList<SpotItem>(_list174.size);
                SpotItem _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = new SpotItem();
                  _elem175.read(iprot);
                  struct.spotItems.add(_elem175);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SpotPhoneNumberResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.spotItems != null) {
        oprot.writeFieldBegin(SPOT_ITEMS_FIELD_DESC);
        {
          ...
          for (SpotItem _iter177 : struct.spotItems)
          {
      ...
      if (struct.isSetSpotItems()) {
        {
          ...
          for (SpotItem _iter178 : struct.spotItems)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.spotItems = new java.util.ArrayList<SpotItem>(_list179.size);
          SpotItem _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new SpotItem();
            _elem180.read(iprot);
            struct.spotItems.add(_elem180);
          }
        }
        struct.setSpotItemsIsSet(true);
      }
