...
public class ApproveSquareMembersResponse implements org.apache.thrift.TBase<ApproveSquareMembersResponse, ApproveSquareMembersResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ApproveSquareMembersResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SquareMember> approvedMembers; // required
  public @org.apache.thrift.annotation.Nullable SquareStatus status; // required
  ...
  public ApproveSquareMembersResponse setApprovedMembers(@org.apache.thrift.annotation.Nullable java.util.List<SquareMember> approvedMembers) {
    this.approvedMembers = approvedMembers;
    return this;
  }
  ...
  public ApproveSquareMembersResponse setStatus(@org.apache.thrift.annotation.Nullable SquareStatus status) {
    this.status = status;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.approvedMembers = new java.util.ArrayList<SquareMember>(_list568.size);
                @org.apache.thrift.annotation.Nullable SquareMember _elem569;
                for (int _i570 = 0; _i570 < _list568.size; ++_i570)
                {
                  _elem569 = new SquareMember();
                  _elem569.read(iprot);
                  struct.approvedMembers.add(_elem569);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ApproveSquareMembersResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.approvedMembers != null) {
        oprot.writeFieldBegin(APPROVED_MEMBERS_FIELD_DESC);
        {
          ...
          for (SquareMember _iter571 : struct.approvedMembers)
          {
      ...
      if (struct.isSetApprovedMembers()) {
        {
          ...
          for (SquareMember _iter572 : struct.approvedMembers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.approvedMembers = new java.util.ArrayList<SquareMember>(_list573.size);
          @org.apache.thrift.annotation.Nullable SquareMember _elem574;
          for (int _i575 = 0; _i575 < _list573.size; ++_i575)
          {
            _elem574 = new SquareMember();
            _elem574.read(iprot);
            struct.approvedMembers.add(_elem574);
          }
        }
        struct.setApprovedMembersIsSet(true);
      }
