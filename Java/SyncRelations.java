...
public class SyncRelations implements org.apache.thrift.TBase<SyncRelations, SyncRelations._Fields>, java.io.Serializable, Cloneable, Comparable<SyncRelations> {
  ...
  public java.util.List<SyncParamContact> syncParamContact; // required
  public java.util.List<SyncParamMid> syncParamMid; // required
  ...
  public SyncRelations setSyncParamContact(java.util.List<SyncParamContact> syncParamContact) {
    this.syncParamContact = syncParamContact;
    return this;
  }
  ...
  public SyncRelations setSyncParamMid(java.util.List<SyncParamMid> syncParamMid) {
    this.syncParamMid = syncParamMid;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.syncParamContact = new java.util.ArrayList<SyncParamContact>(_list728.size);
                SyncParamContact _elem729;
                for (int _i730 = 0; _i730 < _list728.size; ++_i730)
                {
                  _elem729 = new SyncParamContact();
                  _elem729.read(iprot);
                  struct.syncParamContact.add(_elem729);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.syncParamMid = new java.util.ArrayList<SyncParamMid>(_list731.size);
                SyncParamMid _elem732;
                for (int _i733 = 0; _i733 < _list731.size; ++_i733)
                {
                  _elem732 = new SyncParamMid();
                  _elem732.read(iprot);
                  struct.syncParamMid.add(_elem732);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SyncRelations struct) throws org.apache.thrift.TException {
      ...
      if (struct.syncParamContact != null) {
        oprot.writeFieldBegin(SYNC_PARAM_CONTACT_FIELD_DESC);
        {
          ...
          for (SyncParamContact _iter734 : struct.syncParamContact)
          {
      ...
      if (struct.syncParamMid != null) {
        oprot.writeFieldBegin(SYNC_PARAM_MID_FIELD_DESC);
        {
          ...
          for (SyncParamMid _iter735 : struct.syncParamMid)
          {
  ...
  private static class SyncRelationsTupleScheme extends org.apache.thrift.scheme.TupleScheme<SyncRelations> {
      ...
      if (struct.isSetSyncParamContact()) {
        {
          ...
          for (SyncParamContact _iter736 : struct.syncParamContact)
          {
      ...
      if (struct.isSetSyncParamMid()) {
        {
          ...
          for (SyncParamMid _iter737 : struct.syncParamMid)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SyncRelations struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list738 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.syncParamContact = new java.util.ArrayList<SyncParamContact>(_list738.size);
          SyncParamContact _elem739;
          for (int _i740 = 0; _i740 < _list738.size; ++_i740)
          {
            _elem739 = new SyncParamContact();
            _elem739.read(iprot);
            struct.syncParamContact.add(_elem739);
          }
        }
        struct.setSyncParamContactIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.syncParamMid = new java.util.ArrayList<SyncParamMid>(_list741.size);
          SyncParamMid _elem742;
          for (int _i743 = 0; _i743 < _list741.size; ++_i743)
          {
            _elem742 = new SyncParamMid();
            _elem742.read(iprot);
            struct.syncParamMid.add(_elem742);
          }
        }
        struct.setSyncParamMidIsSet(true);
      }
