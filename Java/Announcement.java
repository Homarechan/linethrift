...
public class Announcement implements org.apache.thrift.TBase<Announcement, Announcement._Fields>, java.io.Serializable, Cloneable, Comparable<Announcement> {
  ...
  public int compareTo(Announcement other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetForceUpdate(), other.isSetForceUpdate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForceUpdate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPictureUrl(), other.isSetPictureUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPictureUrl()) {
