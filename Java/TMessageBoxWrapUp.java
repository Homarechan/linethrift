...
public class TMessageBoxWrapUp implements org.apache.thrift.TBase<TMessageBoxWrapUp, TMessageBoxWrapUp._Fields>, java.io.Serializable, Cloneable, Comparable<TMessageBoxWrapUp> {
  ...
  public java.lang.String pictureRevision; // required
  ...
  public TMessageBoxWrapUp setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TMessageBoxWrapUp setContacts(java.util.List<Contact> contacts) {
    this.contacts = contacts;
    return this;
  }
  ...
  public TMessageBoxWrapUp setPictureRevision(java.lang.String pictureRevision) {
    this.pictureRevision = pictureRevision;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contacts = new java.util.ArrayList<Contact>(_list694.size);
                Contact _elem695;
                for (int _i696 = 0; _i696 < _list694.size; ++_i696)
                {
                  _elem695 = new Contact();
                  _elem695.read(iprot);
                  struct.contacts.add(_elem695);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMessageBoxWrapUp struct) throws org.apache.thrift.TException {
      ...
      if (struct.contacts != null) {
        oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
        {
          ...
          for (Contact _iter697 : struct.contacts)
          {
      ...
      if (struct.isSetContacts()) {
        {
          ...
          for (Contact _iter698 : struct.contacts)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.contacts = new java.util.ArrayList<Contact>(_list699.size);
          Contact _elem700;
          for (int _i701 = 0; _i701 < _list699.size; ++_i701)
          {
            _elem700 = new Contact();
            _elem700.read(iprot);
            struct.contacts.add(_elem700);
          }
        }
        struct.setContactsIsSet(true);
      }
