...
public class UpdateSquareFeatureSetRequest implements org.apache.thrift.TBase<UpdateSquareFeatureSetRequest, UpdateSquareFeatureSetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareFeatureSetRequest> {
        ...
        switch (schemeField.id) {
          case 2: // UPDATE_ATTRIBUTES
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set994 = iprot.readSetBegin();
                struct.updateAttributes = java.util.EnumSet.noneOf(SquareFeatureSetAttribute.class);
                SquareFeatureSetAttribute _elem995;
                for (int _i996 = 0; _i996 < _set994.size; ++_i996)
                {
                  _elem995 = SquareFeatureSetAttribute.findByValue(iprot.readI32());
                  if (_elem995 != null)
                  {
                    struct.updateAttributes.add(_elem995);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareFeatureSetRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateAttributes != null) {
        oprot.writeFieldBegin(UPDATE_ATTRIBUTES_FIELD_DESC);
        {
          ...
          for (SquareFeatureSetAttribute _iter997 : struct.updateAttributes)
          {
  ...
  private static class UpdateSquareFeatureSetRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareFeatureSetRequest> {
      ...
      if (struct.isSetUpdateAttributes()) {
        {
          ...
          for (SquareFeatureSetAttribute _iter998 : struct.updateAttributes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareFeatureSetRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set999 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updateAttributes = java.util.EnumSet.noneOf(SquareFeatureSetAttribute.class);
          SquareFeatureSetAttribute _elem1000;
          for (int _i1001 = 0; _i1001 < _set999.size; ++_i1001)
          {
            _elem1000 = SquareFeatureSetAttribute.findByValue(iprot.readI32());
            if (_elem1000 != null)
            {
              struct.updateAttributes.add(_elem1000);
            }
          }
        }
        struct.setUpdateAttributesIsSet(true);
