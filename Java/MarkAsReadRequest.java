...
public class MarkAsReadRequest implements org.apache.thrift.TBase<MarkAsReadRequest, MarkAsReadRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MarkAsReadRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MarkAsReadRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MarkAsReadRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MarkAsReadRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MarkAsReadRequest.class, metaDataMap);
  }
   ...
   */
  public MarkAsReadRequest(MarkAsReadRequest other) {
  ...
  public MarkAsReadRequest deepCopy() {
  ...
  public MarkAsReadRequest setSquareChatMid(@org.apache.thrift.annotation.Nullable java.lang.String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
  ...
  public MarkAsReadRequest setMessageId(@org.apache.thrift.annotation.Nullable java.lang.String messageId) {
    this.messageId = messageId;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof MarkAsReadRequest)
      return this.equals((MarkAsReadRequest)that);
    return false;
  }

  public boolean equals(MarkAsReadRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(MarkAsReadRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("MarkAsReadRequest(");
    boolean first = true;
  ...
  private static class MarkAsReadRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MarkAsReadRequestStandardScheme getScheme() {
      return new MarkAsReadRequestStandardScheme();
    }
  }

  private static class MarkAsReadRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<MarkAsReadRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MarkAsReadRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MarkAsReadRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MarkAsReadRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MarkAsReadRequestTupleScheme getScheme() {
      return new MarkAsReadRequestTupleScheme();
    }
  }

  private static class MarkAsReadRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<MarkAsReadRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MarkAsReadRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MarkAsReadRequest struct) throws org.apache.thrift.TException {
