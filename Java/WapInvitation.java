...
public class WapInvitation implements org.apache.thrift.TBase<WapInvitation, WapInvitation._Fields>, java.io.Serializable, Cloneable, Comparable<WapInvitation> {
  ...
  public java.lang.String inviteeEmail; // required
  public java.lang.String inviterMid; // required
  ...
  public WapInvitation setInviteeEmail(java.lang.String inviteeEmail) {
    this.inviteeEmail = inviteeEmail;
    return this;
  }
  ...
  public WapInvitation setInviterMid(java.lang.String inviterMid) {
    this.inviterMid = inviterMid;
    return this;
  }
  ...
  public WapInvitation setRoomMid(java.lang.String roomMid) {
    this.roomMid = roomMid;
    return this;
  }
  ...
  public int compareTo(WapInvitation other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInviteeEmail()).compareTo(other.isSetInviteeEmail());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInviteeEmail()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInviterMid()).compareTo(other.isSetInviterMid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInviterMid()) {
