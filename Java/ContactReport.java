...
public class ContactReport implements org.apache.thrift.TBase<ContactReport, ContactReport._Fields>, java.io.Serializable, Cloneable, Comparable<ContactReport> {
  ...
  public ContactReport setMid(@org.apache.thrift.annotation.Nullable java.lang.String mid) {
    this.mid = mid;
    return this;
  }
  ...
  public ContactReport setContact(@org.apache.thrift.annotation.Nullable Contact contact) {
    this.contact = contact;
    return this;
  }
  ...
  public int compareTo(ContactReport other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetExists(), other.isSetExists());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExists()) {
