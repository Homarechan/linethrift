            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.categoryList = new java.util.ArrayList<Category>(_list932.size);
                Category _elem933;
                for (int _i934 = 0; _i934 < _list932.size; ++_i934)
                {
                  _elem933 = new Category();
                  _elem933.read(iprot);
                  struct.categoryList.add(_elem933);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetSquareCategoriesResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.categoryList != null) {
        oprot.writeFieldBegin(CATEGORY_LIST_FIELD_DESC);
        {
          ...
          for (Category _iter935 : struct.categoryList)
          {
      ...
      if (struct.isSetCategoryList()) {
        {
          ...
          for (Category _iter936 : struct.categoryList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.categoryList = new java.util.ArrayList<Category>(_list937.size);
          Category _elem938;
          for (int _i939 = 0; _i939 < _list937.size; ++_i939)
          {
            _elem938 = new Category();
            _elem938.read(iprot);
            struct.categoryList.add(_elem938);
          }
        }
        struct.setCategoryListIsSet(true);
      }
