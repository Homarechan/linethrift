...
public class CoinUseReservation implements org.apache.thrift.TBase<CoinUseReservation, CoinUseReservation._Fields>, java.io.Serializable, Cloneable, Comparable<CoinUseReservation> {
  ...
  public java.lang.String shopOrderId; // required
  /**
   * 
   * @see PaymentType
   */
  public PaymentType appStoreCode; // required
  public java.util.List<CoinUseReservationItem> items; // required
  ...
  public CoinUseReservation setChannelId(java.lang.String channelId) {
    this.channelId = channelId;
    return this;
  }
  ...
  public CoinUseReservation setShopOrderId(java.lang.String shopOrderId) {
    this.shopOrderId = shopOrderId;
    return this;
  }
  ...
  public CoinUseReservation setItems(java.util.List<CoinUseReservationItem> items) {
    this.items = items;
    return this;
  }
  ...
  public CoinUseReservation setCountry(java.lang.String country) {
    this.country = country;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new java.util.ArrayList<CoinUseReservationItem>(_list378.size);
                CoinUseReservationItem _elem379;
                for (int _i380 = 0; _i380 < _list378.size; ++_i380)
                {
                  _elem379 = new CoinUseReservationItem();
                  _elem379.read(iprot);
                  struct.items.add(_elem379);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CoinUseReservation struct) throws org.apache.thrift.TException {
      ...
      if (struct.items != null) {
        oprot.writeFieldBegin(ITEMS_FIELD_DESC);
        {
          ...
          for (CoinUseReservationItem _iter381 : struct.items)
          {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (CoinUseReservationItem _iter382 : struct.items)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.items = new java.util.ArrayList<CoinUseReservationItem>(_list383.size);
          CoinUseReservationItem _elem384;
          for (int _i385 = 0; _i385 < _list383.size; ++_i385)
          {
            _elem384 = new CoinUseReservationItem();
            _elem384.read(iprot);
            struct.items.add(_elem384);
          }
        }
        struct.setItemsIsSet(true);
      }
