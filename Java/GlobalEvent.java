...
public class GlobalEvent implements org.apache.thrift.TBase<GlobalEvent, GlobalEvent._Fields>, java.io.Serializable, Cloneable, Comparable<GlobalEvent> {
  ...
  public java.util.List<NotificationTarget> targets; // required
  ...
  public GlobalEvent setKey(java.lang.String key) {
    this.key = key;
    return this;
  }
  ...
  public GlobalEvent setTargets(java.util.List<NotificationTarget> targets) {
    this.targets = targets;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.targets = new java.util.ArrayList<NotificationTarget>(_list434.size);
                NotificationTarget _elem435;
                for (int _i436 = 0; _i436 < _list434.size; ++_i436)
                {
                  _elem435 = new NotificationTarget();
                  _elem435.read(iprot);
                  struct.targets.add(_elem435);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GlobalEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.targets != null) {
        oprot.writeFieldBegin(TARGETS_FIELD_DESC);
        {
          ...
          for (NotificationTarget _iter437 : struct.targets)
          {
      ...
      if (struct.isSetTargets()) {
        {
          ...
          for (NotificationTarget _iter438 : struct.targets)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.targets = new java.util.ArrayList<NotificationTarget>(_list439.size);
          NotificationTarget _elem440;
          for (int _i441 = 0; _i441 < _list439.size; ++_i441)
          {
            _elem440 = new NotificationTarget();
            _elem440.read(iprot);
            struct.targets.add(_elem440);
          }
        }
        struct.setTargetsIsSet(true);
      }
