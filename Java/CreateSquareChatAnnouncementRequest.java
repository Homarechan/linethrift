...
public class CreateSquareChatAnnouncementRequest implements org.apache.thrift.TBase<CreateSquareChatAnnouncementRequest, CreateSquareChatAnnouncementRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateSquareChatAnnouncementRequest> {
  ...
  public SquareChatAnnouncement squareChatAnnouncement; // required
  ...
  public CreateSquareChatAnnouncementRequest setSquareChatMid(java.lang.String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
  ...
  public CreateSquareChatAnnouncementRequest setSquareChatAnnouncement(SquareChatAnnouncement squareChatAnnouncement) {
    this.squareChatAnnouncement = squareChatAnnouncement;
    return this;
  }
  ...
  public int compareTo(CreateSquareChatAnnouncementRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSquareChatAnnouncement()).compareTo(other.isSetSquareChatAnnouncement());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSquareChatAnnouncement()) {
