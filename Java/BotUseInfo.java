...
public class BotUseInfo implements org.apache.thrift.TBase<BotUseInfo, BotUseInfo._Fields>, java.io.Serializable, Cloneable, Comparable<BotUseInfo> {
  ...
  public java.lang.String primaryApplication; // required
  ...
  public BotUseInfo setPrimaryApplication(java.lang.String primaryApplication) {
    this.primaryApplication = primaryApplication;
    return this;
  }
  ...
  public BotUseInfo setLocale(java.lang.String locale) {
    this.locale = locale;
    return this;
  }
