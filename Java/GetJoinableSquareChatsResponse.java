...
public class GetJoinableSquareChatsResponse implements org.apache.thrift.TBase<GetJoinableSquareChatsResponse, GetJoinableSquareChatsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetJoinableSquareChatsResponse> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SquareChat> squareChats; // required
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SquareChatStatus> squareChatStatuses; // required
  ...
  public GetJoinableSquareChatsResponse setSquareChats(@org.apache.thrift.annotation.Nullable java.util.List<SquareChat> squareChats) {
    this.squareChats = squareChats;
    return this;
  }
  ...
  public GetJoinableSquareChatsResponse setContinuationToken(@org.apache.thrift.annotation.Nullable java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
  ...
  public GetJoinableSquareChatsResponse setSquareChatStatuses(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,SquareChatStatus> squareChatStatuses) {
    this.squareChatStatuses = squareChatStatuses;
    return this;
  }
  ...
  public int compareTo(GetJoinableSquareChatsResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSquareChats(), other.isSetSquareChats());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTotalSquareChatCount(), other.isSetTotalSquareChatCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetSquareChatStatuses(), other.isSetSquareChatStatuses());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSquareChatStatuses()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable SquareChat _elem641;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                @org.apache.thrift.annotation.Nullable java.lang.String _key644;
                @org.apache.thrift.annotation.Nullable SquareChatStatus _val645;
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable SquareChat _elem652;
      ...
      if (incoming.get(3)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable SquareChatStatus _val656;
