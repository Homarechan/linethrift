            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.categories = new java.util.ArrayList<ProductCategory>(_list562.size);
                ProductCategory _elem563;
                for (int _i564 = 0; _i564 < _list562.size; ++_i564)
                {
                  _elem563 = new ProductCategory();
                  _elem563.read(iprot);
                  struct.categories.add(_elem563);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Product struct) throws org.apache.thrift.TException {
      ...
      if (struct.categories != null) {
        oprot.writeFieldBegin(CATEGORIES_FIELD_DESC);
        {
          ...
          for (ProductCategory _iter565 : struct.categories)
          {
      ...
      if (struct.isSetCategories()) {
        {
          ...
          for (ProductCategory _iter566 : struct.categories)
          {
      ...
      if (incoming.get(28)) {
        {
          ...
          struct.categories = new java.util.ArrayList<ProductCategory>(_list567.size);
          ProductCategory _elem568;
          for (int _i569 = 0; _i569 < _list567.size; ++_i569)
          {
            _elem568 = new ProductCategory();
            _elem568.read(iprot);
            struct.categories.add(_elem568);
          }
        }
        struct.setCategoriesIsSet(true);
      }
