...
public class NotificationFetchResult implements org.apache.thrift.TBase<NotificationFetchResult, NotificationFetchResult._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationFetchResult> {
  ...
  public java.util.List<NotificationItem> itemList; // required
  ...
  public NotificationFetchResult setItemList(java.util.List<NotificationItem> itemList) {
    this.itemList = itemList;
    return this;
  }
  ...
  public int compareTo(NotificationFetchResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFetchMode()).compareTo(other.isSetFetchMode());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.itemList = new java.util.ArrayList<NotificationItem>(_list544.size);
                NotificationItem _elem545;
                for (int _i546 = 0; _i546 < _list544.size; ++_i546)
                {
                  _elem545 = new NotificationItem();
                  _elem545.read(iprot);
                  struct.itemList.add(_elem545);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NotificationFetchResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.itemList != null) {
        oprot.writeFieldBegin(ITEM_LIST_FIELD_DESC);
        {
          ...
          for (NotificationItem _iter547 : struct.itemList)
          {
      ...
      if (struct.isSetItemList()) {
        {
          ...
          for (NotificationItem _iter548 : struct.itemList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.itemList = new java.util.ArrayList<NotificationItem>(_list549.size);
          NotificationItem _elem550;
          for (int _i551 = 0; _i551 < _list549.size; ++_i551)
          {
            _elem550 = new NotificationItem();
            _elem550.read(iprot);
            struct.itemList.add(_elem550);
          }
        }
        struct.setItemListIsSet(true);
      }
