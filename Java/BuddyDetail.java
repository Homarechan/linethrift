...
public class BuddyDetail implements org.apache.thrift.TBase<BuddyDetail, BuddyDetail._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyDetail> {
  ...
  public java.util.Set<ContentType> acceptableContentTypes; // required
  ...
  public BuddyDetail setMid(java.lang.String mid) {
    this.mid = mid;
    return this;
  }
  ...
  public BuddyDetail setAcceptableContentTypes(java.util.Set<ContentType> acceptableContentTypes) {
    this.acceptableContentTypes = acceptableContentTypes;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                ContentType _elem263;
                for (int _i264 = 0; _i264 < _set262.size; ++_i264)
                {
                  _elem263 = ContentType.findByValue(iprot.readI32());
                  if (_elem263 != null)
                  {
                    struct.acceptableContentTypes.add(_elem263);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuddyDetail struct) throws org.apache.thrift.TException {
      ...
      if (struct.acceptableContentTypes != null) {
        oprot.writeFieldBegin(ACCEPTABLE_CONTENT_TYPES_FIELD_DESC);
        {
          ...
          for (ContentType _iter265 : struct.acceptableContentTypes)
          {
      ...
      if (struct.isSetAcceptableContentTypes()) {
        {
          ...
          for (ContentType _iter266 : struct.acceptableContentTypes)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.acceptableContentTypes = java.util.EnumSet.noneOf(ContentType.class);
          ContentType _elem268;
          for (int _i269 = 0; _i269 < _set267.size; ++_i269)
          {
            _elem268 = ContentType.findByValue(iprot.readI32());
            if (_elem268 != null)
            {
              struct.acceptableContentTypes.add(_elem268);
            }
          }
        }
        struct.setAcceptableContentTypesIsSet(true);
