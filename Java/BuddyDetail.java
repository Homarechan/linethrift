...
public class BuddyDetail implements org.apache.thrift.TBase<BuddyDetail, BuddyDetail._Fields>, java.io.Serializable, Cloneable, Comparable<BuddyDetail> {
  ...
  public int compareTo(BuddyDetail other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBusinessAccount(), other.isSetBusinessAccount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetAddable(), other.isSetAddable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAddable()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAcceptableContentTypes(), other.isSetAcceptableContentTypes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAcceptableContentTypes()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCapableMyhome(), other.isSetCapableMyhome());
    if (lastComparison != 0) {
      return lastComparison;
    }
