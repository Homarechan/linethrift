            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1220.size);
                java.lang.String _key1221;
                java.lang.String _val1222;
                for (int _i1223 = 0; _i1223 < _map1220.size; ++_i1223)
                {
                  _key1221 = iprot.readString();
                  _val1222 = iprot.readString();
                  struct.extra.put(_key1221, _val1222);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PointException struct) throws org.apache.thrift.TException {
      ...
      if (struct.extra != null) {
        oprot.writeFieldBegin(EXTRA_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1224 : struct.extra.entrySet())
          {
      ...
      if (struct.isSetExtra()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1225 : struct.extra.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.extra = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1226.size);
          java.lang.String _key1227;
          java.lang.String _val1228;
          for (int _i1229 = 0; _i1229 < _map1226.size; ++_i1229)
          {
            _key1227 = iprot.readString();
            _val1228 = iprot.readString();
            struct.extra.put(_key1227, _val1228);
          }
        }
        struct.setExtraIsSet(true);
      }
