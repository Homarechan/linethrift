...
public class SquareFeatureSet implements org.apache.thrift.TBase<SquareFeatureSet, SquareFeatureSet._Fields>, java.io.Serializable, Cloneable, Comparable<SquareFeatureSet> {
  ...
  public SquareFeatureSet setSquareMid(java.lang.String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public int compareTo(SquareFeatureSet other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCreatingSecretSquareChat()).compareTo(other.isSetCreatingSecretSquareChat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreatingSecretSquareChat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInvitingIntoOpenSquareChat()).compareTo(other.isSetInvitingIntoOpenSquareChat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInvitingIntoOpenSquareChat()) {
