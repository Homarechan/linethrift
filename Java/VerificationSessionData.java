...
public class VerificationSessionData implements org.apache.thrift.TBase<VerificationSessionData, VerificationSessionData._Fields>, java.io.Serializable, Cloneable, Comparable<VerificationSessionData> {
  ...
  private static final org.apache.thrift.protocol.TField CALLER_ID_MASK_FIELD_DESC = new org.apache.thrift.protocol.TField("callerIdMask", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  public java.lang.String callback; // required
  public java.lang.String normalizedPhone; // required
  public java.lang.String countryCode; // required
  public java.lang.String nationalSignificantNumber; // required
  public java.util.List<VerificationMethod> availableVerificationMethods; // required
  public java.lang.String callerIdMask; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CALLER_ID_MASK((short)8, "callerIdMask");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // CALLER_ID_MASK
          return CALLER_ID_MASK;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.AVAILABLE_VERIFICATION_METHODS, new org.apache.thrift.meta_data.FieldMetaData("availableVerificationMethods", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, VerificationMethod.class))));
    tmpMap.put(_Fields.CALLER_ID_MASK, new org.apache.thrift.meta_data.FieldMetaData("callerIdMask", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    java.lang.String callerIdMask)
  {
    ...
    this.callerIdMask = callerIdMask;
  }
  ...
  public VerificationSessionData(VerificationSessionData other) {
    ...
    if (other.isSetCallerIdMask()) {
      this.callerIdMask = other.callerIdMask;
    }
  }
  ...
  public VerificationSessionData setSessionId(java.lang.String sessionId) {
    this.sessionId = sessionId;
    return this;
  }
  ...
  public VerificationSessionData setCallback(java.lang.String callback) {
    this.callback = callback;
    return this;
  }
  ...
  public VerificationSessionData setNormalizedPhone(java.lang.String normalizedPhone) {
    this.normalizedPhone = normalizedPhone;
    return this;
  }
  ...
  public VerificationSessionData setCountryCode(java.lang.String countryCode) {
    this.countryCode = countryCode;
    return this;
  }
  ...
  public VerificationSessionData setNationalSignificantNumber(java.lang.String nationalSignificantNumber) {
    this.nationalSignificantNumber = nationalSignificantNumber;
    return this;
  }
  ...
  public VerificationSessionData setAvailableVerificationMethods(java.util.List<VerificationMethod> availableVerificationMethods) {
    this.availableVerificationMethods = availableVerificationMethods;
    return this;
  }
  ...
  public java.lang.String getCallerIdMask() {
    return this.callerIdMask;
  }

  public VerificationSessionData setCallerIdMask(java.lang.String callerIdMask) {
    this.callerIdMask = callerIdMask;
    return this;
  }

  public void unsetCallerIdMask() {
    this.callerIdMask = null;
  }

  /** Returns true if field callerIdMask is set (has been assigned a value) and false otherwise */
  public boolean isSetCallerIdMask() {
    return this.callerIdMask != null;
  }

  public void setCallerIdMaskIsSet(boolean value) {
    if (!value) {
      this.callerIdMask = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CALLER_ID_MASK:
      if (value == null) {
        ...
        setCallerIdMask((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(VerificationSessionData that) {
    ...
    boolean this_present_callerIdMask = true && this.isSetCallerIdMask();
    boolean that_present_callerIdMask = true && that.isSetCallerIdMask();
    if (this_present_callerIdMask || that_present_callerIdMask) {
      if (!(this_present_callerIdMask && that_present_callerIdMask))
        return false;
      if (!this.callerIdMask.equals(that.callerIdMask))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCallerIdMask()) ? 131071 : 524287);
    if (isSetCallerIdMask())
      hashCode = hashCode * 8191 + callerIdMask.hashCode();
  ...
  public int compareTo(VerificationSessionData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCallerIdMask()).compareTo(other.isSetCallerIdMask());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallerIdMask()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callerIdMask, other.callerIdMask);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, VerificationSessionData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.availableVerificationMethods = new java.util.ArrayList<VerificationMethod>(_list482.size);
                VerificationMethod _elem483;
                for (int _i484 = 0; _i484 < _list482.size; ++_i484)
                {
                  _elem483 = VerificationMethod.findByValue(iprot.readI32());
                  if (_elem483 != null)
                  {
                    struct.availableVerificationMethods.add(_elem483);
                  }
                }
                iprot.readListEnd();
              }
          ...
          case 8: // CALLER_ID_MASK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.callerIdMask = iprot.readString();
              struct.setCallerIdMaskIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, VerificationSessionData struct) throws org.apache.thrift.TException {
      ...
      if (struct.availableVerificationMethods != null) {
        oprot.writeFieldBegin(AVAILABLE_VERIFICATION_METHODS_FIELD_DESC);
        {
          ...
          for (VerificationMethod _iter485 : struct.availableVerificationMethods)
          {
      ...
      if (struct.callerIdMask != null) {
        oprot.writeFieldBegin(CALLER_ID_MASK_FIELD_DESC);
        oprot.writeString(struct.callerIdMask);
        oprot.writeFieldEnd();
      }
  ...
  private static class VerificationSessionDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<VerificationSessionData> {
      ...
      if (struct.isSetAvailableVerificationMethods()) {
        {
          ...
          for (VerificationMethod _iter486 : struct.availableVerificationMethods)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, VerificationSessionData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list487 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.availableVerificationMethods = new java.util.ArrayList<VerificationMethod>(_list487.size);
          VerificationMethod _elem488;
          for (int _i489 = 0; _i489 < _list487.size; ++_i489)
          {
            _elem488 = VerificationMethod.findByValue(iprot.readI32());
            if (_elem488 != null)
            {
              struct.availableVerificationMethods.add(_elem488);
            }
          }
        }
        struct.setAvailableVerificationMethodsIsSet(true);
