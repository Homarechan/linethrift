...
public class VerificationSessionData implements org.apache.thrift.TBase<VerificationSessionData, VerificationSessionData._Fields>, java.io.Serializable, Cloneable, Comparable<VerificationSessionData> {
  ...
  public int compareTo(VerificationSessionData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNormalizedPhone(), other.isSetNormalizedPhone());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNormalizedPhone()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNationalSignificantNumber(), other.isSetNationalSignificantNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNationalSignificantNumber()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAvailableVerificationMethods(), other.isSetAvailableVerificationMethods());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAvailableVerificationMethods()) {
