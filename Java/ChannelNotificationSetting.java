...
public class ChannelNotificationSetting implements org.apache.thrift.TBase<ChannelNotificationSetting, ChannelNotificationSetting._Fields>, java.io.Serializable, Cloneable, Comparable<ChannelNotificationSetting> {
  ...
  public ChannelNotificationSetting setChannelId(java.lang.String channelId) {
    this.channelId = channelId;
    return this;
  }
  ...
  public ChannelNotificationSetting setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public int compareTo(ChannelNotificationSetting other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNotificationReceivable()).compareTo(other.isSetNotificationReceivable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMessageReceivable()).compareTo(other.isSetMessageReceivable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetShowDefault()).compareTo(other.isSetShowDefault());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShowDefault()) {
