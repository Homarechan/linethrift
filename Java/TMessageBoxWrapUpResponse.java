            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageBoxWrapUpList = new java.util.ArrayList<TMessageBoxWrapUp>(_list702.size);
                TMessageBoxWrapUp _elem703;
                for (int _i704 = 0; _i704 < _list702.size; ++_i704)
                {
                  _elem703 = new TMessageBoxWrapUp();
                  _elem703.read(iprot);
                  struct.messageBoxWrapUpList.add(_elem703);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMessageBoxWrapUpResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.messageBoxWrapUpList != null) {
        oprot.writeFieldBegin(MESSAGE_BOX_WRAP_UP_LIST_FIELD_DESC);
        {
          ...
          for (TMessageBoxWrapUp _iter705 : struct.messageBoxWrapUpList)
          {
      ...
      if (struct.isSetMessageBoxWrapUpList()) {
        {
          ...
          for (TMessageBoxWrapUp _iter706 : struct.messageBoxWrapUpList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.messageBoxWrapUpList = new java.util.ArrayList<TMessageBoxWrapUp>(_list707.size);
          TMessageBoxWrapUp _elem708;
          for (int _i709 = 0; _i709 < _list707.size; ++_i709)
          {
            _elem708 = new TMessageBoxWrapUp();
            _elem708.read(iprot);
            struct.messageBoxWrapUpList.add(_elem708);
          }
        }
        struct.setMessageBoxWrapUpListIsSet(true);
      }
