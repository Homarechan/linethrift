...
public class AgeCheckDocomoResult implements org.apache.thrift.TBase<AgeCheckDocomoResult, AgeCheckDocomoResult._Fields>, java.io.Serializable, Cloneable, Comparable<AgeCheckDocomoResult> {
   ...
   * @see UserAgeType
   */
  public @org.apache.thrift.annotation.Nullable UserAgeType userAgeType; // required
  ...
  public AgeCheckDocomoResult setAuthUrl(@org.apache.thrift.annotation.Nullable java.lang.String authUrl) {
    this.authUrl = authUrl;
    return this;
  }
   ...
   * @see UserAgeType
   */
  public AgeCheckDocomoResult setUserAgeType(@org.apache.thrift.annotation.Nullable UserAgeType userAgeType) {
    this.userAgeType = userAgeType;
    return this;
  }
  ...
  public int compareTo(AgeCheckDocomoResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAuthUrl(), other.isSetAuthUrl());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUserAgeType(), other.isSetUserAgeType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUserAgeType()) {
