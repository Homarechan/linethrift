...
public class ChannelException extends org.apache.thrift.TException implements org.apache.thrift.TBase<ChannelException, ChannelException._Fields>, java.io.Serializable, Cloneable, Comparable<ChannelException> {
  ...
  public ChannelException setReason(java.lang.String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ChannelException setParameterMap(java.util.Map<java.lang.String,java.lang.String> parameterMap) {
    this.parameterMap = parameterMap;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1230.size);
                java.lang.String _key1231;
                java.lang.String _val1232;
                for (int _i1233 = 0; _i1233 < _map1230.size; ++_i1233)
                {
                  _key1231 = iprot.readString();
                  _val1232 = iprot.readString();
                  struct.parameterMap.put(_key1231, _val1232);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChannelException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1234 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1235 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1236.size);
          java.lang.String _key1237;
          java.lang.String _val1238;
          for (int _i1239 = 0; _i1239 < _map1236.size; ++_i1239)
          {
            _key1237 = iprot.readString();
            _val1238 = iprot.readString();
            struct.parameterMap.put(_key1237, _val1238);
          }
        }
        struct.setParameterMapIsSet(true);
      }
