            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.popularContacts = new java.util.ArrayList<Contact>(_list280.size);
                Contact _elem281;
                for (int _i282 = 0; _i282 < _list280.size; ++_i282)
                {
                  _elem281 = new Contact();
                  _elem281.read(iprot);
                  struct.popularContacts.add(_elem281);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BuddyList struct) throws org.apache.thrift.TException {
      ...
      if (struct.popularContacts != null) {
        oprot.writeFieldBegin(POPULAR_CONTACTS_FIELD_DESC);
        {
          ...
          for (Contact _iter283 : struct.popularContacts)
          {
      ...
      if (struct.isSetPopularContacts()) {
        {
          ...
          for (Contact _iter284 : struct.popularContacts)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.popularContacts = new java.util.ArrayList<Contact>(_list285.size);
          Contact _elem286;
          for (int _i287 = 0; _i287 < _list285.size; ++_i287)
          {
            _elem286 = new Contact();
            _elem286.read(iprot);
            struct.popularContacts.add(_elem286);
          }
        }
        struct.setPopularContactsIsSet(true);
      }
