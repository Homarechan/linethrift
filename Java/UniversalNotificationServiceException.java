...
public class UniversalNotificationServiceException extends org.apache.thrift.TException implements org.apache.thrift.TBase<UniversalNotificationServiceException, UniversalNotificationServiceException._Fields>, java.io.Serializable, Cloneable, Comparable<UniversalNotificationServiceException> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable UniversalNotificationServiceErrorCode code; // required
   ...
   * @see UniversalNotificationServiceErrorCode
   */
  public UniversalNotificationServiceException setCode(@org.apache.thrift.annotation.Nullable UniversalNotificationServiceErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public UniversalNotificationServiceException setReason(@org.apache.thrift.annotation.Nullable java.lang.String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public UniversalNotificationServiceException setParameterMap(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> parameterMap) {
    this.parameterMap = parameterMap;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 3: // PARAMETER_MAP
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map1064 = iprot.readMapBegin();
                struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1064.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key1065;
                @org.apache.thrift.annotation.Nullable java.lang.String _val1066;
                for (int _i1067 = 0; _i1067 < _map1064.size; ++_i1067)
                {
                  _key1065 = iprot.readString();
                  _val1066 = iprot.readString();
                  struct.parameterMap.put(_key1065, _val1066);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UniversalNotificationServiceException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1068 : struct.parameterMap.entrySet())
          {
            oprot.writeString(_iter1068.getKey());
            oprot.writeString(_iter1068.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class UniversalNotificationServiceExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<UniversalNotificationServiceException> {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter1069 : struct.parameterMap.entrySet())
          {
            oprot.writeString(_iter1069.getKey());
            oprot.writeString(_iter1069.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UniversalNotificationServiceException struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map1070 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map1070.size);
          ...
          for (int _i1073 = 0; _i1073 < _map1070.size; ++_i1073)
          {
            ...
            struct.parameterMap.put(_key1071, _val1072);
          }
        }
        struct.setParameterMapIsSet(true);
      }
