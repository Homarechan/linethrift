...
public class UpdateSquareMemberResponse implements org.apache.thrift.TBase<UpdateSquareMemberResponse, UpdateSquareMemberResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateSquareMemberResponse> {
  ...
  public UpdateSquareMemberResponse setUpdatedAttrs(java.util.Set<SquareMemberAttribute> updatedAttrs) {
    this.updatedAttrs = updatedAttrs;
    return this;
  }
  ...
  public UpdateSquareMemberResponse setSquareMember(SquareMember squareMember) {
    this.squareMember = squareMember;
    return this;
  }
  ...
  public UpdateSquareMemberResponse setUpdatedPreferenceAttrs(java.util.Set<SquarePreferenceAttribute> updatedPreferenceAttrs) {
    this.updatedPreferenceAttrs = updatedPreferenceAttrs;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // UPDATED_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1026 = iprot.readSetBegin();
                struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
                SquareMemberAttribute _elem1027;
                for (int _i1028 = 0; _i1028 < _set1026.size; ++_i1028)
                {
                  _elem1027 = SquareMemberAttribute.findByValue(iprot.readI32());
                  if (_elem1027 != null)
                  {
                    struct.updatedAttrs.add(_elem1027);
                  }
                }
                iprot.readSetEnd();
              }
          ...
          case 3: // UPDATED_PREFERENCE_ATTRS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set1029 = iprot.readSetBegin();
                struct.updatedPreferenceAttrs = java.util.EnumSet.noneOf(SquarePreferenceAttribute.class);
                SquarePreferenceAttribute _elem1030;
                for (int _i1031 = 0; _i1031 < _set1029.size; ++_i1031)
                {
                  _elem1030 = SquarePreferenceAttribute.findByValue(iprot.readI32());
                  if (_elem1030 != null)
                  {
                    struct.updatedPreferenceAttrs.add(_elem1030);
                  }
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UpdateSquareMemberResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.updatedAttrs != null) {
        oprot.writeFieldBegin(UPDATED_ATTRS_FIELD_DESC);
        {
          ...
          for (SquareMemberAttribute _iter1032 : struct.updatedAttrs)
          {
      ...
      if (struct.updatedPreferenceAttrs != null) {
        oprot.writeFieldBegin(UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
        {
          ...
          for (SquarePreferenceAttribute _iter1033 : struct.updatedPreferenceAttrs)
          {
  ...
  private static class UpdateSquareMemberResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<UpdateSquareMemberResponse> {
      ...
      if (struct.isSetUpdatedAttrs()) {
        {
          ...
          for (SquareMemberAttribute _iter1034 : struct.updatedAttrs)
          {
      ...
      if (struct.isSetUpdatedPreferenceAttrs()) {
        {
          ...
          for (SquarePreferenceAttribute _iter1035 : struct.updatedPreferenceAttrs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, UpdateSquareMemberResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set1036 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedAttrs = java.util.EnumSet.noneOf(SquareMemberAttribute.class);
          SquareMemberAttribute _elem1037;
          for (int _i1038 = 0; _i1038 < _set1036.size; ++_i1038)
          {
            _elem1037 = SquareMemberAttribute.findByValue(iprot.readI32());
            if (_elem1037 != null)
            {
              struct.updatedAttrs.add(_elem1037);
            }
          }
        }
        struct.setUpdatedAttrsIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TSet _set1039 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.updatedPreferenceAttrs = java.util.EnumSet.noneOf(SquarePreferenceAttribute.class);
          SquarePreferenceAttribute _elem1040;
          for (int _i1041 = 0; _i1041 < _set1039.size; ++_i1041)
          {
            _elem1040 = SquarePreferenceAttribute.findByValue(iprot.readI32());
            if (_elem1040 != null)
            {
              struct.updatedPreferenceAttrs.add(_elem1040);
            }
          }
        }
        struct.setUpdatedPreferenceAttrsIsSet(true);
