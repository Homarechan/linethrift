...
public class LastReadMessageIds implements org.apache.thrift.TBase<LastReadMessageIds, LastReadMessageIds._Fields>, java.io.Serializable, Cloneable, Comparable<LastReadMessageIds> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<LastReadMessageId> lastReadMessageIds; // required
  ...
  public LastReadMessageIds setChatId(@org.apache.thrift.annotation.Nullable java.lang.String chatId) {
    this.chatId = chatId;
    return this;
  }
  ...
  public LastReadMessageIds setLastReadMessageIds(@org.apache.thrift.annotation.Nullable java.util.List<LastReadMessageId> lastReadMessageIds) {
    this.lastReadMessageIds = lastReadMessageIds;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lastReadMessageIds = new java.util.ArrayList<LastReadMessageId>(_list298.size);
                @org.apache.thrift.annotation.Nullable LastReadMessageId _elem299;
                for (int _i300 = 0; _i300 < _list298.size; ++_i300)
                {
                  _elem299 = new LastReadMessageId();
                  _elem299.read(iprot);
                  struct.lastReadMessageIds.add(_elem299);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LastReadMessageIds struct) throws org.apache.thrift.TException {
      ...
      if (struct.lastReadMessageIds != null) {
        oprot.writeFieldBegin(LAST_READ_MESSAGE_IDS_FIELD_DESC);
        {
          ...
          for (LastReadMessageId _iter301 : struct.lastReadMessageIds)
          {
      ...
      if (struct.isSetLastReadMessageIds()) {
        {
          ...
          for (LastReadMessageId _iter302 : struct.lastReadMessageIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.lastReadMessageIds = new java.util.ArrayList<LastReadMessageId>(_list303.size);
          @org.apache.thrift.annotation.Nullable LastReadMessageId _elem304;
          for (int _i305 = 0; _i305 < _list303.size; ++_i305)
          {
            _elem304 = new LastReadMessageId();
            _elem304.read(iprot);
            struct.lastReadMessageIds.add(_elem304);
          }
        }
        struct.setLastReadMessageIdsIsSet(true);
      }
