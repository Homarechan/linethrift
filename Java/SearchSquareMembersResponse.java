...
public class SearchSquareMembersResponse implements org.apache.thrift.TBase<SearchSquareMembersResponse, SearchSquareMembersResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SearchSquareMembersResponse> {
  ...
  public SearchSquareMembersResponse setMembers(java.util.List<SquareMember> members) {
    this.members = members;
    return this;
  }
  ...
  public SearchSquareMembersResponse setContinuationToken(java.lang.String continuationToken) {
    this.continuationToken = continuationToken;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.members = new java.util.ArrayList<SquareMember>(_list842.size);
                SquareMember _elem843;
                for (int _i844 = 0; _i844 < _list842.size; ++_i844)
                {
                  _elem843 = new SquareMember();
                  _elem843.read(iprot);
                  struct.members.add(_elem843);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchSquareMembersResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.members != null) {
        oprot.writeFieldBegin(MEMBERS_FIELD_DESC);
        {
          ...
          for (SquareMember _iter845 : struct.members)
          {
      ...
      if (struct.isSetMembers()) {
        {
          ...
          for (SquareMember _iter846 : struct.members)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.members = new java.util.ArrayList<SquareMember>(_list847.size);
          SquareMember _elem848;
          for (int _i849 = 0; _i849 < _list847.size; ++_i849)
          {
            _elem848 = new SquareMember();
            _elem848.read(iprot);
            struct.members.add(_elem848);
          }
        }
        struct.setMembersIsSet(true);
      }
