...
public class ApprovedChannelInfos implements org.apache.thrift.TBase<ApprovedChannelInfos, ApprovedChannelInfos._Fields>, java.io.Serializable, Cloneable, Comparable<ApprovedChannelInfos> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<ApprovedChannelInfo> approvedChannelInfos; // required
  ...
  public ApprovedChannelInfos setApprovedChannelInfos(@org.apache.thrift.annotation.Nullable java.util.List<ApprovedChannelInfo> approvedChannelInfos) {
    this.approvedChannelInfos = approvedChannelInfos;
    return this;
  }
  ...
  public int compareTo(ApprovedChannelInfos other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetApprovedChannelInfos(), other.isSetApprovedChannelInfos());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable ApprovedChannelInfo _elem105;
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable ApprovedChannelInfo _elem110;
