            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.approvedChannelInfos = new java.util.ArrayList<ApprovedChannelInfo>(_list254.size);
                ApprovedChannelInfo _elem255;
                for (int _i256 = 0; _i256 < _list254.size; ++_i256)
                {
                  _elem255 = new ApprovedChannelInfo();
                  _elem255.read(iprot);
                  struct.approvedChannelInfos.add(_elem255);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ApprovedChannelInfos struct) throws org.apache.thrift.TException {
      ...
      if (struct.approvedChannelInfos != null) {
        oprot.writeFieldBegin(APPROVED_CHANNEL_INFOS_FIELD_DESC);
        {
          ...
          for (ApprovedChannelInfo _iter257 : struct.approvedChannelInfos)
          {
      ...
      if (struct.isSetApprovedChannelInfos()) {
        {
          ...
          for (ApprovedChannelInfo _iter258 : struct.approvedChannelInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.approvedChannelInfos = new java.util.ArrayList<ApprovedChannelInfo>(_list259.size);
          ApprovedChannelInfo _elem260;
          for (int _i261 = 0; _i261 < _list259.size; ++_i261)
          {
            _elem260 = new ApprovedChannelInfo();
            _elem260.read(iprot);
            struct.approvedChannelInfos.add(_elem260);
          }
        }
        struct.setApprovedChannelInfosIsSet(true);
      }
