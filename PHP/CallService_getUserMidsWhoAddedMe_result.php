...
class CallService_getUserMidsWhoAddedMe_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2404 = 0;
                        $_etype2407 = 0;
                        $xfer += $input->readListBegin($_etype2407, $_size2404);
                        for ($_i2408 = 0; $_i2408 < $_size2404; ++$_i2408) {
                            $elem2409 = null;
                            $xfer += $input->readString($elem2409);
                            $this->success []= $elem2409;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2410) {
                $xfer += $output->writeString($iter2410);
            }
            $output->writeListEnd();
