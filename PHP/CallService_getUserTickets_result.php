...
class CallService_getUserTickets_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2376 = 0;
                        $_etype2379 = 0;
                        $xfer += $input->readListBegin($_etype2379, $_size2376);
                        for ($_i2380 = 0; $_i2380 < $_size2376; ++$_i2380) {
                            $elem2381 = null;
                            $elem2381 = new \UserTicketResponse();
                            $xfer += $elem2381->read($input);
                            $this->success []= $elem2381;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2382) {
                $xfer += $iter2382->write($output);
            }
            $output->writeListEnd();
