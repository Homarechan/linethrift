...
class CallService_getCallCreditProducts_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2173 = 0;
                        $_etype2176 = 0;
                        $xfer += $input->readListBegin($_etype2176, $_size2173);
                        for ($_i2177 = 0; $_i2177 < $_size2173; ++$_i2177) {
                            $elem2178 = null;
                            $elem2178 = new \CoinProductItem();
                            $xfer += $elem2178->read($input);
                            $this->success []= $elem2178;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2179) {
