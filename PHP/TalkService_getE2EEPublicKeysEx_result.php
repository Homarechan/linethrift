...
class TalkService_getE2EEPublicKeysEx_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2007 = 0;
                        $_etype2010 = 0;
                        $xfer += $input->readListBegin($_etype2010, $_size2007);
                        for ($_i2011 = 0; $_i2011 < $_size2007; ++$_i2011) {
                            $elem2012 = null;
                            $elem2012 = new \E2EEPublicKey();
                            $xfer += $elem2012->read($input);
                            $this->success []= $elem2012;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2013) {
                $xfer += $iter2013->write($output);
            }
            $output->writeListEnd();
