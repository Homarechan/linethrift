...
class TalkService_kickoutFromGroup_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1845 = 0;
                        $_etype1848 = 0;
                        $xfer += $input->readListBegin($_etype1848, $_size1845);
                        for ($_i1849 = 0; $_i1849 < $_size1845; ++$_i1849) {
                            $elem1850 = null;
                            $xfer += $input->readString($elem1850);
                            $this->contactIds []= $elem1850;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->contactIds !== null) {
            ...
            foreach ($this->contactIds as $iter1851) {
                $xfer += $output->writeString($iter1851);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
