...
class CallService_lookupGroupMembers_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2194 = 0;
                        $_etype2197 = 0;
                        $xfer += $input->readListBegin($_etype2197, $_size2194);
                        for ($_i2198 = 0; $_i2198 < $_size2194; ++$_i2198) {
                            $elem2199 = null;
                            $elem2199 = new \SimpleChannelContact();
                            $xfer += $elem2199->read($input);
                            $this->success []= $elem2199;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2200) {
                $xfer += $iter2200->write($output);
            }
            $output->writeListEnd();
