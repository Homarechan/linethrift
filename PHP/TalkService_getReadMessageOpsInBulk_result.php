...
class TalkService_getReadMessageOpsInBulk_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2021 = 0;
                        $_etype2024 = 0;
                        $xfer += $input->readListBegin($_etype2024, $_size2021);
                        for ($_i2025 = 0; $_i2025 < $_size2021; ++$_i2025) {
                            $elem2026 = null;
                            $elem2026 = new \Operation();
                            $xfer += $elem2026->read($input);
                            $this->success []= $elem2026;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2027) {
                $xfer += $iter2027->write($output);
            }
            $output->writeListEnd();
