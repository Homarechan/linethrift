...
class CallService_lookupRoomMembers_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2348 = 0;
                        $_etype2351 = 0;
                        $xfer += $input->readListBegin($_etype2351, $_size2348);
                        for ($_i2352 = 0; $_i2352 < $_size2348; ++$_i2352) {
                            $elem2353 = null;
                            $elem2353 = new \SimpleChannelContact();
                            $xfer += $elem2353->read($input);
                            $this->success []= $elem2353;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2354) {
                $xfer += $iter2354->write($output);
            }
            $output->writeListEnd();
