...
class TalkService_getE2EEPublicKeys_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2000 = 0;
                        $_etype2003 = 0;
                        $xfer += $input->readListBegin($_etype2003, $_size2000);
                        for ($_i2004 = 0; $_i2004 < $_size2000; ++$_i2004) {
                            $elem2005 = null;
                            $elem2005 = new \E2EEPublicKey();
                            $xfer += $elem2005->read($input);
                            $this->success []= $elem2005;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2006) {
                $xfer += $iter2006->write($output);
            }
            $output->writeListEnd();
