...
class TalkService_syncContactBySnsIds_result
{
    ...
    /**
     * @var \SnsFriendContactRegistration[]
     */
    public $success = null;
    /**
     * @var \TalkException
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i2069 = 0; $_i2069 < $_size2065; ++$_i2069) {
                            $elem2070 = null;
                            $elem2070 = new \SnsFriendContactRegistration();
                            $xfer += $elem2070->read($input);
                            $this->success []= $elem2070;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2071) {
                $xfer += $iter2071->write($output);
            }
            $output->writeListEnd();
