...
class CallService_getJoinedGroupIdsForChannel_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2397 = 0;
                        $_etype2400 = 0;
                        $xfer += $input->readListBegin($_etype2400, $_size2397);
                        for ($_i2401 = 0; $_i2401 < $_size2397; ++$_i2401) {
                            $elem2402 = null;
                            $xfer += $input->readString($elem2402);
                            $this->success []= $elem2402;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2403) {
                $xfer += $output->writeString($iter2403);
            }
            $output->writeListEnd();
