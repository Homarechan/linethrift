...
class CallService_getPaidCallBalanceList_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2257 = 0;
                        $_etype2260 = 0;
                        $xfer += $input->readListBegin($_etype2260, $_size2257);
                        for ($_i2261 = 0; $_i2261 < $_size2257; ++$_i2261) {
                            $elem2262 = null;
                            $elem2262 = new \PaidCallBalance();
                            $xfer += $elem2262->read($input);
                            $this->success []= $elem2262;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2263) {
                $xfer += $iter2263->write($output);
            }
            $output->writeListEnd();
