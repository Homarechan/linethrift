...
class CallService_getContactsForChannel_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2166 = 0;
                        $_etype2169 = 0;
                        $xfer += $input->readListBegin($_etype2169, $_size2166);
                        for ($_i2170 = 0; $_i2170 < $_size2166; ++$_i2170) {
                            $elem2171 = null;
                            $elem2171 = new \Contact();
                            $xfer += $elem2171->read($input);
                            $this->success []= $elem2171;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2172) {
                $xfer += $iter2172->write($output);
            }
            $output->writeListEnd();
