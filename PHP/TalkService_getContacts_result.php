...
class TalkService_getContacts_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1683 = 0;
                        $_etype1686 = 0;
                        $xfer += $input->readListBegin($_etype1686, $_size1683);
                        for ($_i1687 = 0; $_i1687 < $_size1683; ++$_i1687) {
                            $elem1688 = null;
                            $elem1688 = new \Contact();
                            $xfer += $elem1688->read($input);
                            $this->success []= $elem1688;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1689) {
                $xfer += $iter1689->write($output);
            }
            $output->writeListEnd();
