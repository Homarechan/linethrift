...
class TalkService_getPreviousMessagesV2WithReadCount_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        ...
                        $xfer += $this->endMessageId->read($input);
                    } else {
                        $xfer += $input->skip($ftype);
                    }
                    break;
    ...
    public function write($output)
    {
        ...
        if ($this->endMessageId !== null) {
            if (!is_object($this->endMessageId)) {
                throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
            }
            $xfer += $output->writeFieldBegin('endMessageId', TType::STRUCT, 3);
            $xfer += $this->endMessageId->write($output);
            $xfer += $output->writeFieldEnd();
        }
