...
class TalkService_getNotificationPolicy_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1767 = 0;
                        $_etype1770 = 0;
                        $xfer += $input->readListBegin($_etype1770, $_size1767);
                        for ($_i1771 = 0; $_i1771 < $_size1767; ++$_i1771) {
                            $elem1772 = null;
                            $xfer += $input->readI32($elem1772);
                            $this->success []= $elem1772;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1773) {
                $xfer += $output->writeI32($iter1773);
            }
            $output->writeListEnd();
