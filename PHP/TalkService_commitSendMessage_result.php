...
class TalkService_commitSendMessage_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1430 = 0;
                        $_vtype1431 = 0;
                        $xfer += $input->readMapBegin($_ktype1430, $_vtype1431, $_size1429);
                        for ($_i1433 = 0; $_i1433 < $_size1429; ++$_i1433) {
                            $key1434 = '';
                            $val1435 = '';
                            $xfer += $input->readString($key1434);
                            $xfer += $input->readString($val1435);
                            $this->success[$key1434] = $val1435;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $kiter1436 => $viter1437) {
                $xfer += $output->writeString($kiter1436);
                $xfer += $output->writeString($viter1437);
            }
            $output->writeMapEnd();
