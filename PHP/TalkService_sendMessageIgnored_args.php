...
class TalkService_sendMessageIgnored_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2028 = 0;
                        $_etype2031 = 0;
                        $xfer += $input->readListBegin($_etype2031, $_size2028);
                        for ($_i2032 = 0; $_i2032 < $_size2028; ++$_i2032) {
                            $elem2033 = null;
                            $xfer += $input->readString($elem2033);
                            $this->messageIds []= $elem2033;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->messageIds !== null) {
            ...
            $xfer += $output->writeFieldBegin('messageIds', TType::LST, 3);
            $output->writeListBegin(TType::STRING, count($this->messageIds));
            foreach ($this->messageIds as $iter2034) {
                $xfer += $output->writeString($iter2034);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
