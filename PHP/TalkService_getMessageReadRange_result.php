...
class TalkService_getMessageReadRange_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1891 = 0;
                        $_etype1894 = 0;
                        $xfer += $input->readListBegin($_etype1894, $_size1891);
                        for ($_i1895 = 0; $_i1895 < $_size1891; ++$_i1895) {
                            $elem1896 = null;
                            $elem1896 = new \TMessageReadRange();
                            $xfer += $elem1896->read($input);
                            $this->success []= $elem1896;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1897) {
                $xfer += $iter1897->write($output);
            }
            $output->writeListEnd();
