...
class TalkService_sendMessageReceipt_args
{
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2035 = 0;
                        $_etype2038 = 0;
                        $xfer += $input->readListBegin($_etype2038, $_size2035);
                        for ($_i2039 = 0; $_i2039 < $_size2035; ++$_i2039) {
                            $elem2040 = null;
                            $xfer += $input->readString($elem2040);
                            $this->messageIds []= $elem2040;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->messageIds !== null) {
            ...
            foreach ($this->messageIds as $iter2041) {
                $xfer += $output->writeString($iter2041);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
