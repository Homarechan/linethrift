...
class CallService_getRoomMemberMidsForAppPlatform_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2250 = 0;
                        $_etype2253 = 0;
                        $xfer += $input->readListBegin($_etype2253, $_size2250);
                        for ($_i2254 = 0; $_i2254 < $_size2250; ++$_i2254) {
                            $elem2255 = null;
                            $xfer += $input->readString($elem2255);
                            $this->success []= $elem2255;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2256) {
                $xfer += $output->writeString($iter2256);
            }
            $output->writeListEnd();
