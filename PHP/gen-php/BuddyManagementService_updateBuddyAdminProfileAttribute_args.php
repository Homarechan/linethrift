...
class BuddyManagementService_updateBuddyAdminProfileAttribute_args
{
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::MAP) {
                        ...
                        $_ktype1107 = 0;
                        $_vtype1108 = 0;
                        $xfer += $input->readMapBegin($_ktype1107, $_vtype1108, $_size1106);
                        for ($_i1110 = 0; $_i1110 < $_size1106; ++$_i1110) {
                            $key1111 = '';
                            $val1112 = '';
                            $xfer += $input->readString($key1111);
                            $xfer += $input->readString($val1112);
                            $this->attributes[$key1111] = $val1112;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->attributes !== null) {
            ...
            foreach ($this->attributes as $kiter1113 => $viter1114) {
                $xfer += $output->writeString($kiter1113);
                $xfer += $output->writeString($viter1114);
            }
            $output->writeMapEnd();
            $xfer += $output->writeFieldEnd();
        }
