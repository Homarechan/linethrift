...
class CallService_getOAFriendMids_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2383 = 0;
                        $_etype2386 = 0;
                        $xfer += $input->readListBegin($_etype2386, $_size2383);
                        for ($_i2387 = 0; $_i2387 < $_size2383; ++$_i2387) {
                            $elem2388 = null;
                            $xfer += $input->readString($elem2388);
                            $this->success []= $elem2388;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2389) {
                $xfer += $output->writeString($iter2389);
            }
            $output->writeListEnd();
