...
class TalkService_getRecentMessagesV2_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2095 = 0;
                        $_etype2098 = 0;
                        $xfer += $input->readListBegin($_etype2098, $_size2095);
                        for ($_i2099 = 0; $_i2099 < $_size2095; ++$_i2099) {
                            $elem2100 = null;
                            $elem2100 = new \Message();
                            $xfer += $elem2100->read($input);
                            $this->success []= $elem2100;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2101) {
                $xfer += $iter2101->write($output);
            }
            $output->writeListEnd();
