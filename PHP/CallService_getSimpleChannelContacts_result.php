...
class CallService_getSimpleChannelContacts_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2418 = 0;
                        $_etype2421 = 0;
                        $xfer += $input->readListBegin($_etype2421, $_size2418);
                        for ($_i2422 = 0; $_i2422 < $_size2418; ++$_i2422) {
                            $elem2423 = null;
                            $elem2423 = new \SimpleChannelContact();
                            $xfer += $elem2423->read($input);
                            $this->success []= $elem2423;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2424) {
                $xfer += $iter2424->write($output);
            }
            $output->writeListEnd();
