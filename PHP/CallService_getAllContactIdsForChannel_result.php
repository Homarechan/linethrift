...
class CallService_getAllContactIdsForChannel_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2362 = 0;
                        $_etype2365 = 0;
                        $xfer += $input->readListBegin($_etype2365, $_size2362);
                        for ($_i2366 = 0; $_i2366 < $_size2362; ++$_i2366) {
                            $elem2367 = null;
                            $xfer += $input->readString($elem2367);
                            $this->success []= $elem2367;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2368) {
                $xfer += $output->writeString($iter2368);
            }
            $output->writeListEnd();
