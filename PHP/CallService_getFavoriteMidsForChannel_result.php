...
class CallService_getFavoriteMidsForChannel_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2355 = 0;
                        $_etype2358 = 0;
                        $xfer += $input->readListBegin($_etype2358, $_size2355);
                        for ($_i2359 = 0; $_i2359 < $_size2355; ++$_i2359) {
                            $elem2360 = null;
                            $xfer += $input->readString($elem2360);
                            $this->success []= $elem2360;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2361) {
                $xfer += $output->writeString($iter2361);
            }
            $output->writeListEnd();
