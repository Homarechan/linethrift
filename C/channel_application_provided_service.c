          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem577, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem577);
              }
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                CompactContact * _elem578 = NULL;
                if ( _elem578 != NULL)
                {
                  g_object_unref (_elem578);
                }
                _elem578 = g_object_new (TYPE_COMPACT_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem578), protocol, error)) < 0)
                {
                  g_object_unref (_elem578);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem578);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (ids ? ids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i579 = 0; i579 < (ids ? ids->len : 0); i579++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) ids, i579)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                Contact * _elem580 = NULL;
                if ( _elem580 != NULL)
                {
                  g_object_unref (_elem580);
                }
                _elem580 = g_object_new (TYPE_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem580), protocol, error)) < 0)
                {
                  g_object_unref (_elem580);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem580);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem581, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem581);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem582, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem582);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem583, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem583);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (groupIds ? groupIds->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i584 = 0; i584 < (groupIds ? groupIds->len : 0); i584++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) groupIds, i584)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ( _elem585 != NULL)
                {
                  g_object_unref (_elem585);
                }
                _elem585 = g_object_new (TYPE_GROUP, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem585), protocol, error)) < 0)
                {
                  g_object_unref (_elem585);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem585);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem586, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem586);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (ids ? ids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i587 = 0; i587 < (ids ? ids->len : 0); i587++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) ids, i587)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelContact * _elem588 = NULL;
                if ( _elem588 != NULL)
                {
                  g_object_unref (_elem588);
                }
                _elem588 = g_object_new (TYPE_SIMPLE_CHANNEL_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem588), protocol, error)) < 0)
                {
                  g_object_unref (_elem588);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem588);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                RegistrationType key589;
                gchar * val590 = NULL;
                gint32 ecast591;
                if ((ret = thrift_protocol_read_i32 (protocol, &ecast591, error)) < 0)
                  return 0;
                xfer += ret;
                key589 = (RegistrationType)ecast591;
                if (val590 != NULL)
                {
                  g_free(val590);
                  val590 = NULL;
                ...
                if ((ret = thrift_protocol_read_string (protocol, &val590, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key589)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key589, (gpointer) val590);
              }
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem592, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem592);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
