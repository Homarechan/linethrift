...
struct _AuthServiceIfInterface
{
  ...
  gboolean (*update_password) (AuthServiceIf *iface, IdentityCredentialResponse ** _return, const gchar * authSessionId, const IdentityCredentialRequest * request, TalkException ** e, GError **error);
  gboolean (*get_auth_r_s_a_key) (AuthServiceIf *iface, RSAKey ** _return, const gchar * authSessionId, const IdentityProvider identityProvider, TalkException ** e, GError **error);
  gboolean (*open_auth_session) (AuthServiceIf *iface, gchar ** _return, const AuthSessionRequest * request, TalkException ** e, GError **error);
...
gboolean auth_service_if_update_password (AuthServiceIf *iface, IdentityCredentialResponse ** _return, const gchar * authSessionId, const IdentityCredentialRequest * request, TalkException ** e, GError **error);
gboolean auth_service_if_get_auth_r_s_a_key (AuthServiceIf *iface, RSAKey ** _return, const gchar * authSessionId, const IdentityProvider identityProvider, TalkException ** e, GError **error);
gboolean auth_service_if_open_auth_session (AuthServiceIf *iface, gchar ** _return, const AuthSessionRequest * request, TalkException ** e, GError **error);
