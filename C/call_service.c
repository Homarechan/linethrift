    ...
    while (1)
    {
      ...
      switch (fid)
      {
        case 0:
          ...
          {
            gint32 ecast1134;
            if ((ret = thrift_protocol_read_i32 (protocol, &ecast1134, error)) < 0)
              return 0;
            xfer += ret;
            *_return = (UserStatus)ecast1134;
          } else {
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelContact * _elem1135 = NULL;
                if ( _elem1135 != NULL)
                {
                  g_object_unref (_elem1135);
                }
                _elem1135 = g_object_new (TYPE_SIMPLE_CHANNEL_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1135), protocol, error)) < 0)
                {
                  g_object_unref (_elem1135);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1135);
              }
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                RegistrationType key1136;
                gchar * val1137 = NULL;
                gint32 ecast1138;
                if ((ret = thrift_protocol_read_i32 (protocol, &ecast1138, error)) < 0)
                  return 0;
                xfer += ret;
                key1136 = (RegistrationType)ecast1138;
                if (val1137 != NULL)
                {
                  g_free(val1137);
                  val1137 = NULL;
                ...
                if ((ret = thrift_protocol_read_string (protocol, &val1137, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key1136)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key1136, (gpointer) val1137);
              }
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (mids ? mids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1139 = 0; i1139 < (mids ? mids->len : 0); i1139++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) mids, i1139)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &key1140, error)) < 0)
                  return 0;
                xfer += ret;
                if (val1141 != NULL)
                {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &val1141, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key1140)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key1140, (gpointer) val1141);
              }
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (ids ? ids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1142 = 0; i1142 < (ids ? ids->len : 0); i1142++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) ids, i1142)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                Contact * _elem1143 = NULL;
                if ( _elem1143 != NULL)
                {
                  g_object_unref (_elem1143);
                }
                _elem1143 = g_object_new (TYPE_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1143), protocol, error)) < 0)
                {
                  g_object_unref (_elem1143);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1143);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                CoinProductItem * _elem1144 = NULL;
                if ( _elem1144 != NULL)
                {
                  g_object_unref (_elem1144);
                }
                _elem1144 = g_object_new (TYPE_COIN_PRODUCT_ITEM, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1144), protocol, error)) < 0)
                {
                  g_object_unref (_elem1144);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1144);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                CompactContact * _elem1145 = NULL;
                if ( _elem1145 != NULL)
                {
                  g_object_unref (_elem1145);
                }
                _elem1145 = g_object_new (TYPE_COMPACT_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1145), protocol, error)) < 0)
                {
                  g_object_unref (_elem1145);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1145);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (mids ? mids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1146 = 0; i1146 < (mids ? mids->len : 0); i1146++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) mids, i1146)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelContact * _elem1147 = NULL;
                if ( _elem1147 != NULL)
                {
                  g_object_unref (_elem1147);
                }
                _elem1147 = g_object_new (TYPE_SIMPLE_CHANNEL_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1147), protocol, error)) < 0)
                {
                  g_object_unref (_elem1147);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1147);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (contactIds ? contactIds->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1148 = 0; i1148 < (contactIds ? contactIds->len : 0); i1148++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) contactIds, i1148)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1149, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1149);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (memberMids ? memberMids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1150 = 0; i1150 < (memberMids ? memberMids->len : 0); i1150++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) memberMids, i1150)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1151, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1151);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (groupIds ? groupIds->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1152 = 0; i1152 < (groupIds ? groupIds->len : 0); i1152++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) groupIds, i1152)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                Group * _elem1153 = NULL;
                if ( _elem1153 != NULL)
                {
                  g_object_unref (_elem1153);
                }
                _elem1153 = g_object_new (TYPE_GROUP, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1153), protocol, error)) < 0)
                {
                  g_object_unref (_elem1153);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1153);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                PaidCallCurrencyExchangeRate * _elem1154 = NULL;
                if ( _elem1154 != NULL)
                {
                  g_object_unref (_elem1154);
                }
                _elem1154 = g_object_new (TYPE_PAID_CALL_CURRENCY_EXCHANGE_RATE, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1154), protocol, error)) < 0)
                {
                  g_object_unref (_elem1154);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1154);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1155, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1155);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                PaidCallBalance * _elem1156 = NULL;
                if ( _elem1156 != NULL)
                {
                  g_object_unref (_elem1156);
                }
                _elem1156 = g_object_new (TYPE_PAID_CALL_BALANCE, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1156), protocol, error)) < 0)
                {
                  g_object_unref (_elem1156);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1156);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                PersonalInfo key1157;
                gchar * val1158 = NULL;
                gint32 ecast1159;
                if ((ret = thrift_protocol_read_i32 (protocol, &ecast1159, error)) < 0)
                  return 0;
                xfer += ret;
                key1157 = (PersonalInfo)ecast1159;
                if (val1158 != NULL)
                {
                  g_free(val1158);
                  val1158 = NULL;
                ...
                if ((ret = thrift_protocol_read_string (protocol, &val1158, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key1157)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key1157, (gpointer) val1158);
              }
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (userMids ? userMids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1160 = 0; i1160 < (userMids ? userMids->len : 0); i1160++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) userMids, i1160)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelClient * _elem1161 = NULL;
                if ( _elem1161 != NULL)
                {
                  g_object_unref (_elem1161);
                }
                _elem1161 = g_object_new (TYPE_SIMPLE_CHANNEL_CLIENT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1161), protocol, error)) < 0)
                {
                  g_object_unref (_elem1161);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1161);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1162, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1162);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (ids ? ids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1163 = 0; i1163 < (ids ? ids->len : 0); i1163++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) ids, i1163)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &key1164, error)) < 0)
                  return 0;
                xfer += ret;
                if ( val1165 != NULL)
                {
                  g_object_unref (val1165);
                }
                val1165 = g_object_new (TYPE_COMPACT_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (val1165), protocol, error)) < 0)
                {
                  g_object_unref (val1165);
                  return 0;
                }
                xfer += ret;
                if (*_return && key1164)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key1164, (gpointer) val1165);
              }
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1166, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1166);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (mids ? mids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1167 = 0; i1167 < (mids ? mids->len : 0); i1167++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) mids, i1167)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &key1168, error)) < 0)
                  return 0;
                xfer += ret;
                if ((ret = thrift_protocol_read_i64 (protocol, &*val1169, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key1168)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key1168, (gpointer) val1169);
              }
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (mids ? mids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1170 = 0; i1170 < (mids ? mids->len : 0); i1170++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) mids, i1170)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelContact * _elem1171 = NULL;
                if ( _elem1171 != NULL)
                {
                  g_object_unref (_elem1171);
                }
                _elem1171 = g_object_new (TYPE_SIMPLE_CHANNEL_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1171), protocol, error)) < 0)
                {
                  g_object_unref (_elem1171);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1171);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1172, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1172);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1173, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1173);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (userMids ? userMids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1174 = 0; i1174 < (userMids ? userMids->len : 0); i1174++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) userMids, i1174)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                UserTicketResponse * _elem1175 = NULL;
                if ( _elem1175 != NULL)
                {
                  g_object_unref (_elem1175);
                }
                _elem1175 = g_object_new (TYPE_USER_TICKET_RESPONSE, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1175), protocol, error)) < 0)
                {
                  g_object_unref (_elem1175);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1175);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1176, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1176);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                PaidCallUserRate * _elem1177 = NULL;
                if ( _elem1177 != NULL)
                {
                  g_object_unref (_elem1177);
                }
                _elem1177 = g_object_new (TYPE_PAID_CALL_USER_RATE, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1177), protocol, error)) < 0)
                {
                  g_object_unref (_elem1177);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1177);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1178, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1178);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &_elem1179, error)) < 0)
                  return 0;
                xfer += ret;
                g_ptr_array_add (*_return, _elem1179);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (ids ? ids->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i1180 = 0; i1180 < (ids ? ids->len : 0); i1180++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) ids, i1180)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                SimpleChannelContact * _elem1181 = NULL;
                if ( _elem1181 != NULL)
                {
                  g_object_unref (_elem1181);
                }
                _elem1181 = g_object_new (TYPE_SIMPLE_CHANNEL_CONTACT, NULL);
                if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem1181), protocol, error)) < 0)
                {
                  g_object_unref (_elem1181);
                  return 0;
                }
                xfer += ret;
                g_ptr_array_add (*_return, _elem1181);
              }
              if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
                return 0;
              xfer += ret;
