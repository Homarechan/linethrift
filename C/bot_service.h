...
struct _BotServiceIfInterface
{
  ...
  gboolean (*send_chat_checked_by_watermark) (BotServiceIf *iface, const gint32 seq, const gchar * mid, const gint64 watermark, const gint32 sessionId, TalkException ** e, GError **error);
};
...
gboolean bot_service_if_send_chat_checked_by_watermark (BotServiceIf *iface, const gint32 seq, const gchar * mid, const gint64 watermark, const gint32 sessionId, TalkException ** e, GError **error);
