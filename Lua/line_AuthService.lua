...
function AuthServiceClient:updatePassword(authSessionId, request)
  self:send_updatePassword(authSessionId, request)
  return self:recv_updatePassword(authSessionId, request)
end

function AuthServiceClient:send_updatePassword(authSessionId, request)
  self.oprot:writeMessageBegin('updatePassword', TMessageType.CALL, self._seqid)
  local args = updatePassword_args:new{}
...
function AuthServiceClient:recv_updatePassword(authSessionId, request)
  ...
  local result = updatePassword_result:new{}
...
function AuthServiceClient:getAuthRSAKey(authSessionId, identityProvider)
  self:send_getAuthRSAKey(authSessionId, identityProvider)
  return self:recv_getAuthRSAKey(authSessionId, identityProvider)
end

function AuthServiceClient:send_getAuthRSAKey(authSessionId, identityProvider)
  self.oprot:writeMessageBegin('getAuthRSAKey', TMessageType.CALL, self._seqid)
  local args = getAuthRSAKey_args:new{}
  args.authSessionId = authSessionId
...
function AuthServiceClient:recv_getAuthRSAKey(authSessionId, identityProvider)
  local fname, mtype, rseqid = self.iprot:readMessageBegin()
  if mtype == TMessageType.EXCEPTION then
    local x = TApplicationException:new{}
    x:read(self.iprot)
  ...
  local result = getAuthRSAKey_result:new{}
  result:read(self.iprot)
  self.iprot:readMessageEnd()
  if result.success ~= nil then
    return result.success
...
function AuthServiceClient:openAuthSession(request)
  self:send_openAuthSession(request)
  return self:recv_openAuthSession(request)
end

function AuthServiceClient:send_openAuthSession(request)
  self.oprot:writeMessageBegin('openAuthSession', TMessageType.CALL, self._seqid)
  local args = openAuthSession_args:new{}
  args.request = request
  args:write(self.oprot)
  self.oprot:writeMessageEnd()
  self.oprot.trans:flush()
...
function AuthServiceClient:recv_openAuthSession(request)
  local fname, mtype, rseqid = self.iprot:readMessageBegin()
  if mtype == TMessageType.EXCEPTION then
    local x = TApplicationException:new{}
    x:read(self.iprot)
  ...
  local result = openAuthSession_result:new{}
  result:read(self.iprot)
  self.iprot:readMessageEnd()
  if result.success ~= nil then
    return result.success
...
function AuthServiceProcessor:process_updatePassword(seqid, iprot, oprot, server_ctx)
  local args = updatePassword_args:new{}
  local reply_type = TMessageType.REPLY
  args:read(iprot)
  iprot:readMessageEnd()
  local result = updatePassword_result:new{}
  local status, res = pcall(self.handler.updatePassword, self.handler, args.authSessionId, args.request)
  if not status then
  ...
  oprot:writeMessageBegin('updatePassword', reply_type, seqid)
  result:write(oprot)
  oprot:writeMessageEnd()
  oprot.trans:flush()
end

function AuthServiceProcessor:process_getAuthRSAKey(seqid, iprot, oprot, server_ctx)
  local args = getAuthRSAKey_args:new{}
  local reply_type = TMessageType.REPLY
  args:read(iprot)
  iprot:readMessageEnd()
  local result = getAuthRSAKey_result:new{}
  local status, res = pcall(self.handler.getAuthRSAKey, self.handler, args.authSessionId, args.identityProvider)
  if not status then
    reply_type = TMessageType.EXCEPTION
    result = TApplicationException:new{message = res}
  elseif ttype(res) == 'TalkException' then
  ...
  oprot:writeMessageBegin('getAuthRSAKey', reply_type, seqid)
  result:write(oprot)
  oprot:writeMessageEnd()
  oprot.trans:flush()
end

function AuthServiceProcessor:process_openAuthSession(seqid, iprot, oprot, server_ctx)
  local args = openAuthSession_args:new{}
  local reply_type = TMessageType.REPLY
  args:read(iprot)
  iprot:readMessageEnd()
  local result = openAuthSession_result:new{}
  local status, res = pcall(self.handler.openAuthSession, self.handler, args.request)
  if not status then
    reply_type = TMessageType.EXCEPTION
    result = TApplicationException:new{message = res}
  elseif ttype(res) == 'TalkException' then
  ...
  oprot:writeMessageBegin('openAuthSession', reply_type, seqid)
  result:write(oprot)
  oprot:writeMessageEnd()
  oprot.trans:flush()
end
...
updatePassword_args = __TObject:new{
  authSessionId,
  request
}

function updatePassword_args:read(iprot)
...
function updatePassword_args:write(oprot)
  oprot:writeStructBegin('updatePassword_args')
  if self.authSessionId ~= nil then
...
updatePassword_result = __TObject:new{
  success,
  e
}

function updatePassword_result:read(iprot)
  iprot:readStructBegin()
  while true do
    local fname, ftype, fid = iprot:readFieldBegin()
    if ftype == TType.STOP then
...
function updatePassword_result:write(oprot)
...
getAuthRSAKey_args = __TObject:new{
  authSessionId,
  identityProvider
}

function getAuthRSAKey_args:read(iprot)
  iprot:readStructBegin()
  while true do
    local fname, ftype, fid = iprot:readFieldBegin()
    if ftype == TType.STOP then
...
function getAuthRSAKey_args:write(oprot)
...
getAuthRSAKey_result = __TObject:new{
  success,
  e
}

function getAuthRSAKey_result:read(iprot)
  iprot:readStructBegin()
  while true do
    local fname, ftype, fid = iprot:readFieldBegin()
    if ftype == TType.STOP then
...
function getAuthRSAKey_result:write(oprot)
...
openAuthSession_args = __TObject:new{
  request
}

function openAuthSession_args:read(iprot)
  iprot:readStructBegin()
  while true do
    local fname, ftype, fid = iprot:readFieldBegin()
    if ftype == TType.STOP then
...
function openAuthSession_args:write(oprot)
...
openAuthSession_result = __TObject:new{
  success,
  e
}

function openAuthSession_result:read(iprot)
  iprot:readStructBegin()
  while true do
    local fname, ftype, fid = iprot:readFieldBegin()
    if ftype == TType.STOP then
...
function openAuthSession_result:write(oprot)
