          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i83 = 0; _i83 < _list82.length; ++_i83) {
                ChannelDomain _elem84;
                _elem84 = new ChannelDomain();
                _elem84.read(iprot);
                this.channelDomains.add(_elem84);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.channelDomains != null) {
      oprot.writeFieldBegin(_CHANNEL_DOMAINS_FIELD_DESC);
      {
        ...
        for (var elem85 in this.channelDomains) {
          elem85.write(oprot);
        }
        oprot.writeListEnd();
      }
