      ...
      switch (field.id) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i122 = 0; _i122 < _list121.length; ++_i122) {
                int _elem123;
                _elem123 = iprot.readI32();
                this.channelConfigurations.add(_elem123);
              }
              iprot.readListEnd();
            }
          } else {
        ...
        case ALLOWEDPERMISSIONS:
          if (field.type == TType.SET) {
            {
              TSet _set124 = iprot.readSetBegin();
              this.allowedPermissions = new Set<int>();
              for (int _i125 = 0; _i125 < _set124.length; ++_i125) {
                int _elem126;
                _elem126 = iprot.readI32();
                this.allowedPermissions.add(_elem126);
              }
              iprot.readSetEnd();
            }
          } else {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i128 = 0; _i128 < _list127.length; ++_i128) {
                ChannelDomain _elem129;
                _elem129 = new ChannelDomain();
                _elem129.read(iprot);
                this.channelDomains.add(_elem129);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.permissions != null) {
      oprot.writeFieldBegin(_PERMISSIONS_FIELD_DESC);
      {
        ...
        for (var elem130 in this.permissions) {
    ...
    if (this.channelConfigurations != null) {
      oprot.writeFieldBegin(_CHANNEL_CONFIGURATIONS_FIELD_DESC);
      {
        ...
        for (var elem131 in this.channelConfigurations) {
    ...
    if (this.allowedPermissions != null) {
      oprot.writeFieldBegin(_ALLOWED_PERMISSIONS_FIELD_DESC);
      {
        ...
        for (var elem132 in this.allowedPermissions) {
    ...
    if (this.channelDomains != null) {
      oprot.writeFieldBegin(_CHANNEL_DOMAINS_FIELD_DESC);
      {
        ...
        for (var elem133 in this.channelDomains) {
          elem133.write(oprot);
        }
        oprot.writeListEnd();
      }
