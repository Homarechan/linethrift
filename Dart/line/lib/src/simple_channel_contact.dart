 ...
 *  @generated
 */
library line.src.simple_channel_contact;
...
class SimpleChannelContact implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("SimpleChannelContact");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("SimpleChannelContact(");
