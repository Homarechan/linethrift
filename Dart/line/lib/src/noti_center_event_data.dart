          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i99 = 0; _i99 < _map98.length; ++_i99) {
                String _key100;
                String _val101;
                _key100 = iprot.readString();
                _val101 = iprot.readString();
                this.content[_key100] = _val101;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.content != null) {
      oprot.writeFieldBegin(_CONTENT_FIELD_DESC);
      {
        ...
        for (var elem107 in this.content.keys) {
          oprot.writeString(elem107);
          oprot.writeString(this.content[elem107]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.push != null) {
      oprot.writeFieldBegin(_PUSH_FIELD_DESC);
      {
        ...
        for (var elem109 in this.push.keys) {
          oprot.writeString(elem109);
          oprot.writeString(this.push[elem109]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
