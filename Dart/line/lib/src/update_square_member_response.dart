      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set542 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i543 = 0; _i543 < _set542.length; ++_i543) {
                int _elem544;
                _elem544 = iprot.readI32();
                this.updatedAttrs.add(_elem544);
              }
              iprot.readSetEnd();
            }
          } else {
        ...
        case UPDATEDPREFERENCEATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set545 = iprot.readSetBegin();
              this.updatedPreferenceAttrs = new Set<int>();
              for (int _i546 = 0; _i546 < _set545.length; ++_i546) {
                int _elem547;
                _elem547 = iprot.readI32();
                this.updatedPreferenceAttrs.add(_elem547);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem548 in this.updatedAttrs) {
          oprot.writeI32(elem548);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.updatedPreferenceAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_PREFERENCE_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem549 in this.updatedPreferenceAttrs) {
