          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i555 = 0; _i555 < _map554.length; ++_i555) {
                String _key556;
                String _val557;
                _key556 = iprot.readString();
                _val557 = iprot.readString();
                this.parameterMap[_key556] = _val557;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(_PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (var elem559 in this.parameterMap.keys) {
          oprot.writeString(elem559);
          oprot.writeString(this.parameterMap[elem559]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
