 ...
 *  @generated
 */
library line.src.channel_exception;

import 'dart:typed_data' show Uint8List;
import 'package:thrift/thrift.dart';
import 'package:line/line.dart';

class ChannelException extends Error implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ChannelException");
      ...
      switch (field.id) {
        ...
        case PARAMETERMAP:
          if (field.type == TType.MAP) {
            {
              TMap _map650 = iprot.readMapBegin();
              this.parameterMap = new Map<String, String>();
              for (int _i651 = 0; _i651 < _map650.length; ++_i651) {
                String _key652;
                String _val653;
                _key652 = iprot.readString();
                _val653 = iprot.readString();
                this.parameterMap[_key652] = _val653;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(_PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (var elem655 in this.parameterMap.keys) {
          oprot.writeString(elem655);
          oprot.writeString(this.parameterMap[elem655]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ChannelException(");

    ret.write("code:");
    String code_name = ChannelErrorCode.VALUES_TO_NAMES[this.code];
    if (code_name != null) {
      ret.write(code_name);
      ret.write(" (");
    }
