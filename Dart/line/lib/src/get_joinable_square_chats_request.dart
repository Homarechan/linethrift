 ...
 *  @generated
 */
library line.src.get_joinable_square_chats_request;
...
class GetJoinableSquareChatsRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetJoinableSquareChatsRequest");
  static final TField _SQUARE_MID_FIELD_DESC = new TField("squareMid", TType.STRING, 1);
  static final TField _CONTINUATION_TOKEN_FIELD_DESC = new TField("continuationToken", TType.STRING, 10);
  static final TField _LIMIT_FIELD_DESC = new TField("limit", TType.I32, 11);

  String _squareMid;
  static const int SQUAREMID = 1;
  String _continuationToken;
  static const int CONTINUATIONTOKEN = 10;
  int _limit = 0;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetJoinableSquareChatsRequest(");
