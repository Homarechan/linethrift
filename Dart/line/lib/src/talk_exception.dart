...
class TalkException implements TBase, Exception  {
      ...
      switch (field.id) {
        ...
        case PARAMETERMAP:
          if (field.type == TType.MAP) {
            {
              TMap _map542 = iprot.readMapBegin();
              this.parameterMap = new Map<String, String>();
              for (int _i543 = 0; _i543 < _map542.length; ++_i543) {
                String _key544;
                String _val545;
                _key544 = iprot.readString();
                _val545 = iprot.readString();
                this.parameterMap[_key544] = _val545;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(_PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (var elem547 in this.parameterMap.keys) {
          oprot.writeString(elem547);
          oprot.writeString(this.parameterMap[elem547]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
