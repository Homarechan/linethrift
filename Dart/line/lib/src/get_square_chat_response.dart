 ...
 *  @generated
 */
library line.src.get_square_chat_response;
...
class GetSquareChatResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetSquareChatResponse");
  static final TField _SQUARE_CHAT_FIELD_DESC = new TField("squareChat", TType.STRUCT, 1);
  static final TField _SQUARE_CHAT_MEMBER_FIELD_DESC = new TField("squareChatMember", TType.STRUCT, 2);
  static final TField _SQUARE_CHAT_STATUS_FIELD_DESC = new TField("squareChatStatus", TType.STRUCT, 3);

  SquareChat _squareChat;
  static const int SQUARECHAT = 1;
  SquareChatMember _squareChatMember;
  static const int SQUARECHATMEMBER = 2;
  SquareChatStatus _squareChatStatus;
  static const int SQUARECHATSTATUS = 3;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetSquareChatResponse(");
