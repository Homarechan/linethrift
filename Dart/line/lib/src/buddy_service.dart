          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i767 = 0; _i767 < _list766.length; ++_i767) {
                BuddySearchResult _elem768;
                _elem768 = new BuddySearchResult();
                _elem768.read(iprot);
                this.success.add(_elem768);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem769 in this.success) {
          elem769.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem777 in this.success) {
      ...
      switch (field.id) {
        case SUCCESS:
          if (field.type == TType.MAP) {
            {
              TMap _map778 = iprot.readMapBegin();
              this.success = new Map<String, int>();
              for (int _i779 = 0; _i779 < _map778.length; ++_i779) {
                String _key780;
                int _val781;
                _key780 = iprot.readString();
                _val781 = iprot.readI64();
                this.success[_key780] = _val781;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem783 in this.success.keys) {
          oprot.writeString(elem783);
          oprot.writeI64(this.success[elem783]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class getPopularBuddyLists_result implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i785 = 0; _i785 < _list784.length; ++_i785) {
                BuddyList _elem786;
                _elem786 = new BuddyList();
                _elem786.read(iprot);
                this.success.add(_elem786);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for (var elem787 in this.success) {
          elem787.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class getPromotedBuddyContacts_result implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.success = new List<Contact>();
              for (int _i789 = 0; _i789 < _list788.length; ++_i789) {
                Contact _elem790;
                _elem790 = new Contact();
                _elem790.read(iprot);
                this.success.add(_elem790);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for (var elem791 in this.success) {
          elem791.write(oprot);
        }
        oprot.writeListEnd();
      }
