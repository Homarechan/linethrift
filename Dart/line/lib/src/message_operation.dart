 ...
 *  @generated
 */
library line.src.message_operation;
...
class MessageOperation implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("MessageOperation");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("MessageOperation(");
    ...
    ret.write(", ");
    ret.write("type:");
    String type_name = MessageOperationType.VALUES_TO_NAMES[this.type];
    if (type_name != null) {
      ret.write(type_name);
      ret.write(" (");
    }
