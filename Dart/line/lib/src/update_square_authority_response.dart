      ...
      switch (field.id) {
        case UPDATDATTRIBUTES:
          if (field.type == TType.SET) {
            {
              TSet _set606 = iprot.readSetBegin();
              this.updatdAttributes = new Set<int>();
              for (int _i607 = 0; _i607 < _set606.length; ++_i607) {
                int _elem608;
                _elem608 = iprot.readI32();
                this.updatdAttributes.add(_elem608);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatdAttributes != null) {
      oprot.writeFieldBegin(_UPDATD_ATTRIBUTES_FIELD_DESC);
      {
        ...
        for (var elem609 in this.updatdAttributes) {
          oprot.writeI32(elem609);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
