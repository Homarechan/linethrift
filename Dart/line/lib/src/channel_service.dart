          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i851 = 0; _i851 < _list850.length; ++_i851) {
                ChannelNotificationSetting _elem852;
                _elem852 = new ChannelNotificationSetting();
                _elem852.read(iprot);
                this.success.add(_elem852);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem853 in this.success) {
          elem853.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    while (true) {
      ...
      switch (field.id) {
        case CHANNELIDS:
          if (field.type == TType.LIST) {
            {
              TList _list854 = iprot.readListBegin();
              this.channelIds = new List<String>();
              for (int _i855 = 0; _i855 < _list854.length; ++_i855) {
                String _elem856;
                _elem856 = iprot.readString();
                this.channelIds.add(_elem856);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.channelIds != null) {
      oprot.writeFieldBegin(_CHANNEL_IDS_FIELD_DESC);
      {
        ...
        for (var elem857 in this.channelIds) {
          oprot.writeString(elem857);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i859 = 0; _i859 < _list858.length; ++_i859) {
                String _elem860;
                _elem860 = iprot.readString();
                this.authScheme.add(_elem860);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.authScheme != null) {
      oprot.writeFieldBegin(_AUTH_SCHEME_FIELD_DESC);
      {
        ...
        for (var elem861 in this.authScheme) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i863 = 0; _i863 < _list862.length; ++_i863) {
                ChannelIdWithLastUpdated _elem864;
                _elem864 = new ChannelIdWithLastUpdated();
                _elem864.read(iprot);
                this.channelIds.add(_elem864);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.channelIds != null) {
      oprot.writeFieldBegin(_CHANNEL_IDS_FIELD_DESC);
      {
        ...
        for (var elem865 in this.channelIds) {
          elem865.write(oprot);
        }
        oprot.writeListEnd();
      }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i867 = 0; _i867 < _list866.length; ++_i867) {
                String _elem868;
                _elem868 = iprot.readString();
                this.success.add(_elem868);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem869 in this.success) {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i871 = 0; _i871 < _list870.length; ++_i871) {
                ChannelNotificationSetting _elem872;
                _elem872 = new ChannelNotificationSetting();
                _elem872.read(iprot);
                this.setting.add(_elem872);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.setting != null) {
      oprot.writeFieldBegin(_SETTING_FIELD_DESC);
      {
        ...
        for (var elem873 in this.setting) {
          elem873.write(oprot);
        }
        oprot.writeListEnd();
      }
