 ...
 *  @generated
 */
library line.src.coin_history_result;
...
class CoinHistoryResult implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("CoinHistoryResult");
  static final TField _HISTORYS_FIELD_DESC = new TField("historys", TType.LIST, 1);
  static final TField _BALANCE_FIELD_DESC = new TField("balance", TType.STRUCT, 2);
  static final TField _HAS_NEXT_FIELD_DESC = new TField("hasNext", TType.BOOL, 3);

  List<CoinHistory> _historys;
  static const int HISTORYS = 1;
  Coin _balance;
  static const int BALANCE = 2;
  bool _hasNext = false;
  static const int HASNEXT = 3;
  ...
  // historys
  List<CoinHistory> get historys => this._historys;

  set historys(List<CoinHistory> historys) {
  ...
  // balance
  Coin get balance => this._balance;

  set balance(Coin balance) {
    this._balance = balance;
  }

  bool isSetBalance() => this.balance != null;
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i199 = 0; _i199 < _list198.length; ++_i199) {
                CoinHistory _elem200;
                _elem200 = new CoinHistory();
                _elem200.read(iprot);
                this.historys.add(_elem200);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.historys != null) {
      oprot.writeFieldBegin(_HISTORYS_FIELD_DESC);
      {
        ...
        for (var elem201 in this.historys) {
          elem201.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("CoinHistoryResult(");
