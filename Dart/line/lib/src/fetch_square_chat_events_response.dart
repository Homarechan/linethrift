 ...
 *  @generated
 */
library line.src.fetch_square_chat_events_response;

import 'dart:typed_data' show Uint8List;
import 'package:thrift/thrift.dart';
import 'package:line/line.dart';

class FetchSquareChatEventsResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("FetchSquareChatEventsResponse");
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i367 = 0; _i367 < _list366.length; ++_i367) {
                SquareEvent _elem368;
                _elem368 = new SquareEvent();
                _elem368.read(iprot);
                this.events.add(_elem368);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.events != null) {
      oprot.writeFieldBegin(_EVENTS_FIELD_DESC);
      {
        ...
        for (var elem369 in this.events) {
          elem369.write(oprot);
        }
        oprot.writeListEnd();
      }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("FetchSquareChatEventsResponse(");
