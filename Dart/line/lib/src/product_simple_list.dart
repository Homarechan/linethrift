          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i311 = 0; _i311 < _list310.length; ++_i311) {
                ProductSimple _elem312;
                _elem312 = new ProductSimple();
                _elem312.read(iprot);
                this.productList.add(_elem312);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.productList != null) {
      oprot.writeFieldBegin(_PRODUCT_LIST_FIELD_DESC);
      {
        ...
        for (var elem313 in this.productList) {
          elem313.write(oprot);
        }
        oprot.writeListEnd();
      }
