 ...
 *  @generated
 */
library line.src.join_square_response;
...
class JoinSquareResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("JoinSquareResponse");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("JoinSquareResponse(");
