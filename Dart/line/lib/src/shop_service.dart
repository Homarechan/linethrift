          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i883 = 0; _i883 < _list882.length; ++_i883) {
                CoinProductItem _elem884;
                _elem884 = new CoinProductItem();
                _elem884.read(iprot);
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i887 = 0; _i887 < _list886.length; ++_i887) {
                CoinProductItem _elem888;
                _elem888 = new CoinProductItem();
                _elem888.read(iprot);
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i891 = 0; _i891 < _list890.length; ++_i891) {
                ...
                this.productIdList.add(_elem892);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.productIdList != null) {
      oprot.writeFieldBegin(_PRODUCT_ID_LIST_FIELD_DESC);
      {
        ...
        for (var elem893 in this.productIdList) {
          oprot.writeString(elem893);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
...
class getProductListWithCarrier_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        case PRODUCTIDLIST:
          if (field.type == TType.LIST) {
            {
              TList _list894 = iprot.readListBegin();
              this.productIdList = new List<String>();
              for (int _i895 = 0; _i895 < _list894.length; ++_i895) {
                String _elem896;
                _elem896 = iprot.readString();
                this.productIdList.add(_elem896);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.productIdList != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.productIdList.length));
        for (var elem897 in this.productIdList) {
