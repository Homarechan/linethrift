          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i347 = 0; _i347 < _map346.length; ++_i347) {
                ...
                this.snsAccounts[_key348] = _val349;
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i351 = 0; _i351 < _map350.length; ++_i351) {
                int _key352;
                String _val353;
                _key352 = iprot.readI32();
                _val353 = iprot.readString();
                this.customModes[_key352] = _val353;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.snsAccounts != null) {
      oprot.writeFieldBegin(_SNS_ACCOUNTS_FIELD_DESC);
      {
        ...
        for (var elem355 in this.snsAccounts.keys) {
          oprot.writeI32(elem355);
          oprot.writeString(this.snsAccounts[elem355]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.customModes != null) {
      oprot.writeFieldBegin(_CUSTOM_MODES_FIELD_DESC);
      {
        ...
        for (var elem357 in this.customModes.keys) {
          oprot.writeI32(elem357);
          oprot.writeString(this.customModes[elem357]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
