          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i657 = 0; _i657 < _map656.length; ++_i657) {
                String _key658;
                String _val659;
                _key658 = iprot.readString();
                _val659 = iprot.readString();
                this.parameterMap[_key658] = _val659;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(_PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (var elem661 in this.parameterMap.keys) {
          oprot.writeString(elem661);
          oprot.writeString(this.parameterMap[elem661]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
