...
class Contact implements TBase {
  ...
  static final TField _STATUS_MESSAGE_CONTENT_METADATA_FIELD_DESC = new TField("statusMessageContentMetadata", TType.MAP, 43);
  ...
  Map<String, String> _statusMessageContentMetadata;
  static const int STATUSMESSAGECONTENTMETADATA = 43;
  ...
  Map<String, String> get statusMessageContentMetadata => this._statusMessageContentMetadata;

  set statusMessageContentMetadata(Map<String, String> statusMessageContentMetadata) {
    this._statusMessageContentMetadata = statusMessageContentMetadata;
  }

  bool isSetStatusMessageContentMetadata() => this.statusMessageContentMetadata != null;
  ...
  getFieldValue(int fieldID) {
    switch (fieldID) {
      ...
      case STATUSMESSAGECONTENTMETADATA:
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.statusMessageContentMetadata = new Map<String, String>();
              for (int _i143 = 0; _i143 < _map142.length; ++_i143) {
                String _key144;
                String _val145;
                _key144 = iprot.readString();
                _val145 = iprot.readString();
                this.statusMessageContentMetadata[_key144] = _val145;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.statusMessageContentMetadata != null) {
      oprot.writeFieldBegin(_STATUS_MESSAGE_CONTENT_METADATA_FIELD_DESC);
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.statusMessageContentMetadata.length));
        for (var elem147 in this.statusMessageContentMetadata.keys) {
          oprot.writeString(elem147);
          oprot.writeString(this.statusMessageContentMetadata[elem147]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
  ...
  String toString() {
    ...
    ret.write(", ");
    ret.write("statusMessageContentMetadata:");
    if (this.statusMessageContentMetadata == null) {
      ret.write("null");
    } else {
      ret.write(this.statusMessageContentMetadata);
    }
