      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set558 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i559 = 0; _i559 < _set558.length; ++_i559) {
                int _elem560;
                _elem560 = iprot.readI32();
                this.updatedAttrs.add(_elem560);
              }
              iprot.readSetEnd();
            }
          } else {
        ...
        case MEMBERS:
          if (field.type == TType.MAP) {
            {
              TMap _map561 = iprot.readMapBegin();
              this.members = new Map<String, SquareMember>();
              for (int _i562 = 0; _i562 < _map561.length; ++_i562) {
                String _key563;
                SquareMember _val564;
                _key563 = iprot.readString();
                _val564 = new SquareMember();
                _val564.read(iprot);
                this.members[_key563] = _val564;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem565 in this.updatedAttrs) {
          oprot.writeI32(elem565);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.members != null) {
      oprot.writeFieldBegin(_MEMBERS_FIELD_DESC);
      {
        ...
        for (var elem567 in this.members.keys) {
          oprot.writeString(elem567);
          this.members[elem567].write(oprot);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
