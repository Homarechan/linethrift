          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i335 = 0; _i335 < _list334.length; ++_i335) {
                SuggestTagDictionaryRevision _elem336;
                _elem336 = new SuggestTagDictionaryRevision();
                _elem336.read(iprot);
                this.tagRevisions.add(_elem336);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.tagRevisions != null) {
      oprot.writeFieldBegin(_TAG_REVISIONS_FIELD_DESC);
      {
        ...
        for (var elem337 in this.tagRevisions) {
          elem337.write(oprot);
        }
        oprot.writeListEnd();
      }
