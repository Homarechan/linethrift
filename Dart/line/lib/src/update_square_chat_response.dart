      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set594 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i595 = 0; _i595 < _set594.length; ++_i595) {
                int _elem596;
                _elem596 = iprot.readI32();
                this.updatedAttrs.add(_elem596);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem597 in this.updatedAttrs) {
          oprot.writeI32(elem597);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
