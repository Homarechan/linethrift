 ...
 *  @generated
 */
library line.src.get_joined_squares_request;
...
class GetJoinedSquaresRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetJoinedSquaresRequest");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetJoinedSquaresRequest(");
