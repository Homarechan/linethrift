      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set496 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i497 = 0; _i497 < _set496.length; ++_i497) {
                int _elem498;
                _elem498 = iprot.readI32();
                this.updatedAttrs.add(_elem498);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem499 in this.updatedAttrs) {
          oprot.writeI32(elem499);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
