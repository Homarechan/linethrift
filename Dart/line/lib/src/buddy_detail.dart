      ...
      switch (field.id) {
        ...
        case ACCEPTABLECONTENTTYPES:
          if (field.type == TType.SET) {
            {
              TSet _set138 = iprot.readSetBegin();
              this.acceptableContentTypes = new Set<int>();
              for (int _i139 = 0; _i139 < _set138.length; ++_i139) {
                int _elem140;
                _elem140 = iprot.readI32();
                this.acceptableContentTypes.add(_elem140);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.acceptableContentTypes != null) {
      oprot.writeFieldBegin(_ACCEPTABLE_CONTENT_TYPES_FIELD_DESC);
      {
        ...
        for (var elem141 in this.acceptableContentTypes) {
