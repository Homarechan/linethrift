 ...
 *  @generated
 */
library line.src.send_message_request;
...
class SendMessageRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("SendMessageRequest");
  ...
  static final TField _SQUARE_MESSAGE_FIELD_DESC = new TField("squareMessage", TType.STRUCT, 3);
  ...
  static const int SQUAREMESSAGE = 3;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("SendMessageRequest(");
