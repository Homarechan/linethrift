 ...
 *  @generated
 */
library line.src.send_buddy_message_result;
...
class SendBuddyMessageResult implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("SendBuddyMessageResult");
  ...
  static final TField _EVENT_NO_FIELD_DESC = new TField("eventNo", TType.I32, 4);
  ...
  static final TField _BLOCK_COUNT_FIELD_DESC = new TField("blockCount", TType.I64, 15);
  static final TField _UNREGISTER_COUNT_FIELD_DESC = new TField("unregisterCount", TType.I64, 16);
  ...
  int _blockCount = 0;
  static const int BLOCKCOUNT = 15;
  int _unregisterCount = 0;
  static const int UNREGISTERCOUNT = 16;
  int _timestamp = 0;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("SendBuddyMessageResult(");
