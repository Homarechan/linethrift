 ...
 *  @generated
 */
library line.src.update_square_chat_request;
...
class UpdateSquareChatRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("UpdateSquareChatRequest");
      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set494 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i495 = 0; _i495 < _set494.length; ++_i495) {
                int _elem496;
                _elem496 = iprot.readI32();
                this.updatedAttrs.add(_elem496);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem497 in this.updatedAttrs) {
          oprot.writeI32(elem497);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("UpdateSquareChatRequest(");
