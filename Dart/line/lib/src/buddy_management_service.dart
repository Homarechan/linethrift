          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i677 = 0; _i677 < _list676.length; ++_i677) {
                String _elem678;
                _elem678 = iprot.readString();
                this.userMids.add(_elem678);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.userMids != null) {
      oprot.writeFieldBegin(_USER_MIDS_FIELD_DESC);
      {
        ...
        for (var elem679 in this.userMids) {
          oprot.writeString(elem679);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i681 = 0; _i681 < _list680.length; ++_i681) {
                String _elem682;
                _elem682 = iprot.readString();
                this.requestIdList.add(_elem682);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.requestIdList != null) {
      oprot.writeFieldBegin(_REQUEST_ID_LIST_FIELD_DESC);
      {
        ...
        for (var elem683 in this.requestIdList) {
          oprot.writeString(elem683);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i685 = 0; _i685 < _list684.length; ++_i685) {
                SendBuddyMessageResult _elem686;
                _elem686 = new SendBuddyMessageResult();
                _elem686.read(iprot);
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem687 in this.success) {
          elem687.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class commitSendMessagesToMids_args implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i689 = 0; _i689 < _list688.length; ++_i689) {
                ...
                this.requestIdList.add(_elem690);
              }
              iprot.readListEnd();
            }
          } else {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i692 = 0; _i692 < _list691.length; ++_i692) {
                String _elem693;
                _elem693 = iprot.readString();
                this.mids.add(_elem693);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.requestIdList != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.requestIdList.length));
        for (var elem694 in this.requestIdList) {
          oprot.writeString(elem694);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.mids != null) {
      oprot.writeFieldBegin(_MIDS_FIELD_DESC);
      {
        ...
        for (var elem695 in this.mids) {
          oprot.writeString(elem695);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i697 = 0; _i697 < _list696.length; ++_i697) {
                SendBuddyMessageResult _elem698;
                _elem698 = new SendBuddyMessageResult();
                _elem698.read(iprot);
...
class getAllBuddyMembers_result implements TBase {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.success.length));
        for (var elem707 in this.success) {
      ...
      switch (field.id) {
        ...
        case SETTINGS:
          if (field.type == TType.MAP) {
            {
              TMap _map716 = iprot.readMapBegin();
              this.settings = new Map<String, String>();
              for (int _i717 = 0; _i717 < _map716.length; ++_i717) {
                String _key718;
                String _val719;
                _key718 = iprot.readString();
                _val719 = iprot.readString();
                this.settings[_key718] = _val719;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.settings != null) {
      oprot.writeFieldBegin(_SETTINGS_FIELD_DESC);
      {
        ...
        for (var elem721 in this.settings.keys) {
          oprot.writeString(elem721);
          oprot.writeString(this.settings[elem721]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class removeBuddyMembers_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case USERMIDS:
          if (field.type == TType.LIST) {
            {
              TList _list722 = iprot.readListBegin();
              this.userMids = new List<String>();
              for (int _i723 = 0; _i723 < _list722.length; ++_i723) {
                String _elem724;
                _elem724 = iprot.readString();
                this.userMids.add(_elem724);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.userMids != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.userMids.length));
        for (var elem725 in this.userMids) {
...
class sendBuddyContentMessageToMids_args implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.mids = new List<String>();
              for (int _i727 = 0; _i727 < _list726.length; ++_i727) {
                String _elem728;
                _elem728 = iprot.readString();
                this.mids.add(_elem728);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.mids != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.mids.length));
        for (var elem729 in this.mids) {
          oprot.writeString(elem729);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.mids = new List<String>();
              for (int _i731 = 0; _i731 < _list730.length; ++_i731) {
                String _elem732;
                _elem732 = iprot.readString();
                this.mids.add(_elem732);
              }
              iprot.readListEnd();
            }
          } else {
...
class sendBuddyMessageToMids_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case MIDS:
          if (field.type == TType.LIST) {
            {
              TList _list734 = iprot.readListBegin();
              this.mids = new List<String>();
              for (int _i735 = 0; _i735 < _list734.length; ++_i735) {
                String _elem736;
                _elem736 = iprot.readString();
                this.mids.add(_elem736);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.mids != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.mids.length));
        for (var elem737 in this.mids) {
          oprot.writeString(elem737);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.mids = new List<String>();
              for (int _i739 = 0; _i739 < _list738.length; ++_i739) {
                String _elem740;
                _elem740 = iprot.readString();
                this.mids.add(_elem740);
              }
              iprot.readListEnd();
            }
          } else {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case ATTRIBUTES:
          if (field.type == TType.MAP) {
            {
              TMap _map742 = iprot.readMapBegin();
              this.attributes = new Map<String, String>();
              for (int _i743 = 0; _i743 < _map742.length; ++_i743) {
                String _key744;
                String _val745;
                _key744 = iprot.readString();
                _val745 = iprot.readString();
                this.attributes[_key744] = _val745;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.attributes != null) {
      oprot.writeFieldBegin(_ATTRIBUTES_FIELD_DESC);
      {
        ...
        for (var elem747 in this.attributes.keys) {
          oprot.writeString(elem747);
          oprot.writeString(this.attributes[elem747]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class updateBuddyProfileAttributes_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case ATTRIBUTES:
          if (field.type == TType.MAP) {
            {
              TMap _map748 = iprot.readMapBegin();
              this.attributes = new Map<String, String>();
              for (int _i749 = 0; _i749 < _map748.length; ++_i749) {
                String _key750;
                String _val751;
                _key750 = iprot.readString();
                _val751 = iprot.readString();
                this.attributes[_key750] = _val751;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.attributes != null) {
      ...
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.attributes.length));
        for (var elem753 in this.attributes.keys) {
          oprot.writeString(elem753);
          oprot.writeString(this.attributes[elem753]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class updateBuddyProfileAttributesAsync_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        ...
        case ATTRIBUTES:
          if (field.type == TType.MAP) {
            {
              TMap _map754 = iprot.readMapBegin();
              this.attributes = new Map<String, String>();
              for (int _i755 = 0; _i755 < _map754.length; ++_i755) {
                String _key756;
                String _val757;
                _key756 = iprot.readString();
                _val757 = iprot.readString();
                this.attributes[_key756] = _val757;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.attributes != null) {
      ...
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.attributes.length));
        for (var elem759 in this.attributes.keys) {
          oprot.writeString(elem759);
          oprot.writeString(this.attributes[elem759]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class updateBuddySettings_args implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        case SETTINGS:
          if (field.type == TType.MAP) {
            {
              TMap _map760 = iprot.readMapBegin();
              this.settings = new Map<String, String>();
              for (int _i761 = 0; _i761 < _map760.length; ++_i761) {
                String _key762;
                String _val763;
                _key762 = iprot.readString();
                _val763 = iprot.readString();
                this.settings[_key762] = _val763;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.settings != null) {
      ...
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.settings.length));
        for (var elem765 in this.settings.keys) {
          oprot.writeString(elem765);
          oprot.writeString(this.settings[elem765]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
