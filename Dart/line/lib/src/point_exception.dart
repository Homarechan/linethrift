      ...
      switch (field.id) {
        ...
        case EXTRA:
          if (field.type == TType.MAP) {
            {
              TMap _map644 = iprot.readMapBegin();
              this.extra = new Map<String, String>();
              for (int _i645 = 0; _i645 < _map644.length; ++_i645) {
                String _key646;
                String _val647;
                _key646 = iprot.readString();
                _val647 = iprot.readString();
                this.extra[_key646] = _val647;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.extra != null) {
      oprot.writeFieldBegin(_EXTRA_FIELD_DESC);
      {
        ...
        for (var elem649 in this.extra.keys) {
          oprot.writeString(elem649);
          oprot.writeString(this.extra[elem649]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
