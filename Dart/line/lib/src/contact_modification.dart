  ...
  write(TProtocol oprot) {
    ...
    if (this.phones != null) {
      oprot.writeFieldBegin(_PHONES_FIELD_DESC);
      {
        ...
        for (var elem127 in this.phones) {
    ...
    if (this.emails != null) {
      oprot.writeFieldBegin(_EMAILS_FIELD_DESC);
      {
        ...
        for (var elem128 in this.emails) {
    ...
    if (this.userids != null) {
      oprot.writeFieldBegin(_USERIDS_FIELD_DESC);
      {
        ...
        for (var elem129 in this.userids) {
