          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i331 = 0; _i331 < _list330.length; ++_i331) {
                SuggestTagDictionaryIncrement _elem332;
                _elem332 = new SuggestTagDictionaryIncrement();
                _elem332.read(iprot);
                this.tagIncrements.add(_elem332);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.tagIncrements != null) {
      oprot.writeFieldBegin(_TAG_INCREMENTS_FIELD_DESC);
      {
        ...
        for (var elem333 in this.tagIncrements) {
          elem333.write(oprot);
        }
        oprot.writeListEnd();
      }
