 ...
 *  @generated
 */
library line.src.report_square_chat_request;
...
class ReportSquareChatRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("ReportSquareChatRequest");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("ReportSquareChatRequest(");
