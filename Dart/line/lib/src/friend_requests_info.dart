          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i135 = 0; _i135 < _list134.length; ++_i135) {
                FriendRequest _elem136;
                _elem136 = new FriendRequest();
                _elem136.read(iprot);
                this.recentIncomings.add(_elem136);
              }
              iprot.readListEnd();
            }
          } else {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i138 = 0; _i138 < _list137.length; ++_i138) {
                FriendRequest _elem139;
                _elem139 = new FriendRequest();
                _elem139.read(iprot);
                this.recentOutgoings.add(_elem139);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.recentIncomings != null) {
      oprot.writeFieldBegin(_RECENT_INCOMINGS_FIELD_DESC);
      {
        ...
        for (var elem140 in this.recentIncomings) {
          elem140.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.recentOutgoings != null) {
      oprot.writeFieldBegin(_RECENT_OUTGOINGS_FIELD_DESC);
      {
        ...
        for (var elem141 in this.recentOutgoings) {
          elem141.write(oprot);
        }
        oprot.writeListEnd();
      }
