 ...
 *  @generated
 */
library line.src.create_square_chat_response;
...
class CreateSquareChatResponse implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("CreateSquareChatResponse");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("CreateSquareChatResponse(");
