          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i297 = 0; _i297 < _list296.length; ++_i297) {
                SquareMember _elem298;
                _elem298 = new SquareMember();
                _elem298.read(iprot);
                this.approvedMembers.add(_elem298);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.approvedMembers != null) {
      oprot.writeFieldBegin(_APPROVED_MEMBERS_FIELD_DESC);
      {
        ...
        for (var elem299 in this.approvedMembers) {
          elem299.write(oprot);
        }
        oprot.writeListEnd();
      }
