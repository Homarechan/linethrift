      ...
      switch (field.id) {
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set550 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i551 = 0; _i551 < _set550.length; ++_i551) {
                int _elem552;
                _elem552 = iprot.readI32();
                this.updatedAttrs.add(_elem552);
              }
              iprot.readSetEnd();
            }
          } else {
        ...
        case MEMBERS:
          if (field.type == TType.LIST) {
            {
              TList _list553 = iprot.readListBegin();
              this.members = new List<SquareMember>();
              for (int _i554 = 0; _i554 < _list553.length; ++_i554) {
                SquareMember _elem555;
                _elem555 = new SquareMember();
                _elem555.read(iprot);
                this.members.add(_elem555);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem556 in this.updatedAttrs) {
          oprot.writeI32(elem556);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.members != null) {
      oprot.writeFieldBegin(_MEMBERS_FIELD_DESC);
      {
        ...
        for (var elem557 in this.members) {
          elem557.write(oprot);
        }
        oprot.writeListEnd();
      }
