          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i793 = 0; _i793 < _list792.length; ++_i793) {
                String _elem794;
                _elem794 = iprot.readString();
                this.success.add(_elem794);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem795 in this.success) {
          oprot.writeString(elem795);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i797 = 0; _i797 < _list796.length; ++_i797) {
                CompactContact _elem798;
                _elem798 = new CompactContact();
                _elem798.read(iprot);
                this.success.add(_elem798);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem799 in this.success) {
          elem799.write(oprot);
        }
        oprot.writeListEnd();
      }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i801 = 0; _i801 < _list800.length; ++_i801) {
                String _elem802;
                _elem802 = iprot.readString();
                this.ids.add(_elem802);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.ids != null) {
      oprot.writeFieldBegin(_IDS_FIELD_DESC);
      {
        ...
        for (var elem803 in this.ids) {
          oprot.writeString(elem803);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
...
class getContactsForChannel_result implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i805 = 0; _i805 < _list804.length; ++_i805) {
                Contact _elem806;
                _elem806 = new Contact();
                _elem806.read(iprot);
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for (var elem807 in this.success) {
          elem807.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class getFavoriteMidsForChannel_result implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              TList _list808 = iprot.readListBegin();
              this.success = new List<String>();
              for (int _i809 = 0; _i809 < _list808.length; ++_i809) {
                String _elem810;
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.success.length));
        for (var elem811 in this.success) {
          oprot.writeString(elem811);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
...
class getFriendMids_result implements TBase {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.success = new List<String>();
              for (int _i813 = 0; _i813 < _list812.length; ++_i813) {
                String _elem814;
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.success.length));
        for (var elem815 in this.success) {
          oprot.writeString(elem815);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
    ...
    while (true) {
      ...
      switch (field.id) {
        case GROUPIDS:
          if (field.type == TType.LIST) {
            {
              TList _list820 = iprot.readListBegin();
              this.groupIds = new List<String>();
              for (int _i821 = 0; _i821 < _list820.length; ++_i821) {
                String _elem822;
                _elem822 = iprot.readString();
                this.groupIds.add(_elem822);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.groupIds != null) {
      oprot.writeFieldBegin(_GROUP_IDS_FIELD_DESC);
      {
        ...
        for (var elem823 in this.groupIds) {
...
class getJoinedGroupIdsForChannel_result implements TBase {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.success.length));
        for (var elem831 in this.success) {
...
class getSimpleChannelContacts_result implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              TList _list836 = iprot.readListBegin();
              this.success = new List<SimpleChannelContact>();
              for (int _i837 = 0; _i837 < _list836.length; ++_i837) {
                SimpleChannelContact _elem838;
                _elem838 = new SimpleChannelContact();
                _elem838.read(iprot);
                this.success.add(_elem838);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for (var elem839 in this.success) {
          elem839.write(oprot);
        }
        oprot.writeListEnd();
      }
      ...
      switch (field.id) {
        case SUCCESS:
          if (field.type == TType.MAP) {
            {
              TMap _map840 = iprot.readMapBegin();
              this.success = new Map<int, String>();
              for (int _i841 = 0; _i841 < _map840.length; ++_i841) {
                int _key842;
                String _val843;
                _key842 = iprot.readI32();
                _val843 = iprot.readString();
                this.success[_key842] = _val843;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(_SUCCESS_FIELD_DESC);
      {
        ...
        for (var elem845 in this.success.keys) {
          oprot.writeI32(elem845);
          oprot.writeString(this.success[elem845]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
...
class getUserMidsWhoAddedMe_result implements TBase {
    ...
    while (true) {
      ...
      switch (field.id) {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              TList _list846 = iprot.readListBegin();
              this.success = new List<String>();
              for (int _i847 = 0; _i847 < _list846.length; ++_i847) {
                String _elem848;
                _elem848 = iprot.readString();
                this.success.add(_elem848);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.success.length));
        for (var elem849 in this.success) {
