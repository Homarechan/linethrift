 ...
 *  @generated
 */
library line.src.suggest_tag_dictionary_increment;
...
class SuggestTagDictionaryIncrement implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("SuggestTagDictionaryIncrement");
  ...
  static final TField _SCHEME_FIELD_DESC = new TField("scheme", TType.STRING, 4);
  static final TField _DATA_FIELD_DESC = new TField("data", TType.STRING, 5);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("SuggestTagDictionaryIncrement(");
