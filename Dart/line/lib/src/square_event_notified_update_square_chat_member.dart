 ...
 *  @generated
 */
library line.src.square_event_notified_update_square_chat_member;
...
class SquareEventNotifiedUpdateSquareChatMember implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("SquareEventNotifiedUpdateSquareChatMember");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("SquareEventNotifiedUpdateSquareChatMember(");
