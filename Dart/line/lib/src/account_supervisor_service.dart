      ...
      switch (field.id) {
        case PARAMETERMAP:
          if (field.type == TType.MAP) {
            {
              TMap _map670 = iprot.readMapBegin();
              this.parameterMap = new Map<String, String>();
              for (int _i671 = 0; _i671 < _map670.length; ++_i671) {
                String _key672;
                String _val673;
                _key672 = iprot.readString();
                _val673 = iprot.readString();
                this.parameterMap[_key672] = _val673;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(_PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (var elem675 in this.parameterMap.keys) {
          oprot.writeString(elem675);
          oprot.writeString(this.parameterMap[elem675]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
