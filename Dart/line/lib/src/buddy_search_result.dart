...
class BuddySearchResult implements TBase {
  ...
  static final TField _ICON_TYPE_FIELD_DESC = new TField("iconType", TType.I32, 7);
  static final TField _BOT_TYPE_FIELD_DESC = new TField("botType", TType.I32, 8);
  ...
  int _iconType = 0;
  static const int ICONTYPE = 7;
  int _botType;
  static const int BOTTYPE = 8;

  bool __isset_businessAccount = false;
  bool __isset_iconType = false;
  bool __isset_botType = false;
  ...
  // iconType
  int get iconType => this._iconType;

  set iconType(int iconType) {
    this._iconType = iconType;
    this.__isset_iconType = true;
  }

  bool isSetIconType() => this.__isset_iconType;
  ...
  // botType
  int get botType => this._botType;

  set botType(int botType) {
    this._botType = botType;
    this.__isset_botType = true;
  }

  bool isSetBotType() => this.__isset_botType;
  ...
  write(TProtocol oprot) {
    ...
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_ICON_TYPE_FIELD_DESC);
    oprot.writeI32(this.iconType);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(_BOT_TYPE_FIELD_DESC);
  ...
  String toString() {
    ...
    ret.write(", ");
    ret.write("iconType:");
    ret.write(this.iconType);

    ret.write(", ");
    ret.write("botType:");
    String botType_name = BotType.VALUES_TO_NAMES[this.botType];
    if (botType_name != null) {
      ret.write(botType_name);
      ret.write(" (");
    }
    ret.write(this.botType);
    if (botType_name != null) {
      ret.write(")");
    }
  ...
  validate() {
    ...
    if (isSetBotType() && !BotType.VALID_VALUES.contains(botType)) {
      throw new TProtocolError(TProtocolErrorType.UNKNOWN, "The field 'botType' has been assigned the invalid value $botType");
    }
  }
