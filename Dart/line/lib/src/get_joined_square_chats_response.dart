          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i623 = 0; _i623 < _list622.length; ++_i623) {
                SquareChat _elem624;
                _elem624 = new SquareChat();
                _elem624.read(iprot);
                this.chats.add(_elem624);
              }
              iprot.readListEnd();
            }
          } else {
          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i626 = 0; _i626 < _map625.length; ++_i626) {
                String _key627;
                SquareChatMember _val628;
                _key627 = iprot.readString();
                _val628 = new SquareChatMember();
                _val628.read(iprot);
                this.chatMembers[_key627] = _val628;
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i630 = 0; _i630 < _map629.length; ++_i630) {
                String _key631;
                SquareChatStatus _val632;
                _key631 = iprot.readString();
                _val632 = new SquareChatStatus();
                _val632.read(iprot);
                this.statuses[_key631] = _val632;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.chatMembers != null) {
      oprot.writeFieldBegin(_CHAT_MEMBERS_FIELD_DESC);
      {
        ...
        for (var elem635 in this.chatMembers.keys) {
          oprot.writeString(elem635);
          this.chatMembers[elem635].write(oprot);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.statuses != null) {
      oprot.writeFieldBegin(_STATUSES_FIELD_DESC);
      {
        ...
        for (var elem637 in this.statuses.keys) {
          oprot.writeString(elem637);
          this.statuses[elem637].write(oprot);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
