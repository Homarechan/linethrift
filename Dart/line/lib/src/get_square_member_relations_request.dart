 ...
 *  @generated
 */
library line.src.get_square_member_relations_request;
...
class GetSquareMemberRelationsRequest implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("GetSquareMemberRelationsRequest");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("GetSquareMemberRelationsRequest(");
