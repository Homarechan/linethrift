...
class Message implements TBase {
  ...
  static final TField _DISPLAY_NAME_FIELD_DESC = new TField("displayName", TType.STRING, 99);
  static final TField _PICTURE_PATH_FIELD_DESC = new TField("picturePath", TType.STRING, 98);
  static final TField _TYPE_FIELD_DESC = new TField("type", TType.STRING, 97);
  static final TField _PERSON_FIELD_DESC = new TField("person", TType.STRING, 96);
  static final TField _PERSON2_FIELD_DESC = new TField("person2", TType.STRING, 95);
  static final TField _PERSON_NAME_FIELD_DESC = new TField("personName", TType.STRING, 94);
  static final TField _PERSON_NAME2_FIELD_DESC = new TField("personName2", TType.STRING, 93);
  ...
  static final TField _READ_COUNT_FIELD_DESC = new TField("readCount", TType.I32, 23);
  ...
  String _displayName;
  static const int DISPLAYNAME = 99;
  String _picturePath;
  static const int PICTUREPATH = 98;
  String _type;
  static const int TYPE = 97;
  String _person;
  static const int PERSON = 96;
  String _person2;
  static const int PERSON2 = 95;
  String _personName;
  static const int PERSONNAME = 94;
  String _personName2;
  static const int PERSONNAME2 = 93;
  String _to;
  ...
  // person
  String get person => this._person;

  set person(String person) {
    this._person = person;
  }

  bool isSetPerson() => this.person != null;
  ...
  // person2
  String get person2 => this._person2;

  set person2(String person2) {
    this._person2 = person2;
  }

  bool isSetPerson2() => this.person2 != null;
  ...
  // personName2
  String get personName2 => this._personName2;

  set personName2(String personName2) {
    this._personName2 = personName2;
  }

  bool isSetPersonName2() => this.personName2 != null;
          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i259 = 0; _i259 < _map258.length; ++_i259) {
                String _key260;
                String _val261;
                _key260 = iprot.readString();
                _val261 = iprot.readString();
                this.contentMetadata[_key260] = _val261;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.contentMetadata != null) {
      oprot.writeFieldBegin(_CONTENT_METADATA_FIELD_DESC);
      {
        ...
        for (var elem266 in this.contentMetadata.keys) {
          oprot.writeString(elem266);
          oprot.writeString(this.contentMetadata[elem266]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.chunks != null) {
      oprot.writeFieldBegin(_CHUNKS_FIELD_DESC);
      {
        ...
        for (var elem267 in this.chunks) {
          oprot.writeBinary(elem267);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.personName2 != null) {
      oprot.writeFieldBegin(_PERSON_NAME2_FIELD_DESC);
    ...
    if (this.person2 != null) {
      oprot.writeFieldBegin(_PERSON2_FIELD_DESC);
      oprot.writeString(this.person2);
      oprot.writeFieldEnd();
    }
    if (this.person != null) {
      oprot.writeFieldBegin(_PERSON_FIELD_DESC);
  ...
  String toString() {
    ...
    ret.write(", ");
    ret.write("personName2:");
    if (this.personName2 == null) {
      ret.write("null");
    } else {
      ret.write(this.personName2);
    }
