          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i289 = 0; _i289 < _list288.length; ++_i289) {
                SyncParamContact _elem290;
                _elem290 = new SyncParamContact();
                _elem290.read(iprot);
                this.syncParamContact.add(_elem290);
              }
              iprot.readListEnd();
            }
          } else {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i292 = 0; _i292 < _list291.length; ++_i292) {
                SyncParamMid _elem293;
                _elem293 = new SyncParamMid();
                _elem293.read(iprot);
                this.syncParamMid.add(_elem293);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.syncParamContact != null) {
      oprot.writeFieldBegin(_SYNC_PARAM_CONTACT_FIELD_DESC);
      {
        ...
        for (var elem294 in this.syncParamContact) {
          elem294.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.syncParamMid != null) {
      oprot.writeFieldBegin(_SYNC_PARAM_MID_FIELD_DESC);
      {
        ...
        for (var elem295 in this.syncParamMid) {
          elem295.write(oprot);
        }
        oprot.writeListEnd();
      }
