          ...
          if (field.type == TType.MAP) {
            {
              ...
              for (int _i277 = 0; _i277 < _map276.length; ++_i277) {
                int _key278;
                String _val279;
                _key278 = iprot.readI32();
                _val279 = iprot.readString();
                this.identities[_key278] = _val279;
              }
              iprot.readMapEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.identities != null) {
      oprot.writeFieldBegin(_IDENTITIES_FIELD_DESC);
      {
        ...
        for (var elem281 in this.identities.keys) {
          oprot.writeI32(elem281);
          oprot.writeString(this.identities[elem281]);
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
