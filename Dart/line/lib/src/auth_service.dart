...
abstract class AuthService {
  ...
  Future<IdentityCredentialResponse> updatePassword(String authSessionId, IdentityCredentialRequest request);

  Future<RSAKey> getAuthRSAKey(String authSessionId, int identityProvider);

  Future<String> openAuthSession(AuthSessionRequest request);
...
class AuthServiceClient implements AuthService {
  ...
  Future<IdentityCredentialResponse> updatePassword(String authSessionId, IdentityCredentialRequest request) async {
    oprot.writeMessageBegin(new TMessage("updatePassword", TMessageType.CALL, nextSeqid()));
    ...
    throw new TApplicationError(TApplicationErrorType.MISSING_RESULT, "updatePassword failed: unknown result");
  }

  Future<RSAKey> getAuthRSAKey(String authSessionId, int identityProvider) async {
    oprot.writeMessageBegin(new TMessage("getAuthRSAKey", TMessageType.CALL, nextSeqid()));
    ...
    throw new TApplicationError(TApplicationErrorType.MISSING_RESULT, "getAuthRSAKey failed: unknown result");
  }

  Future<String> openAuthSession(AuthSessionRequest request) async {
    oprot.writeMessageBegin(new TMessage("openAuthSession", TMessageType.CALL, nextSeqid()));
    ...
    throw new TApplicationError(TApplicationErrorType.MISSING_RESULT, "openAuthSession failed: unknown result");
  }
...
class AuthServiceProcessor implements TProcessor {
  AuthServiceProcessor(AuthService iface) {
    iface_ = iface;
    PROCESS_MAP["updatePassword"] = updatePassword;
    PROCESS_MAP["getAuthRSAKey"] = getAuthRSAKey;
    PROCESS_MAP["openAuthSession"] = openAuthSession;
  ...
  updatePassword(int seqid, TProtocol iprot, TProtocol oprot) async {
    updatePassword_args args = new updatePassword_args();
    args.read(iprot);
    iprot.readMessageEnd();
    updatePassword_result result = new updatePassword_result();
    try {
      result.success = await iface_.updatePassword(args.authSessionId, args.request);
    } on TalkException catch(e) {
      result.e = e;
    } catch (th) {
      // Internal error
      TApplicationError x = new TApplicationError(TApplicationErrorType.INTERNAL_ERROR, "Internal error processing updatePassword");
  ...
  getAuthRSAKey(int seqid, TProtocol iprot, TProtocol oprot) async {
    getAuthRSAKey_args args = new getAuthRSAKey_args();
    args.read(iprot);
    iprot.readMessageEnd();
    getAuthRSAKey_result result = new getAuthRSAKey_result();
    try {
      result.success = await iface_.getAuthRSAKey(args.authSessionId, args.identityProvider);
    } on TalkException catch(e) {
      result.e = e;
    } catch (th) {
      // Internal error
      TApplicationError x = new TApplicationError(TApplicationErrorType.INTERNAL_ERROR, "Internal error processing getAuthRSAKey");
  ...
  openAuthSession(int seqid, TProtocol iprot, TProtocol oprot) async {
    openAuthSession_args args = new openAuthSession_args();
    args.read(iprot);
    iprot.readMessageEnd();
    openAuthSession_result result = new openAuthSession_result();
    try {
      result.success = await iface_.openAuthSession(args.request);
    } on TalkException catch(e) {
      result.e = e;
    } catch (th) {
      // Internal error
      TApplicationError x = new TApplicationError(TApplicationErrorType.INTERNAL_ERROR, "Internal error processing openAuthSession");
...
class updatePassword_args implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("updatePassword_args");
  static final TField _AUTH_SESSION_ID_FIELD_DESC = new TField("authSessionId", TType.STRING, 2);
  static final TField _REQUEST_FIELD_DESC = new TField("request", TType.STRUCT, 3);

  String _authSessionId;
  static const int AUTHSESSIONID = 2;
  IdentityCredentialRequest _request;
  ...
  // authSessionId
  String get authSessionId => this._authSessionId;

  set authSessionId(String authSessionId) {
    this._authSessionId = authSessionId;
  }

  bool isSetAuthSessionId() => this.authSessionId != null;
  ...
  // request
  IdentityCredentialRequest get request => this._request;

  set request(IdentityCredentialRequest request) {
  ...
  write(TProtocol oprot) {
    ...
    if (this.authSessionId != null) {
      oprot.writeFieldBegin(_AUTH_SESSION_ID_FIELD_DESC);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("updatePassword_args(");

    ret.write("authSessionId:");
    if (this.authSessionId == null) {
      ret.write("null");
    } else {
      ret.write(this.authSessionId);
    }
...
class updatePassword_result implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("updatePassword_result");
  ...
  IdentityCredentialResponse _success;
  ...
  // success
  IdentityCredentialResponse get success => this._success;

  set success(IdentityCredentialResponse success) {
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("updatePassword_result(");
...
class getAuthRSAKey_args implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("getAuthRSAKey_args");
  static final TField _AUTH_SESSION_ID_FIELD_DESC = new TField("authSessionId", TType.STRING, 2);
  static final TField _IDENTITY_PROVIDER_FIELD_DESC = new TField("identityProvider", TType.I32, 3);

  String _authSessionId;
  static const int AUTHSESSIONID = 2;
  int _identityProvider;
  static const int IDENTITYPROVIDER = 3;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("getAuthRSAKey_args(");
...
class getAuthRSAKey_result implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("getAuthRSAKey_result");
  static final TField _SUCCESS_FIELD_DESC = new TField("success", TType.STRUCT, 0);
  static final TField _E_FIELD_DESC = new TField("e", TType.STRUCT, 1);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("getAuthRSAKey_result(");
...
class openAuthSession_args implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("openAuthSession_args");
  static final TField _REQUEST_FIELD_DESC = new TField("request", TType.STRUCT, 2);

  AuthSessionRequest _request;
  ...
  // request
  AuthSessionRequest get request => this._request;

  set request(AuthSessionRequest request) {
    this._request = request;
  }
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("openAuthSession_args(");
...
class openAuthSession_result implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("openAuthSession_result");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("openAuthSession_result(");
