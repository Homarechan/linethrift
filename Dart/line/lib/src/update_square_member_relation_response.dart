      ...
      switch (field.id) {
        ...
        case UPDATEDATTRS:
          if (field.type == TType.SET) {
            {
              TSet _set518 = iprot.readSetBegin();
              this.updatedAttrs = new Set<int>();
              for (int _i519 = 0; _i519 < _set518.length; ++_i519) {
                int _elem520;
                _elem520 = iprot.readI32();
                this.updatedAttrs.add(_elem520);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updatedAttrs != null) {
      oprot.writeFieldBegin(_UPDATED_ATTRS_FIELD_DESC);
      {
        ...
        for (var elem521 in this.updatedAttrs) {
          oprot.writeI32(elem521);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
