      ...
      switch (field.id) {
        case UPDATEATTRIBUTES:
          if (field.type == TType.SET) {
            {
              TSet _set530 = iprot.readSetBegin();
              this.updateAttributes = new Set<int>();
              for (int _i531 = 0; _i531 < _set530.length; ++_i531) {
                int _elem532;
                _elem532 = iprot.readI32();
                this.updateAttributes.add(_elem532);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.updateAttributes != null) {
      oprot.writeFieldBegin(_UPDATE_ATTRIBUTES_FIELD_DESC);
      {
        ...
        for (var elem533 in this.updateAttributes) {
          oprot.writeI32(elem533);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
