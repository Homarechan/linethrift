          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i523 = 0; _i523 < _list522.length; ++_i523) {
                SquareChatAnnouncement _elem524;
                _elem524 = new SquareChatAnnouncement();
                _elem524.read(iprot);
                this.announcements.add(_elem524);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.announcements != null) {
      oprot.writeFieldBegin(_ANNOUNCEMENTS_FIELD_DESC);
      {
        ...
        for (var elem525 in this.announcements) {
          elem525.write(oprot);
        }
        oprot.writeListEnd();
      }
