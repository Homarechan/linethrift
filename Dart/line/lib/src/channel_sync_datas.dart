          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i179 = 0; _i179 < _list178.length; ++_i179) {
                ChannelInfo _elem180;
                _elem180 = new ChannelInfo();
                _elem180.read(iprot);
                this.channelInfos.add(_elem180);
              }
              iprot.readListEnd();
            }
          } else {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              for (int _i182 = 0; _i182 < _list181.length; ++_i182) {
                ChannelDomain _elem183;
                _elem183 = new ChannelDomain();
                _elem183.read(iprot);
                this.channelDomains.add(_elem183);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  write(TProtocol oprot) {
    ...
    if (this.channelInfos != null) {
      oprot.writeFieldBegin(_CHANNEL_INFOS_FIELD_DESC);
      {
        ...
        for (var elem184 in this.channelInfos) {
          elem184.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.channelDomains != null) {
      oprot.writeFieldBegin(_CHANNEL_DOMAINS_FIELD_DESC);
      {
        ...
        for (var elem185 in this.channelDomains) {
          elem185.write(oprot);
        }
        oprot.writeListEnd();
      }
