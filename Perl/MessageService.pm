                      ...
                      /^2$/ && do{                      if ($ftype == Thrift::TType::LIST) {
                        {
                          ...
                          for (my $_i1466 = 0; $_i1466 < $_size1462; ++$_i1466)
                          {
                            my $elem1467 = undef;
                            $xfer += $input->readString(\$elem1467);
                            push(@{$self->{chatIds}},$elem1467);
                          }
...
sub write {
                  ...
                  if (defined $self->{chatIds}) {
                    $xfer += $output->writeFieldBegin('chatIds', Thrift::TType::LIST, 2);
                    {
                      ...
                      {
                        foreach my $iter1468 (@{$self->{chatIds}}) 
                        {
                      ...
                      /^0$/ && do{                      if ($ftype == Thrift::TType::LIST) {
                        {
                          ...
                          for (my $_i1473 = 0; $_i1473 < $_size1469; ++$_i1473)
                          {
                            my $elem1474 = undef;
                            $elem1474 = LastReadMessageIds->new();
                            $xfer += $elem1474->read($input);
                            push(@{$self->{success}},$elem1474);
                          }
                          $xfer += $input->readListEnd();
                        }
                      } else {
...
sub write {
                  ...
                  if (defined $self->{success}) {
                    $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                    {
                      ...
                      {
                        foreach my $iter1475 (@{$self->{success}}) 
                        {
