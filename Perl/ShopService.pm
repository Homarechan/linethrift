                        ...
                        /^0$/ && do{                        if ($ftype == Thrift::TType::LIST) {
                          {
                            ...
                            for (my $_i1480 = 0; $_i1480 < $_size1476; ++$_i1480)
                            {
                              my $elem1481 = undef;
                              $elem1481 = CoinProductItem->new();
                              $xfer += $elem1481->read($input);
                              push(@{$self->{success}},$elem1481);
                            }
...
sub write {
                    ...
                    if (defined $self->{success}) {
                      $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                      {
                        ...
                        {
                          foreach my $iter1482 (@{$self->{success}}) 
                          {
                        ...
                        /^0$/ && do{                        if ($ftype == Thrift::TType::LIST) {
                          {
                            ...
                            for (my $_i1487 = 0; $_i1487 < $_size1483; ++$_i1487)
                            {
                              my $elem1488 = undef;
                              $elem1488 = CoinProductItem->new();
                              $xfer += $elem1488->read($input);
                              push(@{$self->{success}},$elem1488);
                            }
                            $xfer += $input->readListEnd();
                          }
                        } else {
...
sub write {
                    ...
                    if (defined $self->{success}) {
                      $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                      {
                        $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
                        {
                          foreach my $iter1489 (@{$self->{success}}) 
                          {
                        ...
                        /^2$/ && do{                        if ($ftype == Thrift::TType::LIST) {
                          {
                            ...
                            for (my $_i1494 = 0; $_i1494 < $_size1490; ++$_i1494)
                            {
                              my $elem1495 = undef;
                              $xfer += $input->readString(\$elem1495);
                              push(@{$self->{productIdList}},$elem1495);
                            }
                            $xfer += $input->readListEnd();
                          }
                        } else {
...
sub write {
                    ...
                    if (defined $self->{productIdList}) {
                      $xfer += $output->writeFieldBegin('productIdList', Thrift::TType::LIST, 2);
                      {
                        ...
                        {
                          foreach my $iter1496 (@{$self->{productIdList}}) 
                          {
                        ...
                        /^2$/ && do{                        if ($ftype == Thrift::TType::LIST) {
                          {
                            ...
                            for (my $_i1501 = 0; $_i1501 < $_size1497; ++$_i1501)
                            {
                              my $elem1502 = undef;
                              $xfer += $input->readString(\$elem1502);
                              push(@{$self->{productIdList}},$elem1502);
                            }
                            $xfer += $input->readListEnd();
                          }
                        } else {
...
sub write {
                    ...
                    if (defined $self->{productIdList}) {
                      $xfer += $output->writeFieldBegin('productIdList', Thrift::TType::LIST, 2);
                      {
                        $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{productIdList}}));
                        {
                          foreach my $iter1503 (@{$self->{productIdList}}) 
                          {
...
sub send_buyCoinProduct{
  ...
  my $paymentReservation = shift;
                    ...
                    my $args = new ShopService_buyCoinProduct_args();
...
sub recv_buyCoinProduct{
  my $self = shift;
                    ...
                    my $result = new ShopService_buyCoinProduct_result();
...
sub send_buyFreeProduct{
  ...
  my $packageId = shift;
                    ...
                    my $args = new ShopService_buyFreeProduct_args();
...
sub recv_buyFreeProduct{
  my $self = shift;
                    ...
                    my $result = new ShopService_buyFreeProduct_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_buyMustbuyProduct{
  ...
  my $serialNumber = shift;
                    ...
                    my $args = new ShopService_buyMustbuyProduct_args();
                    $args->{receiverMid} = $receiverMid;
                    $args->{productId} = $productId;
                    $args->{messageTemplate} = $messageTemplate;
                    $args->{language} = $language;
...
sub recv_buyMustbuyProduct{
  my $self = shift;
                    ...
                    my $result = new ShopService_buyMustbuyProduct_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_checkCanReceivePresent{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_checkCanReceivePresent_args();
...
sub recv_checkCanReceivePresent{
  my $self = shift;
                    ...
                    my $result = new ShopService_checkCanReceivePresent_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getActivePurchases{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getActivePurchases_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getActivePurchases{
  my $self = shift;
                    ...
                    my $result = new ShopService_getActivePurchases_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getActivePurchaseVersions{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getActivePurchaseVersions_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getActivePurchaseVersions{
  my $self = shift;
                    ...
                    my $result = new ShopService_getActivePurchaseVersions_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getCoinProducts{
  ...
  my $language = shift;
                    ...
                    my $args = new ShopService_getCoinProducts_args();
...
sub recv_getCoinProducts{
  my $self = shift;
                    ...
                    my $result = new ShopService_getCoinProducts_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getCoinProductsByPgCode{
  ...
  my $language = shift;
                    ...
                    my $args = new ShopService_getCoinProductsByPgCode_args();
                    $args->{appStoreCode} = $appStoreCode;
                    $args->{pgCode} = $pgCode;
                    $args->{country} = $country;
                    $args->{language} = $language;
...
sub recv_getCoinProductsByPgCode{
  my $self = shift;
                    ...
                    my $result = new ShopService_getCoinProductsByPgCode_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getCoinPurchaseHistory{
  ...
  my $request = shift;
                    ...
                    my $args = new ShopService_getCoinPurchaseHistory_args();
...
sub recv_getCoinPurchaseHistory{
  my $self = shift;
                    ...
                    my $result = new ShopService_getCoinPurchaseHistory_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getCoinUseAndRefundHistory{
  ...
  my $request = shift;
                    ...
                    my $args = new ShopService_getCoinUseAndRefundHistory_args();
                    $args->{request} = $request;
                    $args->write($self->{output});
                    $self->{output}->writeMessageEnd();
                    $self->{output}->getTransport()->flush();
...
sub recv_getCoinUseAndRefundHistory{
  my $self = shift;
                    ...
                    my $result = new ShopService_getCoinUseAndRefundHistory_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getDownloads{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getDownloads_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getDownloads{
  my $self = shift;
                    ...
                    my $result = new ShopService_getDownloads_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getEventPackages{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getEventPackages_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getEventPackages{
  my $self = shift;
                    ...
                    my $result = new ShopService_getEventPackages_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getNewlyReleasedPackages{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getNewlyReleasedPackages_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getNewlyReleasedPackages{
  my $self = shift;
                    ...
                    my $result = new ShopService_getNewlyReleasedPackages_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getPopularPackages{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getPopularPackages_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getPopularPackages{
  my $self = shift;
                    ...
                    my $result = new ShopService_getPopularPackages_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getPresentsReceived{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getPresentsReceived_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getPresentsReceived{
  my $self = shift;
                    ...
                    my $result = new ShopService_getPresentsReceived_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getPresentsSent{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getPresentsSent_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getPresentsSent{
  my $self = shift;
                    ...
                    my $result = new ShopService_getPresentsSent_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getProduct{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getProduct_args();
                    $args->{packageID} = $packageID;
                    $args->{language} = $language;
                    $args->{country} = $country;
                    $args->write($self->{output});
...
sub recv_getProduct{
  my $self = shift;
                    ...
                    my $result = new ShopService_getProduct_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getProductList{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getProductList_args();
...
sub recv_getProductList{
  my $self = shift;
                    ...
                    my $result = new ShopService_getProductList_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getProductListWithCarrier{
  ...
  my $carrierCode = shift;
                    ...
                    my $args = new ShopService_getProductListWithCarrier_args();
                    $args->{productIdList} = $productIdList;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getProductListWithCarrier{
  my $self = shift;
                    ...
                    my $result = new ShopService_getProductListWithCarrier_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getProductWithCarrier{
  ...
  my $carrierCode = shift;
                    ...
                    my $args = new ShopService_getProductWithCarrier_args();
                    $args->{packageID} = $packageID;
                    $args->{language} = $language;
                    $args->{country} = $country;
                    $args->{carrierCode} = $carrierCode;
...
sub recv_getProductWithCarrier{
  my $self = shift;
                    ...
                    my $result = new ShopService_getProductWithCarrier_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getPurchaseHistory{
  ...
  my $country = shift;
                    ...
                    my $args = new ShopService_getPurchaseHistory_args();
                    $args->{start} = $start;
                    $args->{size} = $size;
                    $args->{language} = $language;
                    $args->{country} = $country;
...
sub recv_getPurchaseHistory{
  my $self = shift;
                    ...
                    my $result = new ShopService_getPurchaseHistory_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_getTotalBalance{
  ...
  my $appStoreCode = shift;
                    ...
                    my $args = new ShopService_getTotalBalance_args();
                    $args->{appStoreCode} = $appStoreCode;
                    $args->write($self->{output});
                    $self->{output}->writeMessageEnd();
                    $self->{output}->getTransport()->flush();
...
sub recv_getTotalBalance{
  my $self = shift;
                    ...
                    my $result = new ShopService_getTotalBalance_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_notifyDownloaded{
  ...
  my $language = shift;
                    ...
                    my $args = new ShopService_notifyDownloaded_args();
                    $args->{packageId} = $packageId;
                    $args->{language} = $language;
                    $args->write($self->{output});
                    $self->{output}->writeMessageEnd();
...
sub recv_notifyDownloaded{
  my $self = shift;
                    ...
                    my $result = new ShopService_notifyDownloaded_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_reserveCoinPurchase{
  ...
  my $request = shift;
                    ...
                    my $args = new ShopService_reserveCoinPurchase_args();
                    $args->{request} = $request;
                    $args->write($self->{output});
                    $self->{output}->writeMessageEnd();
                    $self->{output}->getTransport()->flush();
...
sub recv_reserveCoinPurchase{
  my $self = shift;
                    ...
                    my $result = new ShopService_reserveCoinPurchase_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
...
sub send_reservePayment{
  ...
  my $paymentReservation = shift;
                    ...
                    my $args = new ShopService_reservePayment_args();
                    $args->{paymentReservation} = $paymentReservation;
                    $args->write($self->{output});
                    $self->{output}->writeMessageEnd();
                    $self->{output}->getTransport()->flush();
...
sub recv_reservePayment{
  my $self = shift;
                    ...
                    my $result = new ShopService_reservePayment_result();
                    $result->read($self->{input});
                    $self->{input}->readMessageEnd();
