                    ...
                    /^0$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1424 = 0; $_i1424 < $_size1420; ++$_i1424)
                        {
                          my $elem1425 = undef;
                          $elem1425 = ChannelNotificationSetting->new();
                          $xfer += $elem1425->read($input);
                          push(@{$self->{success}},$elem1425);
                        }
...
sub write {
                ...
                if (defined $self->{success}) {
                  $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                  {
                    ...
                    {
                      foreach my $iter1426 (@{$self->{success}}) 
                      {
                    ...
                    /^1$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1431 = 0; $_i1431 < $_size1427; ++$_i1431)
                        {
                          my $elem1432 = undef;
                          $xfer += $input->readString(\$elem1432);
                          push(@{$self->{channelIds}},$elem1432);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{channelIds}) {
                  $xfer += $output->writeFieldBegin('channelIds', Thrift::TType::LIST, 1);
                  {
                    ...
                    {
                      foreach my $iter1433 (@{$self->{channelIds}}) 
                      {
                    ...
                    /^3$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1438 = 0; $_i1438 < $_size1434; ++$_i1438)
                        {
                          my $elem1439 = undef;
                          $xfer += $input->readString(\$elem1439);
                          push(@{$self->{authScheme}},$elem1439);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{authScheme}) {
                  $xfer += $output->writeFieldBegin('authScheme', Thrift::TType::LIST, 3);
                  {
                    ...
                    {
                      foreach my $iter1440 (@{$self->{authScheme}}) 
                      {
                    ...
                    /^1$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1445 = 0; $_i1445 < $_size1441; ++$_i1445)
                        {
                          my $elem1446 = undef;
                          $elem1446 = ChannelIdWithLastUpdated->new();
                          $xfer += $elem1446->read($input);
                          push(@{$self->{channelIds}},$elem1446);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{channelIds}) {
                  $xfer += $output->writeFieldBegin('channelIds', Thrift::TType::LIST, 1);
                  {
                    ...
                    {
                      foreach my $iter1447 (@{$self->{channelIds}}) 
                      {
                    ...
                    /^0$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1452 = 0; $_i1452 < $_size1448; ++$_i1452)
                        {
                          my $elem1453 = undef;
                          $xfer += $input->readString(\$elem1453);
                          push(@{$self->{success}},$elem1453);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{success}) {
                  $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                  {
                    ...
                    {
                      foreach my $iter1454 (@{$self->{success}}) 
                      {
                    ...
                    /^1$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i1459 = 0; $_i1459 < $_size1455; ++$_i1459)
                        {
                          my $elem1460 = undef;
                          $elem1460 = ChannelNotificationSetting->new();
                          $xfer += $elem1460->read($input);
                          push(@{$self->{setting}},$elem1460);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{setting}) {
                  $xfer += $output->writeFieldBegin('setting', Thrift::TType::LIST, 1);
                  {
                    ...
                    {
                      foreach my $iter1461 (@{$self->{setting}}) 
                      {
...
sub send_issueOTP{
  ...
  my $channelId = shift;
                ...
                my $args = new ChannelService_issueOTP_args();
...
sub recv_issueOTP{
  my $self = shift;
                ...
                my $result = new ChannelService_issueOTP_result();
...
sub send_approveChannelAndIssueChannelToken{
  ...
  my $channelId = shift;
                ...
                my $args = new ChannelService_approveChannelAndIssueChannelToken_args();
                $args->{channelId} = $channelId;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_approveChannelAndIssueChannelToken{
  my $self = shift;
                ...
                my $result = new ChannelService_approveChannelAndIssueChannelToken_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_approveChannelAndIssueRequestToken{
  ...
  my $otpId = shift;
                ...
                my $args = new ChannelService_approveChannelAndIssueRequestToken_args();
                $args->{channelId} = $channelId;
                $args->{otpId} = $otpId;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_approveChannelAndIssueRequestToken{
  my $self = shift;
                ...
                my $result = new ChannelService_approveChannelAndIssueRequestToken_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_fetchNotificationItems{
  ...
  my $localRev = shift;
                ...
                my $args = new ChannelService_fetchNotificationItems_args();
...
sub recv_fetchNotificationItems{
  my $self = shift;
                ...
                my $result = new ChannelService_fetchNotificationItems_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getApprovedChannels{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_getApprovedChannels_args();
...
sub recv_getApprovedChannels{
  my $self = shift;
                ...
                my $result = new ChannelService_getApprovedChannels_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getChannelInfo{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_getChannelInfo_args();
                $args->{channelId} = $channelId;
                $args->{locale} = $locale;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_getChannelInfo{
  my $self = shift;
                ...
                my $result = new ChannelService_getChannelInfo_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getChannelNotificationSetting{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_getChannelNotificationSetting_args();
                $args->{channelId} = $channelId;
                $args->{locale} = $locale;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_getChannelNotificationSetting{
  my $self = shift;
                ...
                my $result = new ChannelService_getChannelNotificationSetting_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getChannelNotificationSettings{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_getChannelNotificationSettings_args();
                $args->{locale} = $locale;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_getChannelNotificationSettings{
  my $self = shift;
                ...
                my $result = new ChannelService_getChannelNotificationSettings_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getChannels{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_getChannels_args();
                $args->{lastSynced} = $lastSynced;
                $args->{locale} = $locale;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_getChannels{
  my $self = shift;
                ...
                my $result = new ChannelService_getChannels_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getDomains{
  ...
  my $lastSynced = shift;
                ...
                my $args = new ChannelService_getDomains_args();
                $args->{lastSynced} = $lastSynced;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_getDomains{
  my $self = shift;
                ...
                my $result = new ChannelService_getDomains_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getFriendChannelMatrices{
  ...
  my $channelIds = shift;
                ...
                my $args = new ChannelService_getFriendChannelMatrices_args();
...
sub recv_getFriendChannelMatrices{
  my $self = shift;
                ...
                my $result = new ChannelService_getFriendChannelMatrices_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_updateChannelSettings{
  ...
  my $channelSettings = shift;
                ...
                my $args = new ChannelService_updateChannelSettings_args();
...
sub recv_updateChannelSettings{
  my $self = shift;
                ...
                my $result = new ChannelService_updateChannelSettings_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getCommonDomains{
  ...
  my $lastSynced = shift;
                ...
                my $args = new ChannelService_getCommonDomains_args();
                $args->{lastSynced} = $lastSynced;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_getCommonDomains{
  my $self = shift;
                ...
                my $result = new ChannelService_getCommonDomains_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getNotificationBadgeCount{
  ...
  my $localRev = shift;
                ...
                my $args = new ChannelService_getNotificationBadgeCount_args();
                $args->{localRev} = $localRev;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_getNotificationBadgeCount{
  my $self = shift;
                ...
                my $result = new ChannelService_getNotificationBadgeCount_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_issueChannelToken{
  ...
  my $channelId = shift;
                ...
                my $args = new ChannelService_issueChannelToken_args();
                $args->{channelId} = $channelId;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_issueChannelToken{
  my $self = shift;
                ...
                my $result = new ChannelService_issueChannelToken_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_issueRequestToken{
  ...
  my $otpId = shift;
                ...
                my $args = new ChannelService_issueRequestToken_args();
                $args->{channelId} = $channelId;
                $args->{otpId} = $otpId;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_issueRequestToken{
  my $self = shift;
                ...
                my $result = new ChannelService_issueRequestToken_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_issueRequestTokenWithAuthScheme{
  ...
  my $returnUrl = shift;
                ...
                my $args = new ChannelService_issueRequestTokenWithAuthScheme_args();
                $args->{channelId} = $channelId;
                $args->{otpId} = $otpId;
...
sub recv_issueRequestTokenWithAuthScheme{
  my $self = shift;
                ...
                my $result = new ChannelService_issueRequestTokenWithAuthScheme_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_issueRequestTokenForAutoLogin{
  ...
  my $redirectUrl = shift;
                ...
                my $args = new ChannelService_issueRequestTokenForAutoLogin_args();
                $args->{channelId} = $channelId;
                $args->{otpId} = $otpId;
...
sub recv_issueRequestTokenForAutoLogin{
  my $self = shift;
                ...
                my $result = new ChannelService_issueRequestTokenForAutoLogin_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_getUpdatedChannelIds{
  ...
  my $channelIds = shift;
                ...
                my $args = new ChannelService_getUpdatedChannelIds_args();
                $args->{channelIds} = $channelIds;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_getUpdatedChannelIds{
  my $self = shift;
                ...
                my $result = new ChannelService_getUpdatedChannelIds_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_reserveCoinUse{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_reserveCoinUse_args();
...
sub recv_reserveCoinUse{
  my $self = shift;
                ...
                my $result = new ChannelService_reserveCoinUse_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_revokeChannel{
  ...
  my $channelId = shift;
                ...
                my $args = new ChannelService_revokeChannel_args();
                $args->{channelId} = $channelId;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
                $self->{output}->getTransport()->flush();
...
sub recv_revokeChannel{
  my $self = shift;
                ...
                my $result = new ChannelService_revokeChannel_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_syncChannelData{
  ...
  my $locale = shift;
                ...
                my $args = new ChannelService_syncChannelData_args();
                $args->{lastSynced} = $lastSynced;
                $args->{locale} = $locale;
                $args->write($self->{output});
                $self->{output}->writeMessageEnd();
...
sub recv_syncChannelData{
  my $self = shift;
                ...
                my $result = new ChannelService_syncChannelData_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
...
sub send_updateChannelNotificationSetting{
  ...
  my $setting = shift;
                ...
                my $args = new ChannelService_updateChannelNotificationSetting_args();
...
sub recv_updateChannelNotificationSetting{
  my $self = shift;
                ...
                my $result = new ChannelService_updateChannelNotificationSetting_result();
                $result->read($self->{input});
                $self->{input}->readMessageEnd();
