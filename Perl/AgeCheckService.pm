...
sub send_checkUserAge{
  ...
  my $standardAge = shift;
        ...
        my $args = new AgeCheckService_checkUserAge_args();
...
sub recv_checkUserAge{
  my $self = shift;
        ...
        my $result = new AgeCheckService_checkUserAge_result();
...
sub send_checkUserAgeWithDocomo{
  ...
  my $verifier = shift;
        ...
        my $args = new AgeCheckService_checkUserAgeWithDocomo_args();
...
sub recv_checkUserAgeWithDocomo{
  my $self = shift;
        ...
        my $result = new AgeCheckService_checkUserAgeWithDocomo_result();
        $result->read($self->{input});
        $self->{input}->readMessageEnd();
...
sub send_retrieveOpenIdAuthUrlWithDocomo{
  my $self = shift;
        ...
        my $args = new AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_args();
        $args->write($self->{output});
        $self->{output}->writeMessageEnd();
        $self->{output}->getTransport()->flush();
}
...
sub recv_retrieveOpenIdAuthUrlWithDocomo{
  my $self = shift;
        ...
        my $result = new AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result();
        $result->read($self->{input});
        $self->{input}->readMessageEnd();
...
sub send_retrieveRequestToken{
  ...
  my $carrier = shift;
        ...
        my $args = new AgeCheckService_retrieveRequestToken_args();
        $args->{carrier} = $carrier;
        $args->write($self->{output});
        $self->{output}->writeMessageEnd();
        $self->{output}->getTransport()->flush();
...
sub recv_retrieveRequestToken{
  my $self = shift;
        ...
        my $result = new AgeCheckService_retrieveRequestToken_result();
        $result->read($self->{input});
        $self->{input}->readMessageEnd();
