...
sub send_lookupByPhoneNumber{
  ...
  my $phoneNumber = shift;
    ...
    my $args = new SpotService_lookupByPhoneNumber_args();
...
sub recv_lookupByPhoneNumber{
  my $self = shift;
    ...
    my $result = new SpotService_lookupByPhoneNumber_result();
...
sub send_lookupNearby{
  ...
  my $countryAreaCode = shift;
    ...
    my $args = new SpotService_lookupNearby_args();
...
sub recv_lookupNearby{
  my $self = shift;
    ...
    my $result = new SpotService_lookupNearby_result();
    $result->read($self->{input});
    $self->{input}->readMessageEnd();
