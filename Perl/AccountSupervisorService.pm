...
sub send_getRSAKey{
  ...
  my $args = AccountSupervisorService_getRSAKey_args->new();
...
sub recv_getRSAKey{
  ...
  my $result = AccountSupervisorService_getRSAKey_result->new();
...
sub send_notifyEmailConfirmationResult{
  ...
  my $args = AccountSupervisorService_notifyEmailConfirmationResult_args->new();
...
sub recv_notifyEmailConfirmationResult{
  ...
  my $result = AccountSupervisorService_notifyEmailConfirmationResult_result->new();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_registerVirtualAccount{
  ...
  my $args = AccountSupervisorService_registerVirtualAccount_args->new();
  $args->{locale} = $locale;
...
sub recv_registerVirtualAccount{
  ...
  my $result = AccountSupervisorService_registerVirtualAccount_result->new();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_requestVirtualAccountPasswordChange{
  ...
  my $args = AccountSupervisorService_requestVirtualAccountPasswordChange_args->new();
...
sub recv_requestVirtualAccountPasswordChange{
  ...
  my $result = AccountSupervisorService_requestVirtualAccountPasswordChange_result->new();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_requestVirtualAccountPasswordSet{
  ...
  my $args = AccountSupervisorService_requestVirtualAccountPasswordSet_args->new();
  $args->{virtualMid} = $virtualMid;
  $args->{encryptedVirtualUserId} = $encryptedVirtualUserId;
  $args->{encryptedNewPassword} = $encryptedNewPassword;
  $args->write($self->{output});
...
sub recv_requestVirtualAccountPasswordSet{
  ...
  my $result = AccountSupervisorService_requestVirtualAccountPasswordSet_result->new();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_unregisterVirtualAccount{
  ...
  my $args = AccountSupervisorService_unregisterVirtualAccount_args->new();
  $args->{virtualMid} = $virtualMid;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_unregisterVirtualAccount{
  ...
  my $result = AccountSupervisorService_unregisterVirtualAccount_result->new();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
