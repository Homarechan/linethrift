...
package AuthService_updatePassword_args;
use base qw(Class::Accessor);
AuthService_updatePassword_args->mk_accessors( qw( authSessionId request ) );

sub new {
                              my $classname = shift;
                              my $self      = {};
                              my $vals      = shift || {};
                              $self->{authSessionId} = undef;
                              $self->{request} = undef;
                              if (UNIVERSAL::isa($vals,'HASH')) {
                                if (defined $vals->{authSessionId}) {
                                  $self->{authSessionId} = $vals->{authSessionId};
                                }
                              ...
                              while (1) 
                              {
                                ...
                                SWITCH: for($fid)
                                {
                                  /^2$/ && do{                                  if ($ftype == Thrift::TType::STRING) {
                                    $xfer += $input->readString(\$self->{authSessionId});
                                  } else {
                                    $xfer += $input->skip($ftype);
                                  }
                                  last; };
                                  /^3$/ && do{                                  if ($ftype == Thrift::TType::STRUCT) {
                                    $self->{request} = IdentityCredentialRequest->new();
...
sub write {
                              ...
                              if (defined $self->{authSessionId}) {
                                $xfer += $output->writeFieldBegin('authSessionId', Thrift::TType::STRING, 2);
                                $xfer += $output->writeString($self->{authSessionId});
                                $xfer += $output->writeFieldEnd();
                              }
                              if (defined $self->{request}) {
                                $xfer += $output->writeFieldBegin('request', Thrift::TType::STRUCT, 3);
...
package AuthService_updatePassword_result;
use base qw(Class::Accessor);
AuthService_updatePassword_result->mk_accessors( qw( success ) );
                              ...
                              while (1) 
                              {
                                ...
                                SWITCH: for($fid)
                                {
                                  /^0$/ && do{                                  if ($ftype == Thrift::TType::STRUCT) {
                                    $self->{success} = IdentityCredentialResponse->new();
...
package AuthService_getAuthRSAKey_args;
use base qw(Class::Accessor);
AuthService_getAuthRSAKey_args->mk_accessors( qw( authSessionId identityProvider ) );
...
sub write {
                              ...
                              if (defined $self->{identityProvider}) {
                                $xfer += $output->writeFieldBegin('identityProvider', Thrift::TType::I32, 3);
...
package AuthService_getAuthRSAKey_result;
use base qw(Class::Accessor);
AuthService_getAuthRSAKey_result->mk_accessors( qw( success ) );
...
package AuthService_openAuthSession_args;
use base qw(Class::Accessor);
AuthService_openAuthSession_args->mk_accessors( qw( request ) );
                              ...
                              while (1) 
                              {
                                ...
                                SWITCH: for($fid)
                                {
                                  /^2$/ && do{                                  if ($ftype == Thrift::TType::STRUCT) {
                                    $self->{request} = AuthSessionRequest->new();
                                    $xfer += $self->{request}->read($input);
                                  } else {
                                    $xfer += $input->skip($ftype);
                                  }
...
package AuthService_openAuthSession_result;
use base qw(Class::Accessor);
AuthService_openAuthSession_result->mk_accessors( qw( success ) );
...
sub updatePassword{
                              ...
                              my $authSessionId = ($request->{'authSessionId'}) ? $request->{'authSessionId'} : undef;
                              my $request = ($request->{'request'}) ? $request->{'request'} : undef;
                              return $self->{impl}->updatePassword($authSessionId, $request);
                            }
...
sub getAuthRSAKey{
                              ...
                              return $self->{impl}->getAuthRSAKey($authSessionId, $identityProvider);
                            }
...
sub openAuthSession{
                              ...
                              my $request = ($request->{'request'}) ? $request->{'request'} : undef;
                              return $self->{impl}->openAuthSession($request);
                            }
...
sub send_updatePassword{
  my $self = shift;
  my $authSessionId = shift;
  my $request = shift;

                              $self->{output}->writeMessageBegin('updatePassword', Thrift::TMessageType::CALL, $self->{seqid});
                              my $args = new AuthService_updatePassword_args();
...
sub recv_updatePassword{
  my $self = shift;
                              ...
                              my $result = new AuthService_updatePassword_result();
                              ...
                              die "updatePassword failed: unknown result";
}
sub getAuthRSAKey{
  my $self = shift;
  my $authSessionId = shift;
...
sub send_getAuthRSAKey{
  my $self = shift;
  my $authSessionId = shift;
  my $identityProvider = shift;

                              $self->{output}->writeMessageBegin('getAuthRSAKey', Thrift::TMessageType::CALL, $self->{seqid});
                              my $args = new AuthService_getAuthRSAKey_args();
                              $args->{authSessionId} = $authSessionId;
...
sub recv_getAuthRSAKey{
  my $self = shift;
                              ...
                              my $result = new AuthService_getAuthRSAKey_result();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
                              ...
                              die "getAuthRSAKey failed: unknown result";
}
sub openAuthSession{
  my $self = shift;
  my $request = shift;
...
sub send_openAuthSession{
  my $self = shift;
  my $request = shift;

                              $self->{output}->writeMessageBegin('openAuthSession', Thrift::TMessageType::CALL, $self->{seqid});
                              my $args = new AuthService_openAuthSession_args();
                              $args->{request} = $request;
                              $args->write($self->{output});
                              $self->{output}->writeMessageEnd();
                              $self->{output}->getTransport()->flush();
...
sub recv_openAuthSession{
  my $self = shift;
                              ...
                              my $result = new AuthService_openAuthSession_result();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
                              ...
                              die "openAuthSession failed: unknown result";
}
sub normalizePhoneNumber{
  my $self = shift;
  my $countryCode = shift;
...
sub process_updatePassword {
                                ...
                                my $result = new AuthService_updatePassword_result();
                                eval {
                                  $result->{success} = $self->{handler}->updatePassword($args->authSessionId, $args->request);
                                ...
                                if ($@) {
                                  ...
                                  $output->writeMessageBegin('updatePassword', Thrift::TMessageType::EXCEPTION, $seqid);
                                  $err->write($output);
                                  $output->writeMessageEnd();
                                  $output->getTransport()->flush();
                                  $@ = undef;
                                ...
                                $output->writeMessageBegin('updatePassword', Thrift::TMessageType::REPLY, $seqid);
                                $result->write($output);
                                $output->writeMessageEnd();
                                $output->getTransport()->flush();
}

sub process_getAuthRSAKey {
                                my ($self, $seqid, $input, $output) = @_;
                                my $args = new AuthService_getAuthRSAKey_args();
                                $args->read($input);
                                $input->readMessageEnd();
                                my $result = new AuthService_getAuthRSAKey_result();
                                eval {
                                  $result->{success} = $self->{handler}->getAuthRSAKey($args->authSessionId, $args->identityProvider);
                                }; if( UNIVERSAL::isa($@,'TalkException') ){ 
                                  $result->{e} = $@;
                                  $@ = undef;
                                }
                                if ($@) {
                                  $@ =~ s/^\s+|\s+$//g;
                                  my $err = new Thrift::TApplicationException("Unexpected Exception: " . $@, Thrift::TApplicationException::INTERNAL_ERROR);
                                  $output->writeMessageBegin('getAuthRSAKey', Thrift::TMessageType::EXCEPTION, $seqid);
                                  $err->write($output);
                                  $output->writeMessageEnd();
                                  $output->getTransport()->flush();
                                  $@ = undef;
                                ...
                                $output->writeMessageBegin('getAuthRSAKey', Thrift::TMessageType::REPLY, $seqid);
                                $result->write($output);
                                $output->writeMessageEnd();
                                $output->getTransport()->flush();
}

sub process_openAuthSession {
                                my ($self, $seqid, $input, $output) = @_;
                                my $args = new AuthService_openAuthSession_args();
                                $args->read($input);
                                $input->readMessageEnd();
                                my $result = new AuthService_openAuthSession_result();
                                eval {
                                  $result->{success} = $self->{handler}->openAuthSession($args->request);
                                }; if( UNIVERSAL::isa($@,'TalkException') ){ 
                                  $result->{e} = $@;
                                  $@ = undef;
                                }
                                if ($@) {
                                  $@ =~ s/^\s+|\s+$//g;
                                  my $err = new Thrift::TApplicationException("Unexpected Exception: " . $@, Thrift::TApplicationException::INTERNAL_ERROR);
                                  $output->writeMessageBegin('openAuthSession', Thrift::TMessageType::EXCEPTION, $seqid);
                                  $err->write($output);
                                  $output->writeMessageEnd();
                                  $output->getTransport()->flush();
                                  $@ = undef;
                                ...
                                $output->writeMessageBegin('openAuthSession', Thrift::TMessageType::REPLY, $seqid);
                                $result->write($output);
                                $output->writeMessageEnd();
                                $output->getTransport()->flush();
}
