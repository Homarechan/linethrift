...
sub send_normalizePhoneNumber{
  ...
  my $countryCodeHint = shift;
                              ...
                              my $args = AuthService_normalizePhoneNumber_args->new();
...
sub recv_normalizePhoneNumber{
  my $self = shift;
                              ...
                              my $result = AuthService_normalizePhoneNumber_result->new();
...
sub send_respondE2EELoginRequest{
  ...
  my $errorCode = shift;
                              ...
                              my $args = AuthService_respondE2EELoginRequest_args->new();
...
sub recv_respondE2EELoginRequest{
  my $self = shift;
                              ...
                              my $result = AuthService_respondE2EELoginRequest_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_confirmE2EELogin{
  ...
  my $deviceSecret = shift;
                              ...
                              my $args = AuthService_confirmE2EELogin_args->new();
                              $args->{verifier} = $verifier;
...
sub recv_confirmE2EELogin{
  my $self = shift;
                              ...
                              my $result = AuthService_confirmE2EELogin_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_logoutZ{
  my $self = shift;
                              ...
                              my $args = AuthService_logoutZ_args->new();
                              $args->write($self->{output});
                              $self->{output}->writeMessageEnd();
                              $self->{output}->getTransport()->flush();
}
...
sub recv_logoutZ{
  my $self = shift;
                              ...
                              my $result = AuthService_logoutZ_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_loginZ{
  ...
  my $loginRequest = shift;
                              ...
                              my $args = AuthService_loginZ_args->new();
...
sub recv_loginZ{
  my $self = shift;
                              ...
                              my $result = AuthService_loginZ_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_issueTokenForAccountMigrationSettings{
  ...
  my $enforce = shift;
                              ...
                              my $args = AuthService_issueTokenForAccountMigrationSettings_args->new();
...
sub recv_issueTokenForAccountMigrationSettings{
  my $self = shift;
                              ...
                              my $result = AuthService_issueTokenForAccountMigrationSettings_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_issueTokenForAccountMigration{
  ...
  my $migrationSessionId = shift;
                              ...
                              my $args = AuthService_issueTokenForAccountMigration_args->new();
...
sub recv_issueTokenForAccountMigration{
  my $self = shift;
                              ...
                              my $result = AuthService_issueTokenForAccountMigration_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
...
sub send_verifyQrcodeWithE2EE{
  ...
  my $hashKeyChain = shift;
                              ...
                              my $args = AuthService_verifyQrcodeWithE2EE_args->new();
                              $args->{verifier} = $verifier;
...
sub recv_verifyQrcodeWithE2EE{
  my $self = shift;
                              ...
                              my $result = AuthService_verifyQrcodeWithE2EE_result->new();
                              $result->read($self->{input});
                              $self->{input}->readMessageEnd();
