                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i1280 = 0; $_i1280 < $_size1276; ++$_i1280)
                    {
                      my $elem1281 = undef;
                      $elem1281 = BuddySearchResult->new();
                      $xfer += $elem1281->read($input);
                      push(@{$self->{success}},$elem1281);
                    }
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
              {
                ...
                {
                  foreach my $iter1282 (@{$self->{success}}) 
                  {
                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i1287 = 0; $_i1287 < $_size1283; ++$_i1287)
                    {
                      my $elem1288 = undef;
                      $elem1288 = Contact->new();
                      $xfer += $elem1288->read($input);
                      push(@{$self->{success}},$elem1288);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
              {
                $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
                {
                  foreach my $iter1289 (@{$self->{success}}) 
                  {
                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i1294 = 0; $_i1294 < $_size1290; ++$_i1294)
                    {
                      my $elem1295 = undef;
                      $xfer += $input->readString(\$elem1295);
                      push(@{$self->{success}},$elem1295);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
              {
                ...
                {
                  foreach my $iter1296 (@{$self->{success}}) 
                  {
                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::MAP) {
                  {
                    ...
                    my $_ktype1298 = 0;
                    my $_vtype1299 = 0;
                    $xfer += $input->readMapBegin(\$_ktype1298, \$_vtype1299, \$_size1297);
                    for (my $_i1301 = 0; $_i1301 < $_size1297; ++$_i1301)
                    {
                      my $key1302 = '';
                      my $val1303 = 0;
                      $xfer += $input->readString(\$key1302);
                      $xfer += $input->readI64(\$val1303);
                      $self->{success}->{$key1302} = $val1303;
                    }
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::MAP, 0);
              {
                ...
                {
                  while( my ($kiter1304,$viter1305) = each %{$self->{success}}) 
                  {
                    $xfer += $output->writeString($kiter1304);
                    $xfer += $output->writeI64($viter1305);
                  }
                }
                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    {
                      my $elem1311 = undef;
                      $elem1311 = BuddyList->new();
                      $xfer += $elem1311->read($input);
                      push(@{$self->{success}},$elem1311);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
              {
                $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
                {
                  foreach my $iter1312 (@{$self->{success}}) 
                  {
...
sub send_findBuddyContactsByQuery{
  ...
  my $requestSource = shift;
            ...
            my $args = new BuddyService_findBuddyContactsByQuery_args();
...
sub recv_findBuddyContactsByQuery{
  my $self = shift;
            ...
            my $result = new BuddyService_findBuddyContactsByQuery_result();
...
sub send_getBuddyContacts{
  ...
  my $count = shift;
            ...
            my $args = new BuddyService_getBuddyContacts_args();
            $args->{language} = $language;
            $args->{country} = $country;
...
sub recv_getBuddyContacts{
  my $self = shift;
            ...
            my $result = new BuddyService_getBuddyContacts_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getBuddyDetail{
  ...
  my $buddyMid = shift;
            ...
            my $args = new BuddyService_getBuddyDetail_args();
...
sub recv_getBuddyDetail{
  my $self = shift;
            ...
            my $result = new BuddyService_getBuddyDetail_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getBuddyOnAir{
  ...
  my $buddyMid = shift;
            ...
            my $args = new BuddyService_getBuddyOnAir_args();
            $args->{buddyMid} = $buddyMid;
            $args->write($self->{output});
            $self->{output}->writeMessageEnd();
            $self->{output}->getTransport()->flush();
...
sub recv_getBuddyOnAir{
  my $self = shift;
            ...
            my $result = new BuddyService_getBuddyOnAir_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getCountriesHavingBuddy{
  my $self = shift;
            ...
            my $args = new BuddyService_getCountriesHavingBuddy_args();
            $args->write($self->{output});
            $self->{output}->writeMessageEnd();
            $self->{output}->getTransport()->flush();
}
...
sub recv_getCountriesHavingBuddy{
  my $self = shift;
            ...
            my $result = new BuddyService_getCountriesHavingBuddy_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getNewlyReleasedBuddyIds{
  ...
  my $country = shift;
            ...
            my $args = new BuddyService_getNewlyReleasedBuddyIds_args();
            $args->{country} = $country;
            $args->write($self->{output});
            $self->{output}->writeMessageEnd();
            $self->{output}->getTransport()->flush();
...
sub recv_getNewlyReleasedBuddyIds{
  my $self = shift;
            ...
            my $result = new BuddyService_getNewlyReleasedBuddyIds_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getPopularBuddyBanner{
  ...
  my $resourceSpecification = shift;
            ...
            my $args = new BuddyService_getPopularBuddyBanner_args();
            $args->{language} = $language;
            $args->{country} = $country;
...
sub recv_getPopularBuddyBanner{
  my $self = shift;
            ...
            my $result = new BuddyService_getPopularBuddyBanner_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getPopularBuddyLists{
  ...
  my $country = shift;
            ...
            my $args = new BuddyService_getPopularBuddyLists_args();
            $args->{language} = $language;
            $args->{country} = $country;
            $args->write($self->{output});
            $self->{output}->writeMessageEnd();
...
sub recv_getPopularBuddyLists{
  my $self = shift;
            ...
            my $result = new BuddyService_getPopularBuddyLists_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
...
sub send_getPromotedBuddyContacts{
  ...
  my $country = shift;
            ...
            my $args = new BuddyService_getPromotedBuddyContacts_args();
            $args->{language} = $language;
            $args->{country} = $country;
            $args->write($self->{output});
            $self->{output}->writeMessageEnd();
...
sub recv_getPromotedBuddyContacts{
  my $self = shift;
            ...
            my $result = new BuddyService_getPromotedBuddyContacts_result();
            $result->read($self->{input});
            $self->{input}->readMessageEnd();
