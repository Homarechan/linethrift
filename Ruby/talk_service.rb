...
module TalkService
  class Client
    ...
    def searchCollection(query, param)
      send_searchCollection(query, param)
      return recv_searchCollection()
    end

    def send_searchCollection(query, param)
      send_message('searchCollection', SearchCollection_args, :query => query, :param => param)
    end

    def recv_searchCollection()
      result = receive_message(SearchCollection_result)
      return result.success unless result.success.nil?
      raise result.e unless result.e.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'searchCollection failed: unknown result')
    end
  ...
  class Processor
    ...
    def process_searchCollection(seqid, iprot, oprot)
      args = read_args(iprot, SearchCollection_args)
      result = SearchCollection_result.new()
      begin
        result.success = @handler.searchCollection(args.query, args.param)
      rescue ::TalkException => e
        result.e = e
      end
      write_result(result, oprot, 'searchCollection', seqid)
    end
  ...
  class SearchCollection_args
    ...
    FIELDS = {
      ...
      PARAM => {:type => ::Thrift::Types::STRUCT, :name => 'param', :class => ::SearchPagingParameter}
    }
  ...
  class SearchCollection_result
    ...
    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::SearchResult},
