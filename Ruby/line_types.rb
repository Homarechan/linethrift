...
class TextMessageAnnouncementContents; end

class SquareChatAnnouncementContents; end

class SquareChatAnnouncement; end
...
class SquareAuthority; end

class SquarePreference; end

class SquareMember; end

class SquareMemberRelation; end

class SquareFeature; end

class SquareFeatureSet; end

class SquareStatus; end

class SquareChat; end

class NoteStatus; end

class SquareInfo; end

class BotUseInfo; end
...
class SpotNearbyItem; end

class SpotNearbyResponse; end

class SpotPhoneNumberResponse; end
...
class ContactTransition; end

class UserTicketResponse; end
...
class CommitMessageResult; end

class BuddySearchResult; end

class SyncParamMid; end

class SIMInfo; end

class SyncParamContact; end
...
class LoginRequest; end

class LoginSession; end

class Message; end

class SquareMessage; end

class SquareChatStatusWithoutMessage; end

class SquareChatStatus; end

class SquareChatMember; end

class MessageOperation; end

class MessageOperations; end

class MessageStoreResult; end
...
class SuggestDictionary; end

class SuggestItemDictionaryIncrement; end

class SuggestTagDictionaryIncrement; end

class SuggestDictionaryIncrements; end

class SuggestItemDictionaryRevision; end

class SuggestTagDictionaryRevision; end

class SuggestDictionaryRevisions; end

class SuggestDictionarySettings; end

class PhoneInfoForChannel; end
...
class ErrorExtraInfo; end

class SyncRelations; end

class SyncScope; end

class JoinSquareResponse; end

class JoinSquareRequest; end

class JoinSquareChatResponse; end

class JoinSquareChatRequest; end

class SendMessageResponse; end

class SendMessageRequest; end

class MarkAsReadRequest; end

class MarkAsReadResponse; end

class SubscriptionState; end

class ApproveSquareMembersResponse; end

class ApproveSquareMembersRequest; end

class CreateSquareChatResponse; end

class CreateSquareChatRequest; end

class CreateSquareResponse; end

class CreateSquareRequest; end

class DeleteSquareResponse; end

class DeleteSquareRequest; end

class DestroyMessageResponse; end

class DestroyMessageRequest; end

class GetSquareChatMembersRequest; end

class GetSquareChatMembersResponse; end

class GetSquareChatStatusRequest; end

class GetSquareChatStatusResponse; end

class GetSquareChatRequest; end

class GetSquareChatResponse; end

class GetSquareAuthorityRequest; end

class GetSquareAuthorityResponse; end

class GetJoinedSquaresRequest; end

class GetJoinedSquaresResponse; end

class GetJoinableSquareChatsRequest; end

class GetJoinableSquareChatsResponse; end

class GetInvitationTicketUrlRequest; end

class GetInvitationTicketUrlResponse; end

class LeaveSquareRequest; end

class LeaveSquareResponse; end

class LeaveSquareChatRequest; end

class LeaveSquareChatResponse; end

class SquareMemberSearchOption; end

class SearchSquareMembersRequest; end

class SearchSquareMembersResponse; end

class FindSquareByInvitationTicketRequest; end

class FindSquareByInvitationTicketResponse; end

class SquareEventReceiveMessage; end

class SquareEventSendMessage; end

class SquareEventNotifiedJoinSquareChat; end

class SquareEventNotifiedInviteIntoSquareChat; end

class SquareEventNotifiedLeaveSquareChat; end

class SquareEventNotifiedDestroyMessage; end

class SquareEventNotifiedMarkAsRead; end

class SquareEventNotifiedUpdateSquareMemberProfile; end

class SquareEventNotifiedKickoutFromSquare; end

class SquareEventNotifiedShutdownSquare; end

class SquareEventNotifiedDeleteSquareChat; end

class SquareEventNotifiedUpdateSquareChatProfileName; end

class SquareEventNotifiedUpdateSquareChatProfileImage; end

class SquareEventNotifiedUpdateSquareChatStatus; end

class SquareEventNotifiedUpdateSquareStatus; end

class SquareEventNotifiedCreateSquareMember; end

class SquareEventNotifiedCreateSquareChatMember; end

class SquareEventNotifiedUpdateSquareMemberRelation; end

class SquareEventNotifiedUpdateSquare; end

class SquareEventNotifiedUpdateSquareMember; end

class SquareEventNotifiedUpdateSquareChat; end

class SquareEventNotificationJoinRequest; end

class SquareEventNotificationMemberUpdate; end

class SquareEventNotificationSquareDelete; end

class SquareEventNotificationSquareChatDelete; end

class SquareEventNotificationMessage; end

class SquareEventNotifiedUpdateSquareChatMember; end

class SquareEventNotifiedUpdateSquareAuthority; end

class SquareEventNotifiedUpdateSquareFeatureSet; end

class SquareEventPayload; end

class SquareEvent; end

class FetchMyEventsRequest; end

class FetchMyEventsResponse; end

class FetchSquareChatEventsRequest; end

class FetchSquareChatEventsResponse; end

class InviteToSquareRequest; end

class InviteToSquareResponse; end

class InviteToSquareChatRequest; end

class InviteToSquareChatResponse; end

class GetSquareMemberRequest; end

class GetSquareMemberResponse; end

class GetSquareMembersRequest; end

class GetSquareMembersResponse; end

class GetSquareMemberRelationsRequest; end

class GetSquareMemberRelationsResponse; end

class GetSquareMemberRelationRequest; end

class GetSquareMemberRelationResponse; end

class Category; end

class GetSquareCategoriesRequest; end

class GetSquareCategoriesResponse; end

class UpdateSquareRequest; end

class UpdateSquareResponse; end

class SearchSquaresRequest; end

class SearchSquaresResponse; end

class GetSquareFeatureSetRequest; end

class GetSquareFeatureSetResponse; end

class UpdateSquareFeatureSetRequest; end

class UpdateSquareFeatureSetResponse; end

class UpdateSquareMemberRequest; end

class UpdateSquareMemberResponse; end

class UpdateSquareMembersRequest; end

class UpdateSquareMembersResponse; end

class RejectSquareMembersRequest; end

class RejectSquareMembersResponse; end

class RemoveSubscriptionsRequest; end

class RemoveSubscriptionsResponse; end

class RefreshSubscriptionsRequest; end

class RefreshSubscriptionsResponse; end

class UpdateSquareChatRequest; end

class UpdateSquareChatResponse; end

class DeleteSquareChatRequest; end

class DeleteSquareChatResponse; end

class UpdateSquareChatMemberRequest; end

class UpdateSquareChatMemberResponse; end

class UpdateSquareAuthorityRequest; end

class UpdateSquareAuthorityResponse; end

class UpdateSquareMemberRelationRequest; end

class UpdateSquareMemberRelationResponse; end

class ReportSquareRequest; end

class ReportSquareResponse; end

class ReportSquareChatRequest; end

class ReportSquareChatResponse; end

class ReportSquareMessageRequest; end

class ReportSquareMessageResponse; end

class ReportSquareMemberRequest; end

class ReportSquareMemberResponse; end

class GetSquareRequest; end

class GetSquareResponse; end

class GetSquareStatusRequest; end

class GetSquareStatusResponse; end

class GetNoteStatusRequest; end

class GetNoteStatusResponse; end

class CreateSquareChatAnnouncementRequest; end

class CreateSquareChatAnnouncementResponse; end

class DeleteSquareChatAnnouncementRequest; end

class DeleteSquareChatAnnouncementResponse; end

class GetSquareChatAnnouncementsRequest; end

class GetSquareChatAnnouncementsResponse; end

class GetJoinedSquareChatsRequest; end

class GetJoinedSquareChatsResponse; end

class TalkException < ::Thrift::Exception; end

class ShouldSyncException < ::Thrift::Exception; end

class PointException < ::Thrift::Exception; end

class ChannelException < ::Thrift::Exception; end

class SquareException < ::Thrift::Exception; end
