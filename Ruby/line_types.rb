...
module SRType
  ...
  L = 6
  POPUP_SOUND = 6
  VALUE_MAP = {1 => "STATIC", 2 => "ANIMATION", 3 => "SOUND", 4 => "ANIMATION_SOUND", 5 => "POPUP", 6 => "L", 6 => "POPUP_SOUND"}
  VALID_VALUES = Set.new([STATIC, ANIMATION, SOUND, ANIMATION_SOUND, POPUP, L, POPUP_SOUND]).freeze
end
...
module SubType
  GENERAL = 0
  CREATORS = 1
  VALUE_MAP = {0 => "GENERAL", 1 => "CREATORS"}
  VALID_VALUES = Set.new([GENERAL, CREATORS]).freeze
end
...
class Chatapp
  ...
  FIELDS = {
    ...
    AVAILABLECHATTYPES => {:type => ::Thrift::Types::LIST, :name => 'availableChatTypes', :element => {:type => ::Thrift::Types::I32, :enum_class => ::AvailableChatTypes}}
  }
...
class MyChatapp
  ...
  FIELDS = {
    ...
    CATEGORY => {:type => ::Thrift::Types::I32, :name => 'category', :enum_class => ::ChatappCategory},
    PRIORITY => {:type => ::Thrift::Types::I64, :name => 'priority'}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @category.nil? || ::ChatappCategory::VALID_VALUES.include?(@category)
...
class ChatappException
  ...
  FIELDS = {
    CODE => {:type => ::Thrift::Types::I32, :name => 'code', :enum_class => ::ChatAppExceptionCode},
  ...
  def validate
    unless @code.nil? || ::ChatAppExceptionCode::VALID_VALUES.include?(@code)
...
class UpdateProfileAttributesRequest
  ...
  FIELDS = {
    PROFILEATTRIBUTES => {:type => ::Thrift::Types::MAP, :name => 'profileAttributes', :key => {:type => ::Thrift::Types::I32, :enum_class => ::ProfileAttribute}, :value => {:type => ::Thrift::Types::STRUCT, :class => ::ProfileContent}}
  }
...
class IdentityCredentialResponse
  ...
  FIELDS = {
    ...
    RESPONSETYPE => {:type => ::Thrift::Types::I32, :name => 'responseType', :enum_class => ::IdentityResponseType},
  ...
  def validate
    unless @responseType.nil? || ::IdentityResponseType::VALID_VALUES.include?(@responseType)
...
class CategoryItem
  ...
  FIELDS = {
    ...
    CAT => {:type => ::Thrift::Types::I32, :name => 'cat'},
    NAME => {:type => ::Thrift::Types::STRING, :name => 'name'}
  }
...
class PromotionMissionInfo
  ...
  FIELDS = {
    PROMOTIONMISSIONTYPE => {:type => ::Thrift::Types::I32, :name => 'promotionMissionType', :enum_class => ::PMType},
  ...
  def validate
    unless @promotionMissionType.nil? || ::PMType::VALID_VALUES.include?(@promotionMissionType)
...
class PromotionInfo
  ...
  FIELDS = {
    PROMOTIONTYPE => {:type => ::Thrift::Types::I32, :name => 'promotionType', :enum_class => ::PromotionType},
  ...
  def validate
    unless @promotionType.nil? || ::PromotionType::VALID_VALUES.include?(@promotionType)
...
class StickerProperty
  ...
  FIELDS = {
    ...
    STICKERRESOURCETYPE => {:type => ::Thrift::Types::I32, :name => 'stickerResourceType', :enum_class => ::SRType},
    ...
    STICKERIDS => {:type => ::Thrift::Types::SET, :name => 'stickerIds', :element => {:type => ::Thrift::Types::STRING}}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @stickerResourceType.nil? || ::SRType::VALID_VALUES.include?(@stickerResourceType)
...
class ThemeProperty
  ...
  FIELDS = {
    ...
    THEMERESOURCETYPE => {:type => ::Thrift::Types::I32, :name => 'themeResourceType', :enum_class => ::TRType}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @themeResourceType.nil? || ::TRType::VALID_VALUES.include?(@themeResourceType)
...
class SticonProperty
  ...
  FIELDS = {
    STICONIDS => {:type => ::Thrift::Types::SET, :name => 'sticonIds', :element => {:type => ::Thrift::Types::STRING}}
  }
...
class ProductSearchSummary
  ...
  FIELDS = {
    ...
    TYPE => {:type => ::Thrift::Types::I32, :name => 'type', :enum_class => ::PType},
    NAME => {:type => ::Thrift::Types::STRING, :name => 'name'},
    AUTHOR => {:type => ::Thrift::Types::STRING, :name => 'author'},
    PROMOTIONINFO => {:type => ::Thrift::Types::STRUCT, :name => 'promotionInfo', :class => ::PromotionInfo},
    ...
    PROPERTY => {:type => ::Thrift::Types::STRUCT, :name => 'property', :class => ::ProductProperty},
    SUBTYPE => {:type => ::Thrift::Types::I32, :name => 'subType', :enum_class => ::SubType},
    ...
    SALEFLAG => {:type => ::Thrift::Types::BOOL, :name => 'saleFlag'}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @type.nil? || ::PType::VALID_VALUES.include?(@type)
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Invalid value of field type!')
    end
    unless @subType.nil? || ::SubType::VALID_VALUES.include?(@subType)
...
class BuddySearchResult
  ...
  FIELDS = {
    ...
    BOTTYPE => {:type => ::Thrift::Types::I32, :name => 'botType', :enum_class => ::BotType}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @botType.nil? || ::BotType::VALID_VALUES.include?(@botType)
...
class ShortcutButton
  ...
  FIELDS = {
    ...
    ACTION => {:type => ::Thrift::Types::STRUCT, :name => 'action', :class => ::ShortcutButtonAction}
  }
...
class SearchItemUnion
  ...
  FIELDS = {
    ...
    SQUARECATEGORYITEM => {:type => ::Thrift::Types::STRUCT, :name => 'squareCategoryItem', :class => ::SQCat}
  }
...
class SearchResultItem
  ...
  FIELDS = {
    ID => {:type => ::Thrift::Types::STRING, :name => 'id'},
    ITEMTYPE => {:type => ::Thrift::Types::I32, :name => 'ItemType'},
    ITEM => {:type => ::Thrift::Types::STRUCT, :name => 'item', :class => ::SearchItemUnion},
    TITLE => {:type => ::Thrift::Types::STRING, :name => 'title'},
    SUB1 => {:type => ::Thrift::Types::STRING, :name => 'sub1'},
    SUB2 => {:type => ::Thrift::Types::STRING, :name => 'sub2'},
    ICONURL => {:type => ::Thrift::Types::STRING, :name => 'iconUrl'},
    TITLELINK => {:type => ::Thrift::Types::STRING, :name => 'titleLink'},
    ICONLINK => {:type => ::Thrift::Types::STRING, :name => 'iconLink'},
    DISPLAYTEMPLATE => {:type => ::Thrift::Types::STRING, :name => 'displayTemplate'},
    ADDITIONALINFO => {:type => ::Thrift::Types::LIST, :name => 'additionalInfo', :element => {:type => ::Thrift::Types::STRUCT, :class => ::AdditionalInfoItem}}
  }
...
class SearchResultCollection
  ...
  FIELDS = {
    ...
    CAT => {:type => ::Thrift::Types::LIST, :name => 'cat', :element => {:type => ::Thrift::Types::I32}},
    ERROR => {:type => ::Thrift::Types::STRING, :name => 'error'},
    TABTITLE => {:type => ::Thrift::Types::STRING, :name => 'tabTitle'},
    START => {:type => ::Thrift::Types::I32, :name => 'start'},
    LENGTH => {:type => ::Thrift::Types::I32, :name => 'length'},
    SQUARECATEGORYID => {:type => ::Thrift::Types::I32, :name => 'squareCategoryId'}
  }
...
class SearchCommonParameter
  ...
  FIELDS = {
    ...
    SID => {:type => ::Thrift::Types::STRING, :name => 'sid'},
    QUERYTYPE => {:type => ::Thrift::Types::I32, :name => 'queryType'}
  }
...
class Message
  ...
  FIELDS = {
    ...
    PERSON => {:type => ::Thrift::Types::STRING, :name => 'person'},
    PERSON2 => {:type => ::Thrift::Types::STRING, :name => 'person2'},
    PERSONNAME => {:type => ::Thrift::Types::STRING, :name => 'personName'},
    PERSONNAME2 => {:type => ::Thrift::Types::STRING, :name => 'personName2'},
    TO => {:type => ::Thrift::Types::STRING, :name => 'to'},
